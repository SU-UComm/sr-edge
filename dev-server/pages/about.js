export default async function About() {
    ...
    <html lang="en" class="">
    <head>
        <title>About - Stanford Report</title>
        ...
        <script>window.pageController={"id":130290,"status":16,"topicPath":"/about","isStory":false,"mainTopic":"","mainTopicId":"","contentType":"","storyLayout":"","search":{"endpoint":"https://news.stanford.edu/_api/fb/query","collection":"sug~sp-stanford-report-search","profile":"stanford-report-push-search","resultPage":"https://news.stanford.edu/search"},"title":"About","gaData":{"publishedDate":"1730098800","srContentCategory":null,"srContentCategoryText":"","srFeaturedUnit":null,"srFeaturedUnitText":"","srContentMainTopic":null,"srContentMainTopicText":"","srContentTopic":null,"srContentTopicText":null,"srContentSubtopic":null,"srContentSubtopicText":null,"srContentType":null,"srContentTypeText":"","srByline":"null","srContributors":{"authors":null,"writers":null,"editors":null,"producers":null}}}</script>

        <link preload href="http://localhost:4000/mysource_files/global/bundle.css" rel="stylesheet"/>
    </head>

    <body class="about dark:su-bg-black-true dark:su-text-white">
        ...
        <main id="main-content" role="main" class="su-page su-page--hero su-page--top-margin su-page--bottom-margin">
            <div class="su-page-wrap">
                ...
                <div class="su-page-content">
                    ...
                    <div class="su-text">
                        <p>This is an example about page demonstrating the new page routing system.</p>
                        <p>Adding new pages is now as simple as:</p>
                        <ol>
                            <li>Create a new page file in the pages directory</li>
                            <li>Add an entry to pages-config.js</li>
                            <li>That's it!</li>
                        </ol>
                    </div>
