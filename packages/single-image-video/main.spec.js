...
describe('[Single Image or Video]', () => {
    ...
    describe('[Main Function]', () => {
        ...
        it('Should return the expected HTML with no youtubeid and vimeoid', async () => {
            ...
            expect(result).toMatchInlineSnapshot(`"<section data-component="single-image-video"><div class="su-mx-auto su-component-container su-container-px"><section class="su-flex su-flex-col su-items-center"><div class="su-w-full md:su-max-w-[60.7rem] lg:su-max-w-[63.6rem] su-mx-auto su-rs-mb-3"><h2 class="su-text-center su-text-[3.5rem] su-leading-[4.179rem] su-font-bold md:su-text-[4.0rem] md:su-leading-[4.776rem] lg:su-text-[4.9rem] lg:su-leading-[6.37rem]">Single image or video title is centered</h2><div data-test="component-story-lead" class="su-text-left su-wysiwyg-content su-rs-mt-0 su-text-[1.8rem] su-leading-[2.25rem] su-mt-[1.5rem] md:su-text-[1.9rem] md:su-leading-[2.375rem] md:su-mt-[1.9rem] lg:su-text-[2.1rem] lg:su-leading-[2.625rem]"><p>Balch, an experimental physicist in the Dionne lab at Stanford, has developed a thumbnail-sized optical sensor that can track the health of marine ecosystems in near-real time through quick detection of environmental DNA. It could be a critical tool for natural resource managers in the face of climate change impacts like coral bleaching, warming seas, and migration of species.</p></div></div><div class="su-w-full su-aspect-[16/9] su-relative"><img src="https://picsum.photos/400/400" alt="image alt" class="su-size-full" /><img src="https://picsum.photos/400/400" alt="image alt" class="su-w-full su-object-cover" /></div><div class="su-flex su-gap-8 md:su-gap-22 su-w-full su-relative su-flex-col su-items-center lg:su-flex-row lg:su-items-start su-mt-8 md:su-mt-9 lg:su-mt-15"><div class="su-mx-auto su-flex su-justify-center su-w-full"><p class="dark:su-text-white su-m-0 su-text-14 su-max-w-[633px] su-leading-[16.72px] su-font-normal su-text-black-70 md:su-text-16 md:su-leading-[19.11px] md:su-text-left">Caption text goes here lorem ipsum dolor sit amet | Credit goes here lorem ipsum lorem ipsum lorem ipsum lorem dolor site amit</p></div></div></section></div></section>"`);
        });
