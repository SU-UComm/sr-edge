            ...
            expect(result).toMatchInlineSnapshot(`
              ...
              <div class="component-slider">
                  <div class="swiper component-slider-single component-slider-peek">
                      <div class="swiper-wrapper">
                                      <div class="swiper-slide">
                                          <article aria-label="Three Example Three" data-test="media-card" class="su-component-card-media md:su-min-h-[38.4rem] su-relative su-w-full md:su-px-0 su-flex su-flex-wrap su-justify-center su-gap-20 md:su-gap-36 md:su-gap-48 md:su-flex-nowrap su-items-center">
                                              <div class="su-relative su-w-full su-px-20 md:su-px-0 su-h-[34.2rem] lg:su-h-[57.2rem] lg:su-py-30 su-min-w-[24.9rem] lg:su-min-w-[38.2rem] lg:su-max-w-[38.2rem] su-flex su-items-center su-justify-center">
                                                  <img class="su-media-card-thumb su-size-full su-object-scale-down su-object-center" src="https://picsum.photos/400/400" alt="" />
                                              </div>
                                              <div class="su-media-card-text su-grow su-w-full md:su-w-auto">
                                                  <div class="su-mb-20 md:su-mb-27">
                                              ...
                                              <span data-test="icon" class="dark:su-hidden">
                                                  ...
                                                  <h3 class="su-text-[3.5rem] su-leading-tight md:su-text-[4rem] lg:su-text-[4.3rem] su-mb-5">
                                                      <a href="https://www.squiz.net" class="su-group su-text-black su-transition dark:su-text-white hocus:su-text-digital-red dark:hocus:su-text-dark-mode-red hocus:su-underline">
                                                          <span>Three Example Three</span>
                                                      </a>
                                                  </h3>
                                                  <div data-test="mediacard-author" class="su-mb-15 md:su-mb-19">Susannah Young-ah Gottlieb</div>
                                                  <div class="su-text-18 md:su-text-16 su-mb-15 md:su-mb-19 su-gap-6 su-text-black-70 dark:su-text-black-50 su-flex su-nowrap su-items-center su-leading-none">
                                                      <svg aria-hidden="true" focusable="false" data-testid=svg-book-open data-prefix="fas" data-icon="book-open" class="svg-inline--fa fa-book-open " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="16">
                                                      ...
                                                      </svg>            <span class="su-font-semibold">Magazine</span>
                                                  </div>
                                                  <div data-test="mediacard-description" class="*:su-my-0 *:su-leading-[125%] su-leading-[125%] *:su-text-18 su-text-18 md:*:su-text-19 md:su-text-19 lg:*:su-text-21 lg:su-text-21 dark:su-text-white su-font-sans su-w-full">
                                                      Third on W. H. Auden&#x27;s work from the late 1930s, when he seeks to understand the poet&#x27;s responsibility in the face of a triumphant fascism, to the late 1950s, when he discerns an irreconcilable &quot;divorce&quot; between poetry...
                                                  </div>
                                              </div>
                                          </article>            </div>
                                      <div class="swiper-slide">
                                          <article aria-label="Four Example Four news.stanford.edu link" data-test="media-card" class="su-component-card-media md:su-min-h-[38.4rem] su-relative su-w-full md:su-px-0 su-flex su-flex-wrap su-justify-center su-gap-20 md:su-gap-36 md:su-gap-48 md:su-flex-nowrap su-items-center">
                                              <div class="su-relative su-w-full su-px-20 md:su-px-0 su-h-[34.2rem] lg:su-h-[57.2rem] lg:su-py-30 su-min-w-[24.9rem] lg:su-min-w-[38.2rem] lg:su-max-w-[38.2rem] su-flex su-items-center su-justify-center">
                                                  <img class="su-media-card-thumb su-size-full su-object-scale-down su-object-center" src="https://picsum.photos/400/400" alt="" />
                                              </div>
                                              <div class="su-media-card-text su-grow su-w-full md:su-w-auto">
                                              ...
                                              <span data-test="icon" class="dark:su-hidden">
                                                  ...
                                                  <h3 class="su-text-[3.5rem] su-leading-tight md:su-text-[4rem] lg:su-text-[4.3rem] su-mb-5">
                                                      <a href="https://news.stanford.edu/report/2024/04/04/stanford-alum-business-school-dean-jonathan-levin-named-stanford-president/" class="su-group su-text-black su-transition dark:su-text-white hocus:su-text-digital-red dark:hocus:su-text-dark-mode-red hocus:su-underline">
                                                          <span>Four Example Four news.stanford.edu link</span>
                                                      </a>
                                                  </h3>
                                                  <div data-test="mediacard-author" class="su-mb-15 md:su-mb-19">Susannah Young-ah Gottlieb</div>
                                                  <div class="su-text-18 md:su-text-16 su-mb-15 md:su-mb-19 su-gap-6 su-text-black-70 dark:su-text-black-50 su-flex su-nowrap su-items-center su-leading-none">
                                                      <svg aria-hidden="true" focusable="false" data-testid=svg-microphone data-prefix="fas" data-icon="microphone" class="svg-inline--fa fa-microphone " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="16">
                                                      ...
                                                      </svg>            <span class="su-font-semibold">Podcast</span>
                                                  </div>
                                                  <div data-test="mediacard-description" class="*:su-my-0 *:su-leading-[125%] su-leading-[125%] *:su-text-18 su-text-18 md:*:su-text-19 md:su-text-19 lg:*:su-text-21 lg:su-text-21 dark:su-text-white su-font-sans su-w-full">
                                                      Fourth concentrating on W. H. Auden&#x27;s work from the late 1930s, when he seeks to understand the poet&#x27;s responsibility in the face of a triumphant fascism, to the late 1950s, when he discerns an irreconcilable &quot;divorce&quot; between poetry...
                                                  </div>
                                              </div>
                                          </article>            </div>
                      </div>
                  ...
                  <div class="component-slider-controls su-flex su-mt-45 lg:su-mt-48 su-items-center su-content-center">
                      <div aria-label="Slide Navigation" class="component-slider-pagination component-slider-pagination-476f6893-b77b-43d8-ac8c-ac74d3d75dd7 su-mr-full"></div>
                                          ...
                                          <article aria-label="Three Example Three" data-test="media-card" class="su-component-card-media md:su-min-h-[38.4rem] su-relative su-w-full md:su-px-0 su-flex su-flex-wrap su-justify-center su-gap-20 md:su-gap-36 md:su-gap-48 md:su-flex-nowrap su-items-center">
                                              ...
                                              <span data-test="icon" class="dark:su-hidden">
                                                  ...
                                                  <h3 class="su-text-[3.5rem] su-leading-tight md:su-text-[4rem] lg:su-text-[4.3rem] su-mb-5">
                                                      <a href="https://www.squiz.net" class="su-group su-text-black su-transition dark:su-text-white hocus:su-text-digital-red dark:hocus:su-text-dark-mode-red hocus:su-underline">
                                                          <span>Three Example Three</span>
                                                          <svg aria-hidden="true" focusable="false" data-testid=svg-arrow-up-right data-prefix="far" data-icon="arrow-up-right" class="svg-inline--fa fa-arrow-up-right su-h-auto su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="24">
                                                              <path fill="currentColor" d="M328 96c13.3 0 24 10.7 24 24l0 240c0 13.3-10.7 24-24 24s-24-10.7-24-24l0-182.1L73 409c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l231-231L88 144c-13.3 0-24-10.7-24-24s10.7-24 24-24l240 0z"></path>
                                                          </svg>            </a>
                                                  </h3>
                                                  <div data-test="mediacard-author" class="su-mb-15 md:su-mb-19">Susannah Young-ah Gottlieb</div>
                                                  <div class="su-text-18 md:su-text-16 su-mb-15 md:su-mb-19 su-gap-6 su-text-black-70 dark:su-text-black-50 su-flex su-nowrap su-items-center su-leading-none">
