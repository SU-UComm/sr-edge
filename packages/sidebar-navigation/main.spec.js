...
describe('[Sidebar Navigation]', () => {
    ...
    describe('[Error Handling]', () => {
        ...
        it('Should throw error when fns or ctx is invalid', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: The "info.fns.assetId" field cannot be undefined and must be a non-empty string. The undefined was received. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
        ...
        it('Should throw error when fns.assetId is an empty string', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: The "info.fns.assetId" field cannot be undefined and must be a non-empty string. The "" was received. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
        ...
        it('Should throw error when ctx.assetId is an empty string', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: The "info.fns.assetId" field cannot be undefined and must be a non-empty string. The 123 was received. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
    });
    ...
    describe('[Edge Cases]', () => {
        it('Should throw error when fetch for header data will fail', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: Error parsing hero data JSON response: Network Error -->');
            expect(mockedError).toBeCalledTimes(1);
        });
        ...
        it('Should throw error when fetch for header data will not return object', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: Error parsing hero data JSON response: Invalid API response: heroData is missing or not an object. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
        ...
        it('Should throw error when fetch for header data will return data without title', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: The "title" must be non-empty string. The undefined was received. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
        ...
        it('Should throw error when fetch for header data will return data with empty title', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: The "title" must be non-empty string. The "" was received. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
        ...
        it('Should throw error when fetch for header data will return media that is not an object', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: The "media" must be an object. The 123 was received. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
        ...
        it('Should throw error when fetch for header data will return summary that is not a string', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: The "summary" must be a string. The 123 was received. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
        ...
        it('Should throw error when fetch for header data will return pubDateFormatted that is not a string', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: The "pubDateFormatted" must be a string. The 123 was received. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
        ...
        it('Should throw error when fetch for header data will return topic that is not an object', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: The "topic" must be an object. The 123 was received. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
        ...
        it('Should throw error when fetch for header data will return mediaType not one of ["image", "video", "carousel"]', async () => {
            ...
            expect(result).toBe('<!-- Error occurred in the Sidebar Navigation component: The "mediaType" must be one of ["image", "video", "carousel"]. The "test" was received. -->');
            expect(mockedError).toBeCalledTimes(1);
        });
