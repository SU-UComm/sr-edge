...
describe('[Multicolumn Info Section]', () => {
    ...
    describe('[Component Rendering]', () => {
        it('Should render the component with all sections', async () => {
            ...
            expect(result).toMatchInlineSnapshot(`"<div data-component="multicolumn-info-section"><div class="su-mx-auto su-component-container su-container-wide su-container-px"><div class="su-grid lg:su-grid-cols-12 su-grid-gap su-gap-y-0 su-max-w-800 su-mx-auto lg:su-max-w-none su-border-b su-rs-pb-5 su-border-b-black-30 dark:su-border-b-black"><h2 class="su-type-2 su-break-words su-col-span-full lg:su-col-span-8 xl:su-col-span-3" data-se="title">Research</h2><div class="su-col-span-full lg:su-col-span-8 xl:su-col-span-6 xl:last:[&amp;&gt;*]:su-mb-0"> <p>Test info text</p>   <a href="https://example.com" class="su-group su-flex su-items-center su-w-fit hocus:su-underline su-px-30 su-pt-12 su-pb-14 su-text-18 md:su-text-20 dark:hocus:su-ring-1 su-button dark:hocus:su-ring-white su-rs-mt-1 su-order-3" data-se="button" data-se-target="infoTextButton">Read more   </a> </div> <div class="su-mx-auto su-component-container su-container-full su-break-words su-col-span-full lg:su-col-span-4 lg:su-col-start-9 xl:su-col-span-3"><div class="su-flex su-flex-col su-justify-start su-items-start su-bg-fog-light lg:su-mx-auto dark:su-bg-black [&>p]:su-m-0 [&>p]:!su-mb-0 [&>p]:su-text-16 md:[&>p]:!su-text-19 last-of-type:[&>p]:!su-mb-0 su-p-20 md:su-p-36 lg:su-px-20 lg:su-py-26"><div class="su-relative su-justify-start su-items-center su-w-full su-gap-3 su-flex su-overflow-hidden su-rs-mb-0"><div><h3 class="su-font-serif su-text-21 md:su-text-23 su-inline su-pr-10 su-m-0" data-se="infoBoxTitle">More Info</h3><span class="su-w-full su-bg-black-40 dark:su-bg-black-70 su-h-px su-absolute su-bottom-4" /></div></div><div class="su-order-1 su-flex su-flex-col su-gap-12"><div class="su-wysiwyg-content *:su-text-16 *:md:su-text-19 *:su-leading last:*:su-mb-0" data-se="infoBoxContent"><p>Test content</p></div></div><figure class=" su-order-2 su-pt-20 md:su-pt-12 lg:su-pt-27 su-w-full"><img src="https://example.com" alt="" class="su-w-full"/><figcaption class="su-m-0 su-text-14 su-leading-[1.672rem] md:su-leading-[1.911rem] md:su-text-16 su-mt-8 md:su-mt-12" data-se="captionCredit">Test caption | Test credit</figcaption></figure><a href="https://example.com" class="su-group su-flex su-items-center su-w-fit hocus:su-underline su-px-30 su-pt-12 su-pb-14 su-text-18 md:su-text-20 dark:hocus:su-ring-1 su-button dark:hocus:su-ring-white su-rs-mt-1 su-order-3" data-se="button" data-se-target="infoBoxButton">Click me   </a></div></div> </div></div></div>"`);
        });
