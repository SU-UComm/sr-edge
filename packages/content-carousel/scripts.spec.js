    ...
    describe('[Carousel functionality]', () => {
        ...
        it("Should call updateAccessibility after slideChange event", async () => {
            ...
            swiper.on("slideChange", function () {
                setTimeout(() => {
                    contentCarousel.updateAccessibility(swiper);
                }, 100);
            });
