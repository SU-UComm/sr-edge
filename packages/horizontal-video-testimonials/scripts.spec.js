...
import * as horizontalVideoTestimonials from './scripts';

describe('[Horizontal Video Testimonials][Client]', () => {
    ...
    beforeEach(() => {
        ...
        modal.classList.add(horizontalVideoTestimonials.HORIZONTAL_VIDEO_TESTIMONIALS_HIDDEN_CLASS);
    ...
    describe('[DOMContentLoaded]', () => {
        it('Should call _modalInit for each section', () => {
            ...
            section.setAttribute('data-component', 'horizontal-video-testimonials');
            document.body.appendChild(section);

            const _modalInitSpy = vi.spyOn(horizontalVideoTestimonials, '_modalInit');

            // Simulate DOMContentLoaded event
            const event = new Event('DOMContentLoaded');
            document.dispatchEvent(event);

            document.querySelectorAll(horizontalVideoTestimonials.HORIZONTAL_VIDEO_TESTIMONIALS_SELECTOR).forEach(section => {
                // Call the function to set up all event listeners
                horizontalVideoTestimonials._modalInit(section);
            });
    ...
    describe('[Modal functionality]', () => {
        ...
        it('Should open the modal when open button was clicked', () => {
            ...
            expect(modal.classList.contains(horizontalVideoTestimonials.HORIZONTAL_VIDEO_TESTIMONIALS_HIDDEN_CLASS)).toBe(false);
        });
        ...
        it('Should close the modal when close button was clicked', () => {
            ...
            expect(modal.classList.contains(horizontalVideoTestimonials.HORIZONTAL_VIDEO_TESTIMONIALS_HIDDEN_CLASS)).toBe(true);
        });
