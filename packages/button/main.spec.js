...
describe('[Button]', () => {
    ...
    describe('[Main Function]', () => {
        ...
        it('Should render button with internal URL', async () => {
            ...
            expect(result).toMatchInlineSnapshot(`"<section data-component="button"><div class="su-mx-auto su-component-container su-container-large su-container-px"> <a href="https://example.com/internal-link" class="su-group su-flex su-items-center su-w-fit hocus:su-underline md:su-px-30 md:su-pt-12 md:su-pb-14 su-text-18 md:su-text-20 dark:hocus:su-ring-1 su-button dark:hocus:su-ring-white"> Button Text   </a> </div></section>"`);
        });
        ...
        it('Should handle isNewWindow correctly', async () => {
            ...
            expect(result).toMatchInlineSnapshot(`"<section data-component="button"><div class="su-mx-auto su-component-container su-container-large su-container-px"> <a href="https://example.com/internal-link" target="_blank" class="su-group su-flex su-items-center su-w-fit hocus:su-underline md:su-px-30 md:su-pt-12 md:su-pb-14 su-text-18 md:su-text-20 dark:hocus:su-ring-1 su-button dark:hocus:su-ring-white"> Button Text   </a> </div></section>"`);
        });
