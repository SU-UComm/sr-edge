...
import campaignBrandBarTemplate from './campaign-brand-bar.hbs';

/**
 * Campaign Brand Bar component that renders on Campaign pages only.
 * @module CampaignBrand Bar
 */
export default {
    /**
     * Renders the Campaign Brand Bar component.
     *
     * @async
     * @function
     ...
     * @returns {Promise<string>} The rendered Campaign Brand Bar HTML or an error message.
     * @throws {Error} If Campaign Brand Bar data fetch operation fails.
    */
    async main(args, info) {
        ...
        return campaignBrandBarTemplate(componentData);
    }
};
