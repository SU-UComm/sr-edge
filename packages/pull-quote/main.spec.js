...
describe('[Pull Quote]', () => {
    ...
    describe('[Main Function]', () => {
        ...
        it('Should return the expected HTML with no image data when not provided', async () => {
            ...
            expect(result).toMatchInlineSnapshot(`"<section data-component="pullquote"><div class="su-mx-auto su-component-container su-container-large su-container-px"><div class="su-component-pullquote su-mx-auto su-relative su-mt-0 su-flex su-flex-wrap su-gap-27 su-justify-center su-pr-0 su-py-0"><blockquote class="su-w-full su-pl-39 dark:su-text-white dark:before:su-text-white su-font-serif su-text-black lg:su-pl-[5.2rem]"><div class="quote-mark su-font-semibold su-font-serif-0 su-text-[2.4rem] md:su-text-[3.6rem] su-leading md:su-leading-[130.245%] [&>*:last-child]:su-mb-0 su-relative before:su-text-[73px] before:su-leading-[109.5px] lg:before:su-leading-[139.5px] lg:before:su-text-[93px] before:su-font-semibold before:su--mt-25 lg:before:su--mt-38 before:su-text-serif before:su-text-black dark:su-text-white before:su-absolute before:su-right-full lg:before:su-right-full before:su-mr-6 lg:before:su-mr-13 dark:before:su-text-white su-leading-[33.6px] md:su-leading-[46.89px]" data-se="featuredQuote">Test quote</div><cite class="su-mt-15 md:su-mt-26 lg:su-mt-29 su-font-sans su-text-21 su-leading-[25.2px] su-flex su-flex-col"><span class="su-font-bold su-block su-leading-[25.2px]" data-se="name">Test name</span><span class="su-block su-leading-[25.2px]" data-se="title">Test title</span></cite></blockquote></div></div></section>"`);
        });
    });
