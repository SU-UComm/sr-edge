...
describe('[ButtonRow]', () => {
    ...
    describe('[Main Function]', () => {
        it('Should render button row with internal URLs', async () => {
            ...
            expect(result).toMatchInlineSnapshot(`"<section data-component="button-row">
...
"`);
    ...
    <div class="su-mx-auto su-component-container  su-container-px">
        <div class="su-flex su-flex-wrap su-justify-center su-gap-x-18 md:su-gap-x-27 su-gap-y-12 su-mx-auto su-w-fit">
                <a href="https://external.com" target="_blank" rel="noopener nofollow" class="su-group su-flex su-items-center su-w-fit hocus:su-underline md:su-px-30 md:su-pt-12 md:su-pb-14 su-text-18 md:su-text-20 dark:hocus:su-ring-1 su-button dark:hocus:su-ring-white">
                    External Link         
...
"`);
    ...
    <div class="su-mx-auto su-component-container  su-container-px">
        <div class="su-flex su-flex-wrap su-justify-center su-gap-x-18 md:su-gap-x-27 su-gap-y-12 su-mx-auto su-w-fit">
                <a href="https://example.com/internal-link" class="su-group su-flex su-items-center su-w-fit hocus:su-underline md:su-px-30 md:su-pt-12 md:su-pb-14 su-text-18 md:su-text-20 dark:hocus:su-ring-1 su-button dark:hocus:su-ring-white">
                    Primary Button         
                </a>                <a href="https://external.com" target="_blank" rel="noopener nofollow" class="su-group su-flex su-items-center su-w-fit hocus:su-underline md:su-px-30 md:su-pt-12 md:su-pb-14 su-text-18 md:su-text-20 dark:hocus:su-ring-1 su-button dark:hocus:su-ring-white">
                    External Link         
                        <svg class="svg-inline--fa fa-fw su-inline-block su-shrink-0 su-text-white group-hocus:su-text-white su-text-[0.9em] su-ml-04em su-transition-transform su-rotate-45 group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em"
                            width="20"
                            height="20"
