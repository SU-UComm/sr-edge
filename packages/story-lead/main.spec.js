...
describe('[Story Lead]', () => {
    ...
    describe('[Content Rendering]', () => {
        ...
        it('Should not render when no parameters was provided.', async () => {
            const result = await main();
            expect(result).not.toContain('data-component="story-lead"');
        });
        
        it('Should not render when no data was provided', async () => {
            const result = await main({});
            expect(result).not.toContain('data-component="story-lead"');
        });
