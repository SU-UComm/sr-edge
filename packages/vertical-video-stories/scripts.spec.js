...
import * as verticalVideoStories from './scripts.js';
import * as videoUtils from '../../global/js/helpers/VideoUtils/index.js';

describe('[Vertical Video Stories][Client]', () => {
    ...
    beforeEach(() => {
        ...
        modal.classList.add(verticalVideoStories.VERTICAL_VIDEO_STORIES_HIDDEN_CLASS);
    ...
    describe('[DOMContentLoaded]', () => {
        it('Should call _modalInit and _videoInit for each section', () => {
            ...
            section.setAttribute('data-component', 'vertical-video-stories');
            document.body.appendChild(section);

            const _modalInitSpy = vi.spyOn(verticalVideoStories, '_modalInit');
            const _videoInitSpy = vi.spyOn(verticalVideoStories, '_videoInit');
             ...
             document.querySelectorAll(verticalVideoStories.VERTICAL_VIDEO_STORIES_SELECTOR).forEach(section => {
                // Call the function to set up all event listeners
                verticalVideoStories._modalInit(section);
                verticalVideoStories._videoInit(section);
            });
    ...
    describe('[Modal functionality]', () => {
        ...
        it('Should open the modal when open button was clicked', () => {
            ...
            expect(modal.classList.contains(verticalVideoStories.VERTICAL_VIDEO_STORIES_HIDDEN_CLASS)).toBe(false);
        });
        ...
        it('Should close the modal when close button was clicked', () => {
            ...
            expect(modal.classList.contains(verticalVideoStories.VERTICAL_VIDEO_STORIES_HIDDEN_CLASS)).toBe(true);
        });
    ...
    describe('focusTrap', () => {
        ...
        beforeEach(() => {
            ...
            document.body.innerHTML = `
                <section class="" data-component="vertical-video-stories">
        ...
        it('should loop focus to first element when Tab is pressed on the last element', () => {
            ...
            verticalVideoStories.focusTrap(
