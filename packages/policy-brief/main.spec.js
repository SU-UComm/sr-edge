            ...
            expect(result).toMatchInlineSnapshot(`
              "<section data-component="policy-brief">
               ...
               <span class="su-transition group-hocus:su--translate-y-01em group-hocus:su-translate-x-01em [&>svg]:su-translate-y-1">
                                                                                              <svg data-testid='svg-externalarrow' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' class='su-stroke-digital-red su-fill-transparent dark:su-stroke-dark-mode-red' width='23' height='24' viewBox='0 0 23 24' fill='none' class='' > <path d='M8.95664 7.57744L15.5563 7.57744M15.5563 7.57744L15.5563 14.1771M15.5563 7.57744L7.07102 16.0627' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round' /> </svg>                                         </span>
               </a>
               </div>
               </div>
               </div>
