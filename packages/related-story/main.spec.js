                              ...
                              <h3 class="su-component-sidebar-heading su-w-full su-flex su-flex-wrap su-gap-6 su-my-0 su-font-sans su-text-black dark:su-text-white su-font-bold su-text-20 md:su-text-28 su-items-start">
                                  ...
                                  <span data-test="icon" class="su-hidden dark:su-block">
                                      <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
                                          ...
                                          <defs>
                                              <linearGradient id="bullseyePointerDarkGradient">
                                  ...
                                  </span>        <span>Related story</span>
                              </h3>
                          <a class="su-text-black hocus:su-text-black su-no-underline su-group" href=https://canary-us.uat.matrix.squiz.cloud/_pnp-stanford/stories/stanford-releases-preliminary-enrollment-data-for-class-of-2028>
                              <div class="su-flex su-gap-20 sm:su-gap-40 su-mt-30 lg:su-mt-36 lg:su-mt-38">
                                  <img class="su-object-cover su-h-auto su-max-h-[103px] su-max-w-[103px] md:su-max-h-[168px] md:su-max-w-[168px] lg:su-max-h-[185px] lg:su-max-w-[185px] su-object-center" src="https://canary-us.uat.matrix.squiz.cloud/__data/assets/image/0023/63356/photo-1496171367470-9ed9a91ea931.jpeg" alt=""/>
                                  <div>
                                      ...
                                      <div class="su-wysiwyg-content su-text-16 sm:su-text-18 su-leading-[125%] !su-m-0 su-font-normal dark:su-text-white">
                                          This is an override description
                                      </div>
                                  </div>
                              </div>
                          </a>
              ...
              "<section data-component="related-story">
                  <div class="su-mx-auto su-component-container su-container-narrow su-container-px">
                      <section class="story__related-story su-col-span-full sm:su-col-span-10 sm:su-col-start-2 lg:su-col-span-6 lg:su-col-start-4 su-mx-auto">
                          ...
                          <a class="su-text-black hocus:su-text-black su-no-underline su-group" href=https://example.com/test>
                              <div class="su-flex su-gap-20 sm:su-gap-40 su-mt-30 lg:su-mt-36 lg:su-mt-38">
                                  <img class="su-object-cover su-h-auto su-max-h-[103px] su-max-w-[103px] md:su-max-h-[168px] md:su-max-w-[168px] lg:su-max-h-[185px] lg:su-max-w-[185px] su-object-center" src="https://example.com/image.jpg" alt=""/>
                                  <div>
                                      <h4 class="su-transition group-hocus:su-underline group-hocus:su-text-digital-red dark:group-hocus:su-text-dark-mode-red su-text-20 dark:su-text-white sm:su-text-24 su-font-serif !su-font-bold su-leading-display su-mb-9">
                                          Test Story
                                      </h4>
