...
describe('[Related Story Content]', () => {
  ...
  describe('[Main Function]', () => {
    it('Should return the expected HTML with valid data', async () => {
      ...
      expect(result).toContain(`<section data-component="related-story">
    <div class="su-mx-auto su-component-container su-container-narrow su-container-px">
        <section class="story__related-story su-col-span-full sm:su-col-span-10 sm:su-col-start-2 lg:su-col-span-6 lg:su-col-start-4 su-mx-auto">
            ...
            <div class="su-flex su-gap-20 sm:su-gap-40 su-mt-30 lg:su-mt-36 lg:su-mt-38">
                <img class="su-object-cover su-h-auto su-max-h-[103px] su-max-w-[103px] md:su-max-h-[168px] md:su-max-w-[168px] lg:su-max-h-[185px] lg:su-max-w-[185px] su-object-center"
                src="https://canary-us.uat.matrix.squiz.cloud/__data/assets/image/0023/63356/photo-1496171367470-9ed9a91ea931.jpeg"
                alt=""
                />
                <div>
