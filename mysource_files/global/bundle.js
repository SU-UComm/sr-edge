import F from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const Ze=typeof window>"u"?{}:window;function Tt(e=Ze){return e.document!==void 0}function Pe(e,t=Ze){if(!Tt(t))return null;const{document:n}=t,{cookie:s}=n;if(typeof s!="string")return null;const r=s.split("; ");let i=null;return r.find(a=>{const[o,l]=a.split("=");return o===e&&l!==""&&(i=l),null}),i}const Ae="su-hidden";function xe(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')};Object.values(t).forEach(n=>{n==null||n.forEach(s=>{s.classList.add(Ae)})}),t[e]&&t[e].forEach(n=>{n.classList.remove(Ae)})}document.addEventListener("DOMContentLoaded",function(){const e=Pe("preferences_personalisation");xe(e==="null"||!e?"external":e)});function Ge(e){if(!e)return 0;const t=225,n=e.trim().split(/\s+/).length;return Math.ceil(n/t)}function kt(e,t,n,s=()=>{}){const r=e.slides.length;let i=t-r+1;r%n!==0&&(i+=n-r%n);const a=document.createDocumentFragment(),o=e.slides.map(l=>l.outerHTML).join("");for(let l=0;l<i;l++){const f=document.createElement("div");for(f.innerHTML=o;f.firstChild;)f.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(f.firstChild)}e.wrapperEl.appendChild(a),e.update(),I(e,"",!1),s()}function D(e,t=()=>{}){const{slidesPerView:n,slidesPerGroup:s}=e.params,r=e.slides.length,i=Math.ceil(n+s);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<i||r%s!==0?kt(e,i,s,t):(I(e,"",!1),t())}function be(e){const t=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(t){let n=e.pagination.bullets.length-e.slides.length+t;for(;n>0;){const s=e.pagination.bullets.pop();s&&s.remove(),n--}}}const I=(e,t,n)=>{e.slides.forEach(s=>{if(s.classList.contains("swiper-slide-active")){if(s.removeAttribute("aria-hidden"),s.removeAttribute("inert"),s.setAttribute("tabindex","-1"),t&&n){let r=null;t==="slide"?r=s:r=s.querySelector(t),r&&r.focus()}}else s.setAttribute("aria-hidden","true"),s.setAttribute("inert","true"),s.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(s=>{s.classList.contains("swiper-pagination-bullet-active")?s.setAttribute("aria-current","true"):s.removeAttribute("aria-current")})},$t='section[data-component="basic-story-hero"]',Vt='span[data-reading="true"]',Ue="su-hidden",Ot='button[data-click="open-modal"]',Ht='button[data-dismiss="modal"]',Fe='iframe[data-modal="iframe"]';function qt(e){const t=e.querySelector(Fe);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(Ue),e.hidden=!1,document.body.style.overflow="hidden"}function se(e){const t=e.querySelector(Fe);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(Ue),e.hidden=!0,document.body.style.overflow=""}function Nt(e){const t=e.querySelectorAll(Ot),n=e.querySelectorAll(Ht);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||se(s)}),s.dataset.listenerAdded="true"),qt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&se(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&se(s)})}function Rt(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new F(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{D(a),I(a,"",!1)},resize:a=>{D(a)},paginationUpdate:a=>{be(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?I(i,"slide",!0):I(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}function Bt(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(Vt);if(t&&n){const s=Ge(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll($t).forEach(e=>{Rt(e),Nt(e),Bt(e)})});const Dt='section[data-component="combined-content-grid"]',ze="su-hidden",Zt='button[data-click="open-modal"]',Pt='button[data-dismiss="modal"]',We='iframe[data-modal="iframe"]';function Gt(e){const t=e.querySelector(We),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(ze),e.hidden=!1,document.body.style.overflow="hidden"}function ne(e){const t=e.querySelector(We),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(ze),e.hidden=!0,document.body.style.overflow=""}function Ut(e){const t=e.querySelectorAll(Zt),n=e.querySelectorAll(Pt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ne(s)}),s.dataset.listenerAdded="true"),Gt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ne(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ne(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Dt).forEach(e=>{Ut(e)})});const Ft='section[data-component="content-carousel"]';function zt(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new F(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{D(a),I(a,"",!1)},resize:a=>{D(a)},paginationUpdate:a=>{be(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?I(i,"slide",!0):I(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ft).forEach(e=>{zt(e)})});const Wt='section[data-component="feature-story-hero"]',jt='span[data-reading="true"]';function Xt(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(jt);if(t&&n){const s=Ge(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Wt).forEach(e=>{Xt(e)})});const Yt='section[data-component="featured-content"]',je="su-hidden",Qt='button[data-click="open-modal"]',Kt='button[data-dismiss="modal"]',Xe='iframe[data-modal="iframe"]';function Jt(e){const t=e.querySelector(Xe),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(je),e.hidden=!1,document.body.style.overflow="hidden"}function re(e){const t=e.querySelector(Xe),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(je),e.hidden=!0,document.body.style.overflow=""}function e1(e){const t=e.querySelectorAll(Qt),n=e.querySelectorAll(Kt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||re(s)}),s.dataset.listenerAdded="true"),Jt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&re(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&re(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Yt).forEach(e=>{e1(e)})});const t1='section[data-component="image-gallery-modal"]',s1='button[data-click="open-gallery-modal"]',n1='div[data-modal="modal"]',r1='button[data-dismiss="modal"]',Ye="su-hidden";let we;const a1=(e,t)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function i1(e){e.classList.remove(Ye),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&a1(t,e)})}function ae(e){e.classList.add(Ye),e.hidden=!0,document.body.style.overflow=""}function o1(e){const t=e.dataset.modalId;we=new F(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function l1(e){const t=e.querySelector(n1),n=e.querySelector(s1),s=e.querySelector(r1);n&&n.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",i=>{r.contains(i.target)||ae(t)}),t.dataset.listenerAdded="true"),i1(t),o1(t)}),s&&s.addEventListener("click",function(){ae(t),we.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(ae(t),we.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(t1).forEach(e=>{l1(e)})});class u1{constructor(t,n){this.url=t,this.type=n,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const s=this.assetIds.map(async r=>{const i=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(i,this.requestProps).catch(l=>{throw new Error(l)})).json()});return Promise.all(s)}return await(await fetch(this.url,this.requestProps).catch(s=>{throw new Error(s)})).json()}}function c1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:n,summary:s,image:r,taxonomyContentTypeText:i,contentTopic:a,contentSubtopic:o,taxonomyContentMainTopicText:l,contentCategory:f,featuredVideo:p,taxonomyContentMainTopicLandingPageUrl:c,taxonomyFeaturedUnitLandingPageUrl:d,taxonomyFeaturedUnitText:C,imageAlt:u,authorName:y,authorImage:h,author:v,isTeaser:m,storySource:g,assetHref:E},date:$,liveUrl:V}){const O=y!==void 0?y:v,S=h!==""?h:void 0,M=r&&r!==""?r:null,L=u&&u!==""?u:"",T=p,Z=n||s;let H=l;!H&&a&&(H=a instanceof Array?a[0]:a),!H&&o&&(H=o instanceof Array?o[0]:o);const te=c;let P=i?i[0]:"";return!P&&f&&(P=f instanceof Array?f[0]:f),E&&t[0]==="link"&&(V=E),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(Z)?Z[0]:Z,liveUrl:Array.isArray(V)?V[0]:V,imageUrl:Array.isArray(M)?M[0]:M,imageAlt:Array.isArray(L)?L[0]:L,taxonomy:Array.isArray(H)?H[0]:H,taxonomyUrl:Array.isArray(te)?te[0]:te,type:Array.isArray(P)?P[0]:P,videoUrl:Array.isArray(T)?T[0]:T,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(O)?O[0]:O,authorAvatar:Array.isArray(S)?S[0]:S,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(d)?d[0]:d,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(m)?m[0]:m,storySource:Array.isArray(g)?g[0]:g}}function ie(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function Qe(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}function d1(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}const f1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(t+s)%16|0,t=Math.floor(t/16)),(n==="x"?s:s&3|8).toString(16)})},p1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),C1=()=>typeof crypto<"u"?p1():f1();async function g1(e=null,t="",n=null){var r,i,a,o,l,f,p,c,d,C,u,y,h,v,m,g,E,$,V;const s=new u1;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const O=`
            ...
            &meta_taxonomyAudienceText=${d1(t)}&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;let S=O;n&&(n!=null&&n.behavioural)&&(S=`${(p=(f=e==null?void 0:e.search)==null?void 0:f.endpoint)==null?void 0:p.replace(/\.html/g,".json")}
                ?profile=${(c=e==null?void 0:e.search)==null?void 0:c.profile}
                &collection=${(d=e==null?void 0:e.search)==null?void 0:d.collection}${n.partialQuery}&num_ranks=3&log=false&meta_isTeaser=false`),s.url=S.replace(/\n+|\t+| {2,}/g,"");let L=((u=(C=(await s.fetch()).response)==null?void 0:C.resultPacket)==null?void 0:u.results)||null;if(L&&L.length<3&&(s.url=O.replace(/\n+|\t+| {2,}/g,""),L=((h=(y=(await s.fetch()).response)==null?void 0:y.resultPacket)==null?void 0:h.results)||null,L&&L.length<3)){const Z=`${(m=(v=e==null?void 0:e.search)==null?void 0:v.endpoint)==null?void 0:m.replace(/\.html/g,".json")}
                    ?profile=${(g=e==null?void 0:e.search)==null?void 0:g.profile}
                    &collection=${(E=e==null?void 0:e.search)==null?void 0:E.collection}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;s.url=Z.replace(/\n+|\t+| {2,}/g,""),L=((V=($=(await s.fetch()).response)==null?void 0:$.resultPacket)==null?void 0:V.results)||null}return L}return null}const oe={WRAPPER:'[data-role="link-list-wrap"]',TOGGLE:'[data-role="link-drawer-toggle"]',DRAWER:'[data-role="link-drawer"]'},b={ACTIVE:"su-rotate-90",INACTIVE:"su-rotate-[-90deg]",OPEN:"su-h-auto",CLOSED:"su-h-0",VISIBLE:"su-opacity-[1]",HIDDEN:"su-opacity-[0]",NO_STORIES:"su-link-list-no-stories"};function m1(e,t){var s;if(!(((s=e==null?void 0:e.dataset)==null?void 0:s.active)==="true")){e.dataset.active=!0,e.classList.remove(b.INACTIVE),e.classList.add(b.ACTIVE),t.classList.remove(b.CLOSED),t.classList.add(b.OPEN);return}e.dataset.active=!1,e.classList.add(b.INACTIVE),e.classList.remove(b.ACTIVE),t.classList.add(b.CLOSED),t.classList.remove(b.OPEN)}function h1(e){const t=document.body.getBoundingClientRect().height,n=window.scrollY+window.innerHeight;if(window.scrollY>=Math.round(30/100*document.body.clientHeight)&&n<=t-700){e.classList.remove(b.HIDDEN),e.classList.remove("su-bottom-[-100px]"),e.classList.add(b.VISIBLE),e.classList.add("su-bottom-0");return}e.classList.remove(b.VISIBLE),e.classList.add("su-bottom-[-100px]"),e.classList.add(b.HIDDEN),e.classList.remove("su-bottom-0")}function v1(e,t){return`
    ...
    `}function w1(e,t,n){if(!e.length){t.classList.add(b.NO_STORIES);return}const[s,r,i]=e;n.innerHTML=`
    ...
    `,t.classList.remove(b.NO_STORIES)}async function y1(e,t,n,s,r,i){const o=(await g1(e,i,t)).map(({title:l,indexUrl:f})=>v1(l,f));w1(o,n,r),L1(n,s,r)}function L1(e,t,n){t.addEventListener("click",function(){m1(t,n)}),window.addEventListener("scroll",function(){h1(e)})}function b1(e,t,n,s){if(!e||!window.pageController)return;const r=window.pageController,i=r.topicsQuery?r.topicsQuery():null;y1(r,i,e,t,n,s)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(oe.WRAPPER),t=document.querySelector(oe.TOGGLE),n=document.querySelector(oe.DRAWER),s=Pe("preferences_personalisation");b1(e,t,n,s)});const E1='section[data-component="media-carousel"]';function S1(e){const t=e.dataset.uniqueId,n=new F(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{D(a),I(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{D(a)},paginationUpdate:a=>{be(a)}}}),s=n.slides.length,r=n.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(s-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),n.on("slideChange",function(){setTimeout(()=>{a?I(n,"h2 a, h3 a, button",!0):I(n,"",!1)},100)})}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(E1).forEach(e=>{S1(e)})});const A1='button[data-role="copy-link"]';function x1(e){e.addEventListener("click",function(){navigator.clipboard.writeText(window.location.href).then(()=>{const t=document.querySelector("[data-copy-text]");t.textContent="Copied",setTimeout(()=>{t.textContent="Copy link"},3e3)})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(A1).forEach(e=>{x1(e)})});const _1='section[data-component="multicolumn-listing"]',Ke="su-hidden",M1='button[data-click="open-modal"]',I1='button[data-dismiss="modal"]',Je='iframe[data-modal="iframe"]';function T1(e){const t=e.querySelector(Je),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ke),e.hidden=!1,document.body.style.overflow="hidden"}function le(e){const t=e.querySelector(Je),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ke),e.hidden=!0,document.body.style.overflow=""}function k1(e){const t=e.querySelectorAll(M1),n=e.querySelectorAll(I1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||le(s)}),s.dataset.listenerAdded="true"),T1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&le(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&le(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(_1).forEach(e=>{k1(e)})});const $1='section[data-component="sidebar-navigation"]',V1='nav[data-nav="nav"]',K="su-hidden",O1='button[data-click="toggle-nav"]',H1="su-bg-digital-red su-text-white dark:su-bg-dark-mode-red dark:aria-expanded:su-text-black-true",q1='span[data-label="button"]';function et(e,t){const n=e.querySelector(q1),s=e.querySelector('svg[data-icon="bars"]'),r=e.querySelector('svg[data-icon="xmark"]');e.setAttribute("aria-expanded",t.toString()),H1.split(" ").forEach(i=>{e.classList.toggle(i,t)}),s&&(s.classList.toggle(`!${K}`,t),s.hidden=t),r&&(r.classList.toggle(`!${K}`,!t),r.hidden=!t),n&&(n.innerHTML=t?n.getAttribute("data-label-close"):n.getAttribute("data-label-open"))}function _e(e,t){e.classList.remove(K),e.hidden=!1,et(t,!0)}function z(e,t){e.classList.add(K),e.hidden=!0,et(t,!1)}function N1(e){const t=e.querySelector(O1),n=e.querySelector(V1);let s;t&&t.addEventListener("click",function(){const r=t.getAttribute("aria-expanded")==="true";n.dataset.listenerAdded||(document.addEventListener("click",i=>{const a=n.contains(i.target),o=t.contains(i.target);!a&&!o&&z(n,t)}),n.dataset.listenerAdded="true"),r?z(n,t):_e(n,t)}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&t&&z(n,t)}),window.addEventListener("resize",()=>{clearTimeout(s),s=setTimeout(()=>{window.innerWidth>991?n&&t&&_e(n,t):n&&t&&z(n,t)},10)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll($1).forEach(e=>{N1(e)})});function N(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function R(e,t){const n=e.querySelector('svg[data-control="play"]'),s=e.querySelector('svg[data-control="pause"]'),r=!t;e.setAttribute("aria-pressed",String(r)),n.classList.toggle("su-hidden",r),n.hidden=r,s.classList.toggle("su-hidden",!r),s.hidden=!r,e.innerHTML=`
  ...
  `}const R1='section[data-component="single-image-video"]',B1='iframe[data-role="video-player"]',D1='button[data-role="video-control"]',tt="su-hidden",Z1='button[data-click="open-modal"]',P1='button[data-dismiss="modal"]',st='iframe[data-modal="iframe"]',G1=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function U1(e){const t=e.querySelector(st),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(tt),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&G1(r,e)})}function ue(e){const t=e.querySelector(st),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(tt),e.hidden=!0,document.body.style.overflow=""}function F1(e){const t=e.querySelectorAll(Z1),n=e.querySelectorAll(P1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ue(s)}),s.dataset.listenerAdded="true"),U1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ue(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ue(s)})}function z1(e){const t=e.querySelector(B1),n=e.querySelector(D1);let s=!1;if(!t||!n)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!s?(N(t,"play"),R(n,!1)):a.isIntersecting||(N(t,"pause"),R(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(N(t,"pause"),R(n,!0),s=!0):(N(t,"play"),R(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(R1).forEach(e=>{F1(e),z1(e)})});const W1='section[data-component="standalone-visual-hero"]',nt="su-hidden",j1='button[data-click="open-modal"]',X1='button[data-dismiss="modal"]',rt='iframe[data-modal="iframe"]';function Y1(e){const t=e.querySelector(rt);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(nt),e.hidden=!1,document.body.style.overflow="hidden"}function ce(e){const t=e.querySelector(rt);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(nt),e.hidden=!0,document.body.style.overflow=""}function Q1(e){const t=e.querySelectorAll(j1),n=e.querySelectorAll(X1);let s=null;t.forEach(r=>{r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ce(s)}),s.dataset.listenerAdded="true"),Y1(s)})}),n.forEach(r=>{r.addEventListener("click",function(){s&&ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ce(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(W1).forEach(e=>{Q1(e)})});const K1='section[data-component="stories-carousel"]',at="su-hidden",J1='button[data-click="open-modal"]',es='button[data-dismiss="modal"]',it='iframe[data-modal="iframe"]';let Me=!1,U=!1;function ts(e){const t=e.querySelector(it),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(at),e.hidden=!1,document.body.style.overflow="hidden"}function de(e){const t=e.querySelector(it),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(at),e.hidden=!0,document.body.style.overflow=""}function ss(e){const t=e.querySelectorAll(J1),n=e.querySelectorAll(es);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||de(s)}),s.dataset.listenerAdded="true"),ts(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&de(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&de(s)})}let Ie=!1;function ns(e,t){const n=e.querySelector(`.component-slider-pagination-${t}`);n&&n.addEventListener("click",function(i){i.target.classList.contains("swiper-pagination-bullet")&&(U=!0)});const s=e.querySelector(".component-slider-next"),r=e.querySelector(".component-slider-prev");s&&s.addEventListener("click",function(){U=!0}),r&&r.addEventListener("click",function(){U=!0})}function rs(e){const t=e.dataset.uniqueId,n=`section[data-unique-id="${t}"] .swiper`;new F(n,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,on:{init:function(){setTimeout(()=>{Me=!0},500),ns(e,t)},slideChange:function(s){const r=document.querySelector(n),i=r.querySelector(".swiper-slide-active");i&&i.removeAttribute("tabindex"),Me&&U&&(Ie=!0,setTimeout(()=>{const a=r.querySelector(".swiper-slide-active"),o=a.querySelector("h2 a, h3 a, button")?a.querySelector("h2 a, h3 a, button"):(()=>(a.setAttribute("tabindex","-1"),a))();Ie&&o.focus()},300),U=!1),s.slides.forEach(a=>{a.classList.contains("swiper-slide-visible")?(a.removeAttribute("aria-hidden"),a.removeAttribute("inert")):(a.setAttribute("aria-hidden","true"),a.setAttribute("inert","true"))}),s.pagination.bullets.length>0&&s.pagination.bullets.forEach(a=>{a.classList.contains("swiper-pagination-bullet-active")?a.setAttribute("aria-current","true"):a.removeAttribute("aria-current")})}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(K1).forEach(e=>{rs(e),ss(e)})});const as='section[data-component="subscribe-to-stanford-report"]';function is(e){const t=e.querySelector("form"),n=t.querySelector('input[type="email"]'),s=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let i="";const a=n.value;if(!a||!a.match(/\w+@\w+\.\w+/)){i='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',s.innerHTML=i,n.setAttribute("aria-describedby","subscription-error");return}s.innerHTML="",n.removeAttribute("aria-describedby"),r.target.submit()}),n.addEventListener("keyup",function(){const r=n.value,i=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(i.innerHTML="",n.removeAttribute("aria-describedby"))})}function os(){document.querySelectorAll(as).forEach(e=>{is(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",os);function ls({offsetNum:e,pageNumber:t,index:n}){return`
        <button
            data-offset="${e}"
    ...
    `}function us({pageNumber:e,allResults:t,resultsPerPage:n,paginationRange:s,currentPage:r=1}){const i=Math.ceil(t/n),a=s,o=e-n,l=e+n,f="su-text-black-50",p=[],c=[];for(let m=0;m<i;m++){const g=m*n+1;c.push(g)}let d=[...c],C=[...c];const u=c.indexOf(r),y=Math.floor(a*.5);if((u<y||i===a)&&(d=d.filter((m,g)=>m>r&&g<a),C=C.filter(m=>m<r)),u>=y&&i!==a)if(d=d.filter((m,g)=>m>r&&g<=u+y),d.length===y)C=C.filter((m,g)=>m<r&&g>=u-y);else{const m=d.length?a-d.length:a;C=C.filter((g,E)=>g<r&&E>u-m)}return[...C,r,...d].map(m=>({offset:m,index:c.indexOf(m)+1})).forEach(({offset:m,index:g})=>{p.push(ls({offsetNum:m,pageNumber:e,index:g}))}),i>1?`<div class="su-mx-auto su-component-container">
                <div class="su-flex su-gap-9 su-items-center su-justify-center su-rs-mt-4 lg:su-rs-mt-7">
                    ...
                    <button
                    type="button"
                        class="su-size-24 su-font-serif su-flex su-items-center su-justify-center dark:su-text-white ${l>c[c.length-1]?f:""}"
            ...
            </div>`:""}function cs(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var ye={exports:{}},w={},Le={exports:{}},B={};function ot(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function ds(e,t,n){}function fs(e,t,n){}var ps=/javascript\s*\:/img;function Cs(e,t){return ps.test(t)?"":t}B.whiteList=ot();B.getDefaultWhiteList=ot;B.onAttr=ds;B.onIgnoreAttr=fs;B.safeAttrValue=Cs;var gs={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},G=gs;function ms(e,t){e=G.trimRight(e),e[e.length-1]!==";"&&(e+=";");var n=e.length,s=!1,r=0,i=0,a="";function o(){if(!s){var p=G.trim(e.slice(r,i)),c=p.indexOf(":");if(c!==-1){var d=G.trim(p.slice(0,c)),C=G.trim(p.slice(c+1));if(d){var u=t(r,a.length,d,C,p);u&&(a+=u+"; ")}}}r=i+1}for(;i<n;i++){var l=e[i];if(l==="/"&&e[i+1]==="*"){var f=e.indexOf("*/",i+2);if(f===-1)break;i=f+1,r=i+1,s=!1}else l==="("?s=!0:l===")"?s=!1:l===";"?s||o():l===`
`&&o()}return G.trim(a)}var hs=ms,W=B,vs=hs;function Te(e){return e==null}function ws(e){var t={};for(var n in e)t[n]=e[n];return t}function lt(e){e=ws(e||{}),e.whiteList=e.whiteList||W.whiteList,e.onAttr=e.onAttr||W.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||W.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||W.safeAttrValue,this.options=e}lt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onAttr,i=n.onIgnoreAttr,a=n.safeAttrValue,o=vs(e,function(l,f,p,c,d){var C=s[p],u=!1;if(C===!0?u=C:typeof C=="function"?u=C(c):C instanceof RegExp&&(u=C.test(c)),u!==!0&&(u=!1),c=a(p,c),!!c){var y={position:f,sourcePosition:l,source:d,isWhite:u};if(u){var h=r(p,c,y);return Te(h)?p+":"+c:h}else{var h=i(p,c,y);if(!Te(h))return h}}});return o};var ys=lt;(function(e,t){var n=B,s=ys;function r(a,o){var l=new s(o);return l.process(a)}t=e.exports=r,t.FilterCSS=s;for(var i in n)t[i]=n[i];typeof window<"u"&&(window.filterCSS=e.exports)})(Le,Le.exports);var Ee=Le.exports,Se={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,n=t.exec(e);return n?n.index:-1}},Ls=Ee.FilterCSS,bs=Ee.getDefaultWhiteList,J=Se;function ut(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var ct=new Ls;function Es(e,t,n){}function Ss(e,t,n){}function As(e,t,n){}function xs(e,t,n){}function dt(e){return e.replace(Ms,"&lt;").replace(Is,"&gt;")}function _s(e,t,n,s){if(n=ht(n),t==="href"||t==="src"){if(n=J.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(t==="background"){if(j.lastIndex=0,j.test(n))return""}else if(t==="style"){if(ke.lastIndex=0,ke.test(n)||($e.lastIndex=0,$e.test(n)&&(j.lastIndex=0,j.test(n))))return"";s!==!1&&(s=s||ct,n=s.process(n))}return n=vt(n),n}var Ms=/</g,Is=/>/g,Ts=/"/g,ks=/&quot;/g,$s=/&#([a-zA-Z0-9]*);?/gim,Vs=/&colon;?/gim,Os=/&newline;?/gim,j=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,ke=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,$e=/u\s*r\s*l\s*\(.*/gi;function ft(e){return e.replace(Ts,"&quot;")}function pt(e){return e.replace(ks,'"')}function Ct(e){return e.replace($s,function(n,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function gt(e){return e.replace(Vs,":").replace(Os," ")}function mt(e){for(var t="",n=0,s=e.length;n<s;n++)t+=e.charCodeAt(n)<32?" ":e.charAt(n);return J.trim(t)}function ht(e){return e=pt(e),e=Ct(e),e=gt(e),e=mt(e),e}function vt(e){return e=ft(e),e=dt(e),e}function Hs(){return""}function qs(e,t){typeof t!="function"&&(t=function(){});var n=!Array.isArray(e);function s(a){return n?!0:J.indexOf(e,a)!==-1}var r=[],i=!1;return{onIgnoreTag:function(a,o,l){if(s(a))if(l.isClosing){var f="[/removed]",p=l.position+f.length;return r.push([i!==!1?i:l.position,p]),i=!1,f}else return i||(i=l.position),"[removed]";else return t(a,o,l)},remove:function(a){var o="",l=0;return J.forEach(r,function(f){o+=a.slice(l,f[0]),l=f[1]}),o+=a.slice(l),o}}}function Ns(e){for(var t="",n=0;n<e.length;){var s=e.indexOf("<!--",n);if(s===-1){t+=e.slice(n);break}t+=e.slice(n,s);var r=e.indexOf("-->",s);if(r===-1)break;n=r+3}return t}function Rs(e){var t=e.split("");return t=t.filter(function(n){var s=n.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),t.join("")}w.whiteList=ut();w.getDefaultWhiteList=ut;w.onTag=Es;w.onIgnoreTag=Ss;w.onTagAttr=As;w.onIgnoreTagAttr=xs;w.safeAttrValue=_s;w.escapeHtml=dt;w.escapeQuote=ft;w.unescapeQuote=pt;w.escapeHtmlEntities=Ct;w.escapeDangerHtml5Entities=gt;w.clearNonPrintableCharacter=mt;w.friendlyAttrValue=ht;w.escapeAttrValue=vt;w.onIgnoreTagStripAll=Hs;w.StripTagBody=qs;w.stripCommentTag=Ns;w.stripBlankChar=Rs;w.attributeWrapSign='"';w.cssFilter=ct;w.getDefaultCSSWhiteList=bs;var ee={},q=Se;function Bs(e){var t=q.spaceIndex(e),n;return t===-1?n=e.slice(1,-1):n=e.slice(1,t+1),n=q.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function Ds(e){return e.slice(0,2)==="</"}function Zs(e,t,n){var s="",r=0,i=!1,a=!1,o=0,l=e.length,f="",p="";e:for(o=0;o<l;o++){var c=e.charAt(o);if(i===!1){if(c==="<"){i=o;continue}}else if(a===!1){if(c==="<"){s+=n(e.slice(r,o)),i=o,r=o;continue}if(c===">"||o===l-1){s+=n(e.slice(r,i)),p=e.slice(i,o+1),f=Bs(p),s+=t(i,s.length,f,p,Ds(p)),r=o+1,i=!1;continue}if(c==='"'||c==="'")for(var d=1,C=e.charAt(o-d);C.trim()===""||C==="=";){if(C==="="){a=c;continue e}C=e.charAt(o-++d)}}else if(c===a){a=!1;continue}}return r<l&&(s+=n(e.substr(r))),s}var Ps=/[^a-zA-Z0-9\\_:.-]/gim;function Gs(e,t){var n=0,s=0,r=[],i=!1,a=e.length;function o(d,C){if(d=q.trim(d),d=d.replace(Ps,"").toLowerCase(),!(d.length<1)){var u=t(d,C||"");u&&r.push(u)}}for(var l=0;l<a;l++){var f=e.charAt(l),p,c;if(i===!1&&f==="="){i=e.slice(n,l),n=l+1,s=e.charAt(n)==='"'||e.charAt(n)==="'"?n:Fs(e,l+1);continue}if(i!==!1&&l===s){if(c=e.indexOf(f,l+1),c===-1)break;p=q.trim(e.slice(s+1,c)),o(i,p),i=!1,l=c,n=l+1;continue}if(/\s|\n|\t/.test(f))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(c=Us(e,l),c===-1){p=q.trim(e.slice(n,l)),o(p),i=!1,n=l+1;continue}else{l=c-1;continue}else if(c=zs(e,l-1),c===-1){p=q.trim(e.slice(n,l)),p=Ve(p),o(i,p),i=!1,n=l+1;continue}else continue}return n<e.length&&(i===!1?o(e.slice(n)):o(i,Ve(q.trim(e.slice(n))))),q.trim(r.join(" "))}function Us(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Fs(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="'"||n==='"'?t:-1}}function zs(e,t){for(;t>0;t--){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Ws(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function Ve(e){return Ws(e)?e.substr(1,e.length-2):e}ee.parseTag=Zs;ee.parseAttr=Gs;var js=Ee.FilterCSS,_=w,wt=ee,Xs=wt.parseTag,Ys=wt.parseAttr,Q=Se;function X(e){return e==null}function Qs(e){var t=Q.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=Q.trim(e.slice(t+1,-1));var n=e[e.length-1]==="/";return n&&(e=Q.trim(e.slice(0,-1))),{html:e,closing:n}}function Ks(e){var t={};for(var n in e)t[n]=e[n];return t}function Js(e){var t={};for(var n in e)Array.isArray(e[n])?t[n.toLowerCase()]=e[n].map(function(s){return s.toLowerCase()}):t[n.toLowerCase()]=e[n];return t}function yt(e){e=Ks(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=_.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=Js(e.whiteList||e.allowList):e.whiteList=_.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":_.attributeWrapSign,e.onTag=e.onTag||_.onTag,e.onTagAttr=e.onTagAttr||_.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||_.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||_.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||_.safeAttrValue,e.escapeHtml=e.escapeHtml||_.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new js(e.css))}yt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onTag,i=n.onIgnoreTag,a=n.onTagAttr,o=n.onIgnoreTagAttr,l=n.safeAttrValue,f=n.escapeHtml,p=t.attributeWrapSign,c=t.cssFilter;n.stripBlankChar&&(e=_.stripBlankChar(e)),n.allowCommentTag||(e=_.stripCommentTag(e));var d=!1;n.stripIgnoreTagBody&&(d=_.StripTagBody(n.stripIgnoreTagBody,i),i=d.onIgnoreTag);var C=Xs(e,function(u,y,h,v,m){var g={sourcePosition:u,position:y,isClosing:m,isWhite:Object.prototype.hasOwnProperty.call(s,h)},E=r(h,v,g);if(!X(E))return E;if(g.isWhite){if(g.isClosing)return"</"+h+">";var $=Qs(v),V=s[h],O=Ys($.html,function(S,M){var L=Q.indexOf(V,S)!==-1,T=a(h,S,M,L);return X(T)?L?(M=l(h,S,M,c),M?S+"="+p+M+p:S):(T=o(h,S,M,L),X(T)?void 0:T):T});return v="<"+h,O&&(v+=" "+O),$.closing&&(v+=" /"),v+=">",v}else return E=i(h,v,g),X(E)?f(v):E},f);return d&&(C=d.remove(C)),C};var en=yt;(function(e,t){var n=w,s=ee,r=en;function i(o,l){var f=new r(l);return f.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=r,function(){for(var o in n)t[o]=n[o];for(var l in s)t[l]=s[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(ye,ye.exports);var tn=ye.exports;const k=cs(tn);var sn=Array.isArray,Lt=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var n=void 0;if(sn(e))for(var s=0,r=e.length;s<r;)n=Lt(e[s++]),n&&(t&&(t+=" "),t+=n);else for(n in e)n&&e[n]&&(t&&(t+=" "),t+=n)}return t};function bt(){for(var e=arguments.length,t=0,n,s,r="";t<e;)n=arguments[t++],n&&(s=Lt(n),s&&(r&&(r+=" "),r+=s));return r}function Oe({children:e="",imageUrl:t,imageAlt:n="",aspectRatio:s="card-small",videoUrl:r}){return`
    <span
      class="${bt("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",s==="card-small"&&"su-aspect-[3/2]",s==="card-medium"&&"su-aspect-[3/2]",s==="card-large"&&"su-aspect-[3/2]",s==="card-featured"&&"su-aspect-[3/2]",s==="square"&&"su-aspect-[1/1]",s==="video"&&"su-aspect-[16/9]",s==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${r?`
  ...
  `}const nn={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function He({imageUrl:e,alt:t="",aspectRatio:n,videoUrl:s,size:r="small",title:i="",videoIconClasses:a,uniqueId:o}){if(s){const l=`
        ...
        ${s?`
          <span
            class="${bt("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",nn[r],a)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${Oe({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:n,children:l})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${Oe({imageUrl:e,imageAlt:t,aspectRatio:n})}
    </div>
  `}function rn(e,t){if(!t)return!0;const n=e.match(/(\d+-\d+-\d+)/)[0],s=t.match(/(\d+-\d+-\d+)/)[0];return n===s}function an({start:e,end:t}){if(!e&&!t)return null;const n=new Date(e),s=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const a=rn(e,t);a||(delete r.time,delete r.hour,delete r.minute);const o=new Intl.DateTimeFormat("en-US",r).format(n),l=t?new Intl.DateTimeFormat("en-US",r).format(s):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function on(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const un="light";function pe({variant:e=un}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function dn({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    >
    ...
    </svg>`}const Re="solid";function vn({variant:e=Re}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get(Re)}function ge(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const wn="light";function Be({variant:e=wn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const A={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},_n={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-font-serif su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function Mn({data:{title:e,description:t,liveUrl:n,imageUrl:s,imageAlt:r,taxonomy:i,taxonomyUrl:a,type:o,date:l,endDate:f,videoUrl:p,uniqueID:c},cardSize:d="small"}){const C=_n[d],u=new Map;return u.set("alert",on()),u.set("analysis & insights",fe()),u.set("analysis &amp; insights",fe()),u.set("analysis&nbsp;&amp;&nbsp;insights",fe()),u.set("case study",pe({variant:"light"})),u.set("case&nbsp;study",pe({variant:"light"})),u.set("casestudy",pe({variant:"light"})),u.set("event",fn()),u.set("event&nbsp;highlights",qe()),u.set("event highlights",qe()),u.set("feature",pn()),u.set("infographic",Cn()),u.set("in&nbsp;the&nbsp;news",Ce()),u.set("in the news",Ce()),u.set("inthenews",Ce()),u.set("leadership&nbsp;messages",Ne()),u.set("leadership messages",Ne()),u.set("obituary",gn()),u.set("opinion",mn()),u.set("photo",hn()),u.set("policy&nbsp;brief",Be({variant:"light"})),u.set("policy brief",Be({variant:"light"})),u.set("poll/quiz",ge()),u.set("poll / quiz",ge()),u.set("poll&nbsp;/&nbsp;quiz",ge()),u.set("profile",yn()),u.set("research",Ln()),u.set("solutions",bn()),u.set("survey",En()),u.set("timeline",Sn()),u.set("tips & takeaways",me()),u.set("tips &amp; takeaways",me()),u.set("tips&nbsp;&amp;&nbsp;takeaways",me()),u.set("university&nbsp;updates",De()),u.set("university updates",De()),u.set("announcement",ln()),u.set("news",cn()),u.set("q&amp;a",Y()),u.set("q&a",Y()),u.set("q & a",Y()),u.set("q&nbsp;&amp;&nbsp;a",Y()),u.set("video",An()),u.set("podcast",vn({variant:"light"})),u.set("book",dn({className:""})),`
    <article aria-label="${e}" class="${A.root} ${C.gap}" data-testid="horizontal-card" >
      
    ${d==="large"?`
        <div class="${A.imageWrapper} ${C.imageWrapper}">
          ${s?`
            ${He({imageUrl:s,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"card-large",size:d,uniqueId:c})}
          `:""}
        </div>
      `:""}
      ...
      ${d==="small"&&s?`
        <div class="${A.imageWrapper} ${C.imageWrapper} su-relative">
            ${He({imageUrl:s,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"large",size:d,uniqueId:c})}
        </div>
      `:""}
      ...
      <div class="${A.contentWrapper} ${C.contentGap}">
        ...
        ${d==="large"&&o?`
          <p data-testid="horizontal-card-type" class="${A.type}">
            ${u.get(o.toLowerCase())}
            <span class="${A.typeText}">${k(o)}</span>
          </p>
        `:""}
  ...
  `:h;return`
    <article aria-label="${e}" class="${x.root}" data-testid="narrow-horizontal-card">
      <div class="${x.contentWrapper}">
        ${o==="In the News"&&c?`
          <p class="${x.source}">
            ${k(c)}
          </p>
        ...
        ${o==="Announcements"&&f?`
          <p data-testid="vertical-card-taxonomy" class="${x.taxonomy}">
            ${l?`
              <a href="${l}" class="${x.taxonomyLink}">
                ${k(f)}
              </a>
            `:`
              <span>${k(f)}</span>
        ...
        <h3 class="${x.heading}">
          <a class="${x.link}" href="${n}">
            <span>${k(e)}</span>
            ${y?`
              <span class="${x.linkIcon}">
        ...
        ${t?`
          <div data-testid="narrow-horizontal-card-description" class="${x.description}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${x.authorWrapper} ${u}">
            ${C?`
              ${In({image:C,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function kn(e){const{videoId:t,className:n="",noAutoPlay:s,title:r,isVertical:i}=e;return`
        <iframe
            width="${i?315:560}"
            height="${i?560:315}"
            class="${n}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const $n='section[data-component="topic-subtopic-listing"]',Vn='[data-element="topics-list"]',Et='[data-element="topics-pagination"]',St="su-hidden",On='section[data-element="modal-wrapper"]',Hn='button[data-click="open-modal"]',qn='button[data-dismiss="modal"]',At='iframe[data-modal="iframe"]';function Nn(e){const t=e.querySelector(At),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(St),e.hidden=!1,document.body.style.overflow="hidden"}function he(e){const t=e.querySelector(At),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(St),e.hidden=!0,document.body.style.overflow="hidden"}function xt(e){const t=e.querySelectorAll(Hn),n=e.querySelectorAll(qn);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||he(s)}),s.dataset.listenerAdded="true"),Nn(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&he(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&he(s)})}async function Rn(e){const{offset:t,query:n,endpoint:s}=e,r=s+n+`&start_rank=${t}`;return await(await fetch(r).catch(o=>{throw new Error(o)})).json()}function Bn(e,t,n,s){e.querySelector(Vn).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(Et).innerHTML=n,e.querySelector(On).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),xt(e),_t(e)}async function Dn(e){var d,C,u,y,h;const{offset:t,query:n,endpoint:s,display:r,section:i}=e,a=await Rn({offset:t,query:n,endpoint:s}),o=(C=(d=a==null?void 0:a.response)==null?void 0:d.resultPacket)==null?void 0:C.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const l=[],f=[];(h=(y=(u=a==null?void 0:a.response)==null?void 0:u.resultPacket)==null?void 0:y.results)==null||h.forEach(v=>{const m=C1(),g=c1(v);g.uniqueID=m,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(g.displayConfiguration=r,l.push(`<div class="su-relative su-grow">${Tn({data:g,cardType:"narrowhorizontal"})}</div>`)):l.push(`<div class="su-relative su-grow">${Mn({data:g,cardType:"horizontal",cardSize:"large"})}</div>`),(g.type==="Video"||g.videoUrl)&&f.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const p=us({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),c=f.map(v=>`
        ...
        ${kn({videoId:v.videoId,title:v.title,noAutoPlay:v.noAutoPlay,isVertical:v.isVertical})}
        ...
        `).join("");Bn(i,l.join(""),p,c)}function _t(e){const{query:t,endpoint:n,display:s}=e.dataset,r=e.querySelector(Et);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const o=a.getAttribute("data-offset");Dn({offset:o,query:t,endpoint:n,display:s,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll($n).forEach(e=>{xt(e),_t(e)})});const Zn='section[data-component="vertical-video-stories"]',Pn='iframe[data-role="video-player"]',Gn='button[data-role="video-control"]',Mt="su-hidden",Un='button[data-click="open-modal"]',Fn='button[data-dismiss="modal"]',It='iframe[data-modal="iframe"]',zn=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function Wn(e){const t=e.querySelector(It),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Mt),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&zn(r,e)})}function ve(e){const t=e.querySelector(It),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Mt),e.hidden=!0,document.body.style.overflow=""}function jn(e){const t=e.querySelectorAll(Un),n=e.querySelectorAll(Fn);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ve(s)}),s.dataset.listenerAdded="true"),Wn(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ve(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ve(s)})}function Xn(e){const t=e.querySelector(Pn),n=e.querySelector(Gn);let s=!1;if(!t||!n)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!s?(N(t,"play"),R(n,!1)):a.isIntersecting||(N(t,"pause"),R(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(N(t,"pause"),R(n,!0),s=!0):(N(t,"play"),R(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Zn).forEach(e=>{jn(e),Xn(e)})});
