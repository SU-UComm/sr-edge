import G from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";function le(e,t,s,r=()=>{}){const a=e.slides.length;let n=t-a+1;a%s!==0&&(n+=s-a%s);const o=document.createDocumentFragment(),l=e.slides.map(u=>u.outerHTML).join("");for(let u=0;u<n;u++){const p=document.createElement("div");for(p.innerHTML=l;p.firstChild;)p.firstChild.classList.add("swiper-slide-duplicate"),o.appendChild(p.firstChild)}e.wrapperEl.appendChild(o),e.update(),r()}function q(e,t=()=>{}){var o;const{slidesPerView:s,slidesPerGroup:r}=e.params,a=e.slides.length,n=Math.ceil(s+r);a===1&&((o=document.querySelector(".component-slider-controls"))==null||o.remove()),(a-1<n||a%r!==0)&&le(e,n,r,t)}function u1(e){const t=e.slides.filter(s=>s.classList.contains("swiper-slide-duplicate")).length;if(t){let s=e.pagination.bullets.length-e.slides.length+t;for(;s>0;){const r=e.pagination.bullets.pop();r&&r.remove(),s--}}}const B=(e,t="a, button",s)=>{e.slides.forEach(r=>{if(r.classList.contains("swiper-slide-active")?(r.removeAttribute("aria-hidden"),r.removeAttribute("inert"),r.setAttribute("tabindex","-1")):(r.setAttribute("aria-hidden","true"),r.setAttribute("inert","true"),r.removeAttribute("tabindex")),t){const a=r.querySelector(t)?r.querySelector(t):null;s&&a&&a.focus()}}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(r=>{r.classList.contains("swiper-pagination-bullet-active")?r.setAttribute("aria-current","true"):r.removeAttribute("aria-current")})},ue='section[data-component="content-carousel"]';let Z;function de(e){const t=e.dataset.uniqueId;Z=new G(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{q(n)},resize:n=>{q(n)},paginationUpdate:n=>{u1(n)}}});const s=Z.slides.length,r=Z.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(s-r)>1&&(Z.on("slideChange",function(){setTimeout(()=>{B(Z,"a, button",!0)},300)}),B(Z,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ue).forEach(e=>{de(e)})});const ce='section[data-component="featured-content"]',V1="su-hidden",fe='button[data-click="open-modal"]',pe='button[data-dismiss="modal"]',I1='iframe[data-modal="iframe"]';function ge(e){const t=e.querySelector(I1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(V1),e.hidden=!1}function f1(e){const t=e.querySelector(I1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(V1),e.hidden=!0}function Ce(e){const t=e.querySelectorAll(fe),s=e.querySelectorAll(pe);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&ge(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){f1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&f1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ce).forEach(e=>{Ce(e)})});const he='section[data-component="image-gallery-modal"]',ve='button[data-click="open-gallery-modal"]',me='div[data-modal="modal"]',we='button[data-dismiss="modal"]',$1="su-hidden";let i1;const Le=(e,t)=>{var o;const s='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',r=(o=Array.from(t==null?void 0:t.querySelectorAll(s)))==null?void 0:o.filter(l=>!l.hasAttribute("disabled")&&!l.getAttribute("aria-hidden"));if(r.length===0||(e==null?void 0:e.key)!=="Tab")return;const a=r[0],n=r[r.length-1];e.shiftKey&&document.activeElement===a?(e.preventDefault(),n.focus()):!e.shiftKey&&document.activeElement===n&&(e.preventDefault(),a.focus())};function be(e){e.classList.remove($1),e.hidden=!1,document.addEventListener("keydown",t=>{e&&Le(t,e)})}function p1(e){e.classList.add($1),e.hidden=!0}function ye(e){const t=e.dataset.modalId;i1=new G(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function xe(e){const t=e.querySelector(me),s=e.querySelector(ve),r=e.querySelector(we);s&&s.addEventListener("click",function(){be(t),ye(t)}),r&&r.addEventListener("click",function(){p1(t),i1.destroy()}),document.addEventListener("keydown",function(a){a.key==="Escape"&&(p1(t),i1.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(he).forEach(e=>{xe(e)})});const Se='[data-component="interactive-photo-card"]',Ae="[data-card-inner]",Ee="[data-card-inner-content]";function Me(e){var r;const s=((e.style.transform&&parseInt((r=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:r[1])||0)+180)%360;e.style.transform=`rotateY(${s}deg)`}function _e(e){const t=e.querySelector(Ae);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>Me(t))}const ke=e=>{e.forEach(t=>{const s=t.getAttribute("aria-hidden")==="true"?"false":"true",r=t.querySelector("button");r&&(r.tabIndex=s==="true"?"-1":""),t.setAttribute("aria-hidden",s)})},Ve=e=>{const t=e.querySelectorAll(Ee);t.length&&t.forEach(s=>s.addEventListener("click",()=>ke(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Se).forEach(e=>{_e(e),Ve(e)})});const Ie='section[data-component="media-carousel"]';let D;function $e(e){const t=e.dataset.uniqueId;D=new G(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o} ${n===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{q(n),n.activeIndex===1&&n.slidePrev()},resize:n=>{q(n)},paginationUpdate:n=>{u1(n)}}});const s=D.slides.length,r=D.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(s-r)>1&&(D.on("slideChange",function(){setTimeout(()=>{B(D,"h2 a, h3 a, button",!0)},100)}),B(D,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ie).forEach(e=>{$e(e)})});const Te='section[data-component="multicolumn-listing"]',T1="su-hidden",He='button[data-click="open-modal"]',Oe='button[data-dismiss="modal"]',H1='iframe[data-modal="iframe"]';function Ze(e){const t=e.querySelector(H1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(T1),e.hidden=!1}function g1(e){const t=e.querySelector(H1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(T1),e.hidden=!0}function De(e){const t=e.querySelectorAll(He),s=e.querySelectorAll(Oe);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&Ze(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){g1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&g1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Te).forEach(e=>{De(e)})});const Ne='section[data-component="single-image-video"]',qe='iframe[data-role="video-player"]',Be='button[data-role="video-control"]',O1="su-hidden",Pe='button[data-click="open-modal"]',Re='button[data-dismiss="modal"]',Z1='iframe[data-modal="iframe"]';function Ge(e){const t=e.querySelector(Z1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(O1),e.hidden=!1}function C1(e){const t=e.querySelector(Z1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(O1),e.hidden=!0}function Ue(e){const t=e.querySelectorAll(Pe),s=e.querySelectorAll(Re);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&Ge(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){C1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&C1(r)})}function U(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function z(e,t){const s=e.querySelector('svg[data-control="play"]'),r=e.querySelector('svg[data-control="pause"]'),a=!t;e.setAttribute("aria-pressed",String(a)),s.classList.toggle("su-hidden",a),s.hidden=a,r.classList.toggle("su-hidden",!a),r.hidden=!a,e.innerHTML=`
  ...
  `}function ze(e){console.log("_videoInit");const t=e.querySelector(qe),s=e.querySelector(Be);let r=!1;if(!t||!s)return;new IntersectionObserver(n=>{n.forEach(o=>{o.isIntersecting&&!r?(U(t,"play"),z(s,!1)):o.isIntersecting||(U(t,"pause"),z(s,!0))})},{threshold:.5}).observe(t),s.addEventListener("click",()=>{s.getAttribute("aria-pressed")==="true"?(U(t,"pause"),z(s,!0),r=!0):(U(t,"play"),z(s,!1),r=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ne).forEach(e=>{Ue(e),ze(e)})});const Fe='section[data-component="stories-carousel"]',D1="su-hidden",We='button[data-click="open-modal"]',je='button[data-dismiss="modal"]',N1='iframe[data-modal="iframe"]';function Xe(e){const t=e.querySelector(N1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(D1)}function h1(e){const t=e.querySelector(N1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(D1)}function Qe(e){const t=e.querySelectorAll(We),s=e.querySelectorAll(je);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&Xe(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){h1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&h1(r)})}function Ye(e){const t=e.dataset.uniqueId;new G(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Fe).forEach(e=>{Ye(e),Qe(e)})});const Je=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,s=>{let r=Math.random()*16;return e>0?(r=(e+r)%16|0,e=Math.floor(e/16)):(r=(t+r)%16|0,t=Math.floor(t/16)),(s==="x"?r:r&3|8).toString(16)})},Ke=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),et=()=>typeof crypto<"u"?Ke():Je();function tt({title:e,listMetadata:{assetTypeCode:t,teaserPlain:s,summary:r,image:a,taxonomyContentTypeText:n,contentTopic:o,contentSubtopic:l,taxonomyContentMainTopicText:u,contentCategory:p,featuredVideo:d,taxonomyContentMainTopicLandingPageUrl:c,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:g,imageAlt:i,authorName:L,authorImage:v,author:w,isTeaser:h,storySource:C,assetHref:A},date:T,liveUrl:H}){const O=L!==void 0?L:w,E=v!==""?v:void 0,S=a;i=a&&i?i:"",!i&&!S&&(i="a close up image of an intricate stone arch");const V=d,_=s||r;let I=u;!I&&o&&(I=o instanceof Array?o[0]:o),!I&&l&&(I=l instanceof Array?l[0]:l);const K=c;let P=n?n[0]:"";return!P&&p&&(P=p instanceof Array?p[0]:p),A&&t[0]==="link"&&(H=A),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(_)?_[0]:_,liveUrl:Array.isArray(H)?H[0]:H,imageUrl:Array.isArray(S)?S[0]:S,imageAlt:Array.isArray(i)?i[0]:i,taxonomy:Array.isArray(I)?I[0]:I,taxonomyUrl:Array.isArray(K)?K[0]:K,type:Array.isArray(P)?P[0]:P,videoUrl:Array.isArray(V)?V[0]:V,date:Array.isArray(T)?T[0]:T,authorDisplayName:Array.isArray(O)?O[0]:O,authorAvatar:Array.isArray(E)?E[0]:E,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(g)?g[0]:g,isTeaser:Array.isArray(h)?h[0]:h,storySource:Array.isArray(C)?C[0]:C}}function st({offsetNum:e,pageNumber:t,index:s}){return`
        <button
            data-offset="${e}"
    ...
    `}function rt({pageNumber:e,allResults:t,resultsPerPage:s,paginationRange:r}){const a=Math.ceil(t/s),n=r,o=e-s,l=e+s,u="su-text-black-50",p=[],d=[];let c=1;for(let h=0;h<a;h++){const C=h*s+1;d.push(C)}let f=[...d],g=[...d];const i=d.indexOf(c),L=Math.floor(n*.5);if((i<L||a===n)&&(f=f.filter((h,C)=>h>c&&C<n),g=g.filter(h=>h<c)),i>=L&&a!==n)if(f=f.filter((h,C)=>h>c&&C<=i+L),f.length===L)g=g.filter((h,C)=>h<c&&C>=i-L);else{const h=f.length?n-f.length:n;g=g.filter((C,A)=>C<c&&A>i-h)}return[...g,c,...f].map(h=>({offset:h,index:d.indexOf(h)+1})).forEach(({offset:h,index:C})=>{p.push(st({offsetNum:h,pageNumber:e,index:C}))}),a>1?`<div class="su-mx-auto su-component-container">
                <div class="su-flex su-gap-9 su-items-center su-justify-center su-rs-mt-4 lg:su-rs-mt-7">
                    <button
                        type="button"
                        class="su-size-24 su-font-serif su-flex su-items-center su-justify-center dark:su-text-white ${o<1?u:""}"
                        ${o<1?"disabled":""}
                        data-offset="${o<1?1:o}"
                    ...
                    <button
                    type="button"
                        class="su-size-24 su-font-serif su-flex su-items-center su-justify-center dark:su-text-white ${l>d[d.length-1]?u:""}"
            ...
            </div>`:""}function at(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var o1={exports:{}},m={},l1={exports:{}},$={};function q1(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function nt(e,t,s){}function it(e,t,s){}var ot=/javascript\s*\:/img;function lt(e,t){return ot.test(t)?"":t}$.whiteList=q1();$.getDefaultWhiteList=q1;$.onAttr=nt;$.onIgnoreAttr=it;$.safeAttrValue=lt;var ut={indexOf:function(e,t){var s,r;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,r=e.length;s<r;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var r,a;if(Array.prototype.forEach)return e.forEach(t,s);for(r=0,a=e.length;r<a;r++)t.call(s,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},R=ut;function dt(e,t){e=R.trimRight(e),e[e.length-1]!==";"&&(e+=";");var s=e.length,r=!1,a=0,n=0,o="";function l(){if(!r){var d=R.trim(e.slice(a,n)),c=d.indexOf(":");if(c!==-1){var f=R.trim(d.slice(0,c)),g=R.trim(d.slice(c+1));if(f){var i=t(a,o.length,f,g,d);i&&(o+=i+"; ")}}}a=n+1}for(;n<s;n++){var u=e[n];if(u==="/"&&e[n+1]==="*"){var p=e.indexOf("*/",n+2);if(p===-1)break;n=p+1,a=n+1,r=!1}else u==="("?r=!0:u===")"?r=!1:u===";"?r||l():u===`
`&&l()}return R.trim(o)}var ct=dt,F=$,ft=ct;function v1(e){return e==null}function pt(e){var t={};for(var s in e)t[s]=e[s];return t}function B1(e){e=pt(e||{}),e.whiteList=e.whiteList||F.whiteList,e.onAttr=e.onAttr||F.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||F.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||F.safeAttrValue,this.options=e}B1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,r=s.whiteList,a=s.onAttr,n=s.onIgnoreAttr,o=s.safeAttrValue,l=ft(e,function(u,p,d,c,f){var g=r[d],i=!1;if(g===!0?i=g:typeof g=="function"?i=g(c):g instanceof RegExp&&(i=g.test(c)),i!==!0&&(i=!1),c=o(d,c),!!c){var L={position:p,sourcePosition:u,source:f,isWhite:i};if(i){var v=a(d,c,L);return v1(v)?d+":"+c:v}else{var v=n(d,c,L);if(!v1(v))return v}}});return l};var gt=B1;(function(e,t){var s=$,r=gt;function a(o,l){var u=new r(l);return u.process(o)}t=e.exports=a,t.FilterCSS=r;for(var n in s)t[n]=s[n];typeof window<"u"&&(window.filterCSS=e.exports)})(l1,l1.exports);var d1=l1.exports,c1={indexOf:function(e,t){var s,r;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,r=e.length;s<r;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var r,a;if(Array.prototype.forEach)return e.forEach(t,s);for(r=0,a=e.length;r<a;r++)t.call(s,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,s=t.exec(e);return s?s.index:-1}},Ct=d1.FilterCSS,ht=d1.getDefaultWhiteList,Y=c1;function P1(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var R1=new Ct;function vt(e,t,s){}function mt(e,t,s){}function wt(e,t,s){}function Lt(e,t,s){}function G1(e){return e.replace(yt,"&lt;").replace(xt,"&gt;")}function bt(e,t,s,r){if(s=X1(s),t==="href"||t==="src"){if(s=Y.trim(s),s==="#")return"#";if(!(s.substr(0,7)==="http://"||s.substr(0,8)==="https://"||s.substr(0,7)==="mailto:"||s.substr(0,4)==="tel:"||s.substr(0,11)==="data:image/"||s.substr(0,6)==="ftp://"||s.substr(0,2)==="./"||s.substr(0,3)==="../"||s[0]==="#"||s[0]==="/"))return""}else if(t==="background"){if(W.lastIndex=0,W.test(s))return""}else if(t==="style"){if(m1.lastIndex=0,m1.test(s)||(w1.lastIndex=0,w1.test(s)&&(W.lastIndex=0,W.test(s))))return"";r!==!1&&(r=r||R1,s=r.process(s))}return s=Q1(s),s}var yt=/</g,xt=/>/g,St=/"/g,At=/&quot;/g,Et=/&#([a-zA-Z0-9]*);?/gim,Mt=/&colon;?/gim,_t=/&newline;?/gim,W=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,m1=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,w1=/u\s*r\s*l\s*\(.*/gi;function U1(e){return e.replace(St,"&quot;")}function z1(e){return e.replace(At,'"')}function F1(e){return e.replace(Et,function(s,r){return r[0]==="x"||r[0]==="X"?String.fromCharCode(parseInt(r.substr(1),16)):String.fromCharCode(parseInt(r,10))})}function W1(e){return e.replace(Mt,":").replace(_t," ")}function j1(e){for(var t="",s=0,r=e.length;s<r;s++)t+=e.charCodeAt(s)<32?" ":e.charAt(s);return Y.trim(t)}function X1(e){return e=z1(e),e=F1(e),e=W1(e),e=j1(e),e}function Q1(e){return e=U1(e),e=G1(e),e}function kt(){return""}function Vt(e,t){typeof t!="function"&&(t=function(){});var s=!Array.isArray(e);function r(o){return s?!0:Y.indexOf(e,o)!==-1}var a=[],n=!1;return{onIgnoreTag:function(o,l,u){if(r(o))if(u.isClosing){var p="[/removed]",d=u.position+p.length;return a.push([n!==!1?n:u.position,d]),n=!1,p}else return n||(n=u.position),"[removed]";else return t(o,l,u)},remove:function(o){var l="",u=0;return Y.forEach(a,function(p){l+=o.slice(u,p[0]),u=p[1]}),l+=o.slice(u),l}}}function It(e){for(var t="",s=0;s<e.length;){var r=e.indexOf("<!--",s);if(r===-1){t+=e.slice(s);break}t+=e.slice(s,r);var a=e.indexOf("-->",r);if(a===-1)break;s=a+3}return t}function $t(e){var t=e.split("");return t=t.filter(function(s){var r=s.charCodeAt(0);return r===127?!1:r<=31?r===10||r===13:!0}),t.join("")}m.whiteList=P1();m.getDefaultWhiteList=P1;m.onTag=vt;m.onIgnoreTag=mt;m.onTagAttr=wt;m.onIgnoreTagAttr=Lt;m.safeAttrValue=bt;m.escapeHtml=G1;m.escapeQuote=U1;m.unescapeQuote=z1;m.escapeHtmlEntities=F1;m.escapeDangerHtml5Entities=W1;m.clearNonPrintableCharacter=j1;m.friendlyAttrValue=X1;m.escapeAttrValue=Q1;m.onIgnoreTagStripAll=kt;m.StripTagBody=Vt;m.stripCommentTag=It;m.stripBlankChar=$t;m.attributeWrapSign='"';m.cssFilter=R1;m.getDefaultCSSWhiteList=ht;var J={},k=c1;function Tt(e){var t=k.spaceIndex(e),s;return t===-1?s=e.slice(1,-1):s=e.slice(1,t+1),s=k.trim(s).toLowerCase(),s.slice(0,1)==="/"&&(s=s.slice(1)),s.slice(-1)==="/"&&(s=s.slice(0,-1)),s}function Ht(e){return e.slice(0,2)==="</"}function Ot(e,t,s){var r="",a=0,n=!1,o=!1,l=0,u=e.length,p="",d="";e:for(l=0;l<u;l++){var c=e.charAt(l);if(n===!1){if(c==="<"){n=l;continue}}else if(o===!1){if(c==="<"){r+=s(e.slice(a,l)),n=l,a=l;continue}if(c===">"||l===u-1){r+=s(e.slice(a,n)),d=e.slice(n,l+1),p=Tt(d),r+=t(n,r.length,p,d,Ht(d)),a=l+1,n=!1;continue}if(c==='"'||c==="'")for(var f=1,g=e.charAt(l-f);g.trim()===""||g==="=";){if(g==="="){o=c;continue e}g=e.charAt(l-++f)}}else if(c===o){o=!1;continue}}return a<u&&(r+=s(e.substr(a))),r}var Zt=/[^a-zA-Z0-9\\_:.-]/gim;function Dt(e,t){var s=0,r=0,a=[],n=!1,o=e.length;function l(f,g){if(f=k.trim(f),f=f.replace(Zt,"").toLowerCase(),!(f.length<1)){var i=t(f,g||"");i&&a.push(i)}}for(var u=0;u<o;u++){var p=e.charAt(u),d,c;if(n===!1&&p==="="){n=e.slice(s,u),s=u+1,r=e.charAt(s)==='"'||e.charAt(s)==="'"?s:qt(e,u+1);continue}if(n!==!1&&u===r){if(c=e.indexOf(p,u+1),c===-1)break;d=k.trim(e.slice(r+1,c)),l(n,d),n=!1,u=c,s=u+1;continue}if(/\s|\n|\t/.test(p))if(e=e.replace(/\s|\n|\t/g," "),n===!1)if(c=Nt(e,u),c===-1){d=k.trim(e.slice(s,u)),l(d),n=!1,s=u+1;continue}else{u=c-1;continue}else if(c=Bt(e,u-1),c===-1){d=k.trim(e.slice(s,u)),d=L1(d),l(n,d),n=!1,s=u+1;continue}else continue}return s<e.length&&(n===!1?l(e.slice(s)):l(n,L1(k.trim(e.slice(s))))),k.trim(a.join(" "))}function Nt(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="="?t:-1}}function qt(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="'"||s==='"'?t:-1}}function Bt(e,t){for(;t>0;t--){var s=e[t];if(s!==" ")return s==="="?t:-1}}function Pt(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function L1(e){return Pt(e)?e.substr(1,e.length-2):e}J.parseTag=Ot;J.parseAttr=Dt;var Rt=d1.FilterCSS,x=m,Y1=J,Gt=Y1.parseTag,Ut=Y1.parseAttr,Q=c1;function j(e){return e==null}function zt(e){var t=Q.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=Q.trim(e.slice(t+1,-1));var s=e[e.length-1]==="/";return s&&(e=Q.trim(e.slice(0,-1))),{html:e,closing:s}}function Ft(e){var t={};for(var s in e)t[s]=e[s];return t}function Wt(e){var t={};for(var s in e)Array.isArray(e[s])?t[s.toLowerCase()]=e[s].map(function(r){return r.toLowerCase()}):t[s.toLowerCase()]=e[s];return t}function J1(e){e=Ft(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=x.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=Wt(e.whiteList||e.allowList):e.whiteList=x.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":x.attributeWrapSign,e.onTag=e.onTag||x.onTag,e.onTagAttr=e.onTagAttr||x.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||x.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||x.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||x.safeAttrValue,e.escapeHtml=e.escapeHtml||x.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Rt(e.css))}J1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,r=s.whiteList,a=s.onTag,n=s.onIgnoreTag,o=s.onTagAttr,l=s.onIgnoreTagAttr,u=s.safeAttrValue,p=s.escapeHtml,d=t.attributeWrapSign,c=t.cssFilter;s.stripBlankChar&&(e=x.stripBlankChar(e)),s.allowCommentTag||(e=x.stripCommentTag(e));var f=!1;s.stripIgnoreTagBody&&(f=x.StripTagBody(s.stripIgnoreTagBody,n),n=f.onIgnoreTag);var g=Gt(e,function(i,L,v,w,h){var C={sourcePosition:i,position:L,isClosing:h,isWhite:Object.prototype.hasOwnProperty.call(r,v)},A=a(v,w,C);if(!j(A))return A;if(C.isWhite){if(C.isClosing)return"</"+v+">";var T=zt(w),H=r[v],O=Ut(T.html,function(E,S){var V=Q.indexOf(H,E)!==-1,_=o(v,E,S,V);return j(_)?V?(S=u(v,E,S,c),S?E+"="+d+S+d:E):(_=l(v,E,S,V),j(_)?void 0:_):_});return w="<"+v,O&&(w+=" "+O),T.closing&&(w+=" /"),w+=">",w}else return A=n(v,w,C),j(A)?p(w):A},p);return f&&(g=f.remove(g)),g};var jt=J1;(function(e,t){var s=m,r=J,a=jt;function n(l,u){var p=new a(u);return p.process(l)}t=e.exports=n,t.filterXSS=n,t.FilterXSS=a,function(){for(var l in s)t[l]=s[l];for(var u in r)t[u]=r[u]}(),typeof window<"u"&&(window.filterXSS=e.exports);function o(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}o()&&(self.filterXSS=e.exports)})(o1,o1.exports);var Xt=o1.exports;const M=at(Xt);var Qt=Array.isArray,K1=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var s=void 0;if(Qt(e))for(var r=0,a=e.length;r<a;)s=K1(e[r++]),s&&(t&&(t+=" "),t+=s);else for(s in e)s&&e[s]&&(t&&(t+=" "),t+=s)}return t};function ee(){for(var e=arguments.length,t=0,s,r,a="";t<e;)s=arguments[t++],s&&(r=K1(s),r&&(a&&(a+=" "),a+=r));return a}function b1({children:e="",imageUrl:t,imageAlt:s="",aspectRatio:r="card-small",videoUrl:a}){return`
    <span
      class="${ee("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",r==="card-small"&&"su-aspect-[3/2]",r==="card-medium"&&"su-aspect-[3/2]",r==="card-large"&&"su-aspect-[3/2]",r==="card-featured"&&"su-aspect-[3/2]",r==="square"&&"su-aspect-[1/1]",r==="video"&&"su-aspect-[16/9]",r==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${a?`
  ...
  `}const Yt={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function y1({imageUrl:e,alt:t="",aspectRatio:s,videoUrl:r,size:a="small",title:n="",videoIconClasses:o,uniqueId:l}){if(r){const u=`
        ...
        ${r?`
          <span
            class="${ee("su-absolute su-leading-none",a==="vertical-video"&&"su-z-30",Yt[a],o)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${l}"
      >
        ${b1({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:s,children:u})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${b1({imageUrl:e,imageAlt:t,aspectRatio:s})}
    </div>
  `}function Jt(e,t){if(!t)return!0;const s=e.match(/(\d+-\d+-\d+)/)[0],r=t.match(/(\d+-\d+-\d+)/)[0];return s===r}function Kt({start:e,end:t}){if(!e&&!t)return null;const s=new Date(e),r=t?new Date(t):null,a={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let n="";const o=Jt(e,t);o||(delete a.time,delete a.hour,delete a.minute);const l=new Intl.DateTimeFormat("en-US",a).format(s),u=t?new Intl.DateTimeFormat("en-US",a).format(r):"";return o?`<span data-testid="event-date" class="su-mb-0 su-text-16">${l.replace(/, /," | ")}</span>`:(n+=`${l} - ${u}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${n}</span>`)}function e5(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const s5="light";function t1({variant:e=s5}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    >
    ...
    </svg>`}const A1="solid";function c5({variant:e=A1}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get(A1)}function r1(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const f5="light";function E1({variant:e=f5}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const b={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},L5={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function b5({data:{title:e,description:t,liveUrl:s,imageUrl:r,imageAlt:a,taxonomy:n,taxonomyUrl:o,type:l,date:u,endDate:p,videoUrl:d,uniqueID:c},cardSize:f="small"}){const g=L5[f],i=new Map;return i.set("alert",e5()),i.set("analysis & insights",e1()),i.set("analysis &amp; insights",e1()),i.set("analysis&nbsp;&amp;&nbsp;insights",e1()),i.set("case study",t1({variant:"light"})),i.set("case&nbsp;study",t1({variant:"light"})),i.set("casestudy",t1({variant:"light"})),i.set("event",n5()),i.set("event&nbsp;highlights",x1()),i.set("event highlights",x1()),i.set("feature",i5()),i.set("infographic",o5()),i.set("in&nbsp;the&nbsp;news",s1()),i.set("in the news",s1()),i.set("inthenews",s1()),i.set("leadership&nbsp;messages",S1()),i.set("leadership messages",S1()),i.set("obituary",l5()),i.set("opinion",u5()),i.set("photo",d5()),i.set("policy&nbsp;brief",E1({variant:"light"})),i.set("policy brief",E1({variant:"light"})),i.set("poll/quiz",r1()),i.set("poll / quiz",r1()),i.set("poll&nbsp;/&nbsp;quiz",r1()),i.set("profile",p5()),i.set("research",g5()),i.set("solutions",C5()),i.set("survey",h5()),i.set("timeline",v5()),i.set("tips & takeaways",a1()),i.set("tips &amp; takeaways",a1()),i.set("tips&nbsp;&amp;&nbsp;takeaways",a1()),i.set("university&nbsp;updates",M1()),i.set("university updates",M1()),i.set("announcement",t5()),i.set("news",r5()),i.set("q&amp;a",X()),i.set("q&a",X()),i.set("q & a",X()),i.set("q&nbsp;&amp;&nbsp;a",X()),i.set("video",m5()),i.set("podcast",c5({variant:"light"})),i.set("book",a5({className:""})),`
    <article aria-label="${e}" class="${b.root} ${g.gap}" data-testid="horizontal-card" >
      
    ${f==="large"?`
        <div class="${b.imageWrapper} ${g.imageWrapper}">
          ${r?`
            ${y1({imageUrl:r,alt:a,videoUrl:d,mediaType:"image",aspectRatio:"card-large",size:f,uniqueId:c})}
          `:""}
        </div>
      `:""}
      ...
      ${f==="small"&&r?`
        <div class="${b.imageWrapper} ${g.imageWrapper} su-relative">
            ${y1({imageUrl:r,alt:a,videoUrl:d,mediaType:"image",aspectRatio:"large",size:f,uniqueId:c})}
        </div>
      `:""}
      ...
      <div class="${b.contentWrapper} ${g.contentGap}">
        ...
        ${f==="large"&&l?`
          <p data-testid="horizontal-card-type" class="${b.type}">
            ${i.get(l.toLowerCase())}
            <span class="${b.typeText}">${M(l)}</span>
          </p>
        `:""}
  ...
  `}function n1(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function y5({image:e,avatarSize:t="small",alt:s=""}){const r=new Map;r.set("small","su-min-w-[56px] su-w-[56px] su-h-[56px] su-p-3"),r.set("medium","su-min-w-[165px] su-w-[165px] su-h-[165px] su-p-7"),r.set("large","su-min-w-[218px] su-w-[218px] su-h-[218px] su-p-9");const a=new Map;return a.set("small","su-w-50 su-h-50 su-top-3 su-left-3"),a.set("medium","su-size-150 su-top-7 su-left-8"),a.set("large","su-size-200 su-top-9 su-left-9"),e?`
    <div
      data-test="size-${t}"
  ...
  `:v;return`
    <article aria-label="${e}" class="${y.root}" data-testid="narrow-horizontal-card">
      <div class="${y.contentWrapper}">
        ...
        ${l==="Leadership Messages"?`
          <div class="${y.authorWrapper} ${i}">
            ${g?`
              ${y5({image:g,avatarSize:"small",alt:`Photo of ${o}`})}
            `:""}
            ${w}
          </div>
        `:""}

        ${a&&l!=="Leadership Messages"&&l!=="In the News"?`
          <p class="${y.date}">
            ${n1(a)}
          </p>
        `:""}
  ...
  `}function S5(e){const{videoId:t,className:s="",noAutoPlay:r,title:a,isVertical:n}=e;return`
        <iframe
            width="${n?315:560}"
            height="${n?560:315}"
            class="${s}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const A5='section[data-component="topic-subtopic-listing"]',E5='[data-element="topics-list"]',te='[data-element="topics-pagination"]',se="su-hidden",M5='section[data-element="modal-wrapper"]',_5='button[data-click="open-modal"]',k5='button[data-dismiss="modal"]',re='iframe[data-modal="iframe"]';function V5(e){const t=e.querySelector(re),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(se),e.hidden=!1}function _1(e){const t=e.querySelector(re),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(se),e.hidden=!0}function ae(e){const t=e.querySelectorAll(_5),s=e.querySelectorAll(k5);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&V5(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){_1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&_1(r)})}async function I5(e){const{offset:t,query:s,endpoint:r}=e,a=r+s+`&start_rank=${t}`;return await(await fetch(a).catch(l=>{throw new Error(l)})).json()}function $5(e,t,s,r){document.querySelector(E5).innerHTML=t,document.querySelector(te).innerHTML=s,document.querySelector(M5).innerHTML=r,window.scrollTo({top:0,behavior:"smooth"}),ae(e),ne(e)}async function T5(e){var f,g,i,L,v;const{offset:t,query:s,endpoint:r,display:a,section:n}=e,o=await I5({offset:t,query:s,endpoint:r}),l=(g=(f=o==null?void 0:o.response)==null?void 0:f.resultPacket)==null?void 0:g.resultsSummary;if(!l){console.warn("Missing resultsSummary from API response");return}const u=[],p=[];(v=(L=(i=o==null?void 0:o.response)==null?void 0:i.resultPacket)==null?void 0:L.results)==null||v.forEach(w=>{const h=et(),C=tt(w);C.uniqueID=h,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(a)?(C.displayConfiguration=a,u.push(x5({data:C,cardType:"narrowhorizontal"}))):u.push(b5({data:C,cardType:"horizontal",cardSize:"large"})),(C.type==="Video"||C.videoUrl)&&p.push({isVertical:C.size==="vertical-video",videoId:C.videoUrl,title:`Watch ${C.title}`,noAutoPlay:!0,uniqueID:C.uniqueID,titleID:"card-modal"})});const d=rt({pageNumber:Number(t),allResults:l.totalMatching,resultsPerPage:l.numRanks,paginationRange:5,currentPage:Number(t)}),c=p.map(w=>`
        ...
        ${S5({videoId:w.videoId,title:w.title,noAutoPlay:w.noAutoPlay,isVertical:w.isVertical})}
        ...
        `).join("");$5(n,u.join(""),d,c)}function ne(e){const{query:t,endpoint:s,display:r}=e.dataset,a=e.querySelector(te);if(!a)return;a.querySelectorAll("button").forEach(o=>{o.addEventListener("click",()=>{if(o.disabled)return;const l=o.getAttribute("data-offset");T5({offset:l,query:t,endpoint:s,display:r,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(A5).forEach(e=>{ae(e),ne(e)})});const H5='section[data-component="vertical-video-panel"]',ie="su-hidden",O5='button[data-click="open-modal"]',Z5='button[data-dismiss="modal"]',oe='iframe[data-modal="iframe"]';let N;function D5(e){const t=e.querySelector(oe),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(ie),e.hidden=!1}function k1(e){const t=e.querySelector(oe),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(ie),e.hidden=!0}function N5(e){const t=e.querySelectorAll(O5),s=e.querySelectorAll(Z5);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&D5(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){k1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&k1(r)})}function q5(e){const t=e.dataset.uniqueId;N=new G(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{q(n),n.slidePrev()},resize:n=>{q(n)},paginationUpdate:n=>{u1(n)}}});const s=N.slides.length,r=N.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(s-r)>1&&(N.on("slideChange",function(){setTimeout(()=>{B(N,"h2 a, h3 a, button",!0)},100)}),B(N,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(H5).forEach(e=>{q5(e),N5(e)})});
