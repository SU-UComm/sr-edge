import B from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const je=typeof window>"u"?{}:window;function Zt(e=je){return e.document!==void 0}function D(e,t=je){if(!Zt(t))return null;const{document:n}=t,{cookie:s}=n;if(typeof s!="string")return null;const r=s.split("; ");let o=null;return r.find(a=>{const[i,l]=a.split("=");return i===e&&l!==""&&(o=l),null}),o}const Oe="su-hidden";function Ve(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')};Object.values(t).forEach(n=>{n==null||n.forEach(s=>{s.classList.add(Oe)})}),t[e]&&t[e].forEach(n=>{n.classList.remove(Oe)})}document.addEventListener("DOMContentLoaded",function(){const e=D("preferences_personalisation");Ve(e==="null"||!e?"external":e)});const Ye=typeof window>"u"?{}:window;function Gt(e=Ye){return e.document!==void 0}function xe(e,t="",n=!0,s="",r="/",o=Ye){if(!Gt(o))return;const{document:a}=o,{location:{hostname:i}}=a;let l="";if(s){const d=new Date;d.setTime(d.getTime()+s*24*60*60*1e3),l=`; expires=${d.toUTCString()}`}n===!0?a.cookie=`${e}=${t}${l}; path=${r}; domain=${i}; secure=${n};`:a.cookie=`${e}=${t}${l}; path=${r}; domain=${i};`}async function Ut(e,t){return await(await fetch("/__dxp/events/custom",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source:"custom",action:e,event:{type:t}}),redirect:"follow"}).catch(r=>{throw new Error(r)})).text()}async function ee(e){return await(await fetch("/__dxp/cdp/setConsent",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({CDPConsent:e,documentVersion:"1.0"}),redirect:"follow"}).catch(s=>{throw new Error(s)})).text()}function Ft(){const e='[id="light-theme"]',t='[id="dark-theme"]',n='[data-role="su-darkmode-icon-active"]',s='[data-role="su-darkmode-icon-nonactive"]',r=document.querySelector(e),o=document.querySelector(t),a=document.querySelector(n),i=document.querySelector(s),l=document.querySelector("html");if(r&&o){const d=D("preferences_theme");d==="dark"||["",null,void 0,!1].includes(d)&&window.matchMedia("(prefers-color-scheme: dark)").matches?(l.classList.add("su-dark"),a.classList.remove("su-hidden"),i.classList.add("su-hidden"),o.checked=!0,r.checked=!1):(a.classList.add("su-hidden"),i.classList.remove("su-hidden"),l.classList.add("su-light"),r.checked=!0,o.checked=!1),r.addEventListener("keyup",({key:f})=>{[" ","Enter"].includes(f)&&document.querySelector('[data-theme="dark-theme"]').click()}),o.addEventListener("keyup",({key:f})=>{[" ","Enter"].includes(f)&&document.querySelector('[data-theme="light-theme"]').click()}),r.addEventListener("click",()=>{l.classList.remove("su-dark"),l.classList.add("su-light"),a.classList.add("su-hidden"),i.classList.remove("su-hidden"),xe("preferences_theme","light",!0,130)}),o.addEventListener("click",()=>{l.classList.remove("su-light"),l.classList.add("su-dark"),a.classList.remove("su-hidden"),i.classList.add("su-hidden"),xe("preferences_theme","dark",!0,130)}),document.personaChangeEvent=new Event("personaChange")}}class zt{constructor(t){this.parent=t,this.menuToggle=this.parent.querySelector('[aria-controls="menu"]'),this.searchToggle=this.parent.querySelector('[aria-controls="search"]'),this.preferencesToggle=this.parent.querySelector('[aria-controls="preferences"]'),this.menuCloseToggle=this.parent.querySelectorAll(".report-header__menu-close,.report-header__menu-tray .report-header__overlay"),this.searchCloseToggle=this.parent.querySelectorAll(".report-header__search-close,.report-header__search-tray .report-header__overlay"),this.preferencesCloseToggle=this.parent.querySelectorAll(".report-header__preferences-close,.report-header__preferences-tray .report-header__overlay"),this.handleHeaderScroll(),this.handleHeaderToggles(),this.handleSearchInputs();const n=document.querySelector('[data-role="header-main-nav"]');n&&(n.classList.remove("su-opacity-0"),n.classList.add("su-opacity-1"))}focus(t){if(t.match(/:/g)){const[n,s,r]=t.split(":");document.querySelector(`[data-location="${t}"]`).querySelectorAll(s)[Number(r)].focus();return}document.querySelector(`[data-location="${t}"]`).focus()}handleTab(t){t.addEventListener("keyup",n=>{const{target:s,key:r}=n;if(r!=="Tab")return;const o=s.dataset.tpTo?s.dataset.tpTo:null;o&&this.focus(o)})}handleSearchInputs(){const t=document.querySelectorAll('[data-role="search-query"]'),n=document.querySelectorAll('[data-role="clear-search"]');t.length&&t.forEach((s,r)=>{s.addEventListener("keyup",()=>{s.value!==""?(s.parentNode.classList.add("input-has-value"),n[r].classList.remove("su-hidden")):(s.parentNode.classList.remove("input-has-value"),n[r].classList.add("su-hidden"))})}),n.length&&n.forEach(s=>{s.addEventListener("click",r=>{s.parentNode.parentNode.querySelector(".input-has-value").classList.remove("input-has-value"),s.classList.add("su-hidden")})})}handleHeaderToggles(){this.handleTab(document.querySelector(".report-header__main")),this.menuToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#menu");this.menuToggle.getAttribute("aria-expanded")==="true"?(this.menuToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--primary-nav-open"),n.setAttribute("aria-hidden","true"),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{n.classList.remove("su-hidden"),n.classList.add("su-block")},300)):(n.classList.remove("su-hidden"),window.innerWidth<768&&(document.body.style.cssText+="overflow: hidden;"),setTimeout(()=>{this.menuCloseToggle[1].focus(),this.menuToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--primary-nav-open"),n.setAttribute("aria-hidden","false")},0))}),this.menuCloseToggle.forEach(n=>{n.addEventListener("click",()=>{const s=this.parent.querySelector("#menu");this.menuToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--primary-nav-open"),s.setAttribute("aria-hidden","true"),this.menuToggle.focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden")},300)})});const t=document.querySelector('[data-role="search-focus-trap"]');this.searchToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#search");this.searchToggle.getAttribute("aria-expanded")==="true"?(this.searchToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--search-open"),n.setAttribute("aria-hidden","true"),setTimeout(()=>{n.classList.add("su-hidden"),n.classList.remove("su-block"),t.classList.add("su-hidden"),t.classList.remove("su-block")},300)):(n.classList.remove("su-hidden"),t.classList.remove("su-hidden"),setTimeout(()=>{this.searchToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--search-open"),n.setAttribute("aria-hidden","false")},0))}),this.searchCloseToggle.forEach(n=>{const s=this.parent.querySelector("#search");n.addEventListener("click",()=>{const r=this.parent.querySelector("#search");this.searchToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--search-open"),r.setAttribute("aria-hidden","true"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden"),t.classList.remove("su-block"),t.classList.add("su-hidden")},300)})}),this.preferencesToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#preferences");this.preferencesToggle.getAttribute("aria-expanded")==="true"?(this.preferencesToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--preferences-open"),n.setAttribute("aria-hidden","true"),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{n.classList.remove("su-hidden"),n.classList.add("su-block")},300)):(n.classList.remove("su-hidden"),this.preferencesCloseToggle[1].focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: hidden;"),setTimeout(()=>{this.preferencesToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--preferences-open"),n.setAttribute("aria-hidden","false")},0))}),this.preferencesCloseToggle.forEach(n=>{n.addEventListener("click",()=>{const s=this.parent.querySelector("#preferences");this.preferencesToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--preferences-open"),s.setAttribute("aria-hidden","true"),this.preferencesToggle.focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden")},300)})})}handleHeaderScroll(){window.addEventListener("scroll",t=>{const n=this.parent;if(window.scrollY>32){n.classList.add("report-header--collapsed");return}n.classList.remove("report-header--collapsed")})}}class Xe{constructor(t,n){this.url=t,this.type=n,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const s=this.assetIds.map(async r=>{const o=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(o,this.requestProps).catch(l=>{throw new Error(l)})).json()});return Promise.all(s)}return await(await fetch(this.url,this.requestProps).catch(s=>{throw new Error(s)})).json()}}function Qe(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}async function Wt(e=null,t=""){var s,r,o,a,i,l,d,f;const n=new Xe;if(e&&e.search){let u="",p="";u=`${(s=e.search.endpoint)==null?void 0:s.replace("search.html","search.json")}?profile=${e.search.profile}&collection=${e.search.collection}&query=[taxonomyContentMainTopicId:${e.mainTopicId} taxonomyContentTopicsId:${e.mainTopicId} taxonomyContentSubtopicsId:${e.mainTopicId}]&meta_taxonomyAudienceText=${Qe(t)}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&sort=date&num_ranks=1&log=false`,p=`${(r=e.search.endpoint)==null?void 0:r.replace("search.html","search.json")}?profile=${e.search.profile}&collection=${e.search.collection}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&sort=date&num_ranks=1&log=false`,e.contentType==="Video"&&(p+="&meta_taxonomyContentTypeId=28207",u+="&meta_taxonomyContentTypeId=28207"),n.url=u;let h=await n.fetch(),c=((i=(a=(o=h.response)==null?void 0:o.resultPacket)==null?void 0:a.results)==null?void 0:i[0])||null;return c||(n.url=p,h=await n.fetch(),c=((f=(d=(l=h.response)==null?void 0:l.resultPacket)==null?void 0:d.results)==null?void 0:f[0])||null),c}return null}function jt(e,t,n,s="su-hidden"){if(e&&t&&n){const r=n.querySelector('h2[data-story="announcement"]'),o=n.querySelector('h1[data-story="title"]'),a=n.querySelector('a[data-story="link"]');t!=null&&t.contentType&&r&&(r.textContent=t.contentType==="Video"?"Watch next:":"Read next:"),t!=null&&t.title&&o&&(o.textContent=t.title),e!=null&&e.displayUrl&&(e!=null&&e.title)&&a&&(a.textContent=e.title,a.href=e.displayUrl),(t!=null&&t.title||e!=null&&e.displayUrl)&&n.classList.remove(s)}}const Yt='header[data-component="header-component"]',Ke='section[data-subcomponent="header-cookie-consent-banner"]',F="su-hidden";let U=!1;function te(){const e=document.querySelector(Ke);e&&e.classList.add(F),e&&e.classList.remove("active")}function Xt(){const e=document.querySelector(Ke);e&&e.classList.remove(F),e&&e.classList.add("active")}function _e(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')},n={student:document.querySelector('button[data-click="student-persona"]'),faculty:document.querySelector('button[data-click="faculty-persona"]')};Object.values(t).forEach(s=>{s==null||s.forEach(r=>{r.classList.add(F)})}),Object.values(n).forEach(s=>{s&&s.setAttribute("aria-pressed","false")}),t[e]&&t[e].forEach(s=>{s.classList.remove(F)}),n[e]&&n[e].setAttribute("aria-pressed","true")}const ie=async(e,t,n=!1)=>{let s=null;!U&&n===!1&&(await ee(1),U=!0,te()),e&&(t===e?s="external":s=e),await Ut("persona-selector",s),n===!0&&(await ee(0),U=!1),xe("preferences_personalisation",s,!0,130),t=s,_e(t),document.dispatchEvent(document.personaChangeEvent),window.location.reload()},qe=async e=>{e===!0?(await ee(1),U=!0,te()):(await ee(0),U=!1,te())};document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector('button[data-click="student-persona"]'),t=document.querySelector('button[data-click="faculty-persona"]'),n=typeof window.pageController<"u"?window.pageController:null,s=document.querySelectorAll('a[data-menu="main-nav"]'),r=document.querySelector('[data-current-story="headline"]'),o=document.querySelector(Yt);o&&new zt(o);let a=null;const i=JSON.parse(D("squiz.cdp.consent")),l=i==null?void 0:i.CDPConsent,d=document.querySelector('button[data-click="clear-preferences"]'),f={};f.pageData=n,f.consentData=i==null?void 0:i.CDPConsent,f.audienceData=D("preferences_personalisation"),(f.audienceData==="null"||!f.audienceData)&&(f.audienceData="external"),window.suHeaderProps=f,Ft(),n&&s&&s.forEach(c=>{(n==null?void 0:n.id)===c.dataset.id&&(c.classList.remove("su-border-transparent"),c.classList.add("!su-text-digital-red su-border-digital-red dark:su-border-dark-mode-red dark:!su-text-dark-mode-red"))}),n!=null&&n.isStory&&(o.classList.add("report-header--story"),(async()=>(a=await Wt(f.pageData,f.audienceData),jt(a,n,r,F)))()),l||Xt(),l&&(te(),d&&(d.removeAttribute("disabled"),d.setAttribute("aria-pressed","false"),d.classList.add("su-text-digital-blue"),d.classList.add("dark:su-text-digital-blue-vivid"),d.addEventListener("click",async function(){await ie(null,null,!0)})));const u=document.querySelector('button[data-click="accept-consent"]'),p=document.querySelector('button[data-click="reject-consent"]');u&&u.addEventListener("click",function(){qe(!0)}),p&&p.addEventListener("click",function(){qe(!1)});const h=D("preferences_personalisation");_e(h==="null"||!h?"external":h),e&&e.addEventListener("click",function(){ie("student",h)}),t&&t.addEventListener("click",function(){ie("faculty",h)})});function Je(e){if(!e)return 0;const t=225,n=e.trim().split(/\s+/).length;return Math.ceil(n/t)}function Qt(e,t,n,s=()=>{}){const r=e.slides.length;let o=t-r+1;r%n!==0&&(o+=n-r%n);const a=document.createDocumentFragment(),i=e.slides.map(l=>l.outerHTML).join("");for(let l=0;l<o;l++){const d=document.createElement("div");for(d.innerHTML=i;d.firstChild;)d.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(d.firstChild)}e.wrapperEl.appendChild(a),e.update(),b(e,"",!1),s()}function N(e,t=()=>{}){const{slidesPerView:n,slidesPerGroup:s}=e.params,r=e.slides.length,o=Math.ceil(n+s);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<o||r%s!==0?Qt(e,o,s,t):(b(e,"",!1),t())}function re(e){const t=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(t){let n=e.pagination.bullets.length-e.slides.length+t;for(;n>0;){const s=e.pagination.bullets.pop();s&&s.remove(),n--}}}const b=(e,t,n)=>{e.slides.forEach(s=>{if(s.classList.contains("swiper-slide-active")){if(s.removeAttribute("aria-hidden"),s.removeAttribute("inert"),s.setAttribute("tabindex","-1"),t&&n){let r=null;t==="slide"?r=s:r=s.querySelector(t),r&&r.focus()}}else s.setAttribute("aria-hidden","true"),s.setAttribute("inert","true"),s.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(s=>{s.classList.contains("swiper-pagination-bullet-active")?s.setAttribute("aria-current","true"):s.removeAttribute("aria-current")})},Kt='section[data-component="basic-story-hero"]',Jt='span[data-reading="true"]',et="su-hidden",e1='button[data-click="open-modal"]',t1='button[data-dismiss="modal"]',tt='iframe[data-modal="iframe"]';function s1(e){const t=e.querySelector(tt);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(et),e.hidden=!1,document.body.style.overflow="hidden"}function le(e){const t=e.querySelector(tt);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(et),e.hidden=!0,document.body.style.overflow=""}function n1(e){const t=e.querySelectorAll(e1),n=e.querySelectorAll(t1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||le(s)}),s.dataset.listenerAdded="true"),s1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&le(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&le(s)})}function r1(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const o=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),o.on("slideChange",function(){setTimeout(()=>{r?b(o,"slide",!0):b(o,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}function a1(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(Jt);if(t&&n){const s=Je(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Kt).forEach(e=>{r1(e),n1(e),a1(e)})});const o1='section[data-component="combined-content-grid"]',st="su-hidden",i1='button[data-click="open-modal"]',l1='button[data-dismiss="modal"]',nt='iframe[data-modal="iframe"]';function c1(e){const t=e.querySelector(nt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(st),e.hidden=!1,document.body.style.overflow="hidden"}function ce(e){const t=e.querySelector(nt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(st),e.hidden=!0,document.body.style.overflow=""}function d1(e){const t=e.querySelectorAll(i1),n=e.querySelectorAll(l1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||ce(s)}),s.dataset.listenerAdded="true"),c1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ce(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(o1).forEach(e=>{d1(e)})});const u1='section[data-component="content-carousel"]';function f1(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const o=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),o.on("slideChange",function(){setTimeout(()=>{r?b(o,"slide",!0):b(o,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(u1).forEach(e=>{f1(e)})});const p1='section[data-component="feature-story-hero"]',h1='span[data-reading="true"]';function m1(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(h1);if(t&&n){const s=Je(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(p1).forEach(e=>{m1(e)})});const C1='section[data-component="featured-content"]',rt="su-hidden",g1='button[data-click="open-modal"]',v1='button[data-dismiss="modal"]',at='iframe[data-modal="iframe"]';function y1(e){const t=e.querySelector(at),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(rt),e.hidden=!1,document.body.style.overflow="hidden"}function de(e){const t=e.querySelector(at),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(rt),e.hidden=!0,document.body.style.overflow=""}function w1(e){const t=e.querySelectorAll(g1),n=e.querySelectorAll(v1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||de(s)}),s.dataset.listenerAdded="true"),y1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&de(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&de(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(C1).forEach(e=>{w1(e)})});const L1='section[data-component="horizontal-video-testimonials"]',ot="su-hidden",E1='button[data-click="open-modal"]',b1='button[data-dismiss="modal"]',it='iframe[data-modal="iframe"]';function S1(e){const t=e.querySelector(it);if(t){const n=t.getAttribute("src"),s=n&&n.replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(ot),e.hidden=!1,document.body.style.overflow="hidden"}function ue(e){const t=e.querySelector(it);if(t){const n=t.getAttribute("src"),s=n&&n.replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(ot),e.hidden=!0,document.body.style.overflow=""}function A1(e){const t=e.querySelectorAll(E1),n=e.querySelectorAll(b1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||ue(s)}),s.dataset.listenerAdded="true"),S1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ue(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ue(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(L1).forEach(e=>{A1(e)})});const x1='section[data-component="image-gallery-modal"]',_1='button[data-click="open-gallery-modal"]',T1='div[data-modal="modal"]',I1='button[data-dismiss="modal"]',lt="su-hidden";let Te;const k1=(e,t)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(i=>!i.hasAttribute("disabled")&&!i.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],o=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),o.focus()):!e.shiftKey&&document.activeElement===o&&(e.preventDefault(),r.focus())};function M1(e){e.classList.remove(lt),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&k1(t,e)})}function fe(e){e.classList.add(lt),e.hidden=!0,document.body.style.overflow=""}function $1(e){const t=e.dataset.modalId;Te=new B(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function O1(e){const t=e.querySelector(T1),n=e.querySelector(_1),s=e.querySelector(I1);n&&n.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",o=>{r.contains(o.target)||fe(t)}),t.dataset.listenerAdded="true"),M1(t),$1(t)}),s&&s.addEventListener("click",function(){fe(t),Te.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(fe(t),Te.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(x1).forEach(e=>{O1(e)})});const V1='[data-component="interactive-photo-card"]',q1="[data-card-inner]",H1="[data-card-inner-content]";function N1(e){var s;const n=((e.style.transform&&parseInt((s=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:s[1])||0)+180)%360;e.style.transform=`rotateY(${n}deg)`}function R1(e){const t=e.querySelector(q1);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>N1(t))}const D1=e=>{e.forEach(t=>{const n=t.getAttribute("aria-hidden")==="true"?"false":"true",s=t.querySelector("button");s&&(s.tabIndex=n==="true"?"-1":""),t.setAttribute("aria-hidden",n)})},B1=e=>{const t=e.querySelectorAll(H1);t.length&&t.forEach(n=>n.addEventListener("click",()=>D1(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(V1).forEach(e=>{R1(e),B1(e)})});function P1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:n,summary:s,image:r,taxonomyContentTypeText:o,contentTopic:a,contentSubtopic:i,taxonomyContentMainTopicText:l,contentCategory:d,featuredVideo:f,taxonomyContentMainTopicLandingPageUrl:u,taxonomyFeaturedUnitLandingPageUrl:p,taxonomyFeaturedUnitText:h,imageAlt:c,authorName:w,authorImage:g,author:v,isTeaser:C,storySource:m,assetHref:S},date:$,liveUrl:O}){const V=w!==void 0?w:v,A=g!==""?g:void 0,I=r&&r!==""?r:null,L=c&&c!==""?c:"",k=f,P=n||s;let q=l;!q&&a&&(q=a instanceof Array?a[0]:a),!q&&i&&(q=i instanceof Array?i[0]:i);const oe=u;let Z=o?o[0]:"";return!Z&&d&&(Z=d instanceof Array?d[0]:d),S&&t[0]==="link"&&(O=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(P)?P[0]:P,liveUrl:Array.isArray(O)?O[0]:O,imageUrl:Array.isArray(I)?I[0]:I,imageAlt:Array.isArray(L)?L[0]:L,taxonomy:Array.isArray(q)?q[0]:q,taxonomyUrl:Array.isArray(oe)?oe[0]:oe,type:Array.isArray(Z)?Z[0]:Z,videoUrl:Array.isArray(k)?k[0]:k,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(V)?V[0]:V,authorAvatar:Array.isArray(A)?A[0]:A,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(p)?p[0]:p,taxonomyFeaturedUnitText:Array.isArray(h)?h[0]:h,isTeaser:Array.isArray(C)?C[0]:C,storySource:Array.isArray(m)?m[0]:m}}function pe(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function ct(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}const Z1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(t+s)%16|0,t=Math.floor(t/16)),(n==="x"?s:s&3|8).toString(16)})},G1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),U1=()=>typeof crypto<"u"?G1():Z1();async function F1(e=null,t="",n=null){var r,o,a,i,l,d,f,u,p,h,c,w,g,v,C,m,S,$,O;const s=new Xe;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const V=`
            ...
            &meta_taxonomyAudienceText=${Qe(t)}&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;let A=V;n&&(n!=null&&n.behavioural)&&(A=`${(f=(d=e==null?void 0:e.search)==null?void 0:d.endpoint)==null?void 0:f.replace(/\.html/g,".json")}
    ...
    `}function Y1(e,t,n){if(!e.length){t.classList.add(E.NO_STORIES);return}const[s,r,o]=e;n.innerHTML=`
    ...
    `,t.classList.remove(E.NO_STORIES)}async function X1(e,t,n,s,r,o){const i=(await F1(e,o,t)).map(({title:l,indexUrl:d})=>j1(l,d));Y1(i,n,r),Q1(n,s,r)}function Q1(e,t,n){t.addEventListener("click",function(){z1(t,n)}),window.addEventListener("scroll",function(){W1(e)})}function K1(e,t,n,s){if(!e||!window.pageController)return;const r=window.pageController,o=r.topicsQuery?r.topicsQuery():null;X1(r,o,e,t,n,s)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(he.WRAPPER),t=document.querySelector(he.TOGGLE),n=document.querySelector(he.DRAWER),s=D("preferences_personalisation");K1(e,t,n,s)});const J1='section[data-component="media-carousel"]';function es(e){const t=e.dataset.uniqueId,n=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}}),s=n.slides.length,r=n.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(s-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),n.on("slideChange",function(){setTimeout(()=>{a?b(n,"h2 a, h3 a, button",!0):b(n,"",!1)},100)})}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(J1).forEach(e=>{es(e)})});const ts='button[data-role="copy-link"]';function ss(e){e.addEventListener("click",function(){navigator.clipboard.writeText(window.location.href).then(()=>{const t=document.querySelector("[data-copy-text]");t.textContent="Copied",setTimeout(()=>{t.textContent="Copy link"},3e3)})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ts).forEach(e=>{ss(e)})});const ns='section[data-component="multicolumn-listing"]',dt="su-hidden",rs='button[data-click="open-modal"]',as='button[data-dismiss="modal"]',ut='iframe[data-modal="iframe"]';function os(e){const t=e.querySelector(ut),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(dt),e.hidden=!1,document.body.style.overflow="hidden"}function me(e){const t=e.querySelector(ut),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(dt),e.hidden=!0,document.body.style.overflow=""}function is(e){const t=e.querySelectorAll(rs),n=e.querySelectorAll(as);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||me(s)}),s.dataset.listenerAdded="true"),os(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&me(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&me(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ns).forEach(e=>{is(e)})});const ls='section[data-component="sidebar-navigation"]',cs='nav[data-nav="nav"]',se="su-hidden",ds='button[data-click="toggle-nav"]',us="su-bg-digital-red su-text-white dark:su-bg-dark-mode-red dark:aria-expanded:su-text-black-true",fs='span[data-label="button"]';function ft(e,t){const n=e.querySelector(fs),s=e.querySelector('svg[data-icon="bars"]'),r=e.querySelector('svg[data-icon="xmark"]');e.setAttribute("aria-expanded",t.toString()),us.split(" ").forEach(o=>{e.classList.toggle(o,t)}),s&&(s.classList.toggle(`!${se}`,t),s.hidden=t),r&&(r.classList.toggle(`!${se}`,!t),r.hidden=!t),n&&(n.innerHTML=t?n.getAttribute("data-label-close"):n.getAttribute("data-label-open"))}function He(e,t){e.classList.remove(se),e.hidden=!1,ft(t,!0)}function z(e,t){e.classList.add(se),e.hidden=!0,ft(t,!1)}function ps(e){const t=e.querySelector(ds),n=e.querySelector(cs);let s;t&&t.addEventListener("click",function(){const r=t.getAttribute("aria-expanded")==="true";n.dataset.listenerAdded||(document.addEventListener("click",o=>{const a=n.contains(o.target),i=t.contains(o.target);!a&&!i&&z(n,t)}),n.dataset.listenerAdded="true"),r?z(n,t):He(n,t)}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&t&&z(n,t)}),window.addEventListener("resize",()=>{clearTimeout(s),s=setTimeout(()=>{window.innerWidth>991?n&&t&&He(n,t):n&&t&&z(n,t)},10)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ls).forEach(e=>{ps(e)})});function W(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function j(e,t){const n=e.querySelector('svg[data-control="play"]'),s=e.querySelector('svg[data-control="pause"]'),r=!t;e.setAttribute("aria-pressed",String(r)),n.classList.toggle("su-hidden",r),n.hidden=r,s.classList.toggle("su-hidden",!r),s.hidden=!r,e.innerHTML=`
  ...
  `}const hs='section[data-component="single-image-video"]',ms='iframe[data-role="video-player"]',Cs='button[data-role="video-control"]',pt="su-hidden",gs='button[data-click="open-modal"]',vs='button[data-dismiss="modal"]',ht='iframe[data-modal="iframe"]',ys=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(i=>!i.hasAttribute("disabled")&&!i.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],o=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),o.focus()):!e.shiftKey&&document.activeElement===o&&(e.preventDefault(),r.focus())};function ws(e){const t=e.querySelector(ht),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(pt),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&ys(r,e)})}function Ce(e){const t=e.querySelector(ht),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(pt),e.hidden=!0,document.body.style.overflow=""}function Ls(e){const t=e.querySelectorAll(gs),n=e.querySelectorAll(vs);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||Ce(s)}),s.dataset.listenerAdded="true"),ws(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&Ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&Ce(s)})}function Es(e){const t=e.querySelector(ms),n=e.querySelector(Cs);let s=!1;if(!t||!n)return;new IntersectionObserver(o=>{o.forEach(a=>{a.isIntersecting&&!s?(W(t,"play"),j(n,!1)):a.isIntersecting||(W(t,"pause"),j(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(W(t,"pause"),j(n,!0),s=!0):(W(t,"play"),j(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(hs).forEach(e=>{Ls(e),Es(e)})});const bs='section[data-component="standalone-visual-hero"]',mt="su-hidden",Ss='button[data-click="open-modal"]',As='button[data-dismiss="modal"]',Ct='iframe[data-modal="iframe"]';function xs(e){const t=e.querySelector(Ct);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(mt),e.hidden=!1,document.body.style.overflow="hidden"}function ge(e){const t=e.querySelector(Ct);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(mt),e.hidden=!0,document.body.style.overflow=""}function _s(e){const t=e.querySelectorAll(Ss),n=e.querySelectorAll(As);let s=null;t.forEach(r=>{r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||ge(s)}),s.dataset.listenerAdded="true"),xs(s)})}),n.forEach(r=>{r.addEventListener("click",function(){s&&ge(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ge(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(bs).forEach(e=>{_s(e)})});const Ts='section[data-component="stories-carousel"]',gt="su-hidden",Is='button[data-click="open-modal"]',ks='button[data-dismiss="modal"]',vt='iframe[data-modal="iframe"]';function Ms(e){const t=e.querySelector(vt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(gt),e.hidden=!1,document.body.style.overflow="hidden"}function ve(e){const t=e.querySelector(vt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(gt),e.hidden=!0,document.body.style.overflow=""}function $s(e){const t=e.querySelectorAll(Is),n=e.querySelectorAll(ks);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||ve(s)}),s.dataset.listenerAdded="true"),Ms(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ve(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ve(s)})}function Os(e){const t=e.dataset.uniqueId;new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ts).forEach(e=>{Os(e),$s(e)})});const Vs='section[data-component="subscribe-to-stanford-report"]';function qs(e){const t=e.querySelector("form"),n=t.querySelector('input[type="email"]'),s=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let o="";const a=n.value;if(!a||!a.match(/\w+@\w+\.\w+/)){o='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',s.innerHTML=o,n.setAttribute("aria-describedby","subscription-error");return}s.innerHTML="",n.removeAttribute("aria-describedby"),r.target.submit()}),n.addEventListener("keyup",function(){const r=n.value,o=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(o.innerHTML="",n.removeAttribute("aria-describedby"))})}function Hs(){document.querySelectorAll(Vs).forEach(e=>{qs(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",Hs);const Ns='section[data-component="subtopic-subnav-component"]',Rs='div[data-list="subnav"]';function Ds(e){return e.filter((t,n)=>n===e.findIndex(s=>{var r,o;return((r=s.taxonomyFeaturedUnitText)==null?void 0:r[0])===((o=t.taxonomyFeaturedUnitText)==null?void 0:o[0])}))}const Bs=async e=>{if(!e||e.length===0)return null;const t=Ds(e),n=[];return t.forEach(s=>{var o,a,i;const r=s;r&&((o=r.taxonomyFeaturedUnitText)!=null&&o[0])&&n.push({asset_name:(a=r.taxonomyFeaturedUnitText)==null?void 0:a[0],asset_url:((i=r.taxonomyFeaturedUnitLandingPageUrl)==null?void 0:i[0])||""})}),n};function Ps({navigation:e}){let t="scrollable-list__item su-mb-0 su-relative after:su-h-22 after:su-w-[1px] after:su-bg-black-60 after:su-mx-12 lg:after:su-mx-18";const n="su-text-inherit su-text-black su-font-semi-bold su-text-16 lg:su-text-18 lg:su-leading-[21.6px] su-no-underline hover:su-underline dark:su-text-white hover:su-text-digital-red dark:hover:su-text-dark-mode-red";return`
    ...
    `}function Zs(e){const t=e.querySelector(Rs);t&&document.addEventListener("topicLoader",async n=>{if(n.detail){const s=await Bs(n.detail.cards);t.innerHTML=Ps({navigation:s})}},!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ns).forEach(e=>{Zs(e)})});function Gs({offsetNum:e,pageNumber:t,index:n}){return`
        <button
            data-offset="${e}"
    ...
    `}function Us({pageNumber:e,allResults:t,resultsPerPage:n,paginationRange:s,currentPage:r=1}){const o=Math.ceil(t/n),a=s,i=e-n,l=e+n,d="su-text-black-50",f=[],u=[];for(let C=0;C<o;C++){const m=C*n+1;u.push(m)}let p=[...u],h=[...u];const c=u.indexOf(r),w=Math.floor(a*.5);if((c<w||o===a)&&(p=p.filter((C,m)=>C>r&&m<a),h=h.filter(C=>C<r)),c>=w&&o!==a)if(p=p.filter((C,m)=>C>r&&m<=c+w),p.length===w)h=h.filter((C,m)=>C<r&&m>=c-w);else{const C=p.length?a-p.length:a;h=h.filter((m,S)=>m<r&&S>c-C)}return[...h,r,...p].map(C=>({offset:C,index:u.indexOf(C)+1})).forEach(({offset:C,index:m})=>{f.push(Gs({offsetNum:C,pageNumber:e,index:m}))}),o>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function Fs(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ie={exports:{}},y={},ke={exports:{}},R={};function yt(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function zs(e,t,n){}function Ws(e,t,n){}var js=/javascript\s*\:/img;function Ys(e,t){return js.test(t)?"":t}R.whiteList=yt();R.getDefaultWhiteList=yt;R.onAttr=zs;R.onIgnoreAttr=Ws;R.safeAttrValue=Ys;var Xs={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},G=Xs;function Qs(e,t){e=G.trimRight(e),e[e.length-1]!==";"&&(e+=";");var n=e.length,s=!1,r=0,o=0,a="";function i(){if(!s){var f=G.trim(e.slice(r,o)),u=f.indexOf(":");if(u!==-1){var p=G.trim(f.slice(0,u)),h=G.trim(f.slice(u+1));if(p){var c=t(r,a.length,p,h,f);c&&(a+=c+"; ")}}}r=o+1}for(;o<n;o++){var l=e[o];if(l==="/"&&e[o+1]==="*"){var d=e.indexOf("*/",o+2);if(d===-1)break;o=d+1,r=o+1,s=!1}else l==="("?s=!0:l===")"?s=!1:l===";"?s||i():l===`
`&&i()}return G.trim(a)}var Ks=Qs,Y=R,Js=Ks;function Ne(e){return e==null}function en(e){var t={};for(var n in e)t[n]=e[n];return t}function wt(e){e=en(e||{}),e.whiteList=e.whiteList||Y.whiteList,e.onAttr=e.onAttr||Y.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||Y.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||Y.safeAttrValue,this.options=e}wt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onAttr,o=n.onIgnoreAttr,a=n.safeAttrValue,i=Js(e,function(l,d,f,u,p){var h=s[f],c=!1;if(h===!0?c=h:typeof h=="function"?c=h(u):h instanceof RegExp&&(c=h.test(u)),c!==!0&&(c=!1),u=a(f,u),!!u){var w={position:d,sourcePosition:l,source:p,isWhite:c};if(c){var g=r(f,u,w);return Ne(g)?f+":"+u:g}else{var g=o(f,u,w);if(!Ne(g))return g}}});return i};var tn=wt;(function(e,t){var n=R,s=tn;function r(a,i){var l=new s(i);return l.process(a)}t=e.exports=r,t.FilterCSS=s;for(var o in n)t[o]=n[o];typeof window<"u"&&(window.filterCSS=e.exports)})(ke,ke.exports);var Me=ke.exports,$e={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,n=t.exec(e);return n?n.index:-1}},sn=Me.FilterCSS,nn=Me.getDefaultWhiteList,ne=$e;function Lt(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var Et=new sn;function rn(e,t,n){}function an(e,t,n){}function on(e,t,n){}function ln(e,t,n){}function bt(e){return e.replace(dn,"&lt;").replace(un,"&gt;")}function cn(e,t,n,s){if(n=It(n),t==="href"||t==="src"){if(n=ne.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(t==="background"){if(X.lastIndex=0,X.test(n))return""}else if(t==="style"){if(Re.lastIndex=0,Re.test(n)||(De.lastIndex=0,De.test(n)&&(X.lastIndex=0,X.test(n))))return"";s!==!1&&(s=s||Et,n=s.process(n))}return n=kt(n),n}var dn=/</g,un=/>/g,fn=/"/g,pn=/&quot;/g,hn=/&#([a-zA-Z0-9]*);?/gim,mn=/&colon;?/gim,Cn=/&newline;?/gim,X=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,Re=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,De=/u\s*r\s*l\s*\(.*/gi;function St(e){return e.replace(fn,"&quot;")}function At(e){return e.replace(pn,'"')}function xt(e){return e.replace(hn,function(n,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function _t(e){return e.replace(mn,":").replace(Cn," ")}function Tt(e){for(var t="",n=0,s=e.length;n<s;n++)t+=e.charCodeAt(n)<32?" ":e.charAt(n);return ne.trim(t)}function It(e){return e=At(e),e=xt(e),e=_t(e),e=Tt(e),e}function kt(e){return e=St(e),e=bt(e),e}function gn(){return""}function vn(e,t){typeof t!="function"&&(t=function(){});var n=!Array.isArray(e);function s(a){return n?!0:ne.indexOf(e,a)!==-1}var r=[],o=!1;return{onIgnoreTag:function(a,i,l){if(s(a))if(l.isClosing){var d="[/removed]",f=l.position+d.length;return r.push([o!==!1?o:l.position,f]),o=!1,d}else return o||(o=l.position),"[removed]";else return t(a,i,l)},remove:function(a){var i="",l=0;return ne.forEach(r,function(d){i+=a.slice(l,d[0]),l=d[1]}),i+=a.slice(l),i}}}function yn(e){for(var t="",n=0;n<e.length;){var s=e.indexOf("<!--",n);if(s===-1){t+=e.slice(n);break}t+=e.slice(n,s);var r=e.indexOf("-->",s);if(r===-1)break;n=r+3}return t}function wn(e){var t=e.split("");return t=t.filter(function(n){var s=n.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),t.join("")}y.whiteList=Lt();y.getDefaultWhiteList=Lt;y.onTag=rn;y.onIgnoreTag=an;y.onTagAttr=on;y.onIgnoreTagAttr=ln;y.safeAttrValue=cn;y.escapeHtml=bt;y.escapeQuote=St;y.unescapeQuote=At;y.escapeHtmlEntities=xt;y.escapeDangerHtml5Entities=_t;y.clearNonPrintableCharacter=Tt;y.friendlyAttrValue=It;y.escapeAttrValue=kt;y.onIgnoreTagStripAll=gn;y.StripTagBody=vn;y.stripCommentTag=yn;y.stripBlankChar=wn;y.attributeWrapSign='"';y.cssFilter=Et;y.getDefaultCSSWhiteList=nn;var ae={},H=$e;function Ln(e){var t=H.spaceIndex(e),n;return t===-1?n=e.slice(1,-1):n=e.slice(1,t+1),n=H.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function En(e){return e.slice(0,2)==="</"}function bn(e,t,n){var s="",r=0,o=!1,a=!1,i=0,l=e.length,d="",f="";e:for(i=0;i<l;i++){var u=e.charAt(i);if(o===!1){if(u==="<"){o=i;continue}}else if(a===!1){if(u==="<"){s+=n(e.slice(r,i)),o=i,r=i;continue}if(u===">"||i===l-1){s+=n(e.slice(r,o)),f=e.slice(o,i+1),d=Ln(f),s+=t(o,s.length,d,f,En(f)),r=i+1,o=!1;continue}if(u==='"'||u==="'")for(var p=1,h=e.charAt(i-p);h.trim()===""||h==="=";){if(h==="="){a=u;continue e}h=e.charAt(i-++p)}}else if(u===a){a=!1;continue}}return r<l&&(s+=n(e.substr(r))),s}var Sn=/[^a-zA-Z0-9\\_:.-]/gim;function An(e,t){var n=0,s=0,r=[],o=!1,a=e.length;function i(p,h){if(p=H.trim(p),p=p.replace(Sn,"").toLowerCase(),!(p.length<1)){var c=t(p,h||"");c&&r.push(c)}}for(var l=0;l<a;l++){var d=e.charAt(l),f,u;if(o===!1&&d==="="){o=e.slice(n,l),n=l+1,s=e.charAt(n)==='"'||e.charAt(n)==="'"?n:_n(e,l+1);continue}if(o!==!1&&l===s){if(u=e.indexOf(d,l+1),u===-1)break;f=H.trim(e.slice(s+1,u)),i(o,f),o=!1,l=u,n=l+1;continue}if(/\s|\n|\t/.test(d))if(e=e.replace(/\s|\n|\t/g," "),o===!1)if(u=xn(e,l),u===-1){f=H.trim(e.slice(n,l)),i(f),o=!1,n=l+1;continue}else{l=u-1;continue}else if(u=Tn(e,l-1),u===-1){f=H.trim(e.slice(n,l)),f=Be(f),i(o,f),o=!1,n=l+1;continue}else continue}return n<e.length&&(o===!1?i(e.slice(n)):i(o,Be(H.trim(e.slice(n))))),H.trim(r.join(" "))}function xn(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="="?t:-1}}function _n(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="'"||n==='"'?t:-1}}function Tn(e,t){for(;t>0;t--){var n=e[t];if(n!==" ")return n==="="?t:-1}}function In(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function Be(e){return In(e)?e.substr(1,e.length-2):e}ae.parseTag=bn;ae.parseAttr=An;var kn=Me.FilterCSS,T=y,Mt=ae,Mn=Mt.parseTag,$n=Mt.parseAttr,J=$e;function Q(e){return e==null}function On(e){var t=J.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=J.trim(e.slice(t+1,-1));var n=e[e.length-1]==="/";return n&&(e=J.trim(e.slice(0,-1))),{html:e,closing:n}}function Vn(e){var t={};for(var n in e)t[n]=e[n];return t}function qn(e){var t={};for(var n in e)Array.isArray(e[n])?t[n.toLowerCase()]=e[n].map(function(s){return s.toLowerCase()}):t[n.toLowerCase()]=e[n];return t}function $t(e){e=Vn(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=T.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=qn(e.whiteList||e.allowList):e.whiteList=T.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":T.attributeWrapSign,e.onTag=e.onTag||T.onTag,e.onTagAttr=e.onTagAttr||T.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||T.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||T.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||T.safeAttrValue,e.escapeHtml=e.escapeHtml||T.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new kn(e.css))}$t.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onTag,o=n.onIgnoreTag,a=n.onTagAttr,i=n.onIgnoreTagAttr,l=n.safeAttrValue,d=n.escapeHtml,f=t.attributeWrapSign,u=t.cssFilter;n.stripBlankChar&&(e=T.stripBlankChar(e)),n.allowCommentTag||(e=T.stripCommentTag(e));var p=!1;n.stripIgnoreTagBody&&(p=T.StripTagBody(n.stripIgnoreTagBody,o),o=p.onIgnoreTag);var h=Mn(e,function(c,w,g,v,C){var m={sourcePosition:c,position:w,isClosing:C,isWhite:Object.prototype.hasOwnProperty.call(s,g)},S=r(g,v,m);if(!Q(S))return S;if(m.isWhite){if(m.isClosing)return"</"+g+">";var $=On(v),O=s[g],V=$n($.html,function(A,I){var L=J.indexOf(O,A)!==-1,k=a(g,A,I,L);return Q(k)?L?(I=l(g,A,I,u),I?A+"="+f+I+f:A):(k=i(g,A,I,L),Q(k)?void 0:k):k});return v="<"+g,V&&(v+=" "+V),$.closing&&(v+=" /"),v+=">",v}else return S=o(g,v,m),Q(S)?d(v):S},d);return p&&(h=p.remove(h)),h};var Hn=$t;(function(e,t){var n=y,s=ae,r=Hn;function o(i,l){var d=new r(l);return d.process(i)}t=e.exports=o,t.filterXSS=o,t.FilterXSS=r,function(){for(var i in n)t[i]=n[i];for(var l in s)t[l]=s[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(Ie,Ie.exports);var Nn=Ie.exports;const M=Fs(Nn);var Rn=Array.isArray,Ot=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var n=void 0;if(Rn(e))for(var s=0,r=e.length;s<r;)n=Ot(e[s++]),n&&(t&&(t+=" "),t+=n);else for(n in e)n&&e[n]&&(t&&(t+=" "),t+=n)}return t};function Vt(){for(var e=arguments.length,t=0,n,s,r="";t<e;)n=arguments[t++],n&&(s=Ot(n),s&&(r&&(r+=" "),r+=s));return r}function Pe({children:e="",imageUrl:t,imageAlt:n="",aspectRatio:s="card-small",videoUrl:r}){return`
    <span
      class="${Vt("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",s==="card-small"&&"su-aspect-[3/2]",s==="card-medium"&&"su-aspect-[3/2]",s==="card-large"&&"su-aspect-[3/2]",s==="card-featured"&&"su-aspect-[3/2]",s==="square"&&"su-aspect-[1/1]",s==="video"&&"su-aspect-[16/9]",s==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${r?`
  ...
  `}const Dn={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function Ze({imageUrl:e,alt:t="",aspectRatio:n,videoUrl:s,size:r="small",title:o="",videoIconClasses:a,uniqueId:i}){if(s){const l=`
        ...
        ${s?`
          <span
            class="${Vt("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",Dn[r],a)}">
  ...
  `}function Bn(e,t){if(!t)return!0;const n=e.match(/(\d+-\d+-\d+)/)[0],s=t.match(/(\d+-\d+-\d+)/)[0];return n===s}function Pn({start:e,end:t}){if(!e&&!t)return null;const n=new Date(e),s=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let o="";const a=Bn(e,t);a||(delete r.time,delete r.hour,delete r.minute);const i=new Intl.DateTimeFormat("en-US",r).format(n),l=t?new Intl.DateTimeFormat("en-US",r).format(s):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${i.replace(/, /," | ")}</span>`:(o+=`${i} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${o}</span>`)}function Zn(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Un="light";function we({variant:e=Un}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function zn({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    </svg>`}const Fe="solid";function Jn({variant:e=Fe}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
    ...
    </svg>`}const er="light";function ze({variant:e=er}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const x={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},lr={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function cr({data:{title:e,description:t,liveUrl:n,imageUrl:s,imageAlt:r,taxonomy:o,taxonomyUrl:a,type:i,date:l,endDate:d,videoUrl:f,uniqueID:u},cardSize:p="small"}){const h=lr[p],c=new Map;return c.set("alert",Zn()),c.set("analysis & insights",ye()),c.set("analysis &amp; insights",ye()),c.set("analysis&nbsp;&amp;&nbsp;insights",ye()),c.set("case study",we({variant:"light"})),c.set("case&nbsp;study",we({variant:"light"})),c.set("casestudy",we({variant:"light"})),c.set("event",Wn()),c.set("event&nbsp;highlights",Ge()),c.set("event highlights",Ge()),c.set("feature",jn()),c.set("infographic",Yn()),c.set("in&nbsp;the&nbsp;news",Le()),c.set("in the news",Le()),c.set("inthenews",Le()),c.set("leadership&nbsp;messages",Ue()),c.set("leadership messages",Ue()),c.set("obituary",Xn()),c.set("opinion",Qn()),c.set("photo",Kn()),c.set("policy&nbsp;brief",ze({variant:"light"})),c.set("policy brief",ze({variant:"light"})),c.set("poll/quiz",Ee()),c.set("poll / quiz",Ee()),c.set("poll&nbsp;/&nbsp;quiz",Ee()),c.set("profile",tr()),c.set("research",sr()),c.set("solutions",nr()),c.set("survey",rr()),c.set("timeline",ar()),c.set("tips & takeaways",be()),c.set("tips &amp; takeaways",be()),c.set("tips&nbsp;&amp;&nbsp;takeaways",be()),c.set("university&nbsp;updates",We()),c.set("university updates",We()),c.set("announcement",Gn()),c.set("news",Fn()),c.set("q&amp;a",K()),c.set("q&a",K()),c.set("q & a",K()),c.set("q&nbsp;&amp;&nbsp;a",K()),c.set("video",or()),c.set("podcast",Jn({variant:"light"})),c.set("book",zn({className:""})),`
    <article aria-label="${e}" class="${x.root} ${h.gap}" data-testid="horizontal-card" >
      
    ${p==="large"?`
        <div class="${x.imageWrapper} ${h.imageWrapper}">
          ${s?`
            ${Ze({imageUrl:s,alt:r,videoUrl:f,mediaType:"image",aspectRatio:"card-large",size:p,uniqueId:u})}
          `:""}
        </div>
      `:""}
      ...
      ${p==="small"&&s?`
        <div class="${x.imageWrapper} ${h.imageWrapper} su-relative">
            ${Ze({imageUrl:s,alt:r,videoUrl:f,mediaType:"image",aspectRatio:"large",size:p,uniqueId:u})}
        </div>
      `:""}
      ...
      <div class="${_.contentWrapper}">
        ...
        ${i==="Leadership Messages"?`
          <div class="${_.authorWrapper} ${c}">
            ${h?`
              ${dr({image:h,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function fr(e){const{videoId:t,className:n="",noAutoPlay:s,title:r,isVertical:o}=e;return`
        <iframe
            width="${o?315:560}"
            height="${o?560:315}"
            class="${n}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const pr='section[data-component="topic-subtopic-listing"]',hr='[data-element="topics-list"]',qt='[data-element="topics-pagination"]',Ht="su-hidden",mr='section[data-element="modal-wrapper"]',Cr='button[data-click="open-modal"]',gr='button[data-dismiss="modal"]',Nt='iframe[data-modal="iframe"]';function vr(e){const t=e.querySelector(Nt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ht),e.hidden=!1,document.body.style.overflow="hidden"}function Se(e){const t=e.querySelector(Nt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ht),e.hidden=!0,document.body.style.overflow="hidden"}function Rt(e){const t=e.querySelectorAll(Cr),n=e.querySelectorAll(gr);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||Se(s)}),s.dataset.listenerAdded="true"),vr(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&Se(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&Se(s)})}async function yr(e){const{offset:t,query:n,endpoint:s}=e,r=s+n+`&start_rank=${t}`;return await(await fetch(r).catch(i=>{throw new Error(i)})).json()}function wr(e,t,n,s){e.querySelector(hr).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(qt).innerHTML=n,e.querySelector(mr).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),Rt(e),Dt(e)}async function Lr(e){var p,h,c,w,g;const{offset:t,query:n,endpoint:s,display:r,section:o}=e,a=await yr({offset:t,query:n,endpoint:s}),i=(h=(p=a==null?void 0:a.response)==null?void 0:p.resultPacket)==null?void 0:h.resultsSummary;if(!i){console.warn("Missing resultsSummary from API response");return}const l=[],d=[];(g=(w=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:w.results)==null||g.forEach(v=>{const C=U1(),m=P1(v);m.uniqueID=C,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(m.displayConfiguration=r,l.push(`<div class="su-relative su-grow">${ur({data:m,cardType:"narrowhorizontal"})}</div>`)):l.push(`<div class="su-relative su-grow">${cr({data:m,cardType:"horizontal",cardSize:"large"})}</div>`),(m.type==="Video"||m.videoUrl)&&d.push({isVertical:m.size==="vertical-video",videoId:m.videoUrl,title:`Watch ${m.title}`,noAutoPlay:!0,uniqueID:m.uniqueID,titleID:"card-modal"})});const f=Us({pageNumber:Number(t),allResults:i.totalMatching,resultsPerPage:i.numRanks,paginationRange:5,currentPage:Number(t)}),u=d.map(v=>`
        ...
        ${fr({videoId:v.videoId,title:v.title,noAutoPlay:v.noAutoPlay,isVertical:v.isVertical})}
        ...
        `).join("");wr(o,l.join(""),f,u)}function Dt(e){const{query:t,endpoint:n,display:s}=e.dataset,r=e.querySelector(qt);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const i=a.getAttribute("data-offset");Lr({offset:i,query:t,endpoint:n,display:s,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(pr).forEach(e=>{Rt(e),Dt(e)})});const Er='section[data-component="vertical-video-panel"]',Bt="su-hidden",br='button[data-click="open-modal"]',Sr='button[data-dismiss="modal"]',Pt='iframe[data-modal="iframe"]';function Ar(e){const t=e.querySelector(Pt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Bt),e.hidden=!1,document.body.style.overflow="hidden"}function Ae(e){const t=e.querySelector(Pt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Bt),e.hidden=!0,document.body.style.overflow=""}function xr(e){const t=e.querySelectorAll(br),n=e.querySelectorAll(Sr);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||Ae(s)}),s.dataset.listenerAdded="true"),Ar(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&Ae(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&Ae(s)})}function _r(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const o=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),o.on("slideChange",function(){setTimeout(()=>{r?b(o,"h2 a, h3 a, button",!0):b(o,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Er).forEach(e=>{_r(e),xr(e)})});
