import F from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const K1='section[data-component="content-carousel"]';let B;const i1=(e,r)=>{e.slides.forEach(t=>{t.classList.contains("swiper-slide-active")?(t.removeAttribute("aria-hidden"),t.removeAttribute("inert"),t.setAttribute("tabindex","-1")):(t.setAttribute("aria-hidden","true"),t.setAttribute("inert","true"),t.removeAttribute("tabindex"));const s=t.querySelector("h2 a, h3 a, button")?t.querySelector("h2 a, h3 a, button"):null;r&&s&&s.focus()}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(t=>{t.classList.contains("swiper-pagination-bullet-active")?t.setAttribute("aria-current","true"):t.removeAttribute("aria-current")})};function J1(e){const r=e.dataset.uniqueId;B=new F(`section[data-unique-id="${r}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${r}"] .component-slider-next`,prevEl:`section[data-unique-id="${r}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${r}`,clickable:!0,bulletElement:"button",renderBullet:function(t,s){return`<button ${t===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${t+1}</span></button>`}}}),B.on("slideChange",function(){setTimeout(()=>{i1(B,!0)},100)}),i1(B,!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(K1).forEach(e=>{J1(e)})});const ee='section[data-component="featured-content"]',A1="su-hidden",te='button[data-click="open-modal"]',re='button[data-dismiss="modal"]',S1='iframe[data-modal="iframe"]';function se(e){const r=e.querySelector(S1),s=r.getAttribute("src").replace("autoplay=0","autoplay=1");r.setAttribute("src",s),e.classList.remove(A1),e.hidden=!1}function o1(e){const r=e.querySelector(S1),s=r.getAttribute("src").replace("autoplay=1","autoplay=0");r.setAttribute("src",s),e.classList.add(A1),e.hidden=!0}function ae(e){const r=e.querySelectorAll(te),t=e.querySelectorAll(re);let s=null;r&&r.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;s=e.querySelector(`div[data-modal-id="${n}"]`),s&&se(s)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){o1(s)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&s&&o1(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ee).forEach(e=>{ae(e)})});const ne='section[data-component="image-gallery-modal"]',ie='button[data-click="open-gallery-modal"]',oe='div[data-modal="modal"]',le='button[data-dismiss="modal"]',M1="su-hidden";let t1;const ue=(e,r)=>{var u;const t='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(u=Array.from(r==null?void 0:r.querySelectorAll(t)))==null?void 0:u.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const a=s[0],n=s[s.length-1];e.shiftKey&&document.activeElement===a?(e.preventDefault(),n.focus()):!e.shiftKey&&document.activeElement===n&&(e.preventDefault(),a.focus())};function de(e){e.classList.remove(M1),e.hidden=!1,document.addEventListener("keydown",r=>{e&&ue(r,e)})}function l1(e){e.classList.add(M1),e.hidden=!0}function ce(e){const r=e.dataset.modalId;t1=new F(`div[data-modal-id="${r}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${r}"] .component-slider-next`,prevEl:`div[data-modal-id="${r}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${r}`,clickable:!0,bulletElement:"button",renderBullet:function(t,s){return`<button ${t===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${t+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function fe(e){const r=e.querySelector(oe),t=e.querySelector(ie),s=e.querySelector(le);t&&t.addEventListener("click",function(){de(r),ce(r)}),s&&s.addEventListener("click",function(){l1(r),t1.destroy()}),document.addEventListener("keydown",function(a){a.key==="Escape"&&(l1(r),t1.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ne).forEach(e=>{fe(e)})});const Ce='[data-component="interactive-photo-card"]',pe="[data-card-inner]",ge="[data-card-inner-content]";function he(e){var s;const t=((e.style.transform&&parseInt((s=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:s[1])||0)+180)%360;e.style.transform=`rotateY(${t}deg)`}function ve(e){const r=e.querySelector(pe);if(!r){console.error("Could not find card inner element for component");return}r.addEventListener("click",()=>he(r))}const me=e=>{e.forEach(r=>{const t=r.getAttribute("aria-hidden")==="true"?"false":"true",s=r.querySelector("button");s&&(s.tabIndex=t==="true"?"-1":""),r.setAttribute("aria-hidden",t)})},we=e=>{const r=e.querySelectorAll(ge);r.length&&r.forEach(t=>t.addEventListener("click",()=>me(r)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ce).forEach(e=>{ve(e),we(e)})});const be='section[data-component="media-carousel"]';let N;const u1=(e,r)=>{e.slides.forEach(t=>{t.classList.contains("swiper-slide-active")?(t.removeAttribute("aria-hidden"),t.removeAttribute("inert"),t.setAttribute("tabindex","-1")):(t.setAttribute("aria-hidden","true"),t.setAttribute("inert","true"),t.removeAttribute("tabindex"));const s=t.querySelector("h2 a, h3 a, button")?t.querySelector("h2 a, h3 a, button"):null;r&&s&&s.focus()}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(t=>{t.classList.contains("swiper-pagination-bullet-active")?t.setAttribute("aria-current","true"):t.removeAttribute("aria-current")})};function ye(e){const r=e.dataset.uniqueId;N=new F(`section[data-unique-id="${r}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${r}"] .component-slider-next`,prevEl:`section[data-unique-id="${r}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${r}`,clickable:!0,bulletElement:"button",renderBullet:function(t,s){return`<button ${t===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${t+1}</span></button>`}}}),N.on("slideChange",function(){setTimeout(()=>{u1(N,!0)},100)}),u1(N,!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(be).forEach(e=>{ye(e)})});const xe='section[data-component="multicolumn-listing"]',E1="su-hidden",Le='button[data-click="open-modal"]',Ae='button[data-dismiss="modal"]',k1='iframe[data-modal="iframe"]';function Se(e){const r=e.querySelector(k1),s=r.getAttribute("src").replace("autoplay=0","autoplay=1");r.setAttribute("src",s),e.classList.remove(E1),e.hidden=!1}function d1(e){const r=e.querySelector(k1),s=r.getAttribute("src").replace("autoplay=1","autoplay=0");r.setAttribute("src",s),e.classList.add(E1),e.hidden=!0}function Me(e){const r=e.querySelectorAll(Le),t=e.querySelectorAll(Ae);let s=null;r&&r.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;s=e.querySelector(`div[data-modal-id="${n}"]`),s&&Se(s)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){d1(s)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&s&&d1(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(xe).forEach(e=>{Me(e)})});const Ee='section[data-component="stories-carousel"]',V1="su-hidden",ke='button[data-click="open-modal"]',Ve='button[data-dismiss="modal"]',$1='iframe[data-modal="iframe"]';function $e(e){const r=e.querySelector($1),s=r.getAttribute("src").replace("autoplay=0","autoplay=1");r.setAttribute("src",s),e.classList.remove(V1)}function c1(e){const r=e.querySelector($1),s=r.getAttribute("src").replace("autoplay=1","autoplay=0");r.setAttribute("src",s),e.classList.add(V1)}function He(e){const r=e.querySelectorAll(ke),t=e.querySelectorAll(Ve);let s=null;r&&r.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;s=e.querySelector(`div[data-modal-id="${n}"]`),s&&$e(s)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){c1(s)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&s&&c1(s)})}function Te(e){const r=e.dataset.uniqueId;new F(`section[data-unique-id="${r}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${r}"] .component-slider-next`,prevEl:`section[data-unique-id="${r}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${r}`,clickable:!0,bulletElement:"button",renderBullet:function(t,s){return`<button ${t===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${t+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ee).forEach(e=>{Te(e),He(e)})});const _e=()=>{let e=new Date().getTime(),r=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,t=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(r+s)%16|0,r=Math.floor(r/16)),(t==="x"?s:s&3|8).toString(16)})},Ie=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),Ze=()=>typeof crypto<"u"?Ie():_e();function Oe({title:e,listMetadata:{assetTypeCode:r,teaserPlain:t,summary:s,image:a,taxonomyContentTypeText:n,contentTopic:u,contentSubtopic:o,taxonomyContentMainTopicText:l,contentCategory:p,featuredVideo:d,taxonomyContentMainTopicLandingPageUrl:c,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:C,imageAlt:i,authorName:g,authorImage:h,author:v,isTeaser:m,storySource:b,assetHref:S},date:_,liveUrl:I}){const Z=g!==void 0?g:v,M=h!==""?h:void 0,A=a;i=a&&i?i:"",!i&&!A&&(i="a close up image of an intricate stone arch");const $=d,k=t||s;let H=l;!H&&u&&(H=u instanceof Array?u[0]:u),!H&&o&&(H=o instanceof Array?o[0]:o);const j=c;let O=n?n[0]:"";return!O&&p&&(O=p instanceof Array?p[0]:p),S&&r[0]==="link"&&(I=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(k)?k[0]:k,liveUrl:Array.isArray(I)?I[0]:I,imageUrl:Array.isArray(A)?A[0]:A,imageAlt:Array.isArray(i)?i[0]:i,taxonomy:Array.isArray(H)?H[0]:H,taxonomyUrl:Array.isArray(j)?j[0]:j,type:Array.isArray(O)?O[0]:O,videoUrl:Array.isArray($)?$[0]:$,date:Array.isArray(_)?_[0]:_,authorDisplayName:Array.isArray(Z)?Z[0]:Z,authorAvatar:Array.isArray(M)?M[0]:M,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(m)?m[0]:m,storySource:Array.isArray(b)?b[0]:b}}function De({offsetNum:e,pageNumber:r,index:t}){return`
        <button
            data-offset="${e}"
            class="su-size-24 su-font-serif su-flex su-items-center su-justify-center su-text-18 dark:su-text-white ${e===r?"su-bg-digital-red su-rounded-[100px] su-text-white":"su-text-black"}"
            ${e===r?"disabled":""}
            type="button"
        >
            ${t}
        </button>
    `}function Be({pageNumber:e,allResults:r,resultsPerPage:t,paginationRange:s}){const a=Math.ceil(r/t),n=s,u=e-t,o=e+t,l="su-text-black-50",p=[],d=[];let c=1;for(let m=0;m<a;m++){const b=m*t+1;d.push(b)}let f=[...d],C=[...d];const i=d.indexOf(c),g=Math.floor(n*.5);if((i<g||a===n)&&(f=f.filter((m,b)=>m>c&&b<n),C=C.filter(m=>m<c)),i>=g&&a!==n)if(f=f.filter((m,b)=>m>c&&b<=i+g),f.length===g)C=C.filter((m,b)=>m<c&&b>=i-g);else{const m=f.length?n-f.length:n;C=C.filter((b,S)=>b<c&&S>i-m)}return[...C,c,...f].map(m=>({offset:m,index:d.indexOf(m)+1})).forEach(({offset:m,index:b})=>{p.push(De({offsetNum:m,pageNumber:e,index:b}))}),a>1?`<div class="su-mx-auto su-component-container">
                <div class="su-flex su-gap-9 su-items-center su-justify-center su-rs-mt-4 lg:su-rs-mt-7">
                    ...
                    <button
                    type="button"
                        class="su-size-24 su-font-serif su-flex su-items-center su-justify-center dark:su-text-white ${o>d[d.length-1]?l:""}"
            ...
            </div>`:""}function Ne(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var r1={exports:{}},w={},s1={exports:{}},T={};function H1(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function qe(e,r,t){}function Pe(e,r,t){}var Re=/javascript\s*\:/img;function Ue(e,r){return Re.test(r)?"":r}T.whiteList=H1();T.getDefaultWhiteList=H1;T.onAttr=qe;T.onIgnoreAttr=Pe;T.safeAttrValue=Ue;var Ge={indexOf:function(e,r){var t,s;if(Array.prototype.indexOf)return e.indexOf(r);for(t=0,s=e.length;t<s;t++)if(e[t]===r)return t;return-1},forEach:function(e,r,t){var s,a;if(Array.prototype.forEach)return e.forEach(r,t);for(s=0,a=e.length;s<a;s++)r.call(t,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},D=Ge;function ze(e,r){e=D.trimRight(e),e[e.length-1]!==";"&&(e+=";");var t=e.length,s=!1,a=0,n=0,u="";function o(){if(!s){var d=D.trim(e.slice(a,n)),c=d.indexOf(":");if(c!==-1){var f=D.trim(d.slice(0,c)),C=D.trim(d.slice(c+1));if(f){var i=r(a,u.length,f,C,d);i&&(u+=i+"; ")}}}a=n+1}for(;n<t;n++){var l=e[n];if(l==="/"&&e[n+1]==="*"){var p=e.indexOf("*/",n+2);if(p===-1)break;n=p+1,a=n+1,s=!1}else l==="("?s=!0:l===")"?s=!1:l===";"?s||o():l===`
`&&o()}return D.trim(u)}var Fe=ze,q=T,We=Fe;function f1(e){return e==null}function je(e){var r={};for(var t in e)r[t]=e[t];return r}function T1(e){e=je(e||{}),e.whiteList=e.whiteList||q.whiteList,e.onAttr=e.onAttr||q.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||q.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||q.safeAttrValue,this.options=e}T1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var r=this,t=r.options,s=t.whiteList,a=t.onAttr,n=t.onIgnoreAttr,u=t.safeAttrValue,o=We(e,function(l,p,d,c,f){var C=s[d],i=!1;if(C===!0?i=C:typeof C=="function"?i=C(c):C instanceof RegExp&&(i=C.test(c)),i!==!0&&(i=!1),c=u(d,c),!!c){var g={position:p,sourcePosition:l,source:f,isWhite:i};if(i){var h=a(d,c,g);return f1(h)?d+":"+c:h}else{var h=n(d,c,g);if(!f1(h))return h}}});return o};var Xe=T1;(function(e,r){var t=T,s=Xe;function a(u,o){var l=new s(o);return l.process(u)}r=e.exports=a,r.FilterCSS=s;for(var n in t)r[n]=t[n];typeof window<"u"&&(window.filterCSS=e.exports)})(s1,s1.exports);var a1=s1.exports,n1={indexOf:function(e,r){var t,s;if(Array.prototype.indexOf)return e.indexOf(r);for(t=0,s=e.length;t<s;t++)if(e[t]===r)return t;return-1},forEach:function(e,r,t){var s,a;if(Array.prototype.forEach)return e.forEach(r,t);for(s=0,a=e.length;s<a;s++)r.call(t,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var r=/\s|\n|\t/,t=r.exec(e);return t?t.index:-1}},Qe=a1.FilterCSS,Ye=a1.getDefaultWhiteList,z=n1;function _1(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var I1=new Qe;function Ke(e,r,t){}function Je(e,r,t){}function et(e,r,t){}function tt(e,r,t){}function Z1(e){return e.replace(st,"&lt;").replace(at,"&gt;")}function rt(e,r,t,s){if(t=P1(t),r==="href"||r==="src"){if(t=z.trim(t),t==="#")return"#";if(!(t.substr(0,7)==="http://"||t.substr(0,8)==="https://"||t.substr(0,7)==="mailto:"||t.substr(0,4)==="tel:"||t.substr(0,11)==="data:image/"||t.substr(0,6)==="ftp://"||t.substr(0,2)==="./"||t.substr(0,3)==="../"||t[0]==="#"||t[0]==="/"))return""}else if(r==="background"){if(P.lastIndex=0,P.test(t))return""}else if(r==="style"){if(C1.lastIndex=0,C1.test(t)||(p1.lastIndex=0,p1.test(t)&&(P.lastIndex=0,P.test(t))))return"";s!==!1&&(s=s||I1,t=s.process(t))}return t=R1(t),t}var st=/</g,at=/>/g,nt=/"/g,it=/&quot;/g,ot=/&#([a-zA-Z0-9]*);?/gim,lt=/&colon;?/gim,ut=/&newline;?/gim,P=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,C1=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,p1=/u\s*r\s*l\s*\(.*/gi;function O1(e){return e.replace(nt,"&quot;")}function D1(e){return e.replace(it,'"')}function B1(e){return e.replace(ot,function(t,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function N1(e){return e.replace(lt,":").replace(ut," ")}function q1(e){for(var r="",t=0,s=e.length;t<s;t++)r+=e.charCodeAt(t)<32?" ":e.charAt(t);return z.trim(r)}function P1(e){return e=D1(e),e=B1(e),e=N1(e),e=q1(e),e}function R1(e){return e=O1(e),e=Z1(e),e}function dt(){return""}function ct(e,r){typeof r!="function"&&(r=function(){});var t=!Array.isArray(e);function s(u){return t?!0:z.indexOf(e,u)!==-1}var a=[],n=!1;return{onIgnoreTag:function(u,o,l){if(s(u))if(l.isClosing){var p="[/removed]",d=l.position+p.length;return a.push([n!==!1?n:l.position,d]),n=!1,p}else return n||(n=l.position),"[removed]";else return r(u,o,l)},remove:function(u){var o="",l=0;return z.forEach(a,function(p){o+=u.slice(l,p[0]),l=p[1]}),o+=u.slice(l),o}}}function ft(e){for(var r="",t=0;t<e.length;){var s=e.indexOf("<!--",t);if(s===-1){r+=e.slice(t);break}r+=e.slice(t,s);var a=e.indexOf("-->",s);if(a===-1)break;t=a+3}return r}function Ct(e){var r=e.split("");return r=r.filter(function(t){var s=t.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),r.join("")}w.whiteList=_1();w.getDefaultWhiteList=_1;w.onTag=Ke;w.onIgnoreTag=Je;w.onTagAttr=et;w.onIgnoreTagAttr=tt;w.safeAttrValue=rt;w.escapeHtml=Z1;w.escapeQuote=O1;w.unescapeQuote=D1;w.escapeHtmlEntities=B1;w.escapeDangerHtml5Entities=N1;w.clearNonPrintableCharacter=q1;w.friendlyAttrValue=P1;w.escapeAttrValue=R1;w.onIgnoreTagStripAll=dt;w.StripTagBody=ct;w.stripCommentTag=ft;w.stripBlankChar=Ct;w.attributeWrapSign='"';w.cssFilter=I1;w.getDefaultCSSWhiteList=Ye;var W={},V=n1;function pt(e){var r=V.spaceIndex(e),t;return r===-1?t=e.slice(1,-1):t=e.slice(1,r+1),t=V.trim(t).toLowerCase(),t.slice(0,1)==="/"&&(t=t.slice(1)),t.slice(-1)==="/"&&(t=t.slice(0,-1)),t}function gt(e){return e.slice(0,2)==="</"}function ht(e,r,t){var s="",a=0,n=!1,u=!1,o=0,l=e.length,p="",d="";e:for(o=0;o<l;o++){var c=e.charAt(o);if(n===!1){if(c==="<"){n=o;continue}}else if(u===!1){if(c==="<"){s+=t(e.slice(a,o)),n=o,a=o;continue}if(c===">"||o===l-1){s+=t(e.slice(a,n)),d=e.slice(n,o+1),p=pt(d),s+=r(n,s.length,p,d,gt(d)),a=o+1,n=!1;continue}if(c==='"'||c==="'")for(var f=1,C=e.charAt(o-f);C.trim()===""||C==="=";){if(C==="="){u=c;continue e}C=e.charAt(o-++f)}}else if(c===u){u=!1;continue}}return a<l&&(s+=t(e.substr(a))),s}var vt=/[^a-zA-Z0-9\\_:.-]/gim;function mt(e,r){var t=0,s=0,a=[],n=!1,u=e.length;function o(f,C){if(f=V.trim(f),f=f.replace(vt,"").toLowerCase(),!(f.length<1)){var i=r(f,C||"");i&&a.push(i)}}for(var l=0;l<u;l++){var p=e.charAt(l),d,c;if(n===!1&&p==="="){n=e.slice(t,l),t=l+1,s=e.charAt(t)==='"'||e.charAt(t)==="'"?t:bt(e,l+1);continue}if(n!==!1&&l===s){if(c=e.indexOf(p,l+1),c===-1)break;d=V.trim(e.slice(s+1,c)),o(n,d),n=!1,l=c,t=l+1;continue}if(/\s|\n|\t/.test(p))if(e=e.replace(/\s|\n|\t/g," "),n===!1)if(c=wt(e,l),c===-1){d=V.trim(e.slice(t,l)),o(d),n=!1,t=l+1;continue}else{l=c-1;continue}else if(c=yt(e,l-1),c===-1){d=V.trim(e.slice(t,l)),d=g1(d),o(n,d),n=!1,t=l+1;continue}else continue}return t<e.length&&(n===!1?o(e.slice(t)):o(n,g1(V.trim(e.slice(t))))),V.trim(a.join(" "))}function wt(e,r){for(;r<e.length;r++){var t=e[r];if(t!==" ")return t==="="?r:-1}}function bt(e,r){for(;r<e.length;r++){var t=e[r];if(t!==" ")return t==="'"||t==='"'?r:-1}}function yt(e,r){for(;r>0;r--){var t=e[r];if(t!==" ")return t==="="?r:-1}}function xt(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function g1(e){return xt(e)?e.substr(1,e.length-2):e}W.parseTag=ht;W.parseAttr=mt;var Lt=a1.FilterCSS,L=w,U1=W,At=U1.parseTag,St=U1.parseAttr,G=n1;function R(e){return e==null}function Mt(e){var r=G.spaceIndex(e);if(r===-1)return{html:"",closing:e[e.length-2]==="/"};e=G.trim(e.slice(r+1,-1));var t=e[e.length-1]==="/";return t&&(e=G.trim(e.slice(0,-1))),{html:e,closing:t}}function Et(e){var r={};for(var t in e)r[t]=e[t];return r}function kt(e){var r={};for(var t in e)Array.isArray(e[t])?r[t.toLowerCase()]=e[t].map(function(s){return s.toLowerCase()}):r[t.toLowerCase()]=e[t];return r}function G1(e){e=Et(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=L.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=kt(e.whiteList||e.allowList):e.whiteList=L.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":L.attributeWrapSign,e.onTag=e.onTag||L.onTag,e.onTagAttr=e.onTagAttr||L.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||L.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||L.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||L.safeAttrValue,e.escapeHtml=e.escapeHtml||L.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Lt(e.css))}G1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var r=this,t=r.options,s=t.whiteList,a=t.onTag,n=t.onIgnoreTag,u=t.onTagAttr,o=t.onIgnoreTagAttr,l=t.safeAttrValue,p=t.escapeHtml,d=r.attributeWrapSign,c=r.cssFilter;t.stripBlankChar&&(e=L.stripBlankChar(e)),t.allowCommentTag||(e=L.stripCommentTag(e));var f=!1;t.stripIgnoreTagBody&&(f=L.StripTagBody(t.stripIgnoreTagBody,n),n=f.onIgnoreTag);var C=At(e,function(i,g,h,v,m){var b={sourcePosition:i,position:g,isClosing:m,isWhite:Object.prototype.hasOwnProperty.call(s,h)},S=a(h,v,b);if(!R(S))return S;if(b.isWhite){if(b.isClosing)return"</"+h+">";var _=Mt(v),I=s[h],Z=St(_.html,function(M,A){var $=G.indexOf(I,M)!==-1,k=u(h,M,A,$);return R(k)?$?(A=l(h,M,A,c),A?M+"="+d+A+d:M):(k=o(h,M,A,$),R(k)?void 0:k):k});return v="<"+h,Z&&(v+=" "+Z),_.closing&&(v+=" /"),v+=">",v}else return S=n(h,v,b),R(S)?p(v):S},p);return f&&(C=f.remove(C)),C};var Vt=G1;(function(e,r){var t=w,s=W,a=Vt;function n(o,l){var p=new a(l);return p.process(o)}r=e.exports=n,r.filterXSS=n,r.FilterXSS=a,function(){for(var o in t)r[o]=t[o];for(var l in s)r[l]=s[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function u(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}u()&&(self.filterXSS=e.exports)})(r1,r1.exports);var $t=r1.exports;const E=Ne($t);var Ht=Array.isArray,z1=function(e){var r="";if(typeof e=="string")r+=e;else if(typeof e=="object"){var t=void 0;if(Ht(e))for(var s=0,a=e.length;s<a;)t=z1(e[s++]),t&&(r&&(r+=" "),r+=t);else for(t in e)t&&e[t]&&(r&&(r+=" "),r+=t)}return r};function F1(){for(var e=arguments.length,r=0,t,s,a="";r<e;)t=arguments[r++],t&&(s=z1(t),s&&(a&&(a+=" "),a+=s));return a}function h1({children:e="",imageUrl:r,imageAlt:t="",aspectRatio:s="card-small",videoUrl:a}){return`
    <span
      class="${F1("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",s==="card-small"&&"su-aspect-[3/2]",s==="card-medium"&&"su-aspect-[3/2]",s==="card-large"&&"su-aspect-[3/2]",s==="card-featured"&&"su-aspect-[3/2]",s==="square"&&"su-aspect-[1/1]",s==="video"&&"su-aspect-[16/9]",s==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${a?`
  ...
  `}const Tt={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function v1({imageUrl:e,alt:r="",aspectRatio:t,videoUrl:s,size:a="small",title:n="",videoIconClasses:u,uniqueId:o}){if(s){const l=`
        ...
        ${s?`
          <span
            class="${F1("su-absolute su-leading-none",a==="vertical-video"&&"su-z-30",Tt[a],u)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${h1({imageUrl:e,imageAlt:`${`Open video ${r||""} in a modal`}`,aspectRatio:t,children:l})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${h1({imageUrl:e,imageAlt:r,aspectRatio:t})}
    </div>
  `}function _t(e,r){if(!r)return!0;const t=e.match(/(\d+-\d+-\d+)/)[0],s=r.match(/(\d+-\d+-\d+)/)[0];return t===s}function It({start:e,end:r}){if(!e&&!r)return null;const t=new Date(e),s=r?new Date(r):null,a={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let n="";const u=_t(e,r);u||(delete a.time,delete a.hour,delete a.minute);const o=new Intl.DateTimeFormat("en-US",a).format(t),l=r?new Intl.DateTimeFormat("en-US",a).format(s):"";return u?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(n+=`${o} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${n}</span>`)}function Zt(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Dt="light";function Q({variant:e=Dt}){const r=new Map;return r.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function Nt({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    >
    ...
    </svg>`}const b1="solid";function Ft({variant:e=b1}){const r=new Map;return r.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),r.get(e)!==null?r.get(e):r.get(b1)}function K(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Wt="light";function y1({variant:e=Wt}){const r=new Map;return r.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const y={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},t5={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function r5({data:{title:e,description:r,liveUrl:t,imageUrl:s,imageAlt:a,taxonomy:n,taxonomyUrl:u,type:o,date:l,endDate:p,videoUrl:d,uniqueID:c},cardSize:f="small"}){const C=t5[f],i=new Map;return i.set("alert",Zt()),i.set("analysis & insights",X()),i.set("analysis &amp; insights",X()),i.set("analysis&nbsp;&amp;&nbsp;insights",X()),i.set("case study",Q({variant:"light"})),i.set("case&nbsp;study",Q({variant:"light"})),i.set("casestudy",Q({variant:"light"})),i.set("event",qt()),i.set("event&nbsp;highlights",m1()),i.set("event highlights",m1()),i.set("feature",Pt()),i.set("infographic",Rt()),i.set("in&nbsp;the&nbsp;news",Y()),i.set("in the news",Y()),i.set("inthenews",Y()),i.set("leadership&nbsp;messages",w1()),i.set("leadership messages",w1()),i.set("obituary",Ut()),i.set("opinion",Gt()),i.set("photo",zt()),i.set("policy&nbsp;brief",y1({variant:"light"})),i.set("policy brief",y1({variant:"light"})),i.set("poll/quiz",K()),i.set("poll / quiz",K()),i.set("poll&nbsp;/&nbsp;quiz",K()),i.set("profile",jt()),i.set("research",Xt()),i.set("solutions",Qt()),i.set("survey",Yt()),i.set("timeline",Kt()),i.set("tips & takeaways",J()),i.set("tips &amp; takeaways",J()),i.set("tips&nbsp;&amp;&nbsp;takeaways",J()),i.set("university&nbsp;updates",x1()),i.set("university updates",x1()),i.set("announcement",Ot()),i.set("news",Bt()),i.set("q&amp;a",U()),i.set("q&a",U()),i.set("q & a",U()),i.set("q&nbsp;&amp;&nbsp;a",U()),i.set("video",Jt()),i.set("podcast",Ft({variant:"light"})),i.set("book",Nt({className:""})),`
    <article aria-label="${e}" class="${y.root} ${C.gap}" data-testid="horizontal-card" >
      
    ${f==="large"?`
        <div class="${y.imageWrapper} ${C.imageWrapper}">
          ${s?`
            ${v1({imageUrl:s,alt:a,videoUrl:d,mediaType:"image",aspectRatio:"card-large",size:f,uniqueId:c})}
          `:""}
        </div>
      `:""}

      ${f==="small"&&s?`
        <div class="${y.imageWrapper} ${C.imageWrapper} su-relative">
            ${v1({imageUrl:s,alt:a,videoUrl:d,mediaType:"image",aspectRatio:"large",size:f,uniqueId:c})}
        </div>
      `:""}

      <div class="${y.contentWrapper} ${C.contentGap}">
        ${f==="small"&&n?`
          <p class="${y.taxonomy}" data-testid="horizontal-card-taxonomy">
        ...
        <h3 class="${y.heading} ${C.title}">
          <a href="${t}" class="${y.link}">
            ${E(e)}
        ...
        ${f==="large"&&o?`
          <p data-testid="horizontal-card-type" class="${y.type}">
            ${i.get(o.toLowerCase())}
            <span class="${y.typeText}">${E(o)}</span>
          </p>
        `:""}

        ${f==="large"&&r?`
          <div data-testid="horizontal-card-description" class="${y.description}">
    ...
    <article aria-label="${e}" class="${x.root}" data-testid="narrow-horizontal-card">
      <div class="${x.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${x.authorWrapper} ${i}">
            ${C?`
              ${s5({image:C,avatarSize:"small",alt:`Photo of ${u}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function n5(e){const{videoId:r,className:t="",noAutoPlay:s,title:a,isVertical:n}=e;return`
        <iframe
            width="${n?315:560}"
            height="${n?560:315}"
            class="${t}"
            src="https://www.youtube.com/embed/${r}?si=vYU81uVmaV7GSju2&amp;autoplay=${s?0:1}&amp;controls=1&amp;rel=0"
            title="${a}"
            frameBorder="0"
            ...
            data-modal="iframe"
        ></iframe>
    `}const i5='section[data-component="topic-subtopic-listing"]',o5='[data-element="topics-list"]',W1='[data-element="topics-pagination"]',j1="su-hidden",l5='section[data-element="modal-wrapper"]',u5='button[data-click="open-modal"]',d5='button[data-dismiss="modal"]',X1='iframe[data-modal="iframe"]';function c5(e){const r=e.querySelector(X1),s=r.getAttribute("src").replace("autoplay=0","autoplay=1");r.setAttribute("src",s),e.classList.remove(j1),e.hidden=!1}function L1(e){const r=e.querySelector(X1),s=r.getAttribute("src").replace("autoplay=1","autoplay=0");r.setAttribute("src",s),e.classList.add(j1),e.hidden=!0}function Q1(e){const r=e.querySelectorAll(u5),t=e.querySelectorAll(d5);let s=null;r&&r.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;s=e.querySelector(`div[data-modal-id="${n}"]`),s&&c5(s)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){L1(s)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&s&&L1(s)})}async function f5(e){const{offset:r,query:t,endpoint:s}=e,a=s+t+`&start_rank=${r}`;return await(await fetch(a).catch(o=>{throw new Error(o)})).json()}function C5(e,r,t,s){document.querySelector(o5).innerHTML=r,document.querySelector(W1).innerHTML=t,document.querySelector(l5).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),Q1(e),Y1(e)}async function p5(e){var f,C,i;const{offset:r,query:t,endpoint:s,display:a,section:n}=e,u=await f5({offset:r,query:t,endpoint:s}),o=u.response.resultPacket&&u.response.resultPacket.resultsSummary?u.response.resultPacket.resultsSummary:null,l=[],p=[];(i=(C=(f=u==null?void 0:u.response)==null?void 0:f.resultPacket)==null?void 0:C.results)==null||i.forEach(g=>{const h=Ze(),v=Oe(g);v.uniqueID=h,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(a)?(v.displayConfiguration=a,l.push(a5({data:v,cardType:"narrowhorizontal"}))):l.push(r5({data:v,cardType:"horizontal",cardSize:"large"})),v.type==="Video"&&p.push({isVertical:v.size==="vertical-video",videoId:v.videoUrl,title:`Watch ${v.title}`,noAutoPlay:!0,uniqueID:v.uniqueID,titleID:"card-modal"})});const d=Be({pageNumber:Number(r),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(r)}),c=p.map(g=>`
        ...
        ${n5({videoId:g.videoId,title:g.title,noAutoPlay:g.noAutoPlay,isVertical:g.isVertical})}
        ...
        `).join("");C5(n,l,d,c)}function Y1(e){const{query:r,endpoint:t,display:s}=e.dataset,a=e.querySelector(W1);if(!a)return;a.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{if(u.disabled)return;const o=u.getAttribute("data-offset");p5({offset:o,query:r,endpoint:t,display:s,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(i5).forEach(e=>{Q1(e),Y1(e)})});
