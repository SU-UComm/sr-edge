import P from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";function ee(e,t,s,r=()=>{}){const a=e.slides.length;let i=t-a+1;a%s!==0&&(i+=s-a%s);const n=document.createDocumentFragment(),o=e.slides.map(u=>u.outerHTML).join("");for(let u=0;u<i;u++){const p=document.createElement("div");for(p.innerHTML=o;p.firstChild;)p.firstChild.classList.add("swiper-slide-duplicate"),n.appendChild(p.firstChild)}e.wrapperEl.appendChild(n),e.update(),r()}function Z(e,t=()=>{}){var n;const{slidesPerView:s,slidesPerGroup:r}=e.params,a=e.slides.length,i=Math.ceil(s+r);a===1&&((n=document.querySelector(".component-slider-controls"))==null||n.remove()),(a-1<i||a%r!==0)&&ee(e,i,r,t)}function a1(e){const t=e.slides.filter(s=>s.classList.contains("swiper-slide-duplicate")).length;if(t){let s=e.pagination.bullets.length-e.slides.length+t;for(;s>0;){const r=e.pagination.bullets.pop();r&&r.remove(),s--}}}const D=(e,t,s)=>{e.slides.forEach(r=>{if(r.classList.contains("swiper-slide-active")){if(r.removeAttribute("aria-hidden"),r.removeAttribute("inert"),r.setAttribute("tabindex","-1"),t&&s){let a=null;t==="slide"?a=r:a=r.querySelector(t),a&&a.focus()}}else r.setAttribute("aria-hidden","true"),r.setAttribute("inert","true"),r.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(r=>{r.classList.contains("swiper-pagination-bullet-active")?r.setAttribute("aria-current","true"):r.removeAttribute("aria-current")})},te='section[data-component="content-carousel"]';function se(e){const t=e.dataset.uniqueId,s=new P(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{Z(n)},resize:n=>{Z(n)},paginationUpdate:n=>{a1(n)}}}),r=s.slides.length,a=s.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(r-a)>1&&(s.on("slideChange",function(){setTimeout(()=>{D(s,"slide",!0)},100)}),D(s,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(te).forEach(e=>{se(e)})});const re='section[data-component="featured-content"]',A1="su-hidden",ae='button[data-click="open-modal"]',ne='button[data-dismiss="modal"]',S1='iframe[data-modal="iframe"]';function ie(e){const t=e.querySelector(S1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(A1),e.hidden=!1}function o1(e){const t=e.querySelector(S1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(A1),e.hidden=!0}function oe(e){const t=e.querySelectorAll(ae),s=e.querySelectorAll(ne);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&ie(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){o1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&o1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(re).forEach(e=>{oe(e)})});const le='section[data-component="image-gallery-modal"]',ue='button[data-click="open-gallery-modal"]',de='div[data-modal="modal"]',ce='button[data-dismiss="modal"]',E1="su-hidden";let t1;const fe=(e,t)=>{var n;const s='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',r=(n=Array.from(t==null?void 0:t.querySelectorAll(s)))==null?void 0:n.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(r.length===0||(e==null?void 0:e.key)!=="Tab")return;const a=r[0],i=r[r.length-1];e.shiftKey&&document.activeElement===a?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),a.focus())};function pe(e){e.classList.remove(E1),e.hidden=!1,document.addEventListener("keydown",t=>{e&&fe(t,e)})}function l1(e){e.classList.add(E1),e.hidden=!0}function Ce(e){const t=e.dataset.modalId;t1=new P(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function ge(e){const t=e.querySelector(de),s=e.querySelector(ue),r=e.querySelector(ce);s&&s.addEventListener("click",function(){pe(t),Ce(t)}),r&&r.addEventListener("click",function(){l1(t),t1.destroy()}),document.addEventListener("keydown",function(a){a.key==="Escape"&&(l1(t),t1.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(le).forEach(e=>{ge(e)})});const he='[data-component="interactive-photo-card"]',ve="[data-card-inner]",me="[data-card-inner-content]";function we(e){var r;const s=((e.style.transform&&parseInt((r=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:r[1])||0)+180)%360;e.style.transform=`rotateY(${s}deg)`}function be(e){const t=e.querySelector(ve);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>we(t))}const Le=e=>{e.forEach(t=>{const s=t.getAttribute("aria-hidden")==="true"?"false":"true",r=t.querySelector("button");r&&(r.tabIndex=s==="true"?"-1":""),t.setAttribute("aria-hidden",s)})},ye=e=>{const t=e.querySelectorAll(me);t.length&&t.forEach(s=>s.addEventListener("click",()=>Le(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(he).forEach(e=>{be(e),ye(e)})});const xe='section[data-component="media-carousel"]';function Ae(e){const t=e.dataset.uniqueId,s=new P(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o} ${n===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{Z(n),n.activeIndex===1&&n.slidePrev()},resize:n=>{Z(n)},paginationUpdate:n=>{a1(n)}}}),r=s.slides.length,a=s.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(r-a)>1&&(s.on("slideChange",function(){setTimeout(()=>{D(s,"h2 a, h3 a, button",!0)},100)}),D(s,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(xe).forEach(e=>{Ae(e)})});const Se='section[data-component="multicolumn-listing"]',M1="su-hidden",Ee='button[data-click="open-modal"]',Me='button[data-dismiss="modal"]',k1='iframe[data-modal="iframe"]';function ke(e){const t=e.querySelector(k1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(M1),e.hidden=!1}function u1(e){const t=e.querySelector(k1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(M1),e.hidden=!0}function Ve(e){const t=e.querySelectorAll(Ee),s=e.querySelectorAll(Me);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&ke(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){u1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&u1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Se).forEach(e=>{Ve(e)})});const $e='section[data-component="stories-carousel"]',V1="su-hidden",_e='button[data-click="open-modal"]',Te='button[data-dismiss="modal"]',$1='iframe[data-modal="iframe"]';function He(e){const t=e.querySelector($1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(V1)}function d1(e){const t=e.querySelector($1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(V1)}function Ie(e){const t=e.querySelectorAll(_e),s=e.querySelectorAll(Te);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&He(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){d1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&d1(r)})}function Oe(e){const t=e.dataset.uniqueId;new P(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll($e).forEach(e=>{Oe(e),Ie(e)})});const Ze=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,s=>{let r=Math.random()*16;return e>0?(r=(e+r)%16|0,e=Math.floor(e/16)):(r=(t+r)%16|0,t=Math.floor(t/16)),(s==="x"?r:r&3|8).toString(16)})},De=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),Be=()=>typeof crypto<"u"?De():Ze();function Ne({title:e,listMetadata:{assetTypeCode:t,teaserPlain:s,summary:r,image:a,taxonomyContentTypeText:i,contentTopic:n,contentSubtopic:o,taxonomyContentMainTopicText:u,contentCategory:p,featuredVideo:d,taxonomyContentMainTopicLandingPageUrl:c,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:C,imageAlt:l,authorName:b,authorImage:v,author:w,isTeaser:h,storySource:g,assetHref:S},date:H,liveUrl:I}){const O=b!==void 0?b:w,E=v!==""?v:void 0,A=a;l=a&&l?l:"",!l&&!A&&(l="a close up image of an intricate stone arch");const $=d,k=s||r;let _=u;!_&&n&&(_=n instanceof Array?n[0]:n),!_&&o&&(_=o instanceof Array?o[0]:o);const j=c;let B=i?i[0]:"";return!B&&p&&(B=p instanceof Array?p[0]:p),S&&t[0]==="link"&&(I=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(k)?k[0]:k,liveUrl:Array.isArray(I)?I[0]:I,imageUrl:Array.isArray(A)?A[0]:A,imageAlt:Array.isArray(l)?l[0]:l,taxonomy:Array.isArray(_)?_[0]:_,taxonomyUrl:Array.isArray(j)?j[0]:j,type:Array.isArray(B)?B[0]:B,videoUrl:Array.isArray($)?$[0]:$,date:Array.isArray(H)?H[0]:H,authorDisplayName:Array.isArray(O)?O[0]:O,authorAvatar:Array.isArray(E)?E[0]:E,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(h)?h[0]:h,storySource:Array.isArray(g)?g[0]:g}}function Pe({offsetNum:e,pageNumber:t,index:s}){return`
        <button
            data-offset="${e}"
    ...
    `}function qe({pageNumber:e,allResults:t,resultsPerPage:s,paginationRange:r}){const a=Math.ceil(t/s),i=r,n=e-s,o=e+s,u="su-text-black-50",p=[],d=[];let c=1;for(let h=0;h<a;h++){const g=h*s+1;d.push(g)}let f=[...d],C=[...d];const l=d.indexOf(c),b=Math.floor(i*.5);if((l<b||a===i)&&(f=f.filter((h,g)=>h>c&&g<i),C=C.filter(h=>h<c)),l>=b&&a!==i)if(f=f.filter((h,g)=>h>c&&g<=l+b),f.length===b)C=C.filter((h,g)=>h<c&&g>=l-b);else{const h=f.length?i-f.length:i;C=C.filter((g,S)=>g<c&&S>l-h)}return[...C,c,...f].map(h=>({offset:h,index:d.indexOf(h)+1})).forEach(({offset:h,index:g})=>{p.push(Pe({offsetNum:h,pageNumber:e,index:g}))}),a>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function Re(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var s1={exports:{}},m={},r1={exports:{}},T={};function _1(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function Ue(e,t,s){}function Ge(e,t,s){}var ze=/javascript\s*\:/img;function Fe(e,t){return ze.test(t)?"":t}T.whiteList=_1();T.getDefaultWhiteList=_1;T.onAttr=Ue;T.onIgnoreAttr=Ge;T.safeAttrValue=Fe;var We={indexOf:function(e,t){var s,r;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,r=e.length;s<r;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var r,a;if(Array.prototype.forEach)return e.forEach(t,s);for(r=0,a=e.length;r<a;r++)t.call(s,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},N=We;function je(e,t){e=N.trimRight(e),e[e.length-1]!==";"&&(e+=";");var s=e.length,r=!1,a=0,i=0,n="";function o(){if(!r){var d=N.trim(e.slice(a,i)),c=d.indexOf(":");if(c!==-1){var f=N.trim(d.slice(0,c)),C=N.trim(d.slice(c+1));if(f){var l=t(a,n.length,f,C,d);l&&(n+=l+"; ")}}}a=i+1}for(;i<s;i++){var u=e[i];if(u==="/"&&e[i+1]==="*"){var p=e.indexOf("*/",i+2);if(p===-1)break;i=p+1,a=i+1,r=!1}else u==="("?r=!0:u===")"?r=!1:u===";"?r||o():u===`
`&&o()}return N.trim(n)}var Xe=je,q=T,Qe=Xe;function c1(e){return e==null}function Ye(e){var t={};for(var s in e)t[s]=e[s];return t}function T1(e){e=Ye(e||{}),e.whiteList=e.whiteList||q.whiteList,e.onAttr=e.onAttr||q.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||q.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||q.safeAttrValue,this.options=e}T1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,r=s.whiteList,a=s.onAttr,i=s.onIgnoreAttr,n=s.safeAttrValue,o=Qe(e,function(u,p,d,c,f){var C=r[d],l=!1;if(C===!0?l=C:typeof C=="function"?l=C(c):C instanceof RegExp&&(l=C.test(c)),l!==!0&&(l=!1),c=n(d,c),!!c){var b={position:p,sourcePosition:u,source:f,isWhite:l};if(l){var v=a(d,c,b);return c1(v)?d+":"+c:v}else{var v=i(d,c,b);if(!c1(v))return v}}});return o};var Ke=T1;(function(e,t){var s=T,r=Ke;function a(n,o){var u=new r(o);return u.process(n)}t=e.exports=a,t.FilterCSS=r;for(var i in s)t[i]=s[i];typeof window<"u"&&(window.filterCSS=e.exports)})(r1,r1.exports);var n1=r1.exports,i1={indexOf:function(e,t){var s,r;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,r=e.length;s<r;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var r,a;if(Array.prototype.forEach)return e.forEach(t,s);for(r=0,a=e.length;r<a;r++)t.call(s,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,s=t.exec(e);return s?s.index:-1}},Je=n1.FilterCSS,et=n1.getDefaultWhiteList,F=i1;function H1(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var I1=new Je;function tt(e,t,s){}function st(e,t,s){}function rt(e,t,s){}function at(e,t,s){}function O1(e){return e.replace(it,"&lt;").replace(ot,"&gt;")}function nt(e,t,s,r){if(s=q1(s),t==="href"||t==="src"){if(s=F.trim(s),s==="#")return"#";if(!(s.substr(0,7)==="http://"||s.substr(0,8)==="https://"||s.substr(0,7)==="mailto:"||s.substr(0,4)==="tel:"||s.substr(0,11)==="data:image/"||s.substr(0,6)==="ftp://"||s.substr(0,2)==="./"||s.substr(0,3)==="../"||s[0]==="#"||s[0]==="/"))return""}else if(t==="background"){if(R.lastIndex=0,R.test(s))return""}else if(t==="style"){if(f1.lastIndex=0,f1.test(s)||(p1.lastIndex=0,p1.test(s)&&(R.lastIndex=0,R.test(s))))return"";r!==!1&&(r=r||I1,s=r.process(s))}return s=R1(s),s}var it=/</g,ot=/>/g,lt=/"/g,ut=/&quot;/g,dt=/&#([a-zA-Z0-9]*);?/gim,ct=/&colon;?/gim,ft=/&newline;?/gim,R=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,f1=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,p1=/u\s*r\s*l\s*\(.*/gi;function Z1(e){return e.replace(lt,"&quot;")}function D1(e){return e.replace(ut,'"')}function B1(e){return e.replace(dt,function(s,r){return r[0]==="x"||r[0]==="X"?String.fromCharCode(parseInt(r.substr(1),16)):String.fromCharCode(parseInt(r,10))})}function N1(e){return e.replace(ct,":").replace(ft," ")}function P1(e){for(var t="",s=0,r=e.length;s<r;s++)t+=e.charCodeAt(s)<32?" ":e.charAt(s);return F.trim(t)}function q1(e){return e=D1(e),e=B1(e),e=N1(e),e=P1(e),e}function R1(e){return e=Z1(e),e=O1(e),e}function pt(){return""}function Ct(e,t){typeof t!="function"&&(t=function(){});var s=!Array.isArray(e);function r(n){return s?!0:F.indexOf(e,n)!==-1}var a=[],i=!1;return{onIgnoreTag:function(n,o,u){if(r(n))if(u.isClosing){var p="[/removed]",d=u.position+p.length;return a.push([i!==!1?i:u.position,d]),i=!1,p}else return i||(i=u.position),"[removed]";else return t(n,o,u)},remove:function(n){var o="",u=0;return F.forEach(a,function(p){o+=n.slice(u,p[0]),u=p[1]}),o+=n.slice(u),o}}}function gt(e){for(var t="",s=0;s<e.length;){var r=e.indexOf("<!--",s);if(r===-1){t+=e.slice(s);break}t+=e.slice(s,r);var a=e.indexOf("-->",r);if(a===-1)break;s=a+3}return t}function ht(e){var t=e.split("");return t=t.filter(function(s){var r=s.charCodeAt(0);return r===127?!1:r<=31?r===10||r===13:!0}),t.join("")}m.whiteList=H1();m.getDefaultWhiteList=H1;m.onTag=tt;m.onIgnoreTag=st;m.onTagAttr=rt;m.onIgnoreTagAttr=at;m.safeAttrValue=nt;m.escapeHtml=O1;m.escapeQuote=Z1;m.unescapeQuote=D1;m.escapeHtmlEntities=B1;m.escapeDangerHtml5Entities=N1;m.clearNonPrintableCharacter=P1;m.friendlyAttrValue=q1;m.escapeAttrValue=R1;m.onIgnoreTagStripAll=pt;m.StripTagBody=Ct;m.stripCommentTag=gt;m.stripBlankChar=ht;m.attributeWrapSign='"';m.cssFilter=I1;m.getDefaultCSSWhiteList=et;var W={},V=i1;function vt(e){var t=V.spaceIndex(e),s;return t===-1?s=e.slice(1,-1):s=e.slice(1,t+1),s=V.trim(s).toLowerCase(),s.slice(0,1)==="/"&&(s=s.slice(1)),s.slice(-1)==="/"&&(s=s.slice(0,-1)),s}function mt(e){return e.slice(0,2)==="</"}function wt(e,t,s){var r="",a=0,i=!1,n=!1,o=0,u=e.length,p="",d="";e:for(o=0;o<u;o++){var c=e.charAt(o);if(i===!1){if(c==="<"){i=o;continue}}else if(n===!1){if(c==="<"){r+=s(e.slice(a,o)),i=o,a=o;continue}if(c===">"||o===u-1){r+=s(e.slice(a,i)),d=e.slice(i,o+1),p=vt(d),r+=t(i,r.length,p,d,mt(d)),a=o+1,i=!1;continue}if(c==='"'||c==="'")for(var f=1,C=e.charAt(o-f);C.trim()===""||C==="=";){if(C==="="){n=c;continue e}C=e.charAt(o-++f)}}else if(c===n){n=!1;continue}}return a<u&&(r+=s(e.substr(a))),r}var bt=/[^a-zA-Z0-9\\_:.-]/gim;function Lt(e,t){var s=0,r=0,a=[],i=!1,n=e.length;function o(f,C){if(f=V.trim(f),f=f.replace(bt,"").toLowerCase(),!(f.length<1)){var l=t(f,C||"");l&&a.push(l)}}for(var u=0;u<n;u++){var p=e.charAt(u),d,c;if(i===!1&&p==="="){i=e.slice(s,u),s=u+1,r=e.charAt(s)==='"'||e.charAt(s)==="'"?s:xt(e,u+1);continue}if(i!==!1&&u===r){if(c=e.indexOf(p,u+1),c===-1)break;d=V.trim(e.slice(r+1,c)),o(i,d),i=!1,u=c,s=u+1;continue}if(/\s|\n|\t/.test(p))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(c=yt(e,u),c===-1){d=V.trim(e.slice(s,u)),o(d),i=!1,s=u+1;continue}else{u=c-1;continue}else if(c=At(e,u-1),c===-1){d=V.trim(e.slice(s,u)),d=C1(d),o(i,d),i=!1,s=u+1;continue}else continue}return s<e.length&&(i===!1?o(e.slice(s)):o(i,C1(V.trim(e.slice(s))))),V.trim(a.join(" "))}function yt(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="="?t:-1}}function xt(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="'"||s==='"'?t:-1}}function At(e,t){for(;t>0;t--){var s=e[t];if(s!==" ")return s==="="?t:-1}}function St(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function C1(e){return St(e)?e.substr(1,e.length-2):e}W.parseTag=wt;W.parseAttr=Lt;var Et=n1.FilterCSS,x=m,U1=W,Mt=U1.parseTag,kt=U1.parseAttr,z=i1;function U(e){return e==null}function Vt(e){var t=z.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=z.trim(e.slice(t+1,-1));var s=e[e.length-1]==="/";return s&&(e=z.trim(e.slice(0,-1))),{html:e,closing:s}}function $t(e){var t={};for(var s in e)t[s]=e[s];return t}function _t(e){var t={};for(var s in e)Array.isArray(e[s])?t[s.toLowerCase()]=e[s].map(function(r){return r.toLowerCase()}):t[s.toLowerCase()]=e[s];return t}function G1(e){e=$t(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=x.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=_t(e.whiteList||e.allowList):e.whiteList=x.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":x.attributeWrapSign,e.onTag=e.onTag||x.onTag,e.onTagAttr=e.onTagAttr||x.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||x.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||x.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||x.safeAttrValue,e.escapeHtml=e.escapeHtml||x.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Et(e.css))}G1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,r=s.whiteList,a=s.onTag,i=s.onIgnoreTag,n=s.onTagAttr,o=s.onIgnoreTagAttr,u=s.safeAttrValue,p=s.escapeHtml,d=t.attributeWrapSign,c=t.cssFilter;s.stripBlankChar&&(e=x.stripBlankChar(e)),s.allowCommentTag||(e=x.stripCommentTag(e));var f=!1;s.stripIgnoreTagBody&&(f=x.StripTagBody(s.stripIgnoreTagBody,i),i=f.onIgnoreTag);var C=Mt(e,function(l,b,v,w,h){var g={sourcePosition:l,position:b,isClosing:h,isWhite:Object.prototype.hasOwnProperty.call(r,v)},S=a(v,w,g);if(!U(S))return S;if(g.isWhite){if(g.isClosing)return"</"+v+">";var H=Vt(w),I=r[v],O=kt(H.html,function(E,A){var $=z.indexOf(I,E)!==-1,k=n(v,E,A,$);return U(k)?$?(A=u(v,E,A,c),A?E+"="+d+A+d:E):(k=o(v,E,A,$),U(k)?void 0:k):k});return w="<"+v,O&&(w+=" "+O),H.closing&&(w+=" /"),w+=">",w}else return S=i(v,w,g),U(S)?p(w):S},p);return f&&(C=f.remove(C)),C};var Tt=G1;(function(e,t){var s=m,r=W,a=Tt;function i(o,u){var p=new a(u);return p.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=a,function(){for(var o in s)t[o]=s[o];for(var u in r)t[u]=r[u]}(),typeof window<"u"&&(window.filterXSS=e.exports);function n(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}n()&&(self.filterXSS=e.exports)})(s1,s1.exports);var Ht=s1.exports;const M=Re(Ht);var It=Array.isArray,z1=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var s=void 0;if(It(e))for(var r=0,a=e.length;r<a;)s=z1(e[r++]),s&&(t&&(t+=" "),t+=s);else for(s in e)s&&e[s]&&(t&&(t+=" "),t+=s)}return t};function F1(){for(var e=arguments.length,t=0,s,r,a="";t<e;)s=arguments[t++],s&&(r=z1(s),r&&(a&&(a+=" "),a+=r));return a}function g1({children:e="",imageUrl:t,imageAlt:s="",aspectRatio:r="card-small",videoUrl:a}){return`
    <span
  ...
  `}const Ot={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function h1({imageUrl:e,alt:t="",aspectRatio:s,videoUrl:r,size:a="small",title:i="",videoIconClasses:n,uniqueId:o}){if(r){const u=`
        ...
        ${r?`
          <span
            class="${F1("su-absolute su-leading-none",a==="vertical-video"&&"su-z-30",Ot[a],n)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${g1({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:s,children:u})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${g1({imageUrl:e,imageAlt:t,aspectRatio:s})}
    </div>
  `}function Zt(e,t){if(!t)return!0;const s=e.match(/(\d+-\d+-\d+)/)[0],r=t.match(/(\d+-\d+-\d+)/)[0];return s===r}function Dt({start:e,end:t}){if(!e&&!t)return null;const s=new Date(e),r=t?new Date(t):null,a={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const n=Zt(e,t);n||(delete a.time,delete a.hour,delete a.minute);const o=new Intl.DateTimeFormat("en-US",a).format(s),u=t?new Intl.DateTimeFormat("en-US",a).format(r):"";return n?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${u}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function Bt(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Pt="light";function Q({variant:e=Pt}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    >
    ...
    </svg>`}const w1="solid";function Xt({variant:e=w1}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get(w1)}function K(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Qt="light";function b1({variant:e=Qt}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
  ...
  `}function e1(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function i5({image:e,avatarSize:t="small",alt:s=""}){const r=new Map;r.set("small","su-min-w-[56px] su-w-[56px] su-h-[56px] su-p-3"),r.set("medium","su-min-w-[165px] su-w-[165px] su-h-[165px] su-p-7"),r.set("large","su-min-w-[218px] su-w-[218px] su-h-[218px] su-p-9");const a=new Map;return a.set("small","su-w-50 su-h-50 su-top-3 su-left-3"),a.set("medium","su-size-150 su-top-7 su-left-8"),a.set("large","su-size-200 su-top-9 su-left-9"),e?`
    <div
      data-test="size-${t}"
      ...
      <div class="${y.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${y.authorWrapper} ${l}">
            ${C?`
              ${i5({image:C,avatarSize:"small",alt:`Photo of ${n}`})}
            `:""}
            ${w}
          </div>
        `:""}
  ...
  `}function u5(e){const{videoId:t,className:s="",noAutoPlay:r,title:a,isVertical:i}=e;return`
        <iframe
            width="${i?315:560}"
            height="${i?560:315}"
            class="${s}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const d5='section[data-component="topic-subtopic-listing"]',c5='[data-element="topics-list"]',W1='[data-element="topics-pagination"]',j1="su-hidden",f5='section[data-element="modal-wrapper"]',p5='button[data-click="open-modal"]',C5='button[data-dismiss="modal"]',X1='iframe[data-modal="iframe"]';function g5(e){const t=e.querySelector(X1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(j1),e.hidden=!1}function y1(e){const t=e.querySelector(X1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(j1),e.hidden=!0}function Q1(e){const t=e.querySelectorAll(p5),s=e.querySelectorAll(C5);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&g5(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){y1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&y1(r)})}async function h5(e){const{offset:t,query:s,endpoint:r}=e,a=r+s+`&start_rank=${t}`;return await(await fetch(a).catch(o=>{throw new Error(o)})).json()}function v5(e,t,s,r){e.querySelector(c5).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(W1).innerHTML=s,e.querySelector(f5).innerHTML=r;const a=-100-60,i=e.getBoundingClientRect().top+window.pageYOffset+a;window.scrollTo({top:i,behavior:"smooth"}),Q1(e),Y1(e)}async function m5(e){var f,C,l,b,v;const{offset:t,query:s,endpoint:r,display:a,section:i}=e,n=await h5({offset:t,query:s,endpoint:r}),o=(C=(f=n==null?void 0:n.response)==null?void 0:f.resultPacket)==null?void 0:C.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const u=[],p=[];(v=(b=(l=n==null?void 0:n.response)==null?void 0:l.resultPacket)==null?void 0:b.results)==null||v.forEach(w=>{const h=Be(),g=Ne(w);g.uniqueID=h,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(a)?(g.displayConfiguration=a,u.push(`<div class="su-relative su-grow">${l5({data:g,cardType:"narrowhorizontal"})}</div>`)):u.push(`<div class="su-relative su-grow">${n5({data:g,cardType:"horizontal",cardSize:"large"})}</div>`),(g.type==="Video"||g.videoUrl)&&p.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const d=qe({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),c=p.map(w=>`
        ...
        ${u5({videoId:w.videoId,title:w.title,noAutoPlay:w.noAutoPlay,isVertical:w.isVertical})}
        ...
        `).join("");v5(i,u.join(""),d,c)}function Y1(e){const{query:t,endpoint:s,display:r}=e.dataset,a=e.querySelector(W1);if(!a)return;a.querySelectorAll("button").forEach(n=>{n.addEventListener("click",()=>{if(n.disabled)return;const o=n.getAttribute("data-offset");m5({offset:o,query:t,endpoint:s,display:r,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(d5).forEach(e=>{Q1(e),Y1(e)})});const w5='section[data-component="vertical-video-panel"]',K1="su-hidden",b5='button[data-click="open-modal"]',L5='button[data-dismiss="modal"]',J1='iframe[data-modal="iframe"]';function y5(e){const t=e.querySelector(J1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(K1),e.hidden=!1}function x1(e){const t=e.querySelector(J1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(K1),e.hidden=!0}function x5(e){const t=e.querySelectorAll(b5),s=e.querySelectorAll(L5);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&y5(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){x1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&x1(r)})}function A5(e){const t=e.dataset.uniqueId,s=new P(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{Z(n),n.slidePrev()},resize:n=>{Z(n)},paginationUpdate:n=>{a1(n)}}}),r=s.slides.length,a=s.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(r-a)>1&&(s.on("slideChange",function(){setTimeout(()=>{D(s,"h2 a, h3 a, button",!0)},100)}),D(s,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(w5).forEach(e=>{A5(e),x5(e)})});
