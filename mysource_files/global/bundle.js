import B from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";function He(e){if(!e)return 0;const t=225,n=e.trim().split(/\s+/).length;return Math.ceil(n/t)}function yt(e,t,n,s=()=>{}){const r=e.slides.length;let i=t-r+1;r%n!==0&&(i+=n-r%n);const a=document.createDocumentFragment(),o=e.slides.map(u=>u.outerHTML).join("");for(let u=0;u<i;u++){const f=document.createElement("div");for(f.innerHTML=o;f.firstChild;)f.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(f.firstChild)}e.wrapperEl.appendChild(a),e.update(),E(e,"",!1),s()}function N(e,t=()=>{}){const{slidesPerView:n,slidesPerGroup:s}=e.params,r=e.slides.length,i=Math.ceil(n+s);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<i||r%s!==0?yt(e,i,s,t):(E(e,"",!1),t())}function J(e){const t=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(t){let n=e.pagination.bullets.length-e.slides.length+t;for(;n>0;){const s=e.pagination.bullets.pop();s&&s.remove(),n--}}}const E=(e,t,n)=>{e.slides.forEach(s=>{if(s.classList.contains("swiper-slide-active")){if(s.removeAttribute("aria-hidden"),s.removeAttribute("inert"),s.setAttribute("tabindex","-1"),t&&n){let r=null;t==="slide"?r=s:r=s.querySelector(t),r&&r.focus()}}else s.setAttribute("aria-hidden","true"),s.setAttribute("inert","true"),s.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(s=>{s.classList.contains("swiper-pagination-bullet-active")?s.setAttribute("aria-current","true"):s.removeAttribute("aria-current")})},bt='section[data-component="basic-story-hero"]',Lt='span[data-reading="true"]',Oe="su-hidden",Et='button[data-click="open-modal"]',St='button[data-dismiss="modal"]',qe='iframe[data-modal="iframe"]';function At(e){const t=e.querySelector(qe);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(Oe),e.hidden=!1,document.body.style.overflow="hidden"}function te(e){const t=e.querySelector(qe);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(Oe),e.hidden=!0,document.body.style.overflow=""}function xt(e){const t=e.querySelectorAll(Et),n=e.querySelectorAll(St);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||te(s)}),s.dataset.listenerAdded="true"),At(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&te(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&te(s)})}function _t(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{N(a),E(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{J(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?E(i,"slide",!0):E(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}function Mt(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(Lt);if(t&&n){const s=He(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(bt).forEach(e=>{_t(e),xt(e),Mt(e)})});const It='section[data-component="combined-content-grid"]',Ne="su-hidden",Tt='button[data-click="open-modal"]',kt='button[data-dismiss="modal"]',Re='iframe[data-modal="iframe"]';function $t(e){const t=e.querySelector(Re),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ne),e.hidden=!1,document.body.style.overflow="hidden"}function se(e){const t=e.querySelector(Re),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ne),e.hidden=!0,document.body.style.overflow=""}function Vt(e){const t=e.querySelectorAll(Tt),n=e.querySelectorAll(kt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||se(s)}),s.dataset.listenerAdded="true"),$t(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&se(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&se(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(It).forEach(e=>{Vt(e)})});const Ht='section[data-component="content-carousel"]';function Ot(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),E(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{J(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?E(i,"slide",!0):E(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ht).forEach(e=>{Ot(e)})});const qt='section[data-component="feature-story-hero"]',Nt='span[data-reading="true"]';function Rt(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(Nt);if(t&&n){const s=He(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(qt).forEach(e=>{Rt(e)})});const Bt='section[data-component="featured-content"]',Be="su-hidden",Dt='button[data-click="open-modal"]',Pt='button[data-dismiss="modal"]',De='iframe[data-modal="iframe"]';function Zt(e){const t=e.querySelector(De),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Be),e.hidden=!1,document.body.style.overflow="hidden"}function ne(e){const t=e.querySelector(De),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Be),e.hidden=!0,document.body.style.overflow=""}function Gt(e){const t=e.querySelectorAll(Dt),n=e.querySelectorAll(Pt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ne(s)}),s.dataset.listenerAdded="true"),Zt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ne(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ne(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Bt).forEach(e=>{Gt(e)})});const Ut='section[data-component="image-gallery-modal"]',Ft='button[data-click="open-gallery-modal"]',zt='div[data-modal="modal"]',Wt='button[data-dismiss="modal"]',Pe="su-hidden";let he;const jt=(e,t)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function Xt(e){e.classList.remove(Pe),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&jt(t,e)})}function re(e){e.classList.add(Pe),e.hidden=!0,document.body.style.overflow=""}function Yt(e){const t=e.dataset.modalId;he=new B(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function Qt(e){const t=e.querySelector(zt),n=e.querySelector(Ft),s=e.querySelector(Wt);n&&n.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",i=>{r.contains(i.target)||re(t)}),t.dataset.listenerAdded="true"),Xt(t),Yt(t)}),s&&s.addEventListener("click",function(){re(t),he.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(re(t),he.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ut).forEach(e=>{Qt(e)})});const Kt='[data-component="interactive-photo-card"]',Jt="[data-card-inner]",e1="[data-card-inner-content]";function t1(e){var s;const n=((e.style.transform&&parseInt((s=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:s[1])||0)+180)%360;e.style.transform=`rotateY(${n}deg)`}function s1(e){const t=e.querySelector(Jt);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>t1(t))}const n1=e=>{e.forEach(t=>{const n=t.getAttribute("aria-hidden")==="true"?"false":"true",s=t.querySelector("button");s&&(s.tabIndex=n==="true"?"-1":""),t.setAttribute("aria-hidden",n)})},r1=e=>{const t=e.querySelectorAll(e1);t.length&&t.forEach(n=>n.addEventListener("click",()=>n1(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Kt).forEach(e=>{s1(e),r1(e)})});class a1{constructor(t,n){this.url=t,this.type=n,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const s=this.assetIds.map(async r=>{const i=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(i,this.requestProps).catch(u=>{throw new Error(u)})).json()});return Promise.all(s)}return await(await fetch(this.url,this.requestProps).catch(s=>{throw new Error(s)})).json()}}function i1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:n,summary:s,image:r,taxonomyContentTypeText:i,contentTopic:a,contentSubtopic:o,taxonomyContentMainTopicText:u,contentCategory:f,featuredVideo:p,taxonomyContentMainTopicLandingPageUrl:d,taxonomyFeaturedUnitLandingPageUrl:c,taxonomyFeaturedUnitText:C,imageAlt:l,authorName:y,authorImage:h,author:v,isTeaser:m,storySource:g,assetHref:S},date:$,liveUrl:V}){const H=y!==void 0?y:v,A=h!==""?h:void 0,x=r;l=r&&l?l:"",!l&&!x&&(l="a close up image of an intricate stone arch");const b=p,T=n||s;let O=u;!O&&a&&(O=a instanceof Array?a[0]:a),!O&&o&&(O=o instanceof Array?o[0]:o);const Z=d;let D=i?i[0]:"";return!D&&f&&(D=f instanceof Array?f[0]:f),S&&t[0]==="link"&&(V=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(T)?T[0]:T,liveUrl:Array.isArray(V)?V[0]:V,imageUrl:Array.isArray(x)?x[0]:x,imageAlt:Array.isArray(l)?l[0]:l,taxonomy:Array.isArray(O)?O[0]:O,taxonomyUrl:Array.isArray(Z)?Z[0]:Z,type:Array.isArray(D)?D[0]:D,videoUrl:Array.isArray(b)?b[0]:b,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(H)?H[0]:H,authorAvatar:Array.isArray(A)?A[0]:A,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(c)?c[0]:c,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(m)?m[0]:m,storySource:Array.isArray(g)?g[0]:g}}function ae(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}const Ze=typeof window>"u"?{}:window;function o1(e=Ze){return e.document!==void 0}function l1(e,t=Ze){if(!o1(t))return null;const{document:n}=t,{cookie:s}=n;if(typeof s!="string")return null;const r=s.split("; ");let i=null;return r.find(a=>{const[o,u]=a.split("=");return o===e&&u!==""&&(i=u),null}),i}function Ge(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}function u1(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}const d1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(t+s)%16|0,t=Math.floor(t/16)),(n==="x"?s:s&3|8).toString(16)})},c1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),f1=()=>typeof crypto<"u"?c1():d1();async function p1(e=null,t="",n=null){var r,i,a,o,u,f,p,d,c,C,l,y,h,v,m,g,S,$,V;const s=new a1;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const H=`
            ...
            &meta_taxonomyAudienceText=${u1(t)}&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;let A=H;n&&(n!=null&&n.behavioural)&&(A=`${(p=(f=e==null?void 0:e.search)==null?void 0:f.endpoint)==null?void 0:p.replace(/\.html/g,".json")}
                ?profile=${(d=e==null?void 0:e.search)==null?void 0:d.profile}
                &collection=${(c=e==null?void 0:e.search)==null?void 0:c.collection}${n.partialQuery}&num_ranks=3&log=false&meta_isTeaser=false`),s.url=A.replace(/\n+|\t+| {2,}/g,"");let b=((l=(C=(await s.fetch()).response)==null?void 0:C.resultPacket)==null?void 0:l.results)||null;if(b&&b.length<3&&(s.url=H.replace(/\n+|\t+| {2,}/g,""),b=((h=(y=(await s.fetch()).response)==null?void 0:y.resultPacket)==null?void 0:h.results)||null,b&&b.length<3)){const O=`${(m=(v=e==null?void 0:e.search)==null?void 0:v.endpoint)==null?void 0:m.replace(/\.html/g,".json")}
                    ?profile=${(g=e==null?void 0:e.search)==null?void 0:g.profile}
                    &collection=${(S=e==null?void 0:e.search)==null?void 0:S.collection}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;s.url=O.replace(/\n+|\t+| {2,}/g,""),b=((V=($=(await s.fetch()).response)==null?void 0:$.resultPacket)==null?void 0:V.results)||null}return b}return null}const ie={WRAPPER:'[data-role="link-list-wrapper"]',TOGGLE:'[data-role="link-drawer-toggle"]',DRAWER:'[data-role="link-drawer"]'},L={ACTIVE:"su-rotate-90",INACTIVE:"su-rotate-[-90deg]",OPEN:"su-h-auto",CLOSED:"su-h-0",VISIBLE:"su-opacity-[1]",HIDDEN:"su-opacity-[0]",NO_STORIES:"su-link-list-no-stories"};function C1(e,t){var s;if(!(((s=e==null?void 0:e.dataset)==null?void 0:s.active)==="true")){e.dataset.active=!0,e.classList.remove(L.INACTIVE),e.classList.add(L.ACTIVE),t.classList.remove(L.CLOSED),t.classList.add(L.OPEN);return}e.dataset.active=!1,e.classList.add(L.INACTIVE),e.classList.remove(L.ACTIVE),t.classList.add(L.CLOSED),t.classList.remove(L.OPEN)}function g1(e){const t=document.body.getBoundingClientRect().height,n=window.scrollY+window.innerHeight;if(window.scrollY>=Math.round(30/100*document.body.clientHeight)&&n<=t-700){e.classList.remove(L.HIDDEN),e.classList.remove("su-bottom-[-100px]"),e.classList.add(L.VISIBLE),e.classList.add("su-bottom-0");return}e.classList.remove(L.VISIBLE),e.classList.add("su-bottom-[-100px]"),e.classList.add(L.HIDDEN),e.classList.remove("su-bottom-0")}function m1(e,t){return`
    ...
    `}function h1(e,t,n){if(!e.length){t.classList.add(L.NO_STORIES);return}const[s,r,i]=e;n.innerHTML=`
    ...
    `,t.classList.remove(L.NO_STORIES)}async function v1(e,t,n,s,r,i){const o=(await p1(e,i,t)).map(({title:u,indexUrl:f})=>m1(u,f));h1(o,n,r),w1(n,s,r)}function w1(e,t,n){t.addEventListener("click",function(){C1(t,n)}),window.addEventListener("scroll",function(){g1(e)})}function y1(e,t,n,s){if(!e||!window.pageController)return;const r=window.pageController,i=r.topicsQuery?r.topicsQuery():null;v1(r,i,e,t,n,s)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(ie.WRAPPER),t=document.querySelector(ie.TOGGLE),n=document.querySelector(ie.DRAWER),s=l1("preferences_personalisation");y1(e,t,n,s)});const b1='section[data-component="media-carousel"]';function L1(e){const t=e.dataset.uniqueId,n=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),E(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{N(a)},paginationUpdate:a=>{J(a)}}}),s=n.slides.length,r=n.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(s-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),n.on("slideChange",function(){setTimeout(()=>{a?E(n,"h2 a, h3 a, button",!0):E(n,"",!1)},100)})}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(b1).forEach(e=>{L1(e)})});const E1='section[data-component="multicolumn-listing"]',Ue="su-hidden",S1='button[data-click="open-modal"]',A1='button[data-dismiss="modal"]',Fe='iframe[data-modal="iframe"]';function x1(e){const t=e.querySelector(Fe),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ue),e.hidden=!1,document.body.style.overflow="hidden"}function oe(e){const t=e.querySelector(Fe),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ue),e.hidden=!0,document.body.style.overflow=""}function _1(e){const t=e.querySelectorAll(S1),n=e.querySelectorAll(A1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||oe(s)}),s.dataset.listenerAdded="true"),x1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&oe(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&oe(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(E1).forEach(e=>{_1(e)})});const M1='section[data-component="sidebar-navigation"]',I1='nav[data-nav="nav"]',Q="su-hidden",T1='button[data-click="toggle-nav"]',k1="su-bg-digital-red su-text-white dark:su-bg-dark-mode-red dark:aria-expanded:su-text-black-true",$1='span[data-label="button"]';function ze(e,t){const n=e.querySelector($1),s=e.querySelector('svg[data-icon="bars"]'),r=e.querySelector('svg[data-icon="xmark"]');e.setAttribute("aria-expanded",t.toString()),k1.split(" ").forEach(i=>{e.classList.toggle(i,t)}),s.classList.toggle(`!${Q}`,t),s.hidden=t,r.classList.toggle(`!${Q}`,!t),r.hidden=!t,n.innerHTML=t?n.getAttribute("data-label-close"):n.getAttribute("data-label-open")}function Le(e,t){e.classList.remove(Q),e.hidden=!1,ze(t,!0)}function G(e,t){e.classList.add(Q),e.hidden=!0,ze(t,!1)}function V1(e){const t=e.querySelector(T1),n=e.querySelector(I1);let s;t&&t.addEventListener("click",function(){const r=t.getAttribute("aria-expanded")==="true";n.dataset.listenerAdded||(document.addEventListener("click",i=>{const a=n.contains(i.target),o=t.contains(i.target);!a&&!o&&G(n,t)}),n.dataset.listenerAdded="true"),r?G(n,t):Le(n,t)}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&G(n,t)}),window.addEventListener("resize",()=>{clearTimeout(s),s=setTimeout(()=>{window.innerWidth>991?Le(n,t):G(n,t)},10)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(M1).forEach(e=>{V1(e)})});function U(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function F(e,t){const n=e.querySelector('svg[data-control="play"]'),s=e.querySelector('svg[data-control="pause"]'),r=!t;e.setAttribute("aria-pressed",String(r)),n.classList.toggle("su-hidden",r),n.hidden=r,s.classList.toggle("su-hidden",!r),s.hidden=!r,e.innerHTML=`
  ...
  `}const H1='section[data-component="single-image-video"]',O1='iframe[data-role="video-player"]',q1='button[data-role="video-control"]',We="su-hidden",N1='button[data-click="open-modal"]',R1='button[data-dismiss="modal"]',je='iframe[data-modal="iframe"]',B1=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function D1(e){const t=e.querySelector(je),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(We),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&B1(r,e)})}function le(e){const t=e.querySelector(je),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(We),e.hidden=!0,document.body.style.overflow=""}function P1(e){const t=e.querySelectorAll(N1),n=e.querySelectorAll(R1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||le(s)}),s.dataset.listenerAdded="true"),D1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&le(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&le(s)})}function Z1(e){const t=e.querySelector(O1),n=e.querySelector(q1);let s=!1;if(!t||!n)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!s?(U(t,"play"),F(n,!1)):a.isIntersecting||(U(t,"pause"),F(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(U(t,"pause"),F(n,!0),s=!0):(U(t,"play"),F(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(H1).forEach(e=>{P1(e),Z1(e)})});const G1='section[data-component="stories-carousel"]',Xe="su-hidden",U1='button[data-click="open-modal"]',F1='button[data-dismiss="modal"]',Ye='iframe[data-modal="iframe"]';function z1(e){const t=e.querySelector(Ye),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Xe),e.hidden=!1,document.body.style.overflow="hidden"}function ue(e){const t=e.querySelector(Ye),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Xe),e.hidden=!0,document.body.style.overflow=""}function W1(e){const t=e.querySelectorAll(U1),n=e.querySelectorAll(F1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ue(s)}),s.dataset.listenerAdded="true"),z1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ue(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ue(s)})}function j1(e){const t=e.dataset.uniqueId;new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(G1).forEach(e=>{j1(e),W1(e)})});const X1='section[data-component="subscribe-to-stanford-report"]';function Y1(e){const t=e.querySelector("form"),n=t.querySelector('input[type="email"]'),s=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let i="";const a=n.value;if(!a||!a.match(/\w+@\w+\.\w+/)){i='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',s.innerHTML=i,n.setAttribute("aria-describedby","subscription-error");return}s.innerHTML="",n.removeAttribute("aria-describedby"),r.target.submit()}),n.addEventListener("keyup",function(){const r=n.value,i=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(i.innerHTML="",n.removeAttribute("aria-describedby"))})}function Q1(){document.querySelectorAll(X1).forEach(e=>{Y1(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",Q1);const K1='section[data-component="subtopic-subnav-component"]',J1='div[data-list="subnav"]';function es(e){return e.filter((t,n)=>n===e.findIndex(s=>{var r,i;return((r=s.taxonomyFeaturedUnitText)==null?void 0:r[0])===((i=t.taxonomyFeaturedUnitText)==null?void 0:i[0])}))}const ts=async e=>{if(!e||e.length===0)return null;const t=es(e),n=[];return t.forEach(s=>{var i,a,o;const r=s;r&&((i=r.taxonomyFeaturedUnitText)!=null&&i[0])&&n.push({asset_name:(a=r.taxonomyFeaturedUnitText)==null?void 0:a[0],asset_url:((o=r.taxonomyFeaturedUnitLandingPageUrl)==null?void 0:o[0])||""})}),n};function ss({navigation:e}){let t="scrollable-list__item su-mb-0 su-relative after:su-h-22 after:su-w-[1px] after:su-bg-black-60 after:su-mx-12 lg:after:su-mx-18";const n="su-text-inherit su-text-black su-font-semi-bold su-text-16 lg:su-text-18 lg:su-leading-[21.6px] su-no-underline hover:su-underline dark:su-text-white hover:su-text-digital-red dark:hover:su-text-dark-mode-red";return`
    ...
    `}function ns(e){const t=e.querySelector(J1);t&&document.addEventListener("topicLoader",async n=>{if(n.detail){const s=await ts(n.detail.cards);t.innerHTML=ss({navigation:s})}},!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(K1).forEach(e=>{ns(e)})});function rs({offsetNum:e,pageNumber:t,index:n}){return`
        <button
            data-offset="${e}"
    ...
    `}function as({pageNumber:e,allResults:t,resultsPerPage:n,paginationRange:s,currentPage:r=1}){const i=Math.ceil(t/n),a=s,o=e-n,u=e+n,f="su-text-black-50",p=[],d=[];for(let m=0;m<i;m++){const g=m*n+1;d.push(g)}let c=[...d],C=[...d];const l=d.indexOf(r),y=Math.floor(a*.5);if((l<y||i===a)&&(c=c.filter((m,g)=>m>r&&g<a),C=C.filter(m=>m<r)),l>=y&&i!==a)if(c=c.filter((m,g)=>m>r&&g<=l+y),c.length===y)C=C.filter((m,g)=>m<r&&g>=l-y);else{const m=c.length?a-c.length:a;C=C.filter((g,S)=>g<r&&S>l-m)}return[...C,r,...c].map(m=>({offset:m,index:d.indexOf(m)+1})).forEach(({offset:m,index:g})=>{p.push(rs({offsetNum:m,pageNumber:e,index:g}))}),i>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function is(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var ve={exports:{}},w={},we={exports:{}},R={};function Qe(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function os(e,t,n){}function ls(e,t,n){}var us=/javascript\s*\:/img;function ds(e,t){return us.test(t)?"":t}R.whiteList=Qe();R.getDefaultWhiteList=Qe;R.onAttr=os;R.onIgnoreAttr=ls;R.safeAttrValue=ds;var cs={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},P=cs;function fs(e,t){e=P.trimRight(e),e[e.length-1]!==";"&&(e+=";");var n=e.length,s=!1,r=0,i=0,a="";function o(){if(!s){var p=P.trim(e.slice(r,i)),d=p.indexOf(":");if(d!==-1){var c=P.trim(p.slice(0,d)),C=P.trim(p.slice(d+1));if(c){var l=t(r,a.length,c,C,p);l&&(a+=l+"; ")}}}r=i+1}for(;i<n;i++){var u=e[i];if(u==="/"&&e[i+1]==="*"){var f=e.indexOf("*/",i+2);if(f===-1)break;i=f+1,r=i+1,s=!1}else u==="("?s=!0:u===")"?s=!1:u===";"?s||o():u===`
`&&o()}return P.trim(a)}var ps=fs,z=R,Cs=ps;function Ee(e){return e==null}function gs(e){var t={};for(var n in e)t[n]=e[n];return t}function Ke(e){e=gs(e||{}),e.whiteList=e.whiteList||z.whiteList,e.onAttr=e.onAttr||z.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||z.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||z.safeAttrValue,this.options=e}Ke.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onAttr,i=n.onIgnoreAttr,a=n.safeAttrValue,o=Cs(e,function(u,f,p,d,c){var C=s[p],l=!1;if(C===!0?l=C:typeof C=="function"?l=C(d):C instanceof RegExp&&(l=C.test(d)),l!==!0&&(l=!1),d=a(p,d),!!d){var y={position:f,sourcePosition:u,source:c,isWhite:l};if(l){var h=r(p,d,y);return Ee(h)?p+":"+d:h}else{var h=i(p,d,y);if(!Ee(h))return h}}});return o};var ms=Ke;(function(e,t){var n=R,s=ms;function r(a,o){var u=new s(o);return u.process(a)}t=e.exports=r,t.FilterCSS=s;for(var i in n)t[i]=n[i];typeof window<"u"&&(window.filterCSS=e.exports)})(we,we.exports);var ye=we.exports,be={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,n=t.exec(e);return n?n.index:-1}},hs=ye.FilterCSS,vs=ye.getDefaultWhiteList,K=be;function Je(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var et=new hs;function ws(e,t,n){}function ys(e,t,n){}function bs(e,t,n){}function Ls(e,t,n){}function tt(e){return e.replace(Ss,"&lt;").replace(As,"&gt;")}function Es(e,t,n,s){if(n=ot(n),t==="href"||t==="src"){if(n=K.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(t==="background"){if(W.lastIndex=0,W.test(n))return""}else if(t==="style"){if(Se.lastIndex=0,Se.test(n)||(Ae.lastIndex=0,Ae.test(n)&&(W.lastIndex=0,W.test(n))))return"";s!==!1&&(s=s||et,n=s.process(n))}return n=lt(n),n}var Ss=/</g,As=/>/g,xs=/"/g,_s=/&quot;/g,Ms=/&#([a-zA-Z0-9]*);?/gim,Is=/&colon;?/gim,Ts=/&newline;?/gim,W=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,Se=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,Ae=/u\s*r\s*l\s*\(.*/gi;function st(e){return e.replace(xs,"&quot;")}function nt(e){return e.replace(_s,'"')}function rt(e){return e.replace(Ms,function(n,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function at(e){return e.replace(Is,":").replace(Ts," ")}function it(e){for(var t="",n=0,s=e.length;n<s;n++)t+=e.charCodeAt(n)<32?" ":e.charAt(n);return K.trim(t)}function ot(e){return e=nt(e),e=rt(e),e=at(e),e=it(e),e}function lt(e){return e=st(e),e=tt(e),e}function ks(){return""}function $s(e,t){typeof t!="function"&&(t=function(){});var n=!Array.isArray(e);function s(a){return n?!0:K.indexOf(e,a)!==-1}var r=[],i=!1;return{onIgnoreTag:function(a,o,u){if(s(a))if(u.isClosing){var f="[/removed]",p=u.position+f.length;return r.push([i!==!1?i:u.position,p]),i=!1,f}else return i||(i=u.position),"[removed]";else return t(a,o,u)},remove:function(a){var o="",u=0;return K.forEach(r,function(f){o+=a.slice(u,f[0]),u=f[1]}),o+=a.slice(u),o}}}function Vs(e){for(var t="",n=0;n<e.length;){var s=e.indexOf("<!--",n);if(s===-1){t+=e.slice(n);break}t+=e.slice(n,s);var r=e.indexOf("-->",s);if(r===-1)break;n=r+3}return t}function Hs(e){var t=e.split("");return t=t.filter(function(n){var s=n.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),t.join("")}w.whiteList=Je();w.getDefaultWhiteList=Je;w.onTag=ws;w.onIgnoreTag=ys;w.onTagAttr=bs;w.onIgnoreTagAttr=Ls;w.safeAttrValue=Es;w.escapeHtml=tt;w.escapeQuote=st;w.unescapeQuote=nt;w.escapeHtmlEntities=rt;w.escapeDangerHtml5Entities=at;w.clearNonPrintableCharacter=it;w.friendlyAttrValue=ot;w.escapeAttrValue=lt;w.onIgnoreTagStripAll=ks;w.StripTagBody=$s;w.stripCommentTag=Vs;w.stripBlankChar=Hs;w.attributeWrapSign='"';w.cssFilter=et;w.getDefaultCSSWhiteList=vs;var ee={},q=be;function Os(e){var t=q.spaceIndex(e),n;return t===-1?n=e.slice(1,-1):n=e.slice(1,t+1),n=q.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function qs(e){return e.slice(0,2)==="</"}function Ns(e,t,n){var s="",r=0,i=!1,a=!1,o=0,u=e.length,f="",p="";e:for(o=0;o<u;o++){var d=e.charAt(o);if(i===!1){if(d==="<"){i=o;continue}}else if(a===!1){if(d==="<"){s+=n(e.slice(r,o)),i=o,r=o;continue}if(d===">"||o===u-1){s+=n(e.slice(r,i)),p=e.slice(i,o+1),f=Os(p),s+=t(i,s.length,f,p,qs(p)),r=o+1,i=!1;continue}if(d==='"'||d==="'")for(var c=1,C=e.charAt(o-c);C.trim()===""||C==="=";){if(C==="="){a=d;continue e}C=e.charAt(o-++c)}}else if(d===a){a=!1;continue}}return r<u&&(s+=n(e.substr(r))),s}var Rs=/[^a-zA-Z0-9\\_:.-]/gim;function Bs(e,t){var n=0,s=0,r=[],i=!1,a=e.length;function o(c,C){if(c=q.trim(c),c=c.replace(Rs,"").toLowerCase(),!(c.length<1)){var l=t(c,C||"");l&&r.push(l)}}for(var u=0;u<a;u++){var f=e.charAt(u),p,d;if(i===!1&&f==="="){i=e.slice(n,u),n=u+1,s=e.charAt(n)==='"'||e.charAt(n)==="'"?n:Ps(e,u+1);continue}if(i!==!1&&u===s){if(d=e.indexOf(f,u+1),d===-1)break;p=q.trim(e.slice(s+1,d)),o(i,p),i=!1,u=d,n=u+1;continue}if(/\s|\n|\t/.test(f))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(d=Ds(e,u),d===-1){p=q.trim(e.slice(n,u)),o(p),i=!1,n=u+1;continue}else{u=d-1;continue}else if(d=Zs(e,u-1),d===-1){p=q.trim(e.slice(n,u)),p=xe(p),o(i,p),i=!1,n=u+1;continue}else continue}return n<e.length&&(i===!1?o(e.slice(n)):o(i,xe(q.trim(e.slice(n))))),q.trim(r.join(" "))}function Ds(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Ps(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="'"||n==='"'?t:-1}}function Zs(e,t){for(;t>0;t--){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Gs(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function xe(e){return Gs(e)?e.substr(1,e.length-2):e}ee.parseTag=Ns;ee.parseAttr=Bs;var Us=ye.FilterCSS,I=w,ut=ee,Fs=ut.parseTag,zs=ut.parseAttr,Y=be;function j(e){return e==null}function Ws(e){var t=Y.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=Y.trim(e.slice(t+1,-1));var n=e[e.length-1]==="/";return n&&(e=Y.trim(e.slice(0,-1))),{html:e,closing:n}}function js(e){var t={};for(var n in e)t[n]=e[n];return t}function Xs(e){var t={};for(var n in e)Array.isArray(e[n])?t[n.toLowerCase()]=e[n].map(function(s){return s.toLowerCase()}):t[n.toLowerCase()]=e[n];return t}function dt(e){e=js(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=I.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=Xs(e.whiteList||e.allowList):e.whiteList=I.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":I.attributeWrapSign,e.onTag=e.onTag||I.onTag,e.onTagAttr=e.onTagAttr||I.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||I.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||I.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||I.safeAttrValue,e.escapeHtml=e.escapeHtml||I.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Us(e.css))}dt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onTag,i=n.onIgnoreTag,a=n.onTagAttr,o=n.onIgnoreTagAttr,u=n.safeAttrValue,f=n.escapeHtml,p=t.attributeWrapSign,d=t.cssFilter;n.stripBlankChar&&(e=I.stripBlankChar(e)),n.allowCommentTag||(e=I.stripCommentTag(e));var c=!1;n.stripIgnoreTagBody&&(c=I.StripTagBody(n.stripIgnoreTagBody,i),i=c.onIgnoreTag);var C=Fs(e,function(l,y,h,v,m){var g={sourcePosition:l,position:y,isClosing:m,isWhite:Object.prototype.hasOwnProperty.call(s,h)},S=r(h,v,g);if(!j(S))return S;if(g.isWhite){if(g.isClosing)return"</"+h+">";var $=Ws(v),V=s[h],H=zs($.html,function(A,x){var b=Y.indexOf(V,A)!==-1,T=a(h,A,x,b);return j(T)?b?(x=u(h,A,x,d),x?A+"="+p+x+p:A):(T=o(h,A,x,b),j(T)?void 0:T):T});return v="<"+h,H&&(v+=" "+H),$.closing&&(v+=" /"),v+=">",v}else return S=i(h,v,g),j(S)?f(v):S},f);return c&&(C=c.remove(C)),C};var Ys=dt;(function(e,t){var n=w,s=ee,r=Ys;function i(o,u){var f=new r(u);return f.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=r,function(){for(var o in n)t[o]=n[o];for(var u in s)t[u]=s[u]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(ve,ve.exports);var Qs=ve.exports;const k=is(Qs);var Ks=Array.isArray,ct=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var n=void 0;if(Ks(e))for(var s=0,r=e.length;s<r;)n=ct(e[s++]),n&&(t&&(t+=" "),t+=n);else for(n in e)n&&e[n]&&(t&&(t+=" "),t+=n)}return t};function ft(){for(var e=arguments.length,t=0,n,s,r="";t<e;)n=arguments[t++],n&&(s=ct(n),s&&(r&&(r+=" "),r+=s));return r}function _e({children:e="",imageUrl:t,imageAlt:n="",aspectRatio:s="card-small",videoUrl:r}){return`
    <span
      class="${ft("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",s==="card-small"&&"su-aspect-[3/2]",s==="card-medium"&&"su-aspect-[3/2]",s==="card-large"&&"su-aspect-[3/2]",s==="card-featured"&&"su-aspect-[3/2]",s==="square"&&"su-aspect-[1/1]",s==="video"&&"su-aspect-[16/9]",s==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${r?`
  ...
  `}const Js={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function Me({imageUrl:e,alt:t="",aspectRatio:n,videoUrl:s,size:r="small",title:i="",videoIconClasses:a,uniqueId:o}){if(s){const u=`
        ...
        ${s?`
          <span
            class="${ft("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",Js[r],a)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${_e({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:n,children:u})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${_e({imageUrl:e,imageAlt:t,aspectRatio:n})}
    </div>
  `}function en(e,t){if(!t)return!0;const n=e.match(/(\d+-\d+-\d+)/)[0],s=t.match(/(\d+-\d+-\d+)/)[0];return n===s}function tn({start:e,end:t}){if(!e&&!t)return null;const n=new Date(e),s=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const a=en(e,t);a||(delete r.time,delete r.hour,delete r.minute);const o=new Intl.DateTimeFormat("en-US",r).format(n),u=t?new Intl.DateTimeFormat("en-US",r).format(s):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${u}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function sn(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const rn="light";function ce({variant:e=rn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    >
    ...
    </svg>`}const ke="solid";function Cn({variant:e=ke}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get(ke)}function pe(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const gn="light";function $e({variant:e=gn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const _={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},En={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function Sn({data:{title:e,description:t,liveUrl:n,imageUrl:s,imageAlt:r,taxonomy:i,taxonomyUrl:a,type:o,date:u,endDate:f,videoUrl:p,uniqueID:d},cardSize:c="small"}){const C=En[c],l=new Map;return l.set("alert",sn()),l.set("analysis & insights",de()),l.set("analysis &amp; insights",de()),l.set("analysis&nbsp;&amp;&nbsp;insights",de()),l.set("case study",ce({variant:"light"})),l.set("case&nbsp;study",ce({variant:"light"})),l.set("casestudy",ce({variant:"light"})),l.set("event",ln()),l.set("event&nbsp;highlights",Ie()),l.set("event highlights",Ie()),l.set("feature",un()),l.set("infographic",dn()),l.set("in&nbsp;the&nbsp;news",fe()),l.set("in the news",fe()),l.set("inthenews",fe()),l.set("leadership&nbsp;messages",Te()),l.set("leadership messages",Te()),l.set("obituary",cn()),l.set("opinion",fn()),l.set("photo",pn()),l.set("policy&nbsp;brief",$e({variant:"light"})),l.set("policy brief",$e({variant:"light"})),l.set("poll/quiz",pe()),l.set("poll / quiz",pe()),l.set("poll&nbsp;/&nbsp;quiz",pe()),l.set("profile",mn()),l.set("research",hn()),l.set("solutions",vn()),l.set("survey",wn()),l.set("timeline",yn()),l.set("tips & takeaways",Ce()),l.set("tips &amp; takeaways",Ce()),l.set("tips&nbsp;&amp;&nbsp;takeaways",Ce()),l.set("university&nbsp;updates",Ve()),l.set("university updates",Ve()),l.set("announcement",nn()),l.set("news",an()),l.set("q&amp;a",X()),l.set("q&a",X()),l.set("q & a",X()),l.set("q&nbsp;&amp;&nbsp;a",X()),l.set("video",bn()),l.set("podcast",Cn({variant:"light"})),l.set("book",on({className:""})),`
      ...
      <div class="${M.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${M.authorWrapper} ${l}">
            ${C?`
              ${An({image:C,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function _n(e){const{videoId:t,className:n="",noAutoPlay:s,title:r,isVertical:i}=e;return`
        <iframe
            width="${i?315:560}"
            height="${i?560:315}"
            class="${n}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const Mn='section[data-component="topic-subtopic-listing"]',In='[data-element="topics-list"]',pt='[data-element="topics-pagination"]',Ct="su-hidden",Tn='section[data-element="modal-wrapper"]',kn='button[data-click="open-modal"]',$n='button[data-dismiss="modal"]',gt='iframe[data-modal="iframe"]';function Vn(e){const t=e.querySelector(gt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ct),e.hidden=!1,document.body.style.overflow="hidden"}function ge(e){const t=e.querySelector(gt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ct),e.hidden=!0,document.body.style.overflow="hidden"}function mt(e){const t=e.querySelectorAll(kn),n=e.querySelectorAll($n);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ge(s)}),s.dataset.listenerAdded="true"),Vn(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ge(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ge(s)})}async function Hn(e){const{offset:t,query:n,endpoint:s}=e,r=s+n+`&start_rank=${t}`;return await(await fetch(r).catch(o=>{throw new Error(o)})).json()}function On(e,t,n,s){e.querySelector(In).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(pt).innerHTML=n,e.querySelector(Tn).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),mt(e),ht(e)}async function qn(e){var c,C,l,y,h;const{offset:t,query:n,endpoint:s,display:r,section:i}=e,a=await Hn({offset:t,query:n,endpoint:s}),o=(C=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:C.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const u=[],f=[];(h=(y=(l=a==null?void 0:a.response)==null?void 0:l.resultPacket)==null?void 0:y.results)==null||h.forEach(v=>{const m=f1(),g=i1(v);g.uniqueID=m,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(g.displayConfiguration=r,u.push(`<div class="su-relative su-grow">${xn({data:g,cardType:"narrowhorizontal"})}</div>`)):u.push(`<div class="su-relative su-grow">${Sn({data:g,cardType:"horizontal",cardSize:"large"})}</div>`),(g.type==="Video"||g.videoUrl)&&f.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const p=as({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),d=f.map(v=>`
        ...
        ${_n({videoId:v.videoId,title:v.title,noAutoPlay:v.noAutoPlay,isVertical:v.isVertical})}
        ...
        `).join("");On(i,u.join(""),p,d)}function ht(e){const{query:t,endpoint:n,display:s}=e.dataset,r=e.querySelector(pt);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const o=a.getAttribute("data-offset");qn({offset:o,query:t,endpoint:n,display:s,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Mn).forEach(e=>{mt(e),ht(e)})});const Nn='section[data-component="vertical-video-panel"]',vt="su-hidden",Rn='button[data-click="open-modal"]',Bn='button[data-dismiss="modal"]',wt='iframe[data-modal="iframe"]';function Dn(e){const t=e.querySelector(wt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(vt),e.hidden=!1,document.body.style.overflow="hidden"}function me(e){const t=e.querySelector(wt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(vt),e.hidden=!0,document.body.style.overflow=""}function Pn(e){const t=e.querySelectorAll(Rn),n=e.querySelectorAll(Bn);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||me(s)}),s.dataset.listenerAdded="true"),Dn(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&me(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&me(s)})}function Zn(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),E(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{J(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?E(i,"h2 a, h3 a, button",!0):E(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Nn).forEach(e=>{Zn(e),Pn(e)})});
