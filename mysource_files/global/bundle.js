import B from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const Ue=typeof window>"u"?{}:window;function Ht(e=Ue){return e.document!==void 0}function Se(e,t="",n=!0,s="",r="/",o=Ue){if(!Ht(o))return;const{document:a}=o,{location:{hostname:i}}=a;let l="";if(s){const c=new Date;c.setTime(c.getTime()+s*24*60*60*1e3),l=`; expires=${c.toUTCString()}`}n===!0?a.cookie=`${e}=${t}${l}; path=${r}; domain=${i}; secure=${n};`:a.cookie=`${e}=${t}${l}; path=${r}; domain=${i};`}const Fe=typeof window>"u"?{}:window;function qt(e=Fe){return e.document!==void 0}function K(e,t=Fe){if(!qt(t))return null;const{document:n}=t,{cookie:s}=n;if(typeof s!="string")return null;const r=s.split("; ");let o=null;return r.find(a=>{const[i,l]=a.split("=");return i===e&&l!==""&&(o=l),null}),o}async function Nt(e,t){return await(await fetch("/__dxp/events/custom",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source:"custom",action:e,event:{type:t}}),redirect:"follow"}).catch(r=>{throw new Error(r)})).text()}async function J(e){return await(await fetch("/__dxp/cdp/setConsent",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({CDPConsent:e,documentVersion:"1.0"}),redirect:"follow"}).catch(s=>{throw new Error(s)})).text()}function Rt(){const e='[id="light-theme"]',t='[id="dark-theme"]',n='[data-role="su-darkmode-icon-active"]',s='[data-role="su-darkmode-icon-nonactive"]',r=document.querySelector(e),o=document.querySelector(t),a=document.querySelector(n),i=document.querySelector(s),l=document.querySelector("html");if(r&&o){const c=K("preferences_theme");c==="dark"||["",null,void 0,!1].includes(c)&&window.matchMedia("(prefers-color-scheme: dark)").matches?(l.classList.add("su-dark"),a.classList.remove("su-hidden"),i.classList.add("su-hidden"),o.checked=!0,r.checked=!1):(a.classList.add("su-hidden"),i.classList.remove("su-hidden"),l.classList.add("su-light"),r.checked=!0,o.checked=!1),r.addEventListener("keyup",({key:p})=>{[" ","Enter"].includes(p)&&document.querySelector('[data-theme="dark-theme"]').click()}),o.addEventListener("keyup",({key:p})=>{[" ","Enter"].includes(p)&&document.querySelector('[data-theme="light-theme"]').click()}),r.addEventListener("click",()=>{l.classList.remove("su-dark"),l.classList.add("su-light"),a.classList.add("su-hidden"),i.classList.remove("su-hidden"),Se("preferences_theme","light",!0,130)}),o.addEventListener("click",()=>{l.classList.remove("su-light"),l.classList.add("su-dark"),a.classList.remove("su-hidden"),i.classList.add("su-hidden"),Se("preferences_theme","dark",!0,130)}),document.personaChangeEvent=new Event("personaChange")}}class Bt{constructor(t){this.parent=t,this.menuToggle=this.parent.querySelector('[aria-controls="menu"]'),this.searchToggle=this.parent.querySelector('[aria-controls="search"]'),this.preferencesToggle=this.parent.querySelector('[aria-controls="preferences"]'),this.menuCloseToggle=this.parent.querySelectorAll(".report-header__menu-close,.report-header__menu-tray .report-header__overlay"),this.searchCloseToggle=this.parent.querySelectorAll(".report-header__search-close,.report-header__search-tray .report-header__overlay"),this.preferencesCloseToggle=this.parent.querySelectorAll(".report-header__preferences-close,.report-header__preferences-tray .report-header__overlay"),this.handleHeaderScroll(),this.handleHeaderToggles(),this.handleSearchInputs();const n=document.querySelector('[data-role="header-main-nav"]');n&&(n.classList.remove("su-opacity-0"),n.classList.add("su-opacity-1"))}focus(t){if(t.match(/:/g)){const[n,s,r]=t.split(":");document.querySelector(`[data-location="${t}"]`).querySelectorAll(s)[Number(r)].focus();return}document.querySelector(`[data-location="${t}"]`).focus()}handleTab(t){t.addEventListener("keyup",n=>{const{target:s,key:r}=n;if(r!=="Tab")return;const o=s.dataset.tpTo?s.dataset.tpTo:null;o&&this.focus(o)})}handleSearchInputs(){const t=document.querySelectorAll('[data-role="search-query"]'),n=document.querySelectorAll('[data-role="clear-search"]');t.length&&t.forEach((s,r)=>{s.addEventListener("keyup",()=>{s.value!==""?(s.parentNode.classList.add("input-has-value"),n[r].classList.remove("su-hidden")):(s.parentNode.classList.remove("input-has-value"),n[r].classList.add("su-hidden"))})}),n.length&&n.forEach(s=>{s.addEventListener("click",r=>{s.parentNode.parentNode.querySelector(".input-has-value").classList.remove("input-has-value"),s.classList.add("su-hidden")})})}handleHeaderToggles(){this.handleTab(document.querySelector(".report-header__main")),this.menuToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#menu");this.menuToggle.getAttribute("aria-expanded")==="true"?(this.menuToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--primary-nav-open"),n.setAttribute("aria-hidden","true"),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{n.classList.remove("su-hidden"),n.classList.add("su-block")},300)):(n.classList.remove("su-hidden"),window.innerWidth<768&&(document.body.style.cssText+="overflow: hidden;"),setTimeout(()=>{this.menuCloseToggle[1].focus(),this.menuToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--primary-nav-open"),n.setAttribute("aria-hidden","false")},0))}),this.menuCloseToggle.forEach(n=>{n.addEventListener("click",()=>{const s=this.parent.querySelector("#menu");this.menuToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--primary-nav-open"),s.setAttribute("aria-hidden","true"),this.menuToggle.focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden")},300)})});const t=document.querySelector('[data-role="search-focus-trap"]');this.searchToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#search");this.searchToggle.getAttribute("aria-expanded")==="true"?(this.searchToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--search-open"),n.setAttribute("aria-hidden","true"),setTimeout(()=>{n.classList.add("su-hidden"),n.classList.remove("su-block"),t.classList.add("su-hidden"),t.classList.remove("su-block")},300)):(n.classList.remove("su-hidden"),t.classList.remove("su-hidden"),setTimeout(()=>{this.searchToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--search-open"),n.setAttribute("aria-hidden","false")},0))}),this.searchCloseToggle.forEach(n=>{const s=this.parent.querySelector("#search");n.addEventListener("click",()=>{const r=this.parent.querySelector("#search");this.searchToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--search-open"),r.setAttribute("aria-hidden","true"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden"),t.classList.remove("su-block"),t.classList.add("su-hidden")},300)})}),this.preferencesToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#preferences");this.preferencesToggle.getAttribute("aria-expanded")==="true"?(this.preferencesToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--preferences-open"),n.setAttribute("aria-hidden","true"),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{n.classList.remove("su-hidden"),n.classList.add("su-block")},300)):(n.classList.remove("su-hidden"),this.preferencesCloseToggle[1].focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: hidden;"),setTimeout(()=>{this.preferencesToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--preferences-open"),n.setAttribute("aria-hidden","false")},0))}),this.preferencesCloseToggle.forEach(n=>{n.addEventListener("click",()=>{const s=this.parent.querySelector("#preferences");this.preferencesToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--preferences-open"),s.setAttribute("aria-hidden","true"),this.preferencesToggle.focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden")},300)})})}handleHeaderScroll(){window.addEventListener("scroll",t=>{const n=this.parent;if(window.scrollY>32){n.classList.add("report-header--collapsed");return}n.classList.remove("report-header--collapsed")})}}class ze{constructor(t,n){this.url=t,this.type=n,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const s=this.assetIds.map(async r=>{const o=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(o,this.requestProps).catch(l=>{throw new Error(l)})).json()});return Promise.all(s)}return await(await fetch(this.url,this.requestProps).catch(s=>{throw new Error(s)})).json()}}function We(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}async function Dt(e=null,t=""){var s,r,o,a,i,l,c,p;const n=new ze;if(e&&e.search){let u="",f="";u=`${(s=e.search.endpoint)==null?void 0:s.replace("search.html","search.json")}?profile=${e.search.profile}&collection=${e.search.collection}&query=[taxonomyContentMainTopicId:${e.mainTopicId} taxonomyContentTopicsId:${e.mainTopicId} taxonomyContentSubtopicsId:${e.mainTopicId}]&meta_taxonomyAudienceText=${We(t)}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&sort=date&num_ranks=1&log=false`,f=`${(r=e.search.endpoint)==null?void 0:r.replace("search.html","search.json")}?profile=${e.search.profile}&collection=${e.search.collection}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&sort=date&num_ranks=1&log=false`,e.contentType==="Video"&&(f+="&meta_taxonomyContentTypeId=28207",u+="&meta_taxonomyContentTypeId=28207"),n.url=u;let h=await n.fetch(),d=((i=(a=(o=h.response)==null?void 0:o.resultPacket)==null?void 0:a.results)==null?void 0:i[0])||null;return d||(n.url=f,h=await n.fetch(),d=((p=(c=(l=h.response)==null?void 0:l.resultPacket)==null?void 0:c.results)==null?void 0:p[0])||null),d}return null}const Pt='header[data-component="header-component"]',Zt='section[data-subcomponent="header-cookie-consent-banner"]',ee="su-hidden";let Z=!1;function te(){const e=document.querySelector(Zt);e&&e.classList.add(ee)}function Ae(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')},n={student:document.querySelector('button[data-click="student-persona"]'),faculty:document.querySelector('button[data-click="faculty-persona"]')};Object.values(t).forEach(s=>{s==null||s.forEach(r=>{r.classList.add(ee)})}),Object.values(n).forEach(s=>{s.setAttribute("aria-pressed","false")}),t[e]&&t[e].forEach(s=>{s.classList.remove(ee)}),n[e]&&n[e].setAttribute("aria-pressed","true")}const oe=async(e,t,n=!1)=>{let s=null;!Z&&n===!1&&(await J(1),Z=!0,te()),e&&(t===e?s="external":s=e),await Nt("persona-selector",s),n===!0&&(await J(0),Z=!1),Se("preferences_personalisation",s,!0,130),t=s,Ae(t),document.dispatchEvent(document.personaChangeEvent),window.location.reload()},Me=async e=>{e===!0?(await J(1),Z=!0,te()):(await J(0),Z=!1,te())};document.addEventListener("DOMContentLoaded",function(){var h,d;const e=document.querySelector('button[data-click="student-persona"]'),t=document.querySelector('button[data-click="faculty-persona"]'),n=document.querySelector(Pt);n&&new Bt(n);let s=null;Rt(),(d=(h=window.suHeaderProps)==null?void 0:h.pageData)!=null&&d.isStory&&(async()=>s=await Dt(window.suHeaderProps.pageData,window.suHeaderProps.audienceData))();const r=typeof window.pageController<"u"?window.pageController:null,o=document.querySelectorAll('a[data-menu="main-nav"]'),a=document.querySelector('section[data-subcomponent="header-current-story-headline"]');if(r&&o&&o.forEach(v=>{(r==null?void 0:r.id)===v.dataset.id&&(v.classList.remove("su-border-transparent"),v.classList.add("!su-text-digital-red su-border-digital-red dark:su-border-dark-mode-red dark:!su-text-dark-mode-red"))}),s&&r&&a){const v=a.querySelector('h2[data-story="announcement"]'),C=a.querySelector('h1[data-story="title"]'),g=a.querySelector('a[data-story="link"]');r!=null&&r.contentType&&v&&v.textContent(r.contentType==="Video"?"Watch next:":"Read next:"),r!=null&&r.title&&C&&C.textContent(r.title),s!=null&&s.displayUrl&&(s!=null&&s.title)&&g&&(g.textContent(s.title),g.href=s.displayUrl),(r!=null&&r.title||s!=null&&s.displayUrl)&&a.classList.remove(ee)}const i=JSON.parse(K("squiz.cdp.consent")),l=i==null?void 0:i.CDPConsent,c=document.querySelector('button[data-click="clear-preferences"]');l&&(te(),c&&(c.removeAttribute("disabled"),c.setAttribute("aria-pressed","false"),c.classList.add("su-text-digital-blue"),c.classList.add("dark:su-text-digital-blue-vivid"),c.addEventListener("click",function(){oe(null,null,!0)})));const p=document.querySelector('button[data-click="accept-consent"]'),u=document.querySelector('button[data-click="reject-consent"]');p&&p.addEventListener("click",function(){Me(!0)}),u&&u.addEventListener("click",function(){Me(!1)});const f=K("preferences_personalisation");Ae(f==="null"||!f?"external":f),e&&e.addEventListener("click",function(){oe("student",f)}),t&&t.addEventListener("click",function(){oe("faculty",f)})});function je(e){if(!e)return 0;const t=225,n=e.trim().split(/\s+/).length;return Math.ceil(n/t)}function Gt(e,t,n,s=()=>{}){const r=e.slides.length;let o=t-r+1;r%n!==0&&(o+=n-r%n);const a=document.createDocumentFragment(),i=e.slides.map(l=>l.outerHTML).join("");for(let l=0;l<o;l++){const c=document.createElement("div");for(c.innerHTML=i;c.firstChild;)c.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(c.firstChild)}e.wrapperEl.appendChild(a),e.update(),E(e,"",!1),s()}function N(e,t=()=>{}){const{slidesPerView:n,slidesPerGroup:s}=e.params,r=e.slides.length,o=Math.ceil(n+s);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<o||r%s!==0?Gt(e,o,s,t):(E(e,"",!1),t())}function re(e){const t=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(t){let n=e.pagination.bullets.length-e.slides.length+t;for(;n>0;){const s=e.pagination.bullets.pop();s&&s.remove(),n--}}}const E=(e,t,n)=>{e.slides.forEach(s=>{if(s.classList.contains("swiper-slide-active")){if(s.removeAttribute("aria-hidden"),s.removeAttribute("inert"),s.setAttribute("tabindex","-1"),t&&n){let r=null;t==="slide"?r=s:r=s.querySelector(t),r&&r.focus()}}else s.setAttribute("aria-hidden","true"),s.setAttribute("inert","true"),s.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(s=>{s.classList.contains("swiper-pagination-bullet-active")?s.setAttribute("aria-current","true"):s.removeAttribute("aria-current")})},Ut='section[data-component="basic-story-hero"]',Ft='span[data-reading="true"]',Ye="su-hidden",zt='button[data-click="open-modal"]',Wt='button[data-dismiss="modal"]',Xe='iframe[data-modal="iframe"]';function jt(e){const t=e.querySelector(Xe);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(Ye),e.hidden=!1,document.body.style.overflow="hidden"}function ie(e){const t=e.querySelector(Xe);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(Ye),e.hidden=!0,document.body.style.overflow=""}function Yt(e){const t=e.querySelectorAll(zt),n=e.querySelectorAll(Wt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||ie(s)}),s.dataset.listenerAdded="true"),jt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ie(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ie(s)})}function Xt(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const o=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{N(a),E(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),o.on("slideChange",function(){setTimeout(()=>{r?E(o,"slide",!0):E(o,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}function Qt(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(Ft);if(t&&n){const s=je(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ut).forEach(e=>{Xt(e),Yt(e),Qt(e)})});const Kt='section[data-component="combined-content-grid"]',Qe="su-hidden",Jt='button[data-click="open-modal"]',e1='button[data-dismiss="modal"]',Ke='iframe[data-modal="iframe"]';function t1(e){const t=e.querySelector(Ke),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Qe),e.hidden=!1,document.body.style.overflow="hidden"}function le(e){const t=e.querySelector(Ke),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Qe),e.hidden=!0,document.body.style.overflow=""}function s1(e){const t=e.querySelectorAll(Jt),n=e.querySelectorAll(e1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||le(s)}),s.dataset.listenerAdded="true"),t1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&le(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&le(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Kt).forEach(e=>{s1(e)})});const n1='section[data-component="content-carousel"]';function r1(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const o=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),E(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),o.on("slideChange",function(){setTimeout(()=>{r?E(o,"slide",!0):E(o,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(n1).forEach(e=>{r1(e)})});const a1='section[data-component="feature-story-hero"]',o1='span[data-reading="true"]';function i1(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(o1);if(t&&n){const s=je(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(a1).forEach(e=>{i1(e)})});const l1='section[data-component="featured-content"]',Je="su-hidden",d1='button[data-click="open-modal"]',c1='button[data-dismiss="modal"]',et='iframe[data-modal="iframe"]';function u1(e){const t=e.querySelector(et),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Je),e.hidden=!1,document.body.style.overflow="hidden"}function de(e){const t=e.querySelector(et),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Je),e.hidden=!0,document.body.style.overflow=""}function f1(e){const t=e.querySelectorAll(d1),n=e.querySelectorAll(c1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||de(s)}),s.dataset.listenerAdded="true"),u1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&de(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&de(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(l1).forEach(e=>{f1(e)})});const p1='section[data-component="horizontal-video-testimonials"]',tt="su-hidden",h1='button[data-click="open-modal"]',m1='button[data-dismiss="modal"]',st='iframe[data-modal="iframe"]';function C1(e){const t=e.querySelector(st);if(t){const n=t.getAttribute("src"),s=n&&n.replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(tt),e.hidden=!1,document.body.style.overflow="hidden"}function ce(e){const t=e.querySelector(st);if(t){const n=t.getAttribute("src"),s=n&&n.replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(tt),e.hidden=!0,document.body.style.overflow=""}function g1(e){const t=e.querySelectorAll(h1),n=e.querySelectorAll(m1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||ce(s)}),s.dataset.listenerAdded="true"),C1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ce(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(p1).forEach(e=>{g1(e)})});const v1='section[data-component="image-gallery-modal"]',y1='button[data-click="open-gallery-modal"]',w1='div[data-modal="modal"]',L1='button[data-dismiss="modal"]',nt="su-hidden";let xe;const b1=(e,t)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(i=>!i.hasAttribute("disabled")&&!i.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],o=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),o.focus()):!e.shiftKey&&document.activeElement===o&&(e.preventDefault(),r.focus())};function E1(e){e.classList.remove(nt),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&b1(t,e)})}function ue(e){e.classList.add(nt),e.hidden=!0,document.body.style.overflow=""}function S1(e){const t=e.dataset.modalId;xe=new B(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function A1(e){const t=e.querySelector(w1),n=e.querySelector(y1),s=e.querySelector(L1);n&&n.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",o=>{r.contains(o.target)||ue(t)}),t.dataset.listenerAdded="true"),E1(t),S1(t)}),s&&s.addEventListener("click",function(){ue(t),xe.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(ue(t),xe.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(v1).forEach(e=>{A1(e)})});const x1='[data-component="interactive-photo-card"]',_1="[data-card-inner]",T1="[data-card-inner-content]";function k1(e){var s;const n=((e.style.transform&&parseInt((s=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:s[1])||0)+180)%360;e.style.transform=`rotateY(${n}deg)`}function I1(e){const t=e.querySelector(_1);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>k1(t))}const M1=e=>{e.forEach(t=>{const n=t.getAttribute("aria-hidden")==="true"?"false":"true",s=t.querySelector("button");s&&(s.tabIndex=n==="true"?"-1":""),t.setAttribute("aria-hidden",n)})},$1=e=>{const t=e.querySelectorAll(T1);t.length&&t.forEach(n=>n.addEventListener("click",()=>M1(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(x1).forEach(e=>{I1(e),$1(e)})});function O1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:n,summary:s,image:r,taxonomyContentTypeText:o,contentTopic:a,contentSubtopic:i,taxonomyContentMainTopicText:l,contentCategory:c,featuredVideo:p,taxonomyContentMainTopicLandingPageUrl:u,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:h,imageAlt:d,authorName:v,authorImage:C,author:g,isTeaser:y,storySource:m,assetHref:S},date:$,liveUrl:O}){const V=v!==void 0?v:g,A=C!==""?C:void 0,x=r;d=r&&d?d:"",!d&&!x&&(d="a close up image of an intricate stone arch");const L=p,I=n||s;let H=l;!H&&a&&(H=a instanceof Array?a[0]:a),!H&&i&&(H=i instanceof Array?i[0]:i);const G=u;let D=o?o[0]:"";return!D&&c&&(D=c instanceof Array?c[0]:c),S&&t[0]==="link"&&(O=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(I)?I[0]:I,liveUrl:Array.isArray(O)?O[0]:O,imageUrl:Array.isArray(x)?x[0]:x,imageAlt:Array.isArray(d)?d[0]:d,taxonomy:Array.isArray(H)?H[0]:H,taxonomyUrl:Array.isArray(G)?G[0]:G,type:Array.isArray(D)?D[0]:D,videoUrl:Array.isArray(L)?L[0]:L,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(V)?V[0]:V,authorAvatar:Array.isArray(A)?A[0]:A,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(h)?h[0]:h,isTeaser:Array.isArray(y)?y[0]:y,storySource:Array.isArray(m)?m[0]:m}}function fe(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function rt(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}const V1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(t+s)%16|0,t=Math.floor(t/16)),(n==="x"?s:s&3|8).toString(16)})},H1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),q1=()=>typeof crypto<"u"?H1():V1();async function N1(e=null,t="",n=null){var r,o,a,i,l,c,p,u,f,h,d,v,C,g,y,m,S,$,O;const s=new ze;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const V=`
            ${(a=(o=e==null?void 0:e.search)==null?void 0:o.endpoint)==null?void 0:a.replace(/\.html/g,".json")}
            ?profile=${(i=e==null?void 0:e.search)==null?void 0:i.profile}
            ...
            &meta_taxonomyAudienceText=${We(t)}&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;let A=V;n&&(n!=null&&n.behavioural)&&(A=`${(p=(c=e==null?void 0:e.search)==null?void 0:c.endpoint)==null?void 0:p.replace(/\.html/g,".json")}
                ?profile=${(u=e==null?void 0:e.search)==null?void 0:u.profile}
                &collection=${(f=e==null?void 0:e.search)==null?void 0:f.collection}${n.partialQuery}&num_ranks=3&log=false&meta_isTeaser=false`),s.url=A.replace(/\n+|\t+| {2,}/g,"");let L=((d=(h=(await s.fetch()).response)==null?void 0:h.resultPacket)==null?void 0:d.results)||null;if(L&&L.length<3&&(s.url=V.replace(/\n+|\t+| {2,}/g,""),L=((C=(v=(await s.fetch()).response)==null?void 0:v.resultPacket)==null?void 0:C.results)||null,L&&L.length<3)){const H=`${(y=(g=e==null?void 0:e.search)==null?void 0:g.endpoint)==null?void 0:y.replace(/\.html/g,".json")}
                    ?profile=${(m=e==null?void 0:e.search)==null?void 0:m.profile}
                    &collection=${(S=e==null?void 0:e.search)==null?void 0:S.collection}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;s.url=H.replace(/\n+|\t+| {2,}/g,""),L=((O=($=(await s.fetch()).response)==null?void 0:$.resultPacket)==null?void 0:O.results)||null}return L}return null}const pe={WRAPPER:'[data-role="link-list-wrap"]',TOGGLE:'[data-role="link-drawer-toggle"]',DRAWER:'[data-role="link-drawer"]'},b={ACTIVE:"su-rotate-90",INACTIVE:"su-rotate-[-90deg]",OPEN:"su-h-auto",CLOSED:"su-h-0",VISIBLE:"su-opacity-[1]",HIDDEN:"su-opacity-[0]",NO_STORIES:"su-link-list-no-stories"};function R1(e,t){var s;if(!(((s=e==null?void 0:e.dataset)==null?void 0:s.active)==="true")){e.dataset.active=!0,e.classList.remove(b.INACTIVE),e.classList.add(b.ACTIVE),t.classList.remove(b.CLOSED),t.classList.add(b.OPEN);return}e.dataset.active=!1,e.classList.add(b.INACTIVE),e.classList.remove(b.ACTIVE),t.classList.add(b.CLOSED),t.classList.remove(b.OPEN)}function B1(e){const t=document.body.getBoundingClientRect().height,n=window.scrollY+window.innerHeight;if(window.scrollY>=Math.round(30/100*document.body.clientHeight)&&n<=t-700){e.classList.remove(b.HIDDEN),e.classList.remove("su-bottom-[-100px]"),e.classList.add(b.VISIBLE),e.classList.add("su-bottom-0");return}e.classList.remove(b.VISIBLE),e.classList.add("su-bottom-[-100px]"),e.classList.add(b.HIDDEN),e.classList.remove("su-bottom-0")}function D1(e,t){return`
    ...
    `}function P1(e,t,n){if(!e.length){t.classList.add(b.NO_STORIES);return}const[s,r,o]=e;n.innerHTML=`
        ...
        ${o?`<article class="su-pt-15 lg:su-pt-36">${o}</article>`:""}
    `,t.classList.remove(b.NO_STORIES)}async function Z1(e,t,n,s,r,o){const i=(await N1(e,o,t)).map(({title:l,indexUrl:c})=>D1(l,c));P1(i,n,r),G1(n,s,r)}function G1(e,t,n){t.addEventListener("click",function(){R1(t,n)}),window.addEventListener("scroll",function(){B1(e)})}function U1(e,t,n,s){if(!e||!window.pageController)return;const r=window.pageController,o=r.topicsQuery?r.topicsQuery():null;Z1(r,o,e,t,n,s)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(pe.WRAPPER),t=document.querySelector(pe.TOGGLE),n=document.querySelector(pe.DRAWER),s=K("preferences_personalisation");U1(e,t,n,s)});const F1='section[data-component="media-carousel"]';function z1(e){const t=e.dataset.uniqueId,n=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),E(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}}),s=n.slides.length,r=n.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(s-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),n.on("slideChange",function(){setTimeout(()=>{a?E(n,"h2 a, h3 a, button",!0):E(n,"",!1)},100)})}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(F1).forEach(e=>{z1(e)})});const W1='button[data-role="copy-link"]';function j1(e){e.addEventListener("click",function(){navigator.clipboard.writeText(window.location.href).then(()=>{const t=document.querySelector("[data-copy-text]");t.textContent="Copied",setTimeout(()=>{t.textContent="Copy link"},3e3)})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(W1).forEach(e=>{j1(e)})});const Y1='section[data-component="multicolumn-listing"]',at="su-hidden",X1='button[data-click="open-modal"]',Q1='button[data-dismiss="modal"]',ot='iframe[data-modal="iframe"]';function K1(e){const t=e.querySelector(ot),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(at),e.hidden=!1,document.body.style.overflow="hidden"}function he(e){const t=e.querySelector(ot),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(at),e.hidden=!0,document.body.style.overflow=""}function J1(e){const t=e.querySelectorAll(X1),n=e.querySelectorAll(Q1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||he(s)}),s.dataset.listenerAdded="true"),K1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&he(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&he(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Y1).forEach(e=>{J1(e)})});const es='section[data-component="sidebar-navigation"]',ts='nav[data-nav="nav"]',se="su-hidden",ss='button[data-click="toggle-nav"]',ns="su-bg-digital-red su-text-white dark:su-bg-dark-mode-red dark:aria-expanded:su-text-black-true",rs='span[data-label="button"]';function it(e,t){const n=e.querySelector(rs),s=e.querySelector('svg[data-icon="bars"]'),r=e.querySelector('svg[data-icon="xmark"]');e.setAttribute("aria-expanded",t.toString()),ns.split(" ").forEach(o=>{e.classList.toggle(o,t)}),s&&(s.classList.toggle(`!${se}`,t),s.hidden=t),r&&(r.classList.toggle(`!${se}`,!t),r.hidden=!t),n&&(n.innerHTML=t?n.getAttribute("data-label-close"):n.getAttribute("data-label-open"))}function $e(e,t){e.classList.remove(se),e.hidden=!1,it(t,!0)}function U(e,t){e.classList.add(se),e.hidden=!0,it(t,!1)}function as(e){const t=e.querySelector(ss),n=e.querySelector(ts);let s;t&&t.addEventListener("click",function(){const r=t.getAttribute("aria-expanded")==="true";n.dataset.listenerAdded||(document.addEventListener("click",o=>{const a=n.contains(o.target),i=t.contains(o.target);!a&&!i&&U(n,t)}),n.dataset.listenerAdded="true"),r?U(n,t):$e(n,t)}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&t&&U(n,t)}),window.addEventListener("resize",()=>{clearTimeout(s),s=setTimeout(()=>{window.innerWidth>991?n&&t&&$e(n,t):n&&t&&U(n,t)},10)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(es).forEach(e=>{as(e)})});function F(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function z(e,t){const n=e.querySelector('svg[data-control="play"]'),s=e.querySelector('svg[data-control="pause"]'),r=!t;e.setAttribute("aria-pressed",String(r)),n.classList.toggle("su-hidden",r),n.hidden=r,s.classList.toggle("su-hidden",!r),s.hidden=!r,e.innerHTML=`
  ...
  `}const os='section[data-component="single-image-video"]',is='iframe[data-role="video-player"]',ls='button[data-role="video-control"]',lt="su-hidden",ds='button[data-click="open-modal"]',cs='button[data-dismiss="modal"]',dt='iframe[data-modal="iframe"]',us=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(i=>!i.hasAttribute("disabled")&&!i.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],o=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),o.focus()):!e.shiftKey&&document.activeElement===o&&(e.preventDefault(),r.focus())};function fs(e){const t=e.querySelector(dt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(lt),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&us(r,e)})}function me(e){const t=e.querySelector(dt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(lt),e.hidden=!0,document.body.style.overflow=""}function ps(e){const t=e.querySelectorAll(ds),n=e.querySelectorAll(cs);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||me(s)}),s.dataset.listenerAdded="true"),fs(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&me(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&me(s)})}function hs(e){const t=e.querySelector(is),n=e.querySelector(ls);let s=!1;if(!t||!n)return;new IntersectionObserver(o=>{o.forEach(a=>{a.isIntersecting&&!s?(F(t,"play"),z(n,!1)):a.isIntersecting||(F(t,"pause"),z(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(F(t,"pause"),z(n,!0),s=!0):(F(t,"play"),z(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(os).forEach(e=>{ps(e),hs(e)})});const ms='section[data-component="stories-carousel"]',ct="su-hidden",Cs='button[data-click="open-modal"]',gs='button[data-dismiss="modal"]',ut='iframe[data-modal="iframe"]';function vs(e){const t=e.querySelector(ut),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(ct),e.hidden=!1,document.body.style.overflow="hidden"}function Ce(e){const t=e.querySelector(ut),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(ct),e.hidden=!0,document.body.style.overflow=""}function ys(e){const t=e.querySelectorAll(Cs),n=e.querySelectorAll(gs);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||Ce(s)}),s.dataset.listenerAdded="true"),vs(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&Ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&Ce(s)})}function ws(e){const t=e.dataset.uniqueId;new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ms).forEach(e=>{ws(e),ys(e)})});const Ls='section[data-component="subscribe-to-stanford-report"]';function bs(e){const t=e.querySelector("form"),n=t.querySelector('input[type="email"]'),s=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let o="";const a=n.value;if(!a||!a.match(/\w+@\w+\.\w+/)){o='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',s.innerHTML=o,n.setAttribute("aria-describedby","subscription-error");return}s.innerHTML="",n.removeAttribute("aria-describedby"),r.target.submit()}),n.addEventListener("keyup",function(){const r=n.value,o=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(o.innerHTML="",n.removeAttribute("aria-describedby"))})}function Es(){document.querySelectorAll(Ls).forEach(e=>{bs(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",Es);const Ss='section[data-component="subtopic-subnav-component"]',As='div[data-list="subnav"]';function xs(e){return e.filter((t,n)=>n===e.findIndex(s=>{var r,o;return((r=s.taxonomyFeaturedUnitText)==null?void 0:r[0])===((o=t.taxonomyFeaturedUnitText)==null?void 0:o[0])}))}const _s=async e=>{if(!e||e.length===0)return null;const t=xs(e),n=[];return t.forEach(s=>{var o,a,i;const r=s;r&&((o=r.taxonomyFeaturedUnitText)!=null&&o[0])&&n.push({asset_name:(a=r.taxonomyFeaturedUnitText)==null?void 0:a[0],asset_url:((i=r.taxonomyFeaturedUnitLandingPageUrl)==null?void 0:i[0])||""})}),n};function Ts({navigation:e}){let t="scrollable-list__item su-mb-0 su-relative after:su-h-22 after:su-w-[1px] after:su-bg-black-60 after:su-mx-12 lg:after:su-mx-18";const n="su-text-inherit su-text-black su-font-semi-bold su-text-16 lg:su-text-18 lg:su-leading-[21.6px] su-no-underline hover:su-underline dark:su-text-white hover:su-text-digital-red dark:hover:su-text-dark-mode-red";return`
        <div class="scrollable-list su-w-full md:su-justify-center su-flex su-nowrap su-mt-15 md:su-mt-26 lg:su-mt-19">
            ...
            ${e.map((s,r,o)=>{const a=s.asset_name;return r+1===o.length&&(t="su-relative su-mb-0"),`
                <li class="${t}">
                    <a class="${n}" href="${s.asset_url}">
                    ${a}
                    </a>
                </li>
                `}).join("")}
    ...
    `}function ks(e){const t=e.querySelector(As);t&&document.addEventListener("topicLoader",async n=>{if(n.detail){const s=await _s(n.detail.cards);t.innerHTML=Ts({navigation:s})}},!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ss).forEach(e=>{ks(e)})});function Is({offsetNum:e,pageNumber:t,index:n}){return`
        <button
            data-offset="${e}"
    ...
    `}function Ms({pageNumber:e,allResults:t,resultsPerPage:n,paginationRange:s,currentPage:r=1}){const o=Math.ceil(t/n),a=s,i=e-n,l=e+n,c="su-text-black-50",p=[],u=[];for(let y=0;y<o;y++){const m=y*n+1;u.push(m)}let f=[...u],h=[...u];const d=u.indexOf(r),v=Math.floor(a*.5);if((d<v||o===a)&&(f=f.filter((y,m)=>y>r&&m<a),h=h.filter(y=>y<r)),d>=v&&o!==a)if(f=f.filter((y,m)=>y>r&&m<=d+v),f.length===v)h=h.filter((y,m)=>y<r&&m>=d-v);else{const y=f.length?a-f.length:a;h=h.filter((m,S)=>m<r&&S>d-y)}return[...h,r,...f].map(y=>({offset:y,index:u.indexOf(y)+1})).forEach(({offset:y,index:m})=>{p.push(Is({offsetNum:y,pageNumber:e,index:m}))}),o>1?`<div class="su-mx-auto su-component-container">
                <div class="su-flex su-gap-9 su-items-center su-justify-center su-rs-mt-4 lg:su-rs-mt-7">
                    <button
                        type="button"
                        class="su-size-24 su-font-serif su-flex su-items-center su-justify-center dark:su-text-white ${i<1?c:""}"
                        ${i<1?"disabled":""}
                        data-offset="${i<1?1:i}"
                    ...
                    <button
                    type="button"
                        class="su-size-24 su-font-serif su-flex su-items-center su-justify-center dark:su-text-white ${l>u[u.length-1]?c:""}"
            ...
            </div>`:""}function $s(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var _e={exports:{}},w={},Te={exports:{}},R={};function ft(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function Os(e,t,n){}function Vs(e,t,n){}var Hs=/javascript\s*\:/img;function qs(e,t){return Hs.test(t)?"":t}R.whiteList=ft();R.getDefaultWhiteList=ft;R.onAttr=Os;R.onIgnoreAttr=Vs;R.safeAttrValue=qs;var Ns={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},P=Ns;function Rs(e,t){e=P.trimRight(e),e[e.length-1]!==";"&&(e+=";");var n=e.length,s=!1,r=0,o=0,a="";function i(){if(!s){var p=P.trim(e.slice(r,o)),u=p.indexOf(":");if(u!==-1){var f=P.trim(p.slice(0,u)),h=P.trim(p.slice(u+1));if(f){var d=t(r,a.length,f,h,p);d&&(a+=d+"; ")}}}r=o+1}for(;o<n;o++){var l=e[o];if(l==="/"&&e[o+1]==="*"){var c=e.indexOf("*/",o+2);if(c===-1)break;o=c+1,r=o+1,s=!1}else l==="("?s=!0:l===")"?s=!1:l===";"?s||i():l===`
`&&i()}return P.trim(a)}var Bs=Rs,W=R,Ds=Bs;function Oe(e){return e==null}function Ps(e){var t={};for(var n in e)t[n]=e[n];return t}function pt(e){e=Ps(e||{}),e.whiteList=e.whiteList||W.whiteList,e.onAttr=e.onAttr||W.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||W.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||W.safeAttrValue,this.options=e}pt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onAttr,o=n.onIgnoreAttr,a=n.safeAttrValue,i=Ds(e,function(l,c,p,u,f){var h=s[p],d=!1;if(h===!0?d=h:typeof h=="function"?d=h(u):h instanceof RegExp&&(d=h.test(u)),d!==!0&&(d=!1),u=a(p,u),!!u){var v={position:c,sourcePosition:l,source:f,isWhite:d};if(d){var C=r(p,u,v);return Oe(C)?p+":"+u:C}else{var C=o(p,u,v);if(!Oe(C))return C}}});return i};var Zs=pt;(function(e,t){var n=R,s=Zs;function r(a,i){var l=new s(i);return l.process(a)}t=e.exports=r,t.FilterCSS=s;for(var o in n)t[o]=n[o];typeof window<"u"&&(window.filterCSS=e.exports)})(Te,Te.exports);var ke=Te.exports,Ie={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,n=t.exec(e);return n?n.index:-1}},Gs=ke.FilterCSS,Us=ke.getDefaultWhiteList,ne=Ie;function ht(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var mt=new Gs;function Fs(e,t,n){}function zs(e,t,n){}function Ws(e,t,n){}function js(e,t,n){}function Ct(e){return e.replace(Xs,"&lt;").replace(Qs,"&gt;")}function Ys(e,t,n,s){if(n=bt(n),t==="href"||t==="src"){if(n=ne.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(t==="background"){if(j.lastIndex=0,j.test(n))return""}else if(t==="style"){if(Ve.lastIndex=0,Ve.test(n)||(He.lastIndex=0,He.test(n)&&(j.lastIndex=0,j.test(n))))return"";s!==!1&&(s=s||mt,n=s.process(n))}return n=Et(n),n}var Xs=/</g,Qs=/>/g,Ks=/"/g,Js=/&quot;/g,en=/&#([a-zA-Z0-9]*);?/gim,tn=/&colon;?/gim,sn=/&newline;?/gim,j=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,Ve=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,He=/u\s*r\s*l\s*\(.*/gi;function gt(e){return e.replace(Ks,"&quot;")}function vt(e){return e.replace(Js,'"')}function yt(e){return e.replace(en,function(n,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function wt(e){return e.replace(tn,":").replace(sn," ")}function Lt(e){for(var t="",n=0,s=e.length;n<s;n++)t+=e.charCodeAt(n)<32?" ":e.charAt(n);return ne.trim(t)}function bt(e){return e=vt(e),e=yt(e),e=wt(e),e=Lt(e),e}function Et(e){return e=gt(e),e=Ct(e),e}function nn(){return""}function rn(e,t){typeof t!="function"&&(t=function(){});var n=!Array.isArray(e);function s(a){return n?!0:ne.indexOf(e,a)!==-1}var r=[],o=!1;return{onIgnoreTag:function(a,i,l){if(s(a))if(l.isClosing){var c="[/removed]",p=l.position+c.length;return r.push([o!==!1?o:l.position,p]),o=!1,c}else return o||(o=l.position),"[removed]";else return t(a,i,l)},remove:function(a){var i="",l=0;return ne.forEach(r,function(c){i+=a.slice(l,c[0]),l=c[1]}),i+=a.slice(l),i}}}function an(e){for(var t="",n=0;n<e.length;){var s=e.indexOf("<!--",n);if(s===-1){t+=e.slice(n);break}t+=e.slice(n,s);var r=e.indexOf("-->",s);if(r===-1)break;n=r+3}return t}function on(e){var t=e.split("");return t=t.filter(function(n){var s=n.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),t.join("")}w.whiteList=ht();w.getDefaultWhiteList=ht;w.onTag=Fs;w.onIgnoreTag=zs;w.onTagAttr=Ws;w.onIgnoreTagAttr=js;w.safeAttrValue=Ys;w.escapeHtml=Ct;w.escapeQuote=gt;w.unescapeQuote=vt;w.escapeHtmlEntities=yt;w.escapeDangerHtml5Entities=wt;w.clearNonPrintableCharacter=Lt;w.friendlyAttrValue=bt;w.escapeAttrValue=Et;w.onIgnoreTagStripAll=nn;w.StripTagBody=rn;w.stripCommentTag=an;w.stripBlankChar=on;w.attributeWrapSign='"';w.cssFilter=mt;w.getDefaultCSSWhiteList=Us;var ae={},q=Ie;function ln(e){var t=q.spaceIndex(e),n;return t===-1?n=e.slice(1,-1):n=e.slice(1,t+1),n=q.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function dn(e){return e.slice(0,2)==="</"}function cn(e,t,n){var s="",r=0,o=!1,a=!1,i=0,l=e.length,c="",p="";e:for(i=0;i<l;i++){var u=e.charAt(i);if(o===!1){if(u==="<"){o=i;continue}}else if(a===!1){if(u==="<"){s+=n(e.slice(r,i)),o=i,r=i;continue}if(u===">"||i===l-1){s+=n(e.slice(r,o)),p=e.slice(o,i+1),c=ln(p),s+=t(o,s.length,c,p,dn(p)),r=i+1,o=!1;continue}if(u==='"'||u==="'")for(var f=1,h=e.charAt(i-f);h.trim()===""||h==="=";){if(h==="="){a=u;continue e}h=e.charAt(i-++f)}}else if(u===a){a=!1;continue}}return r<l&&(s+=n(e.substr(r))),s}var un=/[^a-zA-Z0-9\\_:.-]/gim;function fn(e,t){var n=0,s=0,r=[],o=!1,a=e.length;function i(f,h){if(f=q.trim(f),f=f.replace(un,"").toLowerCase(),!(f.length<1)){var d=t(f,h||"");d&&r.push(d)}}for(var l=0;l<a;l++){var c=e.charAt(l),p,u;if(o===!1&&c==="="){o=e.slice(n,l),n=l+1,s=e.charAt(n)==='"'||e.charAt(n)==="'"?n:hn(e,l+1);continue}if(o!==!1&&l===s){if(u=e.indexOf(c,l+1),u===-1)break;p=q.trim(e.slice(s+1,u)),i(o,p),o=!1,l=u,n=l+1;continue}if(/\s|\n|\t/.test(c))if(e=e.replace(/\s|\n|\t/g," "),o===!1)if(u=pn(e,l),u===-1){p=q.trim(e.slice(n,l)),i(p),o=!1,n=l+1;continue}else{l=u-1;continue}else if(u=mn(e,l-1),u===-1){p=q.trim(e.slice(n,l)),p=qe(p),i(o,p),o=!1,n=l+1;continue}else continue}return n<e.length&&(o===!1?i(e.slice(n)):i(o,qe(q.trim(e.slice(n))))),q.trim(r.join(" "))}function pn(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="="?t:-1}}function hn(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="'"||n==='"'?t:-1}}function mn(e,t){for(;t>0;t--){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Cn(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function qe(e){return Cn(e)?e.substr(1,e.length-2):e}ae.parseTag=cn;ae.parseAttr=fn;var gn=ke.FilterCSS,k=w,St=ae,vn=St.parseTag,yn=St.parseAttr,Q=Ie;function Y(e){return e==null}function wn(e){var t=Q.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=Q.trim(e.slice(t+1,-1));var n=e[e.length-1]==="/";return n&&(e=Q.trim(e.slice(0,-1))),{html:e,closing:n}}function Ln(e){var t={};for(var n in e)t[n]=e[n];return t}function bn(e){var t={};for(var n in e)Array.isArray(e[n])?t[n.toLowerCase()]=e[n].map(function(s){return s.toLowerCase()}):t[n.toLowerCase()]=e[n];return t}function At(e){e=Ln(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=k.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=bn(e.whiteList||e.allowList):e.whiteList=k.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":k.attributeWrapSign,e.onTag=e.onTag||k.onTag,e.onTagAttr=e.onTagAttr||k.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||k.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||k.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||k.safeAttrValue,e.escapeHtml=e.escapeHtml||k.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new gn(e.css))}At.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onTag,o=n.onIgnoreTag,a=n.onTagAttr,i=n.onIgnoreTagAttr,l=n.safeAttrValue,c=n.escapeHtml,p=t.attributeWrapSign,u=t.cssFilter;n.stripBlankChar&&(e=k.stripBlankChar(e)),n.allowCommentTag||(e=k.stripCommentTag(e));var f=!1;n.stripIgnoreTagBody&&(f=k.StripTagBody(n.stripIgnoreTagBody,o),o=f.onIgnoreTag);var h=vn(e,function(d,v,C,g,y){var m={sourcePosition:d,position:v,isClosing:y,isWhite:Object.prototype.hasOwnProperty.call(s,C)},S=r(C,g,m);if(!Y(S))return S;if(m.isWhite){if(m.isClosing)return"</"+C+">";var $=wn(g),O=s[C],V=yn($.html,function(A,x){var L=Q.indexOf(O,A)!==-1,I=a(C,A,x,L);return Y(I)?L?(x=l(C,A,x,u),x?A+"="+p+x+p:A):(I=i(C,A,x,L),Y(I)?void 0:I):I});return g="<"+C,V&&(g+=" "+V),$.closing&&(g+=" /"),g+=">",g}else return S=o(C,g,m),Y(S)?c(g):S},c);return f&&(h=f.remove(h)),h};var En=At;(function(e,t){var n=w,s=ae,r=En;function o(i,l){var c=new r(l);return c.process(i)}t=e.exports=o,t.filterXSS=o,t.FilterXSS=r,function(){for(var i in n)t[i]=n[i];for(var l in s)t[l]=s[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(_e,_e.exports);var Sn=_e.exports;const M=$s(Sn);var An=Array.isArray,xt=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var n=void 0;if(An(e))for(var s=0,r=e.length;s<r;)n=xt(e[s++]),n&&(t&&(t+=" "),t+=n);else for(n in e)n&&e[n]&&(t&&(t+=" "),t+=n)}return t};function _t(){for(var e=arguments.length,t=0,n,s,r="";t<e;)n=arguments[t++],n&&(s=xt(n),s&&(r&&(r+=" "),r+=s));return r}function Ne({children:e="",imageUrl:t,imageAlt:n="",aspectRatio:s="card-small",videoUrl:r}){return`
    <span
      class="${_t("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",s==="card-small"&&"su-aspect-[3/2]",s==="card-medium"&&"su-aspect-[3/2]",s==="card-large"&&"su-aspect-[3/2]",s==="card-featured"&&"su-aspect-[3/2]",s==="square"&&"su-aspect-[1/1]",s==="video"&&"su-aspect-[16/9]",s==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${r?`
  ...
  `}const xn={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function Re({imageUrl:e,alt:t="",aspectRatio:n,videoUrl:s,size:r="small",title:o="",videoIconClasses:a,uniqueId:i}){if(s){const l=`
        ...
        ${s?`
          <span
            class="${_t("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",xn[r],a)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${i}"
      >
        ${Ne({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:n,children:l})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${Ne({imageUrl:e,imageAlt:t,aspectRatio:n})}
    </div>
  `}function _n(e,t){if(!t)return!0;const n=e.match(/(\d+-\d+-\d+)/)[0],s=t.match(/(\d+-\d+-\d+)/)[0];return n===s}function Tn({start:e,end:t}){if(!e&&!t)return null;const n=new Date(e),s=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let o="";const a=_n(e,t);a||(delete r.time,delete r.hour,delete r.minute);const i=new Intl.DateTimeFormat("en-US",r).format(n),l=t?new Intl.DateTimeFormat("en-US",r).format(s):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${i.replace(/, /," | ")}</span>`:(o+=`${i} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${o}</span>`)}function kn(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Mn="light";function ve({variant:e=Mn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function On({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    >
    ...
    </svg>`}const Pe="solid";function Dn({variant:e=Pe}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get(Pe)}function we(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Pn="light";function Ze({variant:e=Pn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const _={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},Yn={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function Xn({data:{title:e,description:t,liveUrl:n,imageUrl:s,imageAlt:r,taxonomy:o,taxonomyUrl:a,type:i,date:l,endDate:c,videoUrl:p,uniqueID:u},cardSize:f="small"}){const h=Yn[f],d=new Map;return d.set("alert",kn()),d.set("analysis & insights",ge()),d.set("analysis &amp; insights",ge()),d.set("analysis&nbsp;&amp;&nbsp;insights",ge()),d.set("case study",ve({variant:"light"})),d.set("case&nbsp;study",ve({variant:"light"})),d.set("casestudy",ve({variant:"light"})),d.set("event",Vn()),d.set("event&nbsp;highlights",Be()),d.set("event highlights",Be()),d.set("feature",Hn()),d.set("infographic",qn()),d.set("in&nbsp;the&nbsp;news",ye()),d.set("in the news",ye()),d.set("inthenews",ye()),d.set("leadership&nbsp;messages",De()),d.set("leadership messages",De()),d.set("obituary",Nn()),d.set("opinion",Rn()),d.set("photo",Bn()),d.set("policy&nbsp;brief",Ze({variant:"light"})),d.set("policy brief",Ze({variant:"light"})),d.set("poll/quiz",we()),d.set("poll / quiz",we()),d.set("poll&nbsp;/&nbsp;quiz",we()),d.set("profile",Zn()),d.set("research",Gn()),d.set("solutions",Un()),d.set("survey",Fn()),d.set("timeline",zn()),d.set("tips & takeaways",Le()),d.set("tips &amp; takeaways",Le()),d.set("tips&nbsp;&amp;&nbsp;takeaways",Le()),d.set("university&nbsp;updates",Ge()),d.set("university updates",Ge()),d.set("announcement",In()),d.set("news",$n()),d.set("q&amp;a",X()),d.set("q&a",X()),d.set("q & a",X()),d.set("q&nbsp;&amp;&nbsp;a",X()),d.set("video",Wn()),d.set("podcast",Dn({variant:"light"})),d.set("book",On({className:""})),`
    <article aria-label="${e}" class="${_.root} ${h.gap}" data-testid="horizontal-card" >
      
    ${f==="large"?`
        <div class="${_.imageWrapper} ${h.imageWrapper}">
          ${s?`
            ${Re({imageUrl:s,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"card-large",size:f,uniqueId:u})}
          `:""}
        </div>
      `:""}

      ${f==="small"&&s?`
        <div class="${_.imageWrapper} ${h.imageWrapper} su-relative">
            ${Re({imageUrl:s,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"large",size:f,uniqueId:u})}
        </div>
      `:""}

      <div class="${_.contentWrapper} ${h.contentGap}">
        ${f==="small"&&o?`
          <p class="${_.taxonomy}" data-testid="horizontal-card-taxonomy">
            <a href="${a}" class="${_.taxonomyLink}">
              ${M(o)}
            </a>
          </p>
        `:""}

        <h3 class="${_.heading} ${h.title}">
          <a href="${n}" class="${_.link}">
            ${M(e)}
            ${rt(n)?`
        ...
        ${f==="large"&&i?`
          <p data-testid="horizontal-card-type" class="${_.type}">
            ${d.get(i.toLowerCase())}
            <span class="${_.typeText}">${M(i)}</span>
          </p>
        `:""}

        ${f==="large"&&t?`
          <div data-testid="horizontal-card-description" class="${_.description}">
  ...
  `:C;return`
    <article aria-label="${e}" class="${T.root}" data-testid="narrow-horizontal-card">
      <div class="${T.contentWrapper}">
        ...
        ${i==="Announcements"&&c?`
          <p data-testid="vertical-card-taxonomy" class="${T.taxonomy}">
            ${l?`
              <a href="${l}" class="${T.taxonomyLink}">
                ${M(c)}
              </a>
            `:`
              <span>${M(c)}</span>
        ...
        <h3 class="${T.heading}">
          <a class="${T.link}" href="${n}">
            <span>${M(e)}</span>
            ${v?`
              <span class="${T.linkIcon}">
        ...
        ${t?`
          <div data-testid="narrow-horizontal-card-description" class="${T.description}">
            <div class="${T.descriptionContent}">
              ${M(t)}
            </div>
          </div>
        `:""}

        ${i==="Leadership Messages"?`
          <div class="${T.authorWrapper} ${d}">
            ${h?`
              ${Qn({image:h,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${g}
          </div>
        `:""}

        ${r&&i!=="Leadership Messages"&&i!=="In the News"?`
          <p class="${T.date}">
            ${fe(r)}
          </p>
        `:""}
  ...
  `}function Jn(e){const{videoId:t,className:n="",noAutoPlay:s,title:r,isVertical:o}=e;return`
        <iframe
            width="${o?315:560}"
            height="${o?560:315}"
            class="${n}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const er='section[data-component="topic-subtopic-listing"]',tr='[data-element="topics-list"]',Tt='[data-element="topics-pagination"]',kt="su-hidden",sr='section[data-element="modal-wrapper"]',nr='button[data-click="open-modal"]',rr='button[data-dismiss="modal"]',It='iframe[data-modal="iframe"]';function ar(e){const t=e.querySelector(It),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(kt),e.hidden=!1,document.body.style.overflow="hidden"}function be(e){const t=e.querySelector(It),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(kt),e.hidden=!0,document.body.style.overflow="hidden"}function Mt(e){const t=e.querySelectorAll(nr),n=e.querySelectorAll(rr);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||be(s)}),s.dataset.listenerAdded="true"),ar(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&be(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&be(s)})}async function or(e){const{offset:t,query:n,endpoint:s}=e,r=s+n+`&start_rank=${t}`;return await(await fetch(r).catch(i=>{throw new Error(i)})).json()}function ir(e,t,n,s){e.querySelector(tr).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(Tt).innerHTML=n,e.querySelector(sr).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),Mt(e),$t(e)}async function lr(e){var f,h,d,v,C;const{offset:t,query:n,endpoint:s,display:r,section:o}=e,a=await or({offset:t,query:n,endpoint:s}),i=(h=(f=a==null?void 0:a.response)==null?void 0:f.resultPacket)==null?void 0:h.resultsSummary;if(!i){console.warn("Missing resultsSummary from API response");return}const l=[],c=[];(C=(v=(d=a==null?void 0:a.response)==null?void 0:d.resultPacket)==null?void 0:v.results)==null||C.forEach(g=>{const y=q1(),m=O1(g);m.uniqueID=y,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(m.displayConfiguration=r,l.push(`<div class="su-relative su-grow">${Kn({data:m,cardType:"narrowhorizontal"})}</div>`)):l.push(`<div class="su-relative su-grow">${Xn({data:m,cardType:"horizontal",cardSize:"large"})}</div>`),(m.type==="Video"||m.videoUrl)&&c.push({isVertical:m.size==="vertical-video",videoId:m.videoUrl,title:`Watch ${m.title}`,noAutoPlay:!0,uniqueID:m.uniqueID,titleID:"card-modal"})});const p=Ms({pageNumber:Number(t),allResults:i.totalMatching,resultsPerPage:i.numRanks,paginationRange:5,currentPage:Number(t)}),u=c.map(g=>`
        <div hidden="true" aria-modal="true" role="dialog" data-overlay-container="true" class="su-modal su-hidden" data-modal="modal" data-modal-id="${g.uniqueID}"><span data-focus-scope-start="true" hidden="true"></span><div aria-describedby="${g.titleID}" role="dialog" tabindex="-1" data-modal="modal-dialog" data-ismodal="true" aria-modal="true"><div class="su-modal-content">
        ${Jn({videoId:g.videoId,title:g.title,noAutoPlay:g.noAutoPlay,isVertical:g.isVertical})}
        ...
        `).join("");ir(o,l.join(""),p,u)}function $t(e){const{query:t,endpoint:n,display:s}=e.dataset,r=e.querySelector(Tt);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const i=a.getAttribute("data-offset");lr({offset:i,query:t,endpoint:n,display:s,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(er).forEach(e=>{Mt(e),$t(e)})});const dr='section[data-component="vertical-video-panel"]',Ot="su-hidden",cr='button[data-click="open-modal"]',ur='button[data-dismiss="modal"]',Vt='iframe[data-modal="iframe"]';function fr(e){const t=e.querySelector(Vt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ot),e.hidden=!1,document.body.style.overflow="hidden"}function Ee(e){const t=e.querySelector(Vt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ot),e.hidden=!0,document.body.style.overflow=""}function pr(e){const t=e.querySelectorAll(cr),n=e.querySelectorAll(ur);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||Ee(s)}),s.dataset.listenerAdded="true"),fr(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&Ee(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&Ee(s)})}function hr(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const o=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),E(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),o.on("slideChange",function(){setTimeout(()=>{r?E(o,"h2 a, h3 a, button",!0):E(o,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(dr).forEach(e=>{hr(e),pr(e)})});
