import B from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const Xe=typeof window>"u"?{}:window;function Ut(e=Xe){return e.document!==void 0}function D(e,t=Xe){if(!Ut(t))return null;const{document:n}=t,{cookie:s}=n;if(typeof s!="string")return null;const r=s.split("; ");let i=null;return r.find(a=>{const[o,l]=a.split("=");return o===e&&l!==""&&(i=l),null}),i}const Ve="su-hidden";function qe(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')};Object.values(t).forEach(n=>{n==null||n.forEach(s=>{s.classList.add(Ve)})}),t[e]&&t[e].forEach(n=>{n.classList.remove(Ve)})}document.addEventListener("DOMContentLoaded",function(){const e=D("preferences_personalisation");qe(e==="null"||!e?"external":e)});const Qe=typeof window>"u"?{}:window;function Ft(e=Qe){return e.document!==void 0}function _e(e,t="",n=!0,s="",r="/",i=Qe){if(!Ft(i))return;const{document:a}=i,{location:{hostname:o}}=a;let l="";if(s){const d=new Date;d.setTime(d.getTime()+s*24*60*60*1e3),l=`; expires=${d.toUTCString()}`}n===!0?a.cookie=`${e}=${t}${l}; path=${r}; domain=${o}; secure=${n};`:a.cookie=`${e}=${t}${l}; path=${r}; domain=${o};`}async function zt(e,t){return await(await fetch("/__dxp/events/custom",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source:"custom",action:e,event:{type:t}}),redirect:"follow"}).catch(r=>{throw new Error(r)})).text()}async function te(e){return await(await fetch("/__dxp/cdp/setConsent",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({CDPConsent:e,documentVersion:"1.0"}),redirect:"follow"}).catch(s=>{throw new Error(s)})).text()}function Wt(){const e='[id="light-theme"]',t='[id="dark-theme"]',n='[data-role="su-darkmode-icon-active"]',s='[data-role="su-darkmode-icon-nonactive"]',r=document.querySelector(e),i=document.querySelector(t),a=document.querySelector(n),o=document.querySelector(s),l=document.querySelector("html");if(r&&i){const d=D("preferences_theme");d==="dark"||["",null,void 0,!1].includes(d)&&window.matchMedia("(prefers-color-scheme: dark)").matches?(l.classList.add("su-dark"),a.classList.remove("su-hidden"),o.classList.add("su-hidden"),i.checked=!0,r.checked=!1):(a.classList.add("su-hidden"),o.classList.remove("su-hidden"),l.classList.add("su-light"),r.checked=!0,i.checked=!1),r.addEventListener("keyup",({key:f})=>{[" ","Enter"].includes(f)&&document.querySelector('[data-theme="dark-theme"]').click()}),i.addEventListener("keyup",({key:f})=>{[" ","Enter"].includes(f)&&document.querySelector('[data-theme="light-theme"]').click()}),r.addEventListener("click",()=>{l.classList.remove("su-dark"),l.classList.add("su-light"),a.classList.add("su-hidden"),o.classList.remove("su-hidden"),_e("preferences_theme","light",!0,130)}),i.addEventListener("click",()=>{l.classList.remove("su-light"),l.classList.add("su-dark"),a.classList.remove("su-hidden"),o.classList.add("su-hidden"),_e("preferences_theme","dark",!0,130)}),document.personaChangeEvent=new Event("personaChange")}}class jt{constructor(t){this.parent=t,this.menuToggle=this.parent.querySelector('[aria-controls="menu"]'),this.searchToggle=this.parent.querySelector('[aria-controls="search"]'),this.preferencesToggle=this.parent.querySelector('[aria-controls="preferences"]'),this.menuCloseToggle=this.parent.querySelectorAll(".report-header__menu-close,.report-header__menu-tray .report-header__overlay"),this.searchCloseToggle=this.parent.querySelectorAll(".report-header__search-close,.report-header__search-tray .report-header__overlay"),this.preferencesCloseToggle=this.parent.querySelectorAll(".report-header__preferences-close,.report-header__preferences-tray .report-header__overlay"),this.handleHeaderScroll(),this.handleHeaderToggles(),this.handleSearchInputs();const n=document.querySelector('[data-role="header-main-nav"]');n&&(n.classList.remove("su-opacity-0"),n.classList.add("su-opacity-1"))}focus(t){if(t.match(/:/g)){const[n,s,r]=t.split(":");document.querySelector(`[data-location="${t}"]`).querySelectorAll(s)[Number(r)].focus();return}document.querySelector(`[data-location="${t}"]`).focus()}handleTab(t){t.addEventListener("keyup",n=>{const{target:s,key:r}=n;if(r!=="Tab")return;const i=s.dataset.tpTo?s.dataset.tpTo:null;i&&this.focus(i)})}handleSearchInputs(){const t=document.querySelectorAll('[data-role="search-query"]'),n=document.querySelectorAll('[data-role="clear-search"]');t.length&&t.forEach((s,r)=>{s.addEventListener("keyup",()=>{s.value!==""?(s.parentNode.classList.add("input-has-value"),n[r].classList.remove("su-hidden")):(s.parentNode.classList.remove("input-has-value"),n[r].classList.add("su-hidden"))})}),n.length&&n.forEach(s=>{s.addEventListener("click",r=>{s.parentNode.parentNode.querySelector(".input-has-value").classList.remove("input-has-value"),s.classList.add("su-hidden")})})}handleHeaderToggles(){this.handleTab(document.querySelector(".report-header__main")),this.menuToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#menu");this.menuToggle.getAttribute("aria-expanded")==="true"?(this.menuToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--primary-nav-open"),n.setAttribute("aria-hidden","true"),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{n.classList.remove("su-hidden"),n.classList.add("su-block")},300)):(n.classList.remove("su-hidden"),window.innerWidth<768&&(document.body.style.cssText+="overflow: hidden;"),setTimeout(()=>{this.menuCloseToggle[1].focus(),this.menuToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--primary-nav-open"),n.setAttribute("aria-hidden","false")},0))}),this.menuCloseToggle.forEach(n=>{n.addEventListener("click",()=>{const s=this.parent.querySelector("#menu");this.menuToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--primary-nav-open"),s.setAttribute("aria-hidden","true"),this.menuToggle.focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden")},300)})});const t=document.querySelector('[data-role="search-focus-trap"]');this.searchToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#search");this.searchToggle.getAttribute("aria-expanded")==="true"?(this.searchToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--search-open"),n.setAttribute("aria-hidden","true"),setTimeout(()=>{n.classList.add("su-hidden"),n.classList.remove("su-block"),t.classList.add("su-hidden"),t.classList.remove("su-block")},300)):(n.classList.remove("su-hidden"),t.classList.remove("su-hidden"),setTimeout(()=>{this.searchToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--search-open"),n.setAttribute("aria-hidden","false")},0))}),this.searchCloseToggle.forEach(n=>{const s=this.parent.querySelector("#search");n.addEventListener("click",()=>{const r=this.parent.querySelector("#search");this.searchToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--search-open"),r.setAttribute("aria-hidden","true"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden"),t.classList.remove("su-block"),t.classList.add("su-hidden")},300)})}),this.preferencesToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#preferences");this.preferencesToggle.getAttribute("aria-expanded")==="true"?(this.preferencesToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--preferences-open"),n.setAttribute("aria-hidden","true"),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{n.classList.remove("su-hidden"),n.classList.add("su-block")},300)):(n.classList.remove("su-hidden"),this.preferencesCloseToggle[1].focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: hidden;"),setTimeout(()=>{this.preferencesToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--preferences-open"),n.setAttribute("aria-hidden","false")},0))}),this.preferencesCloseToggle.forEach(n=>{n.addEventListener("click",()=>{const s=this.parent.querySelector("#preferences");this.preferencesToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--preferences-open"),s.setAttribute("aria-hidden","true"),this.preferencesToggle.focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden")},300)})})}handleHeaderScroll(){window.addEventListener("scroll",t=>{const n=this.parent;if(window.scrollY>32){n.classList.add("report-header--collapsed");return}n.classList.remove("report-header--collapsed")})}}class Ke{constructor(t,n){this.url=t,this.type=n,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const s=this.assetIds.map(async r=>{const i=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(i,this.requestProps).catch(l=>{throw new Error(l)})).json()});return Promise.all(s)}return await(await fetch(this.url,this.requestProps).catch(s=>{throw new Error(s)})).json()}}function Je(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}async function Yt(e=null,t=""){var s,r,i,a,o,l,d,f;const n=new Ke;if(e&&e.search){let u="",p="";u=`${(s=e.search.endpoint)==null?void 0:s.replace("search.html","search.json")}?profile=${e.search.profile}&collection=${e.search.collection}&query=[taxonomyContentMainTopicId:${e.mainTopicId} taxonomyContentTopicsId:${e.mainTopicId} taxonomyContentSubtopicsId:${e.mainTopicId}]&meta_taxonomyAudienceText=${Je(t)}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&sort=date&num_ranks=1&log=false`,p=`${(r=e.search.endpoint)==null?void 0:r.replace("search.html","search.json")}?profile=${e.search.profile}&collection=${e.search.collection}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&sort=date&num_ranks=1&log=false`,e.contentType==="Video"&&(p+="&meta_taxonomyContentTypeId=28207",u+="&meta_taxonomyContentTypeId=28207"),n.url=u;let h=await n.fetch(),c=((o=(a=(i=h.response)==null?void 0:i.resultPacket)==null?void 0:a.results)==null?void 0:o[0])||null;return c||(n.url=p,h=await n.fetch(),c=((f=(d=(l=h.response)==null?void 0:l.resultPacket)==null?void 0:d.results)==null?void 0:f[0])||null),c}return null}function Xt(e,t,n,s="su-hidden"){if(e&&t&&n){const r=n.querySelector('h2[data-story="announcement"]'),i=n.querySelector('h1[data-story="title"]'),a=n.querySelector('a[data-story="link"]');t!=null&&t.contentType&&r&&(r.textContent=t.contentType==="Video"?"Watch next:":"Read next:"),t!=null&&t.title&&i&&(i.textContent=t.title),e!=null&&e.displayUrl&&(e!=null&&e.title)&&a&&(a.textContent=e.title,a.href=e.displayUrl),(t!=null&&t.title||e!=null&&e.displayUrl)&&n.classList.remove(s)}}const Qt='header[data-component="header-component"]',et='section[data-subcomponent="header-cookie-consent-banner"]',z="su-hidden";let F=!1;function se(){const e=document.querySelector(et);e&&e.classList.add(z),e&&e.classList.remove("active")}function Kt(){const e=document.querySelector(et);e&&e.classList.remove(z),e&&e.classList.add("active")}function Te(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')},n={student:document.querySelector('button[data-click="student-persona"]'),faculty:document.querySelector('button[data-click="faculty-persona"]')};Object.values(t).forEach(s=>{s==null||s.forEach(r=>{r.classList.add(z)})}),Object.values(n).forEach(s=>{s&&s.setAttribute("aria-pressed","false")}),t[e]&&t[e].forEach(s=>{s.classList.remove(z)}),n[e]&&n[e].setAttribute("aria-pressed","true")}const le=async(e,t,n=!1)=>{let s=null;!F&&n===!1&&(await te(1),F=!0,se()),e&&(t===e?s="external":s=e),await zt("persona-selector",s),n===!0&&(await te(0),F=!1),_e("preferences_personalisation",s,!0,130),t=s,Te(t),document.dispatchEvent(document.personaChangeEvent),window.location.reload()},He=async e=>{e===!0?(await te(1),F=!0,se()):(await te(0),F=!1,se())};document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector('button[data-click="student-persona"]'),t=document.querySelector('button[data-click="faculty-persona"]'),n=typeof window.pageController<"u"?window.pageController:null,s=document.querySelectorAll('a[data-menu="main-nav"]'),r=document.querySelector('[data-current-story="headline"]'),i=document.querySelector(Qt);i&&new jt(i);let a=null;const o=JSON.parse(D("squiz.cdp.consent")),l=o==null?void 0:o.CDPConsent,d=document.querySelector('button[data-click="clear-preferences"]'),f={};f.pageData=n,f.consentData=o==null?void 0:o.CDPConsent,f.audienceData=D("preferences_personalisation"),(f.audienceData==="null"||!f.audienceData)&&(f.audienceData="external"),window.suHeaderProps=f,Wt(),n&&s&&s.forEach(c=>{(n==null?void 0:n.id)===c.dataset.id&&(c.classList.remove("su-border-transparent"),c.classList.add("!su-text-digital-red su-border-digital-red dark:su-border-dark-mode-red dark:!su-text-dark-mode-red"))}),n!=null&&n.isStory&&(i.classList.add("report-header--story"),(async()=>(a=await Yt(f.pageData,f.audienceData),Xt(a,n,r,z)))()),!l&&l!=0&&Kt(),l&&(se(),d&&(d.removeAttribute("disabled"),d.setAttribute("aria-pressed","false"),d.classList.add("su-text-digital-blue"),d.classList.add("dark:su-text-digital-blue-vivid"),d.addEventListener("click",async function(){await le(null,null,!0)})));const u=document.querySelector('button[data-click="accept-consent"]'),p=document.querySelector('button[data-click="reject-consent"]');u&&u.addEventListener("click",function(){He(!0)}),p&&p.addEventListener("click",function(){He(!1)});const h=D("preferences_personalisation");Te(h==="null"||!h?"external":h),e&&e.addEventListener("click",function(){le("student",h)}),t&&t.addEventListener("click",function(){le("faculty",h)})});function tt(e){if(!e)return 0;const t=225,n=e.trim().split(/\s+/).length;return Math.ceil(n/t)}function Jt(e,t,n,s=()=>{}){const r=e.slides.length;let i=t-r+1;r%n!==0&&(i+=n-r%n);const a=document.createDocumentFragment(),o=e.slides.map(l=>l.outerHTML).join("");for(let l=0;l<i;l++){const d=document.createElement("div");for(d.innerHTML=o;d.firstChild;)d.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(d.firstChild)}e.wrapperEl.appendChild(a),e.update(),b(e,"",!1),s()}function N(e,t=()=>{}){const{slidesPerView:n,slidesPerGroup:s}=e.params,r=e.slides.length,i=Math.ceil(n+s);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<i||r%s!==0?Jt(e,i,s,t):(b(e,"",!1),t())}function ae(e){const t=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(t){let n=e.pagination.bullets.length-e.slides.length+t;for(;n>0;){const s=e.pagination.bullets.pop();s&&s.remove(),n--}}}const b=(e,t,n)=>{e.slides.forEach(s=>{if(s.classList.contains("swiper-slide-active")){if(s.removeAttribute("aria-hidden"),s.removeAttribute("inert"),s.setAttribute("tabindex","-1"),t&&n){let r=null;t==="slide"?r=s:r=s.querySelector(t),r&&r.focus()}}else s.setAttribute("aria-hidden","true"),s.setAttribute("inert","true"),s.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(s=>{s.classList.contains("swiper-pagination-bullet-active")?s.setAttribute("aria-current","true"):s.removeAttribute("aria-current")})},e1='section[data-component="basic-story-hero"]',t1='span[data-reading="true"]',st="su-hidden",s1='button[data-click="open-modal"]',n1='button[data-dismiss="modal"]',nt='iframe[data-modal="iframe"]';function r1(e){const t=e.querySelector(nt);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(st),e.hidden=!1,document.body.style.overflow="hidden"}function ce(e){const t=e.querySelector(nt);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(st),e.hidden=!0,document.body.style.overflow=""}function a1(e){const t=e.querySelectorAll(s1),n=e.querySelectorAll(n1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ce(s)}),s.dataset.listenerAdded="true"),r1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ce(s)})}function i1(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{ae(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?b(i,"slide",!0):b(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}function o1(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(t1);if(t&&n){const s=tt(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(e1).forEach(e=>{i1(e),a1(e),o1(e)})});const l1='section[data-component="combined-content-grid"]',rt="su-hidden",c1='button[data-click="open-modal"]',d1='button[data-dismiss="modal"]',at='iframe[data-modal="iframe"]';function u1(e){const t=e.querySelector(at),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(rt),e.hidden=!1,document.body.style.overflow="hidden"}function de(e){const t=e.querySelector(at),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(rt),e.hidden=!0,document.body.style.overflow=""}function f1(e){const t=e.querySelectorAll(c1),n=e.querySelectorAll(d1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||de(s)}),s.dataset.listenerAdded="true"),u1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&de(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&de(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(l1).forEach(e=>{f1(e)})});const p1='section[data-component="content-carousel"]';function h1(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{ae(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?b(i,"slide",!0):b(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(p1).forEach(e=>{h1(e)})});const m1='section[data-component="feature-story-hero"]',g1='span[data-reading="true"]';function C1(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(g1);if(t&&n){const s=tt(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(m1).forEach(e=>{C1(e)})});const v1='section[data-component="featured-content"]',it="su-hidden",y1='button[data-click="open-modal"]',w1='button[data-dismiss="modal"]',ot='iframe[data-modal="iframe"]';function L1(e){const t=e.querySelector(ot),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(it),e.hidden=!1,document.body.style.overflow="hidden"}function ue(e){const t=e.querySelector(ot),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(it),e.hidden=!0,document.body.style.overflow=""}function E1(e){const t=e.querySelectorAll(y1),n=e.querySelectorAll(w1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ue(s)}),s.dataset.listenerAdded="true"),L1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ue(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ue(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(v1).forEach(e=>{E1(e)})});const b1='section[data-component="horizontal-video-testimonials"]',lt="su-hidden",S1='button[data-click="open-modal"]',A1='button[data-dismiss="modal"]',ct='iframe[data-modal="iframe"]';function x1(e){const t=e.querySelector(ct);if(t){const n=t.getAttribute("src"),s=n&&n.replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(lt),e.hidden=!1,document.body.style.overflow="hidden"}function fe(e){const t=e.querySelector(ct);if(t){const n=t.getAttribute("src"),s=n&&n.replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(lt),e.hidden=!0,document.body.style.overflow=""}function _1(e){const t=e.querySelectorAll(S1),n=e.querySelectorAll(A1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||fe(s)}),s.dataset.listenerAdded="true"),x1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&fe(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&fe(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(b1).forEach(e=>{_1(e)})});const T1='section[data-component="image-gallery-modal"]',I1='button[data-click="open-gallery-modal"]',k1='div[data-modal="modal"]',M1='button[data-dismiss="modal"]',dt="su-hidden";let Ie;const $1=(e,t)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function O1(e){e.classList.remove(dt),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&$1(t,e)})}function pe(e){e.classList.add(dt),e.hidden=!0,document.body.style.overflow=""}function V1(e){const t=e.dataset.modalId;Ie=new B(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function q1(e){const t=e.querySelector(k1),n=e.querySelector(I1),s=e.querySelector(M1);n&&n.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",i=>{r.contains(i.target)||pe(t)}),t.dataset.listenerAdded="true"),O1(t),V1(t)}),s&&s.addEventListener("click",function(){pe(t),Ie.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(pe(t),Ie.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(T1).forEach(e=>{q1(e)})});const H1='[data-component="interactive-photo-card"]',N1="[data-card-inner]",R1="[data-card-inner-content]";function D1(e){var s;const n=((e.style.transform&&parseInt((s=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:s[1])||0)+180)%360;e.style.transform=`rotateY(${n}deg)`}function B1(e){const t=e.querySelector(N1);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>D1(t))}const P1=e=>{e.forEach(t=>{const n=t.getAttribute("aria-hidden")==="true"?"false":"true",s=t.querySelector("button");s&&(s.tabIndex=n==="true"?"-1":""),t.setAttribute("aria-hidden",n)})},Z1=e=>{const t=e.querySelectorAll(R1);t.length&&t.forEach(n=>n.addEventListener("click",()=>P1(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(H1).forEach(e=>{B1(e),Z1(e)})});function G1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:n,summary:s,image:r,taxonomyContentTypeText:i,contentTopic:a,contentSubtopic:o,taxonomyContentMainTopicText:l,contentCategory:d,featuredVideo:f,taxonomyContentMainTopicLandingPageUrl:u,taxonomyFeaturedUnitLandingPageUrl:p,taxonomyFeaturedUnitText:h,imageAlt:c,authorName:w,authorImage:C,author:v,isTeaser:g,storySource:m,assetHref:S},date:$,liveUrl:O}){const V=w!==void 0?w:v,A=C!==""?C:void 0,I=r&&r!==""?r:null,L=c&&c!==""?c:"",k=f,P=n||s;let q=l;!q&&a&&(q=a instanceof Array?a[0]:a),!q&&o&&(q=o instanceof Array?o[0]:o);const oe=u;let Z=i?i[0]:"";return!Z&&d&&(Z=d instanceof Array?d[0]:d),S&&t[0]==="link"&&(O=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(P)?P[0]:P,liveUrl:Array.isArray(O)?O[0]:O,imageUrl:Array.isArray(I)?I[0]:I,imageAlt:Array.isArray(L)?L[0]:L,taxonomy:Array.isArray(q)?q[0]:q,taxonomyUrl:Array.isArray(oe)?oe[0]:oe,type:Array.isArray(Z)?Z[0]:Z,videoUrl:Array.isArray(k)?k[0]:k,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(V)?V[0]:V,authorAvatar:Array.isArray(A)?A[0]:A,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(p)?p[0]:p,taxonomyFeaturedUnitText:Array.isArray(h)?h[0]:h,isTeaser:Array.isArray(g)?g[0]:g,storySource:Array.isArray(m)?m[0]:m}}function he(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function ut(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}const U1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(t+s)%16|0,t=Math.floor(t/16)),(n==="x"?s:s&3|8).toString(16)})},F1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),z1=()=>typeof crypto<"u"?F1():U1();async function W1(e=null,t="",n=null){var r,i,a,o,l,d,f,u,p,h,c,w,C,v,g,m,S,$,O;const s=new Ke;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const V=`
    ...
    `}function Q1(e,t,n){if(!e.length){t.classList.add(E.NO_STORIES);return}const[s,r,i]=e;n.innerHTML=`
    ...
    `,t.classList.remove(E.NO_STORIES)}async function K1(e,t,n,s,r,i){const o=(await W1(e,i,t)).map(({title:l,indexUrl:d})=>X1(l,d));Q1(o,n,r),J1(n,s,r)}function J1(e,t,n){t.addEventListener("click",function(){j1(t,n)}),window.addEventListener("scroll",function(){Y1(e)})}function es(e,t,n,s){if(!e||!window.pageController)return;const r=window.pageController,i=r.topicsQuery?r.topicsQuery():null;K1(r,i,e,t,n,s)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(me.WRAPPER),t=document.querySelector(me.TOGGLE),n=document.querySelector(me.DRAWER),s=D("preferences_personalisation");es(e,t,n,s)});const ts='section[data-component="media-carousel"]';function ss(e){const t=e.dataset.uniqueId,n=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{N(a)},paginationUpdate:a=>{ae(a)}}}),s=n.slides.length,r=n.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(s-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),n.on("slideChange",function(){setTimeout(()=>{a?b(n,"h2 a, h3 a, button",!0):b(n,"",!1)},100)})}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ts).forEach(e=>{ss(e)})});const ns='button[data-role="copy-link"]';function rs(e){e.addEventListener("click",function(){navigator.clipboard.writeText(window.location.href).then(()=>{const t=document.querySelector("[data-copy-text]");t.textContent="Copied",setTimeout(()=>{t.textContent="Copy link"},3e3)})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ns).forEach(e=>{rs(e)})});const as='section[data-component="multicolumn-listing"]',ft="su-hidden",is='button[data-click="open-modal"]',os='button[data-dismiss="modal"]',pt='iframe[data-modal="iframe"]';function ls(e){const t=e.querySelector(pt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(ft),e.hidden=!1,document.body.style.overflow="hidden"}function ge(e){const t=e.querySelector(pt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(ft),e.hidden=!0,document.body.style.overflow=""}function cs(e){const t=e.querySelectorAll(is),n=e.querySelectorAll(os);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ge(s)}),s.dataset.listenerAdded="true"),ls(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ge(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ge(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(as).forEach(e=>{cs(e)})});const ds='section[data-component="sidebar-navigation"]',us='nav[data-nav="nav"]',ne="su-hidden",fs='button[data-click="toggle-nav"]',ps="su-bg-digital-red su-text-white dark:su-bg-dark-mode-red dark:aria-expanded:su-text-black-true",hs='span[data-label="button"]';function ht(e,t){const n=e.querySelector(hs),s=e.querySelector('svg[data-icon="bars"]'),r=e.querySelector('svg[data-icon="xmark"]');e.setAttribute("aria-expanded",t.toString()),ps.split(" ").forEach(i=>{e.classList.toggle(i,t)}),s&&(s.classList.toggle(`!${ne}`,t),s.hidden=t),r&&(r.classList.toggle(`!${ne}`,!t),r.hidden=!t),n&&(n.innerHTML=t?n.getAttribute("data-label-close"):n.getAttribute("data-label-open"))}function Ne(e,t){e.classList.remove(ne),e.hidden=!1,ht(t,!0)}function W(e,t){e.classList.add(ne),e.hidden=!0,ht(t,!1)}function ms(e){const t=e.querySelector(fs),n=e.querySelector(us);let s;t&&t.addEventListener("click",function(){const r=t.getAttribute("aria-expanded")==="true";n.dataset.listenerAdded||(document.addEventListener("click",i=>{const a=n.contains(i.target),o=t.contains(i.target);!a&&!o&&W(n,t)}),n.dataset.listenerAdded="true"),r?W(n,t):Ne(n,t)}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&t&&W(n,t)}),window.addEventListener("resize",()=>{clearTimeout(s),s=setTimeout(()=>{window.innerWidth>991?n&&t&&Ne(n,t):n&&t&&W(n,t)},10)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ds).forEach(e=>{ms(e)})});function j(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function Y(e,t){const n=e.querySelector('svg[data-control="play"]'),s=e.querySelector('svg[data-control="pause"]'),r=!t;e.setAttribute("aria-pressed",String(r)),n.classList.toggle("su-hidden",r),n.hidden=r,s.classList.toggle("su-hidden",!r),s.hidden=!r,e.innerHTML=`
  ...
  `}const gs='section[data-component="single-image-video"]',Cs='iframe[data-role="video-player"]',vs='button[data-role="video-control"]',mt="su-hidden",ys='button[data-click="open-modal"]',ws='button[data-dismiss="modal"]',gt='iframe[data-modal="iframe"]',Ls=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function Es(e){const t=e.querySelector(gt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(mt),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&Ls(r,e)})}function Ce(e){const t=e.querySelector(gt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(mt),e.hidden=!0,document.body.style.overflow=""}function bs(e){const t=e.querySelectorAll(ys),n=e.querySelectorAll(ws);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||Ce(s)}),s.dataset.listenerAdded="true"),Es(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&Ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&Ce(s)})}function Ss(e){const t=e.querySelector(Cs),n=e.querySelector(vs);let s=!1;if(!t||!n)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!s?(j(t,"play"),Y(n,!1)):a.isIntersecting||(j(t,"pause"),Y(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(j(t,"pause"),Y(n,!0),s=!0):(j(t,"play"),Y(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(gs).forEach(e=>{bs(e),Ss(e)})});const As='section[data-component="standalone-visual-hero"]',Ct="su-hidden",xs='button[data-click="open-modal"]',_s='button[data-dismiss="modal"]',vt='iframe[data-modal="iframe"]';function Ts(e){const t=e.querySelector(vt);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(Ct),e.hidden=!1,document.body.style.overflow="hidden"}function ve(e){const t=e.querySelector(vt);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(Ct),e.hidden=!0,document.body.style.overflow=""}function Is(e){const t=e.querySelectorAll(xs),n=e.querySelectorAll(_s);let s=null;t.forEach(r=>{r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ve(s)}),s.dataset.listenerAdded="true"),Ts(s)})}),n.forEach(r=>{r.addEventListener("click",function(){s&&ve(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ve(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(As).forEach(e=>{Is(e)})});const ks='section[data-component="stories-carousel"]',yt="su-hidden",Ms='button[data-click="open-modal"]',$s='button[data-dismiss="modal"]',wt='iframe[data-modal="iframe"]';function Os(e){const t=e.querySelector(wt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(yt),e.hidden=!1,document.body.style.overflow="hidden"}function ye(e){const t=e.querySelector(wt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(yt),e.hidden=!0,document.body.style.overflow=""}function Vs(e){const t=e.querySelectorAll(Ms),n=e.querySelectorAll($s);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ye(s)}),s.dataset.listenerAdded="true"),Os(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ye(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ye(s)})}let G=!1,Re=!1;function qs(e){const t=e.dataset.uniqueId,n=`section[data-unique-id="${t}"] .swiper`;new B(n,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,on:{init:function(){console.log("Swiper has fully initialized."),setTimeout(()=>{Re=!0,G=!0},500)},slideChange:function(s){const r=document.querySelector(n),i=r.querySelector(".swiper-slide-active");i&&i.removeAttribute("tabindex"),console.log("run1",G),Re&&(console.log("focused",G),setTimeout(()=>{const a=r.querySelector(".swiper-slide-active"),o=a.querySelector("h2 a, h3 a, button")?a.querySelector("h2 a, h3 a, button"):(()=>(a.setAttribute("tabindex","-1"),a))();console.log("focused",G),G&&(o.focus(),console.log("focused"))},300)),s.slides.forEach(a=>{a.classList.contains("swiper-slide-visible")?(a.removeAttribute("aria-hidden"),a.removeAttribute("inert")):(a.setAttribute("aria-hidden","true"),a.setAttribute("inert","true"))}),s.pagination.bullets.length>0&&s.pagination.bullets.forEach(a=>{a.classList.contains("swiper-pagination-bullet-active")?a.setAttribute("aria-current","true"):a.removeAttribute("aria-current")})}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ks).forEach(e=>{qs(e),Vs(e)})});const Hs='section[data-component="subscribe-to-stanford-report"]';function Ns(e){const t=e.querySelector("form"),n=t.querySelector('input[type="email"]'),s=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let i="";const a=n.value;if(!a||!a.match(/\w+@\w+\.\w+/)){i='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',s.innerHTML=i,n.setAttribute("aria-describedby","subscription-error");return}s.innerHTML="",n.removeAttribute("aria-describedby"),r.target.submit()}),n.addEventListener("keyup",function(){const r=n.value,i=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(i.innerHTML="",n.removeAttribute("aria-describedby"))})}function Rs(){document.querySelectorAll(Hs).forEach(e=>{Ns(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",Rs);function Ds({offsetNum:e,pageNumber:t,index:n}){return`
        <button
            data-offset="${e}"
    ...
    `}function Bs({pageNumber:e,allResults:t,resultsPerPage:n,paginationRange:s,currentPage:r=1}){const i=Math.ceil(t/n),a=s,o=e-n,l=e+n,d="su-text-black-50",f=[],u=[];for(let g=0;g<i;g++){const m=g*n+1;u.push(m)}let p=[...u],h=[...u];const c=u.indexOf(r),w=Math.floor(a*.5);if((c<w||i===a)&&(p=p.filter((g,m)=>g>r&&m<a),h=h.filter(g=>g<r)),c>=w&&i!==a)if(p=p.filter((g,m)=>g>r&&m<=c+w),p.length===w)h=h.filter((g,m)=>g<r&&m>=c-w);else{const g=p.length?a-p.length:a;h=h.filter((m,S)=>m<r&&S>c-g)}return[...h,r,...p].map(g=>({offset:g,index:u.indexOf(g)+1})).forEach(({offset:g,index:m})=>{f.push(Ds({offsetNum:g,pageNumber:e,index:m}))}),i>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function Ps(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var ke={exports:{}},y={},Me={exports:{}},R={};function Lt(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function Zs(e,t,n){}function Gs(e,t,n){}var Us=/javascript\s*\:/img;function Fs(e,t){return Us.test(t)?"":t}R.whiteList=Lt();R.getDefaultWhiteList=Lt;R.onAttr=Zs;R.onIgnoreAttr=Gs;R.safeAttrValue=Fs;var zs={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},U=zs;function Ws(e,t){e=U.trimRight(e),e[e.length-1]!==";"&&(e+=";");var n=e.length,s=!1,r=0,i=0,a="";function o(){if(!s){var f=U.trim(e.slice(r,i)),u=f.indexOf(":");if(u!==-1){var p=U.trim(f.slice(0,u)),h=U.trim(f.slice(u+1));if(p){var c=t(r,a.length,p,h,f);c&&(a+=c+"; ")}}}r=i+1}for(;i<n;i++){var l=e[i];if(l==="/"&&e[i+1]==="*"){var d=e.indexOf("*/",i+2);if(d===-1)break;i=d+1,r=i+1,s=!1}else l==="("?s=!0:l===")"?s=!1:l===";"?s||o():l===`
`&&o()}return U.trim(a)}var js=Ws,X=R,Ys=js;function De(e){return e==null}function Xs(e){var t={};for(var n in e)t[n]=e[n];return t}function Et(e){e=Xs(e||{}),e.whiteList=e.whiteList||X.whiteList,e.onAttr=e.onAttr||X.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||X.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||X.safeAttrValue,this.options=e}Et.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onAttr,i=n.onIgnoreAttr,a=n.safeAttrValue,o=Ys(e,function(l,d,f,u,p){var h=s[f],c=!1;if(h===!0?c=h:typeof h=="function"?c=h(u):h instanceof RegExp&&(c=h.test(u)),c!==!0&&(c=!1),u=a(f,u),!!u){var w={position:d,sourcePosition:l,source:p,isWhite:c};if(c){var C=r(f,u,w);return De(C)?f+":"+u:C}else{var C=i(f,u,w);if(!De(C))return C}}});return o};var Qs=Et;(function(e,t){var n=R,s=Qs;function r(a,o){var l=new s(o);return l.process(a)}t=e.exports=r,t.FilterCSS=s;for(var i in n)t[i]=n[i];typeof window<"u"&&(window.filterCSS=e.exports)})(Me,Me.exports);var $e=Me.exports,Oe={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,n=t.exec(e);return n?n.index:-1}},Ks=$e.FilterCSS,Js=$e.getDefaultWhiteList,re=Oe;function bt(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var St=new Ks;function en(e,t,n){}function tn(e,t,n){}function sn(e,t,n){}function nn(e,t,n){}function At(e){return e.replace(an,"&lt;").replace(on,"&gt;")}function rn(e,t,n,s){if(n=Mt(n),t==="href"||t==="src"){if(n=re.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(t==="background"){if(Q.lastIndex=0,Q.test(n))return""}else if(t==="style"){if(Be.lastIndex=0,Be.test(n)||(Pe.lastIndex=0,Pe.test(n)&&(Q.lastIndex=0,Q.test(n))))return"";s!==!1&&(s=s||St,n=s.process(n))}return n=$t(n),n}var an=/</g,on=/>/g,ln=/"/g,cn=/&quot;/g,dn=/&#([a-zA-Z0-9]*);?/gim,un=/&colon;?/gim,fn=/&newline;?/gim,Q=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,Be=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,Pe=/u\s*r\s*l\s*\(.*/gi;function xt(e){return e.replace(ln,"&quot;")}function _t(e){return e.replace(cn,'"')}function Tt(e){return e.replace(dn,function(n,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function It(e){return e.replace(un,":").replace(fn," ")}function kt(e){for(var t="",n=0,s=e.length;n<s;n++)t+=e.charCodeAt(n)<32?" ":e.charAt(n);return re.trim(t)}function Mt(e){return e=_t(e),e=Tt(e),e=It(e),e=kt(e),e}function $t(e){return e=xt(e),e=At(e),e}function pn(){return""}function hn(e,t){typeof t!="function"&&(t=function(){});var n=!Array.isArray(e);function s(a){return n?!0:re.indexOf(e,a)!==-1}var r=[],i=!1;return{onIgnoreTag:function(a,o,l){if(s(a))if(l.isClosing){var d="[/removed]",f=l.position+d.length;return r.push([i!==!1?i:l.position,f]),i=!1,d}else return i||(i=l.position),"[removed]";else return t(a,o,l)},remove:function(a){var o="",l=0;return re.forEach(r,function(d){o+=a.slice(l,d[0]),l=d[1]}),o+=a.slice(l),o}}}function mn(e){for(var t="",n=0;n<e.length;){var s=e.indexOf("<!--",n);if(s===-1){t+=e.slice(n);break}t+=e.slice(n,s);var r=e.indexOf("-->",s);if(r===-1)break;n=r+3}return t}function gn(e){var t=e.split("");return t=t.filter(function(n){var s=n.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),t.join("")}y.whiteList=bt();y.getDefaultWhiteList=bt;y.onTag=en;y.onIgnoreTag=tn;y.onTagAttr=sn;y.onIgnoreTagAttr=nn;y.safeAttrValue=rn;y.escapeHtml=At;y.escapeQuote=xt;y.unescapeQuote=_t;y.escapeHtmlEntities=Tt;y.escapeDangerHtml5Entities=It;y.clearNonPrintableCharacter=kt;y.friendlyAttrValue=Mt;y.escapeAttrValue=$t;y.onIgnoreTagStripAll=pn;y.StripTagBody=hn;y.stripCommentTag=mn;y.stripBlankChar=gn;y.attributeWrapSign='"';y.cssFilter=St;y.getDefaultCSSWhiteList=Js;var ie={},H=Oe;function Cn(e){var t=H.spaceIndex(e),n;return t===-1?n=e.slice(1,-1):n=e.slice(1,t+1),n=H.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function vn(e){return e.slice(0,2)==="</"}function yn(e,t,n){var s="",r=0,i=!1,a=!1,o=0,l=e.length,d="",f="";e:for(o=0;o<l;o++){var u=e.charAt(o);if(i===!1){if(u==="<"){i=o;continue}}else if(a===!1){if(u==="<"){s+=n(e.slice(r,o)),i=o,r=o;continue}if(u===">"||o===l-1){s+=n(e.slice(r,i)),f=e.slice(i,o+1),d=Cn(f),s+=t(i,s.length,d,f,vn(f)),r=o+1,i=!1;continue}if(u==='"'||u==="'")for(var p=1,h=e.charAt(o-p);h.trim()===""||h==="=";){if(h==="="){a=u;continue e}h=e.charAt(o-++p)}}else if(u===a){a=!1;continue}}return r<l&&(s+=n(e.substr(r))),s}var wn=/[^a-zA-Z0-9\\_:.-]/gim;function Ln(e,t){var n=0,s=0,r=[],i=!1,a=e.length;function o(p,h){if(p=H.trim(p),p=p.replace(wn,"").toLowerCase(),!(p.length<1)){var c=t(p,h||"");c&&r.push(c)}}for(var l=0;l<a;l++){var d=e.charAt(l),f,u;if(i===!1&&d==="="){i=e.slice(n,l),n=l+1,s=e.charAt(n)==='"'||e.charAt(n)==="'"?n:bn(e,l+1);continue}if(i!==!1&&l===s){if(u=e.indexOf(d,l+1),u===-1)break;f=H.trim(e.slice(s+1,u)),o(i,f),i=!1,l=u,n=l+1;continue}if(/\s|\n|\t/.test(d))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(u=En(e,l),u===-1){f=H.trim(e.slice(n,l)),o(f),i=!1,n=l+1;continue}else{l=u-1;continue}else if(u=Sn(e,l-1),u===-1){f=H.trim(e.slice(n,l)),f=Ze(f),o(i,f),i=!1,n=l+1;continue}else continue}return n<e.length&&(i===!1?o(e.slice(n)):o(i,Ze(H.trim(e.slice(n))))),H.trim(r.join(" "))}function En(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="="?t:-1}}function bn(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="'"||n==='"'?t:-1}}function Sn(e,t){for(;t>0;t--){var n=e[t];if(n!==" ")return n==="="?t:-1}}function An(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function Ze(e){return An(e)?e.substr(1,e.length-2):e}ie.parseTag=yn;ie.parseAttr=Ln;var xn=$e.FilterCSS,T=y,Ot=ie,_n=Ot.parseTag,Tn=Ot.parseAttr,ee=Oe;function K(e){return e==null}function In(e){var t=ee.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=ee.trim(e.slice(t+1,-1));var n=e[e.length-1]==="/";return n&&(e=ee.trim(e.slice(0,-1))),{html:e,closing:n}}function kn(e){var t={};for(var n in e)t[n]=e[n];return t}function Mn(e){var t={};for(var n in e)Array.isArray(e[n])?t[n.toLowerCase()]=e[n].map(function(s){return s.toLowerCase()}):t[n.toLowerCase()]=e[n];return t}function Vt(e){e=kn(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=T.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=Mn(e.whiteList||e.allowList):e.whiteList=T.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":T.attributeWrapSign,e.onTag=e.onTag||T.onTag,e.onTagAttr=e.onTagAttr||T.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||T.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||T.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||T.safeAttrValue,e.escapeHtml=e.escapeHtml||T.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new xn(e.css))}Vt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onTag,i=n.onIgnoreTag,a=n.onTagAttr,o=n.onIgnoreTagAttr,l=n.safeAttrValue,d=n.escapeHtml,f=t.attributeWrapSign,u=t.cssFilter;n.stripBlankChar&&(e=T.stripBlankChar(e)),n.allowCommentTag||(e=T.stripCommentTag(e));var p=!1;n.stripIgnoreTagBody&&(p=T.StripTagBody(n.stripIgnoreTagBody,i),i=p.onIgnoreTag);var h=_n(e,function(c,w,C,v,g){var m={sourcePosition:c,position:w,isClosing:g,isWhite:Object.prototype.hasOwnProperty.call(s,C)},S=r(C,v,m);if(!K(S))return S;if(m.isWhite){if(m.isClosing)return"</"+C+">";var $=In(v),O=s[C],V=Tn($.html,function(A,I){var L=ee.indexOf(O,A)!==-1,k=a(C,A,I,L);return K(k)?L?(I=l(C,A,I,u),I?A+"="+f+I+f:A):(k=o(C,A,I,L),K(k)?void 0:k):k});return v="<"+C,V&&(v+=" "+V),$.closing&&(v+=" /"),v+=">",v}else return S=i(C,v,m),K(S)?d(v):S},d);return p&&(h=p.remove(h)),h};var $n=Vt;(function(e,t){var n=y,s=ie,r=$n;function i(o,l){var d=new r(l);return d.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=r,function(){for(var o in n)t[o]=n[o];for(var l in s)t[l]=s[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(ke,ke.exports);var On=ke.exports;const M=Ps(On);var Vn=Array.isArray,qt=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var n=void 0;if(Vn(e))for(var s=0,r=e.length;s<r;)n=qt(e[s++]),n&&(t&&(t+=" "),t+=n);else for(n in e)n&&e[n]&&(t&&(t+=" "),t+=n)}return t};function Ht(){for(var e=arguments.length,t=0,n,s,r="";t<e;)n=arguments[t++],n&&(s=qt(n),s&&(r&&(r+=" "),r+=s));return r}function Ge({children:e="",imageUrl:t,imageAlt:n="",aspectRatio:s="card-small",videoUrl:r}){return`
    <span
      class="${Ht("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",s==="card-small"&&"su-aspect-[3/2]",s==="card-medium"&&"su-aspect-[3/2]",s==="card-large"&&"su-aspect-[3/2]",s==="card-featured"&&"su-aspect-[3/2]",s==="square"&&"su-aspect-[1/1]",s==="video"&&"su-aspect-[16/9]",s==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${r?`
  ...
  `}const qn={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function Ue({imageUrl:e,alt:t="",aspectRatio:n,videoUrl:s,size:r="small",title:i="",videoIconClasses:a,uniqueId:o}){if(s){const l=`
        ...
        ${s?`
          <span
            class="${Ht("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",qn[r],a)}">
  ...
  `}function Hn(e,t){if(!t)return!0;const n=e.match(/(\d+-\d+-\d+)/)[0],s=t.match(/(\d+-\d+-\d+)/)[0];return n===s}function Nn({start:e,end:t}){if(!e&&!t)return null;const n=new Date(e),s=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const a=Hn(e,t);a||(delete r.time,delete r.hour,delete r.minute);const o=new Intl.DateTimeFormat("en-US",r).format(n),l=t?new Intl.DateTimeFormat("en-US",r).format(s):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function Rn(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Bn="light";function Le({variant:e=Bn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    >
    ...
    </svg>`}const We="solid";function Yn({variant:e=We}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get(We)}function be(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Xn="light";function je({variant:e=Xn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
      ...
      <div class="${_.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${_.authorWrapper} ${c}">
            ${h?`
              ${ir({image:h,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function lr(e){const{videoId:t,className:n="",noAutoPlay:s,title:r,isVertical:i}=e;return`
        <iframe
            width="${i?315:560}"
            height="${i?560:315}"
            class="${n}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const cr='section[data-component="topic-subtopic-listing"]',dr='[data-element="topics-list"]',Nt='[data-element="topics-pagination"]',Rt="su-hidden",ur='section[data-element="modal-wrapper"]',fr='button[data-click="open-modal"]',pr='button[data-dismiss="modal"]',Dt='iframe[data-modal="iframe"]';function hr(e){const t=e.querySelector(Dt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Rt),e.hidden=!1,document.body.style.overflow="hidden"}function Ae(e){const t=e.querySelector(Dt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Rt),e.hidden=!0,document.body.style.overflow="hidden"}function Bt(e){const t=e.querySelectorAll(fr),n=e.querySelectorAll(pr);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||Ae(s)}),s.dataset.listenerAdded="true"),hr(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&Ae(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&Ae(s)})}async function mr(e){const{offset:t,query:n,endpoint:s}=e,r=s+n+`&start_rank=${t}`;return await(await fetch(r).catch(o=>{throw new Error(o)})).json()}function gr(e,t,n,s){e.querySelector(dr).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(Nt).innerHTML=n,e.querySelector(ur).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),Bt(e),Pt(e)}async function Cr(e){var p,h,c,w,C;const{offset:t,query:n,endpoint:s,display:r,section:i}=e,a=await mr({offset:t,query:n,endpoint:s}),o=(h=(p=a==null?void 0:a.response)==null?void 0:p.resultPacket)==null?void 0:h.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const l=[],d=[];(C=(w=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:w.results)==null||C.forEach(v=>{const g=z1(),m=G1(v);m.uniqueID=g,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(m.displayConfiguration=r,l.push(`<div class="su-relative su-grow">${or({data:m,cardType:"narrowhorizontal"})}</div>`)):l.push(`<div class="su-relative su-grow">${ar({data:m,cardType:"horizontal",cardSize:"large"})}</div>`),(m.type==="Video"||m.videoUrl)&&d.push({isVertical:m.size==="vertical-video",videoId:m.videoUrl,title:`Watch ${m.title}`,noAutoPlay:!0,uniqueID:m.uniqueID,titleID:"card-modal"})});const f=Bs({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),u=d.map(v=>`
        ...
        ${lr({videoId:v.videoId,title:v.title,noAutoPlay:v.noAutoPlay,isVertical:v.isVertical})}
        ...
        `).join("");gr(i,l.join(""),f,u)}function Pt(e){const{query:t,endpoint:n,display:s}=e.dataset,r=e.querySelector(Nt);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const o=a.getAttribute("data-offset");Cr({offset:o,query:t,endpoint:n,display:s,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(cr).forEach(e=>{Bt(e),Pt(e)})});const vr='section[data-component="vertical-video-panel"]',Zt="su-hidden",yr='button[data-click="open-modal"]',wr='button[data-dismiss="modal"]',Gt='iframe[data-modal="iframe"]';function Lr(e){const t=e.querySelector(Gt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Zt),e.hidden=!1,document.body.style.overflow="hidden"}function xe(e){const t=e.querySelector(Gt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Zt),e.hidden=!0,document.body.style.overflow=""}function Er(e){const t=e.querySelectorAll(yr),n=e.querySelectorAll(wr);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||xe(s)}),s.dataset.listenerAdded="true"),Lr(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&xe(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&xe(s)})}function br(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{ae(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?b(i,"h2 a, h3 a, button",!0):b(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(vr).forEach(e=>{br(e),Er(e)})});
