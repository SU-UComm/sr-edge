import F from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const J1='section[data-component="content-carousel"]';let B;function i1(e,s=()=>{}){const t=e.params,{slidesPerView:r,slidesPerGroup:a}=t,n=e.slides.length,u=Math.ceil(r+a);n===1&&document.querySelector(".component-slider-controls").remove(),(n<u||n%a!==0)&&ee(e,u,a,s)}function ee(e,s,t,r=()=>{}){const a=e.slides.length;let n=s-a;a%t!==0&&(n+=t-a%t);const u=document.createDocumentFragment(),o=e.slides.map(l=>l.outerHTML).join("");for(let l=0;l<n;l++){const C=document.createElement("div");for(C.innerHTML=o;C.firstChild;)C.firstChild.classList.add("swiper-slide-duplicate"),u.appendChild(C.firstChild)}e.wrapperEl.appendChild(u),e.update(),r()}function te(e){const s=e.slides.filter(t=>t.classList.contains("swiper-slide-duplicate")).length;if(s){let t=e.pagination.bullets.length-e.slides.length+s;for(;t>0;){const r=e.pagination.bullets.pop();r&&r.remove(),t--}}}const o1=(e,s)=>{e.slides.forEach(t=>{t.classList.contains("swiper-slide-active")?(t.removeAttribute("aria-hidden"),t.removeAttribute("inert"),t.setAttribute("tabindex","-1")):(t.setAttribute("aria-hidden","true"),t.setAttribute("inert","true"),t.removeAttribute("tabindex"));const r=t.querySelector("a, button")?t.querySelector("a, button"):null;s&&(console.log("isFocus",s),r&&r.focus())}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(t=>{t.classList.contains("swiper-pagination-bullet-active")?t.setAttribute("aria-current","true"):t.removeAttribute("aria-current")})};function se(e){const s=e.dataset.uniqueId;B=new F(`section[data-unique-id="${s}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${s}"] .component-slider-next`,prevEl:`section[data-unique-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(t,r){return`<button ${t===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${t+1}</span></button>`}},on:{init:t=>{i1(t)},resize:t=>{i1(t)},paginationUpdate:t=>{te(t)}}}),B.on("slideChange",function(){setTimeout(()=>{o1(B,!0)},300)}),o1(B,!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(J1).forEach(e=>{se(e)})});const re='section[data-component="featured-content"]',S1="su-hidden",ae='button[data-click="open-modal"]',ne='button[data-dismiss="modal"]',M1='iframe[data-modal="iframe"]';function ie(e){const s=e.querySelector(M1),r=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",r),e.classList.remove(S1),e.hidden=!1}function l1(e){const s=e.querySelector(M1),r=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",r),e.classList.add(S1),e.hidden=!0}function oe(e){const s=e.querySelectorAll(ae),t=e.querySelectorAll(ne);let r=null;s&&s.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&ie(r)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){l1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&l1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(re).forEach(e=>{oe(e)})});const le='section[data-component="image-gallery-modal"]',ue='button[data-click="open-gallery-modal"]',de='div[data-modal="modal"]',ce='button[data-dismiss="modal"]',E1="su-hidden";let t1;const fe=(e,s)=>{var u;const t='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',r=(u=Array.from(s==null?void 0:s.querySelectorAll(t)))==null?void 0:u.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(r.length===0||(e==null?void 0:e.key)!=="Tab")return;const a=r[0],n=r[r.length-1];e.shiftKey&&document.activeElement===a?(e.preventDefault(),n.focus()):!e.shiftKey&&document.activeElement===n&&(e.preventDefault(),a.focus())};function Ce(e){e.classList.remove(E1),e.hidden=!1,document.addEventListener("keydown",s=>{e&&fe(s,e)})}function u1(e){e.classList.add(E1),e.hidden=!0}function pe(e){const s=e.dataset.modalId;t1=new F(`div[data-modal-id="${s}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${s}"] .component-slider-next`,prevEl:`div[data-modal-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(t,r){return`<button ${t===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${t+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function ge(e){const s=e.querySelector(de),t=e.querySelector(ue),r=e.querySelector(ce);t&&t.addEventListener("click",function(){Ce(s),pe(s)}),r&&r.addEventListener("click",function(){u1(s),t1.destroy()}),document.addEventListener("keydown",function(a){a.key==="Escape"&&(u1(s),t1.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(le).forEach(e=>{ge(e)})});const he='[data-component="interactive-photo-card"]',ve="[data-card-inner]",me="[data-card-inner-content]";function we(e){var r;const t=((e.style.transform&&parseInt((r=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:r[1])||0)+180)%360;e.style.transform=`rotateY(${t}deg)`}function be(e){const s=e.querySelector(ve);if(!s){console.error("Could not find card inner element for component");return}s.addEventListener("click",()=>we(s))}const ye=e=>{e.forEach(s=>{const t=s.getAttribute("aria-hidden")==="true"?"false":"true",r=s.querySelector("button");r&&(r.tabIndex=t==="true"?"-1":""),s.setAttribute("aria-hidden",t)})},xe=e=>{const s=e.querySelectorAll(me);s.length&&s.forEach(t=>t.addEventListener("click",()=>ye(s)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(he).forEach(e=>{be(e),xe(e)})});const Le='section[data-component="media-carousel"]';let N;const d1=(e,s)=>{e.slides.forEach(t=>{t.classList.contains("swiper-slide-active")?(t.removeAttribute("aria-hidden"),t.removeAttribute("inert"),t.setAttribute("tabindex","-1")):(t.setAttribute("aria-hidden","true"),t.setAttribute("inert","true"),t.removeAttribute("tabindex"));const r=t.querySelector("h2 a, h3 a, button")?t.querySelector("h2 a, h3 a, button"):null;s&&r&&r.focus()}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(t=>{t.classList.contains("swiper-pagination-bullet-active")?t.setAttribute("aria-current","true"):t.removeAttribute("aria-current")})};function Ae(e){const s=e.dataset.uniqueId;N=new F(`section[data-unique-id="${s}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${s}"] .component-slider-next`,prevEl:`section[data-unique-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(t,r){return`<button ${t===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${t+1}</span></button>`}}}),N.on("slideChange",function(){setTimeout(()=>{d1(N,!0)},100)}),d1(N,!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Le).forEach(e=>{Ae(e)})});const Se='section[data-component="multicolumn-listing"]',k1="su-hidden",Me='button[data-click="open-modal"]',Ee='button[data-dismiss="modal"]',V1='iframe[data-modal="iframe"]';function ke(e){const s=e.querySelector(V1),r=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",r),e.classList.remove(k1),e.hidden=!1}function c1(e){const s=e.querySelector(V1),r=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",r),e.classList.add(k1),e.hidden=!0}function Ve(e){const s=e.querySelectorAll(Me),t=e.querySelectorAll(Ee);let r=null;s&&s.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&ke(r)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){c1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&c1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Se).forEach(e=>{Ve(e)})});const $e='section[data-component="stories-carousel"]',$1="su-hidden",He='button[data-click="open-modal"]',Te='button[data-dismiss="modal"]',H1='iframe[data-modal="iframe"]';function _e(e){const s=e.querySelector(H1),r=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",r),e.classList.remove($1)}function f1(e){const s=e.querySelector(H1),r=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",r),e.classList.add($1)}function Ie(e){const s=e.querySelectorAll(He),t=e.querySelectorAll(Te);let r=null;s&&s.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&_e(r)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){f1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&f1(r)})}function Ze(e){const s=e.dataset.uniqueId;new F(`section[data-unique-id="${s}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${s}"] .component-slider-next`,prevEl:`section[data-unique-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(t,r){return`<button ${t===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${t+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll($e).forEach(e=>{Ze(e),Ie(e)})});const Oe=()=>{let e=new Date().getTime(),s=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,t=>{let r=Math.random()*16;return e>0?(r=(e+r)%16|0,e=Math.floor(e/16)):(r=(s+r)%16|0,s=Math.floor(s/16)),(t==="x"?r:r&3|8).toString(16)})},De=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),Be=()=>typeof crypto<"u"?De():Oe();function Ne({title:e,listMetadata:{assetTypeCode:s,teaserPlain:t,summary:r,image:a,taxonomyContentTypeText:n,contentTopic:u,contentSubtopic:o,taxonomyContentMainTopicText:l,contentCategory:C,featuredVideo:d,taxonomyContentMainTopicLandingPageUrl:c,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:p,imageAlt:i,authorName:b,authorImage:v,author:w,isTeaser:h,storySource:g,assetHref:S},date:_,liveUrl:I}){const Z=b!==void 0?b:w,M=v!==""?v:void 0,A=a;i=a&&i?i:"",!i&&!A&&(i="a close up image of an intricate stone arch");const $=d,k=t||r;let H=l;!H&&u&&(H=u instanceof Array?u[0]:u),!H&&o&&(H=o instanceof Array?o[0]:o);const j=c;let O=n?n[0]:"";return!O&&C&&(O=C instanceof Array?C[0]:C),S&&s[0]==="link"&&(I=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(k)?k[0]:k,liveUrl:Array.isArray(I)?I[0]:I,imageUrl:Array.isArray(A)?A[0]:A,imageAlt:Array.isArray(i)?i[0]:i,taxonomy:Array.isArray(H)?H[0]:H,taxonomyUrl:Array.isArray(j)?j[0]:j,type:Array.isArray(O)?O[0]:O,videoUrl:Array.isArray($)?$[0]:$,date:Array.isArray(_)?_[0]:_,authorDisplayName:Array.isArray(Z)?Z[0]:Z,authorAvatar:Array.isArray(M)?M[0]:M,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(p)?p[0]:p,isTeaser:Array.isArray(h)?h[0]:h,storySource:Array.isArray(g)?g[0]:g}}function qe({offsetNum:e,pageNumber:s,index:t}){return`
        <button
            data-offset="${e}"
    ...
    `}function Pe({pageNumber:e,allResults:s,resultsPerPage:t,paginationRange:r}){const a=Math.ceil(s/t),n=r,u=e-t,o=e+t,l="su-text-black-50",C=[],d=[];let c=1;for(let h=0;h<a;h++){const g=h*t+1;d.push(g)}let f=[...d],p=[...d];const i=d.indexOf(c),b=Math.floor(n*.5);if((i<b||a===n)&&(f=f.filter((h,g)=>h>c&&g<n),p=p.filter(h=>h<c)),i>=b&&a!==n)if(f=f.filter((h,g)=>h>c&&g<=i+b),f.length===b)p=p.filter((h,g)=>h<c&&g>=i-b);else{const h=f.length?n-f.length:n;p=p.filter((g,S)=>g<c&&S>i-h)}return[...p,c,...f].map(h=>({offset:h,index:d.indexOf(h)+1})).forEach(({offset:h,index:g})=>{C.push(qe({offsetNum:h,pageNumber:e,index:g}))}),a>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function Re(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var s1={exports:{}},m={},r1={exports:{}},T={};function T1(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function Ue(e,s,t){}function Ge(e,s,t){}var ze=/javascript\s*\:/img;function Fe(e,s){return ze.test(s)?"":s}T.whiteList=T1();T.getDefaultWhiteList=T1;T.onAttr=Ue;T.onIgnoreAttr=Ge;T.safeAttrValue=Fe;var We={indexOf:function(e,s){var t,r;if(Array.prototype.indexOf)return e.indexOf(s);for(t=0,r=e.length;t<r;t++)if(e[t]===s)return t;return-1},forEach:function(e,s,t){var r,a;if(Array.prototype.forEach)return e.forEach(s,t);for(r=0,a=e.length;r<a;r++)s.call(t,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},D=We;function je(e,s){e=D.trimRight(e),e[e.length-1]!==";"&&(e+=";");var t=e.length,r=!1,a=0,n=0,u="";function o(){if(!r){var d=D.trim(e.slice(a,n)),c=d.indexOf(":");if(c!==-1){var f=D.trim(d.slice(0,c)),p=D.trim(d.slice(c+1));if(f){var i=s(a,u.length,f,p,d);i&&(u+=i+"; ")}}}a=n+1}for(;n<t;n++){var l=e[n];if(l==="/"&&e[n+1]==="*"){var C=e.indexOf("*/",n+2);if(C===-1)break;n=C+1,a=n+1,r=!1}else l==="("?r=!0:l===")"?r=!1:l===";"?r||o():l===`
`&&o()}return D.trim(u)}var Xe=je,q=T,Qe=Xe;function C1(e){return e==null}function Ye(e){var s={};for(var t in e)s[t]=e[t];return s}function _1(e){e=Ye(e||{}),e.whiteList=e.whiteList||q.whiteList,e.onAttr=e.onAttr||q.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||q.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||q.safeAttrValue,this.options=e}_1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var s=this,t=s.options,r=t.whiteList,a=t.onAttr,n=t.onIgnoreAttr,u=t.safeAttrValue,o=Qe(e,function(l,C,d,c,f){var p=r[d],i=!1;if(p===!0?i=p:typeof p=="function"?i=p(c):p instanceof RegExp&&(i=p.test(c)),i!==!0&&(i=!1),c=u(d,c),!!c){var b={position:C,sourcePosition:l,source:f,isWhite:i};if(i){var v=a(d,c,b);return C1(v)?d+":"+c:v}else{var v=n(d,c,b);if(!C1(v))return v}}});return o};var Ke=_1;(function(e,s){var t=T,r=Ke;function a(u,o){var l=new r(o);return l.process(u)}s=e.exports=a,s.FilterCSS=r;for(var n in t)s[n]=t[n];typeof window<"u"&&(window.filterCSS=e.exports)})(r1,r1.exports);var a1=r1.exports,n1={indexOf:function(e,s){var t,r;if(Array.prototype.indexOf)return e.indexOf(s);for(t=0,r=e.length;t<r;t++)if(e[t]===s)return t;return-1},forEach:function(e,s,t){var r,a;if(Array.prototype.forEach)return e.forEach(s,t);for(r=0,a=e.length;r<a;r++)s.call(t,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var s=/\s|\n|\t/,t=s.exec(e);return t?t.index:-1}},Je=a1.FilterCSS,et=a1.getDefaultWhiteList,z=n1;function I1(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var Z1=new Je;function tt(e,s,t){}function st(e,s,t){}function rt(e,s,t){}function at(e,s,t){}function O1(e){return e.replace(it,"&lt;").replace(ot,"&gt;")}function nt(e,s,t,r){if(t=R1(t),s==="href"||s==="src"){if(t=z.trim(t),t==="#")return"#";if(!(t.substr(0,7)==="http://"||t.substr(0,8)==="https://"||t.substr(0,7)==="mailto:"||t.substr(0,4)==="tel:"||t.substr(0,11)==="data:image/"||t.substr(0,6)==="ftp://"||t.substr(0,2)==="./"||t.substr(0,3)==="../"||t[0]==="#"||t[0]==="/"))return""}else if(s==="background"){if(P.lastIndex=0,P.test(t))return""}else if(s==="style"){if(p1.lastIndex=0,p1.test(t)||(g1.lastIndex=0,g1.test(t)&&(P.lastIndex=0,P.test(t))))return"";r!==!1&&(r=r||Z1,t=r.process(t))}return t=U1(t),t}var it=/</g,ot=/>/g,lt=/"/g,ut=/&quot;/g,dt=/&#([a-zA-Z0-9]*);?/gim,ct=/&colon;?/gim,ft=/&newline;?/gim,P=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,p1=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,g1=/u\s*r\s*l\s*\(.*/gi;function D1(e){return e.replace(lt,"&quot;")}function B1(e){return e.replace(ut,'"')}function N1(e){return e.replace(dt,function(t,r){return r[0]==="x"||r[0]==="X"?String.fromCharCode(parseInt(r.substr(1),16)):String.fromCharCode(parseInt(r,10))})}function q1(e){return e.replace(ct,":").replace(ft," ")}function P1(e){for(var s="",t=0,r=e.length;t<r;t++)s+=e.charCodeAt(t)<32?" ":e.charAt(t);return z.trim(s)}function R1(e){return e=B1(e),e=N1(e),e=q1(e),e=P1(e),e}function U1(e){return e=D1(e),e=O1(e),e}function Ct(){return""}function pt(e,s){typeof s!="function"&&(s=function(){});var t=!Array.isArray(e);function r(u){return t?!0:z.indexOf(e,u)!==-1}var a=[],n=!1;return{onIgnoreTag:function(u,o,l){if(r(u))if(l.isClosing){var C="[/removed]",d=l.position+C.length;return a.push([n!==!1?n:l.position,d]),n=!1,C}else return n||(n=l.position),"[removed]";else return s(u,o,l)},remove:function(u){var o="",l=0;return z.forEach(a,function(C){o+=u.slice(l,C[0]),l=C[1]}),o+=u.slice(l),o}}}function gt(e){for(var s="",t=0;t<e.length;){var r=e.indexOf("<!--",t);if(r===-1){s+=e.slice(t);break}s+=e.slice(t,r);var a=e.indexOf("-->",r);if(a===-1)break;t=a+3}return s}function ht(e){var s=e.split("");return s=s.filter(function(t){var r=t.charCodeAt(0);return r===127?!1:r<=31?r===10||r===13:!0}),s.join("")}m.whiteList=I1();m.getDefaultWhiteList=I1;m.onTag=tt;m.onIgnoreTag=st;m.onTagAttr=rt;m.onIgnoreTagAttr=at;m.safeAttrValue=nt;m.escapeHtml=O1;m.escapeQuote=D1;m.unescapeQuote=B1;m.escapeHtmlEntities=N1;m.escapeDangerHtml5Entities=q1;m.clearNonPrintableCharacter=P1;m.friendlyAttrValue=R1;m.escapeAttrValue=U1;m.onIgnoreTagStripAll=Ct;m.StripTagBody=pt;m.stripCommentTag=gt;m.stripBlankChar=ht;m.attributeWrapSign='"';m.cssFilter=Z1;m.getDefaultCSSWhiteList=et;var W={},V=n1;function vt(e){var s=V.spaceIndex(e),t;return s===-1?t=e.slice(1,-1):t=e.slice(1,s+1),t=V.trim(t).toLowerCase(),t.slice(0,1)==="/"&&(t=t.slice(1)),t.slice(-1)==="/"&&(t=t.slice(0,-1)),t}function mt(e){return e.slice(0,2)==="</"}function wt(e,s,t){var r="",a=0,n=!1,u=!1,o=0,l=e.length,C="",d="";e:for(o=0;o<l;o++){var c=e.charAt(o);if(n===!1){if(c==="<"){n=o;continue}}else if(u===!1){if(c==="<"){r+=t(e.slice(a,o)),n=o,a=o;continue}if(c===">"||o===l-1){r+=t(e.slice(a,n)),d=e.slice(n,o+1),C=vt(d),r+=s(n,r.length,C,d,mt(d)),a=o+1,n=!1;continue}if(c==='"'||c==="'")for(var f=1,p=e.charAt(o-f);p.trim()===""||p==="=";){if(p==="="){u=c;continue e}p=e.charAt(o-++f)}}else if(c===u){u=!1;continue}}return a<l&&(r+=t(e.substr(a))),r}var bt=/[^a-zA-Z0-9\\_:.-]/gim;function yt(e,s){var t=0,r=0,a=[],n=!1,u=e.length;function o(f,p){if(f=V.trim(f),f=f.replace(bt,"").toLowerCase(),!(f.length<1)){var i=s(f,p||"");i&&a.push(i)}}for(var l=0;l<u;l++){var C=e.charAt(l),d,c;if(n===!1&&C==="="){n=e.slice(t,l),t=l+1,r=e.charAt(t)==='"'||e.charAt(t)==="'"?t:Lt(e,l+1);continue}if(n!==!1&&l===r){if(c=e.indexOf(C,l+1),c===-1)break;d=V.trim(e.slice(r+1,c)),o(n,d),n=!1,l=c,t=l+1;continue}if(/\s|\n|\t/.test(C))if(e=e.replace(/\s|\n|\t/g," "),n===!1)if(c=xt(e,l),c===-1){d=V.trim(e.slice(t,l)),o(d),n=!1,t=l+1;continue}else{l=c-1;continue}else if(c=At(e,l-1),c===-1){d=V.trim(e.slice(t,l)),d=h1(d),o(n,d),n=!1,t=l+1;continue}else continue}return t<e.length&&(n===!1?o(e.slice(t)):o(n,h1(V.trim(e.slice(t))))),V.trim(a.join(" "))}function xt(e,s){for(;s<e.length;s++){var t=e[s];if(t!==" ")return t==="="?s:-1}}function Lt(e,s){for(;s<e.length;s++){var t=e[s];if(t!==" ")return t==="'"||t==='"'?s:-1}}function At(e,s){for(;s>0;s--){var t=e[s];if(t!==" ")return t==="="?s:-1}}function St(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function h1(e){return St(e)?e.substr(1,e.length-2):e}W.parseTag=wt;W.parseAttr=yt;var Mt=a1.FilterCSS,L=m,G1=W,Et=G1.parseTag,kt=G1.parseAttr,G=n1;function R(e){return e==null}function Vt(e){var s=G.spaceIndex(e);if(s===-1)return{html:"",closing:e[e.length-2]==="/"};e=G.trim(e.slice(s+1,-1));var t=e[e.length-1]==="/";return t&&(e=G.trim(e.slice(0,-1))),{html:e,closing:t}}function $t(e){var s={};for(var t in e)s[t]=e[t];return s}function Ht(e){var s={};for(var t in e)Array.isArray(e[t])?s[t.toLowerCase()]=e[t].map(function(r){return r.toLowerCase()}):s[t.toLowerCase()]=e[t];return s}function z1(e){e=$t(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=L.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=Ht(e.whiteList||e.allowList):e.whiteList=L.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":L.attributeWrapSign,e.onTag=e.onTag||L.onTag,e.onTagAttr=e.onTagAttr||L.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||L.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||L.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||L.safeAttrValue,e.escapeHtml=e.escapeHtml||L.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Mt(e.css))}z1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var s=this,t=s.options,r=t.whiteList,a=t.onTag,n=t.onIgnoreTag,u=t.onTagAttr,o=t.onIgnoreTagAttr,l=t.safeAttrValue,C=t.escapeHtml,d=s.attributeWrapSign,c=s.cssFilter;t.stripBlankChar&&(e=L.stripBlankChar(e)),t.allowCommentTag||(e=L.stripCommentTag(e));var f=!1;t.stripIgnoreTagBody&&(f=L.StripTagBody(t.stripIgnoreTagBody,n),n=f.onIgnoreTag);var p=Et(e,function(i,b,v,w,h){var g={sourcePosition:i,position:b,isClosing:h,isWhite:Object.prototype.hasOwnProperty.call(r,v)},S=a(v,w,g);if(!R(S))return S;if(g.isWhite){if(g.isClosing)return"</"+v+">";var _=Vt(w),I=r[v],Z=kt(_.html,function(M,A){var $=G.indexOf(I,M)!==-1,k=u(v,M,A,$);return R(k)?$?(A=l(v,M,A,c),A?M+"="+d+A+d:M):(k=o(v,M,A,$),R(k)?void 0:k):k});return w="<"+v,Z&&(w+=" "+Z),_.closing&&(w+=" /"),w+=">",w}else return S=n(v,w,g),R(S)?C(w):S},C);return f&&(p=f.remove(p)),p};var Tt=z1;(function(e,s){var t=m,r=W,a=Tt;function n(o,l){var C=new a(l);return C.process(o)}s=e.exports=n,s.filterXSS=n,s.FilterXSS=a,function(){for(var o in t)s[o]=t[o];for(var l in r)s[l]=r[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function u(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}u()&&(self.filterXSS=e.exports)})(s1,s1.exports);var _t=s1.exports;const E=Re(_t);var It=Array.isArray,F1=function(e){var s="";if(typeof e=="string")s+=e;else if(typeof e=="object"){var t=void 0;if(It(e))for(var r=0,a=e.length;r<a;)t=F1(e[r++]),t&&(s&&(s+=" "),s+=t);else for(t in e)t&&e[t]&&(s&&(s+=" "),s+=t)}return s};function W1(){for(var e=arguments.length,s=0,t,r,a="";s<e;)t=arguments[s++],t&&(r=F1(t),r&&(a&&(a+=" "),a+=r));return a}function v1({children:e="",imageUrl:s,imageAlt:t="",aspectRatio:r="card-small",videoUrl:a}){return`
    <span
      class="${W1("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",r==="card-small"&&"su-aspect-[3/2]",r==="card-medium"&&"su-aspect-[3/2]",r==="card-large"&&"su-aspect-[3/2]",r==="card-featured"&&"su-aspect-[3/2]",r==="square"&&"su-aspect-[1/1]",r==="video"&&"su-aspect-[16/9]",r==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${a?`
  ...
  `}const Zt={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function m1({imageUrl:e,alt:s="",aspectRatio:t,videoUrl:r,size:a="small",title:n="",videoIconClasses:u,uniqueId:o}){if(r){const l=`
        ...
        ${r?`
          <span
            class="${W1("su-absolute su-leading-none",a==="vertical-video"&&"su-z-30",Zt[a],u)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${v1({imageUrl:e,imageAlt:`${`Open video ${s||""} in a modal`}`,aspectRatio:t,children:l})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${v1({imageUrl:e,imageAlt:s,aspectRatio:t})}
    </div>
  `}function Ot(e,s){if(!s)return!0;const t=e.match(/(\d+-\d+-\d+)/)[0],r=s.match(/(\d+-\d+-\d+)/)[0];return t===r}function Dt({start:e,end:s}){if(!e&&!s)return null;const t=new Date(e),r=s?new Date(s):null,a={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let n="";const u=Ot(e,s);u||(delete a.time,delete a.hour,delete a.minute);const o=new Intl.DateTimeFormat("en-US",a).format(t),l=s?new Intl.DateTimeFormat("en-US",a).format(r):"";return u?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(n+=`${o} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${n}</span>`)}function Bt(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const qt="light";function Q({variant:e=qt}){const s=new Map;return s.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function Rt({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    >
    ...
    </svg>`}const y1="solid";function Xt({variant:e=y1}){const s=new Map;return s.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),s.get(e)!==null?s.get(e):s.get(y1)}function K(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Qt="light";function x1({variant:e=Qt}){const s=new Map;return s.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const y={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},a5={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function n5({data:{title:e,description:s,liveUrl:t,imageUrl:r,imageAlt:a,taxonomy:n,taxonomyUrl:u,type:o,date:l,endDate:C,videoUrl:d,uniqueID:c},cardSize:f="small"}){const p=a5[f],i=new Map;return i.set("alert",Bt()),i.set("analysis & insights",X()),i.set("analysis &amp; insights",X()),i.set("analysis&nbsp;&amp;&nbsp;insights",X()),i.set("case study",Q({variant:"light"})),i.set("case&nbsp;study",Q({variant:"light"})),i.set("casestudy",Q({variant:"light"})),i.set("event",Ut()),i.set("event&nbsp;highlights",w1()),i.set("event highlights",w1()),i.set("feature",Gt()),i.set("infographic",zt()),i.set("in&nbsp;the&nbsp;news",Y()),i.set("in the news",Y()),i.set("inthenews",Y()),i.set("leadership&nbsp;messages",b1()),i.set("leadership messages",b1()),i.set("obituary",Ft()),i.set("opinion",Wt()),i.set("photo",jt()),i.set("policy&nbsp;brief",x1({variant:"light"})),i.set("policy brief",x1({variant:"light"})),i.set("poll/quiz",K()),i.set("poll / quiz",K()),i.set("poll&nbsp;/&nbsp;quiz",K()),i.set("profile",Yt()),i.set("research",Kt()),i.set("solutions",Jt()),i.set("survey",e5()),i.set("timeline",t5()),i.set("tips & takeaways",J()),i.set("tips &amp; takeaways",J()),i.set("tips&nbsp;&amp;&nbsp;takeaways",J()),i.set("university&nbsp;updates",L1()),i.set("university updates",L1()),i.set("announcement",Nt()),i.set("news",Pt()),i.set("q&amp;a",U()),i.set("q&a",U()),i.set("q & a",U()),i.set("q&nbsp;&amp;&nbsp;a",U()),i.set("video",s5()),i.set("podcast",Xt({variant:"light"})),i.set("book",Rt({className:""})),`
    <article aria-label="${e}" class="${y.root} ${p.gap}" data-testid="horizontal-card" >
      
    ${f==="large"?`
        <div class="${y.imageWrapper} ${p.imageWrapper}">
          ${r?`
            ${m1({imageUrl:r,alt:a,videoUrl:d,mediaType:"image",aspectRatio:"card-large",size:f,uniqueId:c})}
          `:""}
        </div>
      `:""}

      ${f==="small"&&r?`
        <div class="${y.imageWrapper} ${p.imageWrapper} su-relative">
            ${m1({imageUrl:r,alt:a,videoUrl:d,mediaType:"image",aspectRatio:"large",size:f,uniqueId:c})}
        </div>
      `:""}

      <div class="${y.contentWrapper} ${p.contentGap}">
        ${f==="small"&&n?`
  ...
  `}function e1(e){if(!e)return null;const s=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(s)}`}function i5({image:e,avatarSize:s="small",alt:t=""}){const r=new Map;r.set("small","su-min-w-[56px] su-w-[56px] su-h-[56px] su-p-3"),r.set("medium","su-min-w-[165px] su-w-[165px] su-h-[165px] su-p-7"),r.set("large","su-min-w-[218px] su-w-[218px] su-h-[218px] su-p-9");const a=new Map;return a.set("small","su-w-50 su-h-50 su-top-3 su-left-3"),a.set("medium","su-size-150 su-top-7 su-left-8"),a.set("large","su-size-200 su-top-9 su-left-9"),e?`
    <div
      data-test="size-${s}"
      ...
      <div class="${x.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${x.authorWrapper} ${i}">
            ${p?`
              ${i5({image:p,avatarSize:"small",alt:`Photo of ${u}`})}
            `:""}
            ${w}
          </div>
        `:""}
  ...
  `}function l5(e){const{videoId:s,className:t="",noAutoPlay:r,title:a,isVertical:n}=e;return`
        <iframe
            width="${n?315:560}"
            height="${n?560:315}"
            class="${t}"
            src="https://www.youtube.com/embed/${s}?si=vYU81uVmaV7GSju2&amp;autoplay=${r?0:1}&amp;controls=1&amp;rel=0"
            title="${a}"
            frameBorder="0"
            ...
            data-modal="iframe"
        ></iframe>
    `}const u5='section[data-component="topic-subtopic-listing"]',d5='[data-element="topics-list"]',j1='[data-element="topics-pagination"]',X1="su-hidden",c5='section[data-element="modal-wrapper"]',f5='button[data-click="open-modal"]',C5='button[data-dismiss="modal"]',Q1='iframe[data-modal="iframe"]';function p5(e){const s=e.querySelector(Q1),r=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",r),e.classList.remove(X1),e.hidden=!1}function A1(e){const s=e.querySelector(Q1),r=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",r),e.classList.add(X1),e.hidden=!0}function Y1(e){const s=e.querySelectorAll(f5),t=e.querySelectorAll(C5);let r=null;s&&s.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&p5(r)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){A1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&A1(r)})}async function g5(e){const{offset:s,query:t,endpoint:r}=e,a=r+t+`&start_rank=${s}`;return await(await fetch(a).catch(o=>{throw new Error(o)})).json()}function h5(e,s,t,r){document.querySelector(d5).innerHTML=s,document.querySelector(j1).innerHTML=t,document.querySelector(c5).innerHTML=r,window.scrollTo({top:0,behavior:"smooth"}),Y1(e),K1(e)}async function v5(e){var f,p,i,b,v;const{offset:s,query:t,endpoint:r,display:a,section:n}=e,u=await g5({offset:s,query:t,endpoint:r}),o=(p=(f=u==null?void 0:u.response)==null?void 0:f.resultPacket)==null?void 0:p.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const l=[],C=[];(v=(b=(i=u==null?void 0:u.response)==null?void 0:i.resultPacket)==null?void 0:b.results)==null||v.forEach(w=>{const h=Be(),g=Ne(w);g.uniqueID=h,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(a)?(g.displayConfiguration=a,l.push(o5({data:g,cardType:"narrowhorizontal"}))):l.push(n5({data:g,cardType:"horizontal",cardSize:"large"})),(g.type==="Video"||g.videoUrl)&&C.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const d=Pe({pageNumber:Number(s),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(s)}),c=C.map(w=>`
        ...
        ${l5({videoId:w.videoId,title:w.title,noAutoPlay:w.noAutoPlay,isVertical:w.isVertical})}
        ...
        `).join("");h5(n,l.join(""),d,c)}function K1(e){const{query:s,endpoint:t,display:r}=e.dataset,a=e.querySelector(j1);if(!a)return;a.querySelectorAll("button").forEach(u=>{u.addEventListener("click",()=>{if(u.disabled)return;const o=u.getAttribute("data-offset");v5({offset:o,query:s,endpoint:t,display:r,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(u5).forEach(e=>{Y1(e),K1(e)})});
