import Z from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";function $e(e){if(!e)return 0;const s=225,n=e.trim().split(/\s+/).length;return Math.ceil(n/s)}function h1(e,s,n,t=()=>{}){const r=e.slides.length;let i=s-r+1;r%n!==0&&(i+=n-r%n);const a=document.createDocumentFragment(),o=e.slides.map(u=>u.outerHTML).join("");for(let u=0;u<i;u++){const f=document.createElement("div");for(f.innerHTML=o;f.firstChild;)f.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(f.firstChild)}e.wrapperEl.appendChild(a),e.update(),A(e,"",!1),t()}function q(e,s=()=>{}){const{slidesPerView:n,slidesPerGroup:t}=e.params,r=e.slides.length,i=Math.ceil(n+t);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<i||r%t!==0?h1(e,i,t,s):(A(e,"",!1),s())}function he(e){const s=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(s){let n=e.pagination.bullets.length-e.slides.length+s;for(;n>0;){const t=e.pagination.bullets.pop();t&&t.remove(),n--}}}const A=(e,s,n)=>{e.slides.forEach(t=>{if(t.classList.contains("swiper-slide-active")){if(t.removeAttribute("aria-hidden"),t.removeAttribute("inert"),t.setAttribute("tabindex","-1"),s&&n){let r=null;s==="slide"?r=t:r=t.querySelector(s),r&&r.focus()}}else t.setAttribute("aria-hidden","true"),t.setAttribute("inert","true"),t.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(t=>{t.classList.contains("swiper-pagination-bullet-active")?t.setAttribute("aria-current","true"):t.removeAttribute("aria-current")})},m1='section[data-component="basic-story-hero"]',v1='span[data-reading="true"]',Ve="su-hidden",w1='button[data-click="open-modal"]',y1='button[data-dismiss="modal"]',He='iframe[data-modal="iframe"]';function L1(e){const s=e.querySelector(He);if(s){const t=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",t)}e.classList.remove(Ve),e.hidden=!1,document.body.style.overflow="hidden"}function K(e){const s=e.querySelector(He);if(s){const t=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",t)}e.classList.add(Ve),e.hidden=!0,document.body.style.overflow=""}function b1(e){const s=e.querySelectorAll(w1),n=e.querySelectorAll(y1);let t=null;s&&s.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(t=e.querySelector(`div[data-modal-id="${i}"]`),!t)return;const a=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(a&&t.addEventListener("click",o=>{a.contains(o.target)||K(t)}),t.dataset.listenerAdded="true"),L1(t)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){t&&K(t)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&t&&K(t)})}function S1(e){var t;const s=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new Z(`section[data-unique-id="${s}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${s}"] .component-slider-next`,prevEl:`section[data-unique-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{q(a),A(a,"",!1)},resize:a=>{q(a)},paginationUpdate:a=>{he(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?A(i,"slide",!0):A(i,"",!1)},100)})}else(t=e.querySelector(".component-slider-controls"))==null||t.remove()}function A1(e){const s=document.querySelector(".su-page-content"),n=e.querySelector(v1);if(s&&n){const t=$e(s.innerText);n.textContent=t}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(m1).forEach(e=>{S1(e),b1(e),A1(e)})});const E1='section[data-component="combined-content-grid"]',Oe="su-hidden",x1='button[data-click="open-modal"]',M1='button[data-dismiss="modal"]',De='iframe[data-modal="iframe"]';function _1(e){const s=e.querySelector(De),t=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",t),e.classList.remove(Oe),e.hidden=!1,document.body.style.overflow="hidden"}function J(e){const s=e.querySelector(De),t=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",t),e.classList.add(Oe),e.hidden=!0,document.body.style.overflow=""}function k1(e){const s=e.querySelectorAll(x1),n=e.querySelectorAll(M1);let t=null;s&&s.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(t=e.querySelector(`div[data-modal-id="${i}"]`),!t)return;const a=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(a&&t.addEventListener("click",o=>{a.contains(o.target)||J(t)}),t.dataset.listenerAdded="true"),_1(t)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){t&&J(t)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&t&&J(t)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(E1).forEach(e=>{k1(e)})});const T1='section[data-component="content-carousel"]';function I1(e){var t;const s=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new Z(`section[data-unique-id="${s}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${s}"] .component-slider-next`,prevEl:`section[data-unique-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{q(a),A(a,"",!1)},resize:a=>{q(a)},paginationUpdate:a=>{he(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?A(i,"slide",!0):A(i,"",!1)},100)})}else(t=e.querySelector(".component-slider-controls"))==null||t.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(T1).forEach(e=>{I1(e)})});const $1='section[data-component="feature-story-hero"]',V1='span[data-reading="true"]';function H1(e){const s=document.querySelector(".su-page-content"),n=e.querySelector(V1);if(s&&n){const t=$e(s.innerText);n.textContent=t}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll($1).forEach(e=>{H1(e)})});const O1='section[data-component="featured-content"]',qe="su-hidden",D1='button[data-click="open-modal"]',q1='button[data-dismiss="modal"]',Ne='iframe[data-modal="iframe"]';function N1(e){const s=e.querySelector(Ne),t=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",t),e.classList.remove(qe),e.hidden=!1,document.body.style.overflow="hidden"}function ee(e){const s=e.querySelector(Ne),t=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",t),e.classList.add(qe),e.hidden=!0,document.body.style.overflow=""}function B1(e){const s=e.querySelectorAll(D1),n=e.querySelectorAll(q1);let t=null;s&&s.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(t=e.querySelector(`div[data-modal-id="${i}"]`),!t)return;const a=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(a&&t.addEventListener("click",o=>{a.contains(o.target)||ee(t)}),t.dataset.listenerAdded="true"),N1(t)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){t&&ee(t)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&t&&ee(t)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(O1).forEach(e=>{B1(e)})});const Z1='section[data-component="image-gallery-modal"]',R1='button[data-click="open-gallery-modal"]',P1='div[data-modal="modal"]',G1='button[data-dismiss="modal"]',Be="su-hidden";let pe;const U1=(e,s)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',t=(a=Array.from(s==null?void 0:s.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(t.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=t[0],i=t[t.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function F1(e){e.classList.remove(Be),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",s=>{e&&U1(s,e)})}function te(e){e.classList.add(Be),e.hidden=!0,document.body.style.overflow=""}function z1(e){const s=e.dataset.modalId;pe=new Z(`div[data-modal-id="${s}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${s}"] .component-slider-next`,prevEl:`div[data-modal-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(n,t){return`<button ${n===0?'aria-current="true"':""} class="${t}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function W1(e){const s=e.querySelector(P1),n=e.querySelector(R1),t=e.querySelector(G1);n&&n.addEventListener("click",function(){const r=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(r&&s.addEventListener("click",i=>{r.contains(i.target)||te(s)}),s.dataset.listenerAdded="true"),F1(s),z1(s)}),t&&t.addEventListener("click",function(){te(s),pe.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(te(s),pe.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Z1).forEach(e=>{W1(e)})});const j1='section[data-component="media-carousel"]';function X1(e){const s=e.dataset.uniqueId,n=new Z(`section[data-unique-id="${s}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${s}"] .component-slider-next`,prevEl:`section[data-unique-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{q(a),A(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{q(a)},paginationUpdate:a=>{he(a)}}}),t=n.slides.length,r=n.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(t-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),n.on("slideChange",function(){setTimeout(()=>{a?A(n,"h2 a, h3 a, button",!0):A(n,"",!1)},100)})}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(j1).forEach(e=>{X1(e)})});const Y1='button[data-role="copy-link"]';function Q1(e){e.addEventListener("click",function(){navigator.clipboard.writeText(window.location.href).then(()=>{const s=document.querySelector("[data-copy-text]");s.textContent="Copied",setTimeout(()=>{s.textContent="Copy link"},3e3)})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Y1).forEach(e=>{Q1(e)})});const K1='section[data-component="multicolumn-listing"]',Ze="su-hidden",J1='button[data-click="open-modal"]',et='button[data-dismiss="modal"]',Re='iframe[data-modal="iframe"]';function tt(e){const s=e.querySelector(Re),t=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",t),e.classList.remove(Ze),e.hidden=!1,document.body.style.overflow="hidden"}function se(e){const s=e.querySelector(Re),t=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",t),e.classList.add(Ze),e.hidden=!0,document.body.style.overflow=""}function st(e){const s=e.querySelectorAll(J1),n=e.querySelectorAll(et);let t=null;s&&s.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(t=e.querySelector(`div[data-modal-id="${i}"]`),!t)return;const a=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(a&&t.addEventListener("click",o=>{a.contains(o.target)||se(t)}),t.dataset.listenerAdded="true"),tt(t)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){t&&se(t)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&t&&se(t)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(K1).forEach(e=>{st(e)})});function R(e,s){e.contentWindow.postMessage(JSON.stringify({method:s}),"*")}function P(e,s){const n=e.querySelector('svg[data-control="play"]'),t=e.querySelector('svg[data-control="pause"]'),r=!s;e.setAttribute("aria-pressed",String(r)),n.classList.toggle("su-hidden",r),n.hidden=r,t.classList.toggle("su-hidden",!r),t.hidden=!r,e.innerHTML=`
  ...
  `}const nt='section[data-component="single-image-video"]',rt='iframe[data-role="video-player"]',at='button[data-role="video-control"]',Pe="su-hidden",it='button[data-click="open-modal"]',ot='button[data-dismiss="modal"]',Ge='iframe[data-modal="iframe"]',lt=(e,s)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',t=(a=Array.from(s==null?void 0:s.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(t.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=t[0],i=t[t.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function ut(e){const s=e.querySelector(Ge),t=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",t),e.classList.remove(Pe),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&lt(r,e)})}function ne(e){const s=e.querySelector(Ge),t=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",t),e.classList.add(Pe),e.hidden=!0,document.body.style.overflow=""}function dt(e){const s=e.querySelectorAll(it),n=e.querySelectorAll(ot);let t=null;s&&s.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(t=e.querySelector(`div[data-modal-id="${i}"]`),!t)return;const a=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(a&&t.addEventListener("click",o=>{a.contains(o.target)||ne(t)}),t.dataset.listenerAdded="true"),ut(t)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){t&&ne(t)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&t&&ne(t)})}function ct(e){const s=e.querySelector(rt),n=e.querySelector(at);let t=!1;if(!s||!n)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!t?(R(s,"play"),P(n,!1)):a.isIntersecting||(R(s,"pause"),P(n,!0))})},{threshold:.5}).observe(s),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(R(s,"pause"),P(n,!0),t=!0):(R(s,"play"),P(n,!1),t=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(nt).forEach(e=>{dt(e),ct(e)})});const ft='section[data-component="standalone-visual-hero"]',Ue="su-hidden",pt='button[data-click="open-modal"]',gt='button[data-dismiss="modal"]',Fe='iframe[data-modal="iframe"]';function Ct(e){const s=e.querySelector(Fe);if(s){const t=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",t)}e.classList.remove(Ue),e.hidden=!1,document.body.style.overflow="hidden"}function re(e){const s=e.querySelector(Fe);if(s){const t=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",t)}e.classList.add(Ue),e.hidden=!0,document.body.style.overflow=""}function ht(e){const s=e.querySelectorAll(pt),n=e.querySelectorAll(gt);let t=null;s.forEach(r=>{r.addEventListener("click",function(){const i=r.dataset.modalId;if(t=e.querySelector(`div[data-modal-id="${i}"]`),!t)return;const a=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(a&&t.addEventListener("click",o=>{a.contains(o.target)||re(t)}),t.dataset.listenerAdded="true"),Ct(t)})}),n.forEach(r=>{r.addEventListener("click",function(){t&&re(t)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&t&&re(t)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ft).forEach(e=>{ht(e)})});const mt='section[data-component="stories-carousel"]',ze="su-hidden",vt='button[data-click="open-modal"]',wt='button[data-dismiss="modal"]',We='iframe[data-modal="iframe"]';function yt(e){const s=e.querySelector(We),t=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",t),e.classList.remove(ze),e.hidden=!1,document.body.style.overflow="hidden"}function ae(e){const s=e.querySelector(We),t=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",t),e.classList.add(ze),e.hidden=!0,document.body.style.overflow=""}function Lt(e){const s=e.querySelectorAll(vt),n=e.querySelectorAll(wt);let t=null;s&&s.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(t=e.querySelector(`div[data-modal-id="${i}"]`),!t)return;const a=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(a&&t.addEventListener("click",o=>{a.contains(o.target)||ae(t)}),t.dataset.listenerAdded="true"),yt(t)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){t&&ae(t)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&t&&ae(t)})}let we=!1,ye=!1;function bt(e){const s=e.dataset.uniqueId,n=`section[data-unique-id="${s}"] .swiper`;new Z(n,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${s}"] .component-slider-next`,prevEl:`section[data-unique-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(t,r){return`<button ${t===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${t+1}</span></button>`}},watchSlidesProgress:!0,on:{init:function(){setTimeout(()=>{ye=!0,we=!0},500)},slideChange:function(t){const r=document.querySelector(n),i=r.querySelector(".swiper-slide-active");i&&i.removeAttribute("tabindex"),ye&&setTimeout(()=>{const a=r.querySelector(".swiper-slide-active"),o=a.querySelector("h2 a, h3 a, button")?a.querySelector("h2 a, h3 a, button"):(()=>(a.setAttribute("tabindex","-1"),a))();we&&o.focus()},300),t.slides.forEach(a=>{a.classList.contains("swiper-slide-visible")?(a.removeAttribute("aria-hidden"),a.removeAttribute("inert")):(a.setAttribute("aria-hidden","true"),a.setAttribute("inert","true"))}),t.pagination.bullets.length>0&&t.pagination.bullets.forEach(a=>{a.classList.contains("swiper-pagination-bullet-active")?a.setAttribute("aria-current","true"):a.removeAttribute("aria-current")})}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(mt).forEach(e=>{bt(e),Lt(e)})});const St=()=>{let e=new Date().getTime(),s=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let t=Math.random()*16;return e>0?(t=(e+t)%16|0,e=Math.floor(e/16)):(t=(s+t)%16|0,s=Math.floor(s/16)),(n==="x"?t:t&3|8).toString(16)})},At=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),Et=()=>typeof crypto<"u"?At():St();function xt({title:e,listMetadata:{assetTypeCode:s,teaserPlain:n,summary:t,image:r,taxonomyContentTypeText:i,contentTopic:a,contentSubtopic:o,taxonomyContentMainTopicText:u,contentCategory:f,featuredVideo:p,taxonomyContentMainTopicLandingPageUrl:d,taxonomyFeaturedUnitLandingPageUrl:c,taxonomyFeaturedUnitText:g,imageAlt:l,authorName:y,authorImage:m,author:w,isTeaser:h,storySource:C,assetHref:E},date:H,liveUrl:O}){const D=y!==void 0?y:w,x=m!==""?m:void 0,M=r&&r!==""?r:null,I=l&&l!==""?l:"",k=p,Y=n||t;let $=u;!$&&a&&($=a instanceof Array?a[0]:a),!$&&o&&($=o instanceof Array?o[0]:o);const Q=d;let N=i?i[0]:"";return!N&&f&&(N=f instanceof Array?f[0]:f),E&&s[0]==="link"&&(O=E),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(Y)?Y[0]:Y,liveUrl:Array.isArray(O)?O[0]:O,imageUrl:Array.isArray(M)?M[0]:M,imageAlt:Array.isArray(I)?I[0]:I,taxonomy:Array.isArray($)?$[0]:$,taxonomyUrl:Array.isArray(Q)?Q[0]:Q,type:Array.isArray(N)?N[0]:N,videoUrl:Array.isArray(k)?k[0]:k,date:Array.isArray(H)?H[0]:H,authorDisplayName:Array.isArray(D)?D[0]:D,authorAvatar:Array.isArray(x)?x[0]:x,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(c)?c[0]:c,taxonomyFeaturedUnitText:Array.isArray(g)?g[0]:g,isTeaser:Array.isArray(h)?h[0]:h,storySource:Array.isArray(C)?C[0]:C}}function Mt({offsetNum:e,pageNumber:s,index:n}){return`
        <button
            data-offset="${e}"
    ...
    `}function _t({pageNumber:e,allResults:s,resultsPerPage:n,paginationRange:t,currentPage:r=1}){const i=Math.ceil(s/n),a=t,o=e-n,u=e+n,f="su-text-black-50",p=[],d=[];for(let h=0;h<i;h++){const C=h*n+1;d.push(C)}let c=[...d],g=[...d];const l=d.indexOf(r),y=Math.floor(a*.5);if((l<y||i===a)&&(c=c.filter((h,C)=>h>r&&C<a),g=g.filter(h=>h<r)),l>=y&&i!==a)if(c=c.filter((h,C)=>h>r&&C<=l+y),c.length===y)g=g.filter((h,C)=>h<r&&C>=l-y);else{const h=c.length?a-c.length:a;g=g.filter((C,E)=>C<r&&E>l-h)}return[...g,r,...c].map(h=>({offset:h,index:d.indexOf(h)+1})).forEach(({offset:h,index:C})=>{p.push(Mt({offsetNum:h,pageNumber:e,index:C}))}),i>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function kt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var ge={exports:{}},v={},Ce={exports:{}},V={};function je(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function Tt(e,s,n){}function It(e,s,n){}var $t=/javascript\s*\:/img;function Vt(e,s){return $t.test(s)?"":s}V.whiteList=je();V.getDefaultWhiteList=je;V.onAttr=Tt;V.onIgnoreAttr=It;V.safeAttrValue=Vt;var Ht={indexOf:function(e,s){var n,t;if(Array.prototype.indexOf)return e.indexOf(s);for(n=0,t=e.length;n<t;n++)if(e[n]===s)return n;return-1},forEach:function(e,s,n){var t,r;if(Array.prototype.forEach)return e.forEach(s,n);for(t=0,r=e.length;t<r;t++)s.call(n,e[t],t,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},B=Ht;function Ot(e,s){e=B.trimRight(e),e[e.length-1]!==";"&&(e+=";");var n=e.length,t=!1,r=0,i=0,a="";function o(){if(!t){var p=B.trim(e.slice(r,i)),d=p.indexOf(":");if(d!==-1){var c=B.trim(p.slice(0,d)),g=B.trim(p.slice(d+1));if(c){var l=s(r,a.length,c,g,p);l&&(a+=l+"; ")}}}r=i+1}for(;i<n;i++){var u=e[i];if(u==="/"&&e[i+1]==="*"){var f=e.indexOf("*/",i+2);if(f===-1)break;i=f+1,r=i+1,t=!1}else u==="("?t=!0:u===")"?t=!1:u===";"?t||o():u===`
`&&o()}return B.trim(a)}var Dt=Ot,G=V,qt=Dt;function Le(e){return e==null}function Nt(e){var s={};for(var n in e)s[n]=e[n];return s}function Xe(e){e=Nt(e||{}),e.whiteList=e.whiteList||G.whiteList,e.onAttr=e.onAttr||G.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||G.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||G.safeAttrValue,this.options=e}Xe.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var s=this,n=s.options,t=n.whiteList,r=n.onAttr,i=n.onIgnoreAttr,a=n.safeAttrValue,o=qt(e,function(u,f,p,d,c){var g=t[p],l=!1;if(g===!0?l=g:typeof g=="function"?l=g(d):g instanceof RegExp&&(l=g.test(d)),l!==!0&&(l=!1),d=a(p,d),!!d){var y={position:f,sourcePosition:u,source:c,isWhite:l};if(l){var m=r(p,d,y);return Le(m)?p+":"+d:m}else{var m=i(p,d,y);if(!Le(m))return m}}});return o};var Bt=Xe;(function(e,s){var n=V,t=Bt;function r(a,o){var u=new t(o);return u.process(a)}s=e.exports=r,s.FilterCSS=t;for(var i in n)s[i]=n[i];typeof window<"u"&&(window.filterCSS=e.exports)})(Ce,Ce.exports);var me=Ce.exports,ve={indexOf:function(e,s){var n,t;if(Array.prototype.indexOf)return e.indexOf(s);for(n=0,t=e.length;n<t;n++)if(e[n]===s)return n;return-1},forEach:function(e,s,n){var t,r;if(Array.prototype.forEach)return e.forEach(s,n);for(t=0,r=e.length;t<r;t++)s.call(n,e[t],t,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var s=/\s|\n|\t/,n=s.exec(e);return n?n.index:-1}},Zt=me.FilterCSS,Rt=me.getDefaultWhiteList,j=ve;function Ye(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var Qe=new Zt;function Pt(e,s,n){}function Gt(e,s,n){}function Ut(e,s,n){}function Ft(e,s,n){}function Ke(e){return e.replace(Wt,"&lt;").replace(jt,"&gt;")}function zt(e,s,n,t){if(n=r1(n),s==="href"||s==="src"){if(n=j.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(s==="background"){if(U.lastIndex=0,U.test(n))return""}else if(s==="style"){if(be.lastIndex=0,be.test(n)||(Se.lastIndex=0,Se.test(n)&&(U.lastIndex=0,U.test(n))))return"";t!==!1&&(t=t||Qe,n=t.process(n))}return n=a1(n),n}var Wt=/</g,jt=/>/g,Xt=/"/g,Yt=/&quot;/g,Qt=/&#([a-zA-Z0-9]*);?/gim,Kt=/&colon;?/gim,Jt=/&newline;?/gim,U=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,be=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,Se=/u\s*r\s*l\s*\(.*/gi;function Je(e){return e.replace(Xt,"&quot;")}function e1(e){return e.replace(Yt,'"')}function t1(e){return e.replace(Qt,function(n,t){return t[0]==="x"||t[0]==="X"?String.fromCharCode(parseInt(t.substr(1),16)):String.fromCharCode(parseInt(t,10))})}function s1(e){return e.replace(Kt,":").replace(Jt," ")}function n1(e){for(var s="",n=0,t=e.length;n<t;n++)s+=e.charCodeAt(n)<32?" ":e.charAt(n);return j.trim(s)}function r1(e){return e=e1(e),e=t1(e),e=s1(e),e=n1(e),e}function a1(e){return e=Je(e),e=Ke(e),e}function e5(){return""}function t5(e,s){typeof s!="function"&&(s=function(){});var n=!Array.isArray(e);function t(a){return n?!0:j.indexOf(e,a)!==-1}var r=[],i=!1;return{onIgnoreTag:function(a,o,u){if(t(a))if(u.isClosing){var f="[/removed]",p=u.position+f.length;return r.push([i!==!1?i:u.position,p]),i=!1,f}else return i||(i=u.position),"[removed]";else return s(a,o,u)},remove:function(a){var o="",u=0;return j.forEach(r,function(f){o+=a.slice(u,f[0]),u=f[1]}),o+=a.slice(u),o}}}function s5(e){for(var s="",n=0;n<e.length;){var t=e.indexOf("<!--",n);if(t===-1){s+=e.slice(n);break}s+=e.slice(n,t);var r=e.indexOf("-->",t);if(r===-1)break;n=r+3}return s}function n5(e){var s=e.split("");return s=s.filter(function(n){var t=n.charCodeAt(0);return t===127?!1:t<=31?t===10||t===13:!0}),s.join("")}v.whiteList=Ye();v.getDefaultWhiteList=Ye;v.onTag=Pt;v.onIgnoreTag=Gt;v.onTagAttr=Ut;v.onIgnoreTagAttr=Ft;v.safeAttrValue=zt;v.escapeHtml=Ke;v.escapeQuote=Je;v.unescapeQuote=e1;v.escapeHtmlEntities=t1;v.escapeDangerHtml5Entities=s1;v.clearNonPrintableCharacter=n1;v.friendlyAttrValue=r1;v.escapeAttrValue=a1;v.onIgnoreTagStripAll=e5;v.StripTagBody=t5;v.stripCommentTag=s5;v.stripBlankChar=n5;v.attributeWrapSign='"';v.cssFilter=Qe;v.getDefaultCSSWhiteList=Rt;var X={},T=ve;function r5(e){var s=T.spaceIndex(e),n;return s===-1?n=e.slice(1,-1):n=e.slice(1,s+1),n=T.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function a5(e){return e.slice(0,2)==="</"}function i5(e,s,n){var t="",r=0,i=!1,a=!1,o=0,u=e.length,f="",p="";e:for(o=0;o<u;o++){var d=e.charAt(o);if(i===!1){if(d==="<"){i=o;continue}}else if(a===!1){if(d==="<"){t+=n(e.slice(r,o)),i=o,r=o;continue}if(d===">"||o===u-1){t+=n(e.slice(r,i)),p=e.slice(i,o+1),f=r5(p),t+=s(i,t.length,f,p,a5(p)),r=o+1,i=!1;continue}if(d==='"'||d==="'")for(var c=1,g=e.charAt(o-c);g.trim()===""||g==="=";){if(g==="="){a=d;continue e}g=e.charAt(o-++c)}}else if(d===a){a=!1;continue}}return r<u&&(t+=n(e.substr(r))),t}var o5=/[^a-zA-Z0-9\\_:.-]/gim;function l5(e,s){var n=0,t=0,r=[],i=!1,a=e.length;function o(c,g){if(c=T.trim(c),c=c.replace(o5,"").toLowerCase(),!(c.length<1)){var l=s(c,g||"");l&&r.push(l)}}for(var u=0;u<a;u++){var f=e.charAt(u),p,d;if(i===!1&&f==="="){i=e.slice(n,u),n=u+1,t=e.charAt(n)==='"'||e.charAt(n)==="'"?n:d5(e,u+1);continue}if(i!==!1&&u===t){if(d=e.indexOf(f,u+1),d===-1)break;p=T.trim(e.slice(t+1,d)),o(i,p),i=!1,u=d,n=u+1;continue}if(/\s|\n|\t/.test(f))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(d=u5(e,u),d===-1){p=T.trim(e.slice(n,u)),o(p),i=!1,n=u+1;continue}else{u=d-1;continue}else if(d=c5(e,u-1),d===-1){p=T.trim(e.slice(n,u)),p=Ae(p),o(i,p),i=!1,n=u+1;continue}else continue}return n<e.length&&(i===!1?o(e.slice(n)):o(i,Ae(T.trim(e.slice(n))))),T.trim(r.join(" "))}function u5(e,s){for(;s<e.length;s++){var n=e[s];if(n!==" ")return n==="="?s:-1}}function d5(e,s){for(;s<e.length;s++){var n=e[s];if(n!==" ")return n==="'"||n==='"'?s:-1}}function c5(e,s){for(;s>0;s--){var n=e[s];if(n!==" ")return n==="="?s:-1}}function f5(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function Ae(e){return f5(e)?e.substr(1,e.length-2):e}X.parseTag=i5;X.parseAttr=l5;var p5=me.FilterCSS,S=v,i1=X,g5=i1.parseTag,C5=i1.parseAttr,W=ve;function F(e){return e==null}function h5(e){var s=W.spaceIndex(e);if(s===-1)return{html:"",closing:e[e.length-2]==="/"};e=W.trim(e.slice(s+1,-1));var n=e[e.length-1]==="/";return n&&(e=W.trim(e.slice(0,-1))),{html:e,closing:n}}function m5(e){var s={};for(var n in e)s[n]=e[n];return s}function v5(e){var s={};for(var n in e)Array.isArray(e[n])?s[n.toLowerCase()]=e[n].map(function(t){return t.toLowerCase()}):s[n.toLowerCase()]=e[n];return s}function o1(e){e=m5(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=S.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=v5(e.whiteList||e.allowList):e.whiteList=S.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":S.attributeWrapSign,e.onTag=e.onTag||S.onTag,e.onTagAttr=e.onTagAttr||S.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||S.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||S.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||S.safeAttrValue,e.escapeHtml=e.escapeHtml||S.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new p5(e.css))}o1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var s=this,n=s.options,t=n.whiteList,r=n.onTag,i=n.onIgnoreTag,a=n.onTagAttr,o=n.onIgnoreTagAttr,u=n.safeAttrValue,f=n.escapeHtml,p=s.attributeWrapSign,d=s.cssFilter;n.stripBlankChar&&(e=S.stripBlankChar(e)),n.allowCommentTag||(e=S.stripCommentTag(e));var c=!1;n.stripIgnoreTagBody&&(c=S.StripTagBody(n.stripIgnoreTagBody,i),i=c.onIgnoreTag);var g=g5(e,function(l,y,m,w,h){var C={sourcePosition:l,position:y,isClosing:h,isWhite:Object.prototype.hasOwnProperty.call(t,m)},E=r(m,w,C);if(!F(E))return E;if(C.isWhite){if(C.isClosing)return"</"+m+">";var H=h5(w),O=t[m],D=C5(H.html,function(x,M){var I=W.indexOf(O,x)!==-1,k=a(m,x,M,I);return F(k)?I?(M=u(m,x,M,d),M?x+"="+p+M+p:x):(k=o(m,x,M,I),F(k)?void 0:k):k});return w="<"+m,D&&(w+=" "+D),H.closing&&(w+=" /"),w+=">",w}else return E=i(m,w,C),F(E)?f(w):E},f);return c&&(g=c.remove(g)),g};var w5=o1;(function(e,s){var n=v,t=X,r=w5;function i(o,u){var f=new r(u);return f.process(o)}s=e.exports=i,s.filterXSS=i,s.FilterXSS=r,function(){for(var o in n)s[o]=n[o];for(var u in t)s[u]=t[u]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(ge,ge.exports);var y5=ge.exports;const _=kt(y5);var L5=Array.isArray,l1=function(e){var s="";if(typeof e=="string")s+=e;else if(typeof e=="object"){var n=void 0;if(L5(e))for(var t=0,r=e.length;t<r;)n=l1(e[t++]),n&&(s&&(s+=" "),s+=n);else for(n in e)n&&e[n]&&(s&&(s+=" "),s+=n)}return s};function u1(){for(var e=arguments.length,s=0,n,t,r="";s<e;)n=arguments[s++],n&&(t=l1(n),t&&(r&&(r+=" "),r+=t));return r}function Ee({children:e="",imageUrl:s,imageAlt:n="",aspectRatio:t="card-small",videoUrl:r}){return`
    <span
      class="${u1("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",t==="card-small"&&"su-aspect-[3/2]",t==="card-medium"&&"su-aspect-[3/2]",t==="card-large"&&"su-aspect-[3/2]",t==="card-featured"&&"su-aspect-[3/2]",t==="square"&&"su-aspect-[1/1]",t==="video"&&"su-aspect-[16/9]",t==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${r?`
  ...
  `}const b5={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function xe({imageUrl:e,alt:s="",aspectRatio:n,videoUrl:t,size:r="small",title:i="",videoIconClasses:a,uniqueId:o}){if(t){const u=`
        ${r==="vertical-video"?`
          <div
            aria-hidden="true"
        ...
        ${t?`
          <span
            class="${u1("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",b5[r],a)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${Ee({imageUrl:e,imageAlt:`${`Open video ${s||""} in a modal`}`,aspectRatio:n,children:u})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${Ee({imageUrl:e,imageAlt:s,aspectRatio:n})}
    </div>
  `}function S5(e,s){if(!s)return!0;const n=e.match(/(\d+-\d+-\d+)/)[0],t=s.match(/(\d+-\d+-\d+)/)[0];return n===t}function A5({start:e,end:s}){if(!e&&!s)return null;const n=new Date(e),t=s?new Date(s):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const a=S5(e,s);a||(delete r.time,delete r.hour,delete r.minute);const o=new Intl.DateTimeFormat("en-US",r).format(n),u=s?new Intl.DateTimeFormat("en-US",r).format(t):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${u}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function E5(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const M5="light";function oe({variant:e=M5}){const s=new Map;return s.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function k5({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    >
    ...
    </svg>`}const ke="solid";function D5({variant:e=ke}){const s=new Map;return s.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),s.get(e)!==null?s.get(e):s.get(ke)}function ue(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const q5="light";function Te({variant:e=q5}){const s=new Map;return s.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}function d1(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}const L={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},F5={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function z5({data:{title:e,description:s,liveUrl:n,imageUrl:t,imageAlt:r,taxonomy:i,taxonomyUrl:a,type:o,date:u,endDate:f,videoUrl:p,uniqueID:d},cardSize:c="small"}){const g=F5[c],l=new Map;return l.set("alert",E5()),l.set("analysis & insights",ie()),l.set("analysis &amp; insights",ie()),l.set("analysis&nbsp;&amp;&nbsp;insights",ie()),l.set("case study",oe({variant:"light"})),l.set("case&nbsp;study",oe({variant:"light"})),l.set("casestudy",oe({variant:"light"})),l.set("event",T5()),l.set("event&nbsp;highlights",Me()),l.set("event highlights",Me()),l.set("feature",I5()),l.set("infographic",$5()),l.set("in&nbsp;the&nbsp;news",le()),l.set("in the news",le()),l.set("inthenews",le()),l.set("leadership&nbsp;messages",_e()),l.set("leadership messages",_e()),l.set("obituary",V5()),l.set("opinion",H5()),l.set("photo",O5()),l.set("policy&nbsp;brief",Te({variant:"light"})),l.set("policy brief",Te({variant:"light"})),l.set("poll/quiz",ue()),l.set("poll / quiz",ue()),l.set("poll&nbsp;/&nbsp;quiz",ue()),l.set("profile",N5()),l.set("research",B5()),l.set("solutions",Z5()),l.set("survey",R5()),l.set("timeline",P5()),l.set("tips & takeaways",de()),l.set("tips &amp; takeaways",de()),l.set("tips&nbsp;&amp;&nbsp;takeaways",de()),l.set("university&nbsp;updates",Ie()),l.set("university updates",Ie()),l.set("announcement",x5()),l.set("news",_5()),l.set("q&amp;a",z()),l.set("q&a",z()),l.set("q & a",z()),l.set("q&nbsp;&amp;&nbsp;a",z()),l.set("video",G5()),l.set("podcast",D5({variant:"light"})),l.set("book",k5({className:""})),`
    <article aria-label="${e}" class="${L.root} ${g.gap}" data-testid="horizontal-card" >
      
    ${c==="large"?`
        <div class="${L.imageWrapper} ${g.imageWrapper}">
          ${t?`
            ${xe({imageUrl:t,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"card-large",size:c,uniqueId:d})}
          `:""}
        </div>
      `:""}

      ${c==="small"&&t?`
        <div class="${L.imageWrapper} ${g.imageWrapper} su-relative">
            ${xe({imageUrl:t,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"large",size:c,uniqueId:d})}
        </div>
      `:""}

      <div class="${L.contentWrapper} ${g.contentGap}">
        ${c==="small"&&i?`
          <p class="${L.taxonomy}" data-testid="horizontal-card-taxonomy">
            <a href="${a}" class="${L.taxonomyLink}">
              ${_(i)}
            </a>
          </p>
        `:""}

        <h3 class="${L.heading} ${g.title}">
          <a href="${n}" class="${L.link}">
            ${_(e)}
            ${d1(n)?`
        ...
        ${c==="large"&&o?`
          <p data-testid="horizontal-card-type" class="${L.type}">
            ${l.get(o.toLowerCase())}
            <span class="${L.typeText}">${_(o)}</span>
          </p>
        `:""}
  ...
  `}function ce(e){if(!e)return null;const s=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(s)}`}function W5({image:e,avatarSize:s="small",alt:n=""}){const t=new Map;t.set("small","su-min-w-[56px] su-w-[56px] su-h-[56px] su-p-3"),t.set("medium","su-min-w-[165px] su-w-[165px] su-h-[165px] su-p-7"),t.set("large","su-min-w-[218px] su-w-[218px] su-h-[218px] su-p-9");const r=new Map;return r.set("small","su-w-50 su-h-50 su-top-3 su-left-3"),r.set("medium","su-size-150 su-top-7 su-left-8"),r.set("large","su-size-200 su-top-9 su-left-9"),e?`
    <div
      data-test="size-${s}"
      class="su-component-avatar su-relative su-block su-rounded-full su-bg-gradient-light-red-h su-overflow-hidden ${t.get(s)}"
    >
      <img
        class="su-absolute su-rounded-full su-object-cover su-object-center ${r.get(s)}"
        src="${e}"
        alt="${n}"
      />
    </div>
  `:""}const b={root:"su-grid su-grid-gap su-grid-cols-6 lg:su-grid-cols-10",contentWrapper:"su-flex su-flex-col su-gap-12 su-col-start-1 su-col-span-full lg:su-col-span-6 lg:su-col-start-3",source:"su-text-16 lg:su-text-18 su-leading-[130%] su-font-semibold su-my-0",taxonomy:"su-relative su-text-16 su-leading-[2.3rem] lg:su-text-18 su-z-10 su-mb-0 su-font-semibold",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red hocus:su-underline",heading:"su-font-serif su-basefont-23 su-my-0",link:"su-group hocus:su-text-digital-red hocus:su-underline su-transition su-text-black dark:su-text-white dark:hocus:su-text-dark-mode-red",linkIcon:"su-text-digital-red dark:su-text-dark-mode-red su-translate-x-0 su-translate-y-0 su-transition group-hocus:su-translate-y-[-.1em] group-hocus:su-translate-x-[.1em] su-inline-block",description:"su-my-0 su-text-16 su-leading-[2.4rem] lg:su-text-18 lg:su-leading-[2.7rem]",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0",authorWrapper:"su-flex su-w-full su-min-h-[56px] su-self-end lg:su-self-start su-items-center su-gap-10 su-text-black dark:su-text-white su-text-16 su-leading-[19.106px]",date:"su-text-black-70 dark:su-text-black-60 su-text-16 lg:su-text-18 su-leading-[130%] su-font-semibold su-my-0"};function j5({data:{title:e,description:s,liveUrl:n,imageUrl:t,date:r,authorAvatar:i,authorDisplayName:a,displayConfiguration:o,taxonomyFeaturedUnitLandingPageUrl:u,taxonomyFeaturedUnitText:f,isTeaser:p,storySource:d}}){const c=Array.isArray(t)?t[0]:t,g=i||c,l=i?"su-ml-[-3px] su-mb-[-3px]":"";let y=d1(n)&&(Array.isArray(p)?p[0]==="true":p==="true");const m=`
  ...
  `:m;return`
    <article aria-label="${e}" class="${b.root}" data-testid="narrow-horizontal-card">
      <div class="${b.contentWrapper}">
        ...
        ${o==="Announcements"&&f?`
          <p data-testid="vertical-card-taxonomy" class="${b.taxonomy}">
            ${u?`
              <a href="${u}" class="${b.taxonomyLink}">
                ${_(f)}
              </a>
            `:`
              <span>${_(f)}</span>
        ...
        <h3 class="${b.heading}">
          <a class="${b.link}" href="${n}">
            <span>${_(e)}</span>
            ${y?`
              <span class="${b.linkIcon}">
        ...
        ${s?`
          <div data-testid="narrow-horizontal-card-description" class="${b.description}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${b.authorWrapper} ${l}">
            ${g?`
              ${W5({image:g,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${w}
          </div>
        `:""}
  ...
  `}function X5(e){const{videoId:s,className:n="",noAutoPlay:t,title:r,isVertical:i}=e;return`
        <iframe
            width="${i?315:560}"
            height="${i?560:315}"
            class="${n}"
            src="https://www.youtube.com/embed/${s}?si=vYU81uVmaV7GSju2&amp;autoplay=${t?0:1}&amp;controls=1&amp;rel=0"
            title="${r}"
            frameBorder="0"
            ...
            data-modal="iframe"
        ></iframe>
    `}const Y5='section[data-component="topic-subtopic-listing"]',Q5='[data-element="topics-list"]',c1='[data-element="topics-pagination"]',f1="su-hidden",K5='section[data-element="modal-wrapper"]',J5='button[data-click="open-modal"]',es='button[data-dismiss="modal"]',p1='iframe[data-modal="iframe"]';function ts(e){const s=e.querySelector(p1),t=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",t),e.classList.remove(f1),e.hidden=!1,document.body.style.overflow="hidden"}function fe(e){const s=e.querySelector(p1),t=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",t),e.classList.add(f1),e.hidden=!0,document.body.style.overflow="hidden"}function g1(e){const s=e.querySelectorAll(J5),n=e.querySelectorAll(es);let t=null;s&&s.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(t=e.querySelector(`div[data-modal-id="${i}"]`),!t)return;const a=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(a&&t.addEventListener("click",o=>{a.contains(o.target)||fe(t)}),t.dataset.listenerAdded="true"),ts(t)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){t&&fe(t)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&t&&fe(t)})}async function ss(e){const{offset:s,query:n,endpoint:t}=e,r=t+n+`&start_rank=${s}`;return await(await fetch(r).catch(o=>{throw new Error(o)})).json()}function ns(e,s,n,t){e.querySelector(Q5).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${s}</div></div>`,e.querySelector(c1).innerHTML=n,e.querySelector(K5).innerHTML=t,window.scrollTo({top:0,behavior:"smooth"}),g1(e),C1(e)}async function rs(e){var c,g,l,y,m;const{offset:s,query:n,endpoint:t,display:r,section:i}=e,a=await ss({offset:s,query:n,endpoint:t}),o=(g=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:g.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const u=[],f=[];(m=(y=(l=a==null?void 0:a.response)==null?void 0:l.resultPacket)==null?void 0:y.results)==null||m.forEach(w=>{const h=Et(),C=xt(w);C.uniqueID=h,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(C.displayConfiguration=r,u.push(`<div class="su-relative su-grow">${j5({data:C,cardType:"narrowhorizontal"})}</div>`)):u.push(`<div class="su-relative su-grow">${z5({data:C,cardType:"horizontal",cardSize:"large"})}</div>`),(C.type==="Video"||C.videoUrl)&&f.push({isVertical:C.size==="vertical-video",videoId:C.videoUrl,title:`Watch ${C.title}`,noAutoPlay:!0,uniqueID:C.uniqueID,titleID:"card-modal"})});const p=_t({pageNumber:Number(s),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(s)}),d=f.map(w=>`
        ...
        ${X5({videoId:w.videoId,title:w.title,noAutoPlay:w.noAutoPlay,isVertical:w.isVertical})}
        ...
        `).join("");ns(i,u.join(""),p,d)}function C1(e){const{query:s,endpoint:n,display:t}=e.dataset,r=e.querySelector(c1);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const o=a.getAttribute("data-offset");rs({offset:o,query:s,endpoint:n,display:t,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Y5).forEach(e=>{g1(e),C1(e)})});
