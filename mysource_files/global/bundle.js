import R from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";function u1(e,t,s,r=()=>{}){const n=e.slides.length;let a=t-n+1;n%s!==0&&(a+=s-n%s);const i=document.createDocumentFragment(),o=e.slides.map(u=>u.outerHTML).join("");for(let u=0;u<a;u++){const p=document.createElement("div");for(p.innerHTML=o;p.firstChild;)p.firstChild.classList.add("swiper-slide-duplicate"),i.appendChild(p.firstChild)}e.wrapperEl.appendChild(i),e.update(),q(e,"",!1),r()}function Z(e,t=()=>{}){const{slidesPerView:s,slidesPerGroup:r}=e.params,n=e.slides.length,a=Math.ceil(s+r);n===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),n-1<a||n%r!==0?u1(e,a,r,t):(q(e,"",!1),t())}function le(e){const t=e.slides.filter(s=>s.classList.contains("swiper-slide-duplicate")).length;if(t){let s=e.pagination.bullets.length-e.slides.length+t;for(;s>0;){const r=e.pagination.bullets.pop();r&&r.remove(),s--}}}const q=(e,t,s)=>{e.slides.forEach(r=>{if(r.classList.contains("swiper-slide-active")){if(r.removeAttribute("aria-hidden"),r.removeAttribute("inert"),r.setAttribute("tabindex","-1"),t&&s){let n=null;t==="slide"?n=r:n=r.querySelector(t),n&&n.focus()}}else r.setAttribute("aria-hidden","true"),r.setAttribute("inert","true"),r.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(r=>{r.classList.contains("swiper-pagination-bullet-active")?r.setAttribute("aria-current","true"):r.removeAttribute("aria-current")})},c1='section[data-component="content-carousel"]';function d1(e){var r;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let n=!1;const a=new R(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(i,o){return`<button ${i===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${i+1}</span></button>`}},on:{init:i=>{Z(i),setTimeout(()=>{n=!0},100)},resize:i=>{Z(i)},paginationUpdate:i=>{le(i)}}});a.on("slideChange",function(){n&&setTimeout(()=>{q(a,"slide",!0)},100)})}else(r=e.querySelector(".component-slider-controls"))==null||r.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(c1).forEach(e=>{d1(e)})});const f1='section[data-component="featured-content"]',_e="su-hidden",p1='button[data-click="open-modal"]',C1='button[data-dismiss="modal"]',$e='iframe[data-modal="iframe"]';function g1(e){const t=e.querySelector($e),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(_e),e.hidden=!1}function de(e){const t=e.querySelector($e),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(_e),e.hidden=!0}function h1(e){const t=e.querySelectorAll(p1),s=e.querySelectorAll(C1);let r=null;t&&t.forEach(n=>{n&&n.addEventListener("click",function(){const a=n.dataset.modalId;r=e.querySelector(`div[data-modal-id="${a}"]`),r&&g1(r)})}),s&&s.forEach(n=>{n&&n.addEventListener("click",function(){de(r)})}),document.addEventListener("keydown",function(n){n.key==="Escape"&&r&&de(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(f1).forEach(e=>{h1(e)})});const m1='section[data-component="image-gallery-modal"]',v1='button[data-click="open-gallery-modal"]',w1='div[data-modal="modal"]',y1='button[data-dismiss="modal"]',ke="su-hidden";let ae;const b1=(e,t)=>{var i;const s='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',r=(i=Array.from(t==null?void 0:t.querySelectorAll(s)))==null?void 0:i.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(r.length===0||(e==null?void 0:e.key)!=="Tab")return;const n=r[0],a=r[r.length-1];e.shiftKey&&document.activeElement===n?(e.preventDefault(),a.focus()):!e.shiftKey&&document.activeElement===a&&(e.preventDefault(),n.focus())};function L1(e){e.classList.remove(ke),e.hidden=!1,document.addEventListener("keydown",t=>{e&&b1(t,e)})}function fe(e){e.classList.add(ke),e.hidden=!0}function x1(e){const t=e.dataset.modalId;ae=new R(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function A1(e){const t=e.querySelector(w1),s=e.querySelector(v1),r=e.querySelector(y1);s&&s.addEventListener("click",function(){L1(t),x1(t)}),r&&r.addEventListener("click",function(){fe(t),ae.destroy()}),document.addEventListener("keydown",function(n){n.key==="Escape"&&(fe(t),ae.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(m1).forEach(e=>{A1(e)})});const E1='[data-component="interactive-photo-card"]',S1="[data-card-inner]",M1="[data-card-inner-content]";function I1(e){var r;const s=((e.style.transform&&parseInt((r=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:r[1])||0)+180)%360;e.style.transform=`rotateY(${s}deg)`}function _1(e){const t=e.querySelector(S1);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>I1(t))}const $1=e=>{e.forEach(t=>{const s=t.getAttribute("aria-hidden")==="true"?"false":"true",r=t.querySelector("button");r&&(r.tabIndex=s==="true"?"-1":""),t.setAttribute("aria-hidden",s)})},k1=e=>{const t=e.querySelectorAll(M1);t.length&&t.forEach(s=>s.addEventListener("click",()=>$1(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(E1).forEach(e=>{_1(e),k1(e)})});class V1{constructor(t,s){this.url=t,this.type=s,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const r=this.assetIds.map(async n=>{const a=`${this.url}/${n}?data=${this.assetData}`;return await(await fetch(a,this.requestProps).catch(u=>{throw new Error(u)})).json()});return Promise.all(r)}return await(await fetch(this.url,this.requestProps).catch(r=>{throw new Error(r)})).json()}}function T1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:s,summary:r,image:n,taxonomyContentTypeText:a,contentTopic:i,contentSubtopic:o,taxonomyContentMainTopicText:u,contentCategory:p,featuredVideo:c,taxonomyContentMainTopicLandingPageUrl:d,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:C,imageAlt:l,authorName:y,authorImage:m,author:v,isTeaser:h,storySource:g,assetHref:x},date:k,liveUrl:V}){const T=y!==void 0?y:v,A=m!==""?m:void 0,E=n;l=n&&l?l:"",!l&&!E&&(l="a close up image of an intricate stone arch");const b=c,_=s||r;let H=u;!H&&i&&(H=i instanceof Array?i[0]:i),!H&&o&&(H=o instanceof Array?o[0]:o);const D=d;let P=a?a[0]:"";return!P&&p&&(P=p instanceof Array?p[0]:p),x&&t[0]==="link"&&(V=x),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(_)?_[0]:_,liveUrl:Array.isArray(V)?V[0]:V,imageUrl:Array.isArray(E)?E[0]:E,imageAlt:Array.isArray(l)?l[0]:l,taxonomy:Array.isArray(H)?H[0]:H,taxonomyUrl:Array.isArray(D)?D[0]:D,type:Array.isArray(P)?P[0]:P,videoUrl:Array.isArray(b)?b[0]:b,date:Array.isArray(k)?k[0]:k,authorDisplayName:Array.isArray(T)?T[0]:T,authorAvatar:Array.isArray(A)?A[0]:A,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(h)?h[0]:h,storySource:Array.isArray(g)?g[0]:g}}function K(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}const Ve=typeof window>"u"?{}:window;function H1(e=Ve){return e.document!==void 0}function O1(e,t=Ve){if(!H1(t))return null;const{document:s}=t,{cookie:r}=s;if(typeof r!="string")return null;const n=r.split("; ");let a=null;return n.find(i=>{const[o,u]=i.split("=");return o===e&&u!==""&&(a=u),null}),a}function Te(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}function N1(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}const Z1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,s=>{let r=Math.random()*16;return e>0?(r=(e+r)%16|0,e=Math.floor(e/16)):(r=(t+r)%16|0,t=Math.floor(t/16)),(s==="x"?r:r&3|8).toString(16)})},q1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),P1=()=>typeof crypto<"u"?q1():Z1();async function B1(e=null,t="",s=null){var n,a,i,o,u,p,c,d,f,C,l,y,m,v,h,g,x,k,V;const r=new V1;if(e&&((n=e==null?void 0:e.search)!=null&&n.endpoint)){const T=`
    ...
    `}function U1(e,t,s){if(!e.length){t.classList.add(L.NO_STORIES);return}const[r,n,a]=e;s.innerHTML=`
    ...
    `,t.classList.remove(L.NO_STORIES)}async function F1(e,t,s,r,n,a){const o=(await B1(e,a,t)).map(({title:u,indexUrl:p})=>G1(u,p));U1(o,s,n),z1(s,r,n)}function z1(e,t,s){t.addEventListener("click",function(){R1(t,s)}),window.addEventListener("scroll",function(){D1(e)})}function W1(e,t,s,r){if(!e||!window.pageController)return;const n=window.pageController,a=n.topicsQuery?n.topicsQuery():null;F1(n,a,e,t,s,r)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(J.WRAPPER),t=document.querySelector(J.TOGGLE),s=document.querySelector(J.DRAWER),r=O1("preferences_personalisation");W1(e,t,s,r)});const j1='section[data-component="media-carousel"]';function X1(e){const t=e.dataset.uniqueId,s=new R(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(i,o){return`<button ${i===0?'aria-current="true"':""} class="${o} ${i===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${i+1}</span></button>`}},on:{init:i=>{Z(i),i.activeIndex===1&&i.slidePrev()},resize:i=>{Z(i)},paginationUpdate:i=>{le(i)}}}),r=s.slides.length,n=s.slides.filter(i=>i.classList.contains("swiper-slide-duplicate")).length;Math.floor(r-n)>1&&(s.on("slideChange",function(){setTimeout(()=>{q(s,"h2 a, h3 a, button",!0)},100)}),q(s,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(j1).forEach(e=>{X1(e)})});const Q1='section[data-component="multicolumn-listing"]',He="su-hidden",Y1='button[data-click="open-modal"]',K1='button[data-dismiss="modal"]',Oe='iframe[data-modal="iframe"]';function J1(e){const t=e.querySelector(Oe),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(He),e.hidden=!1}function pe(e){const t=e.querySelector(Oe),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(He),e.hidden=!0}function et(e){const t=e.querySelectorAll(Y1),s=e.querySelectorAll(K1);let r=null;t&&t.forEach(n=>{n&&n.addEventListener("click",function(){const a=n.dataset.modalId;r=e.querySelector(`div[data-modal-id="${a}"]`),r&&J1(r)})}),s&&s.forEach(n=>{n&&n.addEventListener("click",function(){pe(r)})}),document.addEventListener("keydown",function(n){n.key==="Escape"&&r&&pe(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Q1).forEach(e=>{et(e)})});function G(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function U(e,t){const s=e.querySelector('svg[data-control="play"]'),r=e.querySelector('svg[data-control="pause"]'),n=!t;e.setAttribute("aria-pressed",String(n)),s.classList.toggle("su-hidden",n),s.hidden=n,r.classList.toggle("su-hidden",!n),r.hidden=!n,e.innerHTML=`
  ...
  `}const tt='section[data-component="single-image-video"]',st='iframe[data-role="video-player"]',rt='button[data-role="video-control"]',Ne="su-hidden",nt='button[data-click="open-modal"]',at='button[data-dismiss="modal"]',Ze='iframe[data-modal="iframe"]',it=(e,t)=>{var i;const s='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',r=(i=Array.from(t==null?void 0:t.querySelectorAll(s)))==null?void 0:i.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(r.length===0||(e==null?void 0:e.key)!=="Tab")return;const n=r[0],a=r[r.length-1];e.shiftKey&&document.activeElement===n?(e.preventDefault(),a.focus()):!e.shiftKey&&document.activeElement===a&&(e.preventDefault(),n.focus())};function ot(e){const t=e.querySelector(Ze),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(Ne),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",n=>{e&&it(n,e)})}function Ce(e){const t=e.querySelector(Ze),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(Ne),e.hidden=!0,document.body.style.overflow=""}function lt(e){const t=e.querySelectorAll(nt),s=e.querySelectorAll(at);let r=null;t&&t.forEach(n=>{n&&n.addEventListener("click",function(){const a=n.dataset.modalId;r=e.querySelector(`div[data-modal-id="${a}"]`),r&&ot(r)})}),s&&s.forEach(n=>{n&&n.addEventListener("click",function(){Ce(r)})}),document.addEventListener("keydown",function(n){n.key==="Escape"&&r&&Ce(r)})}function ut(e){const t=e.querySelector(st),s=e.querySelector(rt);let r=!1;if(!t||!s)return;new IntersectionObserver(a=>{a.forEach(i=>{i.isIntersecting&&!r?(G(t,"play"),U(s,!1)):i.isIntersecting||(G(t,"pause"),U(s,!0))})},{threshold:.5}).observe(t),s.addEventListener("click",()=>{s.getAttribute("aria-pressed")==="true"?(G(t,"pause"),U(s,!0),r=!0):(G(t,"play"),U(s,!1),r=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(tt).forEach(e=>{lt(e),ut(e)})});const ct='section[data-component="stories-carousel"]',qe="su-hidden",dt='button[data-click="open-modal"]',ft='button[data-dismiss="modal"]',Pe='iframe[data-modal="iframe"]';function pt(e){const t=e.querySelector(Pe),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(qe)}function ge(e){const t=e.querySelector(Pe),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(qe)}function Ct(e){const t=e.querySelectorAll(dt),s=e.querySelectorAll(ft);let r=null;t&&t.forEach(n=>{n&&n.addEventListener("click",function(){const a=n.dataset.modalId;r=e.querySelector(`div[data-modal-id="${a}"]`),r&&pt(r)})}),s&&s.forEach(n=>{n&&n.addEventListener("click",function(){ge(r)})}),document.addEventListener("keydown",function(n){n.key==="Escape"&&r&&ge(r)})}function gt(e){const t=e.dataset.uniqueId;new R(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ct).forEach(e=>{gt(e),Ct(e)})});function ht({offsetNum:e,pageNumber:t,index:s}){return`
        <button
            data-offset="${e}"
    ...
    `}function mt({pageNumber:e,allResults:t,resultsPerPage:s,paginationRange:r}){const n=Math.ceil(t/s),a=r,i=e-s,o=e+s,u="su-text-black-50",p=[],c=[];let d=1;for(let h=0;h<n;h++){const g=h*s+1;c.push(g)}let f=[...c],C=[...c];const l=c.indexOf(d),y=Math.floor(a*.5);if((l<y||n===a)&&(f=f.filter((h,g)=>h>d&&g<a),C=C.filter(h=>h<d)),l>=y&&n!==a)if(f=f.filter((h,g)=>h>d&&g<=l+y),f.length===y)C=C.filter((h,g)=>h<d&&g>=l-y);else{const h=f.length?a-f.length:a;C=C.filter((g,x)=>g<d&&x>l-h)}return[...C,d,...f].map(h=>({offset:h,index:c.indexOf(h)+1})).forEach(({offset:h,index:g})=>{p.push(ht({offsetNum:h,pageNumber:e,index:g}))}),n>1?`<div class="su-mx-auto su-component-container">
                <div class="su-flex su-gap-9 su-items-center su-justify-center su-rs-mt-4 lg:su-rs-mt-7">
                    ...
                    <button
                    type="button"
                        class="su-size-24 su-font-serif su-flex su-items-center su-justify-center dark:su-text-white ${o>c[c.length-1]?u:""}"
            ...
            </div>`:""}function vt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var ie={exports:{}},w={},oe={exports:{}},N={};function Be(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function wt(e,t,s){}function yt(e,t,s){}var bt=/javascript\s*\:/img;function Lt(e,t){return bt.test(t)?"":t}N.whiteList=Be();N.getDefaultWhiteList=Be;N.onAttr=wt;N.onIgnoreAttr=yt;N.safeAttrValue=Lt;var xt={indexOf:function(e,t){var s,r;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,r=e.length;s<r;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var r,n;if(Array.prototype.forEach)return e.forEach(t,s);for(r=0,n=e.length;r<n;r++)t.call(s,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},B=xt;function At(e,t){e=B.trimRight(e),e[e.length-1]!==";"&&(e+=";");var s=e.length,r=!1,n=0,a=0,i="";function o(){if(!r){var c=B.trim(e.slice(n,a)),d=c.indexOf(":");if(d!==-1){var f=B.trim(c.slice(0,d)),C=B.trim(c.slice(d+1));if(f){var l=t(n,i.length,f,C,c);l&&(i+=l+"; ")}}}n=a+1}for(;a<s;a++){var u=e[a];if(u==="/"&&e[a+1]==="*"){var p=e.indexOf("*/",a+2);if(p===-1)break;a=p+1,n=a+1,r=!1}else u==="("?r=!0:u===")"?r=!1:u===";"?r||o():u===`
`&&o()}return B.trim(i)}var Et=At,F=N,St=Et;function he(e){return e==null}function Mt(e){var t={};for(var s in e)t[s]=e[s];return t}function Re(e){e=Mt(e||{}),e.whiteList=e.whiteList||F.whiteList,e.onAttr=e.onAttr||F.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||F.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||F.safeAttrValue,this.options=e}Re.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,r=s.whiteList,n=s.onAttr,a=s.onIgnoreAttr,i=s.safeAttrValue,o=St(e,function(u,p,c,d,f){var C=r[c],l=!1;if(C===!0?l=C:typeof C=="function"?l=C(d):C instanceof RegExp&&(l=C.test(d)),l!==!0&&(l=!1),d=i(c,d),!!d){var y={position:p,sourcePosition:u,source:f,isWhite:l};if(l){var m=n(c,d,y);return he(m)?c+":"+d:m}else{var m=a(c,d,y);if(!he(m))return m}}});return o};var It=Re;(function(e,t){var s=N,r=It;function n(i,o){var u=new r(o);return u.process(i)}t=e.exports=n,t.FilterCSS=r;for(var a in s)t[a]=s[a];typeof window<"u"&&(window.filterCSS=e.exports)})(oe,oe.exports);var ue=oe.exports,ce={indexOf:function(e,t){var s,r;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,r=e.length;s<r;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var r,n;if(Array.prototype.forEach)return e.forEach(t,s);for(r=0,n=e.length;r<n;r++)t.call(s,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,s=t.exec(e);return s?s.index:-1}},_t=ue.FilterCSS,$t=ue.getDefaultWhiteList,Q=ce;function De(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var Ge=new _t;function kt(e,t,s){}function Vt(e,t,s){}function Tt(e,t,s){}function Ht(e,t,s){}function Ue(e){return e.replace(Nt,"&lt;").replace(Zt,"&gt;")}function Ot(e,t,s,r){if(s=Qe(s),t==="href"||t==="src"){if(s=Q.trim(s),s==="#")return"#";if(!(s.substr(0,7)==="http://"||s.substr(0,8)==="https://"||s.substr(0,7)==="mailto:"||s.substr(0,4)==="tel:"||s.substr(0,11)==="data:image/"||s.substr(0,6)==="ftp://"||s.substr(0,2)==="./"||s.substr(0,3)==="../"||s[0]==="#"||s[0]==="/"))return""}else if(t==="background"){if(z.lastIndex=0,z.test(s))return""}else if(t==="style"){if(me.lastIndex=0,me.test(s)||(ve.lastIndex=0,ve.test(s)&&(z.lastIndex=0,z.test(s))))return"";r!==!1&&(r=r||Ge,s=r.process(s))}return s=Ye(s),s}var Nt=/</g,Zt=/>/g,qt=/"/g,Pt=/&quot;/g,Bt=/&#([a-zA-Z0-9]*);?/gim,Rt=/&colon;?/gim,Dt=/&newline;?/gim,z=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,me=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,ve=/u\s*r\s*l\s*\(.*/gi;function Fe(e){return e.replace(qt,"&quot;")}function ze(e){return e.replace(Pt,'"')}function We(e){return e.replace(Bt,function(s,r){return r[0]==="x"||r[0]==="X"?String.fromCharCode(parseInt(r.substr(1),16)):String.fromCharCode(parseInt(r,10))})}function je(e){return e.replace(Rt,":").replace(Dt," ")}function Xe(e){for(var t="",s=0,r=e.length;s<r;s++)t+=e.charCodeAt(s)<32?" ":e.charAt(s);return Q.trim(t)}function Qe(e){return e=ze(e),e=We(e),e=je(e),e=Xe(e),e}function Ye(e){return e=Fe(e),e=Ue(e),e}function Gt(){return""}function Ut(e,t){typeof t!="function"&&(t=function(){});var s=!Array.isArray(e);function r(i){return s?!0:Q.indexOf(e,i)!==-1}var n=[],a=!1;return{onIgnoreTag:function(i,o,u){if(r(i))if(u.isClosing){var p="[/removed]",c=u.position+p.length;return n.push([a!==!1?a:u.position,c]),a=!1,p}else return a||(a=u.position),"[removed]";else return t(i,o,u)},remove:function(i){var o="",u=0;return Q.forEach(n,function(p){o+=i.slice(u,p[0]),u=p[1]}),o+=i.slice(u),o}}}function Ft(e){for(var t="",s=0;s<e.length;){var r=e.indexOf("<!--",s);if(r===-1){t+=e.slice(s);break}t+=e.slice(s,r);var n=e.indexOf("-->",r);if(n===-1)break;s=n+3}return t}function zt(e){var t=e.split("");return t=t.filter(function(s){var r=s.charCodeAt(0);return r===127?!1:r<=31?r===10||r===13:!0}),t.join("")}w.whiteList=De();w.getDefaultWhiteList=De;w.onTag=kt;w.onIgnoreTag=Vt;w.onTagAttr=Tt;w.onIgnoreTagAttr=Ht;w.safeAttrValue=Ot;w.escapeHtml=Ue;w.escapeQuote=Fe;w.unescapeQuote=ze;w.escapeHtmlEntities=We;w.escapeDangerHtml5Entities=je;w.clearNonPrintableCharacter=Xe;w.friendlyAttrValue=Qe;w.escapeAttrValue=Ye;w.onIgnoreTagStripAll=Gt;w.StripTagBody=Ut;w.stripCommentTag=Ft;w.stripBlankChar=zt;w.attributeWrapSign='"';w.cssFilter=Ge;w.getDefaultCSSWhiteList=$t;var Y={},O=ce;function Wt(e){var t=O.spaceIndex(e),s;return t===-1?s=e.slice(1,-1):s=e.slice(1,t+1),s=O.trim(s).toLowerCase(),s.slice(0,1)==="/"&&(s=s.slice(1)),s.slice(-1)==="/"&&(s=s.slice(0,-1)),s}function jt(e){return e.slice(0,2)==="</"}function Xt(e,t,s){var r="",n=0,a=!1,i=!1,o=0,u=e.length,p="",c="";e:for(o=0;o<u;o++){var d=e.charAt(o);if(a===!1){if(d==="<"){a=o;continue}}else if(i===!1){if(d==="<"){r+=s(e.slice(n,o)),a=o,n=o;continue}if(d===">"||o===u-1){r+=s(e.slice(n,a)),c=e.slice(a,o+1),p=Wt(c),r+=t(a,r.length,p,c,jt(c)),n=o+1,a=!1;continue}if(d==='"'||d==="'")for(var f=1,C=e.charAt(o-f);C.trim()===""||C==="=";){if(C==="="){i=d;continue e}C=e.charAt(o-++f)}}else if(d===i){i=!1;continue}}return n<u&&(r+=s(e.substr(n))),r}var Qt=/[^a-zA-Z0-9\\_:.-]/gim;function Yt(e,t){var s=0,r=0,n=[],a=!1,i=e.length;function o(f,C){if(f=O.trim(f),f=f.replace(Qt,"").toLowerCase(),!(f.length<1)){var l=t(f,C||"");l&&n.push(l)}}for(var u=0;u<i;u++){var p=e.charAt(u),c,d;if(a===!1&&p==="="){a=e.slice(s,u),s=u+1,r=e.charAt(s)==='"'||e.charAt(s)==="'"?s:Jt(e,u+1);continue}if(a!==!1&&u===r){if(d=e.indexOf(p,u+1),d===-1)break;c=O.trim(e.slice(r+1,d)),o(a,c),a=!1,u=d,s=u+1;continue}if(/\s|\n|\t/.test(p))if(e=e.replace(/\s|\n|\t/g," "),a===!1)if(d=Kt(e,u),d===-1){c=O.trim(e.slice(s,u)),o(c),a=!1,s=u+1;continue}else{u=d-1;continue}else if(d=e5(e,u-1),d===-1){c=O.trim(e.slice(s,u)),c=we(c),o(a,c),a=!1,s=u+1;continue}else continue}return s<e.length&&(a===!1?o(e.slice(s)):o(a,we(O.trim(e.slice(s))))),O.trim(n.join(" "))}function Kt(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="="?t:-1}}function Jt(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="'"||s==='"'?t:-1}}function e5(e,t){for(;t>0;t--){var s=e[t];if(s!==" ")return s==="="?t:-1}}function t5(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function we(e){return t5(e)?e.substr(1,e.length-2):e}Y.parseTag=Xt;Y.parseAttr=Yt;var s5=ue.FilterCSS,I=w,Ke=Y,r5=Ke.parseTag,n5=Ke.parseAttr,X=ce;function W(e){return e==null}function a5(e){var t=X.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=X.trim(e.slice(t+1,-1));var s=e[e.length-1]==="/";return s&&(e=X.trim(e.slice(0,-1))),{html:e,closing:s}}function i5(e){var t={};for(var s in e)t[s]=e[s];return t}function o5(e){var t={};for(var s in e)Array.isArray(e[s])?t[s.toLowerCase()]=e[s].map(function(r){return r.toLowerCase()}):t[s.toLowerCase()]=e[s];return t}function Je(e){e=i5(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=I.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=o5(e.whiteList||e.allowList):e.whiteList=I.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":I.attributeWrapSign,e.onTag=e.onTag||I.onTag,e.onTagAttr=e.onTagAttr||I.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||I.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||I.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||I.safeAttrValue,e.escapeHtml=e.escapeHtml||I.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new s5(e.css))}Je.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,r=s.whiteList,n=s.onTag,a=s.onIgnoreTag,i=s.onTagAttr,o=s.onIgnoreTagAttr,u=s.safeAttrValue,p=s.escapeHtml,c=t.attributeWrapSign,d=t.cssFilter;s.stripBlankChar&&(e=I.stripBlankChar(e)),s.allowCommentTag||(e=I.stripCommentTag(e));var f=!1;s.stripIgnoreTagBody&&(f=I.StripTagBody(s.stripIgnoreTagBody,a),a=f.onIgnoreTag);var C=r5(e,function(l,y,m,v,h){var g={sourcePosition:l,position:y,isClosing:h,isWhite:Object.prototype.hasOwnProperty.call(r,m)},x=n(m,v,g);if(!W(x))return x;if(g.isWhite){if(g.isClosing)return"</"+m+">";var k=a5(v),V=r[m],T=n5(k.html,function(A,E){var b=X.indexOf(V,A)!==-1,_=i(m,A,E,b);return W(_)?b?(E=u(m,A,E,d),E?A+"="+c+E+c:A):(_=o(m,A,E,b),W(_)?void 0:_):_});return v="<"+m,T&&(v+=" "+T),k.closing&&(v+=" /"),v+=">",v}else return x=a(m,v,g),W(x)?p(v):x},p);return f&&(C=f.remove(C)),C};var l5=Je;(function(e,t){var s=w,r=Y,n=l5;function a(o,u){var p=new n(u);return p.process(o)}t=e.exports=a,t.filterXSS=a,t.FilterXSS=n,function(){for(var o in s)t[o]=s[o];for(var u in r)t[u]=r[u]}(),typeof window<"u"&&(window.filterXSS=e.exports);function i(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}i()&&(self.filterXSS=e.exports)})(ie,ie.exports);var u5=ie.exports;const $=vt(u5);var c5=Array.isArray,e1=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var s=void 0;if(c5(e))for(var r=0,n=e.length;r<n;)s=e1(e[r++]),s&&(t&&(t+=" "),t+=s);else for(s in e)s&&e[s]&&(t&&(t+=" "),t+=s)}return t};function t1(){for(var e=arguments.length,t=0,s,r,n="";t<e;)s=arguments[t++],s&&(r=e1(s),r&&(n&&(n+=" "),n+=r));return n}function ye({children:e="",imageUrl:t,imageAlt:s="",aspectRatio:r="card-small",videoUrl:n}){return`
    <span
      class="${t1("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",r==="card-small"&&"su-aspect-[3/2]",r==="card-medium"&&"su-aspect-[3/2]",r==="card-large"&&"su-aspect-[3/2]",r==="card-featured"&&"su-aspect-[3/2]",r==="square"&&"su-aspect-[1/1]",r==="video"&&"su-aspect-[16/9]",r==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${n?`
  ...
  `}const d5={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function be({imageUrl:e,alt:t="",aspectRatio:s,videoUrl:r,size:n="small",title:a="",videoIconClasses:i,uniqueId:o}){if(r){const u=`
        ...
        ${r?`
          <span
            class="${t1("su-absolute su-leading-none",n==="vertical-video"&&"su-z-30",d5[n],i)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${ye({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:s,children:u})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${ye({imageUrl:e,imageAlt:t,aspectRatio:s})}
    </div>
  `}function f5(e,t){if(!t)return!0;const s=e.match(/(\d+-\d+-\d+)/)[0],r=t.match(/(\d+-\d+-\d+)/)[0];return s===r}function p5({start:e,end:t}){if(!e&&!t)return null;const s=new Date(e),r=t?new Date(t):null,n={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let a="";const i=f5(e,t);i||(delete n.time,delete n.hour,delete n.minute);const o=new Intl.DateTimeFormat("en-US",n).format(s),u=t?new Intl.DateTimeFormat("en-US",n).format(r):"";return i?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(a+=`${o} - ${u}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${a}</span>`)}function C5(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const h5="light";function te({variant:e=h5}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function v5({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    >
    ...
    </svg>`}const Ae="solid";function E5({variant:e=Ae}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get(Ae)}function re(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const S5="light";function Ee({variant:e=S5}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const S={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},H5={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function O5({data:{title:e,description:t,liveUrl:s,imageUrl:r,imageAlt:n,taxonomy:a,taxonomyUrl:i,type:o,date:u,endDate:p,videoUrl:c,uniqueID:d},cardSize:f="small"}){const C=H5[f],l=new Map;return l.set("alert",C5()),l.set("analysis & insights",ee()),l.set("analysis &amp; insights",ee()),l.set("analysis&nbsp;&amp;&nbsp;insights",ee()),l.set("case study",te({variant:"light"})),l.set("case&nbsp;study",te({variant:"light"})),l.set("casestudy",te({variant:"light"})),l.set("event",w5()),l.set("event&nbsp;highlights",Le()),l.set("event highlights",Le()),l.set("feature",y5()),l.set("infographic",b5()),l.set("in&nbsp;the&nbsp;news",se()),l.set("in the news",se()),l.set("inthenews",se()),l.set("leadership&nbsp;messages",xe()),l.set("leadership messages",xe()),l.set("obituary",L5()),l.set("opinion",x5()),l.set("photo",A5()),l.set("policy&nbsp;brief",Ee({variant:"light"})),l.set("policy brief",Ee({variant:"light"})),l.set("poll/quiz",re()),l.set("poll / quiz",re()),l.set("poll&nbsp;/&nbsp;quiz",re()),l.set("profile",M5()),l.set("research",I5()),l.set("solutions",_5()),l.set("survey",$5()),l.set("timeline",k5()),l.set("tips & takeaways",ne()),l.set("tips &amp; takeaways",ne()),l.set("tips&nbsp;&amp;&nbsp;takeaways",ne()),l.set("university&nbsp;updates",Se()),l.set("university updates",Se()),l.set("announcement",g5()),l.set("news",m5()),l.set("q&amp;a",j()),l.set("q&a",j()),l.set("q & a",j()),l.set("q&nbsp;&amp;&nbsp;a",j()),l.set("video",V5()),l.set("podcast",E5({variant:"light"})),l.set("book",v5({className:""})),`
    <article aria-label="${e}" class="${S.root} ${C.gap}" data-testid="horizontal-card" >
      
    ${f==="large"?`
        <div class="${S.imageWrapper} ${C.imageWrapper}">
          ${r?`
            ${be({imageUrl:r,alt:n,videoUrl:c,mediaType:"image",aspectRatio:"card-large",size:f,uniqueId:d})}
          `:""}
        </div>
      `:""}

      ${f==="small"&&r?`
        <div class="${S.imageWrapper} ${C.imageWrapper} su-relative">
            ${be({imageUrl:r,alt:n,videoUrl:c,mediaType:"image",aspectRatio:"large",size:f,uniqueId:d})}
        </div>
      `:""}

      <div class="${S.contentWrapper} ${C.contentGap}">
        ${f==="small"&&a?`
          <p class="${S.taxonomy}" data-testid="horizontal-card-taxonomy">
            <a href="${i}" class="${S.taxonomyLink}">
              ${$(a)}
            </a>
          </p>
        `:""}

        <h3 class="${S.heading} ${C.title}">
          <a href="${s}" class="${S.link}">
            ${$(e)}
            ${Te(s)?`
        ...
        ${f==="large"&&o?`
          <p data-testid="horizontal-card-type" class="${S.type}">
            ${l.get(o.toLowerCase())}
            <span class="${S.typeText}">${$(o)}</span>
          </p>
        `:""}

        ${f==="large"&&t?`
          <div data-testid="horizontal-card-description" class="${S.description}">
            <div class="${S.descriptionContent}">
              ${$(t)}
            </div>
          </div>
        `:""}
      ...
      <div class="${M.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${M.authorWrapper} ${l}">
            ${C?`
              ${N5({image:C,avatarSize:"small",alt:`Photo of ${i}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function q5(e){const{videoId:t,className:s="",noAutoPlay:r,title:n,isVertical:a}=e;return`
        <iframe
            width="${a?315:560}"
            height="${a?560:315}"
            class="${s}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const P5='section[data-component="topic-subtopic-listing"]',B5='[data-element="topics-list"]',s1='[data-element="topics-pagination"]',r1="su-hidden",R5='section[data-element="modal-wrapper"]',D5='button[data-click="open-modal"]',G5='button[data-dismiss="modal"]',n1='iframe[data-modal="iframe"]';function U5(e){const t=e.querySelector(n1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(r1),e.hidden=!1}function Me(e){const t=e.querySelector(n1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(r1),e.hidden=!0}function a1(e){const t=e.querySelectorAll(D5),s=e.querySelectorAll(G5);let r=null;t&&t.forEach(n=>{n&&n.addEventListener("click",function(){const a=n.dataset.modalId;r=e.querySelector(`div[data-modal-id="${a}"]`),r&&U5(r)})}),s&&s.forEach(n=>{n&&n.addEventListener("click",function(){Me(r)})}),document.addEventListener("keydown",function(n){n.key==="Escape"&&r&&Me(r)})}async function F5(e){const{offset:t,query:s,endpoint:r}=e,n=r+s+`&start_rank=${t}`;return await(await fetch(n).catch(o=>{throw new Error(o)})).json()}function z5(e,t,s,r){e.querySelector(B5).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(s1).innerHTML=s,e.querySelector(R5).innerHTML=r;const n=-100-60,a=e.getBoundingClientRect().top+window.pageYOffset+n;window.scrollTo({top:a,behavior:"smooth"}),a1(e),i1(e)}async function W5(e){var f,C,l,y,m;const{offset:t,query:s,endpoint:r,display:n,section:a}=e,i=await F5({offset:t,query:s,endpoint:r}),o=(C=(f=i==null?void 0:i.response)==null?void 0:f.resultPacket)==null?void 0:C.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const u=[],p=[];(m=(y=(l=i==null?void 0:i.response)==null?void 0:l.resultPacket)==null?void 0:y.results)==null||m.forEach(v=>{const h=P1(),g=T1(v);g.uniqueID=h,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(n)?(g.displayConfiguration=n,u.push(`<div class="su-relative su-grow">${Z5({data:g,cardType:"narrowhorizontal"})}</div>`)):u.push(`<div class="su-relative su-grow">${O5({data:g,cardType:"horizontal",cardSize:"large"})}</div>`),(g.type==="Video"||g.videoUrl)&&p.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const c=mt({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),d=p.map(v=>`
        ...
        ${q5({videoId:v.videoId,title:v.title,noAutoPlay:v.noAutoPlay,isVertical:v.isVertical})}
        ...
        `).join("");z5(a,u.join(""),c,d)}function i1(e){const{query:t,endpoint:s,display:r}=e.dataset,n=e.querySelector(s1);if(!n)return;n.querySelectorAll("button").forEach(i=>{i.addEventListener("click",()=>{if(i.disabled)return;const o=i.getAttribute("data-offset");W5({offset:o,query:t,endpoint:s,display:r,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(P5).forEach(e=>{a1(e),i1(e)})});const j5='section[data-component="vertical-video-panel"]',o1="su-hidden",X5='button[data-click="open-modal"]',Q5='button[data-dismiss="modal"]',l1='iframe[data-modal="iframe"]';function Y5(e){const t=e.querySelector(l1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(o1),e.hidden=!1}function Ie(e){const t=e.querySelector(l1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(o1),e.hidden=!0}function K5(e){const t=e.querySelectorAll(X5),s=e.querySelectorAll(Q5);let r=null;t&&t.forEach(n=>{n&&n.addEventListener("click",function(){const a=n.dataset.modalId;r=e.querySelector(`div[data-modal-id="${a}"]`),r&&Y5(r)})}),s&&s.forEach(n=>{n&&n.addEventListener("click",function(){Ie(r)})}),document.addEventListener("keydown",function(n){n.key==="Escape"&&r&&Ie(r)})}function J5(e){var r;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let n=!1;const a=new R(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(i,o){return`<button ${i===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${i+1}</span></button>`}},on:{init:i=>{Z(i),setTimeout(()=>{n=!0},100)},resize:i=>{Z(i)},paginationUpdate:i=>{le(i)}}});a.on("slideChange",function(){n&&setTimeout(()=>{q(a,"h2 a, h3 a, button",!0)},100)})}else(r=e.querySelector(".component-slider-controls"))==null||r.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(j5).forEach(e=>{J5(e),K5(e)})});
