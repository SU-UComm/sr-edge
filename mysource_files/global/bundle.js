import B from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";function He(e){if(!e)return 0;const t=225,n=e.trim().split(/\s+/).length;return Math.ceil(n/t)}function Et(e,t,n,s=()=>{}){const r=e.slides.length;let i=t-r+1;r%n!==0&&(i+=n-r%n);const a=document.createDocumentFragment(),o=e.slides.map(u=>u.outerHTML).join("");for(let u=0;u<i;u++){const f=document.createElement("div");for(f.innerHTML=o;f.firstChild;)f.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(f.firstChild)}e.wrapperEl.appendChild(a),e.update(),E(e,"",!1),s()}function q(e,t=()=>{}){const{slidesPerView:n,slidesPerGroup:s}=e.params,r=e.slides.length,i=Math.ceil(n+s);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<i||r%s!==0?Et(e,i,s,t):(E(e,"",!1),t())}function J(e){const t=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(t){let n=e.pagination.bullets.length-e.slides.length+t;for(;n>0;){const s=e.pagination.bullets.pop();s&&s.remove(),n--}}}const E=(e,t,n)=>{e.slides.forEach(s=>{if(s.classList.contains("swiper-slide-active")){if(s.removeAttribute("aria-hidden"),s.removeAttribute("inert"),s.setAttribute("tabindex","-1"),t&&n){let r=null;t==="slide"?r=s:r=s.querySelector(t),r&&r.focus()}}else s.setAttribute("aria-hidden","true"),s.setAttribute("inert","true"),s.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(s=>{s.classList.contains("swiper-pagination-bullet-active")?s.setAttribute("aria-current","true"):s.removeAttribute("aria-current")})},St='section[data-component="basic-story-hero"]',At='span[data-reading="true"]',Ne="su-hidden",xt='button[data-click="open-modal"]',_t='button[data-dismiss="modal"]',qe='iframe[data-modal="iframe"]';function It(e){const t=e.querySelector(qe);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(Ne),e.hidden=!1,document.body.style.overflow="hidden"}function te(e){const t=e.querySelector(qe);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(Ne),e.hidden=!0,document.body.style.overflow=""}function Mt(e){const t=e.querySelectorAll(xt),n=e.querySelectorAll(_t);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||te(s)}),s.dataset.listenerAdded="true"),It(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&te(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&te(s)})}function Tt(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{q(a),E(a,"",!1)},resize:a=>{q(a)},paginationUpdate:a=>{J(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?E(i,"slide",!0):E(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}function kt(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(At);if(t&&n){const s=He(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(St).forEach(e=>{Tt(e),Mt(e),kt(e)})});const $t='section[data-component="combined-content-grid"]',Re="su-hidden",Vt='button[data-click="open-modal"]',Ot='button[data-dismiss="modal"]',Be='iframe[data-modal="iframe"]';function Ht(e){const t=e.querySelector(Be),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Re),e.hidden=!1,document.body.style.overflow="hidden"}function se(e){const t=e.querySelector(Be),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Re),e.hidden=!0,document.body.style.overflow=""}function Nt(e){const t=e.querySelectorAll(Vt),n=e.querySelectorAll(Ot);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||se(s)}),s.dataset.listenerAdded="true"),Ht(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&se(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&se(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll($t).forEach(e=>{Nt(e)})});const qt='section[data-component="content-carousel"]';function Rt(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{q(a),E(a,"",!1)},resize:a=>{q(a)},paginationUpdate:a=>{J(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?E(i,"slide",!0):E(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(qt).forEach(e=>{Rt(e)})});const Bt='section[data-component="feature-story-hero"]',Dt='span[data-reading="true"]';function Zt(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(Dt);if(t&&n){const s=He(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Bt).forEach(e=>{Zt(e)})});const Pt='section[data-component="featured-content"]',De="su-hidden",Gt='button[data-click="open-modal"]',Ut='button[data-dismiss="modal"]',Ze='iframe[data-modal="iframe"]';function Ft(e){const t=e.querySelector(Ze),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(De),e.hidden=!1,document.body.style.overflow="hidden"}function ne(e){const t=e.querySelector(Ze),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(De),e.hidden=!0,document.body.style.overflow=""}function zt(e){const t=e.querySelectorAll(Gt),n=e.querySelectorAll(Ut);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ne(s)}),s.dataset.listenerAdded="true"),Ft(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ne(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ne(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Pt).forEach(e=>{zt(e)})});const Wt='section[data-component="horizontal-video-testimonials"]',Pe="su-hidden",jt='button[data-click="open-modal"]',Xt='button[data-dismiss="modal"]',Ge='iframe[data-modal="iframe"]';function Yt(e){const t=e.querySelector(Ge);if(t){const n=t.getAttribute("src"),s=n&&n.replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(Pe),e.hidden=!1,document.body.style.overflow="hidden"}function re(e){const t=e.querySelector(Ge);if(t){const n=t.getAttribute("src"),s=n&&n.replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(Pe),e.hidden=!0,document.body.style.overflow=""}function Qt(e){const t=e.querySelectorAll(jt),n=e.querySelectorAll(Xt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||re(s)}),s.dataset.listenerAdded="true"),Yt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&re(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&re(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Wt).forEach(e=>{Qt(e)})});const Kt='section[data-component="image-gallery-modal"]',Jt='button[data-click="open-gallery-modal"]',e1='div[data-modal="modal"]',t1='button[data-dismiss="modal"]',Ue="su-hidden";let ve;const s1=(e,t)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function n1(e){e.classList.remove(Ue),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&s1(t,e)})}function ae(e){e.classList.add(Ue),e.hidden=!0,document.body.style.overflow=""}function r1(e){const t=e.dataset.modalId;ve=new B(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function a1(e){const t=e.querySelector(e1),n=e.querySelector(Jt),s=e.querySelector(t1);n&&n.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",i=>{r.contains(i.target)||ae(t)}),t.dataset.listenerAdded="true"),n1(t),r1(t)}),s&&s.addEventListener("click",function(){ae(t),ve.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(ae(t),ve.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Kt).forEach(e=>{a1(e)})});const i1='[data-component="interactive-photo-card"]',o1="[data-card-inner]",l1="[data-card-inner-content]";function u1(e){var s;const n=((e.style.transform&&parseInt((s=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:s[1])||0)+180)%360;e.style.transform=`rotateY(${n}deg)`}function d1(e){const t=e.querySelector(o1);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>u1(t))}const c1=e=>{e.forEach(t=>{const n=t.getAttribute("aria-hidden")==="true"?"false":"true",s=t.querySelector("button");s&&(s.tabIndex=n==="true"?"-1":""),t.setAttribute("aria-hidden",n)})},f1=e=>{const t=e.querySelectorAll(l1);t.length&&t.forEach(n=>n.addEventListener("click",()=>c1(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(i1).forEach(e=>{d1(e),f1(e)})});class p1{constructor(t,n){this.url=t,this.type=n,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const s=this.assetIds.map(async r=>{const i=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(i,this.requestProps).catch(u=>{throw new Error(u)})).json()});return Promise.all(s)}return await(await fetch(this.url,this.requestProps).catch(s=>{throw new Error(s)})).json()}}function C1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:n,summary:s,image:r,taxonomyContentTypeText:i,contentTopic:a,contentSubtopic:o,taxonomyContentMainTopicText:u,contentCategory:f,featuredVideo:p,taxonomyContentMainTopicLandingPageUrl:d,taxonomyFeaturedUnitLandingPageUrl:c,taxonomyFeaturedUnitText:C,imageAlt:l,authorName:y,authorImage:h,author:v,isTeaser:m,storySource:g,assetHref:S},date:$,liveUrl:V}){const O=y!==void 0?y:v,A=h!==""?h:void 0,x=r;l=r&&l?l:"",!l&&!x&&(l="a close up image of an intricate stone arch");const L=p,T=n||s;let H=u;!H&&a&&(H=a instanceof Array?a[0]:a),!H&&o&&(H=o instanceof Array?o[0]:o);const P=d;let D=i?i[0]:"";return!D&&f&&(D=f instanceof Array?f[0]:f),S&&t[0]==="link"&&(V=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(T)?T[0]:T,liveUrl:Array.isArray(V)?V[0]:V,imageUrl:Array.isArray(x)?x[0]:x,imageAlt:Array.isArray(l)?l[0]:l,taxonomy:Array.isArray(H)?H[0]:H,taxonomyUrl:Array.isArray(P)?P[0]:P,type:Array.isArray(D)?D[0]:D,videoUrl:Array.isArray(L)?L[0]:L,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(O)?O[0]:O,authorAvatar:Array.isArray(A)?A[0]:A,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(c)?c[0]:c,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(m)?m[0]:m,storySource:Array.isArray(g)?g[0]:g}}function ie(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}const Fe=typeof window>"u"?{}:window;function g1(e=Fe){return e.document!==void 0}function m1(e,t=Fe){if(!g1(t))return null;const{document:n}=t,{cookie:s}=n;if(typeof s!="string")return null;const r=s.split("; ");let i=null;return r.find(a=>{const[o,u]=a.split("=");return o===e&&u!==""&&(i=u),null}),i}function ze(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}function h1(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}const v1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(t+s)%16|0,t=Math.floor(t/16)),(n==="x"?s:s&3|8).toString(16)})},w1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),y1=()=>typeof crypto<"u"?w1():v1();async function L1(e=null,t="",n=null){var r,i,a,o,u,f,p,d,c,C,l,y,h,v,m,g,S,$,V;const s=new p1;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const O=`
            ...
            &meta_taxonomyAudienceText=${h1(t)}&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;let A=O;n&&(n!=null&&n.behavioural)&&(A=`${(p=(f=e==null?void 0:e.search)==null?void 0:f.endpoint)==null?void 0:p.replace(/\.html/g,".json")}
                ?profile=${(d=e==null?void 0:e.search)==null?void 0:d.profile}
                &collection=${(c=e==null?void 0:e.search)==null?void 0:c.collection}${n.partialQuery}&num_ranks=3&log=false&meta_isTeaser=false`),s.url=A.replace(/\n+|\t+| {2,}/g,"");let L=((l=(C=(await s.fetch()).response)==null?void 0:C.resultPacket)==null?void 0:l.results)||null;if(L&&L.length<3&&(s.url=O.replace(/\n+|\t+| {2,}/g,""),L=((h=(y=(await s.fetch()).response)==null?void 0:y.resultPacket)==null?void 0:h.results)||null,L&&L.length<3)){const H=`${(m=(v=e==null?void 0:e.search)==null?void 0:v.endpoint)==null?void 0:m.replace(/\.html/g,".json")}
                    ?profile=${(g=e==null?void 0:e.search)==null?void 0:g.profile}
                    &collection=${(S=e==null?void 0:e.search)==null?void 0:S.collection}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;s.url=H.replace(/\n+|\t+| {2,}/g,""),L=((V=($=(await s.fetch()).response)==null?void 0:$.resultPacket)==null?void 0:V.results)||null}return L}return null}const oe={WRAPPER:'[data-role="link-list-wrapper"]',TOGGLE:'[data-role="link-drawer-toggle"]',DRAWER:'[data-role="link-drawer"]'},b={ACTIVE:"su-rotate-90",INACTIVE:"su-rotate-[-90deg]",OPEN:"su-h-auto",CLOSED:"su-h-0",VISIBLE:"su-opacity-[1]",HIDDEN:"su-opacity-[0]",NO_STORIES:"su-link-list-no-stories"};function b1(e,t){var s;if(!(((s=e==null?void 0:e.dataset)==null?void 0:s.active)==="true")){e.dataset.active=!0,e.classList.remove(b.INACTIVE),e.classList.add(b.ACTIVE),t.classList.remove(b.CLOSED),t.classList.add(b.OPEN);return}e.dataset.active=!1,e.classList.add(b.INACTIVE),e.classList.remove(b.ACTIVE),t.classList.add(b.CLOSED),t.classList.remove(b.OPEN)}function E1(e){const t=document.body.getBoundingClientRect().height,n=window.scrollY+window.innerHeight;if(window.scrollY>=Math.round(30/100*document.body.clientHeight)&&n<=t-700){e.classList.remove(b.HIDDEN),e.classList.remove("su-bottom-[-100px]"),e.classList.add(b.VISIBLE),e.classList.add("su-bottom-0");return}e.classList.remove(b.VISIBLE),e.classList.add("su-bottom-[-100px]"),e.classList.add(b.HIDDEN),e.classList.remove("su-bottom-0")}function S1(e,t){return`
    ...
    `}function A1(e,t,n){if(!e.length){t.classList.add(b.NO_STORIES);return}const[s,r,i]=e;n.innerHTML=`
    ...
    `,t.classList.remove(b.NO_STORIES)}async function x1(e,t,n,s,r,i){const o=(await L1(e,i,t)).map(({title:u,indexUrl:f})=>S1(u,f));A1(o,n,r),_1(n,s,r)}function _1(e,t,n){t.addEventListener("click",function(){b1(t,n)}),window.addEventListener("scroll",function(){E1(e)})}function I1(e,t,n,s){if(!e||!window.pageController)return;const r=window.pageController,i=r.topicsQuery?r.topicsQuery():null;x1(r,i,e,t,n,s)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(oe.WRAPPER),t=document.querySelector(oe.TOGGLE),n=document.querySelector(oe.DRAWER),s=m1("preferences_personalisation");I1(e,t,n,s)});const M1='section[data-component="media-carousel"]';function T1(e){const t=e.dataset.uniqueId,n=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{q(a),E(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{q(a)},paginationUpdate:a=>{J(a)}}}),s=n.slides.length,r=n.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(s-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),n.on("slideChange",function(){setTimeout(()=>{a?E(n,"h2 a, h3 a, button",!0):E(n,"",!1)},100)})}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(M1).forEach(e=>{T1(e)})});const k1='section[data-component="multicolumn-listing"]',We="su-hidden",$1='button[data-click="open-modal"]',V1='button[data-dismiss="modal"]',je='iframe[data-modal="iframe"]';function O1(e){const t=e.querySelector(je),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(We),e.hidden=!1,document.body.style.overflow="hidden"}function le(e){const t=e.querySelector(je),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(We),e.hidden=!0,document.body.style.overflow=""}function H1(e){const t=e.querySelectorAll($1),n=e.querySelectorAll(V1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||le(s)}),s.dataset.listenerAdded="true"),O1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&le(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&le(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(k1).forEach(e=>{H1(e)})});const N1='section[data-component="sidebar-navigation"]',q1='nav[data-nav="nav"]',Q="su-hidden",R1='button[data-click="toggle-nav"]',B1="su-bg-digital-red su-text-white dark:su-bg-dark-mode-red dark:aria-expanded:su-text-black-true",D1='span[data-label="button"]';function Xe(e,t){const n=e.querySelector(D1),s=e.querySelector('svg[data-icon="bars"]'),r=e.querySelector('svg[data-icon="xmark"]');e.setAttribute("aria-expanded",t.toString()),B1.split(" ").forEach(i=>{e.classList.toggle(i,t)}),s&&(s.classList.toggle(`!${Q}`,t),s.hidden=t),r&&(r.classList.toggle(`!${Q}`,!t),r.hidden=!t),n&&(n.innerHTML=t?n.getAttribute("data-label-close"):n.getAttribute("data-label-open"))}function Ee(e,t){e.classList.remove(Q),e.hidden=!1,Xe(t,!0)}function G(e,t){e.classList.add(Q),e.hidden=!0,Xe(t,!1)}function Z1(e){const t=e.querySelector(R1),n=e.querySelector(q1);let s;t&&t.addEventListener("click",function(){const r=t.getAttribute("aria-expanded")==="true";n.dataset.listenerAdded||(document.addEventListener("click",i=>{const a=n.contains(i.target),o=t.contains(i.target);!a&&!o&&G(n,t)}),n.dataset.listenerAdded="true"),r?G(n,t):Ee(n,t)}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&t&&G(n,t)}),window.addEventListener("resize",()=>{clearTimeout(s),s=setTimeout(()=>{window.innerWidth>991?n&&t&&Ee(n,t):n&&t&&G(n,t)},10)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(N1).forEach(e=>{Z1(e)})});function U(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function F(e,t){const n=e.querySelector('svg[data-control="play"]'),s=e.querySelector('svg[data-control="pause"]'),r=!t;e.setAttribute("aria-pressed",String(r)),n.classList.toggle("su-hidden",r),n.hidden=r,s.classList.toggle("su-hidden",!r),s.hidden=!r,e.innerHTML=`
  ...
  `}const P1='section[data-component="single-image-video"]',G1='iframe[data-role="video-player"]',U1='button[data-role="video-control"]',Ye="su-hidden",F1='button[data-click="open-modal"]',z1='button[data-dismiss="modal"]',Qe='iframe[data-modal="iframe"]',W1=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function j1(e){const t=e.querySelector(Qe),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ye),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&W1(r,e)})}function ue(e){const t=e.querySelector(Qe),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ye),e.hidden=!0,document.body.style.overflow=""}function X1(e){const t=e.querySelectorAll(F1),n=e.querySelectorAll(z1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ue(s)}),s.dataset.listenerAdded="true"),j1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ue(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ue(s)})}function Y1(e){const t=e.querySelector(G1),n=e.querySelector(U1);let s=!1;if(!t||!n)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!s?(U(t,"play"),F(n,!1)):a.isIntersecting||(U(t,"pause"),F(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(U(t,"pause"),F(n,!0),s=!0):(U(t,"play"),F(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(P1).forEach(e=>{X1(e),Y1(e)})});const Q1='section[data-component="stories-carousel"]',Ke="su-hidden",K1='button[data-click="open-modal"]',J1='button[data-dismiss="modal"]',Je='iframe[data-modal="iframe"]';function es(e){const t=e.querySelector(Je),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ke),e.hidden=!1,document.body.style.overflow="hidden"}function de(e){const t=e.querySelector(Je),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ke),e.hidden=!0,document.body.style.overflow=""}function ts(e){const t=e.querySelectorAll(K1),n=e.querySelectorAll(J1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||de(s)}),s.dataset.listenerAdded="true"),es(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&de(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&de(s)})}function ss(e){const t=e.dataset.uniqueId;new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Q1).forEach(e=>{ss(e),ts(e)})});const ns='section[data-component="subscribe-to-stanford-report"]';function rs(e){const t=e.querySelector("form"),n=t.querySelector('input[type="email"]'),s=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let i="";const a=n.value;if(!a||!a.match(/\w+@\w+\.\w+/)){i='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',s.innerHTML=i,n.setAttribute("aria-describedby","subscription-error");return}s.innerHTML="",n.removeAttribute("aria-describedby"),r.target.submit()}),n.addEventListener("keyup",function(){const r=n.value,i=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(i.innerHTML="",n.removeAttribute("aria-describedby"))})}function as(){document.querySelectorAll(ns).forEach(e=>{rs(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",as);const is='section[data-component="subtopic-subnav-component"]',os='div[data-list="subnav"]';function ls(e){return e.filter((t,n)=>n===e.findIndex(s=>{var r,i;return((r=s.taxonomyFeaturedUnitText)==null?void 0:r[0])===((i=t.taxonomyFeaturedUnitText)==null?void 0:i[0])}))}const us=async e=>{if(!e||e.length===0)return null;const t=ls(e),n=[];return t.forEach(s=>{var i,a,o;const r=s;r&&((i=r.taxonomyFeaturedUnitText)!=null&&i[0])&&n.push({asset_name:(a=r.taxonomyFeaturedUnitText)==null?void 0:a[0],asset_url:((o=r.taxonomyFeaturedUnitLandingPageUrl)==null?void 0:o[0])||""})}),n};function ds({navigation:e}){let t="scrollable-list__item su-mb-0 su-relative after:su-h-22 after:su-w-[1px] after:su-bg-black-60 after:su-mx-12 lg:after:su-mx-18";const n="su-text-inherit su-text-black su-font-semi-bold su-text-16 lg:su-text-18 lg:su-leading-[21.6px] su-no-underline hover:su-underline dark:su-text-white hover:su-text-digital-red dark:hover:su-text-dark-mode-red";return`
        <div class="scrollable-list su-w-full md:su-justify-center su-flex su-nowrap su-mt-15 md:su-mt-26 lg:su-mt-19">
            ...
            ${e.map((s,r,i)=>{const a=s.asset_name;return r+1===i.length&&(t="su-relative su-mb-0"),`
                <li class="${t}">
    ...
    `}function cs(e){const t=e.querySelector(os);t&&document.addEventListener("topicLoader",async n=>{if(n.detail){const s=await us(n.detail.cards);t.innerHTML=ds({navigation:s})}},!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(is).forEach(e=>{cs(e)})});function fs({offsetNum:e,pageNumber:t,index:n}){return`
        <button
            data-offset="${e}"
    ...
    `}function ps({pageNumber:e,allResults:t,resultsPerPage:n,paginationRange:s,currentPage:r=1}){const i=Math.ceil(t/n),a=s,o=e-n,u=e+n,f="su-text-black-50",p=[],d=[];for(let m=0;m<i;m++){const g=m*n+1;d.push(g)}let c=[...d],C=[...d];const l=d.indexOf(r),y=Math.floor(a*.5);if((l<y||i===a)&&(c=c.filter((m,g)=>m>r&&g<a),C=C.filter(m=>m<r)),l>=y&&i!==a)if(c=c.filter((m,g)=>m>r&&g<=l+y),c.length===y)C=C.filter((m,g)=>m<r&&g>=l-y);else{const m=c.length?a-c.length:a;C=C.filter((g,S)=>g<r&&S>l-m)}return[...C,r,...c].map(m=>({offset:m,index:d.indexOf(m)+1})).forEach(({offset:m,index:g})=>{p.push(fs({offsetNum:m,pageNumber:e,index:g}))}),i>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function Cs(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var we={exports:{}},w={},ye={exports:{}},R={};function et(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function gs(e,t,n){}function ms(e,t,n){}var hs=/javascript\s*\:/img;function vs(e,t){return hs.test(t)?"":t}R.whiteList=et();R.getDefaultWhiteList=et;R.onAttr=gs;R.onIgnoreAttr=ms;R.safeAttrValue=vs;var ws={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},Z=ws;function ys(e,t){e=Z.trimRight(e),e[e.length-1]!==";"&&(e+=";");var n=e.length,s=!1,r=0,i=0,a="";function o(){if(!s){var p=Z.trim(e.slice(r,i)),d=p.indexOf(":");if(d!==-1){var c=Z.trim(p.slice(0,d)),C=Z.trim(p.slice(d+1));if(c){var l=t(r,a.length,c,C,p);l&&(a+=l+"; ")}}}r=i+1}for(;i<n;i++){var u=e[i];if(u==="/"&&e[i+1]==="*"){var f=e.indexOf("*/",i+2);if(f===-1)break;i=f+1,r=i+1,s=!1}else u==="("?s=!0:u===")"?s=!1:u===";"?s||o():u===`
`&&o()}return Z.trim(a)}var Ls=ys,z=R,bs=Ls;function Se(e){return e==null}function Es(e){var t={};for(var n in e)t[n]=e[n];return t}function tt(e){e=Es(e||{}),e.whiteList=e.whiteList||z.whiteList,e.onAttr=e.onAttr||z.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||z.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||z.safeAttrValue,this.options=e}tt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onAttr,i=n.onIgnoreAttr,a=n.safeAttrValue,o=bs(e,function(u,f,p,d,c){var C=s[p],l=!1;if(C===!0?l=C:typeof C=="function"?l=C(d):C instanceof RegExp&&(l=C.test(d)),l!==!0&&(l=!1),d=a(p,d),!!d){var y={position:f,sourcePosition:u,source:c,isWhite:l};if(l){var h=r(p,d,y);return Se(h)?p+":"+d:h}else{var h=i(p,d,y);if(!Se(h))return h}}});return o};var Ss=tt;(function(e,t){var n=R,s=Ss;function r(a,o){var u=new s(o);return u.process(a)}t=e.exports=r,t.FilterCSS=s;for(var i in n)t[i]=n[i];typeof window<"u"&&(window.filterCSS=e.exports)})(ye,ye.exports);var Le=ye.exports,be={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,n=t.exec(e);return n?n.index:-1}},As=Le.FilterCSS,xs=Le.getDefaultWhiteList,K=be;function st(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var nt=new As;function _s(e,t,n){}function Is(e,t,n){}function Ms(e,t,n){}function Ts(e,t,n){}function rt(e){return e.replace($s,"&lt;").replace(Vs,"&gt;")}function ks(e,t,n,s){if(n=dt(n),t==="href"||t==="src"){if(n=K.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(t==="background"){if(W.lastIndex=0,W.test(n))return""}else if(t==="style"){if(Ae.lastIndex=0,Ae.test(n)||(xe.lastIndex=0,xe.test(n)&&(W.lastIndex=0,W.test(n))))return"";s!==!1&&(s=s||nt,n=s.process(n))}return n=ct(n),n}var $s=/</g,Vs=/>/g,Os=/"/g,Hs=/&quot;/g,Ns=/&#([a-zA-Z0-9]*);?/gim,qs=/&colon;?/gim,Rs=/&newline;?/gim,W=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,Ae=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,xe=/u\s*r\s*l\s*\(.*/gi;function at(e){return e.replace(Os,"&quot;")}function it(e){return e.replace(Hs,'"')}function ot(e){return e.replace(Ns,function(n,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function lt(e){return e.replace(qs,":").replace(Rs," ")}function ut(e){for(var t="",n=0,s=e.length;n<s;n++)t+=e.charCodeAt(n)<32?" ":e.charAt(n);return K.trim(t)}function dt(e){return e=it(e),e=ot(e),e=lt(e),e=ut(e),e}function ct(e){return e=at(e),e=rt(e),e}function Bs(){return""}function Ds(e,t){typeof t!="function"&&(t=function(){});var n=!Array.isArray(e);function s(a){return n?!0:K.indexOf(e,a)!==-1}var r=[],i=!1;return{onIgnoreTag:function(a,o,u){if(s(a))if(u.isClosing){var f="[/removed]",p=u.position+f.length;return r.push([i!==!1?i:u.position,p]),i=!1,f}else return i||(i=u.position),"[removed]";else return t(a,o,u)},remove:function(a){var o="",u=0;return K.forEach(r,function(f){o+=a.slice(u,f[0]),u=f[1]}),o+=a.slice(u),o}}}function Zs(e){for(var t="",n=0;n<e.length;){var s=e.indexOf("<!--",n);if(s===-1){t+=e.slice(n);break}t+=e.slice(n,s);var r=e.indexOf("-->",s);if(r===-1)break;n=r+3}return t}function Ps(e){var t=e.split("");return t=t.filter(function(n){var s=n.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),t.join("")}w.whiteList=st();w.getDefaultWhiteList=st;w.onTag=_s;w.onIgnoreTag=Is;w.onTagAttr=Ms;w.onIgnoreTagAttr=Ts;w.safeAttrValue=ks;w.escapeHtml=rt;w.escapeQuote=at;w.unescapeQuote=it;w.escapeHtmlEntities=ot;w.escapeDangerHtml5Entities=lt;w.clearNonPrintableCharacter=ut;w.friendlyAttrValue=dt;w.escapeAttrValue=ct;w.onIgnoreTagStripAll=Bs;w.StripTagBody=Ds;w.stripCommentTag=Zs;w.stripBlankChar=Ps;w.attributeWrapSign='"';w.cssFilter=nt;w.getDefaultCSSWhiteList=xs;var ee={},N=be;function Gs(e){var t=N.spaceIndex(e),n;return t===-1?n=e.slice(1,-1):n=e.slice(1,t+1),n=N.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function Us(e){return e.slice(0,2)==="</"}function Fs(e,t,n){var s="",r=0,i=!1,a=!1,o=0,u=e.length,f="",p="";e:for(o=0;o<u;o++){var d=e.charAt(o);if(i===!1){if(d==="<"){i=o;continue}}else if(a===!1){if(d==="<"){s+=n(e.slice(r,o)),i=o,r=o;continue}if(d===">"||o===u-1){s+=n(e.slice(r,i)),p=e.slice(i,o+1),f=Gs(p),s+=t(i,s.length,f,p,Us(p)),r=o+1,i=!1;continue}if(d==='"'||d==="'")for(var c=1,C=e.charAt(o-c);C.trim()===""||C==="=";){if(C==="="){a=d;continue e}C=e.charAt(o-++c)}}else if(d===a){a=!1;continue}}return r<u&&(s+=n(e.substr(r))),s}var zs=/[^a-zA-Z0-9\\_:.-]/gim;function Ws(e,t){var n=0,s=0,r=[],i=!1,a=e.length;function o(c,C){if(c=N.trim(c),c=c.replace(zs,"").toLowerCase(),!(c.length<1)){var l=t(c,C||"");l&&r.push(l)}}for(var u=0;u<a;u++){var f=e.charAt(u),p,d;if(i===!1&&f==="="){i=e.slice(n,u),n=u+1,s=e.charAt(n)==='"'||e.charAt(n)==="'"?n:Xs(e,u+1);continue}if(i!==!1&&u===s){if(d=e.indexOf(f,u+1),d===-1)break;p=N.trim(e.slice(s+1,d)),o(i,p),i=!1,u=d,n=u+1;continue}if(/\s|\n|\t/.test(f))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(d=js(e,u),d===-1){p=N.trim(e.slice(n,u)),o(p),i=!1,n=u+1;continue}else{u=d-1;continue}else if(d=Ys(e,u-1),d===-1){p=N.trim(e.slice(n,u)),p=_e(p),o(i,p),i=!1,n=u+1;continue}else continue}return n<e.length&&(i===!1?o(e.slice(n)):o(i,_e(N.trim(e.slice(n))))),N.trim(r.join(" "))}function js(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Xs(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="'"||n==='"'?t:-1}}function Ys(e,t){for(;t>0;t--){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Qs(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function _e(e){return Qs(e)?e.substr(1,e.length-2):e}ee.parseTag=Fs;ee.parseAttr=Ws;var Ks=Le.FilterCSS,M=w,ft=ee,Js=ft.parseTag,en=ft.parseAttr,Y=be;function j(e){return e==null}function tn(e){var t=Y.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=Y.trim(e.slice(t+1,-1));var n=e[e.length-1]==="/";return n&&(e=Y.trim(e.slice(0,-1))),{html:e,closing:n}}function sn(e){var t={};for(var n in e)t[n]=e[n];return t}function nn(e){var t={};for(var n in e)Array.isArray(e[n])?t[n.toLowerCase()]=e[n].map(function(s){return s.toLowerCase()}):t[n.toLowerCase()]=e[n];return t}function pt(e){e=sn(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=M.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=nn(e.whiteList||e.allowList):e.whiteList=M.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":M.attributeWrapSign,e.onTag=e.onTag||M.onTag,e.onTagAttr=e.onTagAttr||M.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||M.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||M.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||M.safeAttrValue,e.escapeHtml=e.escapeHtml||M.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Ks(e.css))}pt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onTag,i=n.onIgnoreTag,a=n.onTagAttr,o=n.onIgnoreTagAttr,u=n.safeAttrValue,f=n.escapeHtml,p=t.attributeWrapSign,d=t.cssFilter;n.stripBlankChar&&(e=M.stripBlankChar(e)),n.allowCommentTag||(e=M.stripCommentTag(e));var c=!1;n.stripIgnoreTagBody&&(c=M.StripTagBody(n.stripIgnoreTagBody,i),i=c.onIgnoreTag);var C=Js(e,function(l,y,h,v,m){var g={sourcePosition:l,position:y,isClosing:m,isWhite:Object.prototype.hasOwnProperty.call(s,h)},S=r(h,v,g);if(!j(S))return S;if(g.isWhite){if(g.isClosing)return"</"+h+">";var $=tn(v),V=s[h],O=en($.html,function(A,x){var L=Y.indexOf(V,A)!==-1,T=a(h,A,x,L);return j(T)?L?(x=u(h,A,x,d),x?A+"="+p+x+p:A):(T=o(h,A,x,L),j(T)?void 0:T):T});return v="<"+h,O&&(v+=" "+O),$.closing&&(v+=" /"),v+=">",v}else return S=i(h,v,g),j(S)?f(v):S},f);return c&&(C=c.remove(C)),C};var rn=pt;(function(e,t){var n=w,s=ee,r=rn;function i(o,u){var f=new r(u);return f.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=r,function(){for(var o in n)t[o]=n[o];for(var u in s)t[u]=s[u]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(we,we.exports);var an=we.exports;const k=Cs(an);var on=Array.isArray,Ct=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var n=void 0;if(on(e))for(var s=0,r=e.length;s<r;)n=Ct(e[s++]),n&&(t&&(t+=" "),t+=n);else for(n in e)n&&e[n]&&(t&&(t+=" "),t+=n)}return t};function gt(){for(var e=arguments.length,t=0,n,s,r="";t<e;)n=arguments[t++],n&&(s=Ct(n),s&&(r&&(r+=" "),r+=s));return r}function Ie({children:e="",imageUrl:t,imageAlt:n="",aspectRatio:s="card-small",videoUrl:r}){return`
    <span
      class="${gt("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",s==="card-small"&&"su-aspect-[3/2]",s==="card-medium"&&"su-aspect-[3/2]",s==="card-large"&&"su-aspect-[3/2]",s==="card-featured"&&"su-aspect-[3/2]",s==="square"&&"su-aspect-[1/1]",s==="video"&&"su-aspect-[16/9]",s==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${r?`
  ...
  `}const ln={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function Me({imageUrl:e,alt:t="",aspectRatio:n,videoUrl:s,size:r="small",title:i="",videoIconClasses:a,uniqueId:o}){if(s){const u=`
        ...
        ${s?`
          <span
            class="${gt("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",ln[r],a)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${Ie({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:n,children:u})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${Ie({imageUrl:e,imageAlt:t,aspectRatio:n})}
    </div>
  `}function un(e,t){if(!t)return!0;const n=e.match(/(\d+-\d+-\d+)/)[0],s=t.match(/(\d+-\d+-\d+)/)[0];return n===s}function dn({start:e,end:t}){if(!e&&!t)return null;const n=new Date(e),s=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const a=un(e,t);a||(delete r.time,delete r.hour,delete r.minute);const o=new Intl.DateTimeFormat("en-US",r).format(n),u=t?new Intl.DateTimeFormat("en-US",r).format(s):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${u}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function cn(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const pn="light";function fe({variant:e=pn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function gn({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    >
    ...
    </svg>`}const $e="solid";function bn({variant:e=$e}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get($e)}function Ce(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const En="light";function Ve({variant:e=En}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const _={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},kn={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function $n({data:{title:e,description:t,liveUrl:n,imageUrl:s,imageAlt:r,taxonomy:i,taxonomyUrl:a,type:o,date:u,endDate:f,videoUrl:p,uniqueID:d},cardSize:c="small"}){const C=kn[c],l=new Map;return l.set("alert",cn()),l.set("analysis & insights",ce()),l.set("analysis &amp; insights",ce()),l.set("analysis&nbsp;&amp;&nbsp;insights",ce()),l.set("case study",fe({variant:"light"})),l.set("case&nbsp;study",fe({variant:"light"})),l.set("casestudy",fe({variant:"light"})),l.set("event",mn()),l.set("event&nbsp;highlights",Te()),l.set("event highlights",Te()),l.set("feature",hn()),l.set("infographic",vn()),l.set("in&nbsp;the&nbsp;news",pe()),l.set("in the news",pe()),l.set("inthenews",pe()),l.set("leadership&nbsp;messages",ke()),l.set("leadership messages",ke()),l.set("obituary",wn()),l.set("opinion",yn()),l.set("photo",Ln()),l.set("policy&nbsp;brief",Ve({variant:"light"})),l.set("policy brief",Ve({variant:"light"})),l.set("poll/quiz",Ce()),l.set("poll / quiz",Ce()),l.set("poll&nbsp;/&nbsp;quiz",Ce()),l.set("profile",Sn()),l.set("research",An()),l.set("solutions",xn()),l.set("survey",_n()),l.set("timeline",In()),l.set("tips & takeaways",ge()),l.set("tips &amp; takeaways",ge()),l.set("tips&nbsp;&amp;&nbsp;takeaways",ge()),l.set("university&nbsp;updates",Oe()),l.set("university updates",Oe()),l.set("announcement",fn()),l.set("news",Cn()),l.set("q&amp;a",X()),l.set("q&a",X()),l.set("q & a",X()),l.set("q&nbsp;&amp;&nbsp;a",X()),l.set("video",Mn()),l.set("podcast",bn({variant:"light"})),l.set("book",gn({className:""})),`
    <article aria-label="${e}" class="${_.root} ${C.gap}" data-testid="horizontal-card" >
      
    ${c==="large"?`
        <div class="${_.imageWrapper} ${C.imageWrapper}">
          ${s?`
            ${Me({imageUrl:s,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"card-large",size:c,uniqueId:d})}
          `:""}
        </div>
      `:""}

      ${c==="small"&&s?`
        <div class="${_.imageWrapper} ${C.imageWrapper} su-relative">
            ${Me({imageUrl:s,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"large",size:c,uniqueId:d})}
        </div>
      `:""}

      <div class="${_.contentWrapper} ${C.contentGap}">
        ${c==="small"&&i?`
        ...
        ${c==="large"&&o?`
          <p data-testid="horizontal-card-type" class="${_.type}">
            ${l.get(o.toLowerCase())}
            <span class="${_.typeText}">${k(o)}</span>
          </p>
        `:""}
  ...
  `:h;return`
    <article aria-label="${e}" class="${I.root}" data-testid="narrow-horizontal-card">
      <div class="${I.contentWrapper}">
        ...
        ${o==="Announcements"&&f?`
          <p data-testid="vertical-card-taxonomy" class="${I.taxonomy}">
            ${u?`
              <a href="${u}" class="${I.taxonomyLink}">
                ${k(f)}
              </a>
            `:`
              <span>${k(f)}</span>
        ...
        <h3 class="${I.heading}">
          <a class="${I.link}" href="${n}">
            <span>${k(e)}</span>
            ${y?`
              <span class="${I.linkIcon}">
        ...
        ${t?`
          <div data-testid="narrow-horizontal-card-description" class="${I.description}">
            <div class="${I.descriptionContent}">
              ${k(t)}
            </div>
          </div>
        `:""}
        ...
        ${o==="Leadership Messages"?`
          <div class="${I.authorWrapper} ${l}">
            ${C?`
              ${Vn({image:C,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function Hn(e){const{videoId:t,className:n="",noAutoPlay:s,title:r,isVertical:i}=e;return`
        <iframe
            width="${i?315:560}"
            height="${i?560:315}"
            class="${n}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const Nn='section[data-component="topic-subtopic-listing"]',qn='[data-element="topics-list"]',mt='[data-element="topics-pagination"]',ht="su-hidden",Rn='section[data-element="modal-wrapper"]',Bn='button[data-click="open-modal"]',Dn='button[data-dismiss="modal"]',vt='iframe[data-modal="iframe"]';function Zn(e){const t=e.querySelector(vt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(ht),e.hidden=!1,document.body.style.overflow="hidden"}function me(e){const t=e.querySelector(vt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(ht),e.hidden=!0,document.body.style.overflow="hidden"}function wt(e){const t=e.querySelectorAll(Bn),n=e.querySelectorAll(Dn);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||me(s)}),s.dataset.listenerAdded="true"),Zn(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&me(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&me(s)})}async function Pn(e){const{offset:t,query:n,endpoint:s}=e,r=s+n+`&start_rank=${t}`;return await(await fetch(r).catch(o=>{throw new Error(o)})).json()}function Gn(e,t,n,s){e.querySelector(qn).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(mt).innerHTML=n,e.querySelector(Rn).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),wt(e),yt(e)}async function Un(e){var c,C,l,y,h;const{offset:t,query:n,endpoint:s,display:r,section:i}=e,a=await Pn({offset:t,query:n,endpoint:s}),o=(C=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:C.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const u=[],f=[];(h=(y=(l=a==null?void 0:a.response)==null?void 0:l.resultPacket)==null?void 0:y.results)==null||h.forEach(v=>{const m=y1(),g=C1(v);g.uniqueID=m,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(g.displayConfiguration=r,u.push(`<div class="su-relative su-grow">${On({data:g,cardType:"narrowhorizontal"})}</div>`)):u.push(`<div class="su-relative su-grow">${$n({data:g,cardType:"horizontal",cardSize:"large"})}</div>`),(g.type==="Video"||g.videoUrl)&&f.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const p=ps({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),d=f.map(v=>`
        ...
        ${Hn({videoId:v.videoId,title:v.title,noAutoPlay:v.noAutoPlay,isVertical:v.isVertical})}
        ...
        `).join("");Gn(i,u.join(""),p,d)}function yt(e){const{query:t,endpoint:n,display:s}=e.dataset,r=e.querySelector(mt);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const o=a.getAttribute("data-offset");Un({offset:o,query:t,endpoint:n,display:s,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Nn).forEach(e=>{wt(e),yt(e)})});const Fn='section[data-component="vertical-video-panel"]',Lt="su-hidden",zn='button[data-click="open-modal"]',Wn='button[data-dismiss="modal"]',bt='iframe[data-modal="iframe"]';function jn(e){const t=e.querySelector(bt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Lt),e.hidden=!1,document.body.style.overflow="hidden"}function he(e){const t=e.querySelector(bt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Lt),e.hidden=!0,document.body.style.overflow=""}function Xn(e){const t=e.querySelectorAll(zn),n=e.querySelectorAll(Wn);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||he(s)}),s.dataset.listenerAdded="true"),jn(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&he(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&he(s)})}function Yn(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{q(a),E(a,"",!1)},resize:a=>{q(a)},paginationUpdate:a=>{J(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?E(i,"h2 a, h3 a, button",!0):E(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Fn).forEach(e=>{Yn(e),Xn(e)})});
