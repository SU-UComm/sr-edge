import F from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const Y1='section[data-component="content-carousel"]';let N;const o1=(e,s)=>{e.slides.forEach(t=>{t.classList.contains("swiper-slide-active")?(t.removeAttribute("aria-hidden"),t.removeAttribute("inert"),t.setAttribute("tabindex","-1")):(t.setAttribute("aria-hidden","true"),t.setAttribute("inert","true"),t.removeAttribute("tabindex"));const r=t.querySelector("h2 a, h3 a, button")?t.querySelector("h2 a, h3 a, button"):null;s&&r&&r.focus()}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(t=>{t.classList.contains("swiper-pagination-bullet-active")?t.setAttribute("aria-current","true"):t.removeAttribute("aria-current")})};function K1(e){const s=e.dataset.uniqueId;N=new F(`section[data-unique-id="${s}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${s}"] .component-slider-next`,prevEl:`section[data-unique-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(t,r){return`<button ${t===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${t+1}</span></button>`}}}),N.on("slideChange",function(){setTimeout(()=>{o1(N,!0)},100)}),o1(N,!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Y1).forEach(e=>{K1(e)})});const J1='section[data-component="featured-content"]',S1="su-hidden",ee='button[data-click="open-modal"]',te='button[data-dismiss="modal"]',E1='iframe[data-modal="iframe"]';function se(e){const s=e.querySelector(E1),r=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",r),e.classList.remove(S1),e.hidden=!1}function l1(e){const s=e.querySelector(E1),r=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",r),e.classList.add(S1),e.hidden=!0}function re(e){const s=e.querySelectorAll(ee),t=e.querySelectorAll(te);let r=null;s&&s.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&se(r)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){l1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&l1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(J1).forEach(e=>{re(e)})});const ae='section[data-component="image-gallery-modal"]',ne='button[data-click="open-gallery-modal"]',ie='div[data-modal="modal"]',oe='button[data-dismiss="modal"]',M1="su-hidden";let t1;const le=(e,s)=>{var d;const t='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',r=(d=Array.from(s==null?void 0:s.querySelectorAll(t)))==null?void 0:d.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(r.length===0||(e==null?void 0:e.key)!=="Tab")return;const a=r[0],n=r[r.length-1];e.shiftKey&&document.activeElement===a?(e.preventDefault(),n.focus()):!e.shiftKey&&document.activeElement===n&&(e.preventDefault(),a.focus())};function ue(e){e.classList.remove(M1),e.hidden=!1,document.addEventListener("keydown",s=>{e&&le(s,e)})}function u1(e){e.classList.add(M1),e.hidden=!0}function de(e){const s=e.dataset.modalId;t1=new F(`div[data-modal-id="${s}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${s}"] .component-slider-next`,prevEl:`div[data-modal-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(t,r){return`<button ${t===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${t+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function ce(e){const s=e.querySelector(ie),t=e.querySelector(ne),r=e.querySelector(oe);t&&t.addEventListener("click",function(){ue(s),de(s)}),r&&r.addEventListener("click",function(){u1(s),t1.destroy()}),document.addEventListener("keydown",function(a){a.key==="Escape"&&(u1(s),t1.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ae).forEach(e=>{ce(e)})});const fe='[data-component="interactive-photo-card"]',Ce="[data-card-inner]",ge="[data-card-inner-content]";function pe(e){var r;const t=((e.style.transform&&parseInt((r=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:r[1])||0)+180)%360;e.style.transform=`rotateY(${t}deg)`}function he(e){const s=e.querySelector(Ce);if(!s){console.error("Could not find card inner element for component");return}s.addEventListener("click",()=>pe(s))}const ve=e=>{e.forEach(s=>{const t=s.getAttribute("aria-hidden")==="true"?"false":"true",r=s.querySelector("button");r&&(r.tabIndex=t==="true"?"-1":""),s.setAttribute("aria-hidden",t)})},me=e=>{const s=e.querySelectorAll(ge);s.length&&s.forEach(t=>t.addEventListener("click",()=>ve(s)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(fe).forEach(e=>{he(e),me(e)})});const we='section[data-component="media-carousel"]';let D;const d1=(e,s)=>{e.slides.forEach(t=>{t.classList.contains("swiper-slide-active")?(t.removeAttribute("aria-hidden"),t.removeAttribute("inert"),t.setAttribute("tabindex","-1")):(t.setAttribute("aria-hidden","true"),t.setAttribute("inert","true"),t.removeAttribute("tabindex"));const r=t.querySelector("h2 a, h3 a, button")?t.querySelector("h2 a, h3 a, button"):null;s&&r&&r.focus()}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(t=>{t.classList.contains("swiper-pagination-bullet-active")?t.setAttribute("aria-current","true"):t.removeAttribute("aria-current")})};function be(e){const s=e.dataset.uniqueId;D=new F(`section[data-unique-id="${s}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${s}"] .component-slider-next`,prevEl:`section[data-unique-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(t,r){return`<button ${t===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${t+1}</span></button>`}}}),D.on("slideChange",function(){setTimeout(()=>{d1(D,!0)},100)}),d1(D,!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(we).forEach(e=>{be(e)})});const ye='section[data-component="multicolumn-listing"]',k1="su-hidden",Le='button[data-click="open-modal"]',xe='button[data-dismiss="modal"]',$1='iframe[data-modal="iframe"]';function Ae(e){const s=e.querySelector($1),r=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",r),e.classList.remove(k1),e.hidden=!1}function c1(e){const s=e.querySelector($1),r=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",r),e.classList.add(k1),e.hidden=!0}function Se(e){const s=e.querySelectorAll(Le),t=e.querySelectorAll(xe);let r=null;s&&s.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&Ae(r)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){c1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&c1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ye).forEach(e=>{Se(e)})});const Ee='section[data-component="stories-carousel"]',V1="su-hidden",Me='button[data-click="open-modal"]',ke='button[data-dismiss="modal"]',H1='iframe[data-modal="iframe"]';function $e(e){const s=e.querySelector(H1),r=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",r),e.classList.remove(V1)}function f1(e){const s=e.querySelector(H1),r=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",r),e.classList.add(V1)}function Ve(e){const s=e.querySelectorAll(Me),t=e.querySelectorAll(ke);let r=null;s&&s.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&$e(r)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){f1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&f1(r)})}function He(e){const s=e.dataset.uniqueId;new F(`section[data-unique-id="${s}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${s}"] .component-slider-next`,prevEl:`section[data-unique-id="${s}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${s}`,clickable:!0,bulletElement:"button",renderBullet:function(t,r){return`<button ${t===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${t+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ee).forEach(e=>{He(e),Ve(e)})});function Te({title:e,listMetadata:{assetTypeCode:s,teaserPlain:t,summary:r,image:a,taxonomyContentTypeText:n,contentTopic:d,contentSubtopic:o,taxonomyContentMainTopicText:l,contentCategory:C,featuredVideo:c,taxonomyContentMainTopicLandingPageUrl:u,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:i,imageAlt:g,authorName:w,authorImage:h,author:b,isTeaser:_,storySource:p,assetHref:m},date:k,liveUrl:I}){const Z=w!==void 0?w:b,S=h!==""?h:void 0,A=a;g=a&&g?g:"",!g&&!A&&(g="a close up image of an intricate stone arch");const V=c,M=t||r;let H=l;!H&&d&&(H=d instanceof Array?d[0]:d),!H&&o&&(H=o instanceof Array?o[0]:o);const X=u;let O=n?n[0]:"";return!O&&C&&(O=C instanceof Array?C[0]:C),m&&s[0]==="link"&&(I=m),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(M)?M[0]:M,liveUrl:Array.isArray(I)?I[0]:I,imageUrl:Array.isArray(A)?A[0]:A,imageAlt:Array.isArray(g)?g[0]:g,taxonomy:Array.isArray(H)?H[0]:H,taxonomyUrl:Array.isArray(X)?X[0]:X,type:Array.isArray(O)?O[0]:O,videoUrl:Array.isArray(V)?V[0]:V,date:Array.isArray(k)?k[0]:k,authorDisplayName:Array.isArray(Z)?Z[0]:Z,authorAvatar:Array.isArray(S)?S[0]:S,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(i)?i[0]:i,isTeaser:Array.isArray(_)?_[0]:_,storySource:Array.isArray(p)?p[0]:p}}var _e=Array.isArray,T1=function(e){var s="";if(typeof e=="string")s+=e;else if(typeof e=="object"){var t=void 0;if(_e(e))for(var r=0,a=e.length;r<a;)t=T1(e[r++]),t&&(s&&(s+=" "),s+=t);else for(t in e)t&&e[t]&&(s&&(s+=" "),s+=t)}return s};function a1(){for(var e=arguments.length,s=0,t,r,a="";s<e;)t=arguments[s++],t&&(r=T1(t),r&&(a&&(a+=" "),a+=r));return a}const Ie={narrow:"su-container-narrow",large:"su-container-large",wide:"su-container-wide",full:"su-container-full",cc:"su-cc"},Ze={none:"",base:"su-rs-py-0",1:"su-rs-py-1",2:"su-rs-py-2",3:"su-rs-py-3",4:"su-rs-py-4",5:"su-rs-py-5",6:"su-rs-py-6",7:"su-rs-py-7",8:"su-rs-py-8",9:"su-rs-py-9",10:"su-rs-py-10"},Oe={default:"",base:"su-rs-mt-0",1:"su-rs-mt-1",2:"su-rs-mt-2",3:"su-rs-mt-3",4:"su-rs-mt-4",5:"su-rs-mt-5",6:"su-rs-mt-6",7:"su-rs-mt-7",8:"su-rs-mt-8",9:"su-rs-mt-9",10:"su-rs-mt-10"},Be={default:"",base:"su-rs-mb-0",1:"su-rs-mb-1",2:"su-rs-mb-2",3:"su-rs-mb-3",4:"su-rs-mb-4",5:"su-rs-mb-5",6:"su-rs-mb-6",7:"su-rs-mb-7",8:"su-rs-mb-8",9:"su-rs-mb-9",10:"su-rs-mb-10"};function Ne({children:e,width:s="large",paddingX:t=!0,paddingY:r="none",marginTop:a="default",marginBottom:n="default",className:d}){return e!==void 0?`
    <div
      class="${a1("su-mx-auto su-component-container",Ie[s==null?void 0:s.toLowerCase()],t?"su-container-px":"",Ze[r],Oe[a],Be[n],d)}"
    >
      ${e}
    </div>
  `:""}function De({className:e}){return`
    <svg
  ...
  `}function Re({pageNumber:e,allResults:s,resultsPerPage:t,paginationRange:r,onPageChange:a}){const n=Math.ceil(s/t),d=r,o=e-t,l=e+t,C="su-text-black-50",c=[],u=[];let f=1;for(let p=0;p<n;p++){const m=p*t+1;u.push(m)}let i=[...u],g=[...u];const w=u.indexOf(f),h=Math.floor(d*.5);if((w<h||n===d)&&(i=i.filter((p,m)=>p>f&&m<d),g=g.filter(p=>p<f)),w>=h&&n!==d)if(i=i.filter((p,m)=>p>f&&m<=w+h),i.length===h)g=g.filter((p,m)=>p<f&&m>=w-h);else{const p=i.length?d-i.length:d;g=g.filter((m,k)=>m<f&&k>w-p)}return[...g,f,...i].map(p=>({offset:p,index:u.indexOf(p)+1})).forEach(({offset:p,index:m})=>{c.push(qe({offsetNum:p,pageNumber:e,index:m,onPaginate:`
          currentPage = ${p};
          ${a}(${p});
        `}))}),n>1?Ne({children:`
          <div class="su-flex su-gap-9 su-items-center su-justify-center su-rs-mt-4 lg:su-rs-mt-7">
            <button
              type="button"
              class="su-size-24 su-font-serif su-flex su-items-center su-justify-center dark:su-text-white ${o<1?C:""}"
              ${o<1?"disabled":""}
              data-offset="${o<1?1:o}"
              onclick="
                currentPage = ${o<1?1:o};
                ${a}(this.dataset.offset);
              "
            ...
            <button
              ...
              onclick="
                currentPage = ${l>u[u.length-1]?u[u.length-1]:l};
                ${a}(this.dataset.offset);
              "
        ...
        `}):""}function Ge(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var s1={exports:{}},v={},r1={exports:{}},T={};function _1(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function Ue(e,s,t){}function ze(e,s,t){}var Fe=/javascript\s*\:/img;function We(e,s){return Fe.test(s)?"":s}T.whiteList=_1();T.getDefaultWhiteList=_1;T.onAttr=Ue;T.onIgnoreAttr=ze;T.safeAttrValue=We;var Xe={indexOf:function(e,s){var t,r;if(Array.prototype.indexOf)return e.indexOf(s);for(t=0,r=e.length;t<r;t++)if(e[t]===s)return t;return-1},forEach:function(e,s,t){var r,a;if(Array.prototype.forEach)return e.forEach(s,t);for(r=0,a=e.length;r<a;r++)s.call(t,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},B=Xe;function je(e,s){e=B.trimRight(e),e[e.length-1]!==";"&&(e+=";");var t=e.length,r=!1,a=0,n=0,d="";function o(){if(!r){var c=B.trim(e.slice(a,n)),u=c.indexOf(":");if(u!==-1){var f=B.trim(c.slice(0,u)),i=B.trim(c.slice(u+1));if(f){var g=s(a,d.length,f,i,c);g&&(d+=g+"; ")}}}a=n+1}for(;n<t;n++){var l=e[n];if(l==="/"&&e[n+1]==="*"){var C=e.indexOf("*/",n+2);if(C===-1)break;n=C+1,a=n+1,r=!1}else l==="("?r=!0:l===")"?r=!1:l===";"?r||o():l===`
`&&o()}return B.trim(d)}var Qe=je,P=T,Ye=Qe;function C1(e){return e==null}function Ke(e){var s={};for(var t in e)s[t]=e[t];return s}function I1(e){e=Ke(e||{}),e.whiteList=e.whiteList||P.whiteList,e.onAttr=e.onAttr||P.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||P.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||P.safeAttrValue,this.options=e}I1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var s=this,t=s.options,r=t.whiteList,a=t.onAttr,n=t.onIgnoreAttr,d=t.safeAttrValue,o=Ye(e,function(l,C,c,u,f){var i=r[c],g=!1;if(i===!0?g=i:typeof i=="function"?g=i(u):i instanceof RegExp&&(g=i.test(u)),g!==!0&&(g=!1),u=d(c,u),!!u){var w={position:C,sourcePosition:l,source:f,isWhite:g};if(g){var h=a(c,u,w);return C1(h)?c+":"+u:h}else{var h=n(c,u,w);if(!C1(h))return h}}});return o};var Je=I1;(function(e,s){var t=T,r=Je;function a(d,o){var l=new r(o);return l.process(d)}s=e.exports=a,s.FilterCSS=r;for(var n in t)s[n]=t[n];typeof window<"u"&&(window.filterCSS=e.exports)})(r1,r1.exports);var n1=r1.exports,i1={indexOf:function(e,s){var t,r;if(Array.prototype.indexOf)return e.indexOf(s);for(t=0,r=e.length;t<r;t++)if(e[t]===s)return t;return-1},forEach:function(e,s,t){var r,a;if(Array.prototype.forEach)return e.forEach(s,t);for(r=0,a=e.length;r<a;r++)s.call(t,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var s=/\s|\n|\t/,t=s.exec(e);return t?t.index:-1}},et=n1.FilterCSS,tt=n1.getDefaultWhiteList,z=i1;function Z1(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var O1=new et;function st(e,s,t){}function rt(e,s,t){}function at(e,s,t){}function nt(e,s,t){}function B1(e){return e.replace(ot,"&lt;").replace(lt,"&gt;")}function it(e,s,t,r){if(t=G1(t),s==="href"||s==="src"){if(t=z.trim(t),t==="#")return"#";if(!(t.substr(0,7)==="http://"||t.substr(0,8)==="https://"||t.substr(0,7)==="mailto:"||t.substr(0,4)==="tel:"||t.substr(0,11)==="data:image/"||t.substr(0,6)==="ftp://"||t.substr(0,2)==="./"||t.substr(0,3)==="../"||t[0]==="#"||t[0]==="/"))return""}else if(s==="background"){if(q.lastIndex=0,q.test(t))return""}else if(s==="style"){if(g1.lastIndex=0,g1.test(t)||(p1.lastIndex=0,p1.test(t)&&(q.lastIndex=0,q.test(t))))return"";r!==!1&&(r=r||O1,t=r.process(t))}return t=U1(t),t}var ot=/</g,lt=/>/g,ut=/"/g,dt=/&quot;/g,ct=/&#([a-zA-Z0-9]*);?/gim,ft=/&colon;?/gim,Ct=/&newline;?/gim,q=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,g1=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,p1=/u\s*r\s*l\s*\(.*/gi;function N1(e){return e.replace(ut,"&quot;")}function D1(e){return e.replace(dt,'"')}function P1(e){return e.replace(ct,function(t,r){return r[0]==="x"||r[0]==="X"?String.fromCharCode(parseInt(r.substr(1),16)):String.fromCharCode(parseInt(r,10))})}function q1(e){return e.replace(ft,":").replace(Ct," ")}function R1(e){for(var s="",t=0,r=e.length;t<r;t++)s+=e.charCodeAt(t)<32?" ":e.charAt(t);return z.trim(s)}function G1(e){return e=D1(e),e=P1(e),e=q1(e),e=R1(e),e}function U1(e){return e=N1(e),e=B1(e),e}function gt(){return""}function pt(e,s){typeof s!="function"&&(s=function(){});var t=!Array.isArray(e);function r(d){return t?!0:z.indexOf(e,d)!==-1}var a=[],n=!1;return{onIgnoreTag:function(d,o,l){if(r(d))if(l.isClosing){var C="[/removed]",c=l.position+C.length;return a.push([n!==!1?n:l.position,c]),n=!1,C}else return n||(n=l.position),"[removed]";else return s(d,o,l)},remove:function(d){var o="",l=0;return z.forEach(a,function(C){o+=d.slice(l,C[0]),l=C[1]}),o+=d.slice(l),o}}}function ht(e){for(var s="",t=0;t<e.length;){var r=e.indexOf("<!--",t);if(r===-1){s+=e.slice(t);break}s+=e.slice(t,r);var a=e.indexOf("-->",r);if(a===-1)break;t=a+3}return s}function vt(e){var s=e.split("");return s=s.filter(function(t){var r=t.charCodeAt(0);return r===127?!1:r<=31?r===10||r===13:!0}),s.join("")}v.whiteList=Z1();v.getDefaultWhiteList=Z1;v.onTag=st;v.onIgnoreTag=rt;v.onTagAttr=at;v.onIgnoreTagAttr=nt;v.safeAttrValue=it;v.escapeHtml=B1;v.escapeQuote=N1;v.unescapeQuote=D1;v.escapeHtmlEntities=P1;v.escapeDangerHtml5Entities=q1;v.clearNonPrintableCharacter=R1;v.friendlyAttrValue=G1;v.escapeAttrValue=U1;v.onIgnoreTagStripAll=gt;v.StripTagBody=pt;v.stripCommentTag=ht;v.stripBlankChar=vt;v.attributeWrapSign='"';v.cssFilter=O1;v.getDefaultCSSWhiteList=tt;var W={},$=i1;function mt(e){var s=$.spaceIndex(e),t;return s===-1?t=e.slice(1,-1):t=e.slice(1,s+1),t=$.trim(t).toLowerCase(),t.slice(0,1)==="/"&&(t=t.slice(1)),t.slice(-1)==="/"&&(t=t.slice(0,-1)),t}function wt(e){return e.slice(0,2)==="</"}function bt(e,s,t){var r="",a=0,n=!1,d=!1,o=0,l=e.length,C="",c="";e:for(o=0;o<l;o++){var u=e.charAt(o);if(n===!1){if(u==="<"){n=o;continue}}else if(d===!1){if(u==="<"){r+=t(e.slice(a,o)),n=o,a=o;continue}if(u===">"||o===l-1){r+=t(e.slice(a,n)),c=e.slice(n,o+1),C=mt(c),r+=s(n,r.length,C,c,wt(c)),a=o+1,n=!1;continue}if(u==='"'||u==="'")for(var f=1,i=e.charAt(o-f);i.trim()===""||i==="=";){if(i==="="){d=u;continue e}i=e.charAt(o-++f)}}else if(u===d){d=!1;continue}}return a<l&&(r+=t(e.substr(a))),r}var yt=/[^a-zA-Z0-9\\_:.-]/gim;function Lt(e,s){var t=0,r=0,a=[],n=!1,d=e.length;function o(f,i){if(f=$.trim(f),f=f.replace(yt,"").toLowerCase(),!(f.length<1)){var g=s(f,i||"");g&&a.push(g)}}for(var l=0;l<d;l++){var C=e.charAt(l),c,u;if(n===!1&&C==="="){n=e.slice(t,l),t=l+1,r=e.charAt(t)==='"'||e.charAt(t)==="'"?t:At(e,l+1);continue}if(n!==!1&&l===r){if(u=e.indexOf(C,l+1),u===-1)break;c=$.trim(e.slice(r+1,u)),o(n,c),n=!1,l=u,t=l+1;continue}if(/\s|\n|\t/.test(C))if(e=e.replace(/\s|\n|\t/g," "),n===!1)if(u=xt(e,l),u===-1){c=$.trim(e.slice(t,l)),o(c),n=!1,t=l+1;continue}else{l=u-1;continue}else if(u=St(e,l-1),u===-1){c=$.trim(e.slice(t,l)),c=h1(c),o(n,c),n=!1,t=l+1;continue}else continue}return t<e.length&&(n===!1?o(e.slice(t)):o(n,h1($.trim(e.slice(t))))),$.trim(a.join(" "))}function xt(e,s){for(;s<e.length;s++){var t=e[s];if(t!==" ")return t==="="?s:-1}}function At(e,s){for(;s<e.length;s++){var t=e[s];if(t!==" ")return t==="'"||t==='"'?s:-1}}function St(e,s){for(;s>0;s--){var t=e[s];if(t!==" ")return t==="="?s:-1}}function Et(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function h1(e){return Et(e)?e.substr(1,e.length-2):e}W.parseTag=bt;W.parseAttr=Lt;var Mt=n1.FilterCSS,x=v,z1=W,kt=z1.parseTag,$t=z1.parseAttr,U=i1;function R(e){return e==null}function Vt(e){var s=U.spaceIndex(e);if(s===-1)return{html:"",closing:e[e.length-2]==="/"};e=U.trim(e.slice(s+1,-1));var t=e[e.length-1]==="/";return t&&(e=U.trim(e.slice(0,-1))),{html:e,closing:t}}function Ht(e){var s={};for(var t in e)s[t]=e[t];return s}function Tt(e){var s={};for(var t in e)Array.isArray(e[t])?s[t.toLowerCase()]=e[t].map(function(r){return r.toLowerCase()}):s[t.toLowerCase()]=e[t];return s}function F1(e){e=Ht(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=x.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=Tt(e.whiteList||e.allowList):e.whiteList=x.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":x.attributeWrapSign,e.onTag=e.onTag||x.onTag,e.onTagAttr=e.onTagAttr||x.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||x.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||x.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||x.safeAttrValue,e.escapeHtml=e.escapeHtml||x.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Mt(e.css))}F1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var s=this,t=s.options,r=t.whiteList,a=t.onTag,n=t.onIgnoreTag,d=t.onTagAttr,o=t.onIgnoreTagAttr,l=t.safeAttrValue,C=t.escapeHtml,c=s.attributeWrapSign,u=s.cssFilter;t.stripBlankChar&&(e=x.stripBlankChar(e)),t.allowCommentTag||(e=x.stripCommentTag(e));var f=!1;t.stripIgnoreTagBody&&(f=x.StripTagBody(t.stripIgnoreTagBody,n),n=f.onIgnoreTag);var i=kt(e,function(g,w,h,b,_){var p={sourcePosition:g,position:w,isClosing:_,isWhite:Object.prototype.hasOwnProperty.call(r,h)},m=a(h,b,p);if(!R(m))return m;if(p.isWhite){if(p.isClosing)return"</"+h+">";var k=Vt(b),I=r[h],Z=$t(k.html,function(S,A){var V=U.indexOf(I,S)!==-1,M=d(h,S,A,V);return R(M)?V?(A=l(h,S,A,u),A?S+"="+c+A+c:S):(M=o(h,S,A,V),R(M)?void 0:M):M});return b="<"+h,Z&&(b+=" "+Z),k.closing&&(b+=" /"),b+=">",b}else return m=n(h,b,p),R(m)?C(b):m},C);return f&&(i=f.remove(i)),i};var _t=F1;(function(e,s){var t=v,r=W,a=_t;function n(o,l){var C=new a(l);return C.process(o)}s=e.exports=n,s.filterXSS=n,s.FilterXSS=a,function(){for(var o in t)s[o]=t[o];for(var l in r)s[l]=r[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function d(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}d()&&(self.filterXSS=e.exports)})(s1,s1.exports);var It=s1.exports;const E=Ge(It);function v1({children:e="",imageUrl:s,imageAlt:t="",aspectRatio:r="card-small",videoUrl:a}){return`
    <span
      class="${a1("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",r==="card-small"&&"su-aspect-[3/2]",r==="card-medium"&&"su-aspect-[3/2]",r==="card-large"&&"su-aspect-[3/2]",r==="card-featured"&&"su-aspect-[3/2]",r==="square"&&"su-aspect-[1/1]",r==="video"&&"su-aspect-[16/9]",r==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${a?`
  ...
  `}const Zt={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function m1({imageUrl:e,alt:s="",aspectRatio:t,videoUrl:r,size:a="small",title:n="",videoIconClasses:d,uniqueId:o}){if(r){const l=`
        ...
        ${r?`
          <span
            class="${a1("su-absolute su-leading-none",a==="vertical-video"&&"su-z-30",Zt[a],d)}">
  ...
  `}function Ot(e,s){if(!s)return!0;const t=e.match(/(\d+-\d+-\d+)/)[0],r=s.match(/(\d+-\d+-\d+)/)[0];return t===r}function Bt({start:e,end:s}){if(!e&&!s)return null;const t=new Date(e),r=s?new Date(s):null,a={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let n="";const d=Ot(e,s);d||(delete a.time,delete a.hour,delete a.minute);const o=new Intl.DateTimeFormat("en-US",a).format(t),l=s?new Intl.DateTimeFormat("en-US",a).format(r):"";return d?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(n+=`${o} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${n}</span>`)}function Nt(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Pt="light";function Q({variant:e=Pt}){const s=new Map;return s.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}const y1="solid";function jt({variant:e=y1}){const s=new Map;return s.set("solid",`<svg
            aria-hidden="true"
    ...
    </svg>`}const Qt="light";function L1({variant:e=Qt}){const s=new Map;return s.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
  ...
  `:h;return`
    <article aria-label="${e}" class="${L.root}" data-testid="narrow-horizontal-card">
      <div class="${L.contentWrapper}">
        ...
        ${o==="Announcements"&&C?`
          <p data-testid="vertical-card-taxonomy" class="${L.taxonomy}">
            ${l?`
              <a href="${l}" class="${L.taxonomyLink}">
                ${E(C)}
              </a>
            `:`
              <span>${E(C)}</span>
        ...
        <h3 class="${L.heading}">
          <a class="${L.link}" href="${t}">
            <span>${E(e)}</span>
            ${w?`
              <span class="${L.linkIcon}">
        ...
        ${s?`
          <div data-testid="narrow-horizontal-card-description" class="${L.description}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${L.authorWrapper} ${g}">
            ${i?`
              ${i5({image:i,avatarSize:"small",alt:`Photo of ${d}`})}
            `:""}
            ${b}
          </div>
        `:""}
  ...
  `}const l5='section[data-component="topic-subtopic-listing"]',u5='[data-element="topics-list"]',W1='[data-element="topics-pagination"]',X1="su-hidden",d5='button[data-click="open-modal"]',c5='button[data-dismiss="modal"]',j1='iframe[data-modal="iframe"]';function f5(e){const s=e.querySelector(j1),r=s.getAttribute("src").replace("autoplay=0","autoplay=1");s.setAttribute("src",r),e.classList.remove(X1),e.hidden=!1}function A1(e){const s=e.querySelector(j1),r=s.getAttribute("src").replace("autoplay=1","autoplay=0");s.setAttribute("src",r),e.classList.add(X1),e.hidden=!0}function C5(e){const s=e.querySelectorAll(d5),t=e.querySelectorAll(c5);let r=null;s&&s.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${n}"]`),r&&f5(r)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){A1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&A1(r)})}async function g5(e){const{offset:s,query:t,endpoint:r}=e,a=r+t+`&start_rank=${s}`;return await(await fetch(a).catch(o=>{throw new Error(o)})).json()}function p5(e,s,t){document.querySelector(u5).innerHTML=s,document.querySelector(W1).innerHTML=t,window.scrollTo({top:0,behavior:"smooth"}),Q1(e)}async function h5(e){var c,u,f;const{offset:s,query:t,endpoint:r,display:a,section:n}=e,d=await g5({offset:s,query:t,endpoint:r}),o=d.response.resultPacket&&d.response.resultPacket.resultsSummary?d.response.resultPacket.resultsSummary:null,l=[];(f=(u=(c=d==null?void 0:d.response)==null?void 0:c.resultPacket)==null?void 0:u.results)==null||f.forEach(i=>{const g=Te(i);["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(a)?(g.displayConfiguration=a,l.push(o5({data:g,cardType:"narrowhorizontal"}))):l.push(n5({data:g,cardType:"horizontal",cardSize:"large"}))});const C=Re({pageNumber:Number(s),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(s)});p5(n,l,C)}function Q1(e){const{query:s,endpoint:t,display:r}=e.dataset,a=e.querySelector(W1);if(!a)return;a.querySelectorAll("button").forEach(d=>{d.addEventListener("click",()=>{if(d.disabled)return;const o=d.getAttribute("data-offset");h5({offset:o,query:s,endpoint:t,display:r,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(l5).forEach(e=>{C5(e),Q1(e)})});
