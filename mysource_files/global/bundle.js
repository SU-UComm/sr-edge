import F from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const K1='section[data-component="content-carousel"]';let D;const i1=(e,r)=>{e.slides.forEach(t=>{t.classList.contains("swiper-slide-active")?(t.removeAttribute("aria-hidden"),t.removeAttribute("inert"),t.setAttribute("tabindex","-1")):(t.setAttribute("aria-hidden","true"),t.setAttribute("inert","true"),t.removeAttribute("tabindex"));const s=t.querySelector("h2 a, h3 a, button")?t.querySelector("h2 a, h3 a, button"):null;r&&s&&s.focus()}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(t=>{t.classList.contains("swiper-pagination-bullet-active")?t.setAttribute("aria-current","true"):t.removeAttribute("aria-current")})};function J1(e){const r=e.dataset.uniqueId;D=new F(`section[data-unique-id="${r}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${r}"] .component-slider-next`,prevEl:`section[data-unique-id="${r}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${r}`,clickable:!0,bulletElement:"button",renderBullet:function(t,s){return`<button ${t===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${t+1}</span></button>`}}}),D.on("slideChange",function(){setTimeout(()=>{i1(D,!0)},100)}),i1(D,!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(K1).forEach(e=>{J1(e)})});const ee='section[data-component="featured-content"]',A1="su-hidden",te='button[data-click="open-modal"]',re='button[data-dismiss="modal"]',S1='iframe[data-modal="iframe"]';function se(e){const r=e.querySelector(S1),s=r.getAttribute("src").replace("autoplay=0","autoplay=1");r.setAttribute("src",s),e.classList.remove(A1),e.hidden=!1}function o1(e){const r=e.querySelector(S1),s=r.getAttribute("src").replace("autoplay=1","autoplay=0");r.setAttribute("src",s),e.classList.add(A1),e.hidden=!0}function ae(e){const r=e.querySelectorAll(te),t=e.querySelectorAll(re);let s=null;r&&r.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;s=e.querySelector(`div[data-modal-id="${n}"]`),s&&se(s)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){o1(s)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&s&&o1(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ee).forEach(e=>{ae(e)})});const ne='section[data-component="image-gallery-modal"]',ie='button[data-click="open-gallery-modal"]',oe='div[data-modal="modal"]',le='button[data-dismiss="modal"]',M1="su-hidden";let t1;const ue=(e,r)=>{var u;const t='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(u=Array.from(r==null?void 0:r.querySelectorAll(t)))==null?void 0:u.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const a=s[0],n=s[s.length-1];e.shiftKey&&document.activeElement===a?(e.preventDefault(),n.focus()):!e.shiftKey&&document.activeElement===n&&(e.preventDefault(),a.focus())};function de(e){e.classList.remove(M1),e.hidden=!1,document.addEventListener("keydown",r=>{e&&ue(r,e)})}function l1(e){e.classList.add(M1),e.hidden=!0}function ce(e){const r=e.dataset.modalId;t1=new F(`div[data-modal-id="${r}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${r}"] .component-slider-next`,prevEl:`div[data-modal-id="${r}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${r}`,clickable:!0,bulletElement:"button",renderBullet:function(t,s){return`<button ${t===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${t+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function fe(e){const r=e.querySelector(oe),t=e.querySelector(ie),s=e.querySelector(le);t&&t.addEventListener("click",function(){de(r),ce(r)}),s&&s.addEventListener("click",function(){l1(r),t1.destroy()}),document.addEventListener("keydown",function(a){a.key==="Escape"&&(l1(r),t1.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ne).forEach(e=>{fe(e)})});const Ce='[data-component="interactive-photo-card"]',pe="[data-card-inner]",ge="[data-card-inner-content]";function he(e){var s;const t=((e.style.transform&&parseInt((s=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:s[1])||0)+180)%360;e.style.transform=`rotateY(${t}deg)`}function ve(e){const r=e.querySelector(pe);if(!r){console.error("Could not find card inner element for component");return}r.addEventListener("click",()=>he(r))}const me=e=>{e.forEach(r=>{const t=r.getAttribute("aria-hidden")==="true"?"false":"true",s=r.querySelector("button");s&&(s.tabIndex=t==="true"?"-1":""),r.setAttribute("aria-hidden",t)})},we=e=>{const r=e.querySelectorAll(ge);r.length&&r.forEach(t=>t.addEventListener("click",()=>me(r)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ce).forEach(e=>{ve(e),we(e)})});const be='section[data-component="media-carousel"]';let N;const u1=(e,r)=>{e.slides.forEach(t=>{t.classList.contains("swiper-slide-active")?(t.removeAttribute("aria-hidden"),t.removeAttribute("inert"),t.setAttribute("tabindex","-1")):(t.setAttribute("aria-hidden","true"),t.setAttribute("inert","true"),t.removeAttribute("tabindex"));const s=t.querySelector("h2 a, h3 a, button")?t.querySelector("h2 a, h3 a, button"):null;r&&s&&s.focus()}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(t=>{t.classList.contains("swiper-pagination-bullet-active")?t.setAttribute("aria-current","true"):t.removeAttribute("aria-current")})};function ye(e){const r=e.dataset.uniqueId;N=new F(`section[data-unique-id="${r}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${r}"] .component-slider-next`,prevEl:`section[data-unique-id="${r}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${r}`,clickable:!0,bulletElement:"button",renderBullet:function(t,s){return`<button ${t===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${t+1}</span></button>`}}}),N.on("slideChange",function(){setTimeout(()=>{u1(N,!0)},100)}),u1(N,!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(be).forEach(e=>{ye(e)})});const xe='section[data-component="multicolumn-listing"]',E1="su-hidden",Le='button[data-click="open-modal"]',Ae='button[data-dismiss="modal"]',k1='iframe[data-modal="iframe"]';function Se(e){const r=e.querySelector(k1),s=r.getAttribute("src").replace("autoplay=0","autoplay=1");r.setAttribute("src",s),e.classList.remove(E1),e.hidden=!1}function d1(e){const r=e.querySelector(k1),s=r.getAttribute("src").replace("autoplay=1","autoplay=0");r.setAttribute("src",s),e.classList.add(E1),e.hidden=!0}function Me(e){const r=e.querySelectorAll(Le),t=e.querySelectorAll(Ae);let s=null;r&&r.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;s=e.querySelector(`div[data-modal-id="${n}"]`),s&&Se(s)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){d1(s)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&s&&d1(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(xe).forEach(e=>{Me(e)})});const Ee='section[data-component="stories-carousel"]',V1="su-hidden",ke='button[data-click="open-modal"]',Ve='button[data-dismiss="modal"]',$1='iframe[data-modal="iframe"]';function $e(e){const r=e.querySelector($1),s=r.getAttribute("src").replace("autoplay=0","autoplay=1");r.setAttribute("src",s),e.classList.remove(V1)}function c1(e){const r=e.querySelector($1),s=r.getAttribute("src").replace("autoplay=1","autoplay=0");r.setAttribute("src",s),e.classList.add(V1)}function He(e){const r=e.querySelectorAll(ke),t=e.querySelectorAll(Ve);let s=null;r&&r.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;s=e.querySelector(`div[data-modal-id="${n}"]`),s&&$e(s)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){c1(s)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&s&&c1(s)})}function Te(e){const r=e.dataset.uniqueId;new F(`section[data-unique-id="${r}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${r}"] .component-slider-next`,prevEl:`section[data-unique-id="${r}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${r}`,clickable:!0,bulletElement:"button",renderBullet:function(t,s){return`<button ${t===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${t+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ee).forEach(e=>{Te(e),He(e)})});const _e=()=>{let e=new Date().getTime(),r=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,t=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(r+s)%16|0,r=Math.floor(r/16)),(t==="x"?s:s&3|8).toString(16)})},Ie=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),Ze=()=>typeof crypto<"u"?Ie():_e();function Oe({title:e,listMetadata:{assetTypeCode:r,teaserPlain:t,summary:s,image:a,taxonomyContentTypeText:n,contentTopic:u,contentSubtopic:o,taxonomyContentMainTopicText:l,contentCategory:p,featuredVideo:d,taxonomyContentMainTopicLandingPageUrl:c,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:C,imageAlt:i,authorName:b,authorImage:v,author:w,isTeaser:h,storySource:g,assetHref:S},date:_,liveUrl:I}){const Z=b!==void 0?b:w,M=v!==""?v:void 0,A=a;i=a&&i?i:"",!i&&!A&&(i="a close up image of an intricate stone arch");const $=d,k=t||s;let H=l;!H&&u&&(H=u instanceof Array?u[0]:u),!H&&o&&(H=o instanceof Array?o[0]:o);const j=c;let O=n?n[0]:"";return!O&&p&&(O=p instanceof Array?p[0]:p),S&&r[0]==="link"&&(I=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(k)?k[0]:k,liveUrl:Array.isArray(I)?I[0]:I,imageUrl:Array.isArray(A)?A[0]:A,imageAlt:Array.isArray(i)?i[0]:i,taxonomy:Array.isArray(H)?H[0]:H,taxonomyUrl:Array.isArray(j)?j[0]:j,type:Array.isArray(O)?O[0]:O,videoUrl:Array.isArray($)?$[0]:$,date:Array.isArray(_)?_[0]:_,authorDisplayName:Array.isArray(Z)?Z[0]:Z,authorAvatar:Array.isArray(M)?M[0]:M,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(h)?h[0]:h,storySource:Array.isArray(g)?g[0]:g}}function Be({offsetNum:e,pageNumber:r,index:t}){return`
    ...
    `}function De({pageNumber:e,allResults:r,resultsPerPage:t,paginationRange:s}){const a=Math.ceil(r/t),n=s,u=e-t,o=e+t,l="su-text-black-50",p=[],d=[];let c=1;for(let h=0;h<a;h++){const g=h*t+1;d.push(g)}let f=[...d],C=[...d];const i=d.indexOf(c),b=Math.floor(n*.5);if((i<b||a===n)&&(f=f.filter((h,g)=>h>c&&g<n),C=C.filter(h=>h<c)),i>=b&&a!==n)if(f=f.filter((h,g)=>h>c&&g<=i+b),f.length===b)C=C.filter((h,g)=>h<c&&g>=i-b);else{const h=f.length?n-f.length:n;C=C.filter((g,S)=>g<c&&S>i-h)}return[...C,c,...f].map(h=>({offset:h,index:d.indexOf(h)+1})).forEach(({offset:h,index:g})=>{p.push(Be({offsetNum:h,pageNumber:e,index:g}))}),a>1?`<div class="su-mx-auto su-component-container">
...
`&&o()}return B.trim(u)}var Fe=ze,q=T,We=Fe;function f1(e){return e==null}function je(e){var r={};for(var t in e)r[t]=e[t];return r}function T1(e){e=je(e||{}),e.whiteList=e.whiteList||q.whiteList,e.onAttr=e.onAttr||q.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||q.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||q.safeAttrValue,this.options=e}T1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var r=this,t=r.options,s=t.whiteList,a=t.onAttr,n=t.onIgnoreAttr,u=t.safeAttrValue,o=We(e,function(l,p,d,c,f){var C=s[d],i=!1;if(C===!0?i=C:typeof C=="function"?i=C(c):C instanceof RegExp&&(i=C.test(c)),i!==!0&&(i=!1),c=u(d,c),!!c){var b={position:p,sourcePosition:l,source:f,isWhite:i};if(i){var v=a(d,c,b);return f1(v)?d+":"+c:v}else{var v=n(d,c,b);if(!f1(v))return v}}});return o};var Xe=T1;(function(e,r){var t=T,s=Xe;function a(u,o){var l=new s(o);return l.process(u)}r=e.exports=a,r.FilterCSS=s;for(var n in t)r[n]=t[n];typeof window<"u"&&(window.filterCSS=e.exports)})(s1,s1.exports);var a1=s1.exports,n1={indexOf:function(e,r){var t,s;if(Array.prototype.indexOf)return e.indexOf(r);for(t=0,s=e.length;t<s;t++)if(e[t]===r)return t;return-1},forEach:function(e,r,t){var s,a;if(Array.prototype.forEach)return e.forEach(r,t);for(s=0,a=e.length;s<a;s++)r.call(t,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var r=/\s|\n|\t/,t=r.exec(e);return t?t.index:-1}},Qe=a1.FilterCSS,Ye=a1.getDefaultWhiteList,z=n1;function _1(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var I1=new Qe;function Ke(e,r,t){}function Je(e,r,t){}function et(e,r,t){}function tt(e,r,t){}function Z1(e){return e.replace(st,"&lt;").replace(at,"&gt;")}function rt(e,r,t,s){if(t=P1(t),r==="href"||r==="src"){if(t=z.trim(t),t==="#")return"#";if(!(t.substr(0,7)==="http://"||t.substr(0,8)==="https://"||t.substr(0,7)==="mailto:"||t.substr(0,4)==="tel:"||t.substr(0,11)==="data:image/"||t.substr(0,6)==="ftp://"||t.substr(0,2)==="./"||t.substr(0,3)==="../"||t[0]==="#"||t[0]==="/"))return""}else if(r==="background"){if(P.lastIndex=0,P.test(t))return""}else if(r==="style"){if(C1.lastIndex=0,C1.test(t)||(p1.lastIndex=0,p1.test(t)&&(P.lastIndex=0,P.test(t))))return"";s!==!1&&(s=s||I1,t=s.process(t))}return t=R1(t),t}var st=/</g,at=/>/g,nt=/"/g,it=/&quot;/g,ot=/&#([a-zA-Z0-9]*);?/gim,lt=/&colon;?/gim,ut=/&newline;?/gim,P=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,C1=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,p1=/u\s*r\s*l\s*\(.*/gi;function O1(e){return e.replace(nt,"&quot;")}function B1(e){return e.replace(it,'"')}function D1(e){return e.replace(ot,function(t,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function N1(e){return e.replace(lt,":").replace(ut," ")}function q1(e){for(var r="",t=0,s=e.length;t<s;t++)r+=e.charCodeAt(t)<32?" ":e.charAt(t);return z.trim(r)}function P1(e){return e=B1(e),e=D1(e),e=N1(e),e=q1(e),e}function R1(e){return e=O1(e),e=Z1(e),e}function dt(){return""}function ct(e,r){typeof r!="function"&&(r=function(){});var t=!Array.isArray(e);function s(u){return t?!0:z.indexOf(e,u)!==-1}var a=[],n=!1;return{onIgnoreTag:function(u,o,l){if(s(u))if(l.isClosing){var p="[/removed]",d=l.position+p.length;return a.push([n!==!1?n:l.position,d]),n=!1,p}else return n||(n=l.position),"[removed]";else return r(u,o,l)},remove:function(u){var o="",l=0;return z.forEach(a,function(p){o+=u.slice(l,p[0]),l=p[1]}),o+=u.slice(l),o}}}function ft(e){for(var r="",t=0;t<e.length;){var s=e.indexOf("<!--",t);if(s===-1){r+=e.slice(t);break}r+=e.slice(t,s);var a=e.indexOf("-->",s);if(a===-1)break;t=a+3}return r}function Ct(e){var r=e.split("");return r=r.filter(function(t){var s=t.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),r.join("")}m.whiteList=_1();m.getDefaultWhiteList=_1;m.onTag=Ke;m.onIgnoreTag=Je;m.onTagAttr=et;m.onIgnoreTagAttr=tt;m.safeAttrValue=rt;m.escapeHtml=Z1;m.escapeQuote=O1;m.unescapeQuote=B1;m.escapeHtmlEntities=D1;m.escapeDangerHtml5Entities=N1;m.clearNonPrintableCharacter=q1;m.friendlyAttrValue=P1;m.escapeAttrValue=R1;m.onIgnoreTagStripAll=dt;m.StripTagBody=ct;m.stripCommentTag=ft;m.stripBlankChar=Ct;m.attributeWrapSign='"';m.cssFilter=I1;m.getDefaultCSSWhiteList=Ye;var W={},V=n1;function pt(e){var r=V.spaceIndex(e),t;return r===-1?t=e.slice(1,-1):t=e.slice(1,r+1),t=V.trim(t).toLowerCase(),t.slice(0,1)==="/"&&(t=t.slice(1)),t.slice(-1)==="/"&&(t=t.slice(0,-1)),t}function gt(e){return e.slice(0,2)==="</"}function ht(e,r,t){var s="",a=0,n=!1,u=!1,o=0,l=e.length,p="",d="";e:for(o=0;o<l;o++){var c=e.charAt(o);if(n===!1){if(c==="<"){n=o;continue}}else if(u===!1){if(c==="<"){s+=t(e.slice(a,o)),n=o,a=o;continue}if(c===">"||o===l-1){s+=t(e.slice(a,n)),d=e.slice(n,o+1),p=pt(d),s+=r(n,s.length,p,d,gt(d)),a=o+1,n=!1;continue}if(c==='"'||c==="'")for(var f=1,C=e.charAt(o-f);C.trim()===""||C==="=";){if(C==="="){u=c;continue e}C=e.charAt(o-++f)}}else if(c===u){u=!1;continue}}return a<l&&(s+=t(e.substr(a))),s}var vt=/[^a-zA-Z0-9\\_:.-]/gim;function mt(e,r){var t=0,s=0,a=[],n=!1,u=e.length;function o(f,C){if(f=V.trim(f),f=f.replace(vt,"").toLowerCase(),!(f.length<1)){var i=r(f,C||"");i&&a.push(i)}}for(var l=0;l<u;l++){var p=e.charAt(l),d,c;if(n===!1&&p==="="){n=e.slice(t,l),t=l+1,s=e.charAt(t)==='"'||e.charAt(t)==="'"?t:bt(e,l+1);continue}if(n!==!1&&l===s){if(c=e.indexOf(p,l+1),c===-1)break;d=V.trim(e.slice(s+1,c)),o(n,d),n=!1,l=c,t=l+1;continue}if(/\s|\n|\t/.test(p))if(e=e.replace(/\s|\n|\t/g," "),n===!1)if(c=wt(e,l),c===-1){d=V.trim(e.slice(t,l)),o(d),n=!1,t=l+1;continue}else{l=c-1;continue}else if(c=yt(e,l-1),c===-1){d=V.trim(e.slice(t,l)),d=g1(d),o(n,d),n=!1,t=l+1;continue}else continue}return t<e.length&&(n===!1?o(e.slice(t)):o(n,g1(V.trim(e.slice(t))))),V.trim(a.join(" "))}function wt(e,r){for(;r<e.length;r++){var t=e[r];if(t!==" ")return t==="="?r:-1}}function bt(e,r){for(;r<e.length;r++){var t=e[r];if(t!==" ")return t==="'"||t==='"'?r:-1}}function yt(e,r){for(;r>0;r--){var t=e[r];if(t!==" ")return t==="="?r:-1}}function xt(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function g1(e){return xt(e)?e.substr(1,e.length-2):e}W.parseTag=ht;W.parseAttr=mt;var Lt=a1.FilterCSS,L=m,U1=W,At=U1.parseTag,St=U1.parseAttr,G=n1;function R(e){return e==null}function Mt(e){var r=G.spaceIndex(e);if(r===-1)return{html:"",closing:e[e.length-2]==="/"};e=G.trim(e.slice(r+1,-1));var t=e[e.length-1]==="/";return t&&(e=G.trim(e.slice(0,-1))),{html:e,closing:t}}function Et(e){var r={};for(var t in e)r[t]=e[t];return r}function kt(e){var r={};for(var t in e)Array.isArray(e[t])?r[t.toLowerCase()]=e[t].map(function(s){return s.toLowerCase()}):r[t.toLowerCase()]=e[t];return r}function G1(e){e=Et(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=L.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=kt(e.whiteList||e.allowList):e.whiteList=L.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":L.attributeWrapSign,e.onTag=e.onTag||L.onTag,e.onTagAttr=e.onTagAttr||L.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||L.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||L.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||L.safeAttrValue,e.escapeHtml=e.escapeHtml||L.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Lt(e.css))}G1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var r=this,t=r.options,s=t.whiteList,a=t.onTag,n=t.onIgnoreTag,u=t.onTagAttr,o=t.onIgnoreTagAttr,l=t.safeAttrValue,p=t.escapeHtml,d=r.attributeWrapSign,c=r.cssFilter;t.stripBlankChar&&(e=L.stripBlankChar(e)),t.allowCommentTag||(e=L.stripCommentTag(e));var f=!1;t.stripIgnoreTagBody&&(f=L.StripTagBody(t.stripIgnoreTagBody,n),n=f.onIgnoreTag);var C=At(e,function(i,b,v,w,h){var g={sourcePosition:i,position:b,isClosing:h,isWhite:Object.prototype.hasOwnProperty.call(s,v)},S=a(v,w,g);if(!R(S))return S;if(g.isWhite){if(g.isClosing)return"</"+v+">";var _=Mt(w),I=s[v],Z=St(_.html,function(M,A){var $=G.indexOf(I,M)!==-1,k=u(v,M,A,$);return R(k)?$?(A=l(v,M,A,c),A?M+"="+d+A+d:M):(k=o(v,M,A,$),R(k)?void 0:k):k});return w="<"+v,Z&&(w+=" "+Z),_.closing&&(w+=" /"),w+=">",w}else return S=n(v,w,g),R(S)?p(w):S},p);return f&&(C=f.remove(C)),C};var Vt=G1;(function(e,r){var t=m,s=W,a=Vt;function n(o,l){var p=new a(l);return p.process(o)}r=e.exports=n,r.filterXSS=n,r.FilterXSS=a,function(){for(var o in t)r[o]=t[o];for(var l in s)r[l]=s[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function u(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}u()&&(self.filterXSS=e.exports)})(r1,r1.exports);var $t=r1.exports;const E=Ne($t);var Ht=Array.isArray,z1=function(e){var r="";if(typeof e=="string")r+=e;else if(typeof e=="object"){var t=void 0;if(Ht(e))for(var s=0,a=e.length;s<a;)t=z1(e[s++]),t&&(r&&(r+=" "),r+=t);else for(t in e)t&&e[t]&&(r&&(r+=" "),r+=t)}return r};function F1(){for(var e=arguments.length,r=0,t,s,a="";r<e;)t=arguments[r++],t&&(s=z1(t),s&&(a&&(a+=" "),a+=s));return a}function h1({children:e="",imageUrl:r,imageAlt:t="",aspectRatio:s="card-small",videoUrl:a}){return`
  ...
  `}function _t(e,r){if(!r)return!0;const t=e.match(/(\d+-\d+-\d+)/)[0],s=r.match(/(\d+-\d+-\d+)/)[0];return t===s}function It({start:e,end:r}){if(!e&&!r)return null;const t=new Date(e),s=r?new Date(r):null,a={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let n="";const u=_t(e,r);u||(delete a.time,delete a.hour,delete a.minute);const o=new Intl.DateTimeFormat("en-US",a).format(t),l=r?new Intl.DateTimeFormat("en-US",a).format(s):"";return u?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(n+=`${o} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${n}</span>`)}function Zt(){return`
    ...
    </svg>`}const Bt="light";function Q({variant:e=Bt}){const r=new Map;return r.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
  ...
  `}function n5(e){const{videoId:r,className:t="",noAutoPlay:s,title:a,isVertical:n}=e;return`
    ...
    `}const i5='section[data-component="topic-subtopic-listing"]',o5='[data-element="topics-list"]',W1='[data-element="topics-pagination"]',j1="su-hidden",l5='section[data-element="modal-wrapper"]',u5='button[data-click="open-modal"]',d5='button[data-dismiss="modal"]',X1='iframe[data-modal="iframe"]';function c5(e){const r=e.querySelector(X1),s=r.getAttribute("src").replace("autoplay=0","autoplay=1");r.setAttribute("src",s),e.classList.remove(j1),e.hidden=!1}function L1(e){const r=e.querySelector(X1),s=r.getAttribute("src").replace("autoplay=1","autoplay=0");r.setAttribute("src",s),e.classList.add(j1),e.hidden=!0}function Q1(e){const r=e.querySelectorAll(u5),t=e.querySelectorAll(d5);let s=null;r&&r.forEach(a=>{a&&a.addEventListener("click",function(){const n=a.dataset.modalId;s=e.querySelector(`div[data-modal-id="${n}"]`),s&&c5(s)})}),t&&t.forEach(a=>{a&&a.addEventListener("click",function(){L1(s)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&s&&L1(s)})}async function f5(e){const{offset:r,query:t,endpoint:s}=e,a=s+t+`&start_rank=${r}`;return await(await fetch(a).catch(o=>{throw new Error(o)})).json()}function C5(e,r,t,s){document.querySelector(o5).innerHTML=r,document.querySelector(W1).innerHTML=t,document.querySelector(l5).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),Q1(e),Y1(e)}async function p5(e){var f,C,i,b,v;const{offset:r,query:t,endpoint:s,display:a,section:n}=e,u=await f5({offset:r,query:t,endpoint:s}),o=(C=(f=u==null?void 0:u.response)==null?void 0:f.resultPacket)==null?void 0:C.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const l=[],p=[];(v=(b=(i=u==null?void 0:u.response)==null?void 0:i.resultPacket)==null?void 0:b.results)==null||v.forEach(w=>{const h=Ze(),g=Oe(w);g.uniqueID=h,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(a)?(g.displayConfiguration=a,l.push(a5({data:g,cardType:"narrowhorizontal"}))):l.push(r5({data:g,cardType:"horizontal",cardSize:"large"})),(g.type==="Video"||g.videoUrl)&&p.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const d=De({pageNumber:Number(r),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(r)}),c=p.map(w=>`
        ...
        ${n5({videoId:w.videoId,title:w.title,noAutoPlay:w.noAutoPlay,isVertical:w.isVertical})}
