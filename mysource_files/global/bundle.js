import B from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const Xe=typeof window>"u"?{}:window;function Jt(e=Xe){return e.document!==void 0}function D(e,t=Xe){if(!Jt(t))return null;const{document:s}=t,{cookie:n}=s;if(typeof n!="string")return null;const r=n.split("; ");let i=null;return r.find(a=>{const[o,l]=a.split("=");return o===e&&l!==""&&(i=l),null}),i}const Oe="su-hidden";function Ve(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')};Object.values(t).forEach(s=>{s==null||s.forEach(n=>{n.classList.add(Oe)})}),t[e]&&t[e].forEach(s=>{s.classList.remove(Oe)})}document.addEventListener("DOMContentLoaded",function(){const e=D("preferences_personalisation");Ve(e==="null"||!e?"external":e)});const Qe=typeof window>"u"?{}:window;function e1(e=Qe){return e.document!==void 0}function xe(e,t="",s=!0,n="",r="/",i=Qe){if(!e1(i))return;const{document:a}=i,{location:{hostname:o}}=a;let l="";if(n){const d=new Date;d.setTime(d.getTime()+n*24*60*60*1e3),l=`; expires=${d.toUTCString()}`}s===!0?a.cookie=`${e}=${t}${l}; path=${r}; domain=${o}; secure=${s};`:a.cookie=`${e}=${t}${l}; path=${r}; domain=${o};`}async function t1(e,t){return await(await fetch("/__dxp/events/custom",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source:"custom",action:e,event:{type:t}}),redirect:"follow"}).catch(r=>{throw new Error(r)})).text()}async function ee(e){return await(await fetch("/__dxp/cdp/setConsent",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({CDPConsent:e,documentVersion:"1.0"}),redirect:"follow"}).catch(n=>{throw new Error(n)})).text()}function n1(){const e='[id="light-theme"]',t='[id="dark-theme"]',s='[data-role="su-darkmode-icon-active"]',n='[data-role="su-darkmode-icon-nonactive"]',r=document.querySelector(e),i=document.querySelector(t),a=document.querySelector(s),o=document.querySelector(n),l=document.querySelector("html");if(r&&i){const d=D("preferences_theme");d==="dark"||["",null,void 0,!1].includes(d)&&window.matchMedia("(prefers-color-scheme: dark)").matches?(l.classList.add("su-dark"),a.classList.remove("su-hidden"),o.classList.add("su-hidden"),i.checked=!0,r.checked=!1):(a.classList.add("su-hidden"),o.classList.remove("su-hidden"),l.classList.add("su-light"),r.checked=!0,i.checked=!1),r.addEventListener("keyup",({key:f})=>{[" ","Enter"].includes(f)&&document.querySelector('[data-theme="dark-theme"]').click()}),i.addEventListener("keyup",({key:f})=>{[" ","Enter"].includes(f)&&document.querySelector('[data-theme="light-theme"]').click()}),r.addEventListener("click",()=>{l.classList.remove("su-dark"),l.classList.add("su-light"),a.classList.add("su-hidden"),o.classList.remove("su-hidden"),xe("preferences_theme","light",!0,130)}),i.addEventListener("click",()=>{l.classList.remove("su-light"),l.classList.add("su-dark"),a.classList.remove("su-hidden"),o.classList.add("su-hidden"),xe("preferences_theme","dark",!0,130)}),document.personaChangeEvent=new Event("personaChange")}}class s1{constructor(t){this.parent=t,this.menuToggle=this.parent.querySelector('[aria-controls="menu"]'),this.searchToggle=this.parent.querySelector('[aria-controls="search"]'),this.preferencesToggle=this.parent.querySelector('[aria-controls="preferences"]'),this.menuCloseToggle=this.parent.querySelectorAll(".report-header__menu-close,.report-header__menu-tray .report-header__overlay"),this.searchCloseToggle=this.parent.querySelectorAll(".report-header__search-close,.report-header__search-tray .report-header__overlay"),this.preferencesCloseToggle=this.parent.querySelectorAll(".report-header__preferences-close,.report-header__preferences-tray .report-header__overlay"),this.handleHeaderScroll(),this.handleHeaderToggles(),this.handleSearchInputs();const s=document.querySelector('[data-role="header-main-nav"]');s&&(s.classList.remove("su-opacity-0"),s.classList.add("su-opacity-1"))}focus(t){if(t.match(/:/g)){const[s,n,r]=t.split(":");document.querySelector(`[data-location="${t}"]`).querySelectorAll(n)[Number(r)].focus();return}document.querySelector(`[data-location="${t}"]`).focus()}handleTab(t){t.addEventListener("keyup",s=>{const{target:n,key:r}=s;if(r!=="Tab")return;const i=n.dataset.tpTo?n.dataset.tpTo:null;i&&this.focus(i)})}handleSearchInputs(){const t=document.querySelectorAll('[data-role="search-query"]'),s=document.querySelectorAll('[data-role="clear-search"]');t.length&&t.forEach((n,r)=>{n.addEventListener("keyup",()=>{n.value!==""?(n.parentNode.classList.add("input-has-value"),s[r].classList.remove("su-hidden")):(n.parentNode.classList.remove("input-has-value"),s[r].classList.add("su-hidden"))})}),s.length&&s.forEach(n=>{n.addEventListener("click",r=>{n.parentNode.parentNode.querySelector(".input-has-value").classList.remove("input-has-value"),n.classList.add("su-hidden")})})}handleHeaderToggles(){this.handleTab(document.querySelector(".report-header__main")),this.menuToggle.addEventListener("click",()=>{const s=this.parent.querySelector("#menu");this.menuToggle.getAttribute("aria-expanded")==="true"?(this.menuToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--primary-nav-open"),s.setAttribute("aria-hidden","true"),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{s.classList.remove("su-hidden"),s.classList.add("su-block")},300)):(s.classList.remove("su-hidden"),window.innerWidth<768&&(document.body.style.cssText+="overflow: hidden;"),setTimeout(()=>{this.menuCloseToggle[1].focus(),this.menuToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--primary-nav-open"),s.setAttribute("aria-hidden","false")},0))}),this.menuCloseToggle.forEach(s=>{s.addEventListener("click",()=>{const n=this.parent.querySelector("#menu");this.menuToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--primary-nav-open"),n.setAttribute("aria-hidden","true"),this.menuToggle.focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{n.classList.remove("su-block"),n.classList.add("su-hidden")},300)})});const t=document.querySelector('[data-role="search-focus-trap"]');this.searchToggle.addEventListener("click",()=>{const s=this.parent.querySelector("#search");this.searchToggle.getAttribute("aria-expanded")==="true"?(this.searchToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--search-open"),s.setAttribute("aria-hidden","true"),setTimeout(()=>{s.classList.add("su-hidden"),s.classList.remove("su-block"),t.classList.add("su-hidden"),t.classList.remove("su-block")},300)):(s.classList.remove("su-hidden"),t.classList.remove("su-hidden"),setTimeout(()=>{this.searchToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--search-open"),s.setAttribute("aria-hidden","false")},0))}),this.searchCloseToggle.forEach(s=>{const n=this.parent.querySelector("#search");s.addEventListener("click",()=>{const r=this.parent.querySelector("#search");this.searchToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--search-open"),r.setAttribute("aria-hidden","true"),setTimeout(()=>{n.classList.remove("su-block"),n.classList.add("su-hidden"),t.classList.remove("su-block"),t.classList.add("su-hidden")},300)})}),this.preferencesToggle.addEventListener("click",()=>{const s=this.parent.querySelector("#preferences");this.preferencesToggle.getAttribute("aria-expanded")==="true"?(this.preferencesToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--preferences-open"),s.setAttribute("aria-hidden","true"),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{s.classList.remove("su-hidden"),s.classList.add("su-block")},300)):(s.classList.remove("su-hidden"),this.preferencesCloseToggle[1].focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: hidden;"),setTimeout(()=>{this.preferencesToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--preferences-open"),s.setAttribute("aria-hidden","false")},0))}),this.preferencesCloseToggle.forEach(s=>{s.addEventListener("click",()=>{const n=this.parent.querySelector("#preferences");this.preferencesToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--preferences-open"),n.setAttribute("aria-hidden","true"),this.preferencesToggle.focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{n.classList.remove("su-block"),n.classList.add("su-hidden")},300)})})}handleHeaderScroll(){window.addEventListener("scroll",t=>{const s=this.parent;if(window.scrollY>32){s.classList.add("report-header--collapsed");return}s.classList.remove("report-header--collapsed")})}}class Ke{constructor(t,s){this.url=t,this.type=s,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const n=this.assetIds.map(async r=>{const i=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(i,this.requestProps).catch(l=>{throw new Error(l)})).json()});return Promise.all(n)}return await(await fetch(this.url,this.requestProps).catch(n=>{throw new Error(n)})).json()}}function Je(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}async function r1(e=null,t=""){var n,r,i,a,o,l,d,f;const s=new Ke;if(e&&e.search){let u="",p="";u=`${(n=e.search.endpoint)==null?void 0:n.replace("search.html","search.json")}?profile=${e.search.profile}&collection=${e.search.collection}&query=[taxonomyContentMainTopicId:${e.mainTopicId} taxonomyContentTopicsId:${e.mainTopicId} taxonomyContentSubtopicsId:${e.mainTopicId}]&meta_taxonomyAudienceText=${Je(t)}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&sort=date&num_ranks=1&log=false`,p=`${(r=e.search.endpoint)==null?void 0:r.replace("search.html","search.json")}?profile=${e.search.profile}&collection=${e.search.collection}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&sort=date&num_ranks=1&log=false`,e.contentType==="Video"&&(p+="&meta_taxonomyContentTypeId=28207",u+="&meta_taxonomyContentTypeId=28207"),s.url=u;let h=await s.fetch(),c=((o=(a=(i=h.response)==null?void 0:i.resultPacket)==null?void 0:a.results)==null?void 0:o[0])||null;return c||(s.url=p,h=await s.fetch(),c=((f=(d=(l=h.response)==null?void 0:l.resultPacket)==null?void 0:d.results)==null?void 0:f[0])||null),c}return null}function a1(e,t,s,n="su-hidden"){if(e&&t&&s){const r=s.querySelector('h2[data-story="announcement"]'),i=s.querySelector('h1[data-story="title"]'),a=s.querySelector('a[data-story="link"]');t!=null&&t.contentType&&r&&(r.textContent=t.contentType==="Video"?"Watch next:":"Read next:"),t!=null&&t.title&&i&&(i.textContent=t.title),e!=null&&e.displayUrl&&(e!=null&&e.title)&&a&&(a.textContent=e.title,a.href=e.displayUrl),(t!=null&&t.title||e!=null&&e.displayUrl)&&s.classList.remove(n)}}const i1='header[data-component="header-component"]',et='section[data-subcomponent="header-cookie-consent-banner"]',F="su-hidden";let U=!1;function te(){const e=document.querySelector(et);e&&e.classList.add(F),e&&e.classList.remove("active")}function o1(){const e=document.querySelector(et);e&&e.classList.remove(F),e&&e.classList.add("active")}function _e(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')},s={student:document.querySelector('button[data-click="student-persona"]'),faculty:document.querySelector('button[data-click="faculty-persona"]')};Object.values(t).forEach(n=>{n==null||n.forEach(r=>{r.classList.add(F)})}),Object.values(s).forEach(n=>{n&&n.setAttribute("aria-pressed","false")}),t[e]&&t[e].forEach(n=>{n.classList.remove(F)}),s[e]&&s[e].setAttribute("aria-pressed","true")}const oe=async(e,t,s=!1)=>{let n=null;!U&&s===!1&&(await ee(1),U=!0,te()),e&&(t===e?n="external":n=e),await t1("persona-selector",n),s===!0&&(await ee(0),U=!1),xe("preferences_personalisation",n,!0,130),t=n,_e(t),document.dispatchEvent(document.personaChangeEvent),window.location.reload()},qe=async e=>{e===!0?(await ee(1),U=!0,te()):(await ee(0),U=!1,te())};document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector('button[data-click="student-persona"]'),t=document.querySelector('button[data-click="faculty-persona"]'),s=typeof window.pageController<"u"?window.pageController:null,n=document.querySelectorAll('a[data-menu="main-nav"]'),r=document.querySelector('[data-current-story="headline"]'),i=document.querySelector(i1);i&&new s1(i);let a=null;const o=JSON.parse(D("squiz.cdp.consent")),l=o==null?void 0:o.CDPConsent,d=document.querySelector('button[data-click="clear-preferences"]'),f={};f.pageData=s,f.consentData=o==null?void 0:o.CDPConsent,f.audienceData=D("preferences_personalisation"),(f.audienceData==="null"||!f.audienceData)&&(f.audienceData="external"),window.suHeaderProps=f,n1(),s&&n&&n.forEach(c=>{(s==null?void 0:s.id)===c.dataset.id&&(c.classList.remove("su-border-transparent"),c.classList.add("!su-text-digital-red su-border-digital-red dark:su-border-dark-mode-red dark:!su-text-dark-mode-red"))}),s!=null&&s.isStory&&(i.classList.add("report-header--story"),(async()=>(a=await r1(f.pageData,f.audienceData),a1(a,s,r,F)))()),!l&&l!=0&&o1(),l&&(te(),d&&(d.removeAttribute("disabled"),d.setAttribute("aria-pressed","false"),d.classList.add("su-text-digital-blue"),d.classList.add("dark:su-text-digital-blue-vivid"),d.addEventListener("click",async function(){await oe(null,null,!0)})));const u=document.querySelector('button[data-click="accept-consent"]'),p=document.querySelector('button[data-click="reject-consent"]');u&&u.addEventListener("click",function(){qe(!0)}),p&&p.addEventListener("click",function(){qe(!1)});const h=D("preferences_personalisation");_e(h==="null"||!h?"external":h),e&&e.addEventListener("click",function(){oe("student",h)}),t&&t.addEventListener("click",function(){oe("faculty",h)})});function tt(e){if(!e)return 0;const t=225,s=e.trim().split(/\s+/).length;return Math.ceil(s/t)}function l1(e,t,s,n=()=>{}){const r=e.slides.length;let i=t-r+1;r%s!==0&&(i+=s-r%s);const a=document.createDocumentFragment(),o=e.slides.map(l=>l.outerHTML).join("");for(let l=0;l<i;l++){const d=document.createElement("div");for(d.innerHTML=o;d.firstChild;)d.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(d.firstChild)}e.wrapperEl.appendChild(a),e.update(),b(e,"",!1),n()}function N(e,t=()=>{}){const{slidesPerView:s,slidesPerGroup:n}=e.params,r=e.slides.length,i=Math.ceil(s+n);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<i||r%n!==0?l1(e,i,n,t):(b(e,"",!1),t())}function re(e){const t=e.slides.filter(s=>s.classList.contains("swiper-slide-duplicate")).length;if(t){let s=e.pagination.bullets.length-e.slides.length+t;for(;s>0;){const n=e.pagination.bullets.pop();n&&n.remove(),s--}}}const b=(e,t,s)=>{e.slides.forEach(n=>{if(n.classList.contains("swiper-slide-active")){if(n.removeAttribute("aria-hidden"),n.removeAttribute("inert"),n.setAttribute("tabindex","-1"),t&&s){let r=null;t==="slide"?r=n:r=n.querySelector(t),r&&r.focus()}}else n.setAttribute("aria-hidden","true"),n.setAttribute("inert","true"),n.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(n=>{n.classList.contains("swiper-pagination-bullet-active")?n.setAttribute("aria-current","true"):n.removeAttribute("aria-current")})},c1='section[data-component="basic-story-hero"]',d1='span[data-reading="true"]',nt="su-hidden",u1='button[data-click="open-modal"]',f1='button[data-dismiss="modal"]',st='iframe[data-modal="iframe"]';function p1(e){const t=e.querySelector(st);if(t){const n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n)}e.classList.remove(nt),e.hidden=!1,document.body.style.overflow="hidden"}function le(e){const t=e.querySelector(st);if(t){const n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n)}e.classList.add(nt),e.hidden=!0,document.body.style.overflow=""}function h1(e){const t=e.querySelectorAll(u1),s=e.querySelectorAll(f1);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||le(n)}),n.dataset.listenerAdded="true"),p1(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&le(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&le(n)})}function m1(e){var n;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?b(i,"slide",!0):b(i,"",!1)},100)})}else(n=e.querySelector(".component-slider-controls"))==null||n.remove()}function C1(e){const t=document.querySelector(".su-page-content"),s=e.querySelector(d1);if(t&&s){const n=tt(t.innerText);s.textContent=n}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(c1).forEach(e=>{m1(e),h1(e),C1(e)})});const g1='section[data-component="combined-content-grid"]',rt="su-hidden",v1='button[data-click="open-modal"]',y1='button[data-dismiss="modal"]',at='iframe[data-modal="iframe"]';function w1(e){const t=e.querySelector(at),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(rt),e.hidden=!1,document.body.style.overflow="hidden"}function ce(e){const t=e.querySelector(at),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(rt),e.hidden=!0,document.body.style.overflow=""}function L1(e){const t=e.querySelectorAll(v1),s=e.querySelectorAll(y1);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||ce(n)}),n.dataset.listenerAdded="true"),w1(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&ce(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&ce(n)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(g1).forEach(e=>{L1(e)})});const E1='section[data-component="content-carousel"]';function b1(e){var n;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?b(i,"slide",!0):b(i,"",!1)},100)})}else(n=e.querySelector(".component-slider-controls"))==null||n.remove()}function it(){document.querySelectorAll(E1).forEach(e=>{b1(e)})}document.addEventListener("DOMContentLoaded",it);document.addEventListener("livePreviewUpdated",it);const S1='section[data-component="feature-story-hero"]',A1='span[data-reading="true"]';function x1(e){const t=document.querySelector(".su-page-content"),s=e.querySelector(A1);if(t&&s){const n=tt(t.innerText);s.textContent=n}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(S1).forEach(e=>{x1(e)})});const _1='section[data-component="featured-content"]',ot="su-hidden",T1='button[data-click="open-modal"]',I1='button[data-dismiss="modal"]',lt='iframe[data-modal="iframe"]';function k1(e){const t=e.querySelector(lt),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(ot),e.hidden=!1,document.body.style.overflow="hidden"}function de(e){const t=e.querySelector(lt),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(ot),e.hidden=!0,document.body.style.overflow=""}function M1(e){const t=e.querySelectorAll(T1),s=e.querySelectorAll(I1);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||de(n)}),n.dataset.listenerAdded="true"),k1(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&de(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&de(n)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(_1).forEach(e=>{M1(e)})});const $1='section[data-component="horizontal-video-testimonials"]',ct="su-hidden",O1='button[data-click="open-modal"]',V1='button[data-dismiss="modal"]',dt='iframe[data-modal="iframe"]';function q1(e){const t=e.querySelector(dt);if(t){const s=t.getAttribute("src"),n=s&&s.replace("autoplay=0","autoplay=1");t.setAttribute("src",n)}e.classList.remove(ct),e.hidden=!1,document.body.style.overflow="hidden"}function ue(e){const t=e.querySelector(dt);if(t){const s=t.getAttribute("src"),n=s&&s.replace("autoplay=1","autoplay=0");t.setAttribute("src",n)}e.classList.add(ct),e.hidden=!0,document.body.style.overflow=""}function H1(e){const t=e.querySelectorAll(O1),s=e.querySelectorAll(V1);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||ue(n)}),n.dataset.listenerAdded="true"),q1(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&ue(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&ue(n)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll($1).forEach(e=>{H1(e)})});const N1='section[data-component="image-gallery-modal"]',R1='button[data-click="open-gallery-modal"]',D1='div[data-modal="modal"]',B1='button[data-dismiss="modal"]',ut="su-hidden";let Te;const P1=(e,t)=>{var a;const s='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',n=(a=Array.from(t==null?void 0:t.querySelectorAll(s)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(n.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=n[0],i=n[n.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function Z1(e){e.classList.remove(ut),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&P1(t,e)})}function fe(e){e.classList.add(ut),e.hidden=!0,document.body.style.overflow=""}function G1(e){const t=e.dataset.modalId;Te=new B(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,n){return`<button ${s===0?'aria-current="true"':""} class="${n}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function U1(e){const t=e.querySelector(D1),s=e.querySelector(R1),n=e.querySelector(B1);s&&s.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",i=>{r.contains(i.target)||fe(t)}),t.dataset.listenerAdded="true"),Z1(t),G1(t)}),n&&n.addEventListener("click",function(){fe(t),Te.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(fe(t),Te.destroy())})}function ft(){document.querySelectorAll(N1).forEach(e=>{U1(e)})}document.addEventListener("DOMContentLoaded",ft);document.addEventListener("livePreviewUpdated",ft);const F1='[data-component="interactive-photo-card"]',z1="[data-card-inner]",pt="[data-card-inner-content]";function W1(e){var r;const s=((e.style.transform&&parseInt((r=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:r[1])||0)+180)%360;e.style.transform=`rotateY(${s}deg)`;const n=e.querySelectorAll(pt);Y1(n)}function j1(e){const t=e.querySelector(z1);if(!t){console.error("Could not find card inner element for component");return}const s=t.querySelectorAll('button[aria-label="See additional information"], button[aria-label="Dismiss content"]');if(!s.length){console.error("Could not find flip buttons for component");return}s.forEach(n=>{n.addEventListener("click",r=>{r.stopPropagation(),W1(t)})})}const Y1=e=>{e.forEach(t=>{const s=t.getAttribute("aria-hidden")==="true"?"false":"true",n=t.querySelector("button");n&&(n.tabIndex=s==="true"?"-1":""),t.setAttribute("aria-hidden",s)})},X1=e=>{const t=e.querySelectorAll(pt);t.length&&t.forEach(s=>{const n=s.querySelector("button");if(n){const r=s.getAttribute("aria-hidden")==="true";n.tabIndex=r?"-1":""}})};function ht(){document.querySelectorAll(F1).forEach(e=>{j1(e),X1(e)})}document.addEventListener("DOMContentLoaded",ht);document.addEventListener("livePreviewUpdated",ht);function Q1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:s,summary:n,image:r,taxonomyContentTypeText:i,contentTopic:a,contentSubtopic:o,taxonomyContentMainTopicText:l,contentCategory:d,featuredVideo:f,taxonomyContentMainTopicLandingPageUrl:u,taxonomyFeaturedUnitLandingPageUrl:p,taxonomyFeaturedUnitText:h,imageAlt:c,authorName:w,authorImage:g,author:v,isTeaser:C,storySource:m,assetHref:S},date:$,liveUrl:O}){const V=w!==void 0?w:v,A=g!==""?g:void 0,I=r&&r!==""?r:null,L=c&&c!==""?c:"",k=f,P=s||n;let q=l;!q&&a&&(q=a instanceof Array?a[0]:a),!q&&o&&(q=o instanceof Array?o[0]:o);const ie=u;let Z=i?i[0]:"";return!Z&&d&&(Z=d instanceof Array?d[0]:d),S&&t[0]==="link"&&(O=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(P)?P[0]:P,liveUrl:Array.isArray(O)?O[0]:O,imageUrl:Array.isArray(I)?I[0]:I,imageAlt:Array.isArray(L)?L[0]:L,taxonomy:Array.isArray(q)?q[0]:q,taxonomyUrl:Array.isArray(ie)?ie[0]:ie,type:Array.isArray(Z)?Z[0]:Z,videoUrl:Array.isArray(k)?k[0]:k,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(V)?V[0]:V,authorAvatar:Array.isArray(A)?A[0]:A,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(p)?p[0]:p,taxonomyFeaturedUnitText:Array.isArray(h)?h[0]:h,isTeaser:Array.isArray(C)?C[0]:C,storySource:Array.isArray(m)?m[0]:m}}function pe(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function mt(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}const K1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,s=>{let n=Math.random()*16;return e>0?(n=(e+n)%16|0,e=Math.floor(e/16)):(n=(t+n)%16|0,t=Math.floor(t/16)),(s==="x"?n:n&3|8).toString(16)})},J1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),en=()=>typeof crypto<"u"?J1():K1();async function tn(e=null,t="",s=null){var r,i,a,o,l,d,f,u,p,h,c,w,g,v,C,m,S,$,O;const n=new Ke;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const V=`
    ...
    `}function an(e,t,s){if(!e.length){t.classList.add(E.NO_STORIES);return}const[n,r,i]=e;s.innerHTML=`
    ...
    `,t.classList.remove(E.NO_STORIES)}async function on(e,t,s,n,r,i){const o=(await tn(e,i,t)).map(({title:l,indexUrl:d})=>rn(l,d));an(o,s,r),ln(s,n,r)}function ln(e,t,s){t.addEventListener("click",function(){nn(t,s)}),window.addEventListener("scroll",function(){sn(e)})}function cn(e,t,s,n){if(!e||!window.pageController)return;const r=window.pageController,i=r.topicsQuery?r.topicsQuery():null;on(r,i,e,t,s,n)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(he.WRAPPER),t=document.querySelector(he.TOGGLE),s=document.querySelector(he.DRAWER),n=D("preferences_personalisation");cn(e,t,s,n)});const dn='section[data-component="media-carousel"]';function un(e){const t=e.dataset.uniqueId,s=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}}),n=s.slides.length,r=s.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(n-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),s.on("slideChange",function(){setTimeout(()=>{a?b(s,"h2 a, h3 a, button",!0):b(s,"",!1)},100)})}}function Ct(){document.querySelectorAll(dn).forEach(e=>{un(e)})}document.addEventListener("DOMContentLoaded",Ct);document.addEventListener("livePreviewUpdated",Ct);const fn='button[data-role="copy-link"]';function pn(e){e.addEventListener("click",function(){navigator.clipboard.writeText(window.location.href).then(()=>{const t=document.querySelector("[data-copy-text]");t.textContent="Copied",setTimeout(()=>{t.textContent="Copy link"},3e3)})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(fn).forEach(e=>{pn(e)})});const hn='section[data-component="multicolumn-listing"]',gt="su-hidden",mn='button[data-click="open-modal"]',Cn='button[data-dismiss="modal"]',vt='iframe[data-modal="iframe"]';function gn(e){const t=e.querySelector(vt),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(gt),e.hidden=!1,document.body.style.overflow="hidden"}function me(e){const t=e.querySelector(vt),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(gt),e.hidden=!0,document.body.style.overflow=""}function vn(e){const t=e.querySelectorAll(mn),s=e.querySelectorAll(Cn);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||me(n)}),n.dataset.listenerAdded="true"),gn(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&me(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&me(n)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(hn).forEach(e=>{vn(e)})});const yn='section[data-component="sidebar-navigation"]',wn='nav[data-nav="nav"]',ne="su-hidden",Ln='button[data-click="toggle-nav"]',En="su-bg-digital-red su-text-white dark:su-bg-dark-mode-red dark:aria-expanded:su-text-black-true",bn='span[data-label="button"]';function yt(e,t){const s=e.querySelector(bn),n=e.querySelector('svg[data-icon="bars"]'),r=e.querySelector('svg[data-icon="xmark"]');e.setAttribute("aria-expanded",t.toString()),En.split(" ").forEach(i=>{e.classList.toggle(i,t)}),n&&(n.classList.toggle(`!${ne}`,t),n.hidden=t),r&&(r.classList.toggle(`!${ne}`,!t),r.hidden=!t),s&&(s.innerHTML=t?s.getAttribute("data-label-close"):s.getAttribute("data-label-open"))}function He(e,t){e.classList.remove(ne),e.hidden=!1,yt(t,!0)}function z(e,t){e.classList.add(ne),e.hidden=!0,yt(t,!1)}function Sn(e){const t=e.querySelector(Ln),s=e.querySelector(wn);let n;t&&t.addEventListener("click",function(){const r=t.getAttribute("aria-expanded")==="true";s.dataset.listenerAdded||(document.addEventListener("click",i=>{const a=s.contains(i.target),o=t.contains(i.target);!a&&!o&&z(s,t)}),s.dataset.listenerAdded="true"),r?z(s,t):He(s,t)}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&t&&z(s,t)}),window.addEventListener("resize",()=>{clearTimeout(n),n=setTimeout(()=>{window.innerWidth>991?s&&t&&He(s,t):s&&t&&z(s,t)},10)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(yn).forEach(e=>{Sn(e)})});function W(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function j(e,t){const s=e.querySelector('svg[data-control="play"]'),n=e.querySelector('svg[data-control="pause"]'),r=!t;e.setAttribute("aria-pressed",String(r)),s.classList.toggle("su-hidden",r),s.hidden=r,n.classList.toggle("su-hidden",!r),n.hidden=!r,e.innerHTML=`
  ...
  `}const An='section[data-component="single-image-video"]',xn='iframe[data-role="video-player"]',_n='button[data-role="video-control"]',wt="su-hidden",Tn='button[data-click="open-modal"]',In='button[data-dismiss="modal"]',Lt='iframe[data-modal="iframe"]',kn=(e,t)=>{var a;const s='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',n=(a=Array.from(t==null?void 0:t.querySelectorAll(s)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(n.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=n[0],i=n[n.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function Mn(e){const t=e.querySelector(Lt),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(wt),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&kn(r,e)})}function Ce(e){const t=e.querySelector(Lt),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(wt),e.hidden=!0,document.body.style.overflow=""}function $n(e){const t=e.querySelectorAll(Tn),s=e.querySelectorAll(In);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||Ce(n)}),n.dataset.listenerAdded="true"),Mn(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&Ce(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&Ce(n)})}function On(e){const t=e.querySelector(xn),s=e.querySelector(_n);let n=!1;if(!t||!s)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!n?(W(t,"play"),j(s,!1)):a.isIntersecting||(W(t,"pause"),j(s,!0))})},{threshold:.5}).observe(t),s.addEventListener("click",()=>{s.getAttribute("aria-pressed")==="true"?(W(t,"pause"),j(s,!0),n=!0):(W(t,"play"),j(s,!1),n=!1)})}function Et(){document.querySelectorAll(An).forEach(e=>{$n(e),On(e)})}document.addEventListener("DOMContentLoaded",Et);document.addEventListener("livePreviewUpdated",Et);const Vn='section[data-component="standalone-visual-hero"]',bt="su-hidden",qn='button[data-click="open-modal"]',Hn='button[data-dismiss="modal"]',St='iframe[data-modal="iframe"]';function Nn(e){const t=e.querySelector(St);if(t){const n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n)}e.classList.remove(bt),e.hidden=!1,document.body.style.overflow="hidden"}function ge(e){const t=e.querySelector(St);if(t){const n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n)}e.classList.add(bt),e.hidden=!0,document.body.style.overflow=""}function Rn(e){const t=e.querySelectorAll(qn),s=e.querySelectorAll(Hn);let n=null;t.forEach(r=>{r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||ge(n)}),n.dataset.listenerAdded="true"),Nn(n)})}),s.forEach(r=>{r.addEventListener("click",function(){n&&ge(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&ge(n)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Vn).forEach(e=>{Rn(e)})});const Dn='section[data-component="stories-carousel"]',At="su-hidden",Bn='button[data-click="open-modal"]',Pn='button[data-dismiss="modal"]',xt='iframe[data-modal="iframe"]';function Zn(e){const t=e.querySelector(xt),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(At),e.hidden=!1,document.body.style.overflow="hidden"}function ve(e){const t=e.querySelector(xt),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(At),e.hidden=!0,document.body.style.overflow=""}function Gn(e){const t=e.querySelectorAll(Bn),s=e.querySelectorAll(Pn);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||ve(n)}),n.dataset.listenerAdded="true"),Zn(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&ve(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&ve(n)})}let Ne=!1,Re=!1;function Un(e){const t=e.dataset.uniqueId,s=`section[data-unique-id="${t}"] .swiper`;new B(s,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,r){return`<button ${n===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,on:{init:function(){setTimeout(()=>{Re=!0,Ne=!0},500)},slideChange:function(n){const r=document.querySelector(s),i=r.querySelector(".swiper-slide-active");i&&i.removeAttribute("tabindex"),Re&&setTimeout(()=>{const a=r.querySelector(".swiper-slide-active"),o=a.querySelector("h2 a, h3 a, button")?a.querySelector("h2 a, h3 a, button"):(()=>(a.setAttribute("tabindex","-1"),a))();Ne&&o.focus()},300),n.slides.forEach(a=>{a.classList.contains("swiper-slide-visible")?(a.removeAttribute("aria-hidden"),a.removeAttribute("inert")):(a.setAttribute("aria-hidden","true"),a.setAttribute("inert","true"))}),n.pagination.bullets.length>0&&n.pagination.bullets.forEach(a=>{a.classList.contains("swiper-pagination-bullet-active")?a.setAttribute("aria-current","true"):a.removeAttribute("aria-current")})}}})}function _t(){document.querySelectorAll(Dn).forEach(e=>{Un(e),Gn(e)})}document.addEventListener("DOMContentLoaded",_t);document.addEventListener("livePreviewUpdated",_t);const Fn='section[data-component="subscribe-to-stanford-report"]';function zn(e){const t=e.querySelector("form"),s=t.querySelector('input[type="email"]'),n=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let i="";const a=s.value;if(!a||!a.match(/\w+@\w+\.\w+/)){i='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',n.innerHTML=i,s.setAttribute("aria-describedby","subscription-error");return}n.innerHTML="",s.removeAttribute("aria-describedby"),r.target.submit()}),s.addEventListener("keyup",function(){const r=s.value,i=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(i.innerHTML="",s.removeAttribute("aria-describedby"))})}function Wn(){document.querySelectorAll(Fn).forEach(e=>{zn(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",Wn);function jn({offsetNum:e,pageNumber:t,index:s}){return`
        <button
            data-offset="${e}"
    ...
    `}function Yn({pageNumber:e,allResults:t,resultsPerPage:s,paginationRange:n,currentPage:r=1}){const i=Math.ceil(t/s),a=n,o=e-s,l=e+s,d="su-text-black-50",f=[],u=[];for(let C=0;C<i;C++){const m=C*s+1;u.push(m)}let p=[...u],h=[...u];const c=u.indexOf(r),w=Math.floor(a*.5);if((c<w||i===a)&&(p=p.filter((C,m)=>C>r&&m<a),h=h.filter(C=>C<r)),c>=w&&i!==a)if(p=p.filter((C,m)=>C>r&&m<=c+w),p.length===w)h=h.filter((C,m)=>C<r&&m>=c-w);else{const C=p.length?a-p.length:a;h=h.filter((m,S)=>m<r&&S>c-C)}return[...h,r,...p].map(C=>({offset:C,index:u.indexOf(C)+1})).forEach(({offset:C,index:m})=>{f.push(jn({offsetNum:C,pageNumber:e,index:m}))}),i>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function Xn(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ie={exports:{}},y={},ke={exports:{}},R={};function Tt(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function Qn(e,t,s){}function Kn(e,t,s){}var Jn=/javascript\s*\:/img;function es(e,t){return Jn.test(t)?"":t}R.whiteList=Tt();R.getDefaultWhiteList=Tt;R.onAttr=Qn;R.onIgnoreAttr=Kn;R.safeAttrValue=es;var ts={indexOf:function(e,t){var s,n;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,n=e.length;s<n;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var n,r;if(Array.prototype.forEach)return e.forEach(t,s);for(n=0,r=e.length;n<r;n++)t.call(s,e[n],n,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},G=ts;function ns(e,t){e=G.trimRight(e),e[e.length-1]!==";"&&(e+=";");var s=e.length,n=!1,r=0,i=0,a="";function o(){if(!n){var f=G.trim(e.slice(r,i)),u=f.indexOf(":");if(u!==-1){var p=G.trim(f.slice(0,u)),h=G.trim(f.slice(u+1));if(p){var c=t(r,a.length,p,h,f);c&&(a+=c+"; ")}}}r=i+1}for(;i<s;i++){var l=e[i];if(l==="/"&&e[i+1]==="*"){var d=e.indexOf("*/",i+2);if(d===-1)break;i=d+1,r=i+1,n=!1}else l==="("?n=!0:l===")"?n=!1:l===";"?n||o():l===`
`&&o()}return G.trim(a)}var ss=ns,Y=R,rs=ss;function De(e){return e==null}function as(e){var t={};for(var s in e)t[s]=e[s];return t}function It(e){e=as(e||{}),e.whiteList=e.whiteList||Y.whiteList,e.onAttr=e.onAttr||Y.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||Y.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||Y.safeAttrValue,this.options=e}It.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,n=s.whiteList,r=s.onAttr,i=s.onIgnoreAttr,a=s.safeAttrValue,o=rs(e,function(l,d,f,u,p){var h=n[f],c=!1;if(h===!0?c=h:typeof h=="function"?c=h(u):h instanceof RegExp&&(c=h.test(u)),c!==!0&&(c=!1),u=a(f,u),!!u){var w={position:d,sourcePosition:l,source:p,isWhite:c};if(c){var g=r(f,u,w);return De(g)?f+":"+u:g}else{var g=i(f,u,w);if(!De(g))return g}}});return o};var is=It;(function(e,t){var s=R,n=is;function r(a,o){var l=new n(o);return l.process(a)}t=e.exports=r,t.FilterCSS=n;for(var i in s)t[i]=s[i];typeof window<"u"&&(window.filterCSS=e.exports)})(ke,ke.exports);var Me=ke.exports,$e={indexOf:function(e,t){var s,n;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,n=e.length;s<n;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var n,r;if(Array.prototype.forEach)return e.forEach(t,s);for(n=0,r=e.length;n<r;n++)t.call(s,e[n],n,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,s=t.exec(e);return s?s.index:-1}},os=Me.FilterCSS,ls=Me.getDefaultWhiteList,se=$e;function kt(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var Mt=new os;function cs(e,t,s){}function ds(e,t,s){}function us(e,t,s){}function fs(e,t,s){}function $t(e){return e.replace(hs,"&lt;").replace(ms,"&gt;")}function ps(e,t,s,n){if(s=Rt(s),t==="href"||t==="src"){if(s=se.trim(s),s==="#")return"#";if(!(s.substr(0,7)==="http://"||s.substr(0,8)==="https://"||s.substr(0,7)==="mailto:"||s.substr(0,4)==="tel:"||s.substr(0,11)==="data:image/"||s.substr(0,6)==="ftp://"||s.substr(0,2)==="./"||s.substr(0,3)==="../"||s[0]==="#"||s[0]==="/"))return""}else if(t==="background"){if(X.lastIndex=0,X.test(s))return""}else if(t==="style"){if(Be.lastIndex=0,Be.test(s)||(Pe.lastIndex=0,Pe.test(s)&&(X.lastIndex=0,X.test(s))))return"";n!==!1&&(n=n||Mt,s=n.process(s))}return s=Dt(s),s}var hs=/</g,ms=/>/g,Cs=/"/g,gs=/&quot;/g,vs=/&#([a-zA-Z0-9]*);?/gim,ys=/&colon;?/gim,ws=/&newline;?/gim,X=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,Be=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,Pe=/u\s*r\s*l\s*\(.*/gi;function Ot(e){return e.replace(Cs,"&quot;")}function Vt(e){return e.replace(gs,'"')}function qt(e){return e.replace(vs,function(s,n){return n[0]==="x"||n[0]==="X"?String.fromCharCode(parseInt(n.substr(1),16)):String.fromCharCode(parseInt(n,10))})}function Ht(e){return e.replace(ys,":").replace(ws," ")}function Nt(e){for(var t="",s=0,n=e.length;s<n;s++)t+=e.charCodeAt(s)<32?" ":e.charAt(s);return se.trim(t)}function Rt(e){return e=Vt(e),e=qt(e),e=Ht(e),e=Nt(e),e}function Dt(e){return e=Ot(e),e=$t(e),e}function Ls(){return""}function Es(e,t){typeof t!="function"&&(t=function(){});var s=!Array.isArray(e);function n(a){return s?!0:se.indexOf(e,a)!==-1}var r=[],i=!1;return{onIgnoreTag:function(a,o,l){if(n(a))if(l.isClosing){var d="[/removed]",f=l.position+d.length;return r.push([i!==!1?i:l.position,f]),i=!1,d}else return i||(i=l.position),"[removed]";else return t(a,o,l)},remove:function(a){var o="",l=0;return se.forEach(r,function(d){o+=a.slice(l,d[0]),l=d[1]}),o+=a.slice(l),o}}}function bs(e){for(var t="",s=0;s<e.length;){var n=e.indexOf("<!--",s);if(n===-1){t+=e.slice(s);break}t+=e.slice(s,n);var r=e.indexOf("-->",n);if(r===-1)break;s=r+3}return t}function Ss(e){var t=e.split("");return t=t.filter(function(s){var n=s.charCodeAt(0);return n===127?!1:n<=31?n===10||n===13:!0}),t.join("")}y.whiteList=kt();y.getDefaultWhiteList=kt;y.onTag=cs;y.onIgnoreTag=ds;y.onTagAttr=us;y.onIgnoreTagAttr=fs;y.safeAttrValue=ps;y.escapeHtml=$t;y.escapeQuote=Ot;y.unescapeQuote=Vt;y.escapeHtmlEntities=qt;y.escapeDangerHtml5Entities=Ht;y.clearNonPrintableCharacter=Nt;y.friendlyAttrValue=Rt;y.escapeAttrValue=Dt;y.onIgnoreTagStripAll=Ls;y.StripTagBody=Es;y.stripCommentTag=bs;y.stripBlankChar=Ss;y.attributeWrapSign='"';y.cssFilter=Mt;y.getDefaultCSSWhiteList=ls;var ae={},H=$e;function As(e){var t=H.spaceIndex(e),s;return t===-1?s=e.slice(1,-1):s=e.slice(1,t+1),s=H.trim(s).toLowerCase(),s.slice(0,1)==="/"&&(s=s.slice(1)),s.slice(-1)==="/"&&(s=s.slice(0,-1)),s}function xs(e){return e.slice(0,2)==="</"}function _s(e,t,s){var n="",r=0,i=!1,a=!1,o=0,l=e.length,d="",f="";e:for(o=0;o<l;o++){var u=e.charAt(o);if(i===!1){if(u==="<"){i=o;continue}}else if(a===!1){if(u==="<"){n+=s(e.slice(r,o)),i=o,r=o;continue}if(u===">"||o===l-1){n+=s(e.slice(r,i)),f=e.slice(i,o+1),d=As(f),n+=t(i,n.length,d,f,xs(f)),r=o+1,i=!1;continue}if(u==='"'||u==="'")for(var p=1,h=e.charAt(o-p);h.trim()===""||h==="=";){if(h==="="){a=u;continue e}h=e.charAt(o-++p)}}else if(u===a){a=!1;continue}}return r<l&&(n+=s(e.substr(r))),n}var Ts=/[^a-zA-Z0-9\\_:.-]/gim;function Is(e,t){var s=0,n=0,r=[],i=!1,a=e.length;function o(p,h){if(p=H.trim(p),p=p.replace(Ts,"").toLowerCase(),!(p.length<1)){var c=t(p,h||"");c&&r.push(c)}}for(var l=0;l<a;l++){var d=e.charAt(l),f,u;if(i===!1&&d==="="){i=e.slice(s,l),s=l+1,n=e.charAt(s)==='"'||e.charAt(s)==="'"?s:Ms(e,l+1);continue}if(i!==!1&&l===n){if(u=e.indexOf(d,l+1),u===-1)break;f=H.trim(e.slice(n+1,u)),o(i,f),i=!1,l=u,s=l+1;continue}if(/\s|\n|\t/.test(d))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(u=ks(e,l),u===-1){f=H.trim(e.slice(s,l)),o(f),i=!1,s=l+1;continue}else{l=u-1;continue}else if(u=$s(e,l-1),u===-1){f=H.trim(e.slice(s,l)),f=Ze(f),o(i,f),i=!1,s=l+1;continue}else continue}return s<e.length&&(i===!1?o(e.slice(s)):o(i,Ze(H.trim(e.slice(s))))),H.trim(r.join(" "))}function ks(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="="?t:-1}}function Ms(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="'"||s==='"'?t:-1}}function $s(e,t){for(;t>0;t--){var s=e[t];if(s!==" ")return s==="="?t:-1}}function Os(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function Ze(e){return Os(e)?e.substr(1,e.length-2):e}ae.parseTag=_s;ae.parseAttr=Is;var Vs=Me.FilterCSS,T=y,Bt=ae,qs=Bt.parseTag,Hs=Bt.parseAttr,J=$e;function Q(e){return e==null}function Ns(e){var t=J.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=J.trim(e.slice(t+1,-1));var s=e[e.length-1]==="/";return s&&(e=J.trim(e.slice(0,-1))),{html:e,closing:s}}function Rs(e){var t={};for(var s in e)t[s]=e[s];return t}function Ds(e){var t={};for(var s in e)Array.isArray(e[s])?t[s.toLowerCase()]=e[s].map(function(n){return n.toLowerCase()}):t[s.toLowerCase()]=e[s];return t}function Pt(e){e=Rs(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=T.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=Ds(e.whiteList||e.allowList):e.whiteList=T.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":T.attributeWrapSign,e.onTag=e.onTag||T.onTag,e.onTagAttr=e.onTagAttr||T.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||T.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||T.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||T.safeAttrValue,e.escapeHtml=e.escapeHtml||T.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Vs(e.css))}Pt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,n=s.whiteList,r=s.onTag,i=s.onIgnoreTag,a=s.onTagAttr,o=s.onIgnoreTagAttr,l=s.safeAttrValue,d=s.escapeHtml,f=t.attributeWrapSign,u=t.cssFilter;s.stripBlankChar&&(e=T.stripBlankChar(e)),s.allowCommentTag||(e=T.stripCommentTag(e));var p=!1;s.stripIgnoreTagBody&&(p=T.StripTagBody(s.stripIgnoreTagBody,i),i=p.onIgnoreTag);var h=qs(e,function(c,w,g,v,C){var m={sourcePosition:c,position:w,isClosing:C,isWhite:Object.prototype.hasOwnProperty.call(n,g)},S=r(g,v,m);if(!Q(S))return S;if(m.isWhite){if(m.isClosing)return"</"+g+">";var $=Ns(v),O=n[g],V=Hs($.html,function(A,I){var L=J.indexOf(O,A)!==-1,k=a(g,A,I,L);return Q(k)?L?(I=l(g,A,I,u),I?A+"="+f+I+f:A):(k=o(g,A,I,L),Q(k)?void 0:k):k});return v="<"+g,V&&(v+=" "+V),$.closing&&(v+=" /"),v+=">",v}else return S=i(g,v,m),Q(S)?d(v):S},d);return p&&(h=p.remove(h)),h};var Bs=Pt;(function(e,t){var s=y,n=ae,r=Bs;function i(o,l){var d=new r(l);return d.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=r,function(){for(var o in s)t[o]=s[o];for(var l in n)t[l]=n[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(Ie,Ie.exports);var Ps=Ie.exports;const M=Xn(Ps);var Zs=Array.isArray,Zt=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var s=void 0;if(Zs(e))for(var n=0,r=e.length;n<r;)s=Zt(e[n++]),s&&(t&&(t+=" "),t+=s);else for(s in e)s&&e[s]&&(t&&(t+=" "),t+=s)}return t};function Gt(){for(var e=arguments.length,t=0,s,n,r="";t<e;)s=arguments[t++],s&&(n=Zt(s),n&&(r&&(r+=" "),r+=n));return r}function Ge({children:e="",imageUrl:t,imageAlt:s="",aspectRatio:n="card-small",videoUrl:r}){return`
    <span
  ...
  `}const Gs={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function Ue({imageUrl:e,alt:t="",aspectRatio:s,videoUrl:n,size:r="small",title:i="",videoIconClasses:a,uniqueId:o}){if(n){const l=`
        ...
        ${n?`
          <span
            class="${Gt("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",Gs[r],a)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${Ge({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:s,children:l})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${Ge({imageUrl:e,imageAlt:t,aspectRatio:s})}
    </div>
  `}function Us(e,t){if(!t)return!0;const s=e.match(/(\d+-\d+-\d+)/)[0],n=t.match(/(\d+-\d+-\d+)/)[0];return s===n}function Fs({start:e,end:t}){if(!e&&!t)return null;const s=new Date(e),n=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const a=Us(e,t);a||(delete r.time,delete r.hour,delete r.minute);const o=new Intl.DateTimeFormat("en-US",r).format(s),l=t?new Intl.DateTimeFormat("en-US",r).format(n):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function zs(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const js="light";function we({variant:e=js}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function Xs({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    </svg>`}const We="solid";function sr({variant:e=We}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
    ...
    </svg>`}const rr="light";function je({variant:e=rr}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const x={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},fr={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function pr({data:{title:e,description:t,liveUrl:s,imageUrl:n,imageAlt:r,taxonomy:i,taxonomyUrl:a,type:o,date:l,endDate:d,videoUrl:f,uniqueID:u},cardSize:p="small"}){const h=fr[p],c=new Map;return c.set("alert",zs()),c.set("analysis & insights",ye()),c.set("analysis &amp; insights",ye()),c.set("analysis&nbsp;&amp;&nbsp;insights",ye()),c.set("case study",we({variant:"light"})),c.set("case&nbsp;study",we({variant:"light"})),c.set("casestudy",we({variant:"light"})),c.set("event",Qs()),c.set("event&nbsp;highlights",Fe()),c.set("event highlights",Fe()),c.set("feature",Ks()),c.set("infographic",Js()),c.set("in&nbsp;the&nbsp;news",Le()),c.set("in the news",Le()),c.set("inthenews",Le()),c.set("leadership&nbsp;messages",ze()),c.set("leadership messages",ze()),c.set("obituary",er()),c.set("opinion",tr()),c.set("photo",nr()),c.set("policy&nbsp;brief",je({variant:"light"})),c.set("policy brief",je({variant:"light"})),c.set("poll/quiz",Ee()),c.set("poll / quiz",Ee()),c.set("poll&nbsp;/&nbsp;quiz",Ee()),c.set("profile",ar()),c.set("research",ir()),c.set("solutions",or()),c.set("survey",lr()),c.set("timeline",cr()),c.set("tips & takeaways",be()),c.set("tips &amp; takeaways",be()),c.set("tips&nbsp;&amp;&nbsp;takeaways",be()),c.set("university&nbsp;updates",Ye()),c.set("university updates",Ye()),c.set("announcement",Ws()),c.set("news",Ys()),c.set("q&amp;a",K()),c.set("q&a",K()),c.set("q & a",K()),c.set("q&nbsp;&amp;&nbsp;a",K()),c.set("video",dr()),c.set("podcast",sr({variant:"light"})),c.set("book",Xs({className:""})),`
    <article aria-label="${e}" class="${x.root} ${h.gap}" data-testid="horizontal-card" >
      
    ${p==="large"?`
        <div class="${x.imageWrapper} ${h.imageWrapper}">
          ${n?`
            ${Ue({imageUrl:n,alt:r,videoUrl:f,mediaType:"image",aspectRatio:"card-large",size:p,uniqueId:u})}
          `:""}
        </div>
      `:""}
      ...
      ${p==="small"&&n?`
        <div class="${x.imageWrapper} ${h.imageWrapper} su-relative">
            ${Ue({imageUrl:n,alt:r,videoUrl:f,mediaType:"image",aspectRatio:"large",size:p,uniqueId:u})}
        </div>
      `:""}
      ...
      <div class="${_.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${_.authorWrapper} ${c}">
            ${h?`
              ${hr({image:h,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function Cr(e){const{videoId:t,className:s="",noAutoPlay:n,title:r,isVertical:i}=e;return`
        <iframe
            ...
            data-modal="iframe"
        ></iframe>
    `}const gr='section[data-component="topic-subtopic-listing"]',vr='[data-element="topics-list"]',Ut='[data-element="topics-pagination"]',Ft="su-hidden",yr='section[data-element="modal-wrapper"]',wr='button[data-click="open-modal"]',Lr='button[data-dismiss="modal"]',zt='iframe[data-modal="iframe"]';function Er(e){const t=e.querySelector(zt),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(Ft),e.hidden=!1,document.body.style.overflow="hidden"}function Se(e){const t=e.querySelector(zt),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(Ft),e.hidden=!0,document.body.style.overflow="hidden"}function Wt(e){const t=e.querySelectorAll(wr),s=e.querySelectorAll(Lr);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||Se(n)}),n.dataset.listenerAdded="true"),Er(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&Se(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&Se(n)})}async function br(e){const{offset:t,query:s,endpoint:n}=e,r=n+s+`&start_rank=${t}`;return await(await fetch(r).catch(o=>{throw new Error(o)})).json()}function Sr(e,t,s,n){e.querySelector(vr).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(Ut).innerHTML=s,e.querySelector(yr).innerHTML=n,window.scrollTo({top:0,behavior:"smooth"}),Wt(e),jt(e)}async function Ar(e){var p,h,c,w,g;const{offset:t,query:s,endpoint:n,display:r,section:i}=e,a=await br({offset:t,query:s,endpoint:n}),o=(h=(p=a==null?void 0:a.response)==null?void 0:p.resultPacket)==null?void 0:h.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const l=[],d=[];(g=(w=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:w.results)==null||g.forEach(v=>{const C=en(),m=Q1(v);m.uniqueID=C,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(m.displayConfiguration=r,l.push(`<div class="su-relative su-grow">${mr({data:m,cardType:"narrowhorizontal"})}</div>`)):l.push(`<div class="su-relative su-grow">${pr({data:m,cardType:"horizontal",cardSize:"large"})}</div>`),(m.type==="Video"||m.videoUrl)&&d.push({isVertical:m.size==="vertical-video",videoId:m.videoUrl,title:`Watch ${m.title}`,noAutoPlay:!0,uniqueID:m.uniqueID,titleID:"card-modal"})});const f=Yn({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),u=d.map(v=>`
        ...
        `).join("");Sr(i,l.join(""),f,u)}function jt(e){const{query:t,endpoint:s,display:n}=e.dataset,r=e.querySelector(Ut);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const o=a.getAttribute("data-offset");Ar({offset:o,query:t,endpoint:s,display:n,section:e})})})}function Yt(){document.querySelectorAll(gr).forEach(e=>{Wt(e),jt(e)})}document.addEventListener("DOMContentLoaded",Yt);document.addEventListener("livePreviewUpdated",Yt);const xr='section[data-component="vertical-video-panel"]',Xt="su-hidden",_r='button[data-click="open-modal"]',Tr='button[data-dismiss="modal"]',Qt='iframe[data-modal="iframe"]';function Ir(e){const t=e.querySelector(Qt),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(Xt),e.hidden=!1,document.body.style.overflow="hidden"}function Ae(e){const t=e.querySelector(Qt),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(Xt),e.hidden=!0,document.body.style.overflow=""}function kr(e){const t=e.querySelectorAll(_r),s=e.querySelectorAll(Tr);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||Ae(n)}),n.dataset.listenerAdded="true"),Ir(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&Ae(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&Ae(n)})}function Mr(e){var n;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?b(i,"h2 a, h3 a, button",!0):b(i,"",!1)},100)})}else(n=e.querySelector(".component-slider-controls"))==null||n.remove()}function Kt(){document.querySelectorAll(xr).forEach(e=>{Mr(e),kr(e)})}document.addEventListener("DOMContentLoaded",Kt);document.addEventListener("livePreviewUpdated",Kt);
