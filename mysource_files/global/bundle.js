import P from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const ft='section[data-component="combined-content-grid"]',ke="su-hidden",pt='button[data-click="open-modal"]',Ct='button[data-dismiss="modal"]',$e='iframe[data-modal="iframe"]';function gt(e){const t=e.querySelector($e),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(ke),e.hidden=!1,document.body.style.overflow="hidden"}function K(e){const t=e.querySelector($e),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(ke),e.hidden=!0,document.body.style.overflow=""}function ht(e){const t=e.querySelectorAll(pt),n=e.querySelectorAll(Ct);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||K(s)}),s.dataset.listenerAdded="true"),gt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&K(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&K(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ft).forEach(e=>{ht(e)})});function mt(e,t,n,s=()=>{}){const r=e.slides.length;let i=t-r+1;r%n!==0&&(i+=n-r%n);const a=document.createDocumentFragment(),o=e.slides.map(u=>u.outerHTML).join("");for(let u=0;u<i;u++){const f=document.createElement("div");for(f.innerHTML=o;f.firstChild;)f.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(f.firstChild)}e.wrapperEl.appendChild(a),e.update(),I(e,"",!1),s()}function B(e,t=()=>{}){const{slidesPerView:n,slidesPerGroup:s}=e.params,r=e.slides.length,i=Math.ceil(n+s);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<i||r%s!==0?mt(e,i,s,t):(I(e,"",!1),t())}function he(e){const t=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(t){let n=e.pagination.bullets.length-e.slides.length+t;for(;n>0;){const s=e.pagination.bullets.pop();s&&s.remove(),n--}}}const I=(e,t,n)=>{e.slides.forEach(s=>{if(s.classList.contains("swiper-slide-active")){if(s.removeAttribute("aria-hidden"),s.removeAttribute("inert"),s.setAttribute("tabindex","-1"),t&&n){let r=null;t==="slide"?r=s:r=s.querySelector(t),r&&r.focus()}}else s.setAttribute("aria-hidden","true"),s.setAttribute("inert","true"),s.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(s=>{s.classList.contains("swiper-pagination-bullet-active")?s.setAttribute("aria-current","true"):s.removeAttribute("aria-current")})},vt='section[data-component="content-carousel"]';function wt(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new P(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{B(a),I(a,"",!1)},resize:a=>{B(a)},paginationUpdate:a=>{he(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?I(i,"slide",!0):I(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(vt).forEach(e=>{wt(e)})});const yt='section[data-component="featured-content"]',Te="su-hidden",bt='button[data-click="open-modal"]',Lt='button[data-dismiss="modal"]',Ve='iframe[data-modal="iframe"]';function xt(e){const t=e.querySelector(Ve),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Te),e.hidden=!1,document.body.style.overflow="hidden"}function J(e){const t=e.querySelector(Ve),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Te),e.hidden=!0,document.body.style.overflow=""}function Et(e){const t=e.querySelectorAll(bt),n=e.querySelectorAll(Lt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||J(s)}),s.dataset.listenerAdded="true"),xt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&J(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&J(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(yt).forEach(e=>{Et(e)})});const At='section[data-component="image-gallery-modal"]',St='button[data-click="open-gallery-modal"]',Mt='div[data-modal="modal"]',_t='button[data-dismiss="modal"]',He="su-hidden";let pe;const It=(e,t)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function kt(e){e.classList.remove(He),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&It(t,e)})}function ee(e){e.classList.add(He),e.hidden=!0,document.body.style.overflow=""}function $t(e){const t=e.dataset.modalId;pe=new P(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function Tt(e){const t=e.querySelector(Mt),n=e.querySelector(St),s=e.querySelector(_t);n&&n.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",i=>{r.contains(i.target)||ee(t)}),t.dataset.listenerAdded="true"),kt(t),$t(t)}),s&&s.addEventListener("click",function(){ee(t),pe.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(ee(t),pe.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(At).forEach(e=>{Tt(e)})});const Vt='[data-component="interactive-photo-card"]',Ht="[data-card-inner]",Ot="[data-card-inner-content]";function Nt(e){var s;const n=((e.style.transform&&parseInt((s=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:s[1])||0)+180)%360;e.style.transform=`rotateY(${n}deg)`}function qt(e){const t=e.querySelector(Ht);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>Nt(t))}const Bt=e=>{e.forEach(t=>{const n=t.getAttribute("aria-hidden")==="true"?"false":"true",s=t.querySelector("button");s&&(s.tabIndex=n==="true"?"-1":""),t.setAttribute("aria-hidden",n)})},Zt=e=>{const t=e.querySelectorAll(Ot);t.length&&t.forEach(n=>n.addEventListener("click",()=>Bt(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Vt).forEach(e=>{qt(e),Zt(e)})});class Rt{constructor(t,n){this.url=t,this.type=n,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const s=this.assetIds.map(async r=>{const i=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(i,this.requestProps).catch(u=>{throw new Error(u)})).json()});return Promise.all(s)}return await(await fetch(this.url,this.requestProps).catch(s=>{throw new Error(s)})).json()}}function Pt({title:e,listMetadata:{assetTypeCode:t,teaserPlain:n,summary:s,image:r,taxonomyContentTypeText:i,contentTopic:a,contentSubtopic:o,taxonomyContentMainTopicText:u,contentCategory:f,featuredVideo:p,taxonomyContentMainTopicLandingPageUrl:d,taxonomyFeaturedUnitLandingPageUrl:c,taxonomyFeaturedUnitText:C,imageAlt:l,authorName:y,authorImage:m,author:v,isTeaser:h,storySource:g,assetHref:x},date:T,liveUrl:V}){const H=y!==void 0?y:v,E=m!==""?m:void 0,A=r;l=r&&l?l:"",!l&&!A&&(l="a close up image of an intricate stone arch");const b=p,k=n||s;let O=u;!O&&a&&(O=a instanceof Array?a[0]:a),!O&&o&&(O=o instanceof Array?o[0]:o);const D=d;let Z=i?i[0]:"";return!Z&&f&&(Z=f instanceof Array?f[0]:f),x&&t[0]==="link"&&(V=x),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(k)?k[0]:k,liveUrl:Array.isArray(V)?V[0]:V,imageUrl:Array.isArray(A)?A[0]:A,imageAlt:Array.isArray(l)?l[0]:l,taxonomy:Array.isArray(O)?O[0]:O,taxonomyUrl:Array.isArray(D)?D[0]:D,type:Array.isArray(Z)?Z[0]:Z,videoUrl:Array.isArray(b)?b[0]:b,date:Array.isArray(T)?T[0]:T,authorDisplayName:Array.isArray(H)?H[0]:H,authorAvatar:Array.isArray(E)?E[0]:E,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(c)?c[0]:c,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(h)?h[0]:h,storySource:Array.isArray(g)?g[0]:g}}function te(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}const Oe=typeof window>"u"?{}:window;function Dt(e=Oe){return e.document!==void 0}function Gt(e,t=Oe){if(!Dt(t))return null;const{document:n}=t,{cookie:s}=n;if(typeof s!="string")return null;const r=s.split("; ");let i=null;return r.find(a=>{const[o,u]=a.split("=");return o===e&&u!==""&&(i=u),null}),i}function Ne(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}function Ut(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}const Ft=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(t+s)%16|0,t=Math.floor(t/16)),(n==="x"?s:s&3|8).toString(16)})},zt=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),Wt=()=>typeof crypto<"u"?zt():Ft();async function jt(e=null,t="",n=null){var r,i,a,o,u,f,p,d,c,C,l,y,m,v,h,g,x,T,V;const s=new Rt;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const H=`
  ...
  `}const u1='section[data-component="single-image-video"]',d1='iframe[data-role="video-player"]',c1='button[data-role="video-control"]',Ze="su-hidden",f1='button[data-click="open-modal"]',p1='button[data-dismiss="modal"]',Re='iframe[data-modal="iframe"]',C1=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function g1(e){const t=e.querySelector(Re),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ze),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&C1(r,e)})}function re(e){const t=e.querySelector(Re),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ze),e.hidden=!0,document.body.style.overflow=""}function h1(e){const t=e.querySelectorAll(f1),n=e.querySelectorAll(p1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||re(s)}),s.dataset.listenerAdded="true"),g1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&re(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&re(s)})}function m1(e){const t=e.querySelector(d1),n=e.querySelector(c1);let s=!1;if(!t||!n)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!s?(G(t,"play"),U(n,!1)):a.isIntersecting||(G(t,"pause"),U(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(G(t,"pause"),U(n,!0),s=!0):(G(t,"play"),U(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(u1).forEach(e=>{h1(e),m1(e)})});const v1='section[data-component="stories-carousel"]',Pe="su-hidden",w1='button[data-click="open-modal"]',y1='button[data-dismiss="modal"]',De='iframe[data-modal="iframe"]';function b1(e){const t=e.querySelector(De),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Pe),e.hidden=!1,document.body.style.overflow="hidden"}function ae(e){const t=e.querySelector(De),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Pe),e.hidden=!0,document.body.style.overflow=""}function L1(e){const t=e.querySelectorAll(w1),n=e.querySelectorAll(y1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ae(s)}),s.dataset.listenerAdded="true"),b1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ae(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ae(s)})}function x1(e){const t=e.dataset.uniqueId;new P(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(v1).forEach(e=>{x1(e),L1(e)})});const E1='section[data-component="subtopic-subnav-component"]',A1='div[data-list="subnav"]';function S1(e){return e.filter((t,n)=>n===e.findIndex(s=>{var r,i;return((r=s.taxonomyFeaturedUnitText)==null?void 0:r[0])===((i=t.taxonomyFeaturedUnitText)==null?void 0:i[0])}))}const M1=async e=>{if(!e||e.length===0)return null;const t=S1(e),n=[];return t.forEach(s=>{var i,a,o;const r=s;r&&((i=r.taxonomyFeaturedUnitText)!=null&&i[0])&&n.push({asset_name:(a=r.taxonomyFeaturedUnitText)==null?void 0:a[0],asset_url:((o=r.taxonomyFeaturedUnitLandingPageUrl)==null?void 0:o[0])||""})}),n};function _1({navigation:e}){let t="scrollable-list__item su-mb-0 su-relative after:su-h-22 after:su-w-[1px] after:su-bg-black-60 after:su-mx-12 lg:after:su-mx-18";const n="su-text-inherit su-text-black su-font-semi-bold su-text-16 lg:su-text-18 lg:su-leading-[21.6px] su-no-underline hover:su-underline dark:su-text-white hover:su-text-digital-red dark:hover:su-text-dark-mode-red";return`
    ...
    `}function I1(e){const t=e.querySelector(A1);t&&document.addEventListener("topicLoader",async n=>{if(n.detail){const s=await M1(n.detail.cards);t.innerHTML=_1({navigation:s})}},!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(E1).forEach(e=>{I1(e)})});function k1({offsetNum:e,pageNumber:t,index:n}){return`
        <button
            data-offset="${e}"
    ...
    `}function $1({pageNumber:e,allResults:t,resultsPerPage:n,paginationRange:s,currentPage:r=1}){const i=Math.ceil(t/n),a=s,o=e-n,u=e+n,f="su-text-black-50",p=[],d=[];for(let h=0;h<i;h++){const g=h*n+1;d.push(g)}let c=[...d],C=[...d];const l=d.indexOf(r),y=Math.floor(a*.5);if((l<y||i===a)&&(c=c.filter((h,g)=>h>r&&g<a),C=C.filter(h=>h<r)),l>=y&&i!==a)if(c=c.filter((h,g)=>h>r&&g<=l+y),c.length===y)C=C.filter((h,g)=>h<r&&g>=l-y);else{const h=c.length?a-c.length:a;C=C.filter((g,x)=>g<r&&x>l-h)}return[...C,r,...c].map(h=>({offset:h,index:d.indexOf(h)+1})).forEach(({offset:h,index:g})=>{p.push(k1({offsetNum:h,pageNumber:e,index:g}))}),i>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function T1(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ce={exports:{}},w={},ge={exports:{}},q={};function Ge(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function V1(e,t,n){}function H1(e,t,n){}var O1=/javascript\s*\:/img;function N1(e,t){return O1.test(t)?"":t}q.whiteList=Ge();q.getDefaultWhiteList=Ge;q.onAttr=V1;q.onIgnoreAttr=H1;q.safeAttrValue=N1;var q1={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},R=q1;function B1(e,t){e=R.trimRight(e),e[e.length-1]!==";"&&(e+=";");var n=e.length,s=!1,r=0,i=0,a="";function o(){if(!s){var p=R.trim(e.slice(r,i)),d=p.indexOf(":");if(d!==-1){var c=R.trim(p.slice(0,d)),C=R.trim(p.slice(d+1));if(c){var l=t(r,a.length,c,C,p);l&&(a+=l+"; ")}}}r=i+1}for(;i<n;i++){var u=e[i];if(u==="/"&&e[i+1]==="*"){var f=e.indexOf("*/",i+2);if(f===-1)break;i=f+1,r=i+1,s=!1}else u==="("?s=!0:u===")"?s=!1:u===";"?s||o():u===`
`&&o()}return R.trim(a)}var Z1=B1,F=q,R1=Z1;function we(e){return e==null}function P1(e){var t={};for(var n in e)t[n]=e[n];return t}function Ue(e){e=P1(e||{}),e.whiteList=e.whiteList||F.whiteList,e.onAttr=e.onAttr||F.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||F.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||F.safeAttrValue,this.options=e}Ue.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onAttr,i=n.onIgnoreAttr,a=n.safeAttrValue,o=R1(e,function(u,f,p,d,c){var C=s[p],l=!1;if(C===!0?l=C:typeof C=="function"?l=C(d):C instanceof RegExp&&(l=C.test(d)),l!==!0&&(l=!1),d=a(p,d),!!d){var y={position:f,sourcePosition:u,source:c,isWhite:l};if(l){var m=r(p,d,y);return we(m)?p+":"+d:m}else{var m=i(p,d,y);if(!we(m))return m}}});return o};var D1=Ue;(function(e,t){var n=q,s=D1;function r(a,o){var u=new s(o);return u.process(a)}t=e.exports=r,t.FilterCSS=s;for(var i in n)t[i]=n[i];typeof window<"u"&&(window.filterCSS=e.exports)})(ge,ge.exports);var me=ge.exports,ve={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,n=t.exec(e);return n?n.index:-1}},G1=me.FilterCSS,U1=me.getDefaultWhiteList,Q=ve;function Fe(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var ze=new G1;function F1(e,t,n){}function z1(e,t,n){}function W1(e,t,n){}function j1(e,t,n){}function We(e){return e.replace(Q1,"&lt;").replace(Y1,"&gt;")}function X1(e,t,n,s){if(n=Je(n),t==="href"||t==="src"){if(n=Q.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(t==="background"){if(z.lastIndex=0,z.test(n))return""}else if(t==="style"){if(ye.lastIndex=0,ye.test(n)||(be.lastIndex=0,be.test(n)&&(z.lastIndex=0,z.test(n))))return"";s!==!1&&(s=s||ze,n=s.process(n))}return n=et(n),n}var Q1=/</g,Y1=/>/g,K1=/"/g,J1=/&quot;/g,es=/&#([a-zA-Z0-9]*);?/gim,ts=/&colon;?/gim,ss=/&newline;?/gim,z=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,ye=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,be=/u\s*r\s*l\s*\(.*/gi;function je(e){return e.replace(K1,"&quot;")}function Xe(e){return e.replace(J1,'"')}function Qe(e){return e.replace(es,function(n,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function Ye(e){return e.replace(ts,":").replace(ss," ")}function Ke(e){for(var t="",n=0,s=e.length;n<s;n++)t+=e.charCodeAt(n)<32?" ":e.charAt(n);return Q.trim(t)}function Je(e){return e=Xe(e),e=Qe(e),e=Ye(e),e=Ke(e),e}function et(e){return e=je(e),e=We(e),e}function ns(){return""}function rs(e,t){typeof t!="function"&&(t=function(){});var n=!Array.isArray(e);function s(a){return n?!0:Q.indexOf(e,a)!==-1}var r=[],i=!1;return{onIgnoreTag:function(a,o,u){if(s(a))if(u.isClosing){var f="[/removed]",p=u.position+f.length;return r.push([i!==!1?i:u.position,p]),i=!1,f}else return i||(i=u.position),"[removed]";else return t(a,o,u)},remove:function(a){var o="",u=0;return Q.forEach(r,function(f){o+=a.slice(u,f[0]),u=f[1]}),o+=a.slice(u),o}}}function as(e){for(var t="",n=0;n<e.length;){var s=e.indexOf("<!--",n);if(s===-1){t+=e.slice(n);break}t+=e.slice(n,s);var r=e.indexOf("-->",s);if(r===-1)break;n=r+3}return t}function is(e){var t=e.split("");return t=t.filter(function(n){var s=n.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),t.join("")}w.whiteList=Fe();w.getDefaultWhiteList=Fe;w.onTag=F1;w.onIgnoreTag=z1;w.onTagAttr=W1;w.onIgnoreTagAttr=j1;w.safeAttrValue=X1;w.escapeHtml=We;w.escapeQuote=je;w.unescapeQuote=Xe;w.escapeHtmlEntities=Qe;w.escapeDangerHtml5Entities=Ye;w.clearNonPrintableCharacter=Ke;w.friendlyAttrValue=Je;w.escapeAttrValue=et;w.onIgnoreTagStripAll=ns;w.StripTagBody=rs;w.stripCommentTag=as;w.stripBlankChar=is;w.attributeWrapSign='"';w.cssFilter=ze;w.getDefaultCSSWhiteList=U1;var Y={},N=ve;function os(e){var t=N.spaceIndex(e),n;return t===-1?n=e.slice(1,-1):n=e.slice(1,t+1),n=N.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function ls(e){return e.slice(0,2)==="</"}function us(e,t,n){var s="",r=0,i=!1,a=!1,o=0,u=e.length,f="",p="";e:for(o=0;o<u;o++){var d=e.charAt(o);if(i===!1){if(d==="<"){i=o;continue}}else if(a===!1){if(d==="<"){s+=n(e.slice(r,o)),i=o,r=o;continue}if(d===">"||o===u-1){s+=n(e.slice(r,i)),p=e.slice(i,o+1),f=os(p),s+=t(i,s.length,f,p,ls(p)),r=o+1,i=!1;continue}if(d==='"'||d==="'")for(var c=1,C=e.charAt(o-c);C.trim()===""||C==="=";){if(C==="="){a=d;continue e}C=e.charAt(o-++c)}}else if(d===a){a=!1;continue}}return r<u&&(s+=n(e.substr(r))),s}var ds=/[^a-zA-Z0-9\\_:.-]/gim;function cs(e,t){var n=0,s=0,r=[],i=!1,a=e.length;function o(c,C){if(c=N.trim(c),c=c.replace(ds,"").toLowerCase(),!(c.length<1)){var l=t(c,C||"");l&&r.push(l)}}for(var u=0;u<a;u++){var f=e.charAt(u),p,d;if(i===!1&&f==="="){i=e.slice(n,u),n=u+1,s=e.charAt(n)==='"'||e.charAt(n)==="'"?n:ps(e,u+1);continue}if(i!==!1&&u===s){if(d=e.indexOf(f,u+1),d===-1)break;p=N.trim(e.slice(s+1,d)),o(i,p),i=!1,u=d,n=u+1;continue}if(/\s|\n|\t/.test(f))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(d=fs(e,u),d===-1){p=N.trim(e.slice(n,u)),o(p),i=!1,n=u+1;continue}else{u=d-1;continue}else if(d=Cs(e,u-1),d===-1){p=N.trim(e.slice(n,u)),p=Le(p),o(i,p),i=!1,n=u+1;continue}else continue}return n<e.length&&(i===!1?o(e.slice(n)):o(i,Le(N.trim(e.slice(n))))),N.trim(r.join(" "))}function fs(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="="?t:-1}}function ps(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="'"||n==='"'?t:-1}}function Cs(e,t){for(;t>0;t--){var n=e[t];if(n!==" ")return n==="="?t:-1}}function gs(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function Le(e){return gs(e)?e.substr(1,e.length-2):e}Y.parseTag=us;Y.parseAttr=cs;var hs=me.FilterCSS,_=w,tt=Y,ms=tt.parseTag,vs=tt.parseAttr,X=ve;function W(e){return e==null}function ws(e){var t=X.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=X.trim(e.slice(t+1,-1));var n=e[e.length-1]==="/";return n&&(e=X.trim(e.slice(0,-1))),{html:e,closing:n}}function ys(e){var t={};for(var n in e)t[n]=e[n];return t}function bs(e){var t={};for(var n in e)Array.isArray(e[n])?t[n.toLowerCase()]=e[n].map(function(s){return s.toLowerCase()}):t[n.toLowerCase()]=e[n];return t}function st(e){e=ys(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=_.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=bs(e.whiteList||e.allowList):e.whiteList=_.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":_.attributeWrapSign,e.onTag=e.onTag||_.onTag,e.onTagAttr=e.onTagAttr||_.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||_.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||_.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||_.safeAttrValue,e.escapeHtml=e.escapeHtml||_.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new hs(e.css))}st.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onTag,i=n.onIgnoreTag,a=n.onTagAttr,o=n.onIgnoreTagAttr,u=n.safeAttrValue,f=n.escapeHtml,p=t.attributeWrapSign,d=t.cssFilter;n.stripBlankChar&&(e=_.stripBlankChar(e)),n.allowCommentTag||(e=_.stripCommentTag(e));var c=!1;n.stripIgnoreTagBody&&(c=_.StripTagBody(n.stripIgnoreTagBody,i),i=c.onIgnoreTag);var C=ms(e,function(l,y,m,v,h){var g={sourcePosition:l,position:y,isClosing:h,isWhite:Object.prototype.hasOwnProperty.call(s,m)},x=r(m,v,g);if(!W(x))return x;if(g.isWhite){if(g.isClosing)return"</"+m+">";var T=ws(v),V=s[m],H=vs(T.html,function(E,A){var b=X.indexOf(V,E)!==-1,k=a(m,E,A,b);return W(k)?b?(A=u(m,E,A,d),A?E+"="+p+A+p:E):(k=o(m,E,A,b),W(k)?void 0:k):k});return v="<"+m,H&&(v+=" "+H),T.closing&&(v+=" /"),v+=">",v}else return x=i(m,v,g),W(x)?f(v):x},f);return c&&(C=c.remove(C)),C};var Ls=st;(function(e,t){var n=w,s=Y,r=Ls;function i(o,u){var f=new r(u);return f.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=r,function(){for(var o in n)t[o]=n[o];for(var u in s)t[u]=s[u]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(Ce,Ce.exports);var xs=Ce.exports;const $=T1(xs);var Es=Array.isArray,nt=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var n=void 0;if(Es(e))for(var s=0,r=e.length;s<r;)n=nt(e[s++]),n&&(t&&(t+=" "),t+=n);else for(n in e)n&&e[n]&&(t&&(t+=" "),t+=n)}return t};function rt(){for(var e=arguments.length,t=0,n,s,r="";t<e;)n=arguments[t++],n&&(s=nt(n),s&&(r&&(r+=" "),r+=s));return r}function xe({children:e="",imageUrl:t,imageAlt:n="",aspectRatio:s="card-small",videoUrl:r}){return`
    <span
  ...
  `}const As={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function Ee({imageUrl:e,alt:t="",aspectRatio:n,videoUrl:s,size:r="small",title:i="",videoIconClasses:a,uniqueId:o}){if(s){const u=`
        ...
        ${s?`
          <span
            class="${rt("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",As[r],a)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${xe({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:n,children:u})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${xe({imageUrl:e,imageAlt:t,aspectRatio:n})}
    </div>
  `}function Ss(e,t){if(!t)return!0;const n=e.match(/(\d+-\d+-\d+)/)[0],s=t.match(/(\d+-\d+-\d+)/)[0];return n===s}function Ms({start:e,end:t}){if(!e&&!t)return null;const n=new Date(e),s=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const a=Ss(e,t);a||(delete r.time,delete r.hour,delete r.minute);const o=new Intl.DateTimeFormat("en-US",r).format(n),u=t?new Intl.DateTimeFormat("en-US",r).format(s):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${u}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function _s(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const ks="light";function oe({variant:e=ks}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function Ts({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    </svg>`}const Me="solid";function Zs({variant:e=Me}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
    ...
    </svg>`}const Rs="light";function _e({variant:e=Rs}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const S={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},js={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function Xs({data:{title:e,description:t,liveUrl:n,imageUrl:s,imageAlt:r,taxonomy:i,taxonomyUrl:a,type:o,date:u,endDate:f,videoUrl:p,uniqueID:d},cardSize:c="small"}){const C=js[c],l=new Map;return l.set("alert",_s()),l.set("analysis & insights",ie()),l.set("analysis &amp; insights",ie()),l.set("analysis&nbsp;&amp;&nbsp;insights",ie()),l.set("case study",oe({variant:"light"})),l.set("case&nbsp;study",oe({variant:"light"})),l.set("casestudy",oe({variant:"light"})),l.set("event",Vs()),l.set("event&nbsp;highlights",Ae()),l.set("event highlights",Ae()),l.set("feature",Hs()),l.set("infographic",Os()),l.set("in&nbsp;the&nbsp;news",le()),l.set("in the news",le()),l.set("inthenews",le()),l.set("leadership&nbsp;messages",Se()),l.set("leadership messages",Se()),l.set("obituary",Ns()),l.set("opinion",qs()),l.set("photo",Bs()),l.set("policy&nbsp;brief",_e({variant:"light"})),l.set("policy brief",_e({variant:"light"})),l.set("poll/quiz",ue()),l.set("poll / quiz",ue()),l.set("poll&nbsp;/&nbsp;quiz",ue()),l.set("profile",Ps()),l.set("research",Ds()),l.set("solutions",Gs()),l.set("survey",Us()),l.set("timeline",Fs()),l.set("tips & takeaways",de()),l.set("tips &amp; takeaways",de()),l.set("tips&nbsp;&amp;&nbsp;takeaways",de()),l.set("university&nbsp;updates",Ie()),l.set("university updates",Ie()),l.set("announcement",Is()),l.set("news",$s()),l.set("q&amp;a",j()),l.set("q&a",j()),l.set("q & a",j()),l.set("q&nbsp;&amp;&nbsp;a",j()),l.set("video",zs()),l.set("podcast",Zs({variant:"light"})),l.set("book",Ts({className:""})),`
    <article aria-label="${e}" class="${S.root} ${C.gap}" data-testid="horizontal-card" >
      
    ${c==="large"?`
        <div class="${S.imageWrapper} ${C.imageWrapper}">
          ${s?`
            ${Ee({imageUrl:s,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"card-large",size:c,uniqueId:d})}
          `:""}
        </div>
      `:""}
      ...
      ${c==="small"&&s?`
        <div class="${S.imageWrapper} ${C.imageWrapper} su-relative">
            ${Ee({imageUrl:s,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"large",size:c,uniqueId:d})}
        </div>
      `:""}
      ...
      <div class="${M.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${M.authorWrapper} ${l}">
            ${C?`
              ${Qs({image:C,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function Ks(e){const{videoId:t,className:n="",noAutoPlay:s,title:r,isVertical:i}=e;return`
        <iframe
            width="${i?315:560}"
            height="${i?560:315}"
            class="${n}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const Js='section[data-component="topic-subtopic-listing"]',e5='[data-element="topics-list"]',at='[data-element="topics-pagination"]',it="su-hidden",t5='section[data-element="modal-wrapper"]',s5='button[data-click="open-modal"]',n5='button[data-dismiss="modal"]',ot='iframe[data-modal="iframe"]';function r5(e){const t=e.querySelector(ot),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(it),e.hidden=!1,document.body.style.overflow="hidden"}function ce(e){const t=e.querySelector(ot),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(it),e.hidden=!0,document.body.style.overflow="hidden"}function lt(e){const t=e.querySelectorAll(s5),n=e.querySelectorAll(n5);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ce(s)}),s.dataset.listenerAdded="true"),r5(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ce(s)})}async function a5(e){const{offset:t,query:n,endpoint:s}=e,r=s+n+`&start_rank=${t}`;return await(await fetch(r).catch(o=>{throw new Error(o)})).json()}function i5(e,t,n,s){e.querySelector(e5).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(at).innerHTML=n,e.querySelector(t5).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),lt(e),ut(e)}async function o5(e){var c,C,l,y,m;const{offset:t,query:n,endpoint:s,display:r,section:i}=e,a=await a5({offset:t,query:n,endpoint:s}),o=(C=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:C.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const u=[],f=[];(m=(y=(l=a==null?void 0:a.response)==null?void 0:l.resultPacket)==null?void 0:y.results)==null||m.forEach(v=>{const h=Wt(),g=Pt(v);g.uniqueID=h,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(g.displayConfiguration=r,u.push(`<div class="su-relative su-grow">${Ys({data:g,cardType:"narrowhorizontal"})}</div>`)):u.push(`<div class="su-relative su-grow">${Xs({data:g,cardType:"horizontal",cardSize:"large"})}</div>`),(g.type==="Video"||g.videoUrl)&&f.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const p=$1({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),d=f.map(v=>`
        ...
        ${Ks({videoId:v.videoId,title:v.title,noAutoPlay:v.noAutoPlay,isVertical:v.isVertical})}
        ...
        `).join("");i5(i,u.join(""),p,d)}function ut(e){const{query:t,endpoint:n,display:s}=e.dataset,r=e.querySelector(at);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const o=a.getAttribute("data-offset");o5({offset:o,query:t,endpoint:n,display:s,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Js).forEach(e=>{lt(e),ut(e)})});const l5='section[data-component="vertical-video-panel"]',dt="su-hidden",u5='button[data-click="open-modal"]',d5='button[data-dismiss="modal"]',ct='iframe[data-modal="iframe"]';function c5(e){const t=e.querySelector(ct),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(dt),e.hidden=!1,document.body.style.overflow="hidden"}function fe(e){const t=e.querySelector(ct),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(dt),e.hidden=!0,document.body.style.overflow=""}function f5(e){const t=e.querySelectorAll(u5),n=e.querySelectorAll(d5);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||fe(s)}),s.dataset.listenerAdded="true"),c5(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&fe(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&fe(s)})}function p5(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new P(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{B(a),I(a,"",!1)},resize:a=>{B(a)},paginationUpdate:a=>{he(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?I(i,"h2 a, h3 a, button",!0):I(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(l5).forEach(e=>{p5(e),f5(e)})});
