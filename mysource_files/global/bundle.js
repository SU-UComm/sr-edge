import D from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const je=typeof window>"u"?{}:window;function Pt(e=je){return e.document!==void 0}function U(e,t=je){if(!Pt(t))return null;const{document:n}=t,{cookie:s}=n;if(typeof s!="string")return null;const r=s.split("; ");let o=null;return r.find(a=>{const[i,l]=a.split("=");return i===e&&l!==""&&(o=l),null}),o}const Oe="su-hidden";function Ve(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')};Object.values(t).forEach(n=>{n==null||n.forEach(s=>{s.classList.add(Oe)})}),t[e]&&t[e].forEach(n=>{n.classList.remove(Oe)})}document.addEventListener("DOMContentLoaded",function(){const e=U("preferences_personalisation");Ve(e==="null"||!e?"external":e)});const Ye=typeof window>"u"?{}:window;function Zt(e=Ye){return e.document!==void 0}function xe(e,t="",n=!0,s="",r="/",o=Ye){if(!Zt(o))return;const{document:a}=o,{location:{hostname:i}}=a;let l="";if(s){const d=new Date;d.setTime(d.getTime()+s*24*60*60*1e3),l=`; expires=${d.toUTCString()}`}n===!0?a.cookie=`${e}=${t}${l}; path=${r}; domain=${i}; secure=${n};`:a.cookie=`${e}=${t}${l}; path=${r}; domain=${i};`}async function Gt(e,t){return await(await fetch("/__dxp/events/custom",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source:"custom",action:e,event:{type:t}}),redirect:"follow"}).catch(r=>{throw new Error(r)})).text()}async function J(e){return await(await fetch("/__dxp/cdp/setConsent",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({CDPConsent:e,documentVersion:"1.0"}),redirect:"follow"}).catch(s=>{throw new Error(s)})).text()}function Ut(){const e='[id="light-theme"]',t='[id="dark-theme"]',n='[data-role="su-darkmode-icon-active"]',s='[data-role="su-darkmode-icon-nonactive"]',r=document.querySelector(e),o=document.querySelector(t),a=document.querySelector(n),i=document.querySelector(s),l=document.querySelector("html");if(r&&o){const d=U("preferences_theme");d==="dark"||["",null,void 0,!1].includes(d)&&window.matchMedia("(prefers-color-scheme: dark)").matches?(l.classList.add("su-dark"),a.classList.remove("su-hidden"),i.classList.add("su-hidden"),o.checked=!0,r.checked=!1):(a.classList.add("su-hidden"),i.classList.remove("su-hidden"),l.classList.add("su-light"),r.checked=!0,o.checked=!1),r.addEventListener("keyup",({key:p})=>{[" ","Enter"].includes(p)&&document.querySelector('[data-theme="dark-theme"]').click()}),o.addEventListener("keyup",({key:p})=>{[" ","Enter"].includes(p)&&document.querySelector('[data-theme="light-theme"]').click()}),r.addEventListener("click",()=>{l.classList.remove("su-dark"),l.classList.add("su-light"),a.classList.add("su-hidden"),i.classList.remove("su-hidden"),xe("preferences_theme","light",!0,130)}),o.addEventListener("click",()=>{l.classList.remove("su-light"),l.classList.add("su-dark"),a.classList.remove("su-hidden"),i.classList.add("su-hidden"),xe("preferences_theme","dark",!0,130)}),document.personaChangeEvent=new Event("personaChange")}}class Ft{constructor(t){this.parent=t,this.menuToggle=this.parent.querySelector('[aria-controls="menu"]'),this.searchToggle=this.parent.querySelector('[aria-controls="search"]'),this.preferencesToggle=this.parent.querySelector('[aria-controls="preferences"]'),this.menuCloseToggle=this.parent.querySelectorAll(".report-header__menu-close,.report-header__menu-tray .report-header__overlay"),this.searchCloseToggle=this.parent.querySelectorAll(".report-header__search-close,.report-header__search-tray .report-header__overlay"),this.preferencesCloseToggle=this.parent.querySelectorAll(".report-header__preferences-close,.report-header__preferences-tray .report-header__overlay"),this.handleHeaderScroll(),this.handleHeaderToggles(),this.handleSearchInputs();const n=document.querySelector('[data-role="header-main-nav"]');n&&(n.classList.remove("su-opacity-0"),n.classList.add("su-opacity-1"))}focus(t){if(t.match(/:/g)){const[n,s,r]=t.split(":");document.querySelector(`[data-location="${t}"]`).querySelectorAll(s)[Number(r)].focus();return}document.querySelector(`[data-location="${t}"]`).focus()}handleTab(t){t.addEventListener("keyup",n=>{const{target:s,key:r}=n;if(r!=="Tab")return;const o=s.dataset.tpTo?s.dataset.tpTo:null;o&&this.focus(o)})}handleSearchInputs(){const t=document.querySelectorAll('[data-role="search-query"]'),n=document.querySelectorAll('[data-role="clear-search"]');t.length&&t.forEach((s,r)=>{s.addEventListener("keyup",()=>{s.value!==""?(s.parentNode.classList.add("input-has-value"),n[r].classList.remove("su-hidden")):(s.parentNode.classList.remove("input-has-value"),n[r].classList.add("su-hidden"))})}),n.length&&n.forEach(s=>{s.addEventListener("click",r=>{s.parentNode.parentNode.querySelector(".input-has-value").classList.remove("input-has-value"),s.classList.add("su-hidden")})})}handleHeaderToggles(){this.handleTab(document.querySelector(".report-header__main")),this.menuToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#menu");this.menuToggle.getAttribute("aria-expanded")==="true"?(this.menuToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--primary-nav-open"),n.setAttribute("aria-hidden","true"),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{n.classList.remove("su-hidden"),n.classList.add("su-block")},300)):(n.classList.remove("su-hidden"),window.innerWidth<768&&(document.body.style.cssText+="overflow: hidden;"),setTimeout(()=>{this.menuCloseToggle[1].focus(),this.menuToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--primary-nav-open"),n.setAttribute("aria-hidden","false")},0))}),this.menuCloseToggle.forEach(n=>{n.addEventListener("click",()=>{const s=this.parent.querySelector("#menu");this.menuToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--primary-nav-open"),s.setAttribute("aria-hidden","true"),this.menuToggle.focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden")},300)})});const t=document.querySelector('[data-role="search-focus-trap"]');this.searchToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#search");this.searchToggle.getAttribute("aria-expanded")==="true"?(this.searchToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--search-open"),n.setAttribute("aria-hidden","true"),setTimeout(()=>{n.classList.add("su-hidden"),n.classList.remove("su-block"),t.classList.add("su-hidden"),t.classList.remove("su-block")},300)):(n.classList.remove("su-hidden"),t.classList.remove("su-hidden"),setTimeout(()=>{this.searchToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--search-open"),n.setAttribute("aria-hidden","false")},0))}),this.searchCloseToggle.forEach(n=>{const s=this.parent.querySelector("#search");n.addEventListener("click",()=>{const r=this.parent.querySelector("#search");this.searchToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--search-open"),r.setAttribute("aria-hidden","true"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden"),t.classList.remove("su-block"),t.classList.add("su-hidden")},300)})}),this.preferencesToggle.addEventListener("click",()=>{const n=this.parent.querySelector("#preferences");this.preferencesToggle.getAttribute("aria-expanded")==="true"?(this.preferencesToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--preferences-open"),n.setAttribute("aria-hidden","true"),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{n.classList.remove("su-hidden"),n.classList.add("su-block")},300)):(n.classList.remove("su-hidden"),this.preferencesCloseToggle[1].focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: hidden;"),setTimeout(()=>{this.preferencesToggle.setAttribute("aria-expanded","true"),this.parent.classList.add("report-header--preferences-open"),n.setAttribute("aria-hidden","false")},0))}),this.preferencesCloseToggle.forEach(n=>{n.addEventListener("click",()=>{const s=this.parent.querySelector("#preferences");this.preferencesToggle.setAttribute("aria-expanded","false"),this.parent.classList.remove("report-header--preferences-open"),s.setAttribute("aria-hidden","true"),this.preferencesToggle.focus(),window.innerWidth<768&&(document.body.style.cssText+="overflow: auto;"),setTimeout(()=>{s.classList.remove("su-block"),s.classList.add("su-hidden")},300)})})}handleHeaderScroll(){window.addEventListener("scroll",t=>{const n=this.parent;if(window.scrollY>32){n.classList.add("report-header--collapsed");return}n.classList.remove("report-header--collapsed")})}}class Xe{constructor(t,n){this.url=t,this.type=n,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const s=this.assetIds.map(async r=>{const o=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(o,this.requestProps).catch(l=>{throw new Error(l)})).json()});return Promise.all(s)}return await(await fetch(this.url,this.requestProps).catch(s=>{throw new Error(s)})).json()}}function Qe(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}async function zt(e=null,t=""){var s,r,o,a,i,l,d,p;const n=new Xe;if(e&&e.search){let u="",f="";u=`${(s=e.search.endpoint)==null?void 0:s.replace("search.html","search.json")}?profile=${e.search.profile}&collection=${e.search.collection}&query=[taxonomyContentMainTopicId:${e.mainTopicId} taxonomyContentTopicsId:${e.mainTopicId} taxonomyContentSubtopicsId:${e.mainTopicId}]&meta_taxonomyAudienceText=${Qe(t)}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&sort=date&num_ranks=1&log=false`,f=`${(r=e.search.endpoint)==null?void 0:r.replace("search.html","search.json")}?profile=${e.search.profile}&collection=${e.search.collection}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&sort=date&num_ranks=1&log=false`,e.contentType==="Video"&&(f+="&meta_taxonomyContentTypeId=28207",u+="&meta_taxonomyContentTypeId=28207"),n.url=u;let h=await n.fetch(),c=((i=(a=(o=h.response)==null?void 0:o.resultPacket)==null?void 0:a.results)==null?void 0:i[0])||null;return c||(n.url=f,h=await n.fetch(),c=((p=(d=(l=h.response)==null?void 0:l.resultPacket)==null?void 0:d.results)==null?void 0:p[0])||null),c}return null}function Wt(e,t,n,s="su-hidden"){if(e&&t&&n){const r=n.querySelector('h2[data-story="announcement"]'),o=n.querySelector('h1[data-story="title"]'),a=n.querySelector('a[data-story="link"]');t!=null&&t.contentType&&r&&(r.textContent=t.contentType==="Video"?"Watch next:":"Read next:"),t!=null&&t.title&&o&&(o.textContent=t.title),e!=null&&e.displayUrl&&(e!=null&&e.title)&&a&&(a.textContent=e.title,a.href=e.displayUrl),(t!=null&&t.title||e!=null&&e.displayUrl)&&n.classList.remove(s)}}const jt='header[data-component="header-component"]',Yt='section[data-subcomponent="header-cookie-consent-banner"]',ee="su-hidden";let G=!1;function te(){const e=document.querySelector(Yt);e&&e.classList.add(ee)}function _e(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')},n={student:document.querySelector('button[data-click="student-persona"]'),faculty:document.querySelector('button[data-click="faculty-persona"]')};Object.values(t).forEach(s=>{s==null||s.forEach(r=>{r.classList.add(ee)})}),Object.values(n).forEach(s=>{s.setAttribute("aria-pressed","false")}),t[e]&&t[e].forEach(s=>{s.classList.remove(ee)}),n[e]&&n[e].setAttribute("aria-pressed","true")}const ie=async(e,t,n=!1)=>{let s=null;!G&&n===!1&&(await J(1),G=!0,te()),e&&(t===e?s="external":s=e),await Gt("persona-selector",s),n===!0&&(await J(0),G=!1),xe("preferences_personalisation",s,!0,130),t=s,_e(t),document.dispatchEvent(document.personaChangeEvent),window.location.reload()},He=async e=>{e===!0?(await J(1),G=!0,te()):(await J(0),G=!1,te())};document.addEventListener("DOMContentLoaded",function(){var h,c;const e=document.querySelector('button[data-click="student-persona"]'),t=document.querySelector('button[data-click="faculty-persona"]'),n=document.querySelector(jt);n&&new Ft(n);let s=null;Ut(),(c=(h=window.suHeaderProps)==null?void 0:h.pageData)!=null&&c.isStory&&(async()=>s=await zt(window.suHeaderProps.pageData,window.suHeaderProps.audienceData))();const r=typeof window.pageController<"u"?window.pageController:null,o=document.querySelectorAll('a[data-menu="main-nav"]'),a=document.querySelector('section[data-subcomponent="header-current-story-headline"]');r&&o&&o.forEach(v=>{(r==null?void 0:r.id)===v.dataset.id&&(v.classList.remove("su-border-transparent"),v.classList.add("!su-text-digital-red su-border-digital-red dark:su-border-dark-mode-red dark:!su-text-dark-mode-red"))}),Wt(s,r,a,ee);const i=JSON.parse(U("squiz.cdp.consent")),l=i==null?void 0:i.CDPConsent,d=document.querySelector('button[data-click="clear-preferences"]');l&&(te(),d&&(d.removeAttribute("disabled"),d.setAttribute("aria-pressed","false"),d.classList.add("su-text-digital-blue"),d.classList.add("dark:su-text-digital-blue-vivid"),d.addEventListener("click",async function(){await ie(null,null,!0)})));const p=document.querySelector('button[data-click="accept-consent"]'),u=document.querySelector('button[data-click="reject-consent"]');p&&p.addEventListener("click",function(){He(!0)}),u&&u.addEventListener("click",function(){He(!1)});const f=U("preferences_personalisation");_e(f==="null"||!f?"external":f),e&&e.addEventListener("click",function(){ie("student",f)}),t&&t.addEventListener("click",function(){ie("faculty",f)})});function Ke(e){if(!e)return 0;const t=225,n=e.trim().split(/\s+/).length;return Math.ceil(n/t)}function Xt(e,t,n,s=()=>{}){const r=e.slides.length;let o=t-r+1;r%n!==0&&(o+=n-r%n);const a=document.createDocumentFragment(),i=e.slides.map(l=>l.outerHTML).join("");for(let l=0;l<o;l++){const d=document.createElement("div");for(d.innerHTML=i;d.firstChild;)d.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(d.firstChild)}e.wrapperEl.appendChild(a),e.update(),b(e,"",!1),s()}function N(e,t=()=>{}){const{slidesPerView:n,slidesPerGroup:s}=e.params,r=e.slides.length,o=Math.ceil(n+s);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<o||r%s!==0?Xt(e,o,s,t):(b(e,"",!1),t())}function re(e){const t=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(t){let n=e.pagination.bullets.length-e.slides.length+t;for(;n>0;){const s=e.pagination.bullets.pop();s&&s.remove(),n--}}}const b=(e,t,n)=>{e.slides.forEach(s=>{if(s.classList.contains("swiper-slide-active")){if(s.removeAttribute("aria-hidden"),s.removeAttribute("inert"),s.setAttribute("tabindex","-1"),t&&n){let r=null;t==="slide"?r=s:r=s.querySelector(t),r&&r.focus()}}else s.setAttribute("aria-hidden","true"),s.setAttribute("inert","true"),s.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(s=>{s.classList.contains("swiper-pagination-bullet-active")?s.setAttribute("aria-current","true"):s.removeAttribute("aria-current")})},Qt='section[data-component="basic-story-hero"]',Kt='span[data-reading="true"]',Je="su-hidden",Jt='button[data-click="open-modal"]',e1='button[data-dismiss="modal"]',et='iframe[data-modal="iframe"]';function t1(e){const t=e.querySelector(et);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(Je),e.hidden=!1,document.body.style.overflow="hidden"}function le(e){const t=e.querySelector(et);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(Je),e.hidden=!0,document.body.style.overflow=""}function s1(e){const t=e.querySelectorAll(Jt),n=e.querySelectorAll(e1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||le(s)}),s.dataset.listenerAdded="true"),t1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&le(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&le(s)})}function n1(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const o=new D(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),o.on("slideChange",function(){setTimeout(()=>{r?b(o,"slide",!0):b(o,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}function r1(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(Kt);if(t&&n){const s=Ke(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Qt).forEach(e=>{n1(e),s1(e),r1(e)})});const a1='section[data-component="combined-content-grid"]',tt="su-hidden",o1='button[data-click="open-modal"]',i1='button[data-dismiss="modal"]',st='iframe[data-modal="iframe"]';function l1(e){const t=e.querySelector(st),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(tt),e.hidden=!1,document.body.style.overflow="hidden"}function ce(e){const t=e.querySelector(st),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(tt),e.hidden=!0,document.body.style.overflow=""}function c1(e){const t=e.querySelectorAll(o1),n=e.querySelectorAll(i1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||ce(s)}),s.dataset.listenerAdded="true"),l1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ce(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(a1).forEach(e=>{c1(e)})});const d1='section[data-component="content-carousel"]';function u1(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const o=new D(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),o.on("slideChange",function(){setTimeout(()=>{r?b(o,"slide",!0):b(o,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(d1).forEach(e=>{u1(e)})});const f1='section[data-component="feature-story-hero"]',p1='span[data-reading="true"]';function h1(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(p1);if(t&&n){const s=Ke(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(f1).forEach(e=>{h1(e)})});const m1='section[data-component="featured-content"]',nt="su-hidden",C1='button[data-click="open-modal"]',g1='button[data-dismiss="modal"]',rt='iframe[data-modal="iframe"]';function v1(e){const t=e.querySelector(rt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(nt),e.hidden=!1,document.body.style.overflow="hidden"}function de(e){const t=e.querySelector(rt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(nt),e.hidden=!0,document.body.style.overflow=""}function y1(e){const t=e.querySelectorAll(C1),n=e.querySelectorAll(g1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||de(s)}),s.dataset.listenerAdded="true"),v1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&de(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&de(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(m1).forEach(e=>{y1(e)})});const w1='section[data-component="horizontal-video-testimonials"]',at="su-hidden",L1='button[data-click="open-modal"]',E1='button[data-dismiss="modal"]',ot='iframe[data-modal="iframe"]';function b1(e){const t=e.querySelector(ot);if(t){const n=t.getAttribute("src"),s=n&&n.replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(at),e.hidden=!1,document.body.style.overflow="hidden"}function ue(e){const t=e.querySelector(ot);if(t){const n=t.getAttribute("src"),s=n&&n.replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(at),e.hidden=!0,document.body.style.overflow=""}function S1(e){const t=e.querySelectorAll(L1),n=e.querySelectorAll(E1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||ue(s)}),s.dataset.listenerAdded="true"),b1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ue(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ue(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(w1).forEach(e=>{S1(e)})});const A1='section[data-component="image-gallery-modal"]',x1='button[data-click="open-gallery-modal"]',_1='div[data-modal="modal"]',T1='button[data-dismiss="modal"]',it="su-hidden";let Te;const I1=(e,t)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(i=>!i.hasAttribute("disabled")&&!i.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],o=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),o.focus()):!e.shiftKey&&document.activeElement===o&&(e.preventDefault(),r.focus())};function k1(e){e.classList.remove(it),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&I1(t,e)})}function fe(e){e.classList.add(it),e.hidden=!0,document.body.style.overflow=""}function M1(e){const t=e.dataset.modalId;Te=new D(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function $1(e){const t=e.querySelector(_1),n=e.querySelector(x1),s=e.querySelector(T1);n&&n.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",o=>{r.contains(o.target)||fe(t)}),t.dataset.listenerAdded="true"),k1(t),M1(t)}),s&&s.addEventListener("click",function(){fe(t),Te.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(fe(t),Te.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(A1).forEach(e=>{$1(e)})});const O1='[data-component="interactive-photo-card"]',V1="[data-card-inner]",H1="[data-card-inner-content]";function q1(e){var s;const n=((e.style.transform&&parseInt((s=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:s[1])||0)+180)%360;e.style.transform=`rotateY(${n}deg)`}function N1(e){const t=e.querySelector(V1);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>q1(t))}const R1=e=>{e.forEach(t=>{const n=t.getAttribute("aria-hidden")==="true"?"false":"true",s=t.querySelector("button");s&&(s.tabIndex=n==="true"?"-1":""),t.setAttribute("aria-hidden",n)})},D1=e=>{const t=e.querySelectorAll(H1);t.length&&t.forEach(n=>n.addEventListener("click",()=>R1(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(O1).forEach(e=>{N1(e),D1(e)})});function B1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:n,summary:s,image:r,taxonomyContentTypeText:o,contentTopic:a,contentSubtopic:i,taxonomyContentMainTopicText:l,contentCategory:d,featuredVideo:p,taxonomyContentMainTopicLandingPageUrl:u,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:h,imageAlt:c,authorName:v,authorImage:C,author:y,isTeaser:g,storySource:m,assetHref:S},date:$,liveUrl:O}){const V=v!==void 0?v:y,A=C!==""?C:void 0,I=r&&r!==""?r:null,L=c&&c!==""?c:"",k=p,B=n||s;let H=l;!H&&a&&(H=a instanceof Array?a[0]:a),!H&&i&&(H=i instanceof Array?i[0]:i);const oe=u;let P=o?o[0]:"";return!P&&d&&(P=d instanceof Array?d[0]:d),S&&t[0]==="link"&&(O=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(B)?B[0]:B,liveUrl:Array.isArray(O)?O[0]:O,imageUrl:Array.isArray(I)?I[0]:I,imageAlt:Array.isArray(L)?L[0]:L,taxonomy:Array.isArray(H)?H[0]:H,taxonomyUrl:Array.isArray(oe)?oe[0]:oe,type:Array.isArray(P)?P[0]:P,videoUrl:Array.isArray(k)?k[0]:k,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(V)?V[0]:V,authorAvatar:Array.isArray(A)?A[0]:A,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(h)?h[0]:h,isTeaser:Array.isArray(g)?g[0]:g,storySource:Array.isArray(m)?m[0]:m}}function pe(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function lt(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}const P1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(t+s)%16|0,t=Math.floor(t/16)),(n==="x"?s:s&3|8).toString(16)})},Z1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),G1=()=>typeof crypto<"u"?Z1():P1();async function U1(e=null,t="",n=null){var r,o,a,i,l,d,p,u,f,h,c,v,C,y,g,m,S,$,O;const s=new Xe;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const V=`
    ...
    `}function j1(e,t,n){if(!e.length){t.classList.add(E.NO_STORIES);return}const[s,r,o]=e;n.innerHTML=`
    ...
    `,t.classList.remove(E.NO_STORIES)}async function Y1(e,t,n,s,r,o){const i=(await U1(e,o,t)).map(({title:l,indexUrl:d})=>W1(l,d));j1(i,n,r),X1(n,s,r)}function X1(e,t,n){t.addEventListener("click",function(){F1(t,n)}),window.addEventListener("scroll",function(){z1(e)})}function Q1(e,t,n,s){if(!e||!window.pageController)return;const r=window.pageController,o=r.topicsQuery?r.topicsQuery():null;Y1(r,o,e,t,n,s)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(he.WRAPPER),t=document.querySelector(he.TOGGLE),n=document.querySelector(he.DRAWER),s=U("preferences_personalisation");Q1(e,t,n,s)});const K1='section[data-component="media-carousel"]';function J1(e){const t=e.dataset.uniqueId,n=new D(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}}),s=n.slides.length,r=n.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(s-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),n.on("slideChange",function(){setTimeout(()=>{a?b(n,"h2 a, h3 a, button",!0):b(n,"",!1)},100)})}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(K1).forEach(e=>{J1(e)})});const es='button[data-role="copy-link"]';function ts(e){e.addEventListener("click",function(){navigator.clipboard.writeText(window.location.href).then(()=>{const t=document.querySelector("[data-copy-text]");t.textContent="Copied",setTimeout(()=>{t.textContent="Copy link"},3e3)})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(es).forEach(e=>{ts(e)})});const ss='section[data-component="multicolumn-listing"]',ct="su-hidden",ns='button[data-click="open-modal"]',rs='button[data-dismiss="modal"]',dt='iframe[data-modal="iframe"]';function as(e){const t=e.querySelector(dt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(ct),e.hidden=!1,document.body.style.overflow="hidden"}function me(e){const t=e.querySelector(dt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(ct),e.hidden=!0,document.body.style.overflow=""}function os(e){const t=e.querySelectorAll(ns),n=e.querySelectorAll(rs);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||me(s)}),s.dataset.listenerAdded="true"),as(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&me(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&me(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ss).forEach(e=>{os(e)})});const is='section[data-component="sidebar-navigation"]',ls='nav[data-nav="nav"]',se="su-hidden",cs='button[data-click="toggle-nav"]',ds="su-bg-digital-red su-text-white dark:su-bg-dark-mode-red dark:aria-expanded:su-text-black-true",us='span[data-label="button"]';function ut(e,t){const n=e.querySelector(us),s=e.querySelector('svg[data-icon="bars"]'),r=e.querySelector('svg[data-icon="xmark"]');e.setAttribute("aria-expanded",t.toString()),ds.split(" ").forEach(o=>{e.classList.toggle(o,t)}),s&&(s.classList.toggle(`!${se}`,t),s.hidden=t),r&&(r.classList.toggle(`!${se}`,!t),r.hidden=!t),n&&(n.innerHTML=t?n.getAttribute("data-label-close"):n.getAttribute("data-label-open"))}function qe(e,t){e.classList.remove(se),e.hidden=!1,ut(t,!0)}function F(e,t){e.classList.add(se),e.hidden=!0,ut(t,!1)}function fs(e){const t=e.querySelector(cs),n=e.querySelector(ls);let s;t&&t.addEventListener("click",function(){const r=t.getAttribute("aria-expanded")==="true";n.dataset.listenerAdded||(document.addEventListener("click",o=>{const a=n.contains(o.target),i=t.contains(o.target);!a&&!i&&F(n,t)}),n.dataset.listenerAdded="true"),r?F(n,t):qe(n,t)}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&t&&F(n,t)}),window.addEventListener("resize",()=>{clearTimeout(s),s=setTimeout(()=>{window.innerWidth>991?n&&t&&qe(n,t):n&&t&&F(n,t)},10)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(is).forEach(e=>{fs(e)})});function z(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function W(e,t){const n=e.querySelector('svg[data-control="play"]'),s=e.querySelector('svg[data-control="pause"]'),r=!t;e.setAttribute("aria-pressed",String(r)),n.classList.toggle("su-hidden",r),n.hidden=r,s.classList.toggle("su-hidden",!r),s.hidden=!r,e.innerHTML=`
  ...
  `}const ps='section[data-component="single-image-video"]',hs='iframe[data-role="video-player"]',ms='button[data-role="video-control"]',ft="su-hidden",Cs='button[data-click="open-modal"]',gs='button[data-dismiss="modal"]',pt='iframe[data-modal="iframe"]',vs=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(i=>!i.hasAttribute("disabled")&&!i.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],o=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),o.focus()):!e.shiftKey&&document.activeElement===o&&(e.preventDefault(),r.focus())};function ys(e){const t=e.querySelector(pt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(ft),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&vs(r,e)})}function Ce(e){const t=e.querySelector(pt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(ft),e.hidden=!0,document.body.style.overflow=""}function ws(e){const t=e.querySelectorAll(Cs),n=e.querySelectorAll(gs);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||Ce(s)}),s.dataset.listenerAdded="true"),ys(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&Ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&Ce(s)})}function Ls(e){const t=e.querySelector(hs),n=e.querySelector(ms);let s=!1;if(!t||!n)return;new IntersectionObserver(o=>{o.forEach(a=>{a.isIntersecting&&!s?(z(t,"play"),W(n,!1)):a.isIntersecting||(z(t,"pause"),W(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(z(t,"pause"),W(n,!0),s=!0):(z(t,"play"),W(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ps).forEach(e=>{ws(e),Ls(e)})});const Es='section[data-component="standalone-visual-hero"]',ht="su-hidden",bs='button[data-click="open-modal"]',Ss='button[data-dismiss="modal"]',mt='iframe[data-modal="iframe"]';function As(e){const t=e.querySelector(mt);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(ht),e.hidden=!1,document.body.style.overflow="hidden"}function ge(e){const t=e.querySelector(mt);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(ht),e.hidden=!0,document.body.style.overflow=""}function xs(e){const t=e.querySelectorAll(bs),n=e.querySelectorAll(Ss);let s=null;t.forEach(r=>{r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||ge(s)}),s.dataset.listenerAdded="true"),As(s)})}),n.forEach(r=>{r.addEventListener("click",function(){s&&ge(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ge(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Es).forEach(e=>{xs(e)})});const _s='section[data-component="stories-carousel"]',Ct="su-hidden",Ts='button[data-click="open-modal"]',Is='button[data-dismiss="modal"]',gt='iframe[data-modal="iframe"]';function ks(e){const t=e.querySelector(gt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ct),e.hidden=!1,document.body.style.overflow="hidden"}function ve(e){const t=e.querySelector(gt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ct),e.hidden=!0,document.body.style.overflow=""}function Ms(e){const t=e.querySelectorAll(Ts),n=e.querySelectorAll(Is);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||ve(s)}),s.dataset.listenerAdded="true"),ks(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ve(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ve(s)})}function $s(e){const t=e.dataset.uniqueId;new D(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(_s).forEach(e=>{$s(e),Ms(e)})});const Os='section[data-component="subscribe-to-stanford-report"]';function Vs(e){const t=e.querySelector("form"),n=t.querySelector('input[type="email"]'),s=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let o="";const a=n.value;if(!a||!a.match(/\w+@\w+\.\w+/)){o='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',s.innerHTML=o,n.setAttribute("aria-describedby","subscription-error");return}s.innerHTML="",n.removeAttribute("aria-describedby"),r.target.submit()}),n.addEventListener("keyup",function(){const r=n.value,o=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(o.innerHTML="",n.removeAttribute("aria-describedby"))})}function Hs(){document.querySelectorAll(Os).forEach(e=>{Vs(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",Hs);const qs='section[data-component="subtopic-subnav-component"]',Ns='div[data-list="subnav"]';function Rs(e){return e.filter((t,n)=>n===e.findIndex(s=>{var r,o;return((r=s.taxonomyFeaturedUnitText)==null?void 0:r[0])===((o=t.taxonomyFeaturedUnitText)==null?void 0:o[0])}))}const Ds=async e=>{if(!e||e.length===0)return null;const t=Rs(e),n=[];return t.forEach(s=>{var o,a,i;const r=s;r&&((o=r.taxonomyFeaturedUnitText)!=null&&o[0])&&n.push({asset_name:(a=r.taxonomyFeaturedUnitText)==null?void 0:a[0],asset_url:((i=r.taxonomyFeaturedUnitLandingPageUrl)==null?void 0:i[0])||""})}),n};function Bs({navigation:e}){let t="scrollable-list__item su-mb-0 su-relative after:su-h-22 after:su-w-[1px] after:su-bg-black-60 after:su-mx-12 lg:after:su-mx-18";const n="su-text-inherit su-text-black su-font-semi-bold su-text-16 lg:su-text-18 lg:su-leading-[21.6px] su-no-underline hover:su-underline dark:su-text-white hover:su-text-digital-red dark:hover:su-text-dark-mode-red";return`
    ...
    `}function Ps(e){const t=e.querySelector(Ns);t&&document.addEventListener("topicLoader",async n=>{if(n.detail){const s=await Ds(n.detail.cards);t.innerHTML=Bs({navigation:s})}},!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(qs).forEach(e=>{Ps(e)})});function Zs({offsetNum:e,pageNumber:t,index:n}){return`
        <button
            data-offset="${e}"
    ...
    `}function Gs({pageNumber:e,allResults:t,resultsPerPage:n,paginationRange:s,currentPage:r=1}){const o=Math.ceil(t/n),a=s,i=e-n,l=e+n,d="su-text-black-50",p=[],u=[];for(let g=0;g<o;g++){const m=g*n+1;u.push(m)}let f=[...u],h=[...u];const c=u.indexOf(r),v=Math.floor(a*.5);if((c<v||o===a)&&(f=f.filter((g,m)=>g>r&&m<a),h=h.filter(g=>g<r)),c>=v&&o!==a)if(f=f.filter((g,m)=>g>r&&m<=c+v),f.length===v)h=h.filter((g,m)=>g<r&&m>=c-v);else{const g=f.length?a-f.length:a;h=h.filter((m,S)=>m<r&&S>c-g)}return[...h,r,...f].map(g=>({offset:g,index:u.indexOf(g)+1})).forEach(({offset:g,index:m})=>{p.push(Zs({offsetNum:g,pageNumber:e,index:m}))}),o>1?`<div class="su-mx-auto su-component-container">
                <div class="su-flex su-gap-9 su-items-center su-justify-center su-rs-mt-4 lg:su-rs-mt-7">
                    <button
                        type="button"
                        class="su-size-24 su-font-serif su-flex su-items-center su-justify-center dark:su-text-white ${i<1?d:""}"
                        ${i<1?"disabled":""}
                        data-offset="${i<1?1:i}"
            ...
            </div>`:""}function Us(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Ie={exports:{}},w={},ke={exports:{}},R={};function vt(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function Fs(e,t,n){}function zs(e,t,n){}var Ws=/javascript\s*\:/img;function js(e,t){return Ws.test(t)?"":t}R.whiteList=vt();R.getDefaultWhiteList=vt;R.onAttr=Fs;R.onIgnoreAttr=zs;R.safeAttrValue=js;var Ys={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},Z=Ys;function Xs(e,t){e=Z.trimRight(e),e[e.length-1]!==";"&&(e+=";");var n=e.length,s=!1,r=0,o=0,a="";function i(){if(!s){var p=Z.trim(e.slice(r,o)),u=p.indexOf(":");if(u!==-1){var f=Z.trim(p.slice(0,u)),h=Z.trim(p.slice(u+1));if(f){var c=t(r,a.length,f,h,p);c&&(a+=c+"; ")}}}r=o+1}for(;o<n;o++){var l=e[o];if(l==="/"&&e[o+1]==="*"){var d=e.indexOf("*/",o+2);if(d===-1)break;o=d+1,r=o+1,s=!1}else l==="("?s=!0:l===")"?s=!1:l===";"?s||i():l===`
`&&i()}return Z.trim(a)}var Qs=Xs,j=R,Ks=Qs;function Ne(e){return e==null}function Js(e){var t={};for(var n in e)t[n]=e[n];return t}function yt(e){e=Js(e||{}),e.whiteList=e.whiteList||j.whiteList,e.onAttr=e.onAttr||j.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||j.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||j.safeAttrValue,this.options=e}yt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onAttr,o=n.onIgnoreAttr,a=n.safeAttrValue,i=Ks(e,function(l,d,p,u,f){var h=s[p],c=!1;if(h===!0?c=h:typeof h=="function"?c=h(u):h instanceof RegExp&&(c=h.test(u)),c!==!0&&(c=!1),u=a(p,u),!!u){var v={position:d,sourcePosition:l,source:f,isWhite:c};if(c){var C=r(p,u,v);return Ne(C)?p+":"+u:C}else{var C=o(p,u,v);if(!Ne(C))return C}}});return i};var en=yt;(function(e,t){var n=R,s=en;function r(a,i){var l=new s(i);return l.process(a)}t=e.exports=r,t.FilterCSS=s;for(var o in n)t[o]=n[o];typeof window<"u"&&(window.filterCSS=e.exports)})(ke,ke.exports);var Me=ke.exports,$e={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,n=t.exec(e);return n?n.index:-1}},tn=Me.FilterCSS,sn=Me.getDefaultWhiteList,ne=$e;function wt(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var Lt=new tn;function nn(e,t,n){}function rn(e,t,n){}function an(e,t,n){}function on(e,t,n){}function Et(e){return e.replace(cn,"&lt;").replace(dn,"&gt;")}function ln(e,t,n,s){if(n=Tt(n),t==="href"||t==="src"){if(n=ne.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(t==="background"){if(Y.lastIndex=0,Y.test(n))return""}else if(t==="style"){if(Re.lastIndex=0,Re.test(n)||(De.lastIndex=0,De.test(n)&&(Y.lastIndex=0,Y.test(n))))return"";s!==!1&&(s=s||Lt,n=s.process(n))}return n=It(n),n}var cn=/</g,dn=/>/g,un=/"/g,fn=/&quot;/g,pn=/&#([a-zA-Z0-9]*);?/gim,hn=/&colon;?/gim,mn=/&newline;?/gim,Y=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,Re=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,De=/u\s*r\s*l\s*\(.*/gi;function bt(e){return e.replace(un,"&quot;")}function St(e){return e.replace(fn,'"')}function At(e){return e.replace(pn,function(n,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function xt(e){return e.replace(hn,":").replace(mn," ")}function _t(e){for(var t="",n=0,s=e.length;n<s;n++)t+=e.charCodeAt(n)<32?" ":e.charAt(n);return ne.trim(t)}function Tt(e){return e=St(e),e=At(e),e=xt(e),e=_t(e),e}function It(e){return e=bt(e),e=Et(e),e}function Cn(){return""}function gn(e,t){typeof t!="function"&&(t=function(){});var n=!Array.isArray(e);function s(a){return n?!0:ne.indexOf(e,a)!==-1}var r=[],o=!1;return{onIgnoreTag:function(a,i,l){if(s(a))if(l.isClosing){var d="[/removed]",p=l.position+d.length;return r.push([o!==!1?o:l.position,p]),o=!1,d}else return o||(o=l.position),"[removed]";else return t(a,i,l)},remove:function(a){var i="",l=0;return ne.forEach(r,function(d){i+=a.slice(l,d[0]),l=d[1]}),i+=a.slice(l),i}}}function vn(e){for(var t="",n=0;n<e.length;){var s=e.indexOf("<!--",n);if(s===-1){t+=e.slice(n);break}t+=e.slice(n,s);var r=e.indexOf("-->",s);if(r===-1)break;n=r+3}return t}function yn(e){var t=e.split("");return t=t.filter(function(n){var s=n.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),t.join("")}w.whiteList=wt();w.getDefaultWhiteList=wt;w.onTag=nn;w.onIgnoreTag=rn;w.onTagAttr=an;w.onIgnoreTagAttr=on;w.safeAttrValue=ln;w.escapeHtml=Et;w.escapeQuote=bt;w.unescapeQuote=St;w.escapeHtmlEntities=At;w.escapeDangerHtml5Entities=xt;w.clearNonPrintableCharacter=_t;w.friendlyAttrValue=Tt;w.escapeAttrValue=It;w.onIgnoreTagStripAll=Cn;w.StripTagBody=gn;w.stripCommentTag=vn;w.stripBlankChar=yn;w.attributeWrapSign='"';w.cssFilter=Lt;w.getDefaultCSSWhiteList=sn;var ae={},q=$e;function wn(e){var t=q.spaceIndex(e),n;return t===-1?n=e.slice(1,-1):n=e.slice(1,t+1),n=q.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function Ln(e){return e.slice(0,2)==="</"}function En(e,t,n){var s="",r=0,o=!1,a=!1,i=0,l=e.length,d="",p="";e:for(i=0;i<l;i++){var u=e.charAt(i);if(o===!1){if(u==="<"){o=i;continue}}else if(a===!1){if(u==="<"){s+=n(e.slice(r,i)),o=i,r=i;continue}if(u===">"||i===l-1){s+=n(e.slice(r,o)),p=e.slice(o,i+1),d=wn(p),s+=t(o,s.length,d,p,Ln(p)),r=i+1,o=!1;continue}if(u==='"'||u==="'")for(var f=1,h=e.charAt(i-f);h.trim()===""||h==="=";){if(h==="="){a=u;continue e}h=e.charAt(i-++f)}}else if(u===a){a=!1;continue}}return r<l&&(s+=n(e.substr(r))),s}var bn=/[^a-zA-Z0-9\\_:.-]/gim;function Sn(e,t){var n=0,s=0,r=[],o=!1,a=e.length;function i(f,h){if(f=q.trim(f),f=f.replace(bn,"").toLowerCase(),!(f.length<1)){var c=t(f,h||"");c&&r.push(c)}}for(var l=0;l<a;l++){var d=e.charAt(l),p,u;if(o===!1&&d==="="){o=e.slice(n,l),n=l+1,s=e.charAt(n)==='"'||e.charAt(n)==="'"?n:xn(e,l+1);continue}if(o!==!1&&l===s){if(u=e.indexOf(d,l+1),u===-1)break;p=q.trim(e.slice(s+1,u)),i(o,p),o=!1,l=u,n=l+1;continue}if(/\s|\n|\t/.test(d))if(e=e.replace(/\s|\n|\t/g," "),o===!1)if(u=An(e,l),u===-1){p=q.trim(e.slice(n,l)),i(p),o=!1,n=l+1;continue}else{l=u-1;continue}else if(u=_n(e,l-1),u===-1){p=q.trim(e.slice(n,l)),p=Be(p),i(o,p),o=!1,n=l+1;continue}else continue}return n<e.length&&(o===!1?i(e.slice(n)):i(o,Be(q.trim(e.slice(n))))),q.trim(r.join(" "))}function An(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="="?t:-1}}function xn(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="'"||n==='"'?t:-1}}function _n(e,t){for(;t>0;t--){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Tn(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function Be(e){return Tn(e)?e.substr(1,e.length-2):e}ae.parseTag=En;ae.parseAttr=Sn;var In=Me.FilterCSS,T=w,kt=ae,kn=kt.parseTag,Mn=kt.parseAttr,K=$e;function X(e){return e==null}function $n(e){var t=K.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=K.trim(e.slice(t+1,-1));var n=e[e.length-1]==="/";return n&&(e=K.trim(e.slice(0,-1))),{html:e,closing:n}}function On(e){var t={};for(var n in e)t[n]=e[n];return t}function Vn(e){var t={};for(var n in e)Array.isArray(e[n])?t[n.toLowerCase()]=e[n].map(function(s){return s.toLowerCase()}):t[n.toLowerCase()]=e[n];return t}function Mt(e){e=On(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=T.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=Vn(e.whiteList||e.allowList):e.whiteList=T.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":T.attributeWrapSign,e.onTag=e.onTag||T.onTag,e.onTagAttr=e.onTagAttr||T.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||T.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||T.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||T.safeAttrValue,e.escapeHtml=e.escapeHtml||T.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new In(e.css))}Mt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onTag,o=n.onIgnoreTag,a=n.onTagAttr,i=n.onIgnoreTagAttr,l=n.safeAttrValue,d=n.escapeHtml,p=t.attributeWrapSign,u=t.cssFilter;n.stripBlankChar&&(e=T.stripBlankChar(e)),n.allowCommentTag||(e=T.stripCommentTag(e));var f=!1;n.stripIgnoreTagBody&&(f=T.StripTagBody(n.stripIgnoreTagBody,o),o=f.onIgnoreTag);var h=kn(e,function(c,v,C,y,g){var m={sourcePosition:c,position:v,isClosing:g,isWhite:Object.prototype.hasOwnProperty.call(s,C)},S=r(C,y,m);if(!X(S))return S;if(m.isWhite){if(m.isClosing)return"</"+C+">";var $=$n(y),O=s[C],V=Mn($.html,function(A,I){var L=K.indexOf(O,A)!==-1,k=a(C,A,I,L);return X(k)?L?(I=l(C,A,I,u),I?A+"="+p+I+p:A):(k=i(C,A,I,L),X(k)?void 0:k):k});return y="<"+C,V&&(y+=" "+V),$.closing&&(y+=" /"),y+=">",y}else return S=o(C,y,m),X(S)?d(y):S},d);return f&&(h=f.remove(h)),h};var Hn=Mt;(function(e,t){var n=w,s=ae,r=Hn;function o(i,l){var d=new r(l);return d.process(i)}t=e.exports=o,t.filterXSS=o,t.FilterXSS=r,function(){for(var i in n)t[i]=n[i];for(var l in s)t[l]=s[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(Ie,Ie.exports);var qn=Ie.exports;const M=Us(qn);var Nn=Array.isArray,$t=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var n=void 0;if(Nn(e))for(var s=0,r=e.length;s<r;)n=$t(e[s++]),n&&(t&&(t+=" "),t+=n);else for(n in e)n&&e[n]&&(t&&(t+=" "),t+=n)}return t};function Ot(){for(var e=arguments.length,t=0,n,s,r="";t<e;)n=arguments[t++],n&&(s=$t(n),s&&(r&&(r+=" "),r+=s));return r}function Pe({children:e="",imageUrl:t,imageAlt:n="",aspectRatio:s="card-small",videoUrl:r}){return`
    <span
      class="${Ot("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",s==="card-small"&&"su-aspect-[3/2]",s==="card-medium"&&"su-aspect-[3/2]",s==="card-large"&&"su-aspect-[3/2]",s==="card-featured"&&"su-aspect-[3/2]",s==="square"&&"su-aspect-[1/1]",s==="video"&&"su-aspect-[16/9]",s==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${r?`
  ...
  `}const Rn={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function Ze({imageUrl:e,alt:t="",aspectRatio:n,videoUrl:s,size:r="small",title:o="",videoIconClasses:a,uniqueId:i}){if(s){const l=`
        ...
        ${s?`
          <span
            class="${Ot("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",Rn[r],a)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${i}"
      >
        ${Pe({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:n,children:l})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${Pe({imageUrl:e,imageAlt:t,aspectRatio:n})}
    </div>
  `}function Dn(e,t){if(!t)return!0;const n=e.match(/(\d+-\d+-\d+)/)[0],s=t.match(/(\d+-\d+-\d+)/)[0];return n===s}function Bn({start:e,end:t}){if(!e&&!t)return null;const n=new Date(e),s=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let o="";const a=Dn(e,t);a||(delete r.time,delete r.hour,delete r.minute);const i=new Intl.DateTimeFormat("en-US",r).format(n),l=t?new Intl.DateTimeFormat("en-US",r).format(s):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${i.replace(/, /," | ")}</span>`:(o+=`${i} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${o}</span>`)}function Pn(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Gn="light";function we({variant:e=Gn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function Fn({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    >
    ...
    </svg>`}const Fe="solid";function Kn({variant:e=Fe}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get(Fe)}function Ee(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Jn="light";function ze({variant:e=Jn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    ${f==="large"?`
      ...
      ${f==="small"&&s?`
        <div class="${x.imageWrapper} ${h.imageWrapper} su-relative">
            ${Ze({imageUrl:s,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"large",size:f,uniqueId:u})}
        </div>
      `:""}
      ...
      <div class="${x.contentWrapper} ${h.contentGap}">
        ...
        ${f==="large"&&i?`
          <p data-testid="horizontal-card-type" class="${x.type}">
            ${c.get(i.toLowerCase())}
            <span class="${x.typeText}">${M(i)}</span>
          </p>
        `:""}
      ...
      <div class="${_.contentWrapper}">
        ...
        ${i==="Leadership Messages"?`
          <div class="${_.authorWrapper} ${c}">
            ${h?`
              ${cr({image:h,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${y}
          </div>
        `:""}
  ...
  `}function ur(e){const{videoId:t,className:n="",noAutoPlay:s,title:r,isVertical:o}=e;return`
        <iframe
            width="${o?315:560}"
            height="${o?560:315}"
            class="${n}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const fr='section[data-component="topic-subtopic-listing"]',pr='[data-element="topics-list"]',Vt='[data-element="topics-pagination"]',Ht="su-hidden",hr='section[data-element="modal-wrapper"]',mr='button[data-click="open-modal"]',Cr='button[data-dismiss="modal"]',qt='iframe[data-modal="iframe"]';function gr(e){const t=e.querySelector(qt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ht),e.hidden=!1,document.body.style.overflow="hidden"}function Se(e){const t=e.querySelector(qt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ht),e.hidden=!0,document.body.style.overflow="hidden"}function Nt(e){const t=e.querySelectorAll(mr),n=e.querySelectorAll(Cr);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||Se(s)}),s.dataset.listenerAdded="true"),gr(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&Se(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&Se(s)})}async function vr(e){const{offset:t,query:n,endpoint:s}=e,r=s+n+`&start_rank=${t}`;return await(await fetch(r).catch(i=>{throw new Error(i)})).json()}function yr(e,t,n,s){e.querySelector(pr).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(Vt).innerHTML=n,e.querySelector(hr).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),Nt(e),Rt(e)}async function wr(e){var f,h,c,v,C;const{offset:t,query:n,endpoint:s,display:r,section:o}=e,a=await vr({offset:t,query:n,endpoint:s}),i=(h=(f=a==null?void 0:a.response)==null?void 0:f.resultPacket)==null?void 0:h.resultsSummary;if(!i){console.warn("Missing resultsSummary from API response");return}const l=[],d=[];(C=(v=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:v.results)==null||C.forEach(y=>{const g=G1(),m=B1(y);m.uniqueID=g,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(m.displayConfiguration=r,l.push(`<div class="su-relative su-grow">${dr({data:m,cardType:"narrowhorizontal"})}</div>`)):l.push(`<div class="su-relative su-grow">${lr({data:m,cardType:"horizontal",cardSize:"large"})}</div>`),(m.type==="Video"||m.videoUrl)&&d.push({isVertical:m.size==="vertical-video",videoId:m.videoUrl,title:`Watch ${m.title}`,noAutoPlay:!0,uniqueID:m.uniqueID,titleID:"card-modal"})});const p=Gs({pageNumber:Number(t),allResults:i.totalMatching,resultsPerPage:i.numRanks,paginationRange:5,currentPage:Number(t)}),u=d.map(y=>`
        <div hidden="true" aria-modal="true" role="dialog" data-overlay-container="true" class="su-modal su-hidden" data-modal="modal" data-modal-id="${y.uniqueID}"><span data-focus-scope-start="true" hidden="true"></span><div aria-describedby="${y.titleID}" role="dialog" tabindex="-1" data-modal="modal-dialog" data-ismodal="true" aria-modal="true"><div class="su-modal-content">
        ${ur({videoId:y.videoId,title:y.title,noAutoPlay:y.noAutoPlay,isVertical:y.isVertical})}
        ...
        `).join("");yr(o,l.join(""),p,u)}function Rt(e){const{query:t,endpoint:n,display:s}=e.dataset,r=e.querySelector(Vt);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const i=a.getAttribute("data-offset");wr({offset:i,query:t,endpoint:n,display:s,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(fr).forEach(e=>{Nt(e),Rt(e)})});const Lr='section[data-component="vertical-video-panel"]',Dt="su-hidden",Er='button[data-click="open-modal"]',br='button[data-dismiss="modal"]',Bt='iframe[data-modal="iframe"]';function Sr(e){const t=e.querySelector(Bt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Dt),e.hidden=!1,document.body.style.overflow="hidden"}function Ae(e){const t=e.querySelector(Bt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Dt),e.hidden=!0,document.body.style.overflow=""}function Ar(e){const t=e.querySelectorAll(Er),n=e.querySelectorAll(br);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const o=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${o}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",i=>{a.contains(i.target)||Ae(s)}),s.dataset.listenerAdded="true"),Sr(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&Ae(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&Ae(s)})}function xr(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const o=new D(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,i){return`<button ${a===0?'aria-current="true"':""} class="${i}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{N(a),b(a,"",!1)},resize:a=>{N(a)},paginationUpdate:a=>{re(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),o.on("slideChange",function(){setTimeout(()=>{r?b(o,"h2 a, h3 a, button",!0):b(o,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Lr).forEach(e=>{xr(e),Ar(e)})});
