import q from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";function ne(e,t,s,r=()=>{}){const a=e.slides.length;let i=t-a+1;a%s!==0&&(i+=s-a%s);const n=document.createDocumentFragment(),o=e.slides.map(u=>u.outerHTML).join("");for(let u=0;u<i;u++){const p=document.createElement("div");for(p.innerHTML=o;p.firstChild;)p.firstChild.classList.add("swiper-slide-duplicate"),n.appendChild(p.firstChild)}e.wrapperEl.appendChild(n),e.update(),r()}function Z(e,t=()=>{}){var n;const{slidesPerView:s,slidesPerGroup:r}=e.params,a=e.slides.length,i=Math.ceil(s+r);a===1&&((n=document.querySelector(".component-slider-controls"))==null||n.remove()),(a-1<i||a%r!==0)&&ne(e,i,r,t)}function i1(e){const t=e.slides.filter(s=>s.classList.contains("swiper-slide-duplicate")).length;if(t){let s=e.pagination.bullets.length-e.slides.length+t;for(;s>0;){const r=e.pagination.bullets.pop();r&&r.remove(),s--}}}const D=(e,t,s)=>{e.slides.forEach(r=>{if(r.classList.contains("swiper-slide-active")){if(r.removeAttribute("aria-hidden"),r.removeAttribute("inert"),r.setAttribute("tabindex","-1"),t&&s){let a=null;t==="slide"?a=r:a=r.querySelector(t),a&&a.focus()}}else r.setAttribute("aria-hidden","true"),r.setAttribute("inert","true"),r.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(r=>{r.classList.contains("swiper-pagination-bullet-active")?r.setAttribute("aria-current","true"):r.removeAttribute("aria-current")})},ie='section[data-component="content-carousel"]';function oe(e){const t=e.dataset.uniqueId,s=new q(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{Z(n)},resize:n=>{Z(n)},paginationUpdate:n=>{i1(n)}}}),r=s.slides.length,a=s.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(r-a)>1&&(s.on("slideChange",function(){setTimeout(()=>{D(s,"slide",!0)},100)}),D(s,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ie).forEach(e=>{oe(e)})});const le='section[data-component="featured-content"]',M1="su-hidden",ue='button[data-click="open-modal"]',de='button[data-dismiss="modal"]',_1='iframe[data-modal="iframe"]';function ce(e){const t=e.querySelector(_1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(M1),e.hidden=!1}function u1(e){const t=e.querySelector(_1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(M1),e.hidden=!0}function fe(e){const t=e.querySelectorAll(ue),s=e.querySelectorAll(de);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&ce(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){u1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&u1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(le).forEach(e=>{fe(e)})});const pe='section[data-component="image-gallery-modal"]',ge='button[data-click="open-gallery-modal"]',Ce='div[data-modal="modal"]',he='button[data-dismiss="modal"]',k1="su-hidden";let r1;const ve=(e,t)=>{var n;const s='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',r=(n=Array.from(t==null?void 0:t.querySelectorAll(s)))==null?void 0:n.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(r.length===0||(e==null?void 0:e.key)!=="Tab")return;const a=r[0],i=r[r.length-1];e.shiftKey&&document.activeElement===a?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),a.focus())};function me(e){e.classList.remove(k1),e.hidden=!1,document.addEventListener("keydown",t=>{e&&ve(t,e)})}function d1(e){e.classList.add(k1),e.hidden=!0}function we(e){const t=e.dataset.modalId;r1=new q(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function Le(e){const t=e.querySelector(Ce),s=e.querySelector(ge),r=e.querySelector(he);s&&s.addEventListener("click",function(){me(t),we(t)}),r&&r.addEventListener("click",function(){d1(t),r1.destroy()}),document.addEventListener("keydown",function(a){a.key==="Escape"&&(d1(t),r1.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(pe).forEach(e=>{Le(e)})});const be='[data-component="interactive-photo-card"]',ye="[data-card-inner]",xe="[data-card-inner-content]";function Ae(e){var r;const s=((e.style.transform&&parseInt((r=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:r[1])||0)+180)%360;e.style.transform=`rotateY(${s}deg)`}function Se(e){const t=e.querySelector(ye);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>Ae(t))}const Ee=e=>{e.forEach(t=>{const s=t.getAttribute("aria-hidden")==="true"?"false":"true",r=t.querySelector("button");r&&(r.tabIndex=s==="true"?"-1":""),t.setAttribute("aria-hidden",s)})},Me=e=>{const t=e.querySelectorAll(xe);t.length&&t.forEach(s=>s.addEventListener("click",()=>Ee(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(be).forEach(e=>{Se(e),Me(e)})});const _e='section[data-component="media-carousel"]';function ke(e){const t=e.dataset.uniqueId,s=new q(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o} ${n===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{Z(n),n.activeIndex===1&&n.slidePrev()},resize:n=>{Z(n)},paginationUpdate:n=>{i1(n)}}}),r=s.slides.length,a=s.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(r-a)>1&&(s.on("slideChange",function(){setTimeout(()=>{D(s,"h2 a, h3 a, button",!0)},100)}),D(s,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(_e).forEach(e=>{ke(e)})});const Ve='section[data-component="multicolumn-listing"]',V1="su-hidden",Ie='button[data-click="open-modal"]',$e='button[data-dismiss="modal"]',I1='iframe[data-modal="iframe"]';function Te(e){const t=e.querySelector(I1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(V1),e.hidden=!1}function c1(e){const t=e.querySelector(I1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(V1),e.hidden=!0}function He(e){const t=e.querySelectorAll(Ie),s=e.querySelectorAll($e);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&Te(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){c1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&c1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ve).forEach(e=>{He(e)})});function P(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function R(e,t){const s=e.querySelector('svg[data-control="play"]'),r=e.querySelector('svg[data-control="pause"]'),a=!t;e.setAttribute("aria-pressed",String(a)),s.classList.toggle("su-hidden",a),s.hidden=a,r.classList.toggle("su-hidden",!a),r.hidden=!a,e.innerHTML=`
  ...
  `}const Oe='section[data-component="single-image-video"]',Ze='iframe[data-role="video-player"]',De='button[data-role="video-control"]',$1="su-hidden",Ne='button[data-click="open-modal"]',Be='button[data-dismiss="modal"]',T1='iframe[data-modal="iframe"]';function qe(e){const t=e.querySelector(T1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove($1),e.hidden=!1}function f1(e){const t=e.querySelector(T1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add($1),e.hidden=!0}function Pe(e){const t=e.querySelectorAll(Ne),s=e.querySelectorAll(Be);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&qe(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){f1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&f1(r)})}function Re(e){const t=e.querySelector(Ze),s=e.querySelector(De);let r=!1;if(!t||!s)return;new IntersectionObserver(i=>{i.forEach(n=>{n.isIntersecting&&!r?(P(t,"play"),R(s,!1)):n.isIntersecting||(P(t,"pause"),R(s,!0))})},{threshold:.5}).observe(t),s.addEventListener("click",()=>{s.getAttribute("aria-pressed")==="true"?(P(t,"pause"),R(s,!0),r=!0):(P(t,"play"),R(s,!1),r=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Oe).forEach(e=>{Pe(e),Re(e)})});const Ge='section[data-component="stories-carousel"]',H1="su-hidden",Ue='button[data-click="open-modal"]',ze='button[data-dismiss="modal"]',O1='iframe[data-modal="iframe"]';function Fe(e){const t=e.querySelector(O1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(H1)}function p1(e){const t=e.querySelector(O1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(H1)}function We(e){const t=e.querySelectorAll(Ue),s=e.querySelectorAll(ze);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&Fe(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){p1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&p1(r)})}function je(e){const t=e.dataset.uniqueId;new q(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ge).forEach(e=>{je(e),We(e)})});const Xe=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,s=>{let r=Math.random()*16;return e>0?(r=(e+r)%16|0,e=Math.floor(e/16)):(r=(t+r)%16|0,t=Math.floor(t/16)),(s==="x"?r:r&3|8).toString(16)})},Qe=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),Ye=()=>typeof crypto<"u"?Qe():Xe();function Je({title:e,listMetadata:{assetTypeCode:t,teaserPlain:s,summary:r,image:a,taxonomyContentTypeText:i,contentTopic:n,contentSubtopic:o,taxonomyContentMainTopicText:u,contentCategory:p,featuredVideo:d,taxonomyContentMainTopicLandingPageUrl:c,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:g,imageAlt:l,authorName:L,authorImage:v,author:w,isTeaser:h,storySource:C,assetHref:S},date:T,liveUrl:H}){const O=L!==void 0?L:w,E=v!==""?v:void 0,A=a;l=a&&l?l:"",!l&&!A&&(l="a close up image of an intricate stone arch");const V=d,_=s||r;let I=u;!I&&n&&(I=n instanceof Array?n[0]:n),!I&&o&&(I=o instanceof Array?o[0]:o);const Q=c;let N=i?i[0]:"";return!N&&p&&(N=p instanceof Array?p[0]:p),S&&t[0]==="link"&&(H=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(_)?_[0]:_,liveUrl:Array.isArray(H)?H[0]:H,imageUrl:Array.isArray(A)?A[0]:A,imageAlt:Array.isArray(l)?l[0]:l,taxonomy:Array.isArray(I)?I[0]:I,taxonomyUrl:Array.isArray(Q)?Q[0]:Q,type:Array.isArray(N)?N[0]:N,videoUrl:Array.isArray(V)?V[0]:V,date:Array.isArray(T)?T[0]:T,authorDisplayName:Array.isArray(O)?O[0]:O,authorAvatar:Array.isArray(E)?E[0]:E,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(g)?g[0]:g,isTeaser:Array.isArray(h)?h[0]:h,storySource:Array.isArray(C)?C[0]:C}}function Ke({offsetNum:e,pageNumber:t,index:s}){return`
        <button
            data-offset="${e}"
    ...
    `}function et({pageNumber:e,allResults:t,resultsPerPage:s,paginationRange:r}){const a=Math.ceil(t/s),i=r,n=e-s,o=e+s,u="su-text-black-50",p=[],d=[];let c=1;for(let h=0;h<a;h++){const C=h*s+1;d.push(C)}let f=[...d],g=[...d];const l=d.indexOf(c),L=Math.floor(i*.5);if((l<L||a===i)&&(f=f.filter((h,C)=>h>c&&C<i),g=g.filter(h=>h<c)),l>=L&&a!==i)if(f=f.filter((h,C)=>h>c&&C<=l+L),f.length===L)g=g.filter((h,C)=>h<c&&C>=l-L);else{const h=f.length?i-f.length:i;g=g.filter((C,S)=>C<c&&S>l-h)}return[...g,c,...f].map(h=>({offset:h,index:d.indexOf(h)+1})).forEach(({offset:h,index:C})=>{p.push(Ke({offsetNum:h,pageNumber:e,index:C}))}),a>1?`<div class="su-mx-auto su-component-container">
                <div class="su-flex su-gap-9 su-items-center su-justify-center su-rs-mt-4 lg:su-rs-mt-7">
                    <button
                        type="button"
                        class="su-size-24 su-font-serif su-flex su-items-center su-justify-center dark:su-text-white ${n<1?u:""}"
                        ${n<1?"disabled":""}
                        data-offset="${n<1?1:n}"
            ...
            </div>`:""}function tt(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var a1={exports:{}},m={},n1={exports:{}},$={};function Z1(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function st(e,t,s){}function rt(e,t,s){}var at=/javascript\s*\:/img;function nt(e,t){return at.test(t)?"":t}$.whiteList=Z1();$.getDefaultWhiteList=Z1;$.onAttr=st;$.onIgnoreAttr=rt;$.safeAttrValue=nt;var it={indexOf:function(e,t){var s,r;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,r=e.length;s<r;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var r,a;if(Array.prototype.forEach)return e.forEach(t,s);for(r=0,a=e.length;r<a;r++)t.call(s,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},B=it;function ot(e,t){e=B.trimRight(e),e[e.length-1]!==";"&&(e+=";");var s=e.length,r=!1,a=0,i=0,n="";function o(){if(!r){var d=B.trim(e.slice(a,i)),c=d.indexOf(":");if(c!==-1){var f=B.trim(d.slice(0,c)),g=B.trim(d.slice(c+1));if(f){var l=t(a,n.length,f,g,d);l&&(n+=l+"; ")}}}a=i+1}for(;i<s;i++){var u=e[i];if(u==="/"&&e[i+1]==="*"){var p=e.indexOf("*/",i+2);if(p===-1)break;i=p+1,a=i+1,r=!1}else u==="("?r=!0:u===")"?r=!1:u===";"?r||o():u===`
`&&o()}return B.trim(n)}var lt=ot,G=$,ut=lt;function g1(e){return e==null}function dt(e){var t={};for(var s in e)t[s]=e[s];return t}function D1(e){e=dt(e||{}),e.whiteList=e.whiteList||G.whiteList,e.onAttr=e.onAttr||G.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||G.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||G.safeAttrValue,this.options=e}D1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,r=s.whiteList,a=s.onAttr,i=s.onIgnoreAttr,n=s.safeAttrValue,o=ut(e,function(u,p,d,c,f){var g=r[d],l=!1;if(g===!0?l=g:typeof g=="function"?l=g(c):g instanceof RegExp&&(l=g.test(c)),l!==!0&&(l=!1),c=n(d,c),!!c){var L={position:p,sourcePosition:u,source:f,isWhite:l};if(l){var v=a(d,c,L);return g1(v)?d+":"+c:v}else{var v=i(d,c,L);if(!g1(v))return v}}});return o};var ct=D1;(function(e,t){var s=$,r=ct;function a(n,o){var u=new r(o);return u.process(n)}t=e.exports=a,t.FilterCSS=r;for(var i in s)t[i]=s[i];typeof window<"u"&&(window.filterCSS=e.exports)})(n1,n1.exports);var o1=n1.exports,l1={indexOf:function(e,t){var s,r;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,r=e.length;s<r;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var r,a;if(Array.prototype.forEach)return e.forEach(t,s);for(r=0,a=e.length;r<a;r++)t.call(s,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,s=t.exec(e);return s?s.index:-1}},ft=o1.FilterCSS,pt=o1.getDefaultWhiteList,j=l1;function N1(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var B1=new ft;function gt(e,t,s){}function Ct(e,t,s){}function ht(e,t,s){}function vt(e,t,s){}function q1(e){return e.replace(wt,"&lt;").replace(Lt,"&gt;")}function mt(e,t,s,r){if(s=F1(s),t==="href"||t==="src"){if(s=j.trim(s),s==="#")return"#";if(!(s.substr(0,7)==="http://"||s.substr(0,8)==="https://"||s.substr(0,7)==="mailto:"||s.substr(0,4)==="tel:"||s.substr(0,11)==="data:image/"||s.substr(0,6)==="ftp://"||s.substr(0,2)==="./"||s.substr(0,3)==="../"||s[0]==="#"||s[0]==="/"))return""}else if(t==="background"){if(U.lastIndex=0,U.test(s))return""}else if(t==="style"){if(C1.lastIndex=0,C1.test(s)||(h1.lastIndex=0,h1.test(s)&&(U.lastIndex=0,U.test(s))))return"";r!==!1&&(r=r||B1,s=r.process(s))}return s=W1(s),s}var wt=/</g,Lt=/>/g,bt=/"/g,yt=/&quot;/g,xt=/&#([a-zA-Z0-9]*);?/gim,At=/&colon;?/gim,St=/&newline;?/gim,U=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,C1=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,h1=/u\s*r\s*l\s*\(.*/gi;function P1(e){return e.replace(bt,"&quot;")}function R1(e){return e.replace(yt,'"')}function G1(e){return e.replace(xt,function(s,r){return r[0]==="x"||r[0]==="X"?String.fromCharCode(parseInt(r.substr(1),16)):String.fromCharCode(parseInt(r,10))})}function U1(e){return e.replace(At,":").replace(St," ")}function z1(e){for(var t="",s=0,r=e.length;s<r;s++)t+=e.charCodeAt(s)<32?" ":e.charAt(s);return j.trim(t)}function F1(e){return e=R1(e),e=G1(e),e=U1(e),e=z1(e),e}function W1(e){return e=P1(e),e=q1(e),e}function Et(){return""}function Mt(e,t){typeof t!="function"&&(t=function(){});var s=!Array.isArray(e);function r(n){return s?!0:j.indexOf(e,n)!==-1}var a=[],i=!1;return{onIgnoreTag:function(n,o,u){if(r(n))if(u.isClosing){var p="[/removed]",d=u.position+p.length;return a.push([i!==!1?i:u.position,d]),i=!1,p}else return i||(i=u.position),"[removed]";else return t(n,o,u)},remove:function(n){var o="",u=0;return j.forEach(a,function(p){o+=n.slice(u,p[0]),u=p[1]}),o+=n.slice(u),o}}}function _t(e){for(var t="",s=0;s<e.length;){var r=e.indexOf("<!--",s);if(r===-1){t+=e.slice(s);break}t+=e.slice(s,r);var a=e.indexOf("-->",r);if(a===-1)break;s=a+3}return t}function kt(e){var t=e.split("");return t=t.filter(function(s){var r=s.charCodeAt(0);return r===127?!1:r<=31?r===10||r===13:!0}),t.join("")}m.whiteList=N1();m.getDefaultWhiteList=N1;m.onTag=gt;m.onIgnoreTag=Ct;m.onTagAttr=ht;m.onIgnoreTagAttr=vt;m.safeAttrValue=mt;m.escapeHtml=q1;m.escapeQuote=P1;m.unescapeQuote=R1;m.escapeHtmlEntities=G1;m.escapeDangerHtml5Entities=U1;m.clearNonPrintableCharacter=z1;m.friendlyAttrValue=F1;m.escapeAttrValue=W1;m.onIgnoreTagStripAll=Et;m.StripTagBody=Mt;m.stripCommentTag=_t;m.stripBlankChar=kt;m.attributeWrapSign='"';m.cssFilter=B1;m.getDefaultCSSWhiteList=pt;var X={},k=l1;function Vt(e){var t=k.spaceIndex(e),s;return t===-1?s=e.slice(1,-1):s=e.slice(1,t+1),s=k.trim(s).toLowerCase(),s.slice(0,1)==="/"&&(s=s.slice(1)),s.slice(-1)==="/"&&(s=s.slice(0,-1)),s}function It(e){return e.slice(0,2)==="</"}function $t(e,t,s){var r="",a=0,i=!1,n=!1,o=0,u=e.length,p="",d="";e:for(o=0;o<u;o++){var c=e.charAt(o);if(i===!1){if(c==="<"){i=o;continue}}else if(n===!1){if(c==="<"){r+=s(e.slice(a,o)),i=o,a=o;continue}if(c===">"||o===u-1){r+=s(e.slice(a,i)),d=e.slice(i,o+1),p=Vt(d),r+=t(i,r.length,p,d,It(d)),a=o+1,i=!1;continue}if(c==='"'||c==="'")for(var f=1,g=e.charAt(o-f);g.trim()===""||g==="=";){if(g==="="){n=c;continue e}g=e.charAt(o-++f)}}else if(c===n){n=!1;continue}}return a<u&&(r+=s(e.substr(a))),r}var Tt=/[^a-zA-Z0-9\\_:.-]/gim;function Ht(e,t){var s=0,r=0,a=[],i=!1,n=e.length;function o(f,g){if(f=k.trim(f),f=f.replace(Tt,"").toLowerCase(),!(f.length<1)){var l=t(f,g||"");l&&a.push(l)}}for(var u=0;u<n;u++){var p=e.charAt(u),d,c;if(i===!1&&p==="="){i=e.slice(s,u),s=u+1,r=e.charAt(s)==='"'||e.charAt(s)==="'"?s:Zt(e,u+1);continue}if(i!==!1&&u===r){if(c=e.indexOf(p,u+1),c===-1)break;d=k.trim(e.slice(r+1,c)),o(i,d),i=!1,u=c,s=u+1;continue}if(/\s|\n|\t/.test(p))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(c=Ot(e,u),c===-1){d=k.trim(e.slice(s,u)),o(d),i=!1,s=u+1;continue}else{u=c-1;continue}else if(c=Dt(e,u-1),c===-1){d=k.trim(e.slice(s,u)),d=v1(d),o(i,d),i=!1,s=u+1;continue}else continue}return s<e.length&&(i===!1?o(e.slice(s)):o(i,v1(k.trim(e.slice(s))))),k.trim(a.join(" "))}function Ot(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="="?t:-1}}function Zt(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="'"||s==='"'?t:-1}}function Dt(e,t){for(;t>0;t--){var s=e[t];if(s!==" ")return s==="="?t:-1}}function Nt(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function v1(e){return Nt(e)?e.substr(1,e.length-2):e}X.parseTag=$t;X.parseAttr=Ht;var Bt=o1.FilterCSS,x=m,j1=X,qt=j1.parseTag,Pt=j1.parseAttr,W=l1;function z(e){return e==null}function Rt(e){var t=W.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=W.trim(e.slice(t+1,-1));var s=e[e.length-1]==="/";return s&&(e=W.trim(e.slice(0,-1))),{html:e,closing:s}}function Gt(e){var t={};for(var s in e)t[s]=e[s];return t}function Ut(e){var t={};for(var s in e)Array.isArray(e[s])?t[s.toLowerCase()]=e[s].map(function(r){return r.toLowerCase()}):t[s.toLowerCase()]=e[s];return t}function X1(e){e=Gt(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=x.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=Ut(e.whiteList||e.allowList):e.whiteList=x.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":x.attributeWrapSign,e.onTag=e.onTag||x.onTag,e.onTagAttr=e.onTagAttr||x.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||x.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||x.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||x.safeAttrValue,e.escapeHtml=e.escapeHtml||x.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Bt(e.css))}X1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,r=s.whiteList,a=s.onTag,i=s.onIgnoreTag,n=s.onTagAttr,o=s.onIgnoreTagAttr,u=s.safeAttrValue,p=s.escapeHtml,d=t.attributeWrapSign,c=t.cssFilter;s.stripBlankChar&&(e=x.stripBlankChar(e)),s.allowCommentTag||(e=x.stripCommentTag(e));var f=!1;s.stripIgnoreTagBody&&(f=x.StripTagBody(s.stripIgnoreTagBody,i),i=f.onIgnoreTag);var g=qt(e,function(l,L,v,w,h){var C={sourcePosition:l,position:L,isClosing:h,isWhite:Object.prototype.hasOwnProperty.call(r,v)},S=a(v,w,C);if(!z(S))return S;if(C.isWhite){if(C.isClosing)return"</"+v+">";var T=Rt(w),H=r[v],O=Pt(T.html,function(E,A){var V=W.indexOf(H,E)!==-1,_=n(v,E,A,V);return z(_)?V?(A=u(v,E,A,c),A?E+"="+d+A+d:E):(_=o(v,E,A,V),z(_)?void 0:_):_});return w="<"+v,O&&(w+=" "+O),T.closing&&(w+=" /"),w+=">",w}else return S=i(v,w,C),z(S)?p(w):S},p);return f&&(g=f.remove(g)),g};var zt=X1;(function(e,t){var s=m,r=X,a=zt;function i(o,u){var p=new a(u);return p.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=a,function(){for(var o in s)t[o]=s[o];for(var u in r)t[u]=r[u]}(),typeof window<"u"&&(window.filterXSS=e.exports);function n(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}n()&&(self.filterXSS=e.exports)})(a1,a1.exports);var Ft=a1.exports;const M=tt(Ft);var Wt=Array.isArray,Q1=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var s=void 0;if(Wt(e))for(var r=0,a=e.length;r<a;)s=Q1(e[r++]),s&&(t&&(t+=" "),t+=s);else for(s in e)s&&e[s]&&(t&&(t+=" "),t+=s)}return t};function Y1(){for(var e=arguments.length,t=0,s,r,a="";t<e;)s=arguments[t++],s&&(r=Q1(s),r&&(a&&(a+=" "),a+=r));return a}function m1({children:e="",imageUrl:t,imageAlt:s="",aspectRatio:r="card-small",videoUrl:a}){return`
    <span
  ...
  `}const jt={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function w1({imageUrl:e,alt:t="",aspectRatio:s,videoUrl:r,size:a="small",title:i="",videoIconClasses:n,uniqueId:o}){if(r){const u=`
        ...
        ${r?`
          <span
            class="${Y1("su-absolute su-leading-none",a==="vertical-video"&&"su-z-30",jt[a],n)}">
  ...
  `}function Xt(e,t){if(!t)return!0;const s=e.match(/(\d+-\d+-\d+)/)[0],r=t.match(/(\d+-\d+-\d+)/)[0];return s===r}function Qt({start:e,end:t}){if(!e&&!t)return null;const s=new Date(e),r=t?new Date(t):null,a={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const n=Xt(e,t);n||(delete a.time,delete a.hour,delete a.minute);const o=new Intl.DateTimeFormat("en-US",a).format(s),u=t?new Intl.DateTimeFormat("en-US",a).format(r):"";return n?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${u}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function Yt(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Kt="light";function J({variant:e=Kt}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function t5({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    </svg>`}const y1="solid";function l5({variant:e=y1}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
    ...
    </svg>`}const u5="light";function x1({variant:e=u5}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const b={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},v5={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function m5({data:{title:e,description:t,liveUrl:s,imageUrl:r,imageAlt:a,taxonomy:i,taxonomyUrl:n,type:o,date:u,endDate:p,videoUrl:d,uniqueID:c},cardSize:f="small"}){const g=v5[f],l=new Map;return l.set("alert",Yt()),l.set("analysis & insights",Y()),l.set("analysis &amp; insights",Y()),l.set("analysis&nbsp;&amp;&nbsp;insights",Y()),l.set("case study",J({variant:"light"})),l.set("case&nbsp;study",J({variant:"light"})),l.set("casestudy",J({variant:"light"})),l.set("event",s5()),l.set("event&nbsp;highlights",L1()),l.set("event highlights",L1()),l.set("feature",r5()),l.set("infographic",a5()),l.set("in&nbsp;the&nbsp;news",K()),l.set("in the news",K()),l.set("inthenews",K()),l.set("leadership&nbsp;messages",b1()),l.set("leadership messages",b1()),l.set("obituary",n5()),l.set("opinion",i5()),l.set("photo",o5()),l.set("policy&nbsp;brief",x1({variant:"light"})),l.set("policy brief",x1({variant:"light"})),l.set("poll/quiz",e1()),l.set("poll / quiz",e1()),l.set("poll&nbsp;/&nbsp;quiz",e1()),l.set("profile",d5()),l.set("research",c5()),l.set("solutions",f5()),l.set("survey",p5()),l.set("timeline",g5()),l.set("tips & takeaways",t1()),l.set("tips &amp; takeaways",t1()),l.set("tips&nbsp;&amp;&nbsp;takeaways",t1()),l.set("university&nbsp;updates",A1()),l.set("university updates",A1()),l.set("announcement",Jt()),l.set("news",e5()),l.set("q&amp;a",F()),l.set("q&a",F()),l.set("q & a",F()),l.set("q&nbsp;&amp;&nbsp;a",F()),l.set("video",C5()),l.set("podcast",l5({variant:"light"})),l.set("book",t5({className:""})),`
  ...
  `}function s1(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function w5({image:e,avatarSize:t="small",alt:s=""}){const r=new Map;r.set("small","su-min-w-[56px] su-w-[56px] su-h-[56px] su-p-3"),r.set("medium","su-min-w-[165px] su-w-[165px] su-h-[165px] su-p-7"),r.set("large","su-min-w-[218px] su-w-[218px] su-h-[218px] su-p-9");const a=new Map;return a.set("small","su-w-50 su-h-50 su-top-3 su-left-3"),a.set("medium","su-size-150 su-top-7 su-left-8"),a.set("large","su-size-200 su-top-9 su-left-9"),e?`
    <div
      data-test="size-${t}"
      ...
      <div class="${y.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${y.authorWrapper} ${l}">
            ${g?`
              ${w5({image:g,avatarSize:"small",alt:`Photo of ${n}`})}
            `:""}
            ${w}
          </div>
        `:""}
  ...
  `}function y5(e){const{videoId:t,className:s="",noAutoPlay:r,title:a,isVertical:i}=e;return`
        <iframe
            width="${i?315:560}"
            height="${i?560:315}"
            class="${s}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const x5='section[data-component="topic-subtopic-listing"]',A5='[data-element="topics-list"]',J1='[data-element="topics-pagination"]',K1="su-hidden",S5='section[data-element="modal-wrapper"]',E5='button[data-click="open-modal"]',M5='button[data-dismiss="modal"]',ee='iframe[data-modal="iframe"]';function _5(e){const t=e.querySelector(ee),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(K1),e.hidden=!1}function S1(e){const t=e.querySelector(ee),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(K1),e.hidden=!0}function te(e){const t=e.querySelectorAll(E5),s=e.querySelectorAll(M5);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&_5(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){S1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&S1(r)})}async function k5(e){const{offset:t,query:s,endpoint:r}=e,a=r+s+`&start_rank=${t}`;return await(await fetch(a).catch(o=>{throw new Error(o)})).json()}function V5(e,t,s,r){e.querySelector(A5).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(J1).innerHTML=s,e.querySelector(S5).innerHTML=r;const a=-100-60,i=e.getBoundingClientRect().top+window.pageYOffset+a;window.scrollTo({top:i,behavior:"smooth"}),te(e),se(e)}async function I5(e){var f,g,l,L,v;const{offset:t,query:s,endpoint:r,display:a,section:i}=e,n=await k5({offset:t,query:s,endpoint:r}),o=(g=(f=n==null?void 0:n.response)==null?void 0:f.resultPacket)==null?void 0:g.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const u=[],p=[];(v=(L=(l=n==null?void 0:n.response)==null?void 0:l.resultPacket)==null?void 0:L.results)==null||v.forEach(w=>{const h=Ye(),C=Je(w);C.uniqueID=h,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(a)?(C.displayConfiguration=a,u.push(`<div class="su-relative su-grow">${b5({data:C,cardType:"narrowhorizontal"})}</div>`)):u.push(`<div class="su-relative su-grow">${m5({data:C,cardType:"horizontal",cardSize:"large"})}</div>`),(C.type==="Video"||C.videoUrl)&&p.push({isVertical:C.size==="vertical-video",videoId:C.videoUrl,title:`Watch ${C.title}`,noAutoPlay:!0,uniqueID:C.uniqueID,titleID:"card-modal"})});const d=et({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),c=p.map(w=>`
        ...
        `).join("");V5(i,u.join(""),d,c)}function se(e){const{query:t,endpoint:s,display:r}=e.dataset,a=e.querySelector(J1);if(!a)return;a.querySelectorAll("button").forEach(n=>{n.addEventListener("click",()=>{if(n.disabled)return;const o=n.getAttribute("data-offset");I5({offset:o,query:t,endpoint:s,display:r,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(x5).forEach(e=>{te(e),se(e)})});const $5='section[data-component="vertical-video-panel"]',re="su-hidden",T5='button[data-click="open-modal"]',H5='button[data-dismiss="modal"]',ae='iframe[data-modal="iframe"]';function O5(e){const t=e.querySelector(ae),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(re),e.hidden=!1}function E1(e){const t=e.querySelector(ae),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(re),e.hidden=!0}function Z5(e){const t=e.querySelectorAll(T5),s=e.querySelectorAll(H5);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&O5(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){E1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&E1(r)})}function D5(e){const t=e.dataset.uniqueId,s=new q(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{Z(n),n.slidePrev()},resize:n=>{Z(n)},paginationUpdate:n=>{i1(n)}}}),r=s.slides.length,a=s.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(r-a)>1&&(s.on("slideChange",function(){setTimeout(()=>{D(s,"h2 a, h3 a, button",!0)},100)}),D(s,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll($5).forEach(e=>{D5(e),Z5(e)})});
