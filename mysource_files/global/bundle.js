import G from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const De=typeof window>"u"?{}:window;function _t(e=De){return e.document!==void 0}function Ze(e,t=De){if(!_t(t))return null;const{document:n}=t,{cookie:s}=n;if(typeof s!="string")return null;const r=s.split("; ");let i=null;return r.find(a=>{const[o,l]=a.split("=");return o===e&&l!==""&&(i=l),null}),i}const Se="su-hidden";function Ae(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')};Object.values(t).forEach(n=>{n==null||n.forEach(s=>{s.classList.add(Se)})}),t[e]&&t[e].forEach(n=>{n.classList.remove(Se)})}document.addEventListener("DOMContentLoaded",function(){const e=Ze("preferences_personalisation");Ae(e==="null"||!e?"external":e)});function Pe(e){if(!e)return 0;const t=225,n=e.trim().split(/\s+/).length;return Math.ceil(n/t)}function Mt(e,t,n,s=()=>{}){const r=e.slides.length;let i=t-r+1;r%n!==0&&(i+=n-r%n);const a=document.createDocumentFragment(),o=e.slides.map(l=>l.outerHTML).join("");for(let l=0;l<i;l++){const f=document.createElement("div");for(f.innerHTML=o;f.firstChild;)f.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(f.firstChild)}e.wrapperEl.appendChild(a),e.update(),I(e,"",!1),s()}function B(e,t=()=>{}){const{slidesPerView:n,slidesPerGroup:s}=e.params,r=e.slides.length,i=Math.ceil(n+s);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<i||r%s!==0?Mt(e,i,s,t):(I(e,"",!1),t())}function Le(e){const t=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(t){let n=e.pagination.bullets.length-e.slides.length+t;for(;n>0;){const s=e.pagination.bullets.pop();s&&s.remove(),n--}}}const I=(e,t,n)=>{e.slides.forEach(s=>{if(s.classList.contains("swiper-slide-active")){if(s.removeAttribute("aria-hidden"),s.removeAttribute("inert"),s.setAttribute("tabindex","-1"),t&&n){let r=null;t==="slide"?r=s:r=s.querySelector(t),r&&r.focus()}}else s.setAttribute("aria-hidden","true"),s.setAttribute("inert","true"),s.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(s=>{s.classList.contains("swiper-pagination-bullet-active")?s.setAttribute("aria-current","true"):s.removeAttribute("aria-current")})},It='section[data-component="basic-story-hero"]',Tt='span[data-reading="true"]',Ge="su-hidden",kt='button[data-click="open-modal"]',$t='button[data-dismiss="modal"]',Ue='iframe[data-modal="iframe"]';function Vt(e){const t=e.querySelector(Ue);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(Ge),e.hidden=!1,document.body.style.overflow="hidden"}function se(e){const t=e.querySelector(Ue);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(Ge),e.hidden=!0,document.body.style.overflow=""}function Ht(e){const t=e.querySelectorAll(kt),n=e.querySelectorAll($t);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||se(s)}),s.dataset.listenerAdded="true"),Vt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&se(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&se(s)})}function Ot(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new G(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{B(a),I(a,"",!1)},resize:a=>{B(a)},paginationUpdate:a=>{Le(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?I(i,"slide",!0):I(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}function qt(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(Tt);if(t&&n){const s=Pe(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(It).forEach(e=>{Ot(e),Ht(e),qt(e)})});const Nt='section[data-component="combined-content-grid"]',Fe="su-hidden",Bt='button[data-click="open-modal"]',Rt='button[data-dismiss="modal"]',ze='iframe[data-modal="iframe"]';function Dt(e){const t=e.querySelector(ze),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Fe),e.hidden=!1,document.body.style.overflow="hidden"}function ne(e){const t=e.querySelector(ze),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Fe),e.hidden=!0,document.body.style.overflow=""}function Zt(e){const t=e.querySelectorAll(Bt),n=e.querySelectorAll(Rt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ne(s)}),s.dataset.listenerAdded="true"),Dt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ne(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ne(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Nt).forEach(e=>{Zt(e)})});const Pt='section[data-component="content-carousel"]';function Gt(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new G(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{B(a),I(a,"",!1)},resize:a=>{B(a)},paginationUpdate:a=>{Le(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?I(i,"slide",!0):I(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Pt).forEach(e=>{Gt(e)})});const Ut='section[data-component="feature-story-hero"]',Ft='span[data-reading="true"]';function zt(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(Ft);if(t&&n){const s=Pe(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ut).forEach(e=>{zt(e)})});const Wt='section[data-component="featured-content"]',We="su-hidden",jt='button[data-click="open-modal"]',Xt='button[data-dismiss="modal"]',je='iframe[data-modal="iframe"]';function Yt(e){const t=e.querySelector(je),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(We),e.hidden=!1,document.body.style.overflow="hidden"}function re(e){const t=e.querySelector(je),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(We),e.hidden=!0,document.body.style.overflow=""}function Qt(e){const t=e.querySelectorAll(jt),n=e.querySelectorAll(Xt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||re(s)}),s.dataset.listenerAdded="true"),Yt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&re(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&re(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Wt).forEach(e=>{Qt(e)})});const Kt='section[data-component="image-gallery-modal"]',Jt='button[data-click="open-gallery-modal"]',e1='div[data-modal="modal"]',t1='button[data-dismiss="modal"]',Xe="su-hidden";let ve;const s1=(e,t)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function n1(e){e.classList.remove(Xe),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&s1(t,e)})}function ae(e){e.classList.add(Xe),e.hidden=!0,document.body.style.overflow=""}function r1(e){const t=e.dataset.modalId;ve=new G(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function a1(e){const t=e.querySelector(e1),n=e.querySelector(Jt),s=e.querySelector(t1);n&&n.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",i=>{r.contains(i.target)||ae(t)}),t.dataset.listenerAdded="true"),n1(t),r1(t)}),s&&s.addEventListener("click",function(){ae(t),ve.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(ae(t),ve.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Kt).forEach(e=>{a1(e)})});class i1{constructor(t,n){this.url=t,this.type=n,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const s=this.assetIds.map(async r=>{const i=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(i,this.requestProps).catch(l=>{throw new Error(l)})).json()});return Promise.all(s)}return await(await fetch(this.url,this.requestProps).catch(s=>{throw new Error(s)})).json()}}function o1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:n,summary:s,image:r,taxonomyContentTypeText:i,contentTopic:a,contentSubtopic:o,taxonomyContentMainTopicText:l,contentCategory:f,featuredVideo:p,taxonomyContentMainTopicLandingPageUrl:d,taxonomyFeaturedUnitLandingPageUrl:c,taxonomyFeaturedUnitText:C,imageAlt:u,authorName:y,authorImage:h,author:v,isTeaser:m,storySource:g,assetHref:E},date:$,liveUrl:V}){const H=y!==void 0?y:v,S=h!==""?h:void 0,M=r&&r!==""?r:null,L=u&&u!==""?u:"",T=p,R=n||s;let O=l;!O&&a&&(O=a instanceof Array?a[0]:a),!O&&o&&(O=o instanceof Array?o[0]:o);const te=d;let D=i?i[0]:"";return!D&&f&&(D=f instanceof Array?f[0]:f),E&&t[0]==="link"&&(V=E),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(R)?R[0]:R,liveUrl:Array.isArray(V)?V[0]:V,imageUrl:Array.isArray(M)?M[0]:M,imageAlt:Array.isArray(L)?L[0]:L,taxonomy:Array.isArray(O)?O[0]:O,taxonomyUrl:Array.isArray(te)?te[0]:te,type:Array.isArray(D)?D[0]:D,videoUrl:Array.isArray(T)?T[0]:T,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(H)?H[0]:H,authorAvatar:Array.isArray(S)?S[0]:S,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(c)?c[0]:c,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(m)?m[0]:m,storySource:Array.isArray(g)?g[0]:g}}function ie(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function Ye(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}function l1(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}const u1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(t+s)%16|0,t=Math.floor(t/16)),(n==="x"?s:s&3|8).toString(16)})},d1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),c1=()=>typeof crypto<"u"?d1():u1();async function f1(e=null,t="",n=null){var r,i,a,o,l,f,p,d,c,C,u,y,h,v,m,g,E,$,V;const s=new i1;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const H=`
            ...
            &meta_taxonomyAudienceText=${l1(t)}&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;let S=H;n&&(n!=null&&n.behavioural)&&(S=`${(p=(f=e==null?void 0:e.search)==null?void 0:f.endpoint)==null?void 0:p.replace(/\.html/g,".json")}
                ?profile=${(d=e==null?void 0:e.search)==null?void 0:d.profile}
                &collection=${(c=e==null?void 0:e.search)==null?void 0:c.collection}${n.partialQuery}&num_ranks=3&log=false&meta_isTeaser=false`),s.url=S.replace(/\n+|\t+| {2,}/g,"");let L=((u=(C=(await s.fetch()).response)==null?void 0:C.resultPacket)==null?void 0:u.results)||null;if(L&&L.length<3&&(s.url=H.replace(/\n+|\t+| {2,}/g,""),L=((h=(y=(await s.fetch()).response)==null?void 0:y.resultPacket)==null?void 0:h.results)||null,L&&L.length<3)){const R=`${(m=(v=e==null?void 0:e.search)==null?void 0:v.endpoint)==null?void 0:m.replace(/\.html/g,".json")}
                    ?profile=${(g=e==null?void 0:e.search)==null?void 0:g.profile}
                    &collection=${(E=e==null?void 0:e.search)==null?void 0:E.collection}&query_not=[taxonomyContentTypeId:28210 taxonomyContentTypeId:28216 taxonomyContentTypeId:28201 id:${e.id}]&num_ranks=3&sort=date&log=false&meta_isTeaser=false`;s.url=R.replace(/\n+|\t+| {2,}/g,""),L=((V=($=(await s.fetch()).response)==null?void 0:$.resultPacket)==null?void 0:V.results)||null}return L}return null}const oe={WRAPPER:'[data-role="link-list-wrap"]',TOGGLE:'[data-role="link-drawer-toggle"]',DRAWER:'[data-role="link-drawer"]'},b={ACTIVE:"su-rotate-90",INACTIVE:"su-rotate-[-90deg]",OPEN:"su-h-auto",CLOSED:"su-h-0",VISIBLE:"su-opacity-[1]",HIDDEN:"su-opacity-[0]",NO_STORIES:"su-link-list-no-stories"};function p1(e,t){var s;if(!(((s=e==null?void 0:e.dataset)==null?void 0:s.active)==="true")){e.dataset.active=!0,e.classList.remove(b.INACTIVE),e.classList.add(b.ACTIVE),t.classList.remove(b.CLOSED),t.classList.add(b.OPEN);return}e.dataset.active=!1,e.classList.add(b.INACTIVE),e.classList.remove(b.ACTIVE),t.classList.add(b.CLOSED),t.classList.remove(b.OPEN)}function C1(e){const t=document.body.getBoundingClientRect().height,n=window.scrollY+window.innerHeight;if(window.scrollY>=Math.round(30/100*document.body.clientHeight)&&n<=t-700){e.classList.remove(b.HIDDEN),e.classList.remove("su-bottom-[-100px]"),e.classList.add(b.VISIBLE),e.classList.add("su-bottom-0");return}e.classList.remove(b.VISIBLE),e.classList.add("su-bottom-[-100px]"),e.classList.add(b.HIDDEN),e.classList.remove("su-bottom-0")}function g1(e,t){return`
    ...
    `}function m1(e,t,n){if(!e.length){t.classList.add(b.NO_STORIES);return}const[s,r,i]=e;n.innerHTML=`
    ...
    `,t.classList.remove(b.NO_STORIES)}async function h1(e,t,n,s,r,i){const o=(await f1(e,i,t)).map(({title:l,indexUrl:f})=>g1(l,f));m1(o,n,r),v1(n,s,r)}function v1(e,t,n){t.addEventListener("click",function(){p1(t,n)}),window.addEventListener("scroll",function(){C1(e)})}function w1(e,t,n,s){if(!e||!window.pageController)return;const r=window.pageController,i=r.topicsQuery?r.topicsQuery():null;h1(r,i,e,t,n,s)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(oe.WRAPPER),t=document.querySelector(oe.TOGGLE),n=document.querySelector(oe.DRAWER),s=Ze("preferences_personalisation");w1(e,t,n,s)});const y1='section[data-component="media-carousel"]';function L1(e){const t=e.dataset.uniqueId,n=new G(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{B(a),I(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{B(a)},paginationUpdate:a=>{Le(a)}}}),s=n.slides.length,r=n.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(s-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),n.on("slideChange",function(){setTimeout(()=>{a?I(n,"h2 a, h3 a, button",!0):I(n,"",!1)},100)})}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(y1).forEach(e=>{L1(e)})});const b1='button[data-role="copy-link"]';function E1(e){e.addEventListener("click",function(){navigator.clipboard.writeText(window.location.href).then(()=>{const t=document.querySelector("[data-copy-text]");t.textContent="Copied",setTimeout(()=>{t.textContent="Copy link"},3e3)})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(b1).forEach(e=>{E1(e)})});const S1='section[data-component="multicolumn-listing"]',Qe="su-hidden",A1='button[data-click="open-modal"]',x1='button[data-dismiss="modal"]',Ke='iframe[data-modal="iframe"]';function _1(e){const t=e.querySelector(Ke),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Qe),e.hidden=!1,document.body.style.overflow="hidden"}function le(e){const t=e.querySelector(Ke),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Qe),e.hidden=!0,document.body.style.overflow=""}function M1(e){const t=e.querySelectorAll(A1),n=e.querySelectorAll(x1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||le(s)}),s.dataset.listenerAdded="true"),_1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&le(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&le(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(S1).forEach(e=>{M1(e)})});const I1='section[data-component="sidebar-navigation"]',T1='nav[data-nav="nav"]',K="su-hidden",k1='button[data-click="toggle-nav"]',$1="su-bg-digital-red su-text-white dark:su-bg-dark-mode-red dark:aria-expanded:su-text-black-true",V1='span[data-label="button"]';function Je(e,t){const n=e.querySelector(V1),s=e.querySelector('svg[data-icon="bars"]'),r=e.querySelector('svg[data-icon="xmark"]');e.setAttribute("aria-expanded",t.toString()),$1.split(" ").forEach(i=>{e.classList.toggle(i,t)}),s&&(s.classList.toggle(`!${K}`,t),s.hidden=t),r&&(r.classList.toggle(`!${K}`,!t),r.hidden=!t),n&&(n.innerHTML=t?n.getAttribute("data-label-close"):n.getAttribute("data-label-open"))}function xe(e,t){e.classList.remove(K),e.hidden=!1,Je(t,!0)}function U(e,t){e.classList.add(K),e.hidden=!0,Je(t,!1)}function H1(e){const t=e.querySelector(k1),n=e.querySelector(T1);let s;t&&t.addEventListener("click",function(){const r=t.getAttribute("aria-expanded")==="true";n.dataset.listenerAdded||(document.addEventListener("click",i=>{const a=n.contains(i.target),o=t.contains(i.target);!a&&!o&&U(n,t)}),n.dataset.listenerAdded="true"),r?U(n,t):xe(n,t)}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&t&&U(n,t)}),window.addEventListener("resize",()=>{clearTimeout(s),s=setTimeout(()=>{window.innerWidth>991?n&&t&&xe(n,t):n&&t&&U(n,t)},10)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(I1).forEach(e=>{H1(e)})});function F(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function z(e,t){const n=e.querySelector('svg[data-control="play"]'),s=e.querySelector('svg[data-control="pause"]'),r=!t;e.setAttribute("aria-pressed",String(r)),n.classList.toggle("su-hidden",r),n.hidden=r,s.classList.toggle("su-hidden",!r),s.hidden=!r,e.innerHTML=`
  ...
  `}const O1='section[data-component="single-image-video"]',q1='iframe[data-role="video-player"]',N1='button[data-role="video-control"]',et="su-hidden",B1='button[data-click="open-modal"]',R1='button[data-dismiss="modal"]',tt='iframe[data-modal="iframe"]',D1=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function Z1(e){const t=e.querySelector(tt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(et),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&D1(r,e)})}function ue(e){const t=e.querySelector(tt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(et),e.hidden=!0,document.body.style.overflow=""}function P1(e){const t=e.querySelectorAll(B1),n=e.querySelectorAll(R1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ue(s)}),s.dataset.listenerAdded="true"),Z1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ue(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ue(s)})}function G1(e){const t=e.querySelector(q1),n=e.querySelector(N1);let s=!1;if(!t||!n)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!s?(F(t,"play"),z(n,!1)):a.isIntersecting||(F(t,"pause"),z(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(F(t,"pause"),z(n,!0),s=!0):(F(t,"play"),z(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(O1).forEach(e=>{P1(e),G1(e)})});const U1='section[data-component="standalone-visual-hero"]',st="su-hidden",F1='button[data-click="open-modal"]',z1='button[data-dismiss="modal"]',nt='iframe[data-modal="iframe"]';function W1(e){const t=e.querySelector(nt);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(st),e.hidden=!1,document.body.style.overflow="hidden"}function de(e){const t=e.querySelector(nt);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(st),e.hidden=!0,document.body.style.overflow=""}function j1(e){const t=e.querySelectorAll(F1),n=e.querySelectorAll(z1);let s=null;t.forEach(r=>{r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||de(s)}),s.dataset.listenerAdded="true"),W1(s)})}),n.forEach(r=>{r.addEventListener("click",function(){s&&de(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&de(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(U1).forEach(e=>{j1(e)})});const X1='section[data-component="stories-carousel"]',rt="su-hidden",Y1='button[data-click="open-modal"]',Q1='button[data-dismiss="modal"]',at='iframe[data-modal="iframe"]';let _e=!1,P=!1;function K1(e){const t=e.querySelector(at),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(rt),e.hidden=!1,document.body.style.overflow="hidden"}function ce(e){const t=e.querySelector(at),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(rt),e.hidden=!0,document.body.style.overflow=""}function J1(e){const t=e.querySelectorAll(Y1),n=e.querySelectorAll(Q1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ce(s)}),s.dataset.listenerAdded="true"),K1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ce(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ce(s)})}let Me=!1;function es(e,t){const n=e.querySelector(`.component-slider-pagination-${t}`);n&&n.addEventListener("click",function(i){i.target.classList.contains("swiper-pagination-bullet")&&(P=!0)});const s=e.querySelector(".component-slider-next"),r=e.querySelector(".component-slider-prev");s&&s.addEventListener("click",function(){P=!0}),r&&r.addEventListener("click",function(){P=!0})}function ts(e){const t=e.dataset.uniqueId,n=`section[data-unique-id="${t}"] .swiper`;new G(n,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,on:{init:function(){setTimeout(()=>{_e=!0},500),es(e,t)},slideChange:function(s){const r=document.querySelector(n),i=r.querySelector(".swiper-slide-active");i&&i.removeAttribute("tabindex"),_e&&P&&(Me=!0,setTimeout(()=>{const a=r.querySelector(".swiper-slide-active"),o=a.querySelector("h2 a, h3 a, button")?a.querySelector("h2 a, h3 a, button"):(()=>(a.setAttribute("tabindex","-1"),a))();Me&&o.focus()},300),P=!1),s.slides.forEach(a=>{a.classList.contains("swiper-slide-visible")?(a.removeAttribute("aria-hidden"),a.removeAttribute("inert")):(a.setAttribute("aria-hidden","true"),a.setAttribute("inert","true"))}),s.pagination.bullets.length>0&&s.pagination.bullets.forEach(a=>{a.classList.contains("swiper-pagination-bullet-active")?a.setAttribute("aria-current","true"):a.removeAttribute("aria-current")})}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(X1).forEach(e=>{ts(e),J1(e)})});const ss='section[data-component="subscribe-to-stanford-report"]';function ns(e){const t=e.querySelector("form"),n=t.querySelector('input[type="email"]'),s=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let i="";const a=n.value;if(!a||!a.match(/\w+@\w+\.\w+/)){i='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',s.innerHTML=i,n.setAttribute("aria-describedby","subscription-error");return}s.innerHTML="",n.removeAttribute("aria-describedby"),r.target.submit()}),n.addEventListener("keyup",function(){const r=n.value,i=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(i.innerHTML="",n.removeAttribute("aria-describedby"))})}function rs(){document.querySelectorAll(ss).forEach(e=>{ns(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",rs);function as({offsetNum:e,pageNumber:t,index:n}){return`
        <button
            data-offset="${e}"
    ...
    `}function is({pageNumber:e,allResults:t,resultsPerPage:n,paginationRange:s,currentPage:r=1}){const i=Math.ceil(t/n),a=s,o=e-n,l=e+n,f="su-text-black-50",p=[],d=[];for(let m=0;m<i;m++){const g=m*n+1;d.push(g)}let c=[...d],C=[...d];const u=d.indexOf(r),y=Math.floor(a*.5);if((u<y||i===a)&&(c=c.filter((m,g)=>m>r&&g<a),C=C.filter(m=>m<r)),u>=y&&i!==a)if(c=c.filter((m,g)=>m>r&&g<=u+y),c.length===y)C=C.filter((m,g)=>m<r&&g>=u-y);else{const m=c.length?a-c.length:a;C=C.filter((g,E)=>g<r&&E>u-m)}return[...C,r,...c].map(m=>({offset:m,index:d.indexOf(m)+1})).forEach(({offset:m,index:g})=>{p.push(as({offsetNum:m,pageNumber:e,index:g}))}),i>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function os(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var we={exports:{}},w={},ye={exports:{}},N={};function it(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function ls(e,t,n){}function us(e,t,n){}var ds=/javascript\s*\:/img;function cs(e,t){return ds.test(t)?"":t}N.whiteList=it();N.getDefaultWhiteList=it;N.onAttr=ls;N.onIgnoreAttr=us;N.safeAttrValue=cs;var fs={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},Z=fs;function ps(e,t){e=Z.trimRight(e),e[e.length-1]!==";"&&(e+=";");var n=e.length,s=!1,r=0,i=0,a="";function o(){if(!s){var p=Z.trim(e.slice(r,i)),d=p.indexOf(":");if(d!==-1){var c=Z.trim(p.slice(0,d)),C=Z.trim(p.slice(d+1));if(c){var u=t(r,a.length,c,C,p);u&&(a+=u+"; ")}}}r=i+1}for(;i<n;i++){var l=e[i];if(l==="/"&&e[i+1]==="*"){var f=e.indexOf("*/",i+2);if(f===-1)break;i=f+1,r=i+1,s=!1}else l==="("?s=!0:l===")"?s=!1:l===";"?s||o():l===`
`&&o()}return Z.trim(a)}var Cs=ps,W=N,gs=Cs;function Ie(e){return e==null}function ms(e){var t={};for(var n in e)t[n]=e[n];return t}function ot(e){e=ms(e||{}),e.whiteList=e.whiteList||W.whiteList,e.onAttr=e.onAttr||W.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||W.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||W.safeAttrValue,this.options=e}ot.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onAttr,i=n.onIgnoreAttr,a=n.safeAttrValue,o=gs(e,function(l,f,p,d,c){var C=s[p],u=!1;if(C===!0?u=C:typeof C=="function"?u=C(d):C instanceof RegExp&&(u=C.test(d)),u!==!0&&(u=!1),d=a(p,d),!!d){var y={position:f,sourcePosition:l,source:c,isWhite:u};if(u){var h=r(p,d,y);return Ie(h)?p+":"+d:h}else{var h=i(p,d,y);if(!Ie(h))return h}}});return o};var hs=ot;(function(e,t){var n=N,s=hs;function r(a,o){var l=new s(o);return l.process(a)}t=e.exports=r,t.FilterCSS=s;for(var i in n)t[i]=n[i];typeof window<"u"&&(window.filterCSS=e.exports)})(ye,ye.exports);var be=ye.exports,Ee={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,n=t.exec(e);return n?n.index:-1}},vs=be.FilterCSS,ws=be.getDefaultWhiteList,J=Ee;function lt(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var ut=new vs;function ys(e,t,n){}function Ls(e,t,n){}function bs(e,t,n){}function Es(e,t,n){}function dt(e){return e.replace(As,"&lt;").replace(xs,"&gt;")}function Ss(e,t,n,s){if(n=mt(n),t==="href"||t==="src"){if(n=J.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(t==="background"){if(j.lastIndex=0,j.test(n))return""}else if(t==="style"){if(Te.lastIndex=0,Te.test(n)||(ke.lastIndex=0,ke.test(n)&&(j.lastIndex=0,j.test(n))))return"";s!==!1&&(s=s||ut,n=s.process(n))}return n=ht(n),n}var As=/</g,xs=/>/g,_s=/"/g,Ms=/&quot;/g,Is=/&#([a-zA-Z0-9]*);?/gim,Ts=/&colon;?/gim,ks=/&newline;?/gim,j=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,Te=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,ke=/u\s*r\s*l\s*\(.*/gi;function ct(e){return e.replace(_s,"&quot;")}function ft(e){return e.replace(Ms,'"')}function pt(e){return e.replace(Is,function(n,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function Ct(e){return e.replace(Ts,":").replace(ks," ")}function gt(e){for(var t="",n=0,s=e.length;n<s;n++)t+=e.charCodeAt(n)<32?" ":e.charAt(n);return J.trim(t)}function mt(e){return e=ft(e),e=pt(e),e=Ct(e),e=gt(e),e}function ht(e){return e=ct(e),e=dt(e),e}function $s(){return""}function Vs(e,t){typeof t!="function"&&(t=function(){});var n=!Array.isArray(e);function s(a){return n?!0:J.indexOf(e,a)!==-1}var r=[],i=!1;return{onIgnoreTag:function(a,o,l){if(s(a))if(l.isClosing){var f="[/removed]",p=l.position+f.length;return r.push([i!==!1?i:l.position,p]),i=!1,f}else return i||(i=l.position),"[removed]";else return t(a,o,l)},remove:function(a){var o="",l=0;return J.forEach(r,function(f){o+=a.slice(l,f[0]),l=f[1]}),o+=a.slice(l),o}}}function Hs(e){for(var t="",n=0;n<e.length;){var s=e.indexOf("<!--",n);if(s===-1){t+=e.slice(n);break}t+=e.slice(n,s);var r=e.indexOf("-->",s);if(r===-1)break;n=r+3}return t}function Os(e){var t=e.split("");return t=t.filter(function(n){var s=n.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),t.join("")}w.whiteList=lt();w.getDefaultWhiteList=lt;w.onTag=ys;w.onIgnoreTag=Ls;w.onTagAttr=bs;w.onIgnoreTagAttr=Es;w.safeAttrValue=Ss;w.escapeHtml=dt;w.escapeQuote=ct;w.unescapeQuote=ft;w.escapeHtmlEntities=pt;w.escapeDangerHtml5Entities=Ct;w.clearNonPrintableCharacter=gt;w.friendlyAttrValue=mt;w.escapeAttrValue=ht;w.onIgnoreTagStripAll=$s;w.StripTagBody=Vs;w.stripCommentTag=Hs;w.stripBlankChar=Os;w.attributeWrapSign='"';w.cssFilter=ut;w.getDefaultCSSWhiteList=ws;var ee={},q=Ee;function qs(e){var t=q.spaceIndex(e),n;return t===-1?n=e.slice(1,-1):n=e.slice(1,t+1),n=q.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function Ns(e){return e.slice(0,2)==="</"}function Bs(e,t,n){var s="",r=0,i=!1,a=!1,o=0,l=e.length,f="",p="";e:for(o=0;o<l;o++){var d=e.charAt(o);if(i===!1){if(d==="<"){i=o;continue}}else if(a===!1){if(d==="<"){s+=n(e.slice(r,o)),i=o,r=o;continue}if(d===">"||o===l-1){s+=n(e.slice(r,i)),p=e.slice(i,o+1),f=qs(p),s+=t(i,s.length,f,p,Ns(p)),r=o+1,i=!1;continue}if(d==='"'||d==="'")for(var c=1,C=e.charAt(o-c);C.trim()===""||C==="=";){if(C==="="){a=d;continue e}C=e.charAt(o-++c)}}else if(d===a){a=!1;continue}}return r<l&&(s+=n(e.substr(r))),s}var Rs=/[^a-zA-Z0-9\\_:.-]/gim;function Ds(e,t){var n=0,s=0,r=[],i=!1,a=e.length;function o(c,C){if(c=q.trim(c),c=c.replace(Rs,"").toLowerCase(),!(c.length<1)){var u=t(c,C||"");u&&r.push(u)}}for(var l=0;l<a;l++){var f=e.charAt(l),p,d;if(i===!1&&f==="="){i=e.slice(n,l),n=l+1,s=e.charAt(n)==='"'||e.charAt(n)==="'"?n:Ps(e,l+1);continue}if(i!==!1&&l===s){if(d=e.indexOf(f,l+1),d===-1)break;p=q.trim(e.slice(s+1,d)),o(i,p),i=!1,l=d,n=l+1;continue}if(/\s|\n|\t/.test(f))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(d=Zs(e,l),d===-1){p=q.trim(e.slice(n,l)),o(p),i=!1,n=l+1;continue}else{l=d-1;continue}else if(d=Gs(e,l-1),d===-1){p=q.trim(e.slice(n,l)),p=$e(p),o(i,p),i=!1,n=l+1;continue}else continue}return n<e.length&&(i===!1?o(e.slice(n)):o(i,$e(q.trim(e.slice(n))))),q.trim(r.join(" "))}function Zs(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Ps(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="'"||n==='"'?t:-1}}function Gs(e,t){for(;t>0;t--){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Us(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function $e(e){return Us(e)?e.substr(1,e.length-2):e}ee.parseTag=Bs;ee.parseAttr=Ds;var Fs=be.FilterCSS,_=w,vt=ee,zs=vt.parseTag,Ws=vt.parseAttr,Q=Ee;function X(e){return e==null}function js(e){var t=Q.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=Q.trim(e.slice(t+1,-1));var n=e[e.length-1]==="/";return n&&(e=Q.trim(e.slice(0,-1))),{html:e,closing:n}}function Xs(e){var t={};for(var n in e)t[n]=e[n];return t}function Ys(e){var t={};for(var n in e)Array.isArray(e[n])?t[n.toLowerCase()]=e[n].map(function(s){return s.toLowerCase()}):t[n.toLowerCase()]=e[n];return t}function wt(e){e=Xs(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=_.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=Ys(e.whiteList||e.allowList):e.whiteList=_.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":_.attributeWrapSign,e.onTag=e.onTag||_.onTag,e.onTagAttr=e.onTagAttr||_.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||_.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||_.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||_.safeAttrValue,e.escapeHtml=e.escapeHtml||_.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Fs(e.css))}wt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onTag,i=n.onIgnoreTag,a=n.onTagAttr,o=n.onIgnoreTagAttr,l=n.safeAttrValue,f=n.escapeHtml,p=t.attributeWrapSign,d=t.cssFilter;n.stripBlankChar&&(e=_.stripBlankChar(e)),n.allowCommentTag||(e=_.stripCommentTag(e));var c=!1;n.stripIgnoreTagBody&&(c=_.StripTagBody(n.stripIgnoreTagBody,i),i=c.onIgnoreTag);var C=zs(e,function(u,y,h,v,m){var g={sourcePosition:u,position:y,isClosing:m,isWhite:Object.prototype.hasOwnProperty.call(s,h)},E=r(h,v,g);if(!X(E))return E;if(g.isWhite){if(g.isClosing)return"</"+h+">";var $=js(v),V=s[h],H=Ws($.html,function(S,M){var L=Q.indexOf(V,S)!==-1,T=a(h,S,M,L);return X(T)?L?(M=l(h,S,M,d),M?S+"="+p+M+p:S):(T=o(h,S,M,L),X(T)?void 0:T):T});return v="<"+h,H&&(v+=" "+H),$.closing&&(v+=" /"),v+=">",v}else return E=i(h,v,g),X(E)?f(v):E},f);return c&&(C=c.remove(C)),C};var Qs=wt;(function(e,t){var n=w,s=ee,r=Qs;function i(o,l){var f=new r(l);return f.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=r,function(){for(var o in n)t[o]=n[o];for(var l in s)t[l]=s[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(we,we.exports);var Ks=we.exports;const k=os(Ks);var Js=Array.isArray,yt=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var n=void 0;if(Js(e))for(var s=0,r=e.length;s<r;)n=yt(e[s++]),n&&(t&&(t+=" "),t+=n);else for(n in e)n&&e[n]&&(t&&(t+=" "),t+=n)}return t};function Lt(){for(var e=arguments.length,t=0,n,s,r="";t<e;)n=arguments[t++],n&&(s=yt(n),s&&(r&&(r+=" "),r+=s));return r}function Ve({children:e="",imageUrl:t,imageAlt:n="",aspectRatio:s="card-small",videoUrl:r}){return`
    <span
      class="${Lt("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",s==="card-small"&&"su-aspect-[3/2]",s==="card-medium"&&"su-aspect-[3/2]",s==="card-large"&&"su-aspect-[3/2]",s==="card-featured"&&"su-aspect-[3/2]",s==="square"&&"su-aspect-[1/1]",s==="video"&&"su-aspect-[16/9]",s==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${r?`
  ...
  `}const en={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function He({imageUrl:e,alt:t="",aspectRatio:n,videoUrl:s,size:r="small",title:i="",videoIconClasses:a,uniqueId:o}){if(s){const l=`
        ${r==="vertical-video"?`
          <div
            aria-hidden="true"
        ...
        ${s?`
          <span
            class="${Lt("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",en[r],a)}">
    ...
    `;return`
      <button
        ...
        data-modal-id="${o}"
      >
        ${Ve({imageUrl:e,imageAlt:`${`Open video ${t||""} in a modal`}`,aspectRatio:n,children:l})}
      </button>
    `}return`
    <div class="su-component-card-thumbnail su-w-full su-h-full">
      ${Ve({imageUrl:e,imageAlt:t,aspectRatio:n})}
    </div>
  `}function tn(e,t){if(!t)return!0;const n=e.match(/(\d+-\d+-\d+)/)[0],s=t.match(/(\d+-\d+-\d+)/)[0];return n===s}function sn({start:e,end:t}){if(!e&&!t)return null;const n=new Date(e),s=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const a=tn(e,t);a||(delete r.time,delete r.hour,delete r.minute);const o=new Intl.DateTimeFormat("en-US",r).format(n),l=t?new Intl.DateTimeFormat("en-US",r).format(s):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function nn(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const an="light";function pe({variant:e=an}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    </svg>`}function ln({className:e}){return`
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 18 15" 
    ...
    >
    ...
    </svg>`}const Ne="solid";function gn({variant:e=Ne}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get(Ne)}function ge(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const mn="light";function Be({variant:e=mn}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const A={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},Sn={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-font-serif su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function An({data:{title:e,description:t,liveUrl:n,imageUrl:s,imageAlt:r,taxonomy:i,taxonomyUrl:a,type:o,date:l,endDate:f,videoUrl:p,uniqueID:d},cardSize:c="small"}){const C=Sn[c],u=new Map;return u.set("alert",nn()),u.set("analysis & insights",fe()),u.set("analysis &amp; insights",fe()),u.set("analysis&nbsp;&amp;&nbsp;insights",fe()),u.set("case study",pe({variant:"light"})),u.set("case&nbsp;study",pe({variant:"light"})),u.set("casestudy",pe({variant:"light"})),u.set("event",un()),u.set("event&nbsp;highlights",Oe()),u.set("event highlights",Oe()),u.set("feature",dn()),u.set("infographic",cn()),u.set("in&nbsp;the&nbsp;news",Ce()),u.set("in the news",Ce()),u.set("inthenews",Ce()),u.set("leadership&nbsp;messages",qe()),u.set("leadership messages",qe()),u.set("obituary",fn()),u.set("opinion",pn()),u.set("photo",Cn()),u.set("policy&nbsp;brief",Be({variant:"light"})),u.set("policy brief",Be({variant:"light"})),u.set("poll/quiz",ge()),u.set("poll / quiz",ge()),u.set("poll&nbsp;/&nbsp;quiz",ge()),u.set("profile",hn()),u.set("research",vn()),u.set("solutions",wn()),u.set("survey",yn()),u.set("timeline",Ln()),u.set("tips & takeaways",me()),u.set("tips &amp; takeaways",me()),u.set("tips&nbsp;&amp;&nbsp;takeaways",me()),u.set("university&nbsp;updates",Re()),u.set("university updates",Re()),u.set("announcement",rn()),u.set("news",on()),u.set("q&amp;a",Y()),u.set("q&a",Y()),u.set("q & a",Y()),u.set("q&nbsp;&amp;&nbsp;a",Y()),u.set("video",bn()),u.set("podcast",gn({variant:"light"})),u.set("book",ln({className:""})),`
      ...
      <div class="${x.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${x.authorWrapper} ${u}">
            ${C?`
              ${xn({image:C,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function Mn(e){const{videoId:t,className:n="",noAutoPlay:s,title:r,isVertical:i}=e;return`
        <iframe
            width="${i?315:560}"
            height="${i?560:315}"
            class="${n}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const In='section[data-component="topic-subtopic-listing"]',Tn='[data-element="topics-list"]',bt='[data-element="topics-pagination"]',Et="su-hidden",kn='section[data-element="modal-wrapper"]',$n='button[data-click="open-modal"]',Vn='button[data-dismiss="modal"]',St='iframe[data-modal="iframe"]';function Hn(e){const t=e.querySelector(St),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Et),e.hidden=!1,document.body.style.overflow="hidden"}function he(e){const t=e.querySelector(St),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Et),e.hidden=!0,document.body.style.overflow="hidden"}function At(e){const t=e.querySelectorAll($n),n=e.querySelectorAll(Vn);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||he(s)}),s.dataset.listenerAdded="true"),Hn(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&he(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&he(s)})}async function On(e){const{offset:t,query:n,endpoint:s}=e,r=s+n+`&start_rank=${t}`;return await(await fetch(r).catch(o=>{throw new Error(o)})).json()}function qn(e,t,n,s){e.querySelector(Tn).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(bt).innerHTML=n,e.querySelector(kn).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),At(e),xt(e)}async function Nn(e){var c,C,u,y,h;const{offset:t,query:n,endpoint:s,display:r,section:i}=e,a=await On({offset:t,query:n,endpoint:s}),o=(C=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:C.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const l=[],f=[];(h=(y=(u=a==null?void 0:a.response)==null?void 0:u.resultPacket)==null?void 0:y.results)==null||h.forEach(v=>{const m=c1(),g=o1(v);g.uniqueID=m,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(g.displayConfiguration=r,l.push(`<div class="su-relative su-grow">${_n({data:g,cardType:"narrowhorizontal"})}</div>`)):l.push(`<div class="su-relative su-grow">${An({data:g,cardType:"horizontal",cardSize:"large"})}</div>`),(g.type==="Video"||g.videoUrl)&&f.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const p=is({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),d=f.map(v=>`
        ...
        ${Mn({videoId:v.videoId,title:v.title,noAutoPlay:v.noAutoPlay,isVertical:v.isVertical})}
        ...
        `).join("");qn(i,l.join(""),p,d)}function xt(e){const{query:t,endpoint:n,display:s}=e.dataset,r=e.querySelector(bt);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const o=a.getAttribute("data-offset");Nn({offset:o,query:t,endpoint:n,display:s,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(In).forEach(e=>{At(e),xt(e)})});
