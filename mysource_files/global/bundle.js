import q from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";function ie(e,t,s,r=()=>{}){const a=e.slides.length;let i=t-a+1;a%s!==0&&(i+=s-a%s);const n=document.createDocumentFragment(),o=e.slides.map(u=>u.outerHTML).join("");for(let u=0;u<i;u++){const p=document.createElement("div");for(p.innerHTML=o;p.firstChild;)p.firstChild.classList.add("swiper-slide-duplicate"),n.appendChild(p.firstChild)}e.wrapperEl.appendChild(n),e.update(),r()}function Z(e,t=()=>{}){var n;const{slidesPerView:s,slidesPerGroup:r}=e.params,a=e.slides.length,i=Math.ceil(s+r);a===1&&((n=document.querySelector(".component-slider-controls"))==null||n.remove()),(a-1<i||a%r!==0)&&ie(e,i,r,t)}function i1(e){const t=e.slides.filter(s=>s.classList.contains("swiper-slide-duplicate")).length;if(t){let s=e.pagination.bullets.length-e.slides.length+t;for(;s>0;){const r=e.pagination.bullets.pop();r&&r.remove(),s--}}}const D=(e,t,s)=>{e.slides.forEach(r=>{if(r.classList.contains("swiper-slide-active")){if(r.removeAttribute("aria-hidden"),r.removeAttribute("inert"),r.setAttribute("tabindex","-1"),t&&s){let a=null;t==="slide"?a=r:a=r.querySelector(t),a&&a.focus()}}else r.setAttribute("aria-hidden","true"),r.setAttribute("inert","true"),r.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(r=>{r.classList.contains("swiper-pagination-bullet-active")?r.setAttribute("aria-current","true"):r.removeAttribute("aria-current")})},oe='section[data-component="content-carousel"]';function le(e){const t=e.dataset.uniqueId,s=new q(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{Z(n)},resize:n=>{Z(n)},paginationUpdate:n=>{i1(n)}}}),r=s.slides.length,a=s.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(r-a)>1&&(s.on("slideChange",function(){setTimeout(()=>{D(s,"slide",!0)},100)}),D(s,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(oe).forEach(e=>{le(e)})});const ue='section[data-component="featured-content"]',M1="su-hidden",de='button[data-click="open-modal"]',ce='button[data-dismiss="modal"]',_1='iframe[data-modal="iframe"]';function fe(e){const t=e.querySelector(_1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(M1),e.hidden=!1}function u1(e){const t=e.querySelector(_1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(M1),e.hidden=!0}function pe(e){const t=e.querySelectorAll(de),s=e.querySelectorAll(ce);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&fe(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){u1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&u1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ue).forEach(e=>{pe(e)})});const ge='section[data-component="image-gallery-modal"]',Ce='button[data-click="open-gallery-modal"]',he='div[data-modal="modal"]',ve='button[data-dismiss="modal"]',k1="su-hidden";let r1;const me=(e,t)=>{var n;const s='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',r=(n=Array.from(t==null?void 0:t.querySelectorAll(s)))==null?void 0:n.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(r.length===0||(e==null?void 0:e.key)!=="Tab")return;const a=r[0],i=r[r.length-1];e.shiftKey&&document.activeElement===a?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),a.focus())};function we(e){e.classList.remove(k1),e.hidden=!1,document.addEventListener("keydown",t=>{e&&me(t,e)})}function d1(e){e.classList.add(k1),e.hidden=!0}function Le(e){const t=e.dataset.modalId;r1=new q(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function be(e){const t=e.querySelector(he),s=e.querySelector(Ce),r=e.querySelector(ve);s&&s.addEventListener("click",function(){we(t),Le(t)}),r&&r.addEventListener("click",function(){d1(t),r1.destroy()}),document.addEventListener("keydown",function(a){a.key==="Escape"&&(d1(t),r1.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ge).forEach(e=>{be(e)})});const ye='[data-component="interactive-photo-card"]',xe="[data-card-inner]",Ae="[data-card-inner-content]";function Se(e){var r;const s=((e.style.transform&&parseInt((r=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:r[1])||0)+180)%360;e.style.transform=`rotateY(${s}deg)`}function Ee(e){const t=e.querySelector(xe);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>Se(t))}const Me=e=>{e.forEach(t=>{const s=t.getAttribute("aria-hidden")==="true"?"false":"true",r=t.querySelector("button");r&&(r.tabIndex=s==="true"?"-1":""),t.setAttribute("aria-hidden",s)})},_e=e=>{const t=e.querySelectorAll(Ae);t.length&&t.forEach(s=>s.addEventListener("click",()=>Me(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ye).forEach(e=>{Ee(e),_e(e)})});const ke='section[data-component="media-carousel"]';function Ve(e){const t=e.dataset.uniqueId,s=new q(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,o){return`<button ${n===0?'aria-current="true"':""} class="${o} ${n===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${n+1}</span></button>`}},on:{init:n=>{Z(n),n.activeIndex===1&&n.slidePrev()},resize:n=>{Z(n)},paginationUpdate:n=>{i1(n)}}}),r=s.slides.length,a=s.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;Math.floor(r-a)>1&&(s.on("slideChange",function(){setTimeout(()=>{D(s,"h2 a, h3 a, button",!0)},100)}),D(s,"",!1))}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(ke).forEach(e=>{Ve(e)})});const Ie='section[data-component="multicolumn-listing"]',V1="su-hidden",$e='button[data-click="open-modal"]',Te='button[data-dismiss="modal"]',I1='iframe[data-modal="iframe"]';function He(e){const t=e.querySelector(I1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(V1),e.hidden=!1}function c1(e){const t=e.querySelector(I1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(V1),e.hidden=!0}function Oe(e){const t=e.querySelectorAll($e),s=e.querySelectorAll(Te);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&He(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){c1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&c1(r)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ie).forEach(e=>{Oe(e)})});function P(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function R(e,t){const s=e.querySelector('svg[data-control="play"]'),r=e.querySelector('svg[data-control="pause"]'),a=!t;e.setAttribute("aria-pressed",String(a)),s.classList.toggle("su-hidden",a),s.hidden=a,r.classList.toggle("su-hidden",!a),r.hidden=!a,e.innerHTML=`
  ...
  `}const Ze='section[data-component="single-image-video"]',De='iframe[data-role="video-player"]',Ne='button[data-role="video-control"]',$1="su-hidden",Be='button[data-click="open-modal"]',qe='button[data-dismiss="modal"]',T1='iframe[data-modal="iframe"]';function Pe(e){const t=e.querySelector(T1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove($1),e.hidden=!1}function f1(e){const t=e.querySelector(T1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add($1),e.hidden=!0}function Re(e){const t=e.querySelectorAll(Be),s=e.querySelectorAll(qe);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&Pe(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){f1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&f1(r)})}function Ge(e){const t=e.querySelector(De),s=e.querySelector(Ne);let r=!1;if(!t||!s)return;new IntersectionObserver(i=>{i.forEach(n=>{n.isIntersecting&&!r?(P(t,"play"),R(s,!1)):n.isIntersecting||(P(t,"pause"),R(s,!0))})},{threshold:.5}).observe(t),s.addEventListener("click",()=>{s.getAttribute("aria-pressed")==="true"?(P(t,"pause"),R(s,!0),r=!0):(P(t,"play"),R(s,!1),r=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ze).forEach(e=>{Re(e),Ge(e)})});const Ue='section[data-component="stories-carousel"]',H1="su-hidden",ze='button[data-click="open-modal"]',Fe='button[data-dismiss="modal"]',O1='iframe[data-modal="iframe"]';function We(e){const t=e.querySelector(O1),r=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",r),e.classList.remove(H1)}function p1(e){const t=e.querySelector(O1),r=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",r),e.classList.add(H1)}function je(e){const t=e.querySelectorAll(ze),s=e.querySelectorAll(Fe);let r=null;t&&t.forEach(a=>{a&&a.addEventListener("click",function(){const i=a.dataset.modalId;r=e.querySelector(`div[data-modal-id="${i}"]`),r&&We(r)})}),s&&s.forEach(a=>{a&&a.addEventListener("click",function(){p1(r)})}),document.addEventListener("keydown",function(a){a.key==="Escape"&&r&&p1(r)})}function Xe(e){const t=e.dataset.uniqueId;new q(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ue).forEach(e=>{Xe(e),je(e)})});const Qe=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,s=>{let r=Math.random()*16;return e>0?(r=(e+r)%16|0,e=Math.floor(e/16)):(r=(t+r)%16|0,t=Math.floor(t/16)),(s==="x"?r:r&3|8).toString(16)})},Ye=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),Je=()=>typeof crypto<"u"?Ye():Qe();function Ke({title:e,listMetadata:{assetTypeCode:t,teaserPlain:s,summary:r,image:a,taxonomyContentTypeText:i,contentTopic:n,contentSubtopic:o,taxonomyContentMainTopicText:u,contentCategory:p,featuredVideo:d,taxonomyContentMainTopicLandingPageUrl:c,taxonomyFeaturedUnitLandingPageUrl:f,taxonomyFeaturedUnitText:g,imageAlt:l,authorName:L,authorImage:v,author:w,isTeaser:h,storySource:C,assetHref:S},date:T,liveUrl:H}){const O=L!==void 0?L:w,E=v!==""?v:void 0,A=a;l=a&&l?l:"",!l&&!A&&(l="a close up image of an intricate stone arch");const V=d,_=s||r;let I=u;!I&&n&&(I=n instanceof Array?n[0]:n),!I&&o&&(I=o instanceof Array?o[0]:o);const Q=c;let N=i?i[0]:"";return!N&&p&&(N=p instanceof Array?p[0]:p),S&&t[0]==="link"&&(H=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(_)?_[0]:_,liveUrl:Array.isArray(H)?H[0]:H,imageUrl:Array.isArray(A)?A[0]:A,imageAlt:Array.isArray(l)?l[0]:l,taxonomy:Array.isArray(I)?I[0]:I,taxonomyUrl:Array.isArray(Q)?Q[0]:Q,type:Array.isArray(N)?N[0]:N,videoUrl:Array.isArray(V)?V[0]:V,date:Array.isArray(T)?T[0]:T,authorDisplayName:Array.isArray(O)?O[0]:O,authorAvatar:Array.isArray(E)?E[0]:E,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(f)?f[0]:f,taxonomyFeaturedUnitText:Array.isArray(g)?g[0]:g,isTeaser:Array.isArray(h)?h[0]:h,storySource:Array.isArray(C)?C[0]:C}}function et({offsetNum:e,pageNumber:t,index:s}){return`
        <button
            data-offset="${e}"
    ...
    `}function tt({pageNumber:e,allResults:t,resultsPerPage:s,paginationRange:r}){const a=Math.ceil(t/s),i=r,n=e-s,o=e+s,u="su-text-black-50",p=[],d=[];let c=1;for(let h=0;h<a;h++){const C=h*s+1;d.push(C)}let f=[...d],g=[...d];const l=d.indexOf(c),L=Math.floor(i*.5);if((l<L||a===i)&&(f=f.filter((h,C)=>h>c&&C<i),g=g.filter(h=>h<c)),l>=L&&a!==i)if(f=f.filter((h,C)=>h>c&&C<=l+L),f.length===L)g=g.filter((h,C)=>h<c&&C>=l-L);else{const h=f.length?i-f.length:i;g=g.filter((C,S)=>C<c&&S>l-h)}return[...g,c,...f].map(h=>({offset:h,index:d.indexOf(h)+1})).forEach(({offset:h,index:C})=>{p.push(et({offsetNum:h,pageNumber:e,index:C}))}),a>1?`<div class="su-mx-auto su-component-container">
...
`&&o()}return B.trim(n)}var ut=lt,G=$,dt=ut;function g1(e){return e==null}function ct(e){var t={};for(var s in e)t[s]=e[s];return t}function D1(e){e=ct(e||{}),e.whiteList=e.whiteList||G.whiteList,e.onAttr=e.onAttr||G.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||G.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||G.safeAttrValue,this.options=e}D1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,r=s.whiteList,a=s.onAttr,i=s.onIgnoreAttr,n=s.safeAttrValue,o=dt(e,function(u,p,d,c,f){var g=r[d],l=!1;if(g===!0?l=g:typeof g=="function"?l=g(c):g instanceof RegExp&&(l=g.test(c)),l!==!0&&(l=!1),c=n(d,c),!!c){var L={position:p,sourcePosition:u,source:f,isWhite:l};if(l){var v=a(d,c,L);return g1(v)?d+":"+c:v}else{var v=i(d,c,L);if(!g1(v))return v}}});return o};var ft=D1;(function(e,t){var s=$,r=ft;function a(n,o){var u=new r(o);return u.process(n)}t=e.exports=a,t.FilterCSS=r;for(var i in s)t[i]=s[i];typeof window<"u"&&(window.filterCSS=e.exports)})(n1,n1.exports);var o1=n1.exports,l1={indexOf:function(e,t){var s,r;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,r=e.length;s<r;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var r,a;if(Array.prototype.forEach)return e.forEach(t,s);for(r=0,a=e.length;r<a;r++)t.call(s,e[r],r,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,s=t.exec(e);return s?s.index:-1}},pt=o1.FilterCSS,gt=o1.getDefaultWhiteList,j=l1;function N1(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var B1=new pt;function Ct(e,t,s){}function ht(e,t,s){}function vt(e,t,s){}function mt(e,t,s){}function q1(e){return e.replace(Lt,"&lt;").replace(bt,"&gt;")}function wt(e,t,s,r){if(s=F1(s),t==="href"||t==="src"){if(s=j.trim(s),s==="#")return"#";if(!(s.substr(0,7)==="http://"||s.substr(0,8)==="https://"||s.substr(0,7)==="mailto:"||s.substr(0,4)==="tel:"||s.substr(0,11)==="data:image/"||s.substr(0,6)==="ftp://"||s.substr(0,2)==="./"||s.substr(0,3)==="../"||s[0]==="#"||s[0]==="/"))return""}else if(t==="background"){if(U.lastIndex=0,U.test(s))return""}else if(t==="style"){if(C1.lastIndex=0,C1.test(s)||(h1.lastIndex=0,h1.test(s)&&(U.lastIndex=0,U.test(s))))return"";r!==!1&&(r=r||B1,s=r.process(s))}return s=W1(s),s}var Lt=/</g,bt=/>/g,yt=/"/g,xt=/&quot;/g,At=/&#([a-zA-Z0-9]*);?/gim,St=/&colon;?/gim,Et=/&newline;?/gim,U=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,C1=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,h1=/u\s*r\s*l\s*\(.*/gi;function P1(e){return e.replace(yt,"&quot;")}function R1(e){return e.replace(xt,'"')}function G1(e){return e.replace(At,function(s,r){return r[0]==="x"||r[0]==="X"?String.fromCharCode(parseInt(r.substr(1),16)):String.fromCharCode(parseInt(r,10))})}function U1(e){return e.replace(St,":").replace(Et," ")}function z1(e){for(var t="",s=0,r=e.length;s<r;s++)t+=e.charCodeAt(s)<32?" ":e.charAt(s);return j.trim(t)}function F1(e){return e=R1(e),e=G1(e),e=U1(e),e=z1(e),e}function W1(e){return e=P1(e),e=q1(e),e}function Mt(){return""}function _t(e,t){typeof t!="function"&&(t=function(){});var s=!Array.isArray(e);function r(n){return s?!0:j.indexOf(e,n)!==-1}var a=[],i=!1;return{onIgnoreTag:function(n,o,u){if(r(n))if(u.isClosing){var p="[/removed]",d=u.position+p.length;return a.push([i!==!1?i:u.position,d]),i=!1,p}else return i||(i=u.position),"[removed]";else return t(n,o,u)},remove:function(n){var o="",u=0;return j.forEach(a,function(p){o+=n.slice(u,p[0]),u=p[1]}),o+=n.slice(u),o}}}function kt(e){for(var t="",s=0;s<e.length;){var r=e.indexOf("<!--",s);if(r===-1){t+=e.slice(s);break}t+=e.slice(s,r);var a=e.indexOf("-->",r);if(a===-1)break;s=a+3}return t}function Vt(e){var t=e.split("");return t=t.filter(function(s){var r=s.charCodeAt(0);return r===127?!1:r<=31?r===10||r===13:!0}),t.join("")}m.whiteList=N1();m.getDefaultWhiteList=N1;m.onTag=Ct;m.onIgnoreTag=ht;m.onTagAttr=vt;m.onIgnoreTagAttr=mt;m.safeAttrValue=wt;m.escapeHtml=q1;m.escapeQuote=P1;m.unescapeQuote=R1;m.escapeHtmlEntities=G1;m.escapeDangerHtml5Entities=U1;m.clearNonPrintableCharacter=z1;m.friendlyAttrValue=F1;m.escapeAttrValue=W1;m.onIgnoreTagStripAll=Mt;m.StripTagBody=_t;m.stripCommentTag=kt;m.stripBlankChar=Vt;m.attributeWrapSign='"';m.cssFilter=B1;m.getDefaultCSSWhiteList=gt;var X={},k=l1;function It(e){var t=k.spaceIndex(e),s;return t===-1?s=e.slice(1,-1):s=e.slice(1,t+1),s=k.trim(s).toLowerCase(),s.slice(0,1)==="/"&&(s=s.slice(1)),s.slice(-1)==="/"&&(s=s.slice(0,-1)),s}function $t(e){return e.slice(0,2)==="</"}function Tt(e,t,s){var r="",a=0,i=!1,n=!1,o=0,u=e.length,p="",d="";e:for(o=0;o<u;o++){var c=e.charAt(o);if(i===!1){if(c==="<"){i=o;continue}}else if(n===!1){if(c==="<"){r+=s(e.slice(a,o)),i=o,a=o;continue}if(c===">"||o===u-1){r+=s(e.slice(a,i)),d=e.slice(i,o+1),p=It(d),r+=t(i,r.length,p,d,$t(d)),a=o+1,i=!1;continue}if(c==='"'||c==="'")for(var f=1,g=e.charAt(o-f);g.trim()===""||g==="=";){if(g==="="){n=c;continue e}g=e.charAt(o-++f)}}else if(c===n){n=!1;continue}}return a<u&&(r+=s(e.substr(a))),r}var Ht=/[^a-zA-Z0-9\\_:.-]/gim;function Ot(e,t){var s=0,r=0,a=[],i=!1,n=e.length;function o(f,g){if(f=k.trim(f),f=f.replace(Ht,"").toLowerCase(),!(f.length<1)){var l=t(f,g||"");l&&a.push(l)}}for(var u=0;u<n;u++){var p=e.charAt(u),d,c;if(i===!1&&p==="="){i=e.slice(s,u),s=u+1,r=e.charAt(s)==='"'||e.charAt(s)==="'"?s:Dt(e,u+1);continue}if(i!==!1&&u===r){if(c=e.indexOf(p,u+1),c===-1)break;d=k.trim(e.slice(r+1,c)),o(i,d),i=!1,u=c,s=u+1;continue}if(/\s|\n|\t/.test(p))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(c=Zt(e,u),c===-1){d=k.trim(e.slice(s,u)),o(d),i=!1,s=u+1;continue}else{u=c-1;continue}else if(c=Nt(e,u-1),c===-1){d=k.trim(e.slice(s,u)),d=v1(d),o(i,d),i=!1,s=u+1;continue}else continue}return s<e.length&&(i===!1?o(e.slice(s)):o(i,v1(k.trim(e.slice(s))))),k.trim(a.join(" "))}function Zt(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="="?t:-1}}function Dt(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="'"||s==='"'?t:-1}}function Nt(e,t){for(;t>0;t--){var s=e[t];if(s!==" ")return s==="="?t:-1}}function Bt(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function v1(e){return Bt(e)?e.substr(1,e.length-2):e}X.parseTag=Tt;X.parseAttr=Ot;var qt=o1.FilterCSS,x=m,j1=X,Pt=j1.parseTag,Rt=j1.parseAttr,W=l1;function z(e){return e==null}function Gt(e){var t=W.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=W.trim(e.slice(t+1,-1));var s=e[e.length-1]==="/";return s&&(e=W.trim(e.slice(0,-1))),{html:e,closing:s}}function Ut(e){var t={};for(var s in e)t[s]=e[s];return t}function zt(e){var t={};for(var s in e)Array.isArray(e[s])?t[s.toLowerCase()]=e[s].map(function(r){return r.toLowerCase()}):t[s.toLowerCase()]=e[s];return t}function X1(e){e=Ut(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=x.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=zt(e.whiteList||e.allowList):e.whiteList=x.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":x.attributeWrapSign,e.onTag=e.onTag||x.onTag,e.onTagAttr=e.onTagAttr||x.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||x.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||x.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||x.safeAttrValue,e.escapeHtml=e.escapeHtml||x.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new qt(e.css))}X1.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,r=s.whiteList,a=s.onTag,i=s.onIgnoreTag,n=s.onTagAttr,o=s.onIgnoreTagAttr,u=s.safeAttrValue,p=s.escapeHtml,d=t.attributeWrapSign,c=t.cssFilter;s.stripBlankChar&&(e=x.stripBlankChar(e)),s.allowCommentTag||(e=x.stripCommentTag(e));var f=!1;s.stripIgnoreTagBody&&(f=x.StripTagBody(s.stripIgnoreTagBody,i),i=f.onIgnoreTag);var g=Pt(e,function(l,L,v,w,h){var C={sourcePosition:l,position:L,isClosing:h,isWhite:Object.prototype.hasOwnProperty.call(r,v)},S=a(v,w,C);if(!z(S))return S;if(C.isWhite){if(C.isClosing)return"</"+v+">";var T=Gt(w),H=r[v],O=Rt(T.html,function(E,A){var V=W.indexOf(H,E)!==-1,_=n(v,E,A,V);return z(_)?V?(A=u(v,E,A,c),A?E+"="+d+A+d:E):(_=o(v,E,A,V),z(_)?void 0:_):_});return w="<"+v,O&&(w+=" "+O),T.closing&&(w+=" /"),w+=">",w}else return S=i(v,w,C),z(S)?p(w):S},p);return f&&(g=f.remove(g)),g};var Ft=X1;(function(e,t){var s=m,r=X,a=Ft;function i(o,u){var p=new a(u);return p.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=a,function(){for(var o in s)t[o]=s[o];for(var u in r)t[u]=r[u]}(),typeof window<"u"&&(window.filterXSS=e.exports);function n(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}n()&&(self.filterXSS=e.exports)})(a1,a1.exports);var Wt=a1.exports;const M=st(Wt);var jt=Array.isArray,Q1=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var s=void 0;if(jt(e))for(var r=0,a=e.length;r<a;)s=Q1(e[r++]),s&&(t&&(t+=" "),t+=s);else for(s in e)s&&e[s]&&(t&&(t+=" "),t+=s)}return t};function Y1(){for(var e=arguments.length,t=0,s,r,a="";t<e;)s=arguments[t++],s&&(r=Q1(s),r&&(a&&(a+=" "),a+=r));return a}function m1({children:e="",imageUrl:t,imageAlt:s="",aspectRatio:r="card-small",videoUrl:a}){return`
  ...
  `}const Xt={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function w1({imageUrl:e,alt:t="",aspectRatio:s,videoUrl:r,size:a="small",title:i="",videoIconClasses:n,uniqueId:o}){if(r){const u=`
        ...
        ${r?`
          <span
            class="${Y1("su-absolute su-leading-none",a==="vertical-video"&&"su-z-30",Xt[a],n)}">
  ...
  `}function Qt(e,t){if(!t)return!0;const s=e.match(/(\d+-\d+-\d+)/)[0],r=t.match(/(\d+-\d+-\d+)/)[0];return s===r}function Yt({start:e,end:t}){if(!e&&!t)return null;const s=new Date(e),r=t?new Date(t):null,a={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const n=Qt(e,t);n||(delete a.time,delete a.hour,delete a.minute);const o=new Intl.DateTimeFormat("en-US",a).format(s),u=t?new Intl.DateTimeFormat("en-US",a).format(r):"";return n?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${u}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function Jt(){return`
    <svg
        aria-hidden="true"
      ...
      <div class="${y.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${y.authorWrapper} ${l}">
            ${g?`
              ${L5({image:g,avatarSize:"small",alt:`Photo of ${n}`})}
            `:""}
            ${w}
          </div>
        `:""}
