import B from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const Be=typeof window>"u"?{}:window;function Tt(e=Be){return e.document!==void 0}function De(e,t=Be){if(!Tt(t))return null;const{document:s}=t,{cookie:n}=s;if(typeof n!="string")return null;const r=n.split("; ");let i=null;return r.find(a=>{const[o,l]=a.split("=");return o===e&&l!==""&&(i=l),null}),i}const Ae="su-hidden";function xe(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')};Object.values(t).forEach(s=>{s==null||s.forEach(n=>{n.classList.add(Ae)})}),t[e]&&t[e].forEach(s=>{s.classList.remove(Ae)})}document.addEventListener("DOMContentLoaded",function(){const e=De("preferences_personalisation");xe(e==="null"||!e?"external":e)});function Ze(e){if(!e)return 0;const t=225,s=e.trim().split(/\s+/).length;return Math.ceil(s/t)}function kt(e,t,s,n=()=>{}){const r=e.slides.length;let i=t-r+1;r%s!==0&&(i+=s-r%s);const a=document.createDocumentFragment(),o=e.slides.map(l=>l.outerHTML).join("");for(let l=0;l<i;l++){const f=document.createElement("div");for(f.innerHTML=o;f.firstChild;)f.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(f.firstChild)}e.wrapperEl.appendChild(a),e.update(),b(e,"",!1),n()}function q(e,t=()=>{}){const{slidesPerView:s,slidesPerGroup:n}=e.params,r=e.slides.length,i=Math.ceil(s+n);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<i||r%n!==0?kt(e,i,n,t):(b(e,"",!1),t())}function J(e){const t=e.slides.filter(s=>s.classList.contains("swiper-slide-duplicate")).length;if(t){let s=e.pagination.bullets.length-e.slides.length+t;for(;s>0;){const n=e.pagination.bullets.pop();n&&n.remove(),s--}}}const b=(e,t,s)=>{e.slides.forEach(n=>{if(n.classList.contains("swiper-slide-active")){if(n.removeAttribute("aria-hidden"),n.removeAttribute("inert"),n.setAttribute("tabindex","-1"),t&&s){let r=null;t==="slide"?r=n:r=n.querySelector(t),r&&r.focus()}}else n.setAttribute("aria-hidden","true"),n.setAttribute("inert","true"),n.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(n=>{n.classList.contains("swiper-pagination-bullet-active")?n.setAttribute("aria-current","true"):n.removeAttribute("aria-current")})},$t='section[data-component="basic-story-hero"]',Ot='span[data-reading="true"]',Pe="su-hidden",Vt='button[data-click="open-modal"]',Ht='button[data-dismiss="modal"]',Ge='iframe[data-modal="iframe"]';function Nt(e){const t=e.querySelector(Ge);if(t){const n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n)}e.classList.remove(Pe),e.hidden=!1,document.body.style.overflow="hidden"}function ne(e){const t=e.querySelector(Ge);if(t){const n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n)}e.classList.add(Pe),e.hidden=!0,document.body.style.overflow=""}function qt(e){const t=e.querySelectorAll(Vt),s=e.querySelectorAll(Ht);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||ne(n)}),n.dataset.listenerAdded="true"),Nt(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&ne(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&ne(n)})}function Rt(e){var n;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{q(a),b(a,"",!1)},resize:a=>{q(a)},paginationUpdate:a=>{J(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?b(i,"slide",!0):b(i,"",!1)},100)})}else(n=e.querySelector(".component-slider-controls"))==null||n.remove()}function Bt(e){const t=document.querySelector(".su-page-content"),s=e.querySelector(Ot);if(t&&s){const n=Ze(t.innerText);s.textContent=n}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll($t).forEach(e=>{Rt(e),qt(e),Bt(e)})});const Dt='section[data-component="combined-content-grid"]',Ue="su-hidden",Zt='button[data-click="open-modal"]',Pt='button[data-dismiss="modal"]',Fe='iframe[data-modal="iframe"]';function Gt(e){const t=e.querySelector(Fe),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(Ue),e.hidden=!1,document.body.style.overflow="hidden"}function se(e){const t=e.querySelector(Fe),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(Ue),e.hidden=!0,document.body.style.overflow=""}function Ut(e){const t=e.querySelectorAll(Zt),s=e.querySelectorAll(Pt);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||se(n)}),n.dataset.listenerAdded="true"),Gt(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&se(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&se(n)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Dt).forEach(e=>{Ut(e)})});const Ft='section[data-component="content-carousel"]';function zt(e){var n;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{q(a),b(a,"",!1)},resize:a=>{q(a)},paginationUpdate:a=>{J(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?b(i,"slide",!0):b(i,"",!1)},100)})}else(n=e.querySelector(".component-slider-controls"))==null||n.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Ft).forEach(e=>{zt(e)})});const Wt='section[data-component="feature-story-hero"]',jt='span[data-reading="true"]';function Xt(e){const t=document.querySelector(".su-page-content"),s=e.querySelector(jt);if(t&&s){const n=Ze(t.innerText);s.textContent=n}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Wt).forEach(e=>{Xt(e)})});const Yt='section[data-component="featured-content"]',ze="su-hidden",Qt='button[data-click="open-modal"]',Kt='button[data-dismiss="modal"]',We='iframe[data-modal="iframe"]';function Jt(e){const t=e.querySelector(We),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(ze),e.hidden=!1,document.body.style.overflow="hidden"}function re(e){const t=e.querySelector(We),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(ze),e.hidden=!0,document.body.style.overflow=""}function e1(e){const t=e.querySelectorAll(Qt),s=e.querySelectorAll(Kt);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||re(n)}),n.dataset.listenerAdded="true"),Jt(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&re(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&re(n)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Yt).forEach(e=>{e1(e)})});const t1='section[data-component="horizontal-video-testimonials"]',je="su-hidden",n1='button[data-click="open-modal"]',s1='button[data-dismiss="modal"]',Xe='iframe[data-modal="iframe"]';function r1(e){const t=e.querySelector(Xe);if(t){const s=t.getAttribute("src"),n=s&&s.replace("autoplay=0","autoplay=1");t.setAttribute("src",n)}e.classList.remove(je),e.hidden=!1,document.body.style.overflow="hidden"}function ae(e){const t=e.querySelector(Xe);if(t){const s=t.getAttribute("src"),n=s&&s.replace("autoplay=1","autoplay=0");t.setAttribute("src",n)}e.classList.add(je),e.hidden=!0,document.body.style.overflow=""}function a1(e){const t=e.querySelectorAll(n1),s=e.querySelectorAll(s1);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||ae(n)}),n.dataset.listenerAdded="true"),r1(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&ae(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&ae(n)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(t1).forEach(e=>{a1(e)})});const i1='section[data-component="image-gallery-modal"]',o1='button[data-click="open-gallery-modal"]',l1='div[data-modal="modal"]',u1='button[data-dismiss="modal"]',Ye="su-hidden";let ye;const d1=(e,t)=>{var a;const s='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',n=(a=Array.from(t==null?void 0:t.querySelectorAll(s)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(n.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=n[0],i=n[n.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function c1(e){e.classList.remove(Ye),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&d1(t,e)})}function ie(e){e.classList.add(Ye),e.hidden=!0,document.body.style.overflow=""}function f1(e){const t=e.dataset.modalId;ye=new B(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,n){return`<button ${s===0?'aria-current="true"':""} class="${n}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function p1(e){const t=e.querySelector(l1),s=e.querySelector(o1),n=e.querySelector(u1);s&&s.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",i=>{r.contains(i.target)||ie(t)}),t.dataset.listenerAdded="true"),c1(t),f1(t)}),n&&n.addEventListener("click",function(){ie(t),ye.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(ie(t),ye.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(i1).forEach(e=>{p1(e)})});const C1='[data-component="interactive-photo-card"]',g1="[data-card-inner]",m1="[data-card-inner-content]";function h1(e){var n;const s=((e.style.transform&&parseInt((n=e.style.transform.match(/rotateY\((\d+)deg\)/))==null?void 0:n[1])||0)+180)%360;e.style.transform=`rotateY(${s}deg)`}function v1(e){const t=e.querySelector(g1);if(!t){console.error("Could not find card inner element for component");return}t.addEventListener("click",()=>h1(t))}const w1=e=>{e.forEach(t=>{const s=t.getAttribute("aria-hidden")==="true"?"false":"true",n=t.querySelector("button");n&&(n.tabIndex=s==="true"?"-1":""),t.setAttribute("aria-hidden",s)})},y1=e=>{const t=e.querySelectorAll(m1);t.length&&t.forEach(s=>s.addEventListener("click",()=>w1(t)))};document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(C1).forEach(e=>{v1(e),y1(e)})});class L1{constructor(t,s){this.url=t,this.type=s,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const n=this.assetIds.map(async r=>{const i=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(i,this.requestProps).catch(l=>{throw new Error(l)})).json()});return Promise.all(n)}return await(await fetch(this.url,this.requestProps).catch(n=>{throw new Error(n)})).json()}}function E1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:s,summary:n,image:r,taxonomyContentTypeText:i,contentTopic:a,contentSubtopic:o,taxonomyContentMainTopicText:l,contentCategory:f,featuredVideo:p,taxonomyContentMainTopicLandingPageUrl:d,taxonomyFeaturedUnitLandingPageUrl:c,taxonomyFeaturedUnitText:C,imageAlt:u,authorName:y,authorImage:h,author:v,isTeaser:m,storySource:g,assetHref:S},date:$,liveUrl:O}){const V=y!==void 0?y:v,A=h!==""?h:void 0,M=r&&r!==""?r:null,L=u&&u!==""?u:"",T=p,D=s||n;let H=l;!H&&a&&(H=a instanceof Array?a[0]:a),!H&&o&&(H=o instanceof Array?o[0]:o);const te=d;let Z=i?i[0]:"";return!Z&&f&&(Z=f instanceof Array?f[0]:f),S&&t[0]==="link"&&(O=S),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(D)?D[0]:D,liveUrl:Array.isArray(O)?O[0]:O,imageUrl:Array.isArray(M)?M[0]:M,imageAlt:Array.isArray(L)?L[0]:L,taxonomy:Array.isArray(H)?H[0]:H,taxonomyUrl:Array.isArray(te)?te[0]:te,type:Array.isArray(Z)?Z[0]:Z,videoUrl:Array.isArray(T)?T[0]:T,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(V)?V[0]:V,authorAvatar:Array.isArray(A)?A[0]:A,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(c)?c[0]:c,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(m)?m[0]:m,storySource:Array.isArray(g)?g[0]:g}}function oe(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function Qe(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}function b1(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}const S1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,s=>{let n=Math.random()*16;return e>0?(n=(e+n)%16|0,e=Math.floor(e/16)):(n=(t+n)%16|0,t=Math.floor(t/16)),(s==="x"?n:n&3|8).toString(16)})},A1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),x1=()=>typeof crypto<"u"?A1():S1();async function _1(e=null,t="",s=null){var r,i,a,o,l,f,p,d,c,C,u,y,h,v,m,g,S,$,O;const n=new L1;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const V=`
    ...
    `}function k1(e,t,s){if(!e.length){t.classList.add(E.NO_STORIES);return}const[n,r,i]=e;s.innerHTML=`
    ...
    `,t.classList.remove(E.NO_STORIES)}async function $1(e,t,s,n,r,i){const o=(await _1(e,i,t)).map(({title:l,indexUrl:f})=>T1(l,f));k1(o,s,r),O1(s,n,r)}function O1(e,t,s){t.addEventListener("click",function(){I1(t,s)}),window.addEventListener("scroll",function(){M1(e)})}function V1(e,t,s,n){if(!e||!window.pageController)return;const r=window.pageController,i=r.topicsQuery?r.topicsQuery():null;$1(r,i,e,t,s,n)}document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(le.WRAPPER),t=document.querySelector(le.TOGGLE),s=document.querySelector(le.DRAWER),n=De("preferences_personalisation");V1(e,t,s,n)});const H1='section[data-component="media-carousel"]';function N1(e){const t=e.dataset.uniqueId,s=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:0,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.1,spaceBetween:0,centeredSlides:!0,initialSlide:0},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1,initialSlide:0}},slidesPerView:1,variantClassName:"component-slider-single component-slider-peek",loopAdditionalSlides:0,slidesPerGroup:1,watchSlidesProgress:!0,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o} ${a===0?"swiper-pagination-bullet-active":""}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{q(a),b(a,"",!1),a.activeIndex===1&&a.slidePrev()},resize:a=>{q(a)},paginationUpdate:a=>{J(a)}}}),n=s.slides.length,r=s.slides.filter(a=>a.classList.contains("swiper-slide-duplicate")).length;if(Math.floor(n-r)>1){let a=!1;document.addEventListener("keydown",function(){a=!0}),document.addEventListener("mousedown",()=>{a=!1}),document.addEventListener("touchstart",()=>{a=!1}),document.addEventListener("pointerdown",()=>{a=!1}),s.on("slideChange",function(){setTimeout(()=>{a?b(s,"h2 a, h3 a, button",!0):b(s,"",!1)},100)})}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(H1).forEach(e=>{N1(e)})});const q1='button[data-role="copy-link"]';function R1(e){e.addEventListener("click",function(){navigator.clipboard.writeText(window.location.href).then(()=>{const t=document.querySelector("[data-copy-text]");t.textContent="Copied",setTimeout(()=>{t.textContent="Copy link"},3e3)})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(q1).forEach(e=>{R1(e)})});const B1='section[data-component="multicolumn-listing"]',Ke="su-hidden",D1='button[data-click="open-modal"]',Z1='button[data-dismiss="modal"]',Je='iframe[data-modal="iframe"]';function P1(e){const t=e.querySelector(Je),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(Ke),e.hidden=!1,document.body.style.overflow="hidden"}function ue(e){const t=e.querySelector(Je),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(Ke),e.hidden=!0,document.body.style.overflow=""}function G1(e){const t=e.querySelectorAll(D1),s=e.querySelectorAll(Z1);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||ue(n)}),n.dataset.listenerAdded="true"),P1(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&ue(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&ue(n)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(B1).forEach(e=>{G1(e)})});const U1='section[data-component="sidebar-navigation"]',F1='nav[data-nav="nav"]',Q="su-hidden",z1='button[data-click="toggle-nav"]',W1="su-bg-digital-red su-text-white dark:su-bg-dark-mode-red dark:aria-expanded:su-text-black-true",j1='span[data-label="button"]';function et(e,t){const s=e.querySelector(j1),n=e.querySelector('svg[data-icon="bars"]'),r=e.querySelector('svg[data-icon="xmark"]');e.setAttribute("aria-expanded",t.toString()),W1.split(" ").forEach(i=>{e.classList.toggle(i,t)}),n&&(n.classList.toggle(`!${Q}`,t),n.hidden=t),r&&(r.classList.toggle(`!${Q}`,!t),r.hidden=!t),s&&(s.innerHTML=t?s.getAttribute("data-label-close"):s.getAttribute("data-label-open"))}function _e(e,t){e.classList.remove(Q),e.hidden=!1,et(t,!0)}function G(e,t){e.classList.add(Q),e.hidden=!0,et(t,!1)}function X1(e){const t=e.querySelector(z1),s=e.querySelector(F1);let n;t&&t.addEventListener("click",function(){const r=t.getAttribute("aria-expanded")==="true";s.dataset.listenerAdded||(document.addEventListener("click",i=>{const a=s.contains(i.target),o=t.contains(i.target);!a&&!o&&G(s,t)}),s.dataset.listenerAdded="true"),r?G(s,t):_e(s,t)}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&t&&G(s,t)}),window.addEventListener("resize",()=>{clearTimeout(n),n=setTimeout(()=>{window.innerWidth>991?s&&t&&_e(s,t):s&&t&&G(s,t)},10)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(U1).forEach(e=>{X1(e)})});function U(e,t){e.contentWindow.postMessage(JSON.stringify({method:t}),"*")}function F(e,t){const s=e.querySelector('svg[data-control="play"]'),n=e.querySelector('svg[data-control="pause"]'),r=!t;e.setAttribute("aria-pressed",String(r)),s.classList.toggle("su-hidden",r),s.hidden=r,n.classList.toggle("su-hidden",!r),n.hidden=!r,e.innerHTML=`
  ...
  `}const Y1='section[data-component="single-image-video"]',Q1='iframe[data-role="video-player"]',K1='button[data-role="video-control"]',tt="su-hidden",J1='button[data-click="open-modal"]',en='button[data-dismiss="modal"]',nt='iframe[data-modal="iframe"]',tn=(e,t)=>{var a;const s='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',n=(a=Array.from(t==null?void 0:t.querySelectorAll(s)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(n.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=n[0],i=n[n.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function nn(e){const t=e.querySelector(nt),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(tt),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&tn(r,e)})}function de(e){const t=e.querySelector(nt),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(tt),e.hidden=!0,document.body.style.overflow=""}function sn(e){const t=e.querySelectorAll(J1),s=e.querySelectorAll(en);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||de(n)}),n.dataset.listenerAdded="true"),nn(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&de(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&de(n)})}function rn(e){const t=e.querySelector(Q1),s=e.querySelector(K1);let n=!1;if(!t||!s)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!n?(U(t,"play"),F(s,!1)):a.isIntersecting||(U(t,"pause"),F(s,!0))})},{threshold:.5}).observe(t),s.addEventListener("click",()=>{s.getAttribute("aria-pressed")==="true"?(U(t,"pause"),F(s,!0),n=!0):(U(t,"play"),F(s,!1),n=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Y1).forEach(e=>{sn(e),rn(e)})});const an='section[data-component="standalone-visual-hero"]',st="su-hidden",on='button[data-click="open-modal"]',ln='button[data-dismiss="modal"]',rt='iframe[data-modal="iframe"]';function un(e){const t=e.querySelector(rt);if(t){const n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n)}e.classList.remove(st),e.hidden=!1,document.body.style.overflow="hidden"}function ce(e){const t=e.querySelector(rt);if(t){const n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n)}e.classList.add(st),e.hidden=!0,document.body.style.overflow=""}function dn(e){const t=e.querySelectorAll(on),s=e.querySelectorAll(ln);let n=null;t.forEach(r=>{r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||ce(n)}),n.dataset.listenerAdded="true"),un(n)})}),s.forEach(r=>{r.addEventListener("click",function(){n&&ce(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&ce(n)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(an).forEach(e=>{dn(e)})});const cn='section[data-component="stories-carousel"]',at="su-hidden",fn='button[data-click="open-modal"]',pn='button[data-dismiss="modal"]',it='iframe[data-modal="iframe"]';function Cn(e){const t=e.querySelector(it),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(at),e.hidden=!1,document.body.style.overflow="hidden"}function fe(e){const t=e.querySelector(it),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(at),e.hidden=!0,document.body.style.overflow=""}function gn(e){const t=e.querySelectorAll(fn),s=e.querySelectorAll(pn);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||fe(n)}),n.dataset.listenerAdded="true"),Cn(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&fe(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&fe(n)})}function mn(e){const t=e.dataset.uniqueId;new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,n){return`<button ${s===0?'aria-current="true"':""} class="${n}"><span class="sr-only">Slide ${s+1}</span></button>`}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(cn).forEach(e=>{mn(e),gn(e)})});const hn='section[data-component="subscribe-to-stanford-report"]';function vn(e){const t=e.querySelector("form"),s=t.querySelector('input[type="email"]'),n=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let i="";const a=s.value;if(!a||!a.match(/\w+@\w+\.\w+/)){i='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',n.innerHTML=i,s.setAttribute("aria-describedby","subscription-error");return}n.innerHTML="",s.removeAttribute("aria-describedby"),r.target.submit()}),s.addEventListener("keyup",function(){const r=s.value,i=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(i.innerHTML="",s.removeAttribute("aria-describedby"))})}function wn(){document.querySelectorAll(hn).forEach(e=>{vn(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",wn);const yn='section[data-component="subtopic-subnav-component"]',Ln='div[data-list="subnav"]';function En(e){return e.filter((t,s)=>s===e.findIndex(n=>{var r,i;return((r=n.taxonomyFeaturedUnitText)==null?void 0:r[0])===((i=t.taxonomyFeaturedUnitText)==null?void 0:i[0])}))}const bn=async e=>{if(!e||e.length===0)return null;const t=En(e),s=[];return t.forEach(n=>{var i,a,o;const r=n;r&&((i=r.taxonomyFeaturedUnitText)!=null&&i[0])&&s.push({asset_name:(a=r.taxonomyFeaturedUnitText)==null?void 0:a[0],asset_url:((o=r.taxonomyFeaturedUnitLandingPageUrl)==null?void 0:o[0])||""})}),s};function Sn({navigation:e}){let t="scrollable-list__item su-mb-0 su-relative after:su-h-22 after:su-w-[1px] after:su-bg-black-60 after:su-mx-12 lg:after:su-mx-18";const s="su-text-inherit su-text-black su-font-semi-bold su-text-16 lg:su-text-18 lg:su-leading-[21.6px] su-no-underline hover:su-underline dark:su-text-white hover:su-text-digital-red dark:hover:su-text-dark-mode-red";return`
    ...
    `}function An(e){const t=e.querySelector(Ln);t&&document.addEventListener("topicLoader",async s=>{if(s.detail){const n=await bn(s.detail.cards);t.innerHTML=Sn({navigation:n})}},!1)}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(yn).forEach(e=>{An(e)})});function xn({offsetNum:e,pageNumber:t,index:s}){return`
        <button
            data-offset="${e}"
    ...
    `}function _n({pageNumber:e,allResults:t,resultsPerPage:s,paginationRange:n,currentPage:r=1}){const i=Math.ceil(t/s),a=n,o=e-s,l=e+s,f="su-text-black-50",p=[],d=[];for(let m=0;m<i;m++){const g=m*s+1;d.push(g)}let c=[...d],C=[...d];const u=d.indexOf(r),y=Math.floor(a*.5);if((u<y||i===a)&&(c=c.filter((m,g)=>m>r&&g<a),C=C.filter(m=>m<r)),u>=y&&i!==a)if(c=c.filter((m,g)=>m>r&&g<=u+y),c.length===y)C=C.filter((m,g)=>m<r&&g>=u-y);else{const m=c.length?a-c.length:a;C=C.filter((g,S)=>g<r&&S>u-m)}return[...C,r,...c].map(m=>({offset:m,index:d.indexOf(m)+1})).forEach(({offset:m,index:g})=>{p.push(xn({offsetNum:m,pageNumber:e,index:g}))}),i>1?`<div class="su-mx-auto su-component-container">
            ...
            </div>`:""}function In(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var Le={exports:{}},w={},Ee={exports:{}},R={};function ot(){var e={};return e["align-content"]=!1,e["align-items"]=!1,e["align-self"]=!1,e["alignment-adjust"]=!1,e["alignment-baseline"]=!1,e.all=!1,e["anchor-point"]=!1,e.animation=!1,e["animation-delay"]=!1,e["animation-direction"]=!1,e["animation-duration"]=!1,e["animation-fill-mode"]=!1,e["animation-iteration-count"]=!1,e["animation-name"]=!1,e["animation-play-state"]=!1,e["animation-timing-function"]=!1,e.azimuth=!1,e["backface-visibility"]=!1,e.background=!0,e["background-attachment"]=!0,e["background-clip"]=!0,e["background-color"]=!0,e["background-image"]=!0,e["background-origin"]=!0,e["background-position"]=!0,e["background-repeat"]=!0,e["background-size"]=!0,e["baseline-shift"]=!1,e.binding=!1,e.bleed=!1,e["bookmark-label"]=!1,e["bookmark-level"]=!1,e["bookmark-state"]=!1,e.border=!0,e["border-bottom"]=!0,e["border-bottom-color"]=!0,e["border-bottom-left-radius"]=!0,e["border-bottom-right-radius"]=!0,e["border-bottom-style"]=!0,e["border-bottom-width"]=!0,e["border-collapse"]=!0,e["border-color"]=!0,e["border-image"]=!0,e["border-image-outset"]=!0,e["border-image-repeat"]=!0,e["border-image-slice"]=!0,e["border-image-source"]=!0,e["border-image-width"]=!0,e["border-left"]=!0,e["border-left-color"]=!0,e["border-left-style"]=!0,e["border-left-width"]=!0,e["border-radius"]=!0,e["border-right"]=!0,e["border-right-color"]=!0,e["border-right-style"]=!0,e["border-right-width"]=!0,e["border-spacing"]=!0,e["border-style"]=!0,e["border-top"]=!0,e["border-top-color"]=!0,e["border-top-left-radius"]=!0,e["border-top-right-radius"]=!0,e["border-top-style"]=!0,e["border-top-width"]=!0,e["border-width"]=!0,e.bottom=!1,e["box-decoration-break"]=!0,e["box-shadow"]=!0,e["box-sizing"]=!0,e["box-snap"]=!0,e["box-suppress"]=!0,e["break-after"]=!0,e["break-before"]=!0,e["break-inside"]=!0,e["caption-side"]=!1,e.chains=!1,e.clear=!0,e.clip=!1,e["clip-path"]=!1,e["clip-rule"]=!1,e.color=!0,e["color-interpolation-filters"]=!0,e["column-count"]=!1,e["column-fill"]=!1,e["column-gap"]=!1,e["column-rule"]=!1,e["column-rule-color"]=!1,e["column-rule-style"]=!1,e["column-rule-width"]=!1,e["column-span"]=!1,e["column-width"]=!1,e.columns=!1,e.contain=!1,e.content=!1,e["counter-increment"]=!1,e["counter-reset"]=!1,e["counter-set"]=!1,e.crop=!1,e.cue=!1,e["cue-after"]=!1,e["cue-before"]=!1,e.cursor=!1,e.direction=!1,e.display=!0,e["display-inside"]=!0,e["display-list"]=!0,e["display-outside"]=!0,e["dominant-baseline"]=!1,e.elevation=!1,e["empty-cells"]=!1,e.filter=!1,e.flex=!1,e["flex-basis"]=!1,e["flex-direction"]=!1,e["flex-flow"]=!1,e["flex-grow"]=!1,e["flex-shrink"]=!1,e["flex-wrap"]=!1,e.float=!1,e["float-offset"]=!1,e["flood-color"]=!1,e["flood-opacity"]=!1,e["flow-from"]=!1,e["flow-into"]=!1,e.font=!0,e["font-family"]=!0,e["font-feature-settings"]=!0,e["font-kerning"]=!0,e["font-language-override"]=!0,e["font-size"]=!0,e["font-size-adjust"]=!0,e["font-stretch"]=!0,e["font-style"]=!0,e["font-synthesis"]=!0,e["font-variant"]=!0,e["font-variant-alternates"]=!0,e["font-variant-caps"]=!0,e["font-variant-east-asian"]=!0,e["font-variant-ligatures"]=!0,e["font-variant-numeric"]=!0,e["font-variant-position"]=!0,e["font-weight"]=!0,e.grid=!1,e["grid-area"]=!1,e["grid-auto-columns"]=!1,e["grid-auto-flow"]=!1,e["grid-auto-rows"]=!1,e["grid-column"]=!1,e["grid-column-end"]=!1,e["grid-column-start"]=!1,e["grid-row"]=!1,e["grid-row-end"]=!1,e["grid-row-start"]=!1,e["grid-template"]=!1,e["grid-template-areas"]=!1,e["grid-template-columns"]=!1,e["grid-template-rows"]=!1,e["hanging-punctuation"]=!1,e.height=!0,e.hyphens=!1,e.icon=!1,e["image-orientation"]=!1,e["image-resolution"]=!1,e["ime-mode"]=!1,e["initial-letters"]=!1,e["inline-box-align"]=!1,e["justify-content"]=!1,e["justify-items"]=!1,e["justify-self"]=!1,e.left=!1,e["letter-spacing"]=!0,e["lighting-color"]=!0,e["line-box-contain"]=!1,e["line-break"]=!1,e["line-grid"]=!1,e["line-height"]=!1,e["line-snap"]=!1,e["line-stacking"]=!1,e["line-stacking-ruby"]=!1,e["line-stacking-shift"]=!1,e["line-stacking-strategy"]=!1,e["list-style"]=!0,e["list-style-image"]=!0,e["list-style-position"]=!0,e["list-style-type"]=!0,e.margin=!0,e["margin-bottom"]=!0,e["margin-left"]=!0,e["margin-right"]=!0,e["margin-top"]=!0,e["marker-offset"]=!1,e["marker-side"]=!1,e.marks=!1,e.mask=!1,e["mask-box"]=!1,e["mask-box-outset"]=!1,e["mask-box-repeat"]=!1,e["mask-box-slice"]=!1,e["mask-box-source"]=!1,e["mask-box-width"]=!1,e["mask-clip"]=!1,e["mask-image"]=!1,e["mask-origin"]=!1,e["mask-position"]=!1,e["mask-repeat"]=!1,e["mask-size"]=!1,e["mask-source-type"]=!1,e["mask-type"]=!1,e["max-height"]=!0,e["max-lines"]=!1,e["max-width"]=!0,e["min-height"]=!0,e["min-width"]=!0,e["move-to"]=!1,e["nav-down"]=!1,e["nav-index"]=!1,e["nav-left"]=!1,e["nav-right"]=!1,e["nav-up"]=!1,e["object-fit"]=!1,e["object-position"]=!1,e.opacity=!1,e.order=!1,e.orphans=!1,e.outline=!1,e["outline-color"]=!1,e["outline-offset"]=!1,e["outline-style"]=!1,e["outline-width"]=!1,e.overflow=!1,e["overflow-wrap"]=!1,e["overflow-x"]=!1,e["overflow-y"]=!1,e.padding=!0,e["padding-bottom"]=!0,e["padding-left"]=!0,e["padding-right"]=!0,e["padding-top"]=!0,e.page=!1,e["page-break-after"]=!1,e["page-break-before"]=!1,e["page-break-inside"]=!1,e["page-policy"]=!1,e.pause=!1,e["pause-after"]=!1,e["pause-before"]=!1,e.perspective=!1,e["perspective-origin"]=!1,e.pitch=!1,e["pitch-range"]=!1,e["play-during"]=!1,e.position=!1,e["presentation-level"]=!1,e.quotes=!1,e["region-fragment"]=!1,e.resize=!1,e.rest=!1,e["rest-after"]=!1,e["rest-before"]=!1,e.richness=!1,e.right=!1,e.rotation=!1,e["rotation-point"]=!1,e["ruby-align"]=!1,e["ruby-merge"]=!1,e["ruby-position"]=!1,e["shape-image-threshold"]=!1,e["shape-outside"]=!1,e["shape-margin"]=!1,e.size=!1,e.speak=!1,e["speak-as"]=!1,e["speak-header"]=!1,e["speak-numeral"]=!1,e["speak-punctuation"]=!1,e["speech-rate"]=!1,e.stress=!1,e["string-set"]=!1,e["tab-size"]=!1,e["table-layout"]=!1,e["text-align"]=!0,e["text-align-last"]=!0,e["text-combine-upright"]=!0,e["text-decoration"]=!0,e["text-decoration-color"]=!0,e["text-decoration-line"]=!0,e["text-decoration-skip"]=!0,e["text-decoration-style"]=!0,e["text-emphasis"]=!0,e["text-emphasis-color"]=!0,e["text-emphasis-position"]=!0,e["text-emphasis-style"]=!0,e["text-height"]=!0,e["text-indent"]=!0,e["text-justify"]=!0,e["text-orientation"]=!0,e["text-overflow"]=!0,e["text-shadow"]=!0,e["text-space-collapse"]=!0,e["text-transform"]=!0,e["text-underline-position"]=!0,e["text-wrap"]=!0,e.top=!1,e.transform=!1,e["transform-origin"]=!1,e["transform-style"]=!1,e.transition=!1,e["transition-delay"]=!1,e["transition-duration"]=!1,e["transition-property"]=!1,e["transition-timing-function"]=!1,e["unicode-bidi"]=!1,e["vertical-align"]=!1,e.visibility=!1,e["voice-balance"]=!1,e["voice-duration"]=!1,e["voice-family"]=!1,e["voice-pitch"]=!1,e["voice-range"]=!1,e["voice-rate"]=!1,e["voice-stress"]=!1,e["voice-volume"]=!1,e.volume=!1,e["white-space"]=!1,e.widows=!1,e.width=!0,e["will-change"]=!1,e["word-break"]=!0,e["word-spacing"]=!0,e["word-wrap"]=!0,e["wrap-flow"]=!1,e["wrap-through"]=!1,e["writing-mode"]=!1,e["z-index"]=!1,e}function Mn(e,t,s){}function Tn(e,t,s){}var kn=/javascript\s*\:/img;function $n(e,t){return kn.test(t)?"":t}R.whiteList=ot();R.getDefaultWhiteList=ot;R.onAttr=Mn;R.onIgnoreAttr=Tn;R.safeAttrValue=$n;var On={indexOf:function(e,t){var s,n;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,n=e.length;s<n;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var n,r;if(Array.prototype.forEach)return e.forEach(t,s);for(n=0,r=e.length;n<r;n++)t.call(s,e[n],n,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},trimRight:function(e){return String.prototype.trimRight?e.trimRight():e.replace(/(\s*$)/g,"")}},P=On;function Vn(e,t){e=P.trimRight(e),e[e.length-1]!==";"&&(e+=";");var s=e.length,n=!1,r=0,i=0,a="";function o(){if(!n){var p=P.trim(e.slice(r,i)),d=p.indexOf(":");if(d!==-1){var c=P.trim(p.slice(0,d)),C=P.trim(p.slice(d+1));if(c){var u=t(r,a.length,c,C,p);u&&(a+=u+"; ")}}}r=i+1}for(;i<s;i++){var l=e[i];if(l==="/"&&e[i+1]==="*"){var f=e.indexOf("*/",i+2);if(f===-1)break;i=f+1,r=i+1,n=!1}else l==="("?n=!0:l===")"?n=!1:l===";"?n||o():l===`
`&&o()}return P.trim(a)}var Hn=Vn,z=R,Nn=Hn;function Ie(e){return e==null}function qn(e){var t={};for(var s in e)t[s]=e[s];return t}function lt(e){e=qn(e||{}),e.whiteList=e.whiteList||z.whiteList,e.onAttr=e.onAttr||z.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||z.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||z.safeAttrValue,this.options=e}lt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,n=s.whiteList,r=s.onAttr,i=s.onIgnoreAttr,a=s.safeAttrValue,o=Nn(e,function(l,f,p,d,c){var C=n[p],u=!1;if(C===!0?u=C:typeof C=="function"?u=C(d):C instanceof RegExp&&(u=C.test(d)),u!==!0&&(u=!1),d=a(p,d),!!d){var y={position:f,sourcePosition:l,source:c,isWhite:u};if(u){var h=r(p,d,y);return Ie(h)?p+":"+d:h}else{var h=i(p,d,y);if(!Ie(h))return h}}});return o};var Rn=lt;(function(e,t){var s=R,n=Rn;function r(a,o){var l=new n(o);return l.process(a)}t=e.exports=r,t.FilterCSS=n;for(var i in s)t[i]=s[i];typeof window<"u"&&(window.filterCSS=e.exports)})(Ee,Ee.exports);var be=Ee.exports,Se={indexOf:function(e,t){var s,n;if(Array.prototype.indexOf)return e.indexOf(t);for(s=0,n=e.length;s<n;s++)if(e[s]===t)return s;return-1},forEach:function(e,t,s){var n,r;if(Array.prototype.forEach)return e.forEach(t,s);for(n=0,r=e.length;n<r;n++)t.call(s,e[n],n,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,s=t.exec(e);return s?s.index:-1}},Bn=be.FilterCSS,Dn=be.getDefaultWhiteList,K=Se;function ut(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var dt=new Bn;function Zn(e,t,s){}function Pn(e,t,s){}function Gn(e,t,s){}function Un(e,t,s){}function ct(e){return e.replace(zn,"&lt;").replace(Wn,"&gt;")}function Fn(e,t,s,n){if(s=ht(s),t==="href"||t==="src"){if(s=K.trim(s),s==="#")return"#";if(!(s.substr(0,7)==="http://"||s.substr(0,8)==="https://"||s.substr(0,7)==="mailto:"||s.substr(0,4)==="tel:"||s.substr(0,11)==="data:image/"||s.substr(0,6)==="ftp://"||s.substr(0,2)==="./"||s.substr(0,3)==="../"||s[0]==="#"||s[0]==="/"))return""}else if(t==="background"){if(W.lastIndex=0,W.test(s))return""}else if(t==="style"){if(Me.lastIndex=0,Me.test(s)||(Te.lastIndex=0,Te.test(s)&&(W.lastIndex=0,W.test(s))))return"";n!==!1&&(n=n||dt,s=n.process(s))}return s=vt(s),s}var zn=/</g,Wn=/>/g,jn=/"/g,Xn=/&quot;/g,Yn=/&#([a-zA-Z0-9]*);?/gim,Qn=/&colon;?/gim,Kn=/&newline;?/gim,W=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,Me=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,Te=/u\s*r\s*l\s*\(.*/gi;function ft(e){return e.replace(jn,"&quot;")}function pt(e){return e.replace(Xn,'"')}function Ct(e){return e.replace(Yn,function(s,n){return n[0]==="x"||n[0]==="X"?String.fromCharCode(parseInt(n.substr(1),16)):String.fromCharCode(parseInt(n,10))})}function gt(e){return e.replace(Qn,":").replace(Kn," ")}function mt(e){for(var t="",s=0,n=e.length;s<n;s++)t+=e.charCodeAt(s)<32?" ":e.charAt(s);return K.trim(t)}function ht(e){return e=pt(e),e=Ct(e),e=gt(e),e=mt(e),e}function vt(e){return e=ft(e),e=ct(e),e}function Jn(){return""}function es(e,t){typeof t!="function"&&(t=function(){});var s=!Array.isArray(e);function n(a){return s?!0:K.indexOf(e,a)!==-1}var r=[],i=!1;return{onIgnoreTag:function(a,o,l){if(n(a))if(l.isClosing){var f="[/removed]",p=l.position+f.length;return r.push([i!==!1?i:l.position,p]),i=!1,f}else return i||(i=l.position),"[removed]";else return t(a,o,l)},remove:function(a){var o="",l=0;return K.forEach(r,function(f){o+=a.slice(l,f[0]),l=f[1]}),o+=a.slice(l),o}}}function ts(e){for(var t="",s=0;s<e.length;){var n=e.indexOf("<!--",s);if(n===-1){t+=e.slice(s);break}t+=e.slice(s,n);var r=e.indexOf("-->",n);if(r===-1)break;s=r+3}return t}function ns(e){var t=e.split("");return t=t.filter(function(s){var n=s.charCodeAt(0);return n===127?!1:n<=31?n===10||n===13:!0}),t.join("")}w.whiteList=ut();w.getDefaultWhiteList=ut;w.onTag=Zn;w.onIgnoreTag=Pn;w.onTagAttr=Gn;w.onIgnoreTagAttr=Un;w.safeAttrValue=Fn;w.escapeHtml=ct;w.escapeQuote=ft;w.unescapeQuote=pt;w.escapeHtmlEntities=Ct;w.escapeDangerHtml5Entities=gt;w.clearNonPrintableCharacter=mt;w.friendlyAttrValue=ht;w.escapeAttrValue=vt;w.onIgnoreTagStripAll=Jn;w.StripTagBody=es;w.stripCommentTag=ts;w.stripBlankChar=ns;w.attributeWrapSign='"';w.cssFilter=dt;w.getDefaultCSSWhiteList=Dn;var ee={},N=Se;function ss(e){var t=N.spaceIndex(e),s;return t===-1?s=e.slice(1,-1):s=e.slice(1,t+1),s=N.trim(s).toLowerCase(),s.slice(0,1)==="/"&&(s=s.slice(1)),s.slice(-1)==="/"&&(s=s.slice(0,-1)),s}function rs(e){return e.slice(0,2)==="</"}function as(e,t,s){var n="",r=0,i=!1,a=!1,o=0,l=e.length,f="",p="";e:for(o=0;o<l;o++){var d=e.charAt(o);if(i===!1){if(d==="<"){i=o;continue}}else if(a===!1){if(d==="<"){n+=s(e.slice(r,o)),i=o,r=o;continue}if(d===">"||o===l-1){n+=s(e.slice(r,i)),p=e.slice(i,o+1),f=ss(p),n+=t(i,n.length,f,p,rs(p)),r=o+1,i=!1;continue}if(d==='"'||d==="'")for(var c=1,C=e.charAt(o-c);C.trim()===""||C==="=";){if(C==="="){a=d;continue e}C=e.charAt(o-++c)}}else if(d===a){a=!1;continue}}return r<l&&(n+=s(e.substr(r))),n}var is=/[^a-zA-Z0-9\\_:.-]/gim;function os(e,t){var s=0,n=0,r=[],i=!1,a=e.length;function o(c,C){if(c=N.trim(c),c=c.replace(is,"").toLowerCase(),!(c.length<1)){var u=t(c,C||"");u&&r.push(u)}}for(var l=0;l<a;l++){var f=e.charAt(l),p,d;if(i===!1&&f==="="){i=e.slice(s,l),s=l+1,n=e.charAt(s)==='"'||e.charAt(s)==="'"?s:us(e,l+1);continue}if(i!==!1&&l===n){if(d=e.indexOf(f,l+1),d===-1)break;p=N.trim(e.slice(n+1,d)),o(i,p),i=!1,l=d,s=l+1;continue}if(/\s|\n|\t/.test(f))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(d=ls(e,l),d===-1){p=N.trim(e.slice(s,l)),o(p),i=!1,s=l+1;continue}else{l=d-1;continue}else if(d=ds(e,l-1),d===-1){p=N.trim(e.slice(s,l)),p=ke(p),o(i,p),i=!1,s=l+1;continue}else continue}return s<e.length&&(i===!1?o(e.slice(s)):o(i,ke(N.trim(e.slice(s))))),N.trim(r.join(" "))}function ls(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="="?t:-1}}function us(e,t){for(;t<e.length;t++){var s=e[t];if(s!==" ")return s==="'"||s==='"'?t:-1}}function ds(e,t){for(;t>0;t--){var s=e[t];if(s!==" ")return s==="="?t:-1}}function cs(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function ke(e){return cs(e)?e.substr(1,e.length-2):e}ee.parseTag=as;ee.parseAttr=os;var fs=be.FilterCSS,I=w,wt=ee,ps=wt.parseTag,Cs=wt.parseAttr,Y=Se;function j(e){return e==null}function gs(e){var t=Y.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=Y.trim(e.slice(t+1,-1));var s=e[e.length-1]==="/";return s&&(e=Y.trim(e.slice(0,-1))),{html:e,closing:s}}function ms(e){var t={};for(var s in e)t[s]=e[s];return t}function hs(e){var t={};for(var s in e)Array.isArray(e[s])?t[s.toLowerCase()]=e[s].map(function(n){return n.toLowerCase()}):t[s.toLowerCase()]=e[s];return t}function yt(e){e=ms(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=I.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=hs(e.whiteList||e.allowList):e.whiteList=I.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":I.attributeWrapSign,e.onTag=e.onTag||I.onTag,e.onTagAttr=e.onTagAttr||I.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||I.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||I.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||I.safeAttrValue,e.escapeHtml=e.escapeHtml||I.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new fs(e.css))}yt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,s=t.options,n=s.whiteList,r=s.onTag,i=s.onIgnoreTag,a=s.onTagAttr,o=s.onIgnoreTagAttr,l=s.safeAttrValue,f=s.escapeHtml,p=t.attributeWrapSign,d=t.cssFilter;s.stripBlankChar&&(e=I.stripBlankChar(e)),s.allowCommentTag||(e=I.stripCommentTag(e));var c=!1;s.stripIgnoreTagBody&&(c=I.StripTagBody(s.stripIgnoreTagBody,i),i=c.onIgnoreTag);var C=ps(e,function(u,y,h,v,m){var g={sourcePosition:u,position:y,isClosing:m,isWhite:Object.prototype.hasOwnProperty.call(n,h)},S=r(h,v,g);if(!j(S))return S;if(g.isWhite){if(g.isClosing)return"</"+h+">";var $=gs(v),O=n[h],V=Cs($.html,function(A,M){var L=Y.indexOf(O,A)!==-1,T=a(h,A,M,L);return j(T)?L?(M=l(h,A,M,d),M?A+"="+p+M+p:A):(T=o(h,A,M,L),j(T)?void 0:T):T});return v="<"+h,V&&(v+=" "+V),$.closing&&(v+=" /"),v+=">",v}else return S=i(h,v,g),j(S)?f(v):S},f);return c&&(C=c.remove(C)),C};var vs=yt;(function(e,t){var s=w,n=ee,r=vs;function i(o,l){var f=new r(l);return f.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=r,function(){for(var o in s)t[o]=s[o];for(var l in n)t[l]=n[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(Le,Le.exports);var ws=Le.exports;const k=In(ws);var ys=Array.isArray,Lt=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var s=void 0;if(ys(e))for(var n=0,r=e.length;n<r;)s=Lt(e[n++]),s&&(t&&(t+=" "),t+=s);else for(s in e)s&&e[s]&&(t&&(t+=" "),t+=s)}return t};function Et(){for(var e=arguments.length,t=0,s,n,r="";t<e;)s=arguments[t++],s&&(n=Lt(s),n&&(r&&(r+=" "),r+=n));return r}function $e({children:e="",imageUrl:t,imageAlt:s="",aspectRatio:n="card-small",videoUrl:r}){return`
    <span
      class="${Et("su-component-media-ratio su-overflow-hidden su-relative su-size-full su-block",n==="card-small"&&"su-aspect-[3/2]",n==="card-medium"&&"su-aspect-[3/2]",n==="card-large"&&"su-aspect-[3/2]",n==="card-featured"&&"su-aspect-[3/2]",n==="square"&&"su-aspect-[1/1]",n==="video"&&"su-aspect-[16/9]",n==="vertical-video"&&"su-aspect-[9/16]")}"
    >
      ${r?`
  ...
  `}const Ls={small:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",medium:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]",large:"su-left-13 su-bottom-13 [&>svg]:su-text-[4rem]",featured:"su-left-13 su-bottom-13 md:su-left-27 md:su-bottom-27 [&>svg]:su-text-[4rem] [&>svg]:md:su-text-[6rem]","vertical-video":"su-left-32 su-bottom-34 sm:su-left-48 sm:su-bottom-61 lg:su-left-32 lg:su-bottom-34 2xl:su-left-48 2xl:su-bottom-61 [&>svg]:su-text-[6rem]"};function Oe({imageUrl:e,alt:t="",aspectRatio:s,videoUrl:n,size:r="small",title:i="",videoIconClasses:a,uniqueId:o}){if(n){const l=`
        ...
        ${n?`
          <span
            class="${Et("su-absolute su-leading-none",r==="vertical-video"&&"su-z-30",Ls[r],a)}">
  ...
  `}function Es(e,t){if(!t)return!0;const s=e.match(/(\d+-\d+-\d+)/)[0],n=t.match(/(\d+-\d+-\d+)/)[0];return s===n}function bs({start:e,end:t}){if(!e&&!t)return null;const s=new Date(e),n=t?new Date(t):null,r={day:"numeric",month:"short",hour12:!0,time:"long",timeZone:"America/Los_Angeles",hour:"numeric",minute:"numeric"};let i="";const a=Es(e,t);a||(delete r.time,delete r.hour,delete r.minute);const o=new Intl.DateTimeFormat("en-US",r).format(s),l=t?new Intl.DateTimeFormat("en-US",r).format(n):"";return a?`<span data-testid="event-date" class="su-mb-0 su-text-16">${o.replace(/, /," | ")}</span>`:(i+=`${o} - ${l}`,`<span data-testid="event-date" class="su-mb-0 su-text-16">${i}</span>`)}function Ss(){return`
    ...
    </svg>`}const xs="light";function Ce({variant:e=xs}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="23"
            viewBox="0 0 17 23"
    ...
    >
    ...
    </svg>`}const Ne="solid";function Hs({variant:e=Ne}){const t=new Map;return t.set("solid",`<svg
            aria-hidden="true"
        ...
        >
            ...
            />
        </svg>`),t.get(e)!==null?t.get(e):t.get(Ne)}function me(){return`
    <svg
        aria-hidden="true"
    ...
    </svg>`}const Ns="light";function qe({variant:e=Ns}){const t=new Map;return t.set("light",`<svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="22"
            viewBox="0 0 17 22"
    ...
    </svg>`}const x={root:"listing-item su-flex su-relative",imageWrapper:"su-shrink-0",contentWrapper:"su-flex su-flex-col",taxonomy:"su-mb-0 su-text-16 su-font-semibold su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red",taxonomyLink:"focus:su-outline-0 focus:su-ring su-text-digital-red su-no-underline hover:su-text-digital-red dark:su-text-dark-mode-red hover:dark:su-text-dark-mode-red su-block su-mt-[-6px]",heading:"su-font-sans su-my-0 su-group",link:"su-group su-stretched-link su-inline-block su-text-black dark:su-text-white hocus:su-underline hocus:su-text-digital-red su-transition dark:hocus:su-text-dark-mode-red focus:su-outline-none focus-visible:su-ring-2 focus-visible:su-rounded focus-visible:su-ring-digital-red dark:focus-visible:su-ring-dark-mode-red focus-visible:su-outline-none focus-visible:after:su-outline focus-visible:after:su-outline-offset-8 focus-visible:after:su-outline-digital-red dark:focus-visible:after:su-outline-dark-mode-red",linkIcon:"su-inline-block su-align-middle su-ml-5 su-text-digital-red dark:su-text-dark-mode-red group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-transition-transform",type:"su-text-black-70 dark:su-text-black-30 su-w-full su-text-14 lg:su-text-16 su-mt-9 md:su-mt-12 su-mb-0 su-flex su-gap-6 su-items-center su-justify-start",typeText:"su-font-semibold su-text-14 md:su-text-16 su-leading-4",description:"su-hidden md:su-block su-text-16 lg:su-text-18 su-mt-9 md:su-mt-12 su-mb-0",descriptionContent:"su-mb-0 su-w-full [&>*:last-child]:su-mb-0"},Us={large:{gap:"su-gap-20 lg:su-gap-48",contentGap:"su-gap-9 lg:su-gap-12",title:"su-text-18 md:su-text-21 lg:su-text-23 su-font-bold su-leading-[21.6px] md:su-leading-[25.2px] lg:su-leading-[27.6px]",imageWrapper:"su-w-[103px] su-h-[69px] md:su-w-[169px] md:su-h-[113px] lg:su-w-[292px] lg:su-h-[193px]"},small:{gap:"su-gap-19",contentGap:"su-gap-6",title:"su-text-18 su-font-semibold su-leading-[21.495px]",imageWrapper:"su-w-[73px] su-h-[73px]"}};function Fs({data:{title:e,description:t,liveUrl:s,imageUrl:n,imageAlt:r,taxonomy:i,taxonomyUrl:a,type:o,date:l,endDate:f,videoUrl:p,uniqueID:d},cardSize:c="small"}){const C=Us[c],u=new Map;return u.set("alert",Ss()),u.set("analysis & insights",pe()),u.set("analysis &amp; insights",pe()),u.set("analysis&nbsp;&amp;&nbsp;insights",pe()),u.set("case study",Ce({variant:"light"})),u.set("case&nbsp;study",Ce({variant:"light"})),u.set("casestudy",Ce({variant:"light"})),u.set("event",Ms()),u.set("event&nbsp;highlights",Ve()),u.set("event highlights",Ve()),u.set("feature",Ts()),u.set("infographic",ks()),u.set("in&nbsp;the&nbsp;news",ge()),u.set("in the news",ge()),u.set("inthenews",ge()),u.set("leadership&nbsp;messages",He()),u.set("leadership messages",He()),u.set("obituary",$s()),u.set("opinion",Os()),u.set("photo",Vs()),u.set("policy&nbsp;brief",qe({variant:"light"})),u.set("policy brief",qe({variant:"light"})),u.set("poll/quiz",me()),u.set("poll / quiz",me()),u.set("poll&nbsp;/&nbsp;quiz",me()),u.set("profile",qs()),u.set("research",Rs()),u.set("solutions",Bs()),u.set("survey",Ds()),u.set("timeline",Zs()),u.set("tips & takeaways",he()),u.set("tips &amp; takeaways",he()),u.set("tips&nbsp;&amp;&nbsp;takeaways",he()),u.set("university&nbsp;updates",Re()),u.set("university updates",Re()),u.set("announcement",As()),u.set("news",_s()),u.set("q&amp;a",X()),u.set("q&a",X()),u.set("q & a",X()),u.set("q&nbsp;&amp;&nbsp;a",X()),u.set("video",Ps()),u.set("podcast",Hs({variant:"light"})),u.set("book",Is({className:""})),`
    <article aria-label="${e}" class="${x.root} ${C.gap}" data-testid="horizontal-card" >
      
    ${c==="large"?`
        <div class="${x.imageWrapper} ${C.imageWrapper}">
          ${n?`
            ${Oe({imageUrl:n,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"card-large",size:c,uniqueId:d})}
          `:""}
        </div>
      `:""}
      ...
      ${c==="small"&&n?`
        <div class="${x.imageWrapper} ${C.imageWrapper} su-relative">
            ${Oe({imageUrl:n,alt:r,videoUrl:p,mediaType:"image",aspectRatio:"large",size:c,uniqueId:d})}
        </div>
      `:""}
      ...
      <div class="${_.contentWrapper}">
        ...
        ${o==="Leadership Messages"?`
          <div class="${_.authorWrapper} ${u}">
            ${C?`
              ${zs({image:C,avatarSize:"small",alt:`Photo of ${a}`})}
            `:""}
            ${v}
          </div>
        `:""}
  ...
  `}function js(e){const{videoId:t,className:s="",noAutoPlay:n,title:r,isVertical:i}=e;return`
        <iframe
            width="${i?315:560}"
            height="${i?560:315}"
            class="${s}"
            ...
            data-modal="iframe"
        ></iframe>
    `}const Xs='section[data-component="topic-subtopic-listing"]',Ys='[data-element="topics-list"]',bt='[data-element="topics-pagination"]',St="su-hidden",Qs='section[data-element="modal-wrapper"]',Ks='button[data-click="open-modal"]',Js='button[data-dismiss="modal"]',At='iframe[data-modal="iframe"]';function er(e){const t=e.querySelector(At),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(St),e.hidden=!1,document.body.style.overflow="hidden"}function ve(e){const t=e.querySelector(At),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(St),e.hidden=!0,document.body.style.overflow="hidden"}function xt(e){const t=e.querySelectorAll(Ks),s=e.querySelectorAll(Js);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||ve(n)}),n.dataset.listenerAdded="true"),er(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&ve(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&ve(n)})}async function tr(e){const{offset:t,query:s,endpoint:n}=e,r=n+s+`&start_rank=${t}`;return await(await fetch(r).catch(o=>{throw new Error(o)})).json()}function nr(e,t,s,n){e.querySelector(Ys).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(bt).innerHTML=s,e.querySelector(Qs).innerHTML=n,window.scrollTo({top:0,behavior:"smooth"}),xt(e),_t(e)}async function sr(e){var c,C,u,y,h;const{offset:t,query:s,endpoint:n,display:r,section:i}=e,a=await tr({offset:t,query:s,endpoint:n}),o=(C=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:C.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const l=[],f=[];(h=(y=(u=a==null?void 0:a.response)==null?void 0:u.resultPacket)==null?void 0:y.results)==null||h.forEach(v=>{const m=x1(),g=E1(v);g.uniqueID=m,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(g.displayConfiguration=r,l.push(`<div class="su-relative su-grow">${Ws({data:g,cardType:"narrowhorizontal"})}</div>`)):l.push(`<div class="su-relative su-grow">${Fs({data:g,cardType:"horizontal",cardSize:"large"})}</div>`),(g.type==="Video"||g.videoUrl)&&f.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const p=_n({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),d=f.map(v=>`
        ...
        ${js({videoId:v.videoId,title:v.title,noAutoPlay:v.noAutoPlay,isVertical:v.isVertical})}
        ...
        `).join("");nr(i,l.join(""),p,d)}function _t(e){const{query:t,endpoint:s,display:n}=e.dataset,r=e.querySelector(bt);if(!r)return;r.querySelectorAll("button").forEach(a=>{a.addEventListener("click",()=>{if(a.disabled)return;const o=a.getAttribute("data-offset");sr({offset:o,query:t,endpoint:s,display:n,section:e})})})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Xs).forEach(e=>{xt(e),_t(e)})});const rr='section[data-component="vertical-video-panel"]',It="su-hidden",ar='button[data-click="open-modal"]',ir='button[data-dismiss="modal"]',Mt='iframe[data-modal="iframe"]';function or(e){const t=e.querySelector(Mt),n=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",n),e.classList.remove(It),e.hidden=!1,document.body.style.overflow="hidden"}function we(e){const t=e.querySelector(Mt),n=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",n),e.classList.add(It),e.hidden=!0,document.body.style.overflow=""}function lr(e){const t=e.querySelectorAll(ar),s=e.querySelectorAll(ir);let n=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(n=e.querySelector(`div[data-modal-id="${i}"]`),!n)return;const a=n.querySelector(".su-modal-content");n.dataset.listenerAdded||(a&&n.addEventListener("click",o=>{a.contains(o.target)||we(n)}),n.dataset.listenerAdded="true"),or(n)})}),s&&s.forEach(r=>{r&&r.addEventListener("click",function(){n&&we(n)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&n&&we(n)})}function ur(e){var n;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new B(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1.4,spaceBetween:20,centeredSlides:!0,initialSlide:0},576:{slidesPerView:1.6,spaceBetween:20,centeredSlides:!0,initialSlide:0},768:{slidesPerView:1.9,spaceBetween:50,centeredSlides:!0,initialSlide:0}},slidesPerView:1,watchSlidesProgress:!0,loop:!0,loopAdditionalSlides:0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{q(a),b(a,"",!1)},resize:a=>{q(a)},paginationUpdate:a=>{J(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?b(i,"h2 a, h3 a, button",!0):b(i,"",!1)},100)})}else(n=e.querySelector(".component-slider-controls"))==null||n.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(rr).forEach(e=>{ur(e),lr(e)})});
