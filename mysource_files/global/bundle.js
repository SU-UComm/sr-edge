import P from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const Be=typeof window>"u"?{}:window;function xt(e=Be){return e.document!==void 0}function De(e,t=Be){if(!xt(t))return null;const{document:n}=t,{cookie:s}=n;if(typeof s!="string")return null;const r=s.split("; ");let i=null;return r.find(a=>{const[o,l]=a.split("=");return o===e&&l!==""&&(i=l),null}),i}const Ee="su-hidden";function Se(e){const t={external:document.querySelectorAll('[data-audience="external"]'),faculty:document.querySelectorAll('[data-audience="faculty"]'),student:document.querySelectorAll('[data-audience="student"]')};Object.values(t).forEach(n=>{n==null||n.forEach(s=>{s.classList.add(Ee)})}),t[e]&&t[e].forEach(n=>{n.classList.remove(Ee)})}document.addEventListener("DOMContentLoaded",function(){const e=De("preferences_personalisation");Se(e==="null"||!e?"external":e)});function Ze(e){if(!e)return 0;const t=225,n=e.trim().split(/\s+/).length;return Math.ceil(n/t)}function _t(e,t,n,s=()=>{}){const r=e.slides.length;let i=t-r+1;r%n!==0&&(i+=n-r%n);const a=document.createDocumentFragment(),o=e.slides.map(l=>l.outerHTML).join("");for(let l=0;l<i;l++){const f=document.createElement("div");for(f.innerHTML=o;f.firstChild;)f.firstChild.classList.add("swiper-slide-duplicate"),a.appendChild(f.firstChild)}e.wrapperEl.appendChild(a),e.update(),I(e,"",!1),s()}function R(e,t=()=>{}){const{slidesPerView:n,slidesPerGroup:s}=e.params,r=e.slides.length,i=Math.ceil(n+s);r===1&&(e.navigation.nextEl.remove(),e.navigation.prevEl.remove()),r-1<i||r%s!==0?_t(e,i,s,t):(I(e,"",!1),t())}function ye(e){const t=e.slides.filter(n=>n.classList.contains("swiper-slide-duplicate")).length;if(t){let n=e.pagination.bullets.length-e.slides.length+t;for(;n>0;){const s=e.pagination.bullets.pop();s&&s.remove(),n--}}}const I=(e,t,n)=>{e.slides.forEach(s=>{if(s.classList.contains("swiper-slide-active")){if(s.removeAttribute("aria-hidden"),s.removeAttribute("inert"),s.setAttribute("tabindex","-1"),t&&n){let r=null;t==="slide"?r=s:r=s.querySelector(t),r&&r.focus()}}else s.setAttribute("aria-hidden","true"),s.setAttribute("inert","true"),s.removeAttribute("tabindex")}),e.pagination.bullets.length>0&&e.pagination.bullets.forEach(s=>{s.classList.contains("swiper-pagination-bullet-active")?s.setAttribute("aria-current","true"):s.removeAttribute("aria-current")})},Mt='section[data-component="basic-story-hero"]',It='span[data-reading="true"]',Pe="su-hidden",Tt='button[data-click="open-modal"]',kt='button[data-dismiss="modal"]',Ge='iframe[data-modal="iframe"]';function $t(e){const t=e.querySelector(Ge);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(Pe),e.hidden=!1,document.body.style.overflow="hidden"}function te(e){const t=e.querySelector(Ge);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(Pe),e.hidden=!0,document.body.style.overflow=""}function Vt(e){const t=e.querySelectorAll(Tt),n=e.querySelectorAll(kt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||te(s)}),s.dataset.listenerAdded="true"),$t(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&te(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&te(s)})}function Ht(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new P(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}},slidesPerView:1,loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},loopAdditionalSlides:0,watchSlidesProgress:!0,on:{init:a=>{R(a),I(a,"",!1)},resize:a=>{R(a)},paginationUpdate:a=>{ye(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?I(i,"slide",!0):I(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}function Ot(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(It);if(t&&n){const s=Ze(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Mt).forEach(e=>{Ht(e),Vt(e),Ot(e)})});const qt='section[data-component="combined-content-grid"]',Ue="su-hidden",Nt='button[data-click="open-modal"]',Rt='button[data-dismiss="modal"]',Fe='iframe[data-modal="iframe"]';function Bt(e){const t=e.querySelector(Fe),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Ue),e.hidden=!1,document.body.style.overflow="hidden"}function se(e){const t=e.querySelector(Fe),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Ue),e.hidden=!0,document.body.style.overflow=""}function Dt(e){const t=e.querySelectorAll(Nt),n=e.querySelectorAll(Rt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||se(s)}),s.dataset.listenerAdded="true"),Bt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&se(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&se(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(qt).forEach(e=>{Dt(e)})});const Zt='section[data-component="content-carousel"]';function Pt(e){var s;const t=e.dataset.uniqueId;if(e.querySelectorAll(".swiper-slide").length>1){let r=!1;const i=new P(`section[data-unique-id="${t}"] .swiper`,{breakpoints:{0:{slidesPerView:1,centeredSlides:!1},768:{slidesPerView:1,centeredSlides:!1},992:{slidesPerView:1,centeredSlides:!1}},slidesPerView:1,variantClassName:"component-slider-single",loop:!0,watchSlidesProgress:!0,spaceBetween:40,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(a,o){return`<button ${a===0?'aria-current="true"':""} class="${o}"><span class="sr-only">Slide ${a+1}</span></button>`}},on:{init:a=>{R(a),I(a,"",!1)},resize:a=>{R(a)},paginationUpdate:a=>{ye(a)}}});document.addEventListener("keydown",function(){r=!0}),document.addEventListener("mousedown",()=>{r=!1}),document.addEventListener("touchstart",()=>{r=!1}),document.addEventListener("pointerdown",()=>{r=!1}),i.on("slideChange",function(){setTimeout(()=>{r?I(i,"slide",!0):I(i,"",!1)},100)})}else(s=e.querySelector(".component-slider-controls"))==null||s.remove()}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Zt).forEach(e=>{Pt(e)})});const Gt='section[data-component="feature-story-hero"]',Ut='span[data-reading="true"]';function Ft(e){const t=document.querySelector(".su-page-content"),n=e.querySelector(Ut);if(t&&n){const s=Ze(t.innerText);n.textContent=s}}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Gt).forEach(e=>{Ft(e)})});const zt='section[data-component="featured-content"]',ze="su-hidden",Wt='button[data-click="open-modal"]',jt='button[data-dismiss="modal"]',We='iframe[data-modal="iframe"]';function Xt(e){const t=e.querySelector(We),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(ze),e.hidden=!1,document.body.style.overflow="hidden"}function ne(e){const t=e.querySelector(We),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(ze),e.hidden=!0,document.body.style.overflow=""}function Yt(e){const t=e.querySelectorAll(Wt),n=e.querySelectorAll(jt);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ne(s)}),s.dataset.listenerAdded="true"),Xt(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&ne(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ne(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(zt).forEach(e=>{Yt(e)})});const Qt='section[data-component="image-gallery-modal"]',Kt='button[data-click="open-gallery-modal"]',Jt='div[data-modal="modal"]',e1='button[data-dismiss="modal"]',je="su-hidden";let he;const t1=(e,t)=>{var a;const n='a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function s1(e){e.classList.remove(je),e.hidden=!1,document.body.style.overflow="hidden",document.addEventListener("keydown",t=>{e&&t1(t,e)})}function re(e){e.classList.add(je),e.hidden=!0,document.body.style.overflow=""}function n1(e){const t=e.dataset.modalId;he=new P(`div[data-modal-id="${t}"] .swiper`,{slidesPerView:1,variantClassName:"component-slider-imagegallery",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`div[data-modal-id="${t}"] .component-slider-next`,prevEl:`div[data-modal-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(n,s){return`<button ${n===0?'aria-current="true"':""} class="${s}"><span class="sr-only">Slide ${n+1}</span></button>`}},watchSlidesProgress:!0,breakpoints:{0:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},768:{slidesPerView:1,spaceBetween:0,centeredSlides:!1},992:{slidesPerView:1,spaceBetween:0,centeredSlides:!1}}})}function r1(e){const t=e.querySelector(Jt),n=e.querySelector(Kt),s=e.querySelector(e1);n&&n.addEventListener("click",function(){const r=t.querySelector(".su-modal-content");t.dataset.listenerAdded||(r&&t.addEventListener("click",i=>{r.contains(i.target)||re(t)}),t.dataset.listenerAdded="true"),s1(t),n1(t)}),s&&s.addEventListener("click",function(){re(t),he.destroy()}),document.addEventListener("keydown",function(r){r.key==="Escape"&&(re(t),he.destroy())})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(Qt).forEach(e=>{r1(e)})});class a1{constructor(t,n){this.url=t,this.type=n,this.assetData="",this.assetIds=[],this.requestProps={}}assets(...t){return this.assetIds=t,this}data(...t){return this.assetData=t.join(","),this}request(t){return this.requestProps=t,this}async fetch(){if(this.type==="MX"){const s=this.assetIds.map(async r=>{const i=`${this.url}/${r}?data=${this.assetData}`;return await(await fetch(i,this.requestProps).catch(l=>{throw new Error(l)})).json()});return Promise.all(s)}return await(await fetch(this.url,this.requestProps).catch(s=>{throw new Error(s)})).json()}}function i1({title:e,listMetadata:{assetTypeCode:t,teaserPlain:n,summary:s,image:r,taxonomyContentTypeText:i,contentTopic:a,contentSubtopic:o,taxonomyContentMainTopicText:l,contentCategory:f,featuredVideo:p,taxonomyContentMainTopicLandingPageUrl:d,taxonomyFeaturedUnitLandingPageUrl:c,taxonomyFeaturedUnitText:C,imageAlt:u,authorName:y,authorImage:h,author:v,isTeaser:m,storySource:g,assetHref:E},date:$,liveUrl:V}){const H=y!==void 0?y:v,S=h!==""?h:void 0,M=r&&r!==""?r:null,b=u&&u!==""?u:"",T=p,B=n||s;let O=l;!O&&a&&(O=a instanceof Array?a[0]:a),!O&&o&&(O=o instanceof Array?o[0]:o);const ee=d;let D=i?i[0]:"";return!D&&f&&(D=f instanceof Array?f[0]:f),E&&t[0]==="link"&&(V=E),{title:Array.isArray(e)?e[0]:e,description:Array.isArray(B)?B[0]:B,liveUrl:Array.isArray(V)?V[0]:V,imageUrl:Array.isArray(M)?M[0]:M,imageAlt:Array.isArray(b)?b[0]:b,taxonomy:Array.isArray(O)?O[0]:O,taxonomyUrl:Array.isArray(ee)?ee[0]:ee,type:Array.isArray(D)?D[0]:D,videoUrl:Array.isArray(T)?T[0]:T,date:Array.isArray($)?$[0]:$,authorDisplayName:Array.isArray(H)?H[0]:H,authorAvatar:Array.isArray(S)?S[0]:S,taxonomyFeaturedUnitLandingPageUrl:Array.isArray(c)?c[0]:c,taxonomyFeaturedUnitText:Array.isArray(C)?C[0]:C,isTeaser:Array.isArray(m)?m[0]:m,storySource:Array.isArray(g)?g[0]:g}}function ae(e){if(!e)return null;const t=new Date(e);return`${new Intl.DateTimeFormat("en",{month:"long",day:"numeric",year:"numeric",timeZone:"UTC"}).format(t)}`}function Xe(e){return!!e&&!(e!=null&&e.includes("news.stanford.edu"))}function o1(e){switch(e){case"faculty":return"Faculty/staff";case"student":return"Student";default:return"External"}}const l1=()=>{let e=new Date().getTime(),t=typeof performance<"u"&&performance.now&&performance.now()*1e3||0;return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{let s=Math.random()*16;return e>0?(s=(e+s)%16|0,e=Math.floor(e/16)):(s=(t+s)%16|0,t=Math.floor(t/16)),(n==="x"?s:s&3|8).toString(16)})},u1=()=>(1e7.toString()+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,e=>(Number(e)^crypto.getRandomValues(new Uint8Array(1))[0]&15>>Number(e)/4).toString(16)),d1=()=>typeof crypto<"u"?u1():l1();async function c1(e=null,t="",n=null){var r,i,a,o,l,f,p,d,c,C,u,y,h,v,m,g,E,$,V;const s=new a1;if(e&&((r=e==null?void 0:e.search)!=null&&r.endpoint)){const H=`
  ...
  `}const H1='section[data-component="single-image-video"]',O1='iframe[data-role="video-player"]',q1='button[data-role="video-control"]',Je="su-hidden",N1='button[data-click="open-modal"]',R1='button[data-dismiss="modal"]',et='iframe[data-modal="iframe"]',B1=(e,t)=>{var a;const n='[data-focus-scope-start="true"], [data-focus-scope-end="true"], a, button, input, textarea, select, details, iframe, [tabindex]:not([tabindex="-1"])',s=(a=Array.from(t==null?void 0:t.querySelectorAll(n)))==null?void 0:a.filter(o=>!o.hasAttribute("disabled")&&!o.getAttribute("aria-hidden"));if(s.length===0||(e==null?void 0:e.key)!=="Tab")return;const r=s[0],i=s[s.length-1];e.shiftKey&&document.activeElement===r?(e.preventDefault(),i.focus()):!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};function D1(e){const t=e.querySelector(et),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Je),e.hidden=!1,document.body.style.overflow="hidden",e.querySelector('[data-focus-scope-start="true"]').focus(),document.addEventListener("keydown",r=>{e&&B1(r,e)})}function le(e){const t=e.querySelector(et),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Je),e.hidden=!0,document.body.style.overflow=""}function Z1(e){const t=e.querySelectorAll(N1),n=e.querySelectorAll(R1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||le(s)}),s.dataset.listenerAdded="true"),D1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&le(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&le(s)})}function P1(e){const t=e.querySelector(O1),n=e.querySelector(q1);let s=!1;if(!t||!n)return;new IntersectionObserver(i=>{i.forEach(a=>{a.isIntersecting&&!s?(U(t,"play"),F(n,!1)):a.isIntersecting||(U(t,"pause"),F(n,!0))})},{threshold:.5}).observe(t),n.addEventListener("click",()=>{n.getAttribute("aria-pressed")==="true"?(U(t,"pause"),F(n,!0),s=!0):(U(t,"play"),F(n,!1),s=!1)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(H1).forEach(e=>{Z1(e),P1(e)})});const G1='section[data-component="standalone-visual-hero"]',tt="su-hidden",U1='button[data-click="open-modal"]',F1='button[data-dismiss="modal"]',st='iframe[data-modal="iframe"]';function z1(e){const t=e.querySelector(st);if(t){const s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s)}e.classList.remove(tt),e.hidden=!1,document.body.style.overflow="hidden"}function ue(e){const t=e.querySelector(st);if(t){const s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s)}e.classList.add(tt),e.hidden=!0,document.body.style.overflow=""}function W1(e){const t=e.querySelectorAll(U1),n=e.querySelectorAll(F1);let s=null;t.forEach(r=>{r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||ue(s)}),s.dataset.listenerAdded="true"),z1(s)})}),n.forEach(r=>{r.addEventListener("click",function(){s&&ue(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&ue(s)})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(G1).forEach(e=>{W1(e)})});const j1='section[data-component="stories-carousel"]',nt="su-hidden",X1='button[data-click="open-modal"]',Y1='button[data-dismiss="modal"]',rt='iframe[data-modal="iframe"]';function Q1(e){const t=e.querySelector(rt),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(nt),e.hidden=!1,document.body.style.overflow="hidden"}function de(e){const t=e.querySelector(rt),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(nt),e.hidden=!0,document.body.style.overflow=""}function K1(e){const t=e.querySelectorAll(X1),n=e.querySelectorAll(Y1);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||de(s)}),s.dataset.listenerAdded="true"),Q1(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&de(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&de(s)})}let xe=!1,_e=!1;function J1(e){const t=e.dataset.uniqueId,n=`section[data-unique-id="${t}"] .swiper`;new P(n,{breakpoints:{0:{slidesPerView:1.5,spaceBetween:40,centeredSlides:!0},768:{slidesPerView:3,spaceBetween:72,centeredSlides:!1},992:{slidesPerView:3,spaceBetween:102,centeredSlides:!1}},slidesPerView:1.5,spaceBetween:40,variantClassName:"component-slider-cards component-slider-peek",loop:!0,keyboard:{enabled:!0,onlyInViewport:!0},a11y:{prevSlideMessage:"Previous slide",nextSlideMessage:"Next slide"},navigation:{nextEl:`section[data-unique-id="${t}"] .component-slider-next`,prevEl:`section[data-unique-id="${t}"] .component-slider-prev`},pagination:{el:`.component-slider-pagination-${t}`,clickable:!0,bulletElement:"button",renderBullet:function(s,r){return`<button ${s===0?'aria-current="true"':""} class="${r}"><span class="sr-only">Slide ${s+1}</span></button>`}},watchSlidesProgress:!0,on:{init:function(){setTimeout(()=>{_e=!0,xe=!0},500)},slideChange:function(s){const r=document.querySelector(n),i=r.querySelector(".swiper-slide-active");i&&i.removeAttribute("tabindex"),_e&&setTimeout(()=>{const a=r.querySelector(".swiper-slide-active"),o=a.querySelector("h2 a, h3 a, button")?a.querySelector("h2 a, h3 a, button"):(()=>(a.setAttribute("tabindex","-1"),a))();xe&&o.focus()},300),s.slides.forEach(a=>{a.classList.contains("swiper-slide-visible")?(a.removeAttribute("aria-hidden"),a.removeAttribute("inert")):(a.setAttribute("aria-hidden","true"),a.setAttribute("inert","true"))}),s.pagination.bullets.length>0&&s.pagination.bullets.forEach(a=>{a.classList.contains("swiper-pagination-bullet-active")?a.setAttribute("aria-current","true"):a.removeAttribute("aria-current")})}}})}document.addEventListener("DOMContentLoaded",function(){document.querySelectorAll(j1).forEach(e=>{J1(e),K1(e)})});const es='section[data-component="subscribe-to-stanford-report"]';function ts(e){const t=e.querySelector("form"),n=t.querySelector('input[type="email"]'),s=t.querySelector("#error-container");t.addEventListener("submit",function(r){r.preventDefault();let i="";const a=n.value;if(!a||!a.match(/\w+@\w+\.\w+/)){i='<span id="subscription-error" class="su-block su-text-16 su-font-normal su-text-digital-red-light">Please enter a valid email address.</span>',s.innerHTML=i,n.setAttribute("aria-describedby","subscription-error");return}s.innerHTML="",n.removeAttribute("aria-describedby"),r.target.submit()}),n.addEventListener("keyup",function(){const r=n.value,i=t.querySelector("#error-container");r.match(/\w+@\w+\.\w+/)&&(i.innerHTML="",n.removeAttribute("aria-describedby"))})}function ss(){document.querySelectorAll(es).forEach(e=>{ts(e)})}typeof document<"u"&&document.addEventListener("DOMContentLoaded",ss);function ns({offsetNum:e,pageNumber:t,index:n}){return`
    ...
    `}function rs({pageNumber:e,allResults:t,resultsPerPage:n,paginationRange:s,currentPage:r=1}){const i=Math.ceil(t/n),a=s,o=e-n,l=e+n,f="su-text-black-50",p=[],d=[];for(let m=0;m<i;m++){const g=m*n+1;d.push(g)}let c=[...d],C=[...d];const u=d.indexOf(r),y=Math.floor(a*.5);if((u<y||i===a)&&(c=c.filter((m,g)=>m>r&&g<a),C=C.filter(m=>m<r)),u>=y&&i!==a)if(c=c.filter((m,g)=>m>r&&g<=u+y),c.length===y)C=C.filter((m,g)=>m<r&&g>=u-y);else{const m=c.length?a-c.length:a;C=C.filter((g,E)=>g<r&&E>u-m)}return[...C,r,...c].map(m=>({offset:m,index:d.indexOf(m)+1})).forEach(({offset:m,index:g})=>{p.push(ns({offsetNum:m,pageNumber:e,index:g}))}),i>1?`<div class="su-mx-auto su-component-container">
...
`&&o()}return Z.trim(a)}var fs=cs,z=N,ps=fs;function Me(e){return e==null}function Cs(e){var t={};for(var n in e)t[n]=e[n];return t}function it(e){e=Cs(e||{}),e.whiteList=e.whiteList||z.whiteList,e.onAttr=e.onAttr||z.onAttr,e.onIgnoreAttr=e.onIgnoreAttr||z.onIgnoreAttr,e.safeAttrValue=e.safeAttrValue||z.safeAttrValue,this.options=e}it.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onAttr,i=n.onIgnoreAttr,a=n.safeAttrValue,o=ps(e,function(l,f,p,d,c){var C=s[p],u=!1;if(C===!0?u=C:typeof C=="function"?u=C(d):C instanceof RegExp&&(u=C.test(d)),u!==!0&&(u=!1),d=a(p,d),!!d){var y={position:f,sourcePosition:l,source:c,isWhite:u};if(u){var h=r(p,d,y);return Me(h)?p+":"+d:h}else{var h=i(p,d,y);if(!Me(h))return h}}});return o};var gs=it;(function(e,t){var n=N,s=gs;function r(a,o){var l=new s(o);return l.process(a)}t=e.exports=r,t.FilterCSS=s;for(var i in n)t[i]=n[i];typeof window<"u"&&(window.filterCSS=e.exports)})(we,we.exports);var be=we.exports,Le={indexOf:function(e,t){var n,s;if(Array.prototype.indexOf)return e.indexOf(t);for(n=0,s=e.length;n<s;n++)if(e[n]===t)return n;return-1},forEach:function(e,t,n){var s,r;if(Array.prototype.forEach)return e.forEach(t,n);for(s=0,r=e.length;s<r;s++)t.call(n,e[s],s,e)},trim:function(e){return String.prototype.trim?e.trim():e.replace(/(^\s*)|(\s*$)/g,"")},spaceIndex:function(e){var t=/\s|\n|\t/,n=t.exec(e);return n?n.index:-1}},ms=be.FilterCSS,hs=be.getDefaultWhiteList,K=Le;function ot(){return{a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],audio:["autoplay","controls","crossorigin","loop","muted","preload","src"],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:[],dl:[],dt:[],em:[],figcaption:[],figure:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],img:["src","alt","title","width","height","loading"],ins:["datetime"],kbd:[],li:[],mark:[],nav:[],ol:[],p:[],pre:[],s:[],section:[],small:[],span:[],sub:[],summary:[],sup:[],strong:[],strike:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","rowspan","colspan","align","valign"],tfoot:["align","valign"],th:["width","rowspan","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[],video:["autoplay","controls","crossorigin","loop","muted","playsinline","poster","preload","src","height","width"]}}var lt=new ms;function vs(e,t,n){}function ws(e,t,n){}function ys(e,t,n){}function bs(e,t,n){}function ut(e){return e.replace(Es,"&lt;").replace(Ss,"&gt;")}function Ls(e,t,n,s){if(n=gt(n),t==="href"||t==="src"){if(n=K.trim(n),n==="#")return"#";if(!(n.substr(0,7)==="http://"||n.substr(0,8)==="https://"||n.substr(0,7)==="mailto:"||n.substr(0,4)==="tel:"||n.substr(0,11)==="data:image/"||n.substr(0,6)==="ftp://"||n.substr(0,2)==="./"||n.substr(0,3)==="../"||n[0]==="#"||n[0]==="/"))return""}else if(t==="background"){if(W.lastIndex=0,W.test(n))return""}else if(t==="style"){if(Ie.lastIndex=0,Ie.test(n)||(Te.lastIndex=0,Te.test(n)&&(W.lastIndex=0,W.test(n))))return"";s!==!1&&(s=s||lt,n=s.process(n))}return n=mt(n),n}var Es=/</g,Ss=/>/g,As=/"/g,xs=/&quot;/g,_s=/&#([a-zA-Z0-9]*);?/gim,Ms=/&colon;?/gim,Is=/&newline;?/gim,W=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi,Ie=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi,Te=/u\s*r\s*l\s*\(.*/gi;function dt(e){return e.replace(As,"&quot;")}function ct(e){return e.replace(xs,'"')}function ft(e){return e.replace(_s,function(n,s){return s[0]==="x"||s[0]==="X"?String.fromCharCode(parseInt(s.substr(1),16)):String.fromCharCode(parseInt(s,10))})}function pt(e){return e.replace(Ms,":").replace(Is," ")}function Ct(e){for(var t="",n=0,s=e.length;n<s;n++)t+=e.charCodeAt(n)<32?" ":e.charAt(n);return K.trim(t)}function gt(e){return e=ct(e),e=ft(e),e=pt(e),e=Ct(e),e}function mt(e){return e=dt(e),e=ut(e),e}function Ts(){return""}function ks(e,t){typeof t!="function"&&(t=function(){});var n=!Array.isArray(e);function s(a){return n?!0:K.indexOf(e,a)!==-1}var r=[],i=!1;return{onIgnoreTag:function(a,o,l){if(s(a))if(l.isClosing){var f="[/removed]",p=l.position+f.length;return r.push([i!==!1?i:l.position,p]),i=!1,f}else return i||(i=l.position),"[removed]";else return t(a,o,l)},remove:function(a){var o="",l=0;return K.forEach(r,function(f){o+=a.slice(l,f[0]),l=f[1]}),o+=a.slice(l),o}}}function $s(e){for(var t="",n=0;n<e.length;){var s=e.indexOf("<!--",n);if(s===-1){t+=e.slice(n);break}t+=e.slice(n,s);var r=e.indexOf("-->",s);if(r===-1)break;n=r+3}return t}function Vs(e){var t=e.split("");return t=t.filter(function(n){var s=n.charCodeAt(0);return s===127?!1:s<=31?s===10||s===13:!0}),t.join("")}w.whiteList=ot();w.getDefaultWhiteList=ot;w.onTag=vs;w.onIgnoreTag=ws;w.onTagAttr=ys;w.onIgnoreTagAttr=bs;w.safeAttrValue=Ls;w.escapeHtml=ut;w.escapeQuote=dt;w.unescapeQuote=ct;w.escapeHtmlEntities=ft;w.escapeDangerHtml5Entities=pt;w.clearNonPrintableCharacter=Ct;w.friendlyAttrValue=gt;w.escapeAttrValue=mt;w.onIgnoreTagStripAll=Ts;w.StripTagBody=ks;w.stripCommentTag=$s;w.stripBlankChar=Vs;w.attributeWrapSign='"';w.cssFilter=lt;w.getDefaultCSSWhiteList=hs;var J={},q=Le;function Hs(e){var t=q.spaceIndex(e),n;return t===-1?n=e.slice(1,-1):n=e.slice(1,t+1),n=q.trim(n).toLowerCase(),n.slice(0,1)==="/"&&(n=n.slice(1)),n.slice(-1)==="/"&&(n=n.slice(0,-1)),n}function Os(e){return e.slice(0,2)==="</"}function qs(e,t,n){var s="",r=0,i=!1,a=!1,o=0,l=e.length,f="",p="";e:for(o=0;o<l;o++){var d=e.charAt(o);if(i===!1){if(d==="<"){i=o;continue}}else if(a===!1){if(d==="<"){s+=n(e.slice(r,o)),i=o,r=o;continue}if(d===">"||o===l-1){s+=n(e.slice(r,i)),p=e.slice(i,o+1),f=Hs(p),s+=t(i,s.length,f,p,Os(p)),r=o+1,i=!1;continue}if(d==='"'||d==="'")for(var c=1,C=e.charAt(o-c);C.trim()===""||C==="=";){if(C==="="){a=d;continue e}C=e.charAt(o-++c)}}else if(d===a){a=!1;continue}}return r<l&&(s+=n(e.substr(r))),s}var Ns=/[^a-zA-Z0-9\\_:.-]/gim;function Rs(e,t){var n=0,s=0,r=[],i=!1,a=e.length;function o(c,C){if(c=q.trim(c),c=c.replace(Ns,"").toLowerCase(),!(c.length<1)){var u=t(c,C||"");u&&r.push(u)}}for(var l=0;l<a;l++){var f=e.charAt(l),p,d;if(i===!1&&f==="="){i=e.slice(n,l),n=l+1,s=e.charAt(n)==='"'||e.charAt(n)==="'"?n:Ds(e,l+1);continue}if(i!==!1&&l===s){if(d=e.indexOf(f,l+1),d===-1)break;p=q.trim(e.slice(s+1,d)),o(i,p),i=!1,l=d,n=l+1;continue}if(/\s|\n|\t/.test(f))if(e=e.replace(/\s|\n|\t/g," "),i===!1)if(d=Bs(e,l),d===-1){p=q.trim(e.slice(n,l)),o(p),i=!1,n=l+1;continue}else{l=d-1;continue}else if(d=Zs(e,l-1),d===-1){p=q.trim(e.slice(n,l)),p=ke(p),o(i,p),i=!1,n=l+1;continue}else continue}return n<e.length&&(i===!1?o(e.slice(n)):o(i,ke(q.trim(e.slice(n))))),q.trim(r.join(" "))}function Bs(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Ds(e,t){for(;t<e.length;t++){var n=e[t];if(n!==" ")return n==="'"||n==='"'?t:-1}}function Zs(e,t){for(;t>0;t--){var n=e[t];if(n!==" ")return n==="="?t:-1}}function Ps(e){return e[0]==='"'&&e[e.length-1]==='"'||e[0]==="'"&&e[e.length-1]==="'"}function ke(e){return Ps(e)?e.substr(1,e.length-2):e}J.parseTag=qs;J.parseAttr=Rs;var Gs=be.FilterCSS,_=w,ht=J,Us=ht.parseTag,Fs=ht.parseAttr,Y=Le;function j(e){return e==null}function zs(e){var t=Y.spaceIndex(e);if(t===-1)return{html:"",closing:e[e.length-2]==="/"};e=Y.trim(e.slice(t+1,-1));var n=e[e.length-1]==="/";return n&&(e=Y.trim(e.slice(0,-1))),{html:e,closing:n}}function Ws(e){var t={};for(var n in e)t[n]=e[n];return t}function js(e){var t={};for(var n in e)Array.isArray(e[n])?t[n.toLowerCase()]=e[n].map(function(s){return s.toLowerCase()}):t[n.toLowerCase()]=e[n];return t}function vt(e){e=Ws(e||{}),e.stripIgnoreTag&&(e.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),e.onIgnoreTag=_.onIgnoreTagStripAll),e.whiteList||e.allowList?e.whiteList=js(e.whiteList||e.allowList):e.whiteList=_.whiteList,this.attributeWrapSign=e.singleQuotedAttributeValue===!0?"'":_.attributeWrapSign,e.onTag=e.onTag||_.onTag,e.onTagAttr=e.onTagAttr||_.onTagAttr,e.onIgnoreTag=e.onIgnoreTag||_.onIgnoreTag,e.onIgnoreTagAttr=e.onIgnoreTagAttr||_.onIgnoreTagAttr,e.safeAttrValue=e.safeAttrValue||_.safeAttrValue,e.escapeHtml=e.escapeHtml||_.escapeHtml,this.options=e,e.css===!1?this.cssFilter=!1:(e.css=e.css||{},this.cssFilter=new Gs(e.css))}vt.prototype.process=function(e){if(e=e||"",e=e.toString(),!e)return"";var t=this,n=t.options,s=n.whiteList,r=n.onTag,i=n.onIgnoreTag,a=n.onTagAttr,o=n.onIgnoreTagAttr,l=n.safeAttrValue,f=n.escapeHtml,p=t.attributeWrapSign,d=t.cssFilter;n.stripBlankChar&&(e=_.stripBlankChar(e)),n.allowCommentTag||(e=_.stripCommentTag(e));var c=!1;n.stripIgnoreTagBody&&(c=_.StripTagBody(n.stripIgnoreTagBody,i),i=c.onIgnoreTag);var C=Us(e,function(u,y,h,v,m){var g={sourcePosition:u,position:y,isClosing:m,isWhite:Object.prototype.hasOwnProperty.call(s,h)},E=r(h,v,g);if(!j(E))return E;if(g.isWhite){if(g.isClosing)return"</"+h+">";var $=zs(v),V=s[h],H=Fs($.html,function(S,M){var b=Y.indexOf(V,S)!==-1,T=a(h,S,M,b);return j(T)?b?(M=l(h,S,M,d),M?S+"="+p+M+p:S):(T=o(h,S,M,b),j(T)?void 0:T):T});return v="<"+h,H&&(v+=" "+H),$.closing&&(v+=" /"),v+=">",v}else return E=i(h,v,g),j(E)?f(v):E},f);return c&&(C=c.remove(C)),C};var Xs=vt;(function(e,t){var n=w,s=J,r=Xs;function i(o,l){var f=new r(l);return f.process(o)}t=e.exports=i,t.filterXSS=i,t.FilterXSS=r,function(){for(var o in n)t[o]=n[o];for(var l in s)t[l]=s[l]}(),typeof window<"u"&&(window.filterXSS=e.exports);function a(){return typeof self<"u"&&typeof DedicatedWorkerGlobalScope<"u"&&self instanceof DedicatedWorkerGlobalScope}a()&&(self.filterXSS=e.exports)})(ve,ve.exports);var Ys=ve.exports;const k=as(Ys);var Qs=Array.isArray,wt=function(e){var t="";if(typeof e=="string")t+=e;else if(typeof e=="object"){var n=void 0;if(Qs(e))for(var s=0,r=e.length;s<r;)n=wt(e[s++]),n&&(t&&(t+=" "),t+=n);else for(n in e)n&&e[n]&&(t&&(t+=" "),t+=n)}return t};function yt(){for(var e=arguments.length,t=0,n,s,r="";t<e;)n=arguments[t++],n&&(s=wt(n),s&&(r&&(r+=" "),r+=s));return r}function $e({children:e="",imageUrl:t,imageAlt:n="",aspectRatio:s="card-small",videoUrl:r}){return`
  ...
  `}function xn(e){const{videoId:t,className:n="",noAutoPlay:s,title:r,isVertical:i}=e;return`
        <iframe
            ...
            data-modal="iframe"
        ></iframe>
    `}const _n='section[data-component="topic-subtopic-listing"]',Mn='[data-element="topics-list"]',bt='[data-element="topics-pagination"]',Lt="su-hidden",In='section[data-element="modal-wrapper"]',Tn='button[data-click="open-modal"]',kn='button[data-dismiss="modal"]',Et='iframe[data-modal="iframe"]';function $n(e){const t=e.querySelector(Et),s=t.getAttribute("src").replace("autoplay=0","autoplay=1");t.setAttribute("src",s),e.classList.remove(Lt),e.hidden=!1,document.body.style.overflow="hidden"}function me(e){const t=e.querySelector(Et),s=t.getAttribute("src").replace("autoplay=1","autoplay=0");t.setAttribute("src",s),e.classList.add(Lt),e.hidden=!0,document.body.style.overflow="hidden"}function St(e){const t=e.querySelectorAll(Tn),n=e.querySelectorAll(kn);let s=null;t&&t.forEach(r=>{r&&r.addEventListener("click",function(){const i=r.dataset.modalId;if(s=e.querySelector(`div[data-modal-id="${i}"]`),!s)return;const a=s.querySelector(".su-modal-content");s.dataset.listenerAdded||(a&&s.addEventListener("click",o=>{a.contains(o.target)||me(s)}),s.dataset.listenerAdded="true"),$n(s)})}),n&&n.forEach(r=>{r&&r.addEventListener("click",function(){s&&me(s)})}),document.addEventListener("keydown",function(r){r.key==="Escape"&&s&&me(s)})}async function Vn(e){const{offset:t,query:n,endpoint:s}=e,r=s+n+`&start_rank=${t}`;return await(await fetch(r).catch(o=>{throw new Error(o)})).json()}function Hn(e,t,n,s){e.querySelector(Mn).innerHTML=`<div class="su-w-full su-component-horizontal-card-grid" data-test="orientation-topiclisting"><div class="su-relative su-grid su-grid-cols-1 su-gap-30 md:su-gap-48 lg:su-gap-61">${t}</div></div>`,e.querySelector(bt).innerHTML=n,e.querySelector(In).innerHTML=s,window.scrollTo({top:0,behavior:"smooth"}),St(e),At(e)}async function On(e){var c,C,u,y,h;const{offset:t,query:n,endpoint:s,display:r,section:i}=e,a=await Vn({offset:t,query:n,endpoint:s}),o=(C=(c=a==null?void 0:a.response)==null?void 0:c.resultPacket)==null?void 0:C.resultsSummary;if(!o){console.warn("Missing resultsSummary from API response");return}const l=[],f=[];(h=(y=(u=a==null?void 0:a.response)==null?void 0:u.resultPacket)==null?void 0:y.results)==null||h.forEach(v=>{const m=d1(),g=i1(v);g.uniqueID=m,["Press Center","Leadership Messages","University Updates","Announcements","In the News"].includes(r)?(g.displayConfiguration=r,l.push(`<div class="su-relative su-grow">${An({data:g,cardType:"narrowhorizontal"})}</div>`)):l.push(`<div class="su-relative su-grow">${En({data:g,cardType:"horizontal",cardSize:"large"})}</div>`),(g.type==="Video"||g.videoUrl)&&f.push({isVertical:g.size==="vertical-video",videoId:g.videoUrl,title:`Watch ${g.title}`,noAutoPlay:!0,uniqueID:g.uniqueID,titleID:"card-modal"})});const p=rs({pageNumber:Number(t),allResults:o.totalMatching,resultsPerPage:o.numRanks,paginationRange:5,currentPage:Number(t)}),d=f.map(v=>`
