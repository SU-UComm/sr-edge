/**
 * Renders out the book icon for featured audio
 *
 * @return {string}
 */
...
function useId(prefix = 'id') {
  idCounter++;
  return `${prefix}-${idCounter}-featured_audio_`;
}

const DEFAULT_VARIANT = "light";
export function FeaturedAudio({ variant = DEFAULT_VARIANT }) {
        ...
        >
            ...
            <defs>
                ...
                >
                    ...
                    <stop offset="1" stop-color="#E50808" />
                </linearGradient>
            </defs>
        </svg>`
    );
